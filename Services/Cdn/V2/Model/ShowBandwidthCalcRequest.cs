...
namespace HuaweiCloud.SDK.Cdn.V2.Model
{
    ...
    public class ShowBandwidthCalcRequest 
    {
        ...
        /// </summary>
        [SDKProperty("calc_type", IsQuery = true)]
        [JsonProperty("calc_type", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ShowBandwidthCalcRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBandwidthCalcRequest input)
        {
            ...
            if (this.CalcType != input.CalcType || (this.CalcType != null && !this.CalcType.Equals(input.CalcType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CalcType != null) hashCode = hashCode * 59 + this.CalcType.GetHashCode();
                return hashCode;
            }
        }
    }

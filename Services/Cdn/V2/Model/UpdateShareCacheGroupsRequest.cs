...
namespace HuaweiCloud.SDK.Cdn.V2.Model
{
    ...
    public class UpdateShareCacheGroupsRequest 
    {
        ...
        public UpdateShareCacheGroupsRequstBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateShareCacheGroupsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateShareCacheGroupsRequest input)
        {

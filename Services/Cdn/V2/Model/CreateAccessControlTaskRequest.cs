...
namespace HuaweiCloud.SDK.Cdn.V2.Model
{
    ...
    public class CreateAccessControlTaskRequest 
    {
        ...
        public UrlAccessControlTaskRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAccessControlTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAccessControlTaskRequest input)
        {

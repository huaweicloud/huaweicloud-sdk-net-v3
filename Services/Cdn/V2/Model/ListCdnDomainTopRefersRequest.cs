    ...
    public class ListCdnDomainTopRefersRequest 
    {
        ...
        public bool Equals(ListCdnDomainTopRefersRequest input)
        {
            ...
            return 
                ...
                (
                    this.IncludeRatio == input.IncludeRatio ||
                    (this.IncludeRatio != null &&
                    this.IncludeRatio.Equals(input.IncludeRatio))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IncludeRatio != null)
                    hashCode = hashCode * 59 + this.IncludeRatio.GetHashCode();
                return hashCode;
            }
        }
    }

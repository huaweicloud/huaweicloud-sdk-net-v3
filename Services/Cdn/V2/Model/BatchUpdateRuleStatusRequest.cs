...
namespace HuaweiCloud.SDK.Cdn.V2.Model
{
    ...
    public class BatchUpdateRuleStatusRequest 
    {
        ...
        public BatchUpdateRulesRequest Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateRuleStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateRuleStatusRequest input)
        {

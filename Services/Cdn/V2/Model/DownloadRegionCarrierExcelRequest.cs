...
namespace HuaweiCloud.SDK.Cdn.V2.Model
{
    ...
    public class DownloadRegionCarrierExcelRequest 
    {
        ...
        /// </summary>
        [SDKProperty("carrier", IsQuery = true)]
        ...
        {
            return this.Equals(input as DownloadRegionCarrierExcelRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadRegionCarrierExcelRequest input)
        {
            if (input == null)
                return false;

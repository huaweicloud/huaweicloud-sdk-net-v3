...
namespace HuaweiCloud.SDK.Cdn.V1.Model
{
    ...
    public class ShowDomainItemDetailsResponse : SdkResponse
    {
        ...
        public bool Equals(ShowDomainItemDetailsResponse input)
        {
            ...
            if (this.DomainItemDetails != input.DomainItemDetails || (this.DomainItemDetails != null && !this.DomainItemDetails.Equals(input.DomainItemDetails))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.DomainItemDetails != null) hashCode = hashCode * 59 + this.DomainItemDetails.GetHashCode();
                return hashCode;
            }
        }
    }

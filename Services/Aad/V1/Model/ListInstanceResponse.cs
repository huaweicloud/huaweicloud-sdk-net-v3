...
namespace HuaweiCloud.SDK.Aad.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceResponse : SdkResponse
    {
        ...
        public List<InstanceInfo> Items { get; set; }
        ...
        {
            return this.Equals(input as ListInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceResponse input)
        {

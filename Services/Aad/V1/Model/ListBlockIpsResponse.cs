...
namespace HuaweiCloud.SDK.Aad.V1.Model
{
    ...
    public class ListBlockIpsResponse : SdkResponse
    {
        ...
        public bool Equals(ListBlockIpsResponse input)
        {
            ...
            return 
                (
                    this.BlockingList == input.BlockingList ||
                    this.BlockingList != null &&
                    input.BlockingList != null &&
                    this.BlockingList.SequenceEqual(input.BlockingList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BlockingList != null)
                    hashCode = hashCode * 59 + this.BlockingList.GetHashCode();
                if (this.Total != null)

...
namespace HuaweiCloud.SDK.Aad.V1.Model
{
    ...
    public class IpStatusDetail 
    {
        ...
        public bool Equals(IpStatusDetail input)
        {
            ...
            if (this.BlockTime != input.BlockTime || (this.BlockTime != null && !this.BlockTime.Equals(input.BlockTime))) return false;
            if (this.UnblockTime != input.UnblockTime || (this.UnblockTime != null && !this.UnblockTime.Equals(input.UnblockTime))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.BlockTime != null) hashCode = hashCode * 59 + this.BlockTime.GetHashCode();
                if (this.UnblockTime != null) hashCode = hashCode * 59 + this.UnblockTime.GetHashCode();
                return hashCode;
            }
        }
    }

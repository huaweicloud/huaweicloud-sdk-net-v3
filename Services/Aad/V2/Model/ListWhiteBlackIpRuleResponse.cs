...
namespace HuaweiCloud.SDK.Aad.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListWhiteBlackIpRuleResponse : SdkResponse
    {
        ...
        public List<BwListIps> Ips { get; set; }
        ...
        {
            return this.Equals(input as ListWhiteBlackIpRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListWhiteBlackIpRuleResponse input)
        {

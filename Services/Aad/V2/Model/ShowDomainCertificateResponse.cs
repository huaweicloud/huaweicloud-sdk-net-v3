...
namespace HuaweiCloud.SDK.Aad.V2.Model
{
    ...
    public class ShowDomainCertificateResponse : SdkResponse
    {
        ...
        public bool Equals(ShowDomainCertificateResponse input)
        {
            ...
            if (this.CertInfo != input.CertInfo || (this.CertInfo != null && !this.CertInfo.Equals(input.CertInfo))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CertInfo != null) hashCode = hashCode * 59 + this.CertInfo.GetHashCode();
                return hashCode;
            }
        }
    }

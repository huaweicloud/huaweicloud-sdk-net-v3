...
{
    public partial class SMSApiClient : Client
    {
        public static ClientBuilder<SMSApiClient> NewBuilder()
        {
            return new ClientBuilder<SMSApiClient>("SMSApiCredentials");
        }
        ...
        /// </summary>
        public BatchSendDiffSmsResponse BatchSendDiffSms(BatchSendDiffSmsRequest batchSendDiffSmsRequest)
        {
        ...
        public SyncInvoker<BatchSendDiffSmsResponse> BatchSendDiffSmsInvoker(BatchSendDiffSmsRequest batchSendDiffSmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/sms/batchSendDiffSms/v1", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchSendDiffSmsRequest);
            return new SyncInvoker<BatchSendDiffSmsResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchSendDiffSmsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchSendSmsResponse BatchSendSms(BatchSendSmsRequest batchSendSmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchSendSmsResponse> BatchSendSmsInvoker(BatchSendSmsRequest batchSendSmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/sms/batchSendSms/v1", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/x-www-form-urlencoded", batchSendSmsRequest);
            return new SyncInvoker<BatchSendSmsResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchSendSmsResponse>);
        }

...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateManagedAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateManagedAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateManagedAccountResponse input)
        {

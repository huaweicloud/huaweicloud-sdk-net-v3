...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowComplianceStatusForAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowComplianceStatusForAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowComplianceStatusForAccountResponse input)
        {

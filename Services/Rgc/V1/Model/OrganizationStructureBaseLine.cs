...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    public class OrganizationStructureBaseLine 
    {
        ...
        public List<AccountBaseline> Accounts { get; set; }
        ...
        {
            return this.Equals(input as OrganizationStructureBaseLine);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(OrganizationStructureBaseLine input)
        {

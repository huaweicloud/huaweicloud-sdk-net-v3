...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListExternalConfigRuleCompliancesResponse : SdkResponse
    {
        ...
        public List<ExternalConfigRuleCompliance> ConfigRuleCompliances { get; set; }
        ...
        {
            return this.Equals(input as ListExternalConfigRuleCompliancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListExternalConfigRuleCompliancesResponse input)
        {

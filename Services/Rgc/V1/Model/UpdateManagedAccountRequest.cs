...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    public class UpdateManagedAccountRequest 
    {
        ...
        public UpdateManagedAccountRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateManagedAccountRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateManagedAccountRequest input)
        {

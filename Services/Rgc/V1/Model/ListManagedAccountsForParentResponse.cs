...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListManagedAccountsForParentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListManagedAccountsForParentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListManagedAccountsForParentResponse input)
        {

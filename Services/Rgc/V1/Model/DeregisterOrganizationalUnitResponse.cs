...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeregisterOrganizationalUnitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeregisterOrganizationalUnitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeregisterOrganizationalUnitResponse input)
        {

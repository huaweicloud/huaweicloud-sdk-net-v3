...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowManagedOrganizationalUnitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowManagedOrganizationalUnitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowManagedOrganizationalUnitResponse input)
        {

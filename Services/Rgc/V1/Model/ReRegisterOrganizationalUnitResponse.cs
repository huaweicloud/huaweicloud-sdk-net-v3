...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ReRegisterOrganizationalUnitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ReRegisterOrganizationalUnitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ReRegisterOrganizationalUnitResponse input)
        {

...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowControlsForOrganizationalUnitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowControlsForOrganizationalUnitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowControlsForOrganizationalUnitResponse input)
        {

...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowManagedAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowManagedAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowManagedAccountResponse input)
        {

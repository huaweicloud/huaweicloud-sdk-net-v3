...
namespace HuaweiCloud.SDK.Rgc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListControlsForAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListControlsForAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListControlsForAccountResponse input)
        {

...
namespace HuaweiCloud.SDK.Versatile.V1.Model
{
    ...
    /// 
    /// </summary>
    public class UploadAgentFileRequestBody : IFormDataBody
    {
        ...
        public UploadAgentFileRequestBody WithFile(Stream stream, string filename)
        {
            this.File = new FormDataFilePart(stream, filename);
            return this;
        }

        public UploadAgentFileRequestBody WithFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as UploadAgentFileRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadAgentFileRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceJobsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceJobsResponse input)
        {

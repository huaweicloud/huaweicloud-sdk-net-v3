...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInstanceLtCredentialResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateInstanceLtCredentialResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceLtCredentialResponse input)
        {

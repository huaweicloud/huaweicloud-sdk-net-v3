...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceNamespaceRequest 
    {
        ...
        public UpdateNamespaceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceNamespaceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceNamespaceRequest input)
        {

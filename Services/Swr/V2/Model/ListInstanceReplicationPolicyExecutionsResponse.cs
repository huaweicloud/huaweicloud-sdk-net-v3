...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceReplicationPolicyExecutionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceReplicationPolicyExecutionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceReplicationPolicyExecutionsResponse input)
        {

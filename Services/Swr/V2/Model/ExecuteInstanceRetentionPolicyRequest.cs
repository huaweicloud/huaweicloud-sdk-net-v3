...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ExecuteInstanceRetentionPolicyRequest 
    {
        ...
        public ExecuteRetentionPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteInstanceRetentionPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteInstanceRetentionPolicyRequest input)
        {

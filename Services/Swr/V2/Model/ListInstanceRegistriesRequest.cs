...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ListInstanceRegistriesRequest 
    {
        ...
        /// </summary>
        /// <value>排序字段，支持created_at、updated_at、name，默认为created_at</value>
        ...
        public class OrderColumnEnum
        {
            ...
            /// </summary>
            public static readonly OrderColumnEnum CREATED_AT = new OrderColumnEnum("created_at");
            ...
            /// </summary>
            public static readonly OrderColumnEnum NAME = new OrderColumnEnum("name");
        ...
        /// </summary>
        /// <value>排序方式，支持desc、asc，默认desc; 注意：order_type需要与order_column配合使用</value>
        ...
        {
            return this.Equals(input as ListInstanceRegistriesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceRegistriesRequest input)
        {

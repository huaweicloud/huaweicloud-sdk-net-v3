...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceWebhookRequest 
    {
        ...
        public UpdateWebhookPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceWebhookRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceWebhookRequest input)
        {

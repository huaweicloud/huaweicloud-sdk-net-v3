...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceWebhooksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceWebhooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceWebhooksResponse input)
        {

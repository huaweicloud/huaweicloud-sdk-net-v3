...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class CreateManualImageSyncRepoRequest 
    {
        ...
        public CreateManualImageSyncRepoRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateManualImageSyncRepoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateManualImageSyncRepoRequest input)
        {
            if (input == null)
                return false;

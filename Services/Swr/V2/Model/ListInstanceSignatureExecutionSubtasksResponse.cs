...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceSignatureExecutionSubtasksResponse : SdkResponse
    {
        ...
        public List<SignatureExecutionSubTask> SubTasks { get; set; }
        ...
        {
            return this.Equals(input as ListInstanceSignatureExecutionSubtasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceSignatureExecutionSubtasksResponse input)
        {

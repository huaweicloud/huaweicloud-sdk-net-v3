...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class CreateInstanceWebhookRequest 
    {
        ...
        public CreateWebhookPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInstanceWebhookRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceWebhookRequest input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceWebhookResponse input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ListSharedReposDetailsRequest 
    {
        ...
        public bool Equals(ListSharedReposDetailsRequest input)
        {
            ...
            if (this.Center != input.Center || (this.Center != null && !this.Center.Equals(input.Center))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Center != null) hashCode = hashCode * 59 + this.Center.GetHashCode();

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class DeleteImageSyncRepoRequest 
    {
        ...
        public DeleteImageSyncRepoRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteImageSyncRepoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteImageSyncRepoRequest input)
        {
            if (input == null)
                return false;

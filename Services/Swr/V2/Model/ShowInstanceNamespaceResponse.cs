...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceNamespaceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceNamespaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceNamespaceResponse input)
        {

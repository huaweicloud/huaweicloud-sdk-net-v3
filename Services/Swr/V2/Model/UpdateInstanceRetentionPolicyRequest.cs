...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceRetentionPolicyRequest 
    {
        ...
        public UpdateRetentionPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceRetentionPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceRetentionPolicyRequest input)
        {

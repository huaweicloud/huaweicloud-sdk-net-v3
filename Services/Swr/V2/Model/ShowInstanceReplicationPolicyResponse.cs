...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceReplicationPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceReplicationPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceReplicationPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceReplicationPoliciesResponse : SdkResponse
    {
        ...
        public List<ReplicationPolicy> Policies { get; set; }
        ...
        {
            return this.Equals(input as ListInstanceReplicationPoliciesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceReplicationPoliciesResponse input)
        {

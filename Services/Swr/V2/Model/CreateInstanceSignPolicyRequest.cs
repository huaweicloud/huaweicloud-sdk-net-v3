...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class CreateInstanceSignPolicyRequest 
    {
        ...
        public CreateSignaturePolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInstanceSignPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceSignPolicyRequest input)
        {

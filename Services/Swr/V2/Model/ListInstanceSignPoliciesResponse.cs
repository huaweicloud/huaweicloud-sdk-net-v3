...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceSignPoliciesResponse : SdkResponse
    {
        ...
        public List<SignPolicyDetail> Policies { get; set; }
        ...
        {
            return this.Equals(input as ListInstanceSignPoliciesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceSignPoliciesResponse input)
        {

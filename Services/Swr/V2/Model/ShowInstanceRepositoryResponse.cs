...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceRepositoryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceRepositoryResponse input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceRegistryRequest 
    {
        ...
        /// 同步仓库ID
        /// </summary>
        [SDKProperty("registry_id", IsPath = true)]
        ...
        public UpdateRegistryRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceRegistryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceRegistryRequest input)
        {

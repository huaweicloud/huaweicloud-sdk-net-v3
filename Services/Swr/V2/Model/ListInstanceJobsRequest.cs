...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ListInstanceJobsRequest 
    {
        ...
        /// </summary>
        /// <value>任务状态, 支持的状态为：Creating,Initializing,Running,Failed,Success</value>
        ...
        {
            return this.Equals(input as ListInstanceJobsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceJobsRequest input)
        {

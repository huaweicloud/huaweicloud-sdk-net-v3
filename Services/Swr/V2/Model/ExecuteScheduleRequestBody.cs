...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ExecuteScheduleRequestBody 
    {
        ...
        public ExecuteScheduleObj Schedule { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("parameters", NullValueHandling = NullValueHandling.Ignore)]
        public GcParameters Parameters { get; set; }
        ...
        {
            return this.Equals(input as ExecuteScheduleRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteScheduleRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class CreateInstanceResourceTagsRequest 
    {
        ...
        public CreateResourceTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInstanceResourceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceResourceTagsRequest input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceWebhookJobsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceWebhookJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceWebhookJobsResponse input)
        {

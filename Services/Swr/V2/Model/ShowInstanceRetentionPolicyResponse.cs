...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceRetentionPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceRetentionPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceRetentionPolicyResponse input)
        {

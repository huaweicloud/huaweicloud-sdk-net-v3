...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceArtifactResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceArtifactResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceArtifactResponse input)
        {

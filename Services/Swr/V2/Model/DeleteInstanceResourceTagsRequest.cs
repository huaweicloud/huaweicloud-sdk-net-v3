...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class DeleteInstanceResourceTagsRequest 
    {
        ...
        public DeleteResourceTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteInstanceResourceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteInstanceResourceTagsRequest input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceReplicationPolicyRequest 
    {
        ...
        public UpdateReplicationPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceReplicationPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceReplicationPolicyRequest input)
        {

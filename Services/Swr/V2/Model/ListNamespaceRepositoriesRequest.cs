...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ListNamespaceRepositoriesRequest 
    {
        ...
        /// </summary>
        /// <value>排序字段，支持created_at、updated_at，默认为created_at</value>
        ...
        /// </summary>
        /// <value>排序方式，支持desc、asc，默认desc;order_column和order_type参数需要配套使用</value>
        ...
        {
            return this.Equals(input as ListNamespaceRepositoriesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNamespaceRepositoriesRequest input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class ListInstanceTagsRequest 
    {
        ...
        /// 是否返回制品附件，默认为true
        /// </summary>
        [SDKProperty("is_accessory", IsQuery = true)]
        [JsonProperty("is_accessory", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ListInstanceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceTagsRequest input)
        {
            ...
            if (this.IsAccessory != input.IsAccessory || (this.IsAccessory != null && !this.IsAccessory.Equals(input.IsAccessory))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsAccessory != null) hashCode = hashCode * 59 + this.IsAccessory.GetHashCode();
                return hashCode;
            }
        }
    }

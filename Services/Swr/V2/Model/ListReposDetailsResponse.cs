...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListReposDetailsResponse : SdkResponse
    {
        ...
        public List<ShowReposResp> Body { get; set; }
        ...
        {
            return this.Equals(input as ListReposDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListReposDetailsResponse input)
        {
            if (input == null)
                return false;

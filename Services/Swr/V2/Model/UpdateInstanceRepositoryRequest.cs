...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceRepositoryRequest 
    {
        ...
        public UpdateRepoConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceRepositoryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceRepositoryRequest input)
        {

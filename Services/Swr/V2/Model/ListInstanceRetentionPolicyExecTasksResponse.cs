...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceRetentionPolicyExecTasksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceRetentionPolicyExecTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceRetentionPolicyExecTasksResponse input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceSignPolicyExecTasksResponse : SdkResponse
    {
        ...
        public List<SignatureExecutionTask> Tasks { get; set; }
        ...
        {
            return this.Equals(input as ListInstanceSignPolicyExecTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceSignPolicyExecTasksResponse input)
        {

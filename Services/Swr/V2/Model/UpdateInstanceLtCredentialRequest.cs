...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceLtCredentialRequest 
    {
        ...
        public UpdateLongTermCredentialRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceLtCredentialRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceLtCredentialRequest input)
        {

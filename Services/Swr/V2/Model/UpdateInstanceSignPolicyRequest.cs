...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class UpdateInstanceSignPolicyRequest 
    {
        ...
        public UpdateSignaturePolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceSignPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceSignPolicyRequest input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class CreateInstanceRetentionPolicyRequest 
    {
        ...
        public CreateRetentionPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInstanceRetentionPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceRetentionPolicyRequest input)
        {

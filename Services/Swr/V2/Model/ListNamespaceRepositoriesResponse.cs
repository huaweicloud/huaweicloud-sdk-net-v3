...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListNamespaceRepositoriesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListNamespaceRepositoriesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNamespaceRepositoriesResponse input)
        {

...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    public class CreateInstanceRequestBody 
    {
        ...
        /// </summary>
        [JsonProperty("enable_intranet_access", NullValueHandling = NullValueHandling.Ignore)]
        public bool? EnableIntranetAccess { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  enableIntranetAccess: ").Append(EnableIntranetAccess).Append("\n");
        ...
        public bool Equals(CreateInstanceRequestBody input)
        {
            ...
            if (this.EnableIntranetAccess != input.EnableIntranetAccess || (this.EnableIntranetAccess != null && !this.EnableIntranetAccess.Equals(input.EnableIntranetAccess))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnableIntranetAccess != null) hashCode = hashCode * 59 + this.EnableIntranetAccess.GetHashCode();

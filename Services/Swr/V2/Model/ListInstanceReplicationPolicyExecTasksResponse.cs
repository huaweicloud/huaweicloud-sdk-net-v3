...
namespace HuaweiCloud.SDK.Swr.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceReplicationPolicyExecTasksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceReplicationPolicyExecTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceReplicationPolicyExecTasksResponse input)
        {

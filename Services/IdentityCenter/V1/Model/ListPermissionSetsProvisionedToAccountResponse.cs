...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPermissionSetsProvisionedToAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListPermissionSetsProvisionedToAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPermissionSetsProvisionedToAccountResponse input)
        {

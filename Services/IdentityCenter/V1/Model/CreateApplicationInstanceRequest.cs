...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class CreateApplicationInstanceRequest 
    {
        ...
        public CreateApplicationInstanceReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateApplicationInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateApplicationInstanceRequest input)
        {

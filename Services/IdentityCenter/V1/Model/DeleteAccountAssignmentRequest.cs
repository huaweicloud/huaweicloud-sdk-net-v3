...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class DeleteAccountAssignmentRequest 
    {
        ...
        public DeleteAccountAssignmentReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteAccountAssignmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteAccountAssignmentRequest input)
        {

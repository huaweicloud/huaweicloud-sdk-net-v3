...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetApplicationInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetApplicationInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetApplicationInstanceResponse input)
        {

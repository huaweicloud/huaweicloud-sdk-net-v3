...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class ProvisionPermissionSetRequest 
    {
        ...
        public ProvisionPermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as ProvisionPermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProvisionPermissionSetRequest input)
        {

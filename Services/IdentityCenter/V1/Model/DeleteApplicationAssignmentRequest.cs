...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class DeleteApplicationAssignmentRequest 
    {
        ...
        public DeleteApplicationAssignmentReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteApplicationAssignmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteApplicationAssignmentRequest input)
        {

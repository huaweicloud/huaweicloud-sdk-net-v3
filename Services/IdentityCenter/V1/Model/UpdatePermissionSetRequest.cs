...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdatePermissionSetRequest 
    {
        ...
        public UpdatePermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePermissionSetRequest input)
        {

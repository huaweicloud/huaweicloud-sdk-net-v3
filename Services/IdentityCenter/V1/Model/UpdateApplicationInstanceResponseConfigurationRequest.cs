...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceResponseConfigurationRequest 
    {
        ...
        public UpdateApplicationInstanceResponseConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceResponseConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceResponseConfigurationRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceDisplayDataRequest 
    {
        ...
        public UpdateApplicationInstanceDisplayDataReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceDisplayDataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceDisplayDataRequest input)
        {

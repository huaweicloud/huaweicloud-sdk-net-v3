...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class PutCustomPolicyToPermissionSetRequest 
    {
        ...
        public PutCustomPolicyToPermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as PutCustomPolicyToPermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PutCustomPolicyToPermissionSetRequest input)
        {

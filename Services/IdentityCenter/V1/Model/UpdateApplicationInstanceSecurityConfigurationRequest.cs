...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceSecurityConfigurationRequest 
    {
        ...
        public UpdateApplicationInstanceSecurityConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceSecurityConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceSecurityConfigurationRequest input)
        {

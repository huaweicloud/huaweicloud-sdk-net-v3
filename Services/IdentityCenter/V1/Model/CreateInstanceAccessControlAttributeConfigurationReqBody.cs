...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class CreateInstanceAccessControlAttributeConfigurationReqBody 
    {
        ...
        {
            return this.Equals(input as CreateInstanceAccessControlAttributeConfigurationReqBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceAccessControlAttributeConfigurationReqBody input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class PutCustomRoleToPermissionSetRequest 
    {
        ...
        public PutCustomRoleToPermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as PutCustomRoleToPermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PutCustomRoleToPermissionSetRequest input)
        {

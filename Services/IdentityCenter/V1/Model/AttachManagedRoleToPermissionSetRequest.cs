...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class AttachManagedRoleToPermissionSetRequest 
    {
        ...
        public ResourceAttachManagedPolicyToPermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as AttachManagedRoleToPermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachManagedRoleToPermissionSetRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ProvisionPermissionSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ProvisionPermissionSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProvisionPermissionSetResponse input)
        {

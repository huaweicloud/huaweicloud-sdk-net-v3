...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateApplicationInstanceActiveCertificateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceActiveCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceActiveCertificateResponse input)
        {

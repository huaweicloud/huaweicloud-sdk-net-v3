...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class CreateApplicationAssignmentRequest 
    {
        ...
        public CreateApplicationAssignmentReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateApplicationAssignmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateApplicationAssignmentRequest input)
        {

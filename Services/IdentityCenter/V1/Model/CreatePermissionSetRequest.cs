...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class CreatePermissionSetRequest 
    {
        ...
        public CreatePermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePermissionSetRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetApplicationAssignmentConfigurationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetApplicationAssignmentConfigurationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetApplicationAssignmentConfigurationResponse input)
        {

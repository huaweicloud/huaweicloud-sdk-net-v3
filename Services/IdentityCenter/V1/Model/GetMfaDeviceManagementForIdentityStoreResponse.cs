...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetMfaDeviceManagementForIdentityStoreResponse : SdkResponse
    {
        /// <summary>
        /// 允许用户自行操作的MFA行为
        /// </summary>
        /// <value>允许用户自行操作的MFA行为</value>
        ...
        {
            return this.Equals(input as GetMfaDeviceManagementForIdentityStoreResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetMfaDeviceManagementForIdentityStoreResponse input)
        {

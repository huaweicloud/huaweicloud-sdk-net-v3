...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceResponseSchemaConfigurationRequest 
    {
        ...
        public UpdateApplicationInstanceResponseSchemaConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceResponseSchemaConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceResponseSchemaConfigurationRequest input)
        {

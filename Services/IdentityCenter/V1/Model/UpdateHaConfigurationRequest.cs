...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateHaConfigurationRequest 
    {
        ...
        public UpdateHAConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateHaConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHaConfigurationRequest input)
        {

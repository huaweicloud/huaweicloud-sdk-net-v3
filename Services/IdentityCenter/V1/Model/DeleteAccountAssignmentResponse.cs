...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteAccountAssignmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteAccountAssignmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteAccountAssignmentResponse input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class ImportApplicationInstanceServiceProviderMetadataRequest 
    {
        ...
        public ImportApplicationInstanceServiceProviderMetadataReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as ImportApplicationInstanceServiceProviderMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportApplicationInstanceServiceProviderMetadataRequest input)
        {

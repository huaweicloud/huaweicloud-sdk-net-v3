...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DescribeAccountAssignmentCreationStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DescribeAccountAssignmentCreationStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DescribeAccountAssignmentCreationStatusResponse input)
        {

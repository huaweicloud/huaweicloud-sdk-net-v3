...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class AccessControlAttributeDto 
    {
        ...
        public AccessControlAttributeValueDto Value { get; set; }
        ...
        {
            return this.Equals(input as AccessControlAttributeDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AccessControlAttributeDto input)
        {

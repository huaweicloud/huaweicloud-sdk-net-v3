...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class CreateInstanceAccessControlAttributeConfigurationRequest 
    {
        ...
        public CreateInstanceAccessControlAttributeConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInstanceAccessControlAttributeConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceAccessControlAttributeConfigurationRequest input)
        {

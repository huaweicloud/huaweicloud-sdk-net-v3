...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateSsoConfigurationRequest 
    {
        ...
        public UpdateSsoConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSsoConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSsoConfigurationRequest input)
        {

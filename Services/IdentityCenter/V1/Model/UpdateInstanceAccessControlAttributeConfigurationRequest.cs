...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateInstanceAccessControlAttributeConfigurationRequest 
    {
        ...
        public UpdateInstanceAccessControlAttributeConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceAccessControlAttributeConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceAccessControlAttributeConfigurationRequest input)
        {

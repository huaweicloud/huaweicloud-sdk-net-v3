...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class ListApplicationTemplatesRequest 
    {
        ...
        /// 应用程序ID，以app-为前缀
        /// </summary>
        [SDKProperty("application_id", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListApplicationTemplatesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListApplicationTemplatesRequest input)
        {

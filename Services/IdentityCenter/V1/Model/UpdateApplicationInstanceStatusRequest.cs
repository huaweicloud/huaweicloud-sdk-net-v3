...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceStatusRequest 
    {
        ...
        public UpdateApplicationInstanceStatusReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceStatusRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class CreateAccountAssignmentRequest 
    {
        ...
        public CreateAccountAssignmentReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAccountAssignmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAccountAssignmentRequest input)
        {

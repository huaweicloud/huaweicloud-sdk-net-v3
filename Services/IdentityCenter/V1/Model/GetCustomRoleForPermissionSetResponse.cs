...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetCustomRoleForPermissionSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetCustomRoleForPermissionSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetCustomRoleForPermissionSetResponse input)
        {

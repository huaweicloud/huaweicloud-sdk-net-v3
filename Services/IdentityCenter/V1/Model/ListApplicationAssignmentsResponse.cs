...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListApplicationAssignmentsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListApplicationAssignmentsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListApplicationAssignmentsResponse input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DescribePermissionSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DescribePermissionSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DescribePermissionSetResponse input)
        {

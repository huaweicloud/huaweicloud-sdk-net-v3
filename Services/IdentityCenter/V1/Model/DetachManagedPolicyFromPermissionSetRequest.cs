...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class DetachManagedPolicyFromPermissionSetRequest 
    {
        ...
        public DetachManagedPolicyFromPermissionSetReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetachManagedPolicyFromPermissionSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetachManagedPolicyFromPermissionSetRequest input)
        {

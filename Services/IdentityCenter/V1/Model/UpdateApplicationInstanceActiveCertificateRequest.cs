...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceActiveCertificateRequest 
    {
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceActiveCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceActiveCertificateRequest input)
        {

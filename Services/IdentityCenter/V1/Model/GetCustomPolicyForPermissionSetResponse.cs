...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetCustomPolicyForPermissionSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetCustomPolicyForPermissionSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetCustomPolicyForPermissionSetResponse input)
        {

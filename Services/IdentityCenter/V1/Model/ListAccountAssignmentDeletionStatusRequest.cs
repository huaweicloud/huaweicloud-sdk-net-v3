...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class ListAccountAssignmentDeletionStatusRequest 
    {
        ...
        {
            return this.Equals(input as ListAccountAssignmentDeletionStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAccountAssignmentDeletionStatusRequest input)
        {

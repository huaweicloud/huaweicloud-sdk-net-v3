...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class DisassociateProfileRequest 
    {
        ...
        public DisassociateProfileReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DisassociateProfileRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateProfileRequest input)
        {

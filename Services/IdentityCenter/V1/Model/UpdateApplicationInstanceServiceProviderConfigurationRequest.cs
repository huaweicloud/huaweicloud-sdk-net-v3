...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class UpdateApplicationInstanceServiceProviderConfigurationRequest 
    {
        ...
        /// </summary>
        [SDKProperty("application_instance_id", IsPath = true)]
        ...
        public UpdateApplicationInstanceServiceProviderConfigurationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateApplicationInstanceServiceProviderConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateApplicationInstanceServiceProviderConfigurationRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class DescribeInstanceAccessControlAttributeConfigurationRequest 
    {
        ...
        {
            return this.Equals(input as DescribeInstanceAccessControlAttributeConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DescribeInstanceAccessControlAttributeConfigurationRequest input)
        {

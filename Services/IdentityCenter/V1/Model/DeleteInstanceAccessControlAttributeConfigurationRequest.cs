...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class DeleteInstanceAccessControlAttributeConfigurationRequest 
    {
        ...
        {
            return this.Equals(input as DeleteInstanceAccessControlAttributeConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteInstanceAccessControlAttributeConfigurationRequest input)
        {

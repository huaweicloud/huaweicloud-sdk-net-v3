...
namespace HuaweiCloud.SDK.IdentityCenter.V1.Model
{
    ...
    public class PutMfaDeviceManagementForIdentityStoreRequest 
    {
        ...
        public PutMfaDeviceManagementForDirectoryReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as PutMfaDeviceManagementForIdentityStoreRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PutMfaDeviceManagementForIdentityStoreRequest input)
        {

...
namespace HuaweiCloud.SDK.Sis.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateVocabularyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateVocabularyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVocabularyResponse input)
        {
            if (input == null)
                return false;

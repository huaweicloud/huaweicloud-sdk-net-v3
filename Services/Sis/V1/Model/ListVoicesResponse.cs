...
namespace HuaweiCloud.SDK.Sis.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListVoicesResponse : SdkResponse
    {
        ...
        public VoiceListResult Result { get; set; }
        ...
        {
            return this.Equals(input as ListVoicesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListVoicesResponse input)
        {

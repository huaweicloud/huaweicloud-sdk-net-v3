...
namespace HuaweiCloud.SDK.Sis.V1.Model
{
    ...
    public class GenerateSpeechRequestBody 
    {
        ...
        public GenerateSpeechRequestBodyConfig Config { get; set; }
        ...
        {
            return this.Equals(input as GenerateSpeechRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GenerateSpeechRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Sis.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GenerateSpeechResponse : SdkResponse
    {
        ...
        public GenerateSpeechRspResult Result { get; set; }
        ...
        {
            return this.Equals(input as GenerateSpeechResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GenerateSpeechResponse input)
        {

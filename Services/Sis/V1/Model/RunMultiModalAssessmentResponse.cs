...
namespace HuaweiCloud.SDK.Sis.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RunMultiModalAssessmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RunMultiModalAssessmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RunMultiModalAssessmentResponse input)
        {
            if (input == null)
                return false;

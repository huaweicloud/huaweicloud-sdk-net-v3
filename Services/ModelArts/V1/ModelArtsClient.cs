...
{
    public partial class ModelArtsClient : Client
    {
        public static ClientBuilder<ModelArtsClient> NewBuilder()
        {
            return new ClientBuilder<ModelArtsClient>();
        }
        ...
        /// </summary>
        public AcceptScheduledEventResponse AcceptScheduledEvent(AcceptScheduledEventRequest acceptScheduledEventRequest)
        {
        ...
        public SyncInvoker<AcceptScheduledEventResponse> AcceptScheduledEventInvoker(AcceptScheduledEventRequest acceptScheduledEventRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(acceptScheduledEventRequest.EventId, out var valueOfEventId)) urlParam.Add("event_id", valueOfEventId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/scheduled-events/{event_id}/accept", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", acceptScheduledEventRequest);
            return new SyncInvoker<AcceptScheduledEventResponse>(this, "POST", request, JsonUtils.DeSerialize<AcceptScheduledEventResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public AttachDevServerVolumeResponse AttachDevServerVolume(AttachDevServerVolumeRequest attachDevServerVolumeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<AttachDevServerVolumeResponse> AttachDevServerVolumeInvoker(AttachDevServerVolumeRequest attachDevServerVolumeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(attachDevServerVolumeRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/attachvolume", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", attachDevServerVolumeRequest);
            return new SyncInvoker<AttachDevServerVolumeResponse>(this, "POST", request, JsonUtils.DeSerialize<AttachDevServerVolumeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public AttachDynamicStorageResponse AttachDynamicStorage(AttachDynamicStorageRequest attachDynamicStorageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<AttachDynamicStorageResponse> AttachDynamicStorageInvoker(AttachDynamicStorageRequest attachDynamicStorageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(attachDynamicStorageRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{instance_id}/storage", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", attachDynamicStorageRequest);
            return new SyncInvoker<AttachDynamicStorageResponse>(this, "POST", request, JsonUtils.DeSerialize<AttachDynamicStorageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchBindInferApiKeysResponse BatchBindInferApiKeys(BatchBindInferApiKeysRequest batchBindInferApiKeysRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchBindInferApiKeysResponse> BatchBindInferApiKeysInvoker(BatchBindInferApiKeysRequest batchBindInferApiKeysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchBindInferApiKeysRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/api-keys/batch-bind", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchBindInferApiKeysRequest);
            return new SyncInvoker<BatchBindInferApiKeysResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchBindInferApiKeysResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchBindPoolNodesResponse BatchBindPoolNodes(BatchBindPoolNodesRequest batchBindPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchBindPoolNodesResponse> BatchBindPoolNodesInvoker(BatchBindPoolNodesRequest batchBindPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchBindPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-bind", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchBindPoolNodesRequest);
            return new SyncInvoker<BatchBindPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchBindPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchCreatePoolTagsResponse BatchCreatePoolTags(BatchCreatePoolTagsRequest batchCreatePoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchCreatePoolTagsResponse> BatchCreatePoolTagsInvoker(BatchCreatePoolTagsRequest batchCreatePoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchCreatePoolTagsRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/pools/{pool_name}/tags/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchCreatePoolTagsRequest);
            return new SyncInvoker<BatchCreatePoolTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchCreatePoolTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDeleteInferIntranetConnectionsResponse BatchDeleteInferIntranetConnections(BatchDeleteInferIntranetConnectionsRequest batchDeleteInferIntranetConnectionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDeleteInferIntranetConnectionsResponse> BatchDeleteInferIntranetConnectionsInvoker(BatchDeleteInferIntranetConnectionsRequest batchDeleteInferIntranetConnectionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/intranet-connection/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchDeleteInferIntranetConnectionsRequest);
            return new SyncInvoker<BatchDeleteInferIntranetConnectionsResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchDeleteInferIntranetConnectionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDeleteInferServicesResponse BatchDeleteInferServices(BatchDeleteInferServicesRequest batchDeleteInferServicesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDeleteInferServicesResponse> BatchDeleteInferServicesInvoker(BatchDeleteInferServicesRequest batchDeleteInferServicesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchDeleteInferServicesRequest);
            return new SyncInvoker<BatchDeleteInferServicesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchDeleteInferServicesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDeletePoolNodesResponse BatchDeletePoolNodes(BatchDeletePoolNodesRequest batchDeletePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDeletePoolNodesResponse> BatchDeletePoolNodesInvoker(BatchDeletePoolNodesRequest batchDeletePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchDeletePoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDeletePoolNodesRequest);
            return new SyncInvoker<BatchDeletePoolNodesResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchDeletePoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDeletePoolTagsResponse BatchDeletePoolTags(BatchDeletePoolTagsRequest batchDeletePoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDeletePoolTagsResponse> BatchDeletePoolTagsInvoker(BatchDeletePoolTagsRequest batchDeletePoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchDeletePoolTagsRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/pools/{pool_name}/tags/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDeletePoolTagsRequest);
            return new SyncInvoker<BatchDeletePoolTagsResponse>(this, "DELETE", request, JsonUtils.DeSerialize<BatchDeletePoolTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDevServersActionResponse BatchDevServersAction(BatchDevServersActionRequest batchDevServersActionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDevServersActionResponse> BatchDevServersActionInvoker(BatchDevServersActionRequest batchDevServersActionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/action", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchDevServersActionRequest);
            return new SyncInvoker<BatchDevServersActionResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchDevServersActionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDrainPoolNodesResponse BatchDrainPoolNodes(BatchDrainPoolNodesRequest batchDrainPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchDrainPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-drain", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDrainPoolNodesRequest);
            var response = DoHttpRequestSync("POST", request);
            return JsonUtils.DeSerializeNull<BatchDrainPoolNodesResponse>(response);
        }

        public SyncInvoker<BatchDrainPoolNodesResponse> BatchDrainPoolNodesInvoker(BatchDrainPoolNodesRequest batchDrainPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchDrainPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-drain", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDrainPoolNodesRequest);
            return new SyncInvoker<BatchDrainPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchDrainPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchLockPoolNodesResponse BatchLockPoolNodes(BatchLockPoolNodesRequest batchLockPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchLockPoolNodesResponse> BatchLockPoolNodesInvoker(BatchLockPoolNodesRequest batchLockPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchLockPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchLockPoolNodesRequest);
            return new SyncInvoker<BatchLockPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchLockPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchMigratePoolNodesResponse BatchMigratePoolNodes(BatchMigratePoolNodesRequest batchMigratePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchMigratePoolNodesResponse> BatchMigratePoolNodesInvoker(BatchMigratePoolNodesRequest batchMigratePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchMigratePoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-migrate", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchMigratePoolNodesRequest);
            return new SyncInvoker<BatchMigratePoolNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchMigratePoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchRebootPoolNodesResponse BatchRebootPoolNodes(BatchRebootPoolNodesRequest batchRebootPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchRebootPoolNodesResponse> BatchRebootPoolNodesInvoker(BatchRebootPoolNodesRequest batchRebootPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchRebootPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-reboot", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchRebootPoolNodesRequest);
            return new SyncInvoker<BatchRebootPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchRebootPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchResetPoolNodesResponse BatchResetPoolNodes(BatchResetPoolNodesRequest batchResetPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchResetPoolNodesResponse> BatchResetPoolNodesInvoker(BatchResetPoolNodesRequest batchResetPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchResetPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-reset", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchResetPoolNodesRequest);
            return new SyncInvoker<BatchResetPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchResetPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchResizePoolNodesResponse BatchResizePoolNodes(BatchResizePoolNodesRequest batchResizePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchResizePoolNodesResponse> BatchResizePoolNodesInvoker(BatchResizePoolNodesRequest batchResizePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchResizePoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-resize", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchResizePoolNodesRequest);
            return new SyncInvoker<BatchResizePoolNodesResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchResizePoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchUnbindInferApiKeysResponse BatchUnbindInferApiKeys(BatchUnbindInferApiKeysRequest batchUnbindInferApiKeysRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchUnbindInferApiKeysResponse> BatchUnbindInferApiKeysInvoker(BatchUnbindInferApiKeysRequest batchUnbindInferApiKeysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchUnbindInferApiKeysRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/api-keys/batch-unbind", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchUnbindInferApiKeysRequest);
            return new SyncInvoker<BatchUnbindInferApiKeysResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchUnbindInferApiKeysResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchUnlockPoolNodesResponse BatchUnlockPoolNodes(BatchUnlockPoolNodesRequest batchUnlockPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchUnlockPoolNodesResponse> BatchUnlockPoolNodesInvoker(BatchUnlockPoolNodesRequest batchUnlockPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchUnlockPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-unlock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchUnlockPoolNodesRequest);
            return new SyncInvoker<BatchUnlockPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchUnlockPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchUpdatePoolNodesResponse BatchUpdatePoolNodes(BatchUpdatePoolNodesRequest batchUpdatePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchUpdatePoolNodesResponse> BatchUpdatePoolNodesInvoker(BatchUpdatePoolNodesRequest batchUpdatePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchUpdatePoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-update", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchUpdatePoolNodesRequest);
            return new SyncInvoker<BatchUpdatePoolNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchUpdatePoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BindDevServerPublicIPResponse BindDevServerPublicIP(BindDevServerPublicIPRequest bindDevServerPublicIPRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BindDevServerPublicIPResponse> BindDevServerPublicIPInvoker(BindDevServerPublicIPRequest bindDevServerPublicIPRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(bindDevServerPublicIPRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/publicips", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", bindDevServerPublicIPRequest);
            return new SyncInvoker<BindDevServerPublicIPResponse>(this, "POST", request, JsonUtils.DeSerialize<BindDevServerPublicIPResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BindInferApiKeyResponse BindInferApiKey(BindInferApiKeyRequest bindInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BindInferApiKeyResponse> BindInferApiKeyInvoker(BindInferApiKeyRequest bindInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(bindInferApiKeyRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(bindInferApiKeyRequest.KeyId, out var valueOfKeyId)) urlParam.Add("key_id", valueOfKeyId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/api-keys/{key_id}/bind", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", bindInferApiKeyRequest);
            return new SyncInvoker<BindInferApiKeyResponse>(this, "POST", request, JsonUtils.DeSerialize<BindInferApiKeyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CancelInferDeploymentResponse CancelInferDeployment(CancelInferDeploymentRequest cancelInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CancelInferDeploymentResponse> CancelInferDeploymentInvoker(CancelInferDeploymentRequest cancelInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(cancelInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(cancelInferDeploymentRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/interrupt", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", cancelInferDeploymentRequest);
            return new SyncInvoker<CancelInferDeploymentResponse>(this, "POST", request, JsonUtils.DeSerialize<CancelInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ChangeAlgorithmResponse ChangeAlgorithm(ChangeAlgorithmRequest changeAlgorithmRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ChangeAlgorithmResponse> ChangeAlgorithmInvoker(ChangeAlgorithmRequest changeAlgorithmRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeAlgorithmRequest.AlgorithmId, out var valueOfAlgorithmId)) urlParam.Add("algorithm_id", valueOfAlgorithmId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/algorithms/{algorithm_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", changeAlgorithmRequest);
            return new SyncInvoker<ChangeAlgorithmResponse>(this, "PUT", request, JsonUtils.DeSerialize<ChangeAlgorithmResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ChangeDevServerOSResponse ChangeDevServerOS(ChangeDevServerOSRequest changeDevServerOSRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ChangeDevServerOSResponse> ChangeDevServerOSInvoker(ChangeDevServerOSRequest changeDevServerOSRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeDevServerOSRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/changeos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", changeDevServerOSRequest);
            return new SyncInvoker<ChangeDevServerOSResponse>(this, "POST", request, JsonUtils.DeSerialize<ChangeDevServerOSResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ChangeHyperinstanceOSResponse ChangeHyperinstanceOS(ChangeHyperinstanceOSRequest changeHyperinstanceOSRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ChangeHyperinstanceOSResponse> ChangeHyperinstanceOSInvoker(ChangeHyperinstanceOSRequest changeHyperinstanceOSRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeHyperinstanceOSRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/changeos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", changeHyperinstanceOSRequest);
            return new SyncInvoker<ChangeHyperinstanceOSResponse>(this, "POST", request, JsonUtils.DeSerialize<ChangeHyperinstanceOSResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ChangeTrainingExperimentResponse ChangeTrainingExperiment(ChangeTrainingExperimentRequest changeTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ChangeTrainingExperimentResponse> ChangeTrainingExperimentInvoker(ChangeTrainingExperimentRequest changeTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeTrainingExperimentRequest.ExperimentId, out var valueOfExperimentId)) urlParam.Add("experiment_id", valueOfExperimentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiments/{experiment_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", changeTrainingExperimentRequest);
            return new SyncInvoker<ChangeTrainingExperimentResponse>(this, "PUT", request, JsonUtils.DeSerialize<ChangeTrainingExperimentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ChangeTrainingJobDescriptionResponse ChangeTrainingJobDescription(ChangeTrainingJobDescriptionRequest changeTrainingJobDescriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ChangeTrainingJobDescriptionResponse> ChangeTrainingJobDescriptionInvoker(ChangeTrainingJobDescriptionRequest changeTrainingJobDescriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeTrainingJobDescriptionRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", changeTrainingJobDescriptionRequest);
            return new SyncInvoker<ChangeTrainingJobDescriptionResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<ChangeTrainingJobDescriptionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckTrainingExperimentResponse CheckTrainingExperiment(CheckTrainingExperimentRequest checkTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckTrainingExperimentResponse> CheckTrainingExperimentInvoker(CheckTrainingExperimentRequest checkTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiment-names", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkTrainingExperimentRequest);
            return new SyncInvoker<CheckTrainingExperimentResponse>(this, "GET", request, JsonUtils.DeSerialize<CheckTrainingExperimentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CountInferServicesByTagsResponse CountInferServicesByTags(CountInferServicesByTagsRequest countInferServicesByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CountInferServicesByTagsResponse> CountInferServicesByTagsInvoker(CountInferServicesByTagsRequest countInferServicesByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-service-v2/resource-instances/count", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", countInferServicesByTagsRequest);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateAlgorithmResponse CreateAlgorithm(CreateAlgorithmRequest createAlgorithmRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateAlgorithmResponse> CreateAlgorithmInvoker(CreateAlgorithmRequest createAlgorithmRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/algorithms", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createAlgorithmRequest);
            return new SyncInvoker<CreateAlgorithmResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateAlgorithmResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateAlgorithmVersionToGalleryResponse CreateAlgorithmVersionToGallery(CreateAlgorithmVersionToGalleryRequest createAlgorithmVersionToGalleryRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateAlgorithmVersionToGalleryResponse> CreateAlgorithmVersionToGalleryInvoker(CreateAlgorithmVersionToGalleryRequest createAlgorithmVersionToGalleryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/gallery-algorithm-publication", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createAlgorithmVersionToGalleryRequest);
            return new SyncInvoker<CreateAlgorithmVersionToGalleryResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateAlgorithmVersionToGalleryResponse>);
        }
        ...
        public SyncInvoker<CreateAuthorizationResponse> CreateAuthorizationInvoker(CreateAuthorizationRequest createAuthorizationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/authorizations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createAuthorizationRequest);
            return new SyncInvoker<CreateAuthorizationResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateAuthorizationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateDevServerResponse CreateDevServer(CreateDevServerRequest createDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateDevServerResponse> CreateDevServerInvoker(CreateDevServerRequest createDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createDevServerRequest);
            return new SyncInvoker<CreateDevServerResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateDevServerJobResponse CreateDevServerJob(CreateDevServerJobRequest createDevServerJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateDevServerJobResponse> CreateDevServerJobInvoker(CreateDevServerJobRequest createDevServerJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createDevServerJobRequest);
            return new SyncInvoker<CreateDevServerJobResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDevServerJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateHyperClusterResponse CreateHyperCluster(CreateHyperClusterRequest createHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateHyperClusterResponse> CreateHyperClusterInvoker(CreateHyperClusterRequest createHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyper-clusters", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createHyperClusterRequest);
            return new SyncInvoker<CreateHyperClusterResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateHyperClusterResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateHyperinstanceTagsResponse CreateHyperinstanceTags(CreateHyperinstanceTagsRequest createHyperinstanceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateHyperinstanceTagsResponse> CreateHyperinstanceTagsInvoker(CreateHyperinstanceTagsRequest createHyperinstanceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createHyperinstanceTagsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/tags/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createHyperinstanceTagsRequest);
            return new SyncInvoker<CreateHyperinstanceTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateHyperinstanceTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferApiKeyResponse CreateInferApiKey(CreateInferApiKeyRequest createInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferApiKeyResponse> CreateInferApiKeyInvoker(CreateInferApiKeyRequest createInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferApiKeyRequest);
            return new SyncInvoker<CreateInferApiKeyResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferApiKeyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferDeploymentResponse CreateInferDeployment(CreateInferDeploymentRequest createInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferDeploymentResponse> CreateInferDeploymentInvoker(CreateInferDeploymentRequest createInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferDeploymentRequest);
            return new SyncInvoker<CreateInferDeploymentResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferIntranetConnectionResponse CreateInferIntranetConnection(CreateInferIntranetConnectionRequest createInferIntranetConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferIntranetConnectionResponse> CreateInferIntranetConnectionInvoker(CreateInferIntranetConnectionRequest createInferIntranetConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/intranet-connection", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferIntranetConnectionRequest);
            return new SyncInvoker<CreateInferIntranetConnectionResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferIntranetConnectionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferServiceResponse CreateInferService(CreateInferServiceRequest createInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferServiceResponse> CreateInferServiceInvoker(CreateInferServiceRequest createInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferServiceRequest);
            return new SyncInvoker<CreateInferServiceResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferServiceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferServiceTagResponse CreateInferServiceTag(CreateInferServiceTagRequest createInferServiceTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferServiceTagResponse> CreateInferServiceTagInvoker(CreateInferServiceTagRequest createInferServiceTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createInferServiceTagRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-service-v2/{resource_id}/tags/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createInferServiceTagRequest);
            return new SyncInvoker<CreateInferServiceTagResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CreateInferServiceTagResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferTempApiKeyResponse CreateInferTempApiKey(CreateInferTempApiKeyRequest createInferTempApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys/temp", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferTempApiKeyRequest);
            var response = DoHttpRequestSync("POST", request);
            return JsonUtils.DeSerialize<CreateInferTempApiKeyResponse>(response);
        }

        public SyncInvoker<CreateInferTempApiKeyResponse> CreateInferTempApiKeyInvoker(CreateInferTempApiKeyRequest createInferTempApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys/temp", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferTempApiKeyRequest);
            return new SyncInvoker<CreateInferTempApiKeyResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferTempApiKeyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateModelArtsAgencyResponse CreateModelArtsAgency(CreateModelArtsAgencyRequest createModelArtsAgencyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateModelArtsAgencyResponse> CreateModelArtsAgencyInvoker(CreateModelArtsAgencyRequest createModelArtsAgencyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/agency", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createModelArtsAgencyRequest);
            return new SyncInvoker<CreateModelArtsAgencyResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateModelArtsAgencyResponse>);
        }
        ...
        public SyncInvoker<CreateNetworkResponse> CreateNetworkInvoker(CreateNetworkRequest createNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/networks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createNetworkRequest);
            return new SyncInvoker<CreateNetworkResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateNetworkResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateOrderIdResponse CreateOrderId(CreateOrderIdRequest createOrderIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateOrderIdResponse> CreateOrderIdInvoker(CreateOrderIdRequest createOrderIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createOrderIdRequest.Name, out var valueOfName)) urlParam.Add("name", valueOfName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{name}/orderid", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createOrderIdRequest);
            return new SyncInvoker<CreateOrderIdResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateOrderIdResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreatePoolPluginResponse CreatePoolPlugin(CreatePoolPluginRequest createPoolPluginRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreatePoolPluginResponse> CreatePoolPluginInvoker(CreatePoolPluginRequest createPoolPluginRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createPoolPluginRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/plugins", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createPoolPluginRequest);
            return new SyncInvoker<CreatePoolPluginResponse>(this, "POST", request, JsonUtils.DeSerialize<CreatePoolPluginResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateRoceNetworkResponse CreateRoceNetwork(CreateRoceNetworkRequest createRoceNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateRoceNetworkResponse> CreateRoceNetworkInvoker(CreateRoceNetworkRequest createRoceNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/networks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createRoceNetworkRequest);
            return new SyncInvoker<CreateRoceNetworkResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateRoceNetworkResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateSaveImageJobResponse CreateSaveImageJob(CreateSaveImageJobRequest createSaveImageJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateSaveImageJobResponse> CreateSaveImageJobInvoker(CreateSaveImageJobRequest createSaveImageJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createSaveImageJobRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(createSaveImageJobRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/tasks/{task_id}/save-image-job", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createSaveImageJobRequest);
            return new SyncInvoker<CreateSaveImageJobResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateSaveImageJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateTrainJobTagsResponse CreateTrainJobTags(CreateTrainJobTagsRequest createTrainJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateTrainJobTagsResponse> CreateTrainJobTagsInvoker(CreateTrainJobTagsRequest createTrainJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createTrainJobTagsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-training-job/{training_job_id}/tags/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createTrainJobTagsRequest);
            return new SyncInvoker<CreateTrainJobTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateTrainJobTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateTrainingExperimentResponse CreateTrainingExperiment(CreateTrainingExperimentRequest createTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateTrainingExperimentResponse> CreateTrainingExperimentInvoker(CreateTrainingExperimentRequest createTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiments", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createTrainingExperimentRequest);
            return new SyncInvoker<CreateTrainingExperimentResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateTrainingExperimentResponse>);
        }
        ...
        public SyncInvoker<CreateTrainingJobResponse> CreateTrainingJobInvoker(CreateTrainingJobRequest createTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createTrainingJobRequest);
            return new SyncInvoker<CreateTrainingJobResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateTrainingJobResponse>);
        }
        ...
        public SyncInvoker<CreateWorkspaceResponse> CreateWorkspaceInvoker(CreateWorkspaceRequest createWorkspaceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkspaceRequest);
            return new SyncInvoker<CreateWorkspaceResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkspaceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteAlgorithmResponse DeleteAlgorithm(DeleteAlgorithmRequest deleteAlgorithmRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteAlgorithmResponse> DeleteAlgorithmInvoker(DeleteAlgorithmRequest deleteAlgorithmRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteAlgorithmRequest.AlgorithmId, out var valueOfAlgorithmId)) urlParam.Add("algorithm_id", valueOfAlgorithmId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/algorithms/{algorithm_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteAlgorithmRequest);
            return new SyncInvoker<DeleteAlgorithmResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteAlgorithmResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteAuthorizationsResponse DeleteAuthorizations(DeleteAuthorizationsRequest deleteAuthorizationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/authorizations", urlParam);
        ...
        public SyncInvoker<DeleteAuthorizationsResponse> DeleteAuthorizationsInvoker(DeleteAuthorizationsRequest deleteAuthorizationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/authorizations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteAuthorizationsRequest);
            return new SyncInvoker<DeleteAuthorizationsResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteAuthorizationsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteDevServerResponse DeleteDevServer(DeleteDevServerRequest deleteDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteDevServerResponse> DeleteDevServerInvoker(DeleteDevServerRequest deleteDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteDevServerRequest);
            return new SyncInvoker<DeleteDevServerResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteDevServerJobsResponse DeleteDevServerJobs(DeleteDevServerJobsRequest deleteDevServerJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs", urlParam);
        ...
        public SyncInvoker<DeleteDevServerJobsResponse> DeleteDevServerJobsInvoker(DeleteDevServerJobsRequest deleteDevServerJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteDevServerJobsRequest);
            return new SyncInvoker<DeleteDevServerJobsResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteDevServerJobsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteHyperClusterResponse DeleteHyperCluster(DeleteHyperClusterRequest deleteHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteHyperClusterResponse> DeleteHyperClusterInvoker(DeleteHyperClusterRequest deleteHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteHyperClusterRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyper-clusters/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteHyperClusterRequest);
            return new SyncInvoker<DeleteHyperClusterResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteHyperClusterResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteHyperinstanceResponse DeleteHyperinstance(DeleteHyperinstanceRequest deleteHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteHyperinstanceResponse> DeleteHyperinstanceInvoker(DeleteHyperinstanceRequest deleteHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteHyperinstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteHyperinstanceRequest);
            return new SyncInvoker<DeleteHyperinstanceResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteHyperinstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteHyperinstanceTagsResponse DeleteHyperinstanceTags(DeleteHyperinstanceTagsRequest deleteHyperinstanceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteHyperinstanceTagsResponse> DeleteHyperinstanceTagsInvoker(DeleteHyperinstanceTagsRequest deleteHyperinstanceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteHyperinstanceTagsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/tags/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteHyperinstanceTagsRequest);
            return new SyncInvoker<DeleteHyperinstanceTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<DeleteHyperinstanceTagsResponse>);
        }
        ...
        public SyncInvoker<DeleteImageResponse> DeleteImageInvoker(DeleteImageRequest deleteImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteImageRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteImageRequest);
            return new SyncInvoker<DeleteImageResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteImageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteImageGroupResponse DeleteImageGroup(DeleteImageGroupRequest deleteImageGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteImageGroupResponse> DeleteImageGroupInvoker(DeleteImageGroupRequest deleteImageGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteImageGroupRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images/group/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteImageGroupRequest);
            return new SyncInvoker<DeleteImageGroupResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteImageGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferApiKeyResponse DeleteInferApiKey(DeleteInferApiKeyRequest deleteInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferApiKeyResponse> DeleteInferApiKeyInvoker(DeleteInferApiKeyRequest deleteInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferApiKeyRequest.KeyId, out var valueOfKeyId)) urlParam.Add("key_id", valueOfKeyId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys/{key_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferApiKeyRequest);
            return new SyncInvoker<DeleteInferApiKeyResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteInferApiKeyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferDeploymentResponse DeleteInferDeployment(DeleteInferDeploymentRequest deleteInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferDeploymentResponse> DeleteInferDeploymentInvoker(DeleteInferDeploymentRequest deleteInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferDeploymentRequest);
            return new SyncInvoker<DeleteInferDeploymentResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferDeploymentInstanceResponse DeleteInferDeploymentInstance(DeleteInferDeploymentInstanceRequest deleteInferDeploymentInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferDeploymentInstanceResponse> DeleteInferDeploymentInstanceInvoker(DeleteInferDeploymentInstanceRequest deleteInferDeploymentInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentInstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentInstanceRequest.DeploymentName, out var valueOfDeploymentName)) urlParam.Add("deployment_name", valueOfDeploymentName);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{id}/deployments/{deployment_name}/instances/{name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferDeploymentInstanceRequest);
            return new SyncInvoker<DeleteInferDeploymentInstanceResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteInferDeploymentInstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferDeploymentPodResponse DeleteInferDeploymentPod(DeleteInferDeploymentPodRequest deleteInferDeploymentPodRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferDeploymentPodResponse> DeleteInferDeploymentPodInvoker(DeleteInferDeploymentPodRequest deleteInferDeploymentPodRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentPodRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentPodRequest.DeploymentName, out var valueOfDeploymentName)) urlParam.Add("deployment_name", valueOfDeploymentName);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{id}/deployments/{deployment_name}/instances/{instance_name}/pods/{name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferDeploymentPodRequest);
            return new SyncInvoker<DeleteInferDeploymentPodResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteInferDeploymentPodResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferDeploymentVersionResponse DeleteInferDeploymentVersion(DeleteInferDeploymentVersionRequest deleteInferDeploymentVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferDeploymentVersionResponse> DeleteInferDeploymentVersionInvoker(DeleteInferDeploymentVersionRequest deleteInferDeploymentVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentVersionRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentVersionRequest.Version, out var valueOfVersion)) urlParam.Add("version", valueOfVersion);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/versions/{version}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferDeploymentVersionRequest);
            return new SyncInvoker<DeleteInferDeploymentVersionResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteInferDeploymentVersionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferServiceTagResponse DeleteInferServiceTag(DeleteInferServiceTagRequest deleteInferServiceTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferServiceTagResponse> DeleteInferServiceTagInvoker(DeleteInferServiceTagRequest deleteInferServiceTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferServiceTagRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-service-v2/{resource_id}/tags/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferServiceTagRequest);
            return new SyncInvoker<DeleteInferServiceTagResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteInferServiceTagResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteNetworkResponse DeleteNetwork(DeleteNetworkRequest deleteNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteNetworkResponse> DeleteNetworkInvoker(DeleteNetworkRequest deleteNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteNetworkRequest.NetworkName, out var valueOfNetworkName)) urlParam.Add("network_name", valueOfNetworkName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/networks/{network_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteNetworkRequest);
            return new SyncInvoker<DeleteNetworkResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteNetworkResponse>);
        }
        ...
        public SyncInvoker<DeletePoolResponse> DeletePoolInvoker(DeletePoolRequest deletePoolRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deletePoolRequest);
            return new SyncInvoker<DeletePoolResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeletePoolResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteTrainJobTagsResponse DeleteTrainJobTags(DeleteTrainJobTagsRequest deleteTrainJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteTrainJobTagsResponse> DeleteTrainJobTagsInvoker(DeleteTrainJobTagsRequest deleteTrainJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteTrainJobTagsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-training-job/{training_job_id}/tags/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteTrainJobTagsRequest);
            return new SyncInvoker<DeleteTrainJobTagsResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteTrainJobTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteTrainingExperimentResponse DeleteTrainingExperiment(DeleteTrainingExperimentRequest deleteTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteTrainingExperimentResponse> DeleteTrainingExperimentInvoker(DeleteTrainingExperimentRequest deleteTrainingExperimentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteTrainingExperimentRequest.ExperimentId, out var valueOfExperimentId)) urlParam.Add("experiment_id", valueOfExperimentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiments/{experiment_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteTrainingExperimentRequest);
            return new SyncInvoker<DeleteTrainingExperimentResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteTrainingExperimentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteTrainingJobResponse DeleteTrainingJob(DeleteTrainingJobRequest deleteTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteTrainingJobResponse> DeleteTrainingJobInvoker(DeleteTrainingJobRequest deleteTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteTrainingJobRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteTrainingJobRequest);
            return new SyncInvoker<DeleteTrainingJobResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteTrainingJobResponse>);
        }
        ...
        public SyncInvoker<DeleteWorkspaceResponse> DeleteWorkspaceInvoker(DeleteWorkspaceRequest deleteWorkspaceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkspaceRequest.WorkspaceId, out var valueOfWorkspaceId)) urlParam.Add("workspace_id", valueOfWorkspaceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces/{workspace_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteWorkspaceRequest);
            return new SyncInvoker<DeleteWorkspaceResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteWorkspaceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DetachDevServerVolumeResponse DetachDevServerVolume(DetachDevServerVolumeRequest detachDevServerVolumeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DetachDevServerVolumeResponse> DetachDevServerVolumeInvoker(DetachDevServerVolumeRequest detachDevServerVolumeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(detachDevServerVolumeRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(detachDevServerVolumeRequest.VolumeId, out var valueOfVolumeId)) urlParam.Add("volume_id", valueOfVolumeId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/detachvolume/{volume_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", detachDevServerVolumeRequest);
            return new SyncInvoker<DetachDevServerVolumeResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DetachDevServerVolumeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DetachDynamicStorageResponse DetachDynamicStorage(DetachDynamicStorageRequest detachDynamicStorageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DetachDynamicStorageResponse> DetachDynamicStorageInvoker(DetachDynamicStorageRequest detachDynamicStorageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(detachDynamicStorageRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(detachDynamicStorageRequest.StorageId, out var valueOfStorageId)) urlParam.Add("storage_id", valueOfStorageId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{instance_id}/storage/{storage_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", detachDynamicStorageRequest);
            return new SyncInvoker<DetachDynamicStorageResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DetachDynamicStorageResponse>);
        }
        ...
        public SyncInvoker<GetAuthorizationsResponse> GetAuthorizationsInvoker(GetAuthorizationsRequest getAuthorizationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/authorizations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getAuthorizationsRequest);
            return new SyncInvoker<GetAuthorizationsResponse>(this, "GET", request, JsonUtils.DeSerialize<GetAuthorizationsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetDevServerImageResponse GetDevServerImage(GetDevServerImageRequest getDevServerImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetDevServerImageResponse> GetDevServerImageInvoker(GetDevServerImageRequest getDevServerImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getDevServerImageRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/images/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getDevServerImageRequest);
            return new SyncInvoker<GetDevServerImageResponse>(this, "GET", request, JsonUtils.DeSerialize<GetDevServerImageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetDevServerJobResponse GetDevServerJob(GetDevServerJobRequest getDevServerJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetDevServerJobResponse> GetDevServerJobInvoker(GetDevServerJobRequest getDevServerJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getDevServerJobRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getDevServerJobRequest);
            return new SyncInvoker<GetDevServerJobResponse>(this, "GET", request, JsonUtils.DeSerialize<GetDevServerJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetDevServerJobServiceResponse GetDevServerJobService(GetDevServerJobServiceRequest getDevServerJobServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetDevServerJobServiceResponse> GetDevServerJobServiceInvoker(GetDevServerJobServiceRequest getDevServerJobServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getDevServerJobServiceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs/services/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getDevServerJobServiceRequest);
            return new SyncInvoker<GetDevServerJobServiceResponse>(this, "GET", request, JsonUtils.DeSerialize<GetDevServerJobServiceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetDevServerJobTemplateResponse GetDevServerJobTemplate(GetDevServerJobTemplateRequest getDevServerJobTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetDevServerJobTemplateResponse> GetDevServerJobTemplateInvoker(GetDevServerJobTemplateRequest getDevServerJobTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getDevServerJobTemplateRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs/templates/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getDevServerJobTemplateRequest);
            return new SyncInvoker<GetDevServerJobTemplateResponse>(this, "GET", request, JsonUtils.DeSerialize<GetDevServerJobTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetDevServerOperationResponse GetDevServerOperation(GetDevServerOperationRequest getDevServerOperationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetDevServerOperationResponse> GetDevServerOperationInvoker(GetDevServerOperationRequest getDevServerOperationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getDevServerOperationRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(getDevServerOperationRequest.OperationId, out var valueOfOperationId)) urlParam.Add("operation_id", valueOfOperationId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/operation/{operation_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getDevServerOperationRequest);
            return new SyncInvoker<GetDevServerOperationResponse>(this, "GET", request, JsonUtils.DeSerialize<GetDevServerOperationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetHyperClusterResponse GetHyperCluster(GetHyperClusterRequest getHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetHyperClusterResponse> GetHyperClusterInvoker(GetHyperClusterRequest getHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getHyperClusterRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyper-clusters/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getHyperClusterRequest);
            return new SyncInvoker<GetHyperClusterResponse>(this, "GET", request, JsonUtils.DeSerialize<GetHyperClusterResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetHyperinstanceResponse GetHyperinstance(GetHyperinstanceRequest getHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetHyperinstanceResponse> GetHyperinstanceInvoker(GetHyperinstanceRequest getHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getHyperinstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getHyperinstanceRequest);
            return new SyncInvoker<GetHyperinstanceResponse>(this, "GET", request, JsonUtils.DeSerialize<GetHyperinstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetHyperinstanceOperationResponse GetHyperinstanceOperation(GetHyperinstanceOperationRequest getHyperinstanceOperationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetHyperinstanceOperationResponse> GetHyperinstanceOperationInvoker(GetHyperinstanceOperationRequest getHyperinstanceOperationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getHyperinstanceOperationRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(getHyperinstanceOperationRequest.OperationId, out var valueOfOperationId)) urlParam.Add("operation_id", valueOfOperationId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/operation/{operation_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getHyperinstanceOperationRequest);
            return new SyncInvoker<GetHyperinstanceOperationResponse>(this, "GET", request, JsonUtils.DeSerialize<GetHyperinstanceOperationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetScaleEvaluationsDevServerResponse GetScaleEvaluationsDevServer(GetScaleEvaluationsDevServerRequest getScaleEvaluationsDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetScaleEvaluationsDevServerResponse> GetScaleEvaluationsDevServerInvoker(GetScaleEvaluationsDevServerRequest getScaleEvaluationsDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getScaleEvaluationsDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/scale-evaluations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getScaleEvaluationsDevServerRequest);
            return new SyncInvoker<GetScaleEvaluationsDevServerResponse>(this, "GET", request, JsonUtils.DeSerialize<GetScaleEvaluationsDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public GetTopologiesResponse GetTopologies(GetTopologiesRequest getTopologiesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<GetTopologiesResponse> GetTopologiesInvoker(GetTopologiesRequest getTopologiesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/instance-physical-topologies", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getTopologiesRequest);
            return new SyncInvoker<GetTopologiesResponse>(this, "GET", request, JsonUtils.DeSerialize<GetTopologiesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAlgorithmsResponse ListAlgorithms(ListAlgorithmsRequest listAlgorithmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/algorithms", urlParam);
        ...
        public SyncInvoker<ListAlgorithmsResponse> ListAlgorithmsInvoker(ListAlgorithmsRequest listAlgorithmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/algorithms", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAlgorithmsRequest);
            return new SyncInvoker<ListAlgorithmsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAlgorithmsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAllDevServersResponse ListAllDevServers(ListAllDevServersRequest listAllDevServersRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListAllDevServersResponse> ListAllDevServersInvoker(ListAllDevServersRequest listAllDevServersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/all", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAllDevServersRequest);
            return new SyncInvoker<ListAllDevServersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAllDevServersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAllHyperinstancesResponse ListAllHyperinstances(ListAllHyperinstancesRequest listAllHyperinstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListAllHyperinstancesResponse> ListAllHyperinstancesInvoker(ListAllHyperinstancesRequest listAllHyperinstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/all", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAllHyperinstancesRequest);
            return new SyncInvoker<ListAllHyperinstancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAllHyperinstancesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDevServerFlavorsResponse ListDevServerFlavors(ListDevServerFlavorsRequest listDevServerFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDevServerFlavorsResponse> ListDevServerFlavorsInvoker(ListDevServerFlavorsRequest listDevServerFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevServerFlavorsRequest);
            return new SyncInvoker<ListDevServerFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevServerFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDevServerImagesResponse ListDevServerImages(ListDevServerImagesRequest listDevServerImagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDevServerImagesResponse> ListDevServerImagesInvoker(ListDevServerImagesRequest listDevServerImagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/images", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevServerImagesRequest);
            return new SyncInvoker<ListDevServerImagesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevServerImagesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDevServerJobTemplatesResponse ListDevServerJobTemplates(ListDevServerJobTemplatesRequest listDevServerJobTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDevServerJobTemplatesResponse> ListDevServerJobTemplatesInvoker(ListDevServerJobTemplatesRequest listDevServerJobTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs/templates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevServerJobTemplatesRequest);
            return new SyncInvoker<ListDevServerJobTemplatesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevServerJobTemplatesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDevServerJobsResponse ListDevServerJobs(ListDevServerJobsRequest listDevServerJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs", urlParam);
        ...
        public SyncInvoker<ListDevServerJobsResponse> ListDevServerJobsInvoker(ListDevServerJobsRequest listDevServerJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/jobs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevServerJobsRequest);
            return new SyncInvoker<ListDevServerJobsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevServerJobsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDevServerPublicIPResponse ListDevServerPublicIP(ListDevServerPublicIPRequest listDevServerPublicIPRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDevServerPublicIPResponse> ListDevServerPublicIPInvoker(ListDevServerPublicIPRequest listDevServerPublicIPRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDevServerPublicIPRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/publicips", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevServerPublicIPRequest);
            return new SyncInvoker<ListDevServerPublicIPResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevServerPublicIPResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDevServersResponse ListDevServers(ListDevServersRequest listDevServersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers", urlParam);
        ...
        public SyncInvoker<ListDevServersResponse> ListDevServersInvoker(ListDevServersRequest listDevServersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevServersRequest);
            return new SyncInvoker<ListDevServersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevServersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDynamicStoragesResponse ListDynamicStorages(ListDynamicStoragesRequest listDynamicStoragesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDynamicStoragesResponse> ListDynamicStoragesInvoker(ListDynamicStoragesRequest listDynamicStoragesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDynamicStoragesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{instance_id}/storage", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDynamicStoragesRequest);
            return new SyncInvoker<ListDynamicStoragesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDynamicStoragesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListEventCategoriesResponse ListEventCategories(ListEventCategoriesRequest listEventCategoriesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListEventCategoriesResponse> ListEventCategoriesInvoker(ListEventCategoriesRequest listEventCategoriesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-event-categories", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listEventCategoriesRequest);
            return new SyncInvoker<ListEventCategoriesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListEventCategoriesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListHyperClusterResponse ListHyperCluster(ListHyperClusterRequest listHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyper-clusters", urlParam);
        ...
        public SyncInvoker<ListHyperClusterResponse> ListHyperClusterInvoker(ListHyperClusterRequest listHyperClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyper-clusters", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHyperClusterRequest);
            return new SyncInvoker<ListHyperClusterResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHyperClusterResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListHyperinstanceClustersCapacityResponse ListHyperinstanceClustersCapacity(ListHyperinstanceClustersCapacityRequest listHyperinstanceClustersCapacityRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListHyperinstanceClustersCapacityResponse> ListHyperinstanceClustersCapacityInvoker(ListHyperinstanceClustersCapacityRequest listHyperinstanceClustersCapacityRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/cluster-capacity-evaluations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", listHyperinstanceClustersCapacityRequest);
            return new SyncInvoker<ListHyperinstanceClustersCapacityResponse>(this, "POST", request, JsonUtils.DeSerialize<ListHyperinstanceClustersCapacityResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListHyperinstancesResponse ListHyperinstances(ListHyperinstancesRequest listHyperinstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListHyperinstancesResponse> ListHyperinstancesInvoker(ListHyperinstancesRequest listHyperinstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHyperinstancesRequest);
            return new SyncInvoker<ListHyperinstancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHyperinstancesResponse>);
        }
        ...
        public SyncInvoker<ListImageResponse> ListImageInvoker(ListImageRequest listImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listImageRequest);
            return new SyncInvoker<ListImageResponse>(this, "GET", request, JsonUtils.DeSerialize<ListImageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListImageGroupResponse ListImageGroup(ListImageGroupRequest listImageGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListImageGroupResponse> ListImageGroupInvoker(ListImageGroupRequest listImageGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images/group", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listImageGroupRequest);
            return new SyncInvoker<ListImageGroupResponse>(this, "GET", request, JsonUtils.DeSerialize<ListImageGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferApiKeysResponse ListInferApiKeys(ListInferApiKeysRequest listInferApiKeysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys", urlParam);
        ...
        public SyncInvoker<ListInferApiKeysResponse> ListInferApiKeysInvoker(ListInferApiKeysRequest listInferApiKeysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferApiKeysRequest);
            return new SyncInvoker<ListInferApiKeysResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferApiKeysResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferClusterFlavorsResponse ListInferClusterFlavors(ListInferClusterFlavorsRequest listInferClusterFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferClusterFlavorsResponse> ListInferClusterFlavorsInvoker(ListInferClusterFlavorsRequest listInferClusterFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferClusterFlavorsRequest);
            return new SyncInvoker<ListInferClusterFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferClusterFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferDeploymentInstancesResponse ListInferDeploymentInstances(ListInferDeploymentInstancesRequest listInferDeploymentInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferDeploymentInstancesResponse> ListInferDeploymentInstancesInvoker(ListInferDeploymentInstancesRequest listInferDeploymentInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentInstancesRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentInstancesRequest.Name, out var valueOfName)) urlParam.Add("name", valueOfName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{id}/deployments/{name}/instances", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferDeploymentInstancesRequest);
            return new SyncInvoker<ListInferDeploymentInstancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferDeploymentInstancesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferDeploymentPodEventsResponse ListInferDeploymentPodEvents(ListInferDeploymentPodEventsRequest listInferDeploymentPodEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferDeploymentPodEventsResponse> ListInferDeploymentPodEventsInvoker(ListInferDeploymentPodEventsRequest listInferDeploymentPodEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentPodEventsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentPodEventsRequest.DeploymentName, out var valueOfDeploymentName)) urlParam.Add("deployment_name", valueOfDeploymentName);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{id}/deployments/{deployment_name}/instances/{instance_name}/pods/{name}/events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferDeploymentPodEventsRequest);
            return new SyncInvoker<ListInferDeploymentPodEventsResponse>(this, "GET", request, response =>
            {
                var listInferDeploymentPodEventsResponse = JsonUtils.DeSerializeNull<ListInferDeploymentPodEventsResponse>(response);
                listInferDeploymentPodEventsResponse.Body = JsonUtils.DeSerializeList<ServicePodEventResponse>(response);
                return listInferDeploymentPodEventsResponse;
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferDeploymentPodsResponse ListInferDeploymentPods(ListInferDeploymentPodsRequest listInferDeploymentPodsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferDeploymentPodsResponse> ListInferDeploymentPodsInvoker(ListInferDeploymentPodsRequest listInferDeploymentPodsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentPodsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentPodsRequest.DeploymentName, out var valueOfDeploymentName)) urlParam.Add("deployment_name", valueOfDeploymentName);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{id}/deployments/{deployment_name}/instances/{name}/pods", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferDeploymentPodsRequest);
            return new SyncInvoker<ListInferDeploymentPodsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferDeploymentPodsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferDeploymentVersionsResponse ListInferDeploymentVersions(ListInferDeploymentVersionsRequest listInferDeploymentVersionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferDeploymentVersionsResponse> ListInferDeploymentVersionsInvoker(ListInferDeploymentVersionsRequest listInferDeploymentVersionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentVersionsRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentVersionsRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/versions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferDeploymentVersionsRequest);
            return new SyncInvoker<ListInferDeploymentVersionsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferDeploymentVersionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferDeploymentsResponse ListInferDeployments(ListInferDeploymentsRequest listInferDeploymentsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferDeploymentsResponse> ListInferDeploymentsInvoker(ListInferDeploymentsRequest listInferDeploymentsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentsRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferDeploymentsRequest);
            return new SyncInvoker<ListInferDeploymentsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferDeploymentsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferIntranetConnectionApplicationsResponse ListInferIntranetConnectionApplications(ListInferIntranetConnectionApplicationsRequest listInferIntranetConnectionApplicationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferIntranetConnectionApplicationsResponse> ListInferIntranetConnectionApplicationsInvoker(ListInferIntranetConnectionApplicationsRequest listInferIntranetConnectionApplicationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/intranet-connection/requests", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferIntranetConnectionApplicationsRequest);
            return new SyncInvoker<ListInferIntranetConnectionApplicationsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferIntranetConnectionApplicationsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferIntranetConnectionReviewsResponse ListInferIntranetConnectionReviews(ListInferIntranetConnectionReviewsRequest listInferIntranetConnectionReviewsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferIntranetConnectionReviewsResponse> ListInferIntranetConnectionReviewsInvoker(ListInferIntranetConnectionReviewsRequest listInferIntranetConnectionReviewsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/intranet-connection/reviews", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferIntranetConnectionReviewsRequest);
            return new SyncInvoker<ListInferIntranetConnectionReviewsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferIntranetConnectionReviewsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferServiceEventsResponse ListInferServiceEvents(ListInferServiceEventsRequest listInferServiceEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferServiceEventsResponse> ListInferServiceEventsInvoker(ListInferServiceEventsRequest listInferServiceEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferServiceEventsRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferServiceEventsRequest);
            return new SyncInvoker<ListInferServiceEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferServiceEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferServiceTagsResponse ListInferServiceTags(ListInferServiceTagsRequest listInferServiceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferServiceTagsResponse> ListInferServiceTagsInvoker(ListInferServiceTagsRequest listInferServiceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-service-v2/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferServiceTagsRequest);
            return new SyncInvoker<ListInferServiceTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferServiceTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferServicesResponse ListInferServices(ListInferServicesRequest listInferServicesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services", urlParam);
        ...
        public SyncInvoker<ListInferServicesResponse> ListInferServicesInvoker(ListInferServicesRequest listInferServicesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferServicesRequest);
            return new SyncInvoker<ListInferServicesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferServicesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferServicesByTagsResponse ListInferServicesByTags(ListInferServicesByTagsRequest listInferServicesByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferServicesByTagsResponse> ListInferServicesByTagsInvoker(ListInferServicesByTagsRequest listInferServicesByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-service-v2/resource-instances/filter", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferServicesByTagsRequest);
            return new SyncInvoker<ListInferServicesByTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListInferServicesByTagsResponse>);
        }
        ...
        public SyncInvoker<ListNetworksResponse> ListNetworksInvoker(ListNetworksRequest listNetworksRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/networks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listNetworksRequest);
            return new SyncInvoker<ListNetworksResponse>(this, "GET", request, JsonUtils.DeSerialize<ListNetworksResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListNodePoolNodesResponse ListNodePoolNodes(ListNodePoolNodesRequest listNodePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListNodePoolNodesResponse> ListNodePoolNodesInvoker(ListNodePoolNodesRequest listNodePoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listNodePoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            if (StringUtils.TryConvertToNonEmptyString(listNodePoolNodesRequest.NodepoolName, out var valueOfNodepoolName)) urlParam.Add("nodepool_name", valueOfNodepoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodepools/{nodepool_name}/nodes", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listNodePoolNodesRequest);
            return new SyncInvoker<ListNodePoolNodesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListNodePoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListPluginTemplatesResponse ListPluginTemplates(ListPluginTemplatesRequest listPluginTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListPluginTemplatesResponse> ListPluginTemplatesInvoker(ListPluginTemplatesRequest listPluginTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/plugintemplates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPluginTemplatesRequest);
            return new SyncInvoker<ListPluginTemplatesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPluginTemplatesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListPoolNodesResponse ListPoolNodes(ListPoolNodesRequest listPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListPoolNodesResponse> ListPoolNodesInvoker(ListPoolNodesRequest listPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPoolNodesRequest);
            return new SyncInvoker<ListPoolNodesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListPoolPluginsResponse ListPoolPlugins(ListPoolPluginsRequest listPoolPluginsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListPoolPluginsResponse> ListPoolPluginsInvoker(ListPoolPluginsRequest listPoolPluginsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPoolPluginsRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/plugins", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPoolPluginsRequest);
            return new SyncInvoker<ListPoolPluginsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPoolPluginsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListPoolTagsResponse ListPoolTags(ListPoolTagsRequest listPoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListPoolTagsResponse> ListPoolTagsInvoker(ListPoolTagsRequest listPoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/pools/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPoolTagsRequest);
            return new SyncInvoker<ListPoolTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPoolTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListResourceFlavorsResponse ListResourceFlavors(ListResourceFlavorsRequest listResourceFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListResourceFlavorsResponse> ListResourceFlavorsInvoker(ListResourceFlavorsRequest listResourceFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/resourceflavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listResourceFlavorsRequest);
            return new SyncInvoker<ListResourceFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListResourceFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTrainingExperimentsResponse ListTrainingExperiments(ListTrainingExperimentsRequest listTrainingExperimentsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiments", urlParam);
        ...
        public SyncInvoker<ListTrainingExperimentsResponse> ListTrainingExperimentsInvoker(ListTrainingExperimentsRequest listTrainingExperimentsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiments", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTrainingExperimentsRequest);
            return new SyncInvoker<ListTrainingExperimentsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTrainingExperimentsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTrainingJobEventsResponse ListTrainingJobEvents(ListTrainingJobEventsRequest listTrainingJobEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListTrainingJobEventsResponse> ListTrainingJobEventsInvoker(ListTrainingJobEventsRequest listTrainingJobEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listTrainingJobEventsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTrainingJobEventsRequest);
            return new SyncInvoker<ListTrainingJobEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTrainingJobEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTrainingJobStagesResponse ListTrainingJobStages(ListTrainingJobStagesRequest listTrainingJobStagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListTrainingJobStagesResponse> ListTrainingJobStagesInvoker(ListTrainingJobStagesRequest listTrainingJobStagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listTrainingJobStagesRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/stages", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTrainingJobStagesRequest);
            return new SyncInvoker<ListTrainingJobStagesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTrainingJobStagesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTrainingJobTasksResponse ListTrainingJobTasks(ListTrainingJobTasksRequest listTrainingJobTasksRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListTrainingJobTasksResponse> ListTrainingJobTasksInvoker(ListTrainingJobTasksRequest listTrainingJobTasksRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listTrainingJobTasksRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTrainingJobTasksRequest);
            return new SyncInvoker<ListTrainingJobTasksResponse>(this, "GET", request, response =>
            {
                var listTrainingJobTasksResponse = JsonUtils.DeSerializeNull<ListTrainingJobTasksResponse>(response);
                listTrainingJobTasksResponse.Body = JsonUtils.DeSerializeList<TaskHistory>(response);
                return listTrainingJobTasksResponse;
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTrainingJobsResponse ListTrainingJobs(ListTrainingJobsRequest listTrainingJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListTrainingJobsResponse> ListTrainingJobsInvoker(ListTrainingJobsRequest listTrainingJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-job-searches", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", listTrainingJobsRequest);
        ...
        public SyncInvoker<ListWorkloadsResponse> ListWorkloadsInvoker(ListWorkloadsRequest listWorkloadsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listWorkloadsRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/workloads", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listWorkloadsRequest);
            return new SyncInvoker<ListWorkloadsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListWorkloadsResponse>);
        }
        ...
        public SyncInvoker<ListWorkspaceResponse> ListWorkspaceInvoker(ListWorkspaceRequest listWorkspaceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listWorkspaceRequest);
            return new SyncInvoker<ListWorkspaceResponse>(this, "GET", request, JsonUtils.DeSerialize<ListWorkspaceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ModifyInferIntranetConnectionsResponse ModifyInferIntranetConnections(ModifyInferIntranetConnectionsRequest modifyInferIntranetConnectionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ModifyInferIntranetConnectionsResponse> ModifyInferIntranetConnectionsInvoker(ModifyInferIntranetConnectionsRequest modifyInferIntranetConnectionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyInferIntranetConnectionsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/intranet-connection/{id}/modify", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public NotifyTrainingJobInformationResponse NotifyTrainingJobInformation(NotifyTrainingJobInformationRequest notifyTrainingJobInformationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<NotifyTrainingJobInformationResponse> NotifyTrainingJobInformationInvoker(NotifyTrainingJobInformationRequest notifyTrainingJobInformationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(notifyTrainingJobInformationRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(notifyTrainingJobInformationRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/tasks/{task_id}/reports/{report_type}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", notifyTrainingJobInformationRequest);
            return new SyncInvoker<NotifyTrainingJobInformationResponse>(this, "POST", request, JsonUtils.DeSerializeNull<NotifyTrainingJobInformationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public PatchNetworkResponse PatchNetwork(PatchNetworkRequest patchNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<PatchNetworkResponse> PatchNetworkInvoker(PatchNetworkRequest patchNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(patchNetworkRequest.NetworkName, out var valueOfNetworkName)) urlParam.Add("network_name", valueOfNetworkName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/networks/{network_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", patchNetworkRequest);
            return new SyncInvoker<PatchNetworkResponse>(this, "PATCH", request, JsonUtils.DeSerialize<PatchNetworkResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public PatchNodePoolResponse PatchNodePool(PatchNodePoolRequest patchNodePoolRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<PatchNodePoolResponse> PatchNodePoolInvoker(PatchNodePoolRequest patchNodePoolRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(patchNodePoolRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            if (StringUtils.TryConvertToNonEmptyString(patchNodePoolRequest.NodepoolName, out var valueOfNodepoolName)) urlParam.Add("nodepool_name", valueOfNodepoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodepools/{nodepool_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", patchNodePoolRequest);
            return new SyncInvoker<PatchNodePoolResponse>(this, "PATCH", request, JsonUtils.DeSerialize<PatchNodePoolResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public PatchPoolResponse PatchPool(PatchPoolRequest patchPoolRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<PatchPoolResponse> PatchPoolInvoker(PatchPoolRequest patchPoolRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(patchPoolRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public QueryHyperinstanceTagsResponse QueryHyperinstanceTags(QueryHyperinstanceTagsRequest queryHyperinstanceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<QueryHyperinstanceTagsResponse> QueryHyperinstanceTagsInvoker(QueryHyperinstanceTagsRequest queryHyperinstanceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(queryHyperinstanceTagsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", queryHyperinstanceTagsRequest);
            return new SyncInvoker<QueryHyperinstanceTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<QueryHyperinstanceTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RebootDevServerResponse RebootDevServer(RebootDevServerRequest rebootDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<RebootDevServerResponse> RebootDevServerInvoker(RebootDevServerRequest rebootDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(rebootDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/reboot", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", rebootDevServerRequest);
            return new SyncInvoker<RebootDevServerResponse>(this, "PUT", request, JsonUtils.DeSerialize<RebootDevServerResponse>);
        }
        ...
        public SyncInvoker<RegisterImageResponse> RegisterImageInvoker(RegisterImageRequest registerImageRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", registerImageRequest);
            return new SyncInvoker<RegisterImageResponse>(this, "POST", request, JsonUtils.DeSerialize<RegisterImageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ReinstallDevServerOSResponse ReinstallDevServerOS(ReinstallDevServerOSRequest reinstallDevServerOSRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ReinstallDevServerOSResponse> ReinstallDevServerOSInvoker(ReinstallDevServerOSRequest reinstallDevServerOSRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(reinstallDevServerOSRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/reinstallos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", reinstallDevServerOSRequest);
            return new SyncInvoker<ReinstallDevServerOSResponse>(this, "POST", request, JsonUtils.DeSerialize<ReinstallDevServerOSResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ScaleDownHyperinstanceResponse ScaleDownHyperinstance(ScaleDownHyperinstanceRequest scaleDownHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ScaleDownHyperinstanceResponse> ScaleDownHyperinstanceInvoker(ScaleDownHyperinstanceRequest scaleDownHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(scaleDownHyperinstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/live-scale-down", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", scaleDownHyperinstanceRequest);
            return new SyncInvoker<ScaleDownHyperinstanceResponse>(this, "POST", request, JsonUtils.DeSerialize<ScaleDownHyperinstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ScaleUpHyperinstanceResponse ScaleUpHyperinstance(ScaleUpHyperinstanceRequest scaleUpHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ScaleUpHyperinstanceResponse> ScaleUpHyperinstanceInvoker(ScaleUpHyperinstanceRequest scaleUpHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(scaleUpHyperinstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/live-scale-up", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", scaleUpHyperinstanceRequest);
            return new SyncInvoker<ScaleUpHyperinstanceResponse>(this, "POST", request, JsonUtils.DeSerialize<ScaleUpHyperinstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAlgorithmByUuidResponse ShowAlgorithmByUuid(ShowAlgorithmByUuidRequest showAlgorithmByUuidRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAlgorithmByUuidResponse> ShowAlgorithmByUuidInvoker(ShowAlgorithmByUuidRequest showAlgorithmByUuidRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAlgorithmByUuidRequest.AlgorithmId, out var valueOfAlgorithmId)) urlParam.Add("algorithm_id", valueOfAlgorithmId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/algorithms/{algorithm_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAlgorithmByUuidRequest);
            return new SyncInvoker<ShowAlgorithmByUuidResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAlgorithmByUuidResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAuthmodeDetailResponse ShowAuthmodeDetail(ShowAuthmodeDetailRequest showAuthmodeDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAuthmodeDetailResponse> ShowAuthmodeDetailInvoker(ShowAuthmodeDetailRequest showAuthmodeDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/auth-mode", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAuthmodeDetailRequest);
            return new SyncInvoker<ShowAuthmodeDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAuthmodeDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchParamAnalysisResultPathResponse ShowAutoSearchParamAnalysisResultPath(ShowAutoSearchParamAnalysisResultPathRequest showAutoSearchParamAnalysisResultPathRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchParamAnalysisResultPathResponse> ShowAutoSearchParamAnalysisResultPathInvoker(ShowAutoSearchParamAnalysisResultPathRequest showAutoSearchParamAnalysisResultPathRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchParamAnalysisResultPathRequest.ParameterName, out var valueOfParameterName)) urlParam.Add("parameter_name", valueOfParameterName);
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchParamAnalysisResultPathRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/autosearch-parameter-analysis/{parameter_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchParamAnalysisResultPathRequest);
            return new SyncInvoker<ShowAutoSearchParamAnalysisResultPathResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSearchParamAnalysisResultPathResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchParamsAnalysisResponse ShowAutoSearchParamsAnalysis(ShowAutoSearchParamsAnalysisRequest showAutoSearchParamsAnalysisRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchParamsAnalysisResponse> ShowAutoSearchParamsAnalysisInvoker(ShowAutoSearchParamsAnalysisRequest showAutoSearchParamsAnalysisRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchParamsAnalysisRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/autosearch-parameter-analysis", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchParamsAnalysisRequest);
            return new SyncInvoker<ShowAutoSearchParamsAnalysisResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSearchParamsAnalysisResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchPerTrialResponse ShowAutoSearchPerTrial(ShowAutoSearchPerTrialRequest showAutoSearchPerTrialRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchPerTrialResponse> ShowAutoSearchPerTrialInvoker(ShowAutoSearchPerTrialRequest showAutoSearchPerTrialRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchPerTrialRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchPerTrialRequest.TrialId, out var valueOfTrialId)) urlParam.Add("trial_id", valueOfTrialId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/autosearch-trials/{trial_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchPerTrialRequest);
            return new SyncInvoker<ShowAutoSearchPerTrialResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSearchPerTrialResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchTrialEarlyStopResponse ShowAutoSearchTrialEarlyStop(ShowAutoSearchTrialEarlyStopRequest showAutoSearchTrialEarlyStopRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchTrialEarlyStopResponse> ShowAutoSearchTrialEarlyStopInvoker(ShowAutoSearchTrialEarlyStopRequest showAutoSearchTrialEarlyStopRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchTrialEarlyStopRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchTrialEarlyStopRequest.TrialId, out var valueOfTrialId)) urlParam.Add("trial_id", valueOfTrialId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/autosearch-trial-earlystop/{trial_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchTrialEarlyStopRequest);
            return new SyncInvoker<ShowAutoSearchTrialEarlyStopResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowAutoSearchTrialEarlyStopResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchTrialsResponse ShowAutoSearchTrials(ShowAutoSearchTrialsRequest showAutoSearchTrialsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchTrialsResponse> ShowAutoSearchTrialsInvoker(ShowAutoSearchTrialsRequest showAutoSearchTrialsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchTrialsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/autosearch-trials", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchTrialsRequest);
            return new SyncInvoker<ShowAutoSearchTrialsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSearchTrialsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchYamlTemplateContentResponse ShowAutoSearchYamlTemplateContent(ShowAutoSearchYamlTemplateContentRequest showAutoSearchYamlTemplateContentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchYamlTemplateContentResponse> ShowAutoSearchYamlTemplateContentInvoker(ShowAutoSearchYamlTemplateContentRequest showAutoSearchYamlTemplateContentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchYamlTemplateContentRequest.AlgorithmType, out var valueOfAlgorithmType)) urlParam.Add("algorithm_type", valueOfAlgorithmType);
            if (StringUtils.TryConvertToNonEmptyString(showAutoSearchYamlTemplateContentRequest.AlgorithmName, out var valueOfAlgorithmName)) urlParam.Add("algorithm_name", valueOfAlgorithmName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/autosearch/yaml-templates/{algorithm_type}/{algorithm_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchYamlTemplateContentRequest);
            return new SyncInvoker<ShowAutoSearchYamlTemplateContentResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSearchYamlTemplateContentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSearchYamlTemplatesInfoResponse ShowAutoSearchYamlTemplatesInfo(ShowAutoSearchYamlTemplatesInfoRequest showAutoSearchYamlTemplatesInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSearchYamlTemplatesInfoResponse> ShowAutoSearchYamlTemplatesInfoInvoker(ShowAutoSearchYamlTemplatesInfoRequest showAutoSearchYamlTemplatesInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/autosearch/yaml-templates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSearchYamlTemplatesInfoRequest);
            return new SyncInvoker<ShowAutoSearchYamlTemplatesInfoResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSearchYamlTemplatesInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowDevServerResponse ShowDevServer(ShowDevServerRequest showDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowDevServerResponse> ShowDevServerInvoker(ShowDevServerRequest showDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDevServerRequest);
            return new SyncInvoker<ShowDevServerResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowDynamicStorageResponse ShowDynamicStorage(ShowDynamicStorageRequest showDynamicStorageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowDynamicStorageResponse> ShowDynamicStorageInvoker(ShowDynamicStorageRequest showDynamicStorageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDynamicStorageRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showDynamicStorageRequest.StorageId, out var valueOfStorageId)) urlParam.Add("storage_id", valueOfStorageId);
        ...
        public SyncInvoker<ShowImageResponse> ShowImageInvoker(ShowImageRequest showImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showImageRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showImageRequest);
            return new SyncInvoker<ShowImageResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowImageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferDeploymentResponse ShowInferDeployment(ShowInferDeploymentRequest showInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferDeploymentResponse> ShowInferDeploymentInvoker(ShowInferDeploymentRequest showInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(showInferDeploymentRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferDeploymentRequest);
            return new SyncInvoker<ShowInferDeploymentResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferDeploymentVersionResponse ShowInferDeploymentVersion(ShowInferDeploymentVersionRequest showInferDeploymentVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferDeploymentVersionResponse> ShowInferDeploymentVersionInvoker(ShowInferDeploymentVersionRequest showInferDeploymentVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferDeploymentVersionRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(showInferDeploymentVersionRequest.Version, out var valueOfVersion)) urlParam.Add("version", valueOfVersion);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/versions/{version}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferDeploymentVersionRequest);
            return new SyncInvoker<ShowInferDeploymentVersionResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferDeploymentVersionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferServiceResponse ShowInferService(ShowInferServiceRequest showInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferServiceResponse> ShowInferServiceInvoker(ShowInferServiceRequest showInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferServiceRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferServiceRequest);
            return new SyncInvoker<ShowInferServiceResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferServiceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferServiceClusterResponse ShowInferServiceCluster(ShowInferServiceClusterRequest showInferServiceClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferServiceClusterResponse> ShowInferServiceClusterInvoker(ShowInferServiceClusterRequest showInferServiceClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferServiceClusterRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/clusters/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferServiceClusterRequest);
            return new SyncInvoker<ShowInferServiceClusterResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferServiceClusterResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferServiceTagsResponse ShowInferServiceTags(ShowInferServiceTagsRequest showInferServiceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferServiceTagsResponse> ShowInferServiceTagsInvoker(ShowInferServiceTagsRequest showInferServiceTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferServiceTagsRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-service-v2/{resource_id}/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferServiceTagsRequest);
            return new SyncInvoker<ShowInferServiceTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferServiceTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowNetworkResponse ShowNetwork(ShowNetworkRequest showNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowNetworkResponse> ShowNetworkInvoker(ShowNetworkRequest showNetworkRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showNetworkRequest.NetworkName, out var valueOfNetworkName)) urlParam.Add("network_name", valueOfNetworkName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/networks/{network_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showNetworkRequest);
            return new SyncInvoker<ShowNetworkResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowNetworkResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowNetworkAvailableIpResponse ShowNetworkAvailableIp(ShowNetworkAvailableIpRequest showNetworkAvailableIpRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowNetworkAvailableIpResponse> ShowNetworkAvailableIpInvoker(ShowNetworkAvailableIpRequest showNetworkAvailableIpRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showNetworkAvailableIpRequest.NetworkName, out var valueOfNetworkName)) urlParam.Add("network_name", valueOfNetworkName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/networks/{network_name}/network-ip-availabilities", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showNetworkAvailableIpRequest);
            return new SyncInvoker<ShowNetworkAvailableIpResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowNetworkAvailableIpResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowNodeConfigTemplateResponse ShowNodeConfigTemplate(ShowNodeConfigTemplateRequest showNodeConfigTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowNodeConfigTemplateResponse> ShowNodeConfigTemplateInvoker(ShowNodeConfigTemplateRequest showNodeConfigTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showNodeConfigTemplateRequest.NodeconfigtemplateName, out var valueOfNodeconfigtemplateName)) urlParam.Add("nodeconfigtemplate_name", valueOfNodeconfigtemplateName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/nodeconfigtemplates/{nodeconfigtemplate_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showNodeConfigTemplateRequest);
            return new SyncInvoker<ShowNodeConfigTemplateResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowNodeConfigTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowObsUrlOfTrainingJobLogsResponse ShowObsUrlOfTrainingJobLogs(ShowObsUrlOfTrainingJobLogsRequest showObsUrlOfTrainingJobLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowObsUrlOfTrainingJobLogsResponse> ShowObsUrlOfTrainingJobLogsInvoker(ShowObsUrlOfTrainingJobLogsRequest showObsUrlOfTrainingJobLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showObsUrlOfTrainingJobLogsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showObsUrlOfTrainingJobLogsRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/tasks/{task_id}/logs/url", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showObsUrlOfTrainingJobLogsRequest);
            return new SyncInvoker<ShowObsUrlOfTrainingJobLogsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowObsUrlOfTrainingJobLogsResponse>);
        }
        ...
        public SyncInvoker<ShowOrderResponse> ShowOrderInvoker(ShowOrderRequest showOrderRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showOrderRequest.OrderName, out var valueOfOrderName)) urlParam.Add("order_name", valueOfOrderName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/orders/{order_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showOrderRequest);
            return new SyncInvoker<ShowOrderResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowOrderResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowOsConfigResponse ShowOsConfig(ShowOsConfigRequest showOsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowOsConfigResponse> ShowOsConfigInvoker(ShowOsConfigRequest showOsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/os-user-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showOsConfigRequest);
            return new SyncInvoker<ShowOsConfigResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowOsConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowOsQuotaResponse ShowOsQuota(ShowOsQuotaRequest showOsQuotaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowOsQuotaResponse> ShowOsQuotaInvoker(ShowOsQuotaRequest showOsQuotaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/quotas", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showOsQuotaRequest);
            return new SyncInvoker<ShowOsQuotaResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowOsQuotaResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPluginTemplateResponse ShowPluginTemplate(ShowPluginTemplateRequest showPluginTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPluginTemplateResponse> ShowPluginTemplateInvoker(ShowPluginTemplateRequest showPluginTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showPluginTemplateRequest.PlugintemplateName, out var valueOfPlugintemplateName)) urlParam.Add("plugintemplate_name", valueOfPlugintemplateName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/plugintemplates/{plugintemplate_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPluginTemplateRequest);
            return new SyncInvoker<ShowPluginTemplateResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPluginTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolMonitorResponse ShowPoolMonitor(ShowPoolMonitorRequest showPoolMonitorRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolMonitorResponse> ShowPoolMonitorInvoker(ShowPoolMonitorRequest showPoolMonitorRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showPoolMonitorRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/monitor", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolMonitorRequest);
            return new SyncInvoker<ShowPoolMonitorResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolMonitorResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolNodeResponse ShowPoolNode(ShowPoolNodeRequest showPoolNodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolNodeResponse> ShowPoolNodeInvoker(ShowPoolNodeRequest showPoolNodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showPoolNodeRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            if (StringUtils.TryConvertToNonEmptyString(showPoolNodeRequest.NodeName, out var valueOfNodeName)) urlParam.Add("node_name", valueOfNodeName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/{node_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolNodeRequest);
            return new SyncInvoker<ShowPoolNodeResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolNodeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolNodeConfigResponse ShowPoolNodeConfig(ShowPoolNodeConfigRequest showPoolNodeConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolNodeConfigResponse> ShowPoolNodeConfigInvoker(ShowPoolNodeConfigRequest showPoolNodeConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showPoolNodeConfigRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/node-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolNodeConfigRequest);
            return new SyncInvoker<ShowPoolNodeConfigResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolNodeConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolNodeConfigTemplateResponse ShowPoolNodeConfigTemplate(ShowPoolNodeConfigTemplateRequest showPoolNodeConfigTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolNodeConfigTemplateResponse> ShowPoolNodeConfigTemplateInvoker(ShowPoolNodeConfigTemplateRequest showPoolNodeConfigTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showPoolNodeConfigTemplateRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/node-config-template", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolNodeConfigTemplateRequest);
            return new SyncInvoker<ShowPoolNodeConfigTemplateResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolNodeConfigTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolRuntimeMetricsResponse ShowPoolRuntimeMetrics(ShowPoolRuntimeMetricsRequest showPoolRuntimeMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolRuntimeMetricsResponse> ShowPoolRuntimeMetricsInvoker(ShowPoolRuntimeMetricsRequest showPoolRuntimeMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/metrics/runtime/pools", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolRuntimeMetricsRequest);
            return new SyncInvoker<ShowPoolRuntimeMetricsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolRuntimeMetricsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolStatisticsResponse ShowPoolStatistics(ShowPoolStatisticsRequest showPoolStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolStatisticsResponse> ShowPoolStatisticsInvoker(ShowPoolStatisticsRequest showPoolStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/statistics/pools", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolStatisticsRequest);
            return new SyncInvoker<ShowPoolStatisticsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolStatisticsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPoolTagsResponse ShowPoolTags(ShowPoolTagsRequest showPoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPoolTagsResponse> ShowPoolTagsInvoker(ShowPoolTagsRequest showPoolTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showPoolTagsRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/pools/{pool_name}/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPoolTagsRequest);
            return new SyncInvoker<ShowPoolTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPoolTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSaveImageJobResponse ShowSaveImageJob(ShowSaveImageJobRequest showSaveImageJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSaveImageJobResponse> ShowSaveImageJobInvoker(ShowSaveImageJobRequest showSaveImageJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSaveImageJobRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showSaveImageJobRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/tasks/{task_id}/save-image-job", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSaveImageJobRequest);
            return new SyncInvoker<ShowSaveImageJobResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSaveImageJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSearchAlgorithmsResponse ShowSearchAlgorithms(ShowSearchAlgorithmsRequest showSearchAlgorithmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSearchAlgorithmsResponse> ShowSearchAlgorithmsInvoker(ShowSearchAlgorithmsRequest showSearchAlgorithmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/search-algorithms", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSearchAlgorithmsRequest);
            return new SyncInvoker<ShowSearchAlgorithmsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSearchAlgorithmsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainJobTagsResponse ShowTrainJobTags(ShowTrainJobTagsRequest showTrainJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainJobTagsResponse> ShowTrainJobTagsInvoker(ShowTrainJobTagsRequest showTrainJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainJobTagsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-training-job/{training_job_id}/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainJobTagsRequest);
            return new SyncInvoker<ShowTrainJobTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainJobTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingExperimentDetailsResponse ShowTrainingExperimentDetails(ShowTrainingExperimentDetailsRequest showTrainingExperimentDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainingExperimentDetailsResponse> ShowTrainingExperimentDetailsInvoker(ShowTrainingExperimentDetailsRequest showTrainingExperimentDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainingExperimentDetailsRequest.ExperimentId, out var valueOfExperimentId)) urlParam.Add("experiment_id", valueOfExperimentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-experiments/{experiment_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingExperimentDetailsRequest);
            return new SyncInvoker<ShowTrainingExperimentDetailsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingExperimentDetailsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingJobDetailsResponse ShowTrainingJobDetails(ShowTrainingJobDetailsRequest showTrainingJobDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainingJobDetailsResponse> ShowTrainingJobDetailsInvoker(ShowTrainingJobDetailsRequest showTrainingJobDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobDetailsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingJobDetailsRequest);
            return new SyncInvoker<ShowTrainingJobDetailsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingJobDetailsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingJobEnginesResponse ShowTrainingJobEngines(ShowTrainingJobEnginesRequest showTrainingJobEnginesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainingJobEnginesResponse> ShowTrainingJobEnginesInvoker(ShowTrainingJobEnginesRequest showTrainingJobEnginesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-job-engines", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingJobEnginesRequest);
            return new SyncInvoker<ShowTrainingJobEnginesResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingJobEnginesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingJobFlavorsResponse ShowTrainingJobFlavors(ShowTrainingJobFlavorsRequest showTrainingJobFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainingJobFlavorsResponse> ShowTrainingJobFlavorsInvoker(ShowTrainingJobFlavorsRequest showTrainingJobFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-job-flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingJobFlavorsRequest);
            return new SyncInvoker<ShowTrainingJobFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingJobFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingJobLogsPreviewResponse ShowTrainingJobLogsPreview(ShowTrainingJobLogsPreviewRequest showTrainingJobLogsPreviewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainingJobLogsPreviewResponse> ShowTrainingJobLogsPreviewInvoker(ShowTrainingJobLogsPreviewRequest showTrainingJobLogsPreviewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobLogsPreviewRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobLogsPreviewRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/tasks/{task_id}/logs/preview", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingJobLogsPreviewRequest);
            return new SyncInvoker<ShowTrainingJobLogsPreviewResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingJobLogsPreviewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingJobMetricsResponse ShowTrainingJobMetrics(ShowTrainingJobMetricsRequest showTrainingJobMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTrainingJobMetricsResponse> ShowTrainingJobMetricsInvoker(ShowTrainingJobMetricsRequest showTrainingJobMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobMetricsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobMetricsRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTrainingQuotasResponse ShowTrainingQuotas(ShowTrainingQuotasRequest showTrainingQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-quotas", urlParam);
        ...
        public SyncInvoker<ShowTrainingQuotasResponse> ShowTrainingQuotasInvoker(ShowTrainingQuotasRequest showTrainingQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-quotas", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingQuotasRequest);
            return new SyncInvoker<ShowTrainingQuotasResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingQuotasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkloadStatisticsResponse ShowWorkloadStatistics(ShowWorkloadStatisticsRequest showWorkloadStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkloadStatisticsResponse> ShowWorkloadStatisticsInvoker(ShowWorkloadStatisticsRequest showWorkloadStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkloadStatisticsRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/statistics/pools/{pool_name}/workloads", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkloadStatisticsRequest);
            return new SyncInvoker<ShowWorkloadStatisticsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkloadStatisticsResponse>);
        }
        ...
        public SyncInvoker<ShowWorkspaceResponse> ShowWorkspaceInvoker(ShowWorkspaceRequest showWorkspaceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkspaceRequest.WorkspaceId, out var valueOfWorkspaceId)) urlParam.Add("workspace_id", valueOfWorkspaceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces/{workspace_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkspaceRequest);
            return new SyncInvoker<ShowWorkspaceResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkspaceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkspaceQuotasResponse ShowWorkspaceQuotas(ShowWorkspaceQuotasRequest showWorkspaceQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkspaceQuotasResponse> ShowWorkspaceQuotasInvoker(ShowWorkspaceQuotasRequest showWorkspaceQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkspaceQuotasRequest.WorkspaceId, out var valueOfWorkspaceId)) urlParam.Add("workspace_id", valueOfWorkspaceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces/{workspace_id}/quotas", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkspaceQuotasRequest);
            return new SyncInvoker<ShowWorkspaceQuotasResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkspaceQuotasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StartDevServerResponse StartDevServer(StartDevServerRequest startDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StartDevServerResponse> StartDevServerInvoker(StartDevServerRequest startDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/start", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", startDevServerRequest);
            return new SyncInvoker<StartDevServerResponse>(this, "PUT", request, JsonUtils.DeSerialize<StartDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StartHyperinstanceResponse StartHyperinstance(StartHyperinstanceRequest startHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StartHyperinstanceResponse> StartHyperinstanceInvoker(StartHyperinstanceRequest startHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startHyperinstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/start", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", startHyperinstanceRequest);
            return new SyncInvoker<StartHyperinstanceResponse>(this, "PUT", request, JsonUtils.DeSerialize<StartHyperinstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StartInferDeploymentResponse StartInferDeployment(StartInferDeploymentRequest startInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StartInferDeploymentResponse> StartInferDeploymentInvoker(StartInferDeploymentRequest startInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(startInferDeploymentRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/start", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", startInferDeploymentRequest);
            return new SyncInvoker<StartInferDeploymentResponse>(this, "POST", request, JsonUtils.DeSerialize<StartInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StartInferServiceResponse StartInferService(StartInferServiceRequest startInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StartInferServiceResponse> StartInferServiceInvoker(StartInferServiceRequest startInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startInferServiceRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/start", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", startInferServiceRequest);
            return new SyncInvoker<StartInferServiceResponse>(this, "POST", request, JsonUtils.DeSerialize<StartInferServiceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopDevServerResponse StopDevServer(StopDevServerRequest stopDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopDevServerResponse> StopDevServerInvoker(StopDevServerRequest stopDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", stopDevServerRequest);
            return new SyncInvoker<StopDevServerResponse>(this, "PUT", request, JsonUtils.DeSerialize<StopDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopHyperinstanceResponse StopHyperinstance(StopHyperinstanceRequest stopHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopHyperinstanceResponse> StopHyperinstanceInvoker(StopHyperinstanceRequest stopHyperinstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopHyperinstanceRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/hyperinstance/{id}/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", stopHyperinstanceRequest);
            return new SyncInvoker<StopHyperinstanceResponse>(this, "PUT", request, JsonUtils.DeSerialize<StopHyperinstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopInferDeploymentResponse StopInferDeployment(StopInferDeploymentRequest stopInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopInferDeploymentResponse> StopInferDeploymentInvoker(StopInferDeploymentRequest stopInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(stopInferDeploymentRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", stopInferDeploymentRequest);
            return new SyncInvoker<StopInferDeploymentResponse>(this, "POST", request, JsonUtils.DeSerialize<StopInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopInferServiceResponse StopInferService(StopInferServiceRequest stopInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopInferServiceResponse> StopInferServiceInvoker(StopInferServiceRequest stopInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopInferServiceRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", stopInferServiceRequest);
            return new SyncInvoker<StopInferServiceResponse>(this, "POST", request, JsonUtils.DeSerialize<StopInferServiceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopTrainingJobResponse StopTrainingJob(StopTrainingJobRequest stopTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopTrainingJobResponse> StopTrainingJobInvoker(StopTrainingJobRequest stopTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopTrainingJobRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/actions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", stopTrainingJobRequest);
            return new SyncInvoker<StopTrainingJobResponse>(this, "POST", request, JsonUtils.DeSerialize<StopTrainingJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SwitchInferDeploymentVersionResponse SwitchInferDeploymentVersion(SwitchInferDeploymentVersionRequest switchInferDeploymentVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SwitchInferDeploymentVersionResponse> SwitchInferDeploymentVersionInvoker(SwitchInferDeploymentVersionRequest switchInferDeploymentVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchInferDeploymentVersionRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(switchInferDeploymentVersionRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/versions/{version}/switch", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", switchInferDeploymentVersionRequest);
            return new SyncInvoker<SwitchInferDeploymentVersionResponse>(this, "POST", request, JsonUtils.DeSerialize<SwitchInferDeploymentVersionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SyncDevServersResponse SyncDevServers(SyncDevServersRequest syncDevServersRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SyncDevServersResponse> SyncDevServersInvoker(SyncDevServersRequest syncDevServersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/sync", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", syncDevServersRequest);
            return new SyncInvoker<SyncDevServersResponse>(this, "PUT", request, JsonUtils.DeSerialize<SyncDevServersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SyncImageResponse SyncImage(SyncImageRequest syncImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SyncImageResponse> SyncImageInvoker(SyncImageRequest syncImageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(syncImageRequest.ImageId, out var valueOfImageId)) urlParam.Add("image_id", valueOfImageId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images/{image_id}/sync", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", syncImageRequest);
            return new SyncInvoker<SyncImageResponse>(this, "POST", request, JsonUtils.DeSerialize<SyncImageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UnbindInferApiKeyResponse UnbindInferApiKey(UnbindInferApiKeyRequest unbindInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UnbindInferApiKeyResponse> UnbindInferApiKeyInvoker(UnbindInferApiKeyRequest unbindInferApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(unbindInferApiKeyRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(unbindInferApiKeyRequest.KeyId, out var valueOfKeyId)) urlParam.Add("key_id", valueOfKeyId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/api-keys/{key_id}/unbind", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", unbindInferApiKeyRequest);
            return new SyncInvoker<UnbindInferApiKeyResponse>(this, "POST", request, JsonUtils.DeSerialize<UnbindInferApiKeyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateAuthModeResponse UpdateAuthMode(UpdateAuthModeRequest updateAuthModeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/auth-mode", urlParam);
        ...
        public SyncInvoker<UpdateAuthModeResponse> UpdateAuthModeInvoker(UpdateAuthModeRequest updateAuthModeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/auth-mode", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateAuthModeRequest);
            return new SyncInvoker<UpdateAuthModeResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateAuthModeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateDevServerResponse UpdateDevServer(UpdateDevServerRequest updateDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateDevServerResponse> UpdateDevServerInvoker(UpdateDevServerRequest updateDevServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDevServerRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateDevServerRequest);
            return new SyncInvoker<UpdateDevServerResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateDevServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateImageGroupResponse UpdateImageGroup(UpdateImageGroupRequest updateImageGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateImageGroupResponse> UpdateImageGroupInvoker(UpdateImageGroupRequest updateImageGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateImageGroupRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/images/group/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateImageGroupRequest);
            return new SyncInvoker<UpdateImageGroupResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateImageGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateInferDeploymentResponse UpdateInferDeployment(UpdateInferDeploymentRequest updateInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateInferDeploymentResponse> UpdateInferDeploymentInvoker(UpdateInferDeploymentRequest updateInferDeploymentRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInferDeploymentRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(updateInferDeploymentRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateInferDeploymentRequest);
            return new SyncInvoker<UpdateInferDeploymentResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateInferDeploymentResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateInferDeploymentScaleResponse UpdateInferDeploymentScale(UpdateInferDeploymentScaleRequest updateInferDeploymentScaleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateInferDeploymentScaleResponse> UpdateInferDeploymentScaleInvoker(UpdateInferDeploymentScaleRequest updateInferDeploymentScaleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInferDeploymentScaleRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(updateInferDeploymentScaleRequest.DeploymentName, out var valueOfDeploymentName)) urlParam.Add("deployment_name", valueOfDeploymentName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_name}/scale", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateInferDeploymentScaleRequest);
            return new SyncInvoker<UpdateInferDeploymentScaleResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateInferDeploymentScaleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateInferIntranetConnectionResponse UpdateInferIntranetConnection(UpdateInferIntranetConnectionRequest updateInferIntranetConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateInferIntranetConnectionResponse> UpdateInferIntranetConnectionInvoker(UpdateInferIntranetConnectionRequest updateInferIntranetConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInferIntranetConnectionRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/intranet-connection/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateInferIntranetConnectionRequest);
            return new SyncInvoker<UpdateInferIntranetConnectionResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateInferIntranetConnectionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateInferServiceResponse UpdateInferService(UpdateInferServiceRequest updateInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateInferServiceResponse> UpdateInferServiceInvoker(UpdateInferServiceRequest updateInferServiceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInferServiceRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateInferServiceRequest);
            return new SyncInvoker<UpdateInferServiceResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateInferServiceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateWorkspaceQuotasResponse UpdateWorkspaceQuotas(UpdateWorkspaceQuotasRequest updateWorkspaceQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateWorkspaceQuotasResponse> UpdateWorkspaceQuotasInvoker(UpdateWorkspaceQuotasRequest updateWorkspaceQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateWorkspaceQuotasRequest.WorkspaceId, out var valueOfWorkspaceId)) urlParam.Add("workspace_id", valueOfWorkspaceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces/{workspace_id}/quotas", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateWorkspaceQuotasRequest);
            return new SyncInvoker<UpdateWorkspaceQuotasResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateWorkspaceQuotasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ValidateAuthorizationResponse ValidateAuthorization(ValidateAuthorizationRequest validateAuthorizationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ValidateAuthorizationResponse> ValidateAuthorizationInvoker(ValidateAuthorizationRequest validateAuthorizationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(validateAuthorizationRequest.WorkspaceId, out var valueOfWorkspaceId)) urlParam.Add("workspace_id", valueOfWorkspaceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/workspaces/{workspace_id}/auth", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferDeploymentHpaResponse CreateInferDeploymentHpa(CreateInferDeploymentHpaRequest createInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferDeploymentHpaResponse> CreateInferDeploymentHpaInvoker(CreateInferDeploymentHpaRequest createInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createInferDeploymentHpaRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(createInferDeploymentHpaRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hpa", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createInferDeploymentHpaRequest);
            return new SyncInvoker<CreateInferDeploymentHpaResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferDeploymentHpaResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteInferDeploymentHpaResponse DeleteInferDeploymentHpa(DeleteInferDeploymentHpaRequest deleteInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteInferDeploymentHpaResponse> DeleteInferDeploymentHpaInvoker(DeleteInferDeploymentHpaRequest deleteInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentHpaRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(deleteInferDeploymentHpaRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hpa", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteInferDeploymentHpaRequest);
            return new SyncInvoker<DeleteInferDeploymentHpaResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteInferDeploymentHpaResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInferDeploymentHpaEventsResponse ListInferDeploymentHpaEvents(ListInferDeploymentHpaEventsRequest listInferDeploymentHpaEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInferDeploymentHpaEventsResponse> ListInferDeploymentHpaEventsInvoker(ListInferDeploymentHpaEventsRequest listInferDeploymentHpaEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentHpaEventsRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(listInferDeploymentHpaEventsRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hpa/events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInferDeploymentHpaEventsRequest);
            return new SyncInvoker<ListInferDeploymentHpaEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInferDeploymentHpaEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferDeploymentHpaResponse ShowInferDeploymentHpa(ShowInferDeploymentHpaRequest showInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferDeploymentHpaResponse> ShowInferDeploymentHpaInvoker(ShowInferDeploymentHpaRequest showInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferDeploymentHpaRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(showInferDeploymentHpaRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hpa", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferDeploymentHpaRequest);
            return new SyncInvoker<ShowInferDeploymentHpaResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferDeploymentHpaResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateInferDeploymentHpaResponse UpdateInferDeploymentHpa(UpdateInferDeploymentHpaRequest updateInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateInferDeploymentHpaResponse> UpdateInferDeploymentHpaInvoker(UpdateInferDeploymentHpaRequest updateInferDeploymentHpaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInferDeploymentHpaRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(updateInferDeploymentHpaRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hpa", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateInferDeploymentHpaRequest);
            return new SyncInvoker<UpdateInferDeploymentHpaResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateInferDeploymentHpaResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateInferHraResponse CreateInferHra(CreateInferHraRequest createInferHraRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateInferHraResponse> CreateInferHraInvoker(CreateInferHraRequest createInferHraRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createInferHraRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(createInferHraRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hra", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createInferHraRequest);
            return new SyncInvoker<CreateInferHraResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferHraResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInferHraResponse ShowInferHra(ShowInferHraRequest showInferHraRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowInferHraResponse> ShowInferHraInvoker(ShowInferHraRequest showInferHraRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInferHraRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(showInferHraRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hra", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInferHraRequest);
            return new SyncInvoker<ShowInferHraResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInferHraResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateInferHraResponse UpdateInferHra(UpdateInferHraRequest updateInferHraRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateInferHraResponse> UpdateInferHraInvoker(UpdateInferHraRequest updateInferHraRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInferHraRequest.ServiceId, out var valueOfServiceId)) urlParam.Add("service_id", valueOfServiceId);
            if (StringUtils.TryConvertToNonEmptyString(updateInferHraRequest.DeploymentId, out var valueOfDeploymentId)) urlParam.Add("deployment_id", valueOfDeploymentId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/{service_id}/deployments/{deployment_id}/hra", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateInferHraRequest);
            return new SyncInvoker<UpdateInferHraResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateInferHraResponse>);
        }
        ...
        public SyncInvoker<CreateNotebookResponse> CreateNotebookInvoker(CreateNotebookRequest createNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createNotebookRequest);
            return new SyncInvoker<CreateNotebookResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateNotebookResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateNotebookTagsResponse CreateNotebookTags(CreateNotebookTagsRequest createNotebookTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateNotebookTagsResponse> CreateNotebookTagsInvoker(CreateNotebookTagsRequest createNotebookTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createNotebookTagsRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{resource_id}/tags/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createNotebookTagsRequest);
            return new SyncInvoker<CreateNotebookTagsResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CreateNotebookTagsResponse>);
        }
        ...
        public SyncInvoker<DeleteNotebookResponse> DeleteNotebookInvoker(DeleteNotebookRequest deleteNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteNotebookRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteNotebookRequest);
            return new SyncInvoker<DeleteNotebookResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteNotebookResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteNotebookTagsResponse DeleteNotebookTags(DeleteNotebookTagsRequest deleteNotebookTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteNotebookTagsResponse> DeleteNotebookTagsInvoker(DeleteNotebookTagsRequest deleteNotebookTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteNotebookTagsRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{resource_id}/tags/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteNotebookTagsRequest);
            return new SyncInvoker<DeleteNotebookTagsResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteNotebookTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAllNotebooksResponse ListAllNotebooks(ListAllNotebooksRequest listAllNotebooksRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListAllNotebooksResponse> ListAllNotebooksInvoker(ListAllNotebooksRequest listAllNotebooksRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/all", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAllNotebooksRequest);
            return new SyncInvoker<ListAllNotebooksResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAllNotebooksResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAuthoringClustersResponse ListAuthoringClusters(ListAuthoringClustersRequest listAuthoringClustersRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListAuthoringClustersResponse> ListAuthoringClustersInvoker(ListAuthoringClustersRequest listAuthoringClustersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/authoring/clusters", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAuthoringClustersRequest);
            return new SyncInvoker<ListAuthoringClustersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAuthoringClustersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListNotebooksResponse ListNotebooks(ListNotebooksRequest listNotebooksRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks", urlParam);
        ...
        public SyncInvoker<ListNotebooksResponse> ListNotebooksInvoker(ListNotebooksRequest listNotebooksRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listNotebooksRequest);
            return new SyncInvoker<ListNotebooksResponse>(this, "GET", request, JsonUtils.DeSerialize<ListNotebooksResponse>);
        }
        ...
        public SyncInvoker<RenewLeaseResponse> RenewLeaseInvoker(RenewLeaseRequest renewLeaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(renewLeaseRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}/lease", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", renewLeaseRequest);
            return new SyncInvoker<RenewLeaseResponse>(this, "PATCH", request, JsonUtils.DeSerialize<RenewLeaseResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowLeaseResponse ShowLease(ShowLeaseRequest showLeaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowLeaseResponse> ShowLeaseInvoker(ShowLeaseRequest showLeaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showLeaseRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}/lease", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showLeaseRequest);
            return new SyncInvoker<ShowLeaseResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowLeaseResponse>);
        }
        ...
        public SyncInvoker<ShowNotebookResponse> ShowNotebookInvoker(ShowNotebookRequest showNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showNotebookRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showNotebookRequest);
            return new SyncInvoker<ShowNotebookResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowNotebookResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowNotebookTagsResponse ShowNotebookTags(ShowNotebookTagsRequest showNotebookTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowNotebookTagsResponse> ShowNotebookTagsInvoker(ShowNotebookTagsRequest showNotebookTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showNotebookTagsRequest);
            return new SyncInvoker<ShowNotebookTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowNotebookTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSwitchableFlavorsResponse ShowSwitchableFlavors(ShowSwitchableFlavorsRequest showSwitchableFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSwitchableFlavorsResponse> ShowSwitchableFlavorsInvoker(ShowSwitchableFlavorsRequest showSwitchableFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSwitchableFlavorsRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSwitchableFlavorsRequest);
            return new SyncInvoker<ShowSwitchableFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSwitchableFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StartNotebookResponse StartNotebook(StartNotebookRequest startNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StartNotebookResponse> StartNotebookInvoker(StartNotebookRequest startNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startNotebookRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}/start", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", startNotebookRequest);
            return new SyncInvoker<StartNotebookResponse>(this, "POST", request, JsonUtils.DeSerialize<StartNotebookResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopNotebookResponse StopNotebook(StopNotebookRequest stopNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopNotebookResponse> StopNotebookInvoker(StopNotebookRequest stopNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopNotebookRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", stopNotebookRequest);
            return new SyncInvoker<StopNotebookResponse>(this, "POST", request, JsonUtils.DeSerialize<StopNotebookResponse>);
        }
        ...
        public SyncInvoker<UpdateNotebookResponse> UpdateNotebookInvoker(UpdateNotebookRequest updateNotebookRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateNotebookRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/notebooks/{id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateNotebookRequest);
            return new SyncInvoker<UpdateNotebookResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateNotebookResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowPurchasePoolResponse CreateWorkflowPurchasePool(CreateWorkflowPurchasePoolRequest createWorkflowPurchasePoolRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowPurchasePoolResponse> CreateWorkflowPurchasePoolInvoker(CreateWorkflowPurchasePoolRequest createWorkflowPurchasePoolRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowPurchasePoolRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/service/packages", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowPurchasePoolRequest);
            return new SyncInvoker<CreateWorkflowPurchasePoolResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowPurchasePoolResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowServiceAuthResponse CreateWorkflowServiceAuth(CreateWorkflowServiceAuthRequest createWorkflowServiceAuthRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowServiceAuthResponse> CreateWorkflowServiceAuthInvoker(CreateWorkflowServiceAuthRequest createWorkflowServiceAuthRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/service/auth", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowServiceAuthRequest);
            return new SyncInvoker<CreateWorkflowServiceAuthResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowServiceAuthResponse>);
        }
        ...
        public SyncInvoker<DeleteWorkflowResponse> DeleteWorkflowInvoker(DeleteWorkflowRequest deleteWorkflowRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteWorkflowRequest);
            return new SyncInvoker<DeleteWorkflowResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteWorkflowResponse>);
        }
        ...
        public SyncInvoker<ListWorkflowsResponse> ListWorkflowsInvoker(ListWorkflowsRequest listWorkflowsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listWorkflowsRequest);
            return new SyncInvoker<ListWorkflowsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListWorkflowsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowLabelsResponse ShowWorkflowLabels(ShowWorkflowLabelsRequest showWorkflowLabelsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowLabelsResponse> ShowWorkflowLabelsInvoker(ShowWorkflowLabelsRequest showWorkflowLabelsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/labels", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowLabelsRequest);
            return new SyncInvoker<ShowWorkflowLabelsResponse>(this, "GET", request, response =>
            {
                var showWorkflowLabelsResponse = JsonUtils.DeSerializeNull<ShowWorkflowLabelsResponse>(response);
                showWorkflowLabelsResponse.Body = JsonUtils.DeSerializeList<string>(response);
                return showWorkflowLabelsResponse;
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowsOverviewResponse ShowWorkflowsOverview(ShowWorkflowsOverviewRequest showWorkflowsOverviewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowsOverviewResponse> ShowWorkflowsOverviewInvoker(ShowWorkflowsOverviewRequest showWorkflowsOverviewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/overview", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowsOverviewRequest);
            return new SyncInvoker<ShowWorkflowsOverviewResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkflowsOverviewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowsTodolistResponse ShowWorkflowsTodolist(ShowWorkflowsTodolistRequest showWorkflowsTodolistRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowsTodolistResponse> ShowWorkflowsTodolistInvoker(ShowWorkflowsTodolistRequest showWorkflowsTodolistRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/todolist", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowsTodolistRequest);
            return new SyncInvoker<ShowWorkflowsTodolistResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkflowsTodolistResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowExecutionResponse CreateWorkflowExecution(CreateWorkflowExecutionRequest createWorkflowExecutionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowExecutionResponse> CreateWorkflowExecutionInvoker(CreateWorkflowExecutionRequest createWorkflowExecutionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowExecutionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowExecutionRequest);
            return new SyncInvoker<CreateWorkflowExecutionResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowExecutionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowExecutionsActionsResponse CreateWorkflowExecutionsActions(CreateWorkflowExecutionsActionsRequest createWorkflowExecutionsActionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowExecutionsActionsResponse> CreateWorkflowExecutionsActionsInvoker(CreateWorkflowExecutionsActionsRequest createWorkflowExecutionsActionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowExecutionsActionsRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowExecutionsActionsRequest.ExecutionId, out var valueOfExecutionId)) urlParam.Add("execution_id", valueOfExecutionId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions/{execution_id}/actions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowExecutionsActionsRequest);
            return new SyncInvoker<CreateWorkflowExecutionsActionsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowExecutionsActionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowStepExecutionsActionsResponse CreateWorkflowStepExecutionsActions(CreateWorkflowStepExecutionsActionsRequest createWorkflowStepExecutionsActionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowStepExecutionsActionsResponse> CreateWorkflowStepExecutionsActionsInvoker(CreateWorkflowStepExecutionsActionsRequest createWorkflowStepExecutionsActionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowStepExecutionsActionsRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowStepExecutionsActionsRequest.ExecutionId, out var valueOfExecutionId)) urlParam.Add("execution_id", valueOfExecutionId);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions/{execution_id}/step-executions/{step_execution_id}/actions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowStepExecutionsActionsRequest);
            return new SyncInvoker<CreateWorkflowStepExecutionsActionsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowStepExecutionsActionsResponse>);
        }
        ...
        public SyncInvoker<DeleteWorkflowExecutionResponse> DeleteWorkflowExecutionInvoker(DeleteWorkflowExecutionRequest deleteWorkflowExecutionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowExecutionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowExecutionRequest.ExecutionId, out var valueOfExecutionId)) urlParam.Add("execution_id", valueOfExecutionId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions/{execution_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteWorkflowExecutionRequest);
            return new SyncInvoker<DeleteWorkflowExecutionResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteWorkflowExecutionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListExecutionLabelsResponse ListExecutionLabels(ListExecutionLabelsRequest listExecutionLabelsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListExecutionLabelsResponse> ListExecutionLabelsInvoker(ListExecutionLabelsRequest listExecutionLabelsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listExecutionLabelsRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions/labels", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listExecutionLabelsRequest);
            return new SyncInvoker<ListExecutionLabelsResponse>(this, "GET", request, response =>
            {
                var listExecutionLabelsResponse = JsonUtils.DeSerializeNull<ListExecutionLabelsResponse>(response);
                listExecutionLabelsResponse.Body = JsonUtils.DeSerializeList<string>(response);
                return listExecutionLabelsResponse;
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListWorkflowStepExecutionResponse ListWorkflowStepExecution(ListWorkflowStepExecutionRequest listWorkflowStepExecutionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListWorkflowStepExecutionResponse> ListWorkflowStepExecutionInvoker(ListWorkflowStepExecutionRequest listWorkflowStepExecutionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listWorkflowStepExecutionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/step-executions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listWorkflowStepExecutionRequest);
            return new SyncInvoker<ListWorkflowStepExecutionResponse>(this, "GET", request, JsonUtils.DeSerialize<ListWorkflowStepExecutionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowStepExecutionMetricsResponse ShowWorkflowStepExecutionMetrics(ShowWorkflowStepExecutionMetricsRequest showWorkflowStepExecutionMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowStepExecutionMetricsResponse> ShowWorkflowStepExecutionMetricsInvoker(ShowWorkflowStepExecutionMetricsRequest showWorkflowStepExecutionMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowStepExecutionMetricsRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowStepExecutionMetricsRequest.ExecutionId, out var valueOfExecutionId)) urlParam.Add("execution_id", valueOfExecutionId);
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions/{execution_id}/step-executions/{step_execution_id}/metrics", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowStepExecutionMetricsRequest);
            return new SyncInvoker<ShowWorkflowStepExecutionMetricsResponse>(this, "GET", request, response =>
            {
                var showWorkflowStepExecutionMetricsResponse = JsonUtils.DeSerializeNull<ShowWorkflowStepExecutionMetricsResponse>(response);
                showWorkflowStepExecutionMetricsResponse.Body = JsonUtils.DeSerializeList<WorkflowStepMetric>(response);
                return showWorkflowStepExecutionMetricsResponse;
        ...
        public SyncInvoker<UpdateWorkflowExecutionResponse> UpdateWorkflowExecutionInvoker(UpdateWorkflowExecutionRequest updateWorkflowExecutionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateWorkflowExecutionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(updateWorkflowExecutionRequest.ExecutionId, out var valueOfExecutionId)) urlParam.Add("execution_id", valueOfExecutionId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/executions/{execution_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateWorkflowExecutionRequest);
            return new SyncInvoker<UpdateWorkflowExecutionResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateWorkflowExecutionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowScheduleResponse CreateWorkflowSchedule(CreateWorkflowScheduleRequest createWorkflowScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowScheduleResponse> CreateWorkflowScheduleInvoker(CreateWorkflowScheduleRequest createWorkflowScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowScheduleRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowScheduleRequest);
            return new SyncInvoker<CreateWorkflowScheduleResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowScheduleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteWorkflowScheduleIdResponse DeleteWorkflowScheduleId(DeleteWorkflowScheduleIdRequest deleteWorkflowScheduleIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteWorkflowScheduleIdResponse> DeleteWorkflowScheduleIdInvoker(DeleteWorkflowScheduleIdRequest deleteWorkflowScheduleIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowScheduleIdRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowScheduleIdRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteWorkflowScheduleIdRequest);
            return new SyncInvoker<DeleteWorkflowScheduleIdResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteWorkflowScheduleIdResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowScheduleResponse ShowWorkflowSchedule(ShowWorkflowScheduleRequest showWorkflowScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowScheduleResponse> ShowWorkflowScheduleInvoker(ShowWorkflowScheduleRequest showWorkflowScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowScheduleRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowScheduleRequest);
            return new SyncInvoker<ShowWorkflowScheduleResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkflowScheduleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowScheduleListResponse ShowWorkflowScheduleList(ShowWorkflowScheduleListRequest showWorkflowScheduleListRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowScheduleListResponse> ShowWorkflowScheduleListInvoker(ShowWorkflowScheduleListRequest showWorkflowScheduleListRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowScheduleListRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowScheduleListRequest);
            return new SyncInvoker<ShowWorkflowScheduleListResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkflowScheduleListResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateWorkflowScheduleResponse UpdateWorkflowSchedule(UpdateWorkflowScheduleRequest updateWorkflowScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateWorkflowScheduleResponse> UpdateWorkflowScheduleInvoker(UpdateWorkflowScheduleRequest updateWorkflowScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateWorkflowScheduleRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(updateWorkflowScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateWorkflowScheduleRequest);
            return new SyncInvoker<UpdateWorkflowScheduleResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateWorkflowScheduleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateWorkflowSubscriptionsResponse CreateWorkflowSubscriptions(CreateWorkflowSubscriptionsRequest createWorkflowSubscriptionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateWorkflowSubscriptionsResponse> CreateWorkflowSubscriptionsInvoker(CreateWorkflowSubscriptionsRequest createWorkflowSubscriptionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createWorkflowSubscriptionsRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/subscriptions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createWorkflowSubscriptionsRequest);
            return new SyncInvoker<CreateWorkflowSubscriptionsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateWorkflowSubscriptionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteWorkflowSubscriptionResponse DeleteWorkflowSubscription(DeleteWorkflowSubscriptionRequest deleteWorkflowSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteWorkflowSubscriptionResponse> DeleteWorkflowSubscriptionInvoker(DeleteWorkflowSubscriptionRequest deleteWorkflowSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowSubscriptionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(deleteWorkflowSubscriptionRequest.SubscriptionId, out var valueOfSubscriptionId)) urlParam.Add("subscription_id", valueOfSubscriptionId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/subscriptions/{subscription_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteWorkflowSubscriptionRequest);
            return new SyncInvoker<DeleteWorkflowSubscriptionResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteWorkflowSubscriptionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowWorkflowSubscriptionResponse ShowWorkflowSubscription(ShowWorkflowSubscriptionRequest showWorkflowSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowWorkflowSubscriptionResponse> ShowWorkflowSubscriptionInvoker(ShowWorkflowSubscriptionRequest showWorkflowSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowSubscriptionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            if (StringUtils.TryConvertToNonEmptyString(showWorkflowSubscriptionRequest.SubscriptionId, out var valueOfSubscriptionId)) urlParam.Add("subscription_id", valueOfSubscriptionId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/subscriptions/{subscription_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showWorkflowSubscriptionRequest);
            return new SyncInvoker<ShowWorkflowSubscriptionResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowWorkflowSubscriptionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateWorkflowSubscriptionResponse UpdateWorkflowSubscription(UpdateWorkflowSubscriptionRequest updateWorkflowSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateWorkflowSubscriptionResponse> UpdateWorkflowSubscriptionInvoker(UpdateWorkflowSubscriptionRequest updateWorkflowSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateWorkflowSubscriptionRequest.SubscriptionId, out var valueOfSubscriptionId)) urlParam.Add("subscription_id", valueOfSubscriptionId);
            if (StringUtils.TryConvertToNonEmptyString(updateWorkflowSubscriptionRequest.WorkflowId, out var valueOfWorkflowId)) urlParam.Add("workflow_id", valueOfWorkflowId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workflows/{workflow_id}/subscriptions/{subscription_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateWorkflowSubscriptionRequest);
            return new SyncInvoker<UpdateWorkflowSubscriptionResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateWorkflowSubscriptionResponse>);
        }

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateWorkflowExecutionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateWorkflowExecutionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWorkflowExecutionResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInferServiceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInferServiceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInferServiceResponse input)
        {

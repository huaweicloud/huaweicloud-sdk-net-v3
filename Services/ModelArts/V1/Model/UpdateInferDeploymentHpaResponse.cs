...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInferDeploymentHpaResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInferDeploymentHpaResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInferDeploymentHpaResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class NetworkUpdateRequest 
    {
        ...
        public NetworkMetadataUpdate Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public NetworkSpecUpdate Spec { get; set; }
        ...
        {
            return this.Equals(input as NetworkUpdateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NetworkUpdateRequest input)
        {

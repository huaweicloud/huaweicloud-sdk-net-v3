...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class CreateWorkflowPurchasePoolRequest 
    {
        ...
        public WorkflowServicePackage Body { get; set; }
        ...
        {
            return this.Equals(input as CreateWorkflowPurchasePoolRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkflowPurchasePoolRequest input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateWorkflowScheduleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateWorkflowScheduleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWorkflowScheduleResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class DeleteInferServiceTagRequest 
    {
        ...
        public DeleteInferTmsTagsRequest Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteInferServiceTagRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteInferServiceTagRequest input)
        {

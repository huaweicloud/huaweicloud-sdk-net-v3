...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class WorkflowConditionExecutionResp 
    {
        ...
        public List<WorkflowMetricPairResp> MetricList { get; set; }
        ...
        {
            return this.Equals(input as WorkflowConditionExecutionResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(WorkflowConditionExecutionResp input)
        {

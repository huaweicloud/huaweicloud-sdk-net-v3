...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ReinstallDevServerOSResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ReinstallDevServerOSResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ReinstallDevServerOSResponse input)
        {

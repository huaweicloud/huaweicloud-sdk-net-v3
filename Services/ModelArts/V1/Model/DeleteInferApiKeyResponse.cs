...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteInferApiKeyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteInferApiKeyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteInferApiKeyResponse input)
        {

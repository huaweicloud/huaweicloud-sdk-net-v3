...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWorkflowExecutionsActionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateWorkflowExecutionsActionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkflowExecutionsActionsResponse input)
        {

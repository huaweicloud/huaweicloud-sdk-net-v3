...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class RuntimeConfigResponse 
    {
        ...
        public ServiceInvokeResponse ServiceInvoke { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("service_limit", NullValueHandling = NullValueHandling.Ignore)]
        public ServiceLimitResponse ServiceLimit { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("service_secret", NullValueHandling = NullValueHandling.Ignore)]
        public ServiceSecretResponse ServiceSecret { get; set; }
        ...
        {
            return this.Equals(input as RuntimeConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RuntimeConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferDeploymentsResponse : SdkResponse
    {
        ...
        public List<InferDeploymentItemResponseData> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferDeploymentsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferDeploymentsResponse input)
        {

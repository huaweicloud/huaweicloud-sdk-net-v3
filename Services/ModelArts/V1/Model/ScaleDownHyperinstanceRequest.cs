...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ScaleDownHyperinstanceRequest 
    {
        ...
        public ServerScaleDownRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ScaleDownHyperinstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ScaleDownHyperinstanceRequest input)
        {

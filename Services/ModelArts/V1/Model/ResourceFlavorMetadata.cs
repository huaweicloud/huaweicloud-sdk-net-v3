...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ResourceFlavorMetadata 
    {
        ...
        public ResourceFlavorLabel Labels { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("annotations", NullValueHandling = NullValueHandling.Ignore)]
        public ResourceFlavorAnnotation Annotations { get; set; }
        ...
        {
            return this.Equals(input as ResourceFlavorMetadata);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResourceFlavorMetadata input)
        {

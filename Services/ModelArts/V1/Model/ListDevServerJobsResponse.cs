...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDevServerJobsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListDevServerJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDevServerJobsResponse input)
        {

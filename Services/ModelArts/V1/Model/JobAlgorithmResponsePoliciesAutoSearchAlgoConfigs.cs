...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class JobAlgorithmResponsePoliciesAutoSearchAlgoConfigs 
    {
        ...
        public List<AutoSearchAlgoConfigParameter> Params { get; set; }
        ...
        {
            return this.Equals(input as JobAlgorithmResponsePoliciesAutoSearchAlgoConfigs);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(JobAlgorithmResponsePoliciesAutoSearchAlgoConfigs input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyTrainingQuotasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyTrainingQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyTrainingQuotasResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAlgorithmByUuidResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAlgorithmByUuidResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAlgorithmByUuidResponse input)
        {

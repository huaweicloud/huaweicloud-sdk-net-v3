...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInferDeploymentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateInferDeploymentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInferDeploymentResponse input)
        {

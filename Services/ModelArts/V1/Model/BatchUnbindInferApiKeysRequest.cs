...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchUnbindInferApiKeysRequest 
    {
        ...
        public BatchUnBindApiKeyRequest Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUnbindInferApiKeysRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUnbindInferApiKeysRequest input)
        {

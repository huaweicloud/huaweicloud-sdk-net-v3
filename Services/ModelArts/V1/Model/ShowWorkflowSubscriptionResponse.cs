...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWorkflowSubscriptionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowWorkflowSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWorkflowSubscriptionResponse input)
        {

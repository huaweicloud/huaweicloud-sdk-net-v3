...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPoolRuntimeMetricsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPoolRuntimeMetricsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPoolRuntimeMetricsResponse input)
        {

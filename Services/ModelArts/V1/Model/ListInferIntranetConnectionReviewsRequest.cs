...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ListInferIntranetConnectionReviewsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("applicant_domain_id", IsQuery = true)]
        [JsonProperty("applicant_domain_id", NullValueHandling = NullValueHandling.Ignore)]
        public string ApplicantDomainId { get; set; }
        ...
        /// </summary>
        [SDKProperty("applicant_user_name", IsQuery = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  applicantDomainId: ").Append(ApplicantDomainId).Append("\n");
        ...
        {
            return this.Equals(input as ListInferIntranetConnectionReviewsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferIntranetConnectionReviewsRequest input)
        {
            if (input == null) return false;
            if (this.Scene != input.Scene || (this.Scene != null && !this.Scene.Equals(input.Scene))) return false;
            if (this.Id != input.Id || (this.Id != null && !this.Id.Equals(input.Id))) return false;
            if (this.ApplicantDomainId != input.ApplicantDomainId || (this.ApplicantDomainId != null && !this.ApplicantDomainId.Equals(input.ApplicantDomainId))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicantDomainId != null) hashCode = hashCode * 59 + this.ApplicantDomainId.GetHashCode();

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDevServerJobTemplatesResponse : SdkResponse
    {
        ...
        public List<DevServerTemplateListResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListDevServerJobTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDevServerJobTemplatesResponse input)
        {

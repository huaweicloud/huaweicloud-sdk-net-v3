...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchBindInferApiKeysRequest 
    {
        ...
        public BatchBindApiKeyRequest Body { get; set; }
        ...
        {
            return this.Equals(input as BatchBindInferApiKeysRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchBindInferApiKeysRequest input)
        {

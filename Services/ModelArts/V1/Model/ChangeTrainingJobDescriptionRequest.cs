...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ChangeTrainingJobDescriptionRequest 
    {
        ...
        public JobDescription Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeTrainingJobDescriptionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeTrainingJobDescriptionRequest input)
        {

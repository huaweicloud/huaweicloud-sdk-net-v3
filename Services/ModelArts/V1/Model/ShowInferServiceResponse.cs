...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInferServiceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInferServiceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInferServiceResponse input)
        {

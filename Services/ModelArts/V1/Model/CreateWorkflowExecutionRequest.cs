...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class CreateWorkflowExecutionRequest 
    {
        ...
        public WorkflowExecution Body { get; set; }
        ...
        {
            return this.Equals(input as CreateWorkflowExecutionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkflowExecutionRequest input)
        {

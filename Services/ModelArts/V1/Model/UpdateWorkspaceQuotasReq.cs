...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class UpdateWorkspaceQuotasReq 
    {
        ...
        public List<UpdateWorkspaceQuotasReqQuotas> Quotas { get; set; }
        ...
        {
            return this.Equals(input as UpdateWorkspaceQuotasReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWorkspaceQuotasReq input)
        {

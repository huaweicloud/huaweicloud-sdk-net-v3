...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteHyperinstanceResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeleteHyperinstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteHyperinstanceResponse input)
        {

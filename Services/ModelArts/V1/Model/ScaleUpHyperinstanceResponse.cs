...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ScaleUpHyperinstanceResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ScaleUpHyperinstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ScaleUpHyperinstanceResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListWorkloadsResponse : SdkResponse
    {
        ...
        public List<Workload> Items { get; set; }
        ...
        {
            return this.Equals(input as ListWorkloadsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListWorkloadsResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class SummaryResp 
    {
        ...
        {
            return this.Equals(input as SummaryResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SummaryResp input)
        {

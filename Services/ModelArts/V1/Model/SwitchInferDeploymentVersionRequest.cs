...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class SwitchInferDeploymentVersionRequest 
    {
        ...
        public SwitchInferDeploymentVersionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchInferDeploymentVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchInferDeploymentVersionRequest input)
        {

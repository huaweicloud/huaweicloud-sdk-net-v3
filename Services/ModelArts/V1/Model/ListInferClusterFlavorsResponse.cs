...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferClusterFlavorsResponse : SdkResponse
    {
        ...
        public List<InferFlavor> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferClusterFlavorsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferClusterFlavorsResponse input)
        {

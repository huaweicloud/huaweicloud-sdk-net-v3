...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTrainingJobDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTrainingJobDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTrainingJobDetailsResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class NotebookFlavor 
    {
        ...
        /// </summary>
        /// <value>**参数解释**：架构类型。 **取值范围**：枚举类型，取值如下： - x86_64 - aarch64</value>
        ...
        /// </summary>
        /// <value>**参数解释**：规格处理器类型。 **取值范围**：枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)</value>
        ...
        /// </summary>
        /// <value>**参数解释**：实例类别。 **取值范围**：枚举类型，取值如下： - DEFAULT：CodeLab免费规格实例，每个用户最多只能创建一个。 - NOTEBOOK：计费规格实例。</value>
        ...
        {
            return this.Equals(input as NotebookFlavor);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NotebookFlavor input)
        {

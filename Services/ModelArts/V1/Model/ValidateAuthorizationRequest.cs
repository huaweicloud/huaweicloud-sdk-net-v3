...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ValidateAuthorizationRequest 
    {
        ...
        /// </summary>
        [SDKProperty("workspace_id", IsPath = true)]
        ...
        public ValidateAuthorizationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ValidateAuthorizationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ValidateAuthorizationRequest input)
        {

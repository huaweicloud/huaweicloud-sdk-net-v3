...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWorkflowPurchasePoolResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateWorkflowPurchasePoolResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkflowPurchasePoolResponse input)
        {

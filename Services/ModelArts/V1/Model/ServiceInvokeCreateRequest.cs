...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ServiceInvokeCreateRequest 
    {
        ...
        public ElbConnectionCreateRequest ElbConnection { get; set; }
        ...
        {
            return this.Equals(input as ServiceInvokeCreateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ServiceInvokeCreateRequest input)
        {

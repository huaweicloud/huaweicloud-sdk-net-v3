...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListHyperinstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListHyperinstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListHyperinstancesResponse input)
        {

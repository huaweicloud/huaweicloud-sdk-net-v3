...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ListImageRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**：镜像类型。 **约束限制**：不涉及。 **取值范围**：枚举类型，取值如下： - BUILD_IN：系统内置镜像。 - DEDICATED：用户保存的镜像。  **默认取值**：BUILD_IN。</value>
        ...
        /// </summary>
        [SDKProperty("show_name", IsQuery = true)]
        ...
        /// </summary>
        [SDKProperty("show_tag", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListImageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListImageRequest input)
        {

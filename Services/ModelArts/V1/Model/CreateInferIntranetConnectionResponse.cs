...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInferIntranetConnectionResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateInferIntranetConnectionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInferIntranetConnectionResponse input)
        {

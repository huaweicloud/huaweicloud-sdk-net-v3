...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ListTrainingJobsByTagsRequest 
    {
        ...
        public ResourceInstancesFilterReq Body { get; set; }
        ...
        {
            return this.Equals(input as ListTrainingJobsByTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTrainingJobsByTagsRequest input)
        {

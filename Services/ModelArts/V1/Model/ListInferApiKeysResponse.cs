...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferApiKeysResponse : SdkResponse
    {
        ...
        public List<ApiKeyResponseV2> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferApiKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferApiKeysResponse input)
        {

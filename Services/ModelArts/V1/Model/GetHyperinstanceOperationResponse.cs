...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetHyperinstanceOperationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetHyperinstanceOperationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetHyperinstanceOperationResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTrainingJobEventsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListTrainingJobEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTrainingJobEventsResponse input)
        {

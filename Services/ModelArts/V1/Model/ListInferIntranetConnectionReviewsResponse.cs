...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferIntranetConnectionReviewsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInferIntranetConnectionReviewsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferIntranetConnectionReviewsResponse input)
        {

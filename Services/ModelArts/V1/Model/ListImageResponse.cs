...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListImageResponse : SdkResponse
    {
        ...
        public List<ImageResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListImageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListImageResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutoSearchPerTrialResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutoSearchPerTrialResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutoSearchPerTrialResponse input)
        {

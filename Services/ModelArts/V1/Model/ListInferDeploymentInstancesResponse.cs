...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferDeploymentInstancesResponse : SdkResponse
    {
        ...
        public List<ServiceInstanceResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferDeploymentInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferDeploymentInstancesResponse input)
        {

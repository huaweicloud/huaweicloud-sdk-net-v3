...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuthoringClustersResponse : SdkResponse
    {
        ...
        public List<ClusterResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListAuthoringClustersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuthoringClustersResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class DataRequirement 
    {
        ...
        /// </summary>
        /// <value>数据来源类型。枚举值如下： - dataset：数据集 - obs：OBS - swr：SWR - model_list：AI应用列表 - label_task：标注任务 - service：在线服务</value>
        ...
        {
            return this.Equals(input as DataRequirement);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DataRequirement input)
        {

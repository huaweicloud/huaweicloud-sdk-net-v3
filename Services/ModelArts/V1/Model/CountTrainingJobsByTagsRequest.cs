...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class CountTrainingJobsByTagsRequest 
    {
        ...
        public CountResourceInstancesReq Body { get; set; }
        ...
        {
            return this.Equals(input as CountTrainingJobsByTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CountTrainingJobsByTagsRequest input)
        {

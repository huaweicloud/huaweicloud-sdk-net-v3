...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class StepExecution 
    {
        ...
        /// </summary>
        /// <value>节点的状态。枚举值如下： - init：初始化 - wait_inputs：等待输入 - pending：等待 - creating：创建中 - created：创建成功 - create_failed：创建失败 - running：运行中 - stopping：停止中 - stopped：停止 - timeout：超时 - completed：完成 - failed：失败 - hold：持有 - skipped：跳过</value>
        ...
        public WorkflowErrorInfo ErrorInfo { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("policy", NullValueHandling = NullValueHandling.Ignore)]
        public WorkflowStepExecutionPolicy Policy { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("conditions_execution", NullValueHandling = NullValueHandling.Ignore)]
        public WorkflowConditionExecution ConditionsExecution { get; set; }
        ...
        {
            return this.Equals(input as StepExecution);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StepExecution input)
        {

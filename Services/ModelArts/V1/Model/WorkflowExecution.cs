...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class WorkflowExecution 
    {
        ...
        public List<StepExecution> StepsExecution { get; set; }
        ...
        public WorkflowDagPolicies Policies { get; set; }
        ...
        {
            return this.Equals(input as WorkflowExecution);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(WorkflowExecution input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowNodeConfigTemplateResponse : SdkResponse
    {
        ...
        public NodeConfigTemplateMeta Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public NodeConfigTemplateSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as ShowNodeConfigTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowNodeConfigTemplateResponse input)
        {

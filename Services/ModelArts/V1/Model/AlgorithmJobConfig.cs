...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class AlgorithmJobConfig 
    {
        ...
        public List<AlgorithmCreateInput> Inputs { get; set; }

        /// <summary>
        /// 算法的数据输出。
        /// </summary>
        [JsonProperty("outputs", NullValueHandling = NullValueHandling.Ignore)]
        public List<AlgorithmCreateOutput> Outputs { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("engine", NullValueHandling = NullValueHandling.Ignore)]
        public AlgorithmCreateEngine Engine { get; set; }
        ...
        {
            return this.Equals(input as AlgorithmJobConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AlgorithmJobConfig input)
        {

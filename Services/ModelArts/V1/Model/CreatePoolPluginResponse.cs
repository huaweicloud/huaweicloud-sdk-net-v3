...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePoolPluginResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePoolPluginResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePoolPluginResponse input)
        {

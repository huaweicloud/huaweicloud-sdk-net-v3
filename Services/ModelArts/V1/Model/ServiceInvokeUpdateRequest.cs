...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ServiceInvokeUpdateRequest 
    {
        ...
        public ElbConnectionUpdateRequest ElbConnection { get; set; }
        ...
        {
            return this.Equals(input as ServiceInvokeUpdateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ServiceInvokeUpdateRequest input)
        {

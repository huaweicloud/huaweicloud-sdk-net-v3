...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class UnitConfigResponse 
    {
        ...
        public List<InferModelResponse> Models { get; set; }
        ...
        public List<DumpResponse> Dumps { get; set; }
        ...
        public AffinityResponse Affinity { get; set; }
        ...
        {
            return this.Equals(input as UnitConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UnitConfigResponse input)
        {

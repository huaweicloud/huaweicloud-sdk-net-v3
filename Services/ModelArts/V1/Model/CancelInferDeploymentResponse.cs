...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CancelInferDeploymentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CancelInferDeploymentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CancelInferDeploymentResponse input)
        {

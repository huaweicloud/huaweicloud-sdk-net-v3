...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ChangeHyperinstanceOSResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ChangeHyperinstanceOSResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeHyperinstanceOSResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWorkspaceResponse : SdkResponse
    {
        ...
        public List<CreateWorkspaceResponseBodyGrants> Grants { get; set; }
        ...
        {
            return this.Equals(input as CreateWorkspaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkspaceResponse input)
        {

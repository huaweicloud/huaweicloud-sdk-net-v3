...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListResourceFlavorsResponse : SdkResponse
    {
        ...
        public ResourceFlavorListMetadata Metadata { get; set; }

        /// <summary>
        /// 参数解释：资源规格列表。 取值范围：不涉及。
        /// </summary>
        [JsonProperty("items", NullValueHandling = NullValueHandling.Ignore)]
        public List<ResourceFlavor> Items { get; set; }
        ...
        {
            return this.Equals(input as ListResourceFlavorsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListResourceFlavorsResponse input)
        {

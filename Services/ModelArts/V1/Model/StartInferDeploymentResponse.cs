...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class StartInferDeploymentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as StartInferDeploymentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartInferDeploymentResponse input)
        {

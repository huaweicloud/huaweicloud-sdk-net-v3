...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetachDynamicStorageResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DetachDynamicStorageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetachDynamicStorageResponse input)
        {

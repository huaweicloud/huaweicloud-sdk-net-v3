...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDynamicStoragesResponse : SdkResponse
    {
        ...
        public List<DataVolumesRes> Data { get; set; }
        ...
        {
            return this.Equals(input as ListDynamicStoragesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDynamicStoragesResponse input)
        {

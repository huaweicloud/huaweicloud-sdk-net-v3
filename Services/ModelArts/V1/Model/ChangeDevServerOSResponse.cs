...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ChangeDevServerOSResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ChangeDevServerOSResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeDevServerOSResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTrainingExperimentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTrainingExperimentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrainingExperimentResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchUnlockPoolNodesRequest 
    {
        ...
        public BatchLockPoolNodesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUnlockPoolNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUnlockPoolNodesRequest input)
        {

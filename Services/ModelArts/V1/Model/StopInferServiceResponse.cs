...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class StopInferServiceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as StopInferServiceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StopInferServiceResponse input)
        {

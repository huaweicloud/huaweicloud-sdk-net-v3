...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ListInferDeploymentsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("delete_after", IsQuery = true)]
        [JsonProperty("delete_after", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ListInferDeploymentsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferDeploymentsRequest input)
        {
            ...
            if (this.DeleteAfter != input.DeleteAfter || (this.DeleteAfter != null && !this.DeleteAfter.Equals(input.DeleteAfter))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeleteAfter != null) hashCode = hashCode * 59 + this.DeleteAfter.GetHashCode();
                return hashCode;
            }
        }
    }

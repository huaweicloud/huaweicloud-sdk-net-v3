...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class UpdateInferDeploymentHpaRequest 
    {
        ...
        public UpdateHpaRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInferDeploymentHpaRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInferDeploymentHpaRequest input)
        {

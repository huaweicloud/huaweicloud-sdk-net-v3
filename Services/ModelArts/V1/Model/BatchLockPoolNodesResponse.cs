...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchLockPoolNodesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchLockPoolNodesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchLockPoolNodesResponse input)
        {

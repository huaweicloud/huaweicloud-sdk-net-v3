...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class AutoSearch 
    {
        ...
        public List<RewardAttrs> RewardAttrs { get; set; }
        ...
        public List<AlgoConfigs> AlgoConfigs { get; set; }
        ...
        {
            return this.Equals(input as AutoSearch);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AutoSearch input)
        {

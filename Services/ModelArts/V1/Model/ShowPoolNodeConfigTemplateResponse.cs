...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPoolNodeConfigTemplateResponse : SdkResponse
    {
        ...
        public NodeconfigtemplateMetaV2 Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public NodeconfigtemplatesSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as ShowPoolNodeConfigTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPoolNodeConfigTemplateResponse input)
        {

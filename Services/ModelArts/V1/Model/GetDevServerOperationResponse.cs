...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetDevServerOperationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetDevServerOperationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetDevServerOperationResponse input)
        {

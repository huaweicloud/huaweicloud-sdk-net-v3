...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAllNotebooksResponse : SdkResponse
    {
        ...
        public List<NotebookResp> Data { get; set; }
        ...
        {
            return this.Equals(input as ListAllNotebooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllNotebooksResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInferDeploymentVersionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInferDeploymentVersionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInferDeploymentVersionResponse input)
        {

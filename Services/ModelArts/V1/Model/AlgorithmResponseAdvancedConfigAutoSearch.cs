...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class AlgorithmResponseAdvancedConfigAutoSearch 
    {
        ...
        public List<AlgorithmResponseAdvancedConfigAutoSearchSearchParams> SearchParams { get; set; }
        ...
        {
            return this.Equals(input as AlgorithmResponseAdvancedConfigAutoSearch);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AlgorithmResponseAdvancedConfigAutoSearch input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPluginTemplatesResponse : SdkResponse
    {
        ...
        public List<PluginTemplateV2> Items { get; set; }
        ...
        {
            return this.Equals(input as ListPluginTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPluginTemplatesResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAllDevServersResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAllDevServersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllDevServersResponse input)
        {

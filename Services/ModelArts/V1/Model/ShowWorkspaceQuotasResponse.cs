...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWorkspaceQuotasResponse : SdkResponse
    {
        ...
        public List<WorkspaceQuotasResponse> Quotas { get; set; }
        ...
        {
            return this.Equals(input as ShowWorkspaceQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWorkspaceQuotasResponse input)
        {

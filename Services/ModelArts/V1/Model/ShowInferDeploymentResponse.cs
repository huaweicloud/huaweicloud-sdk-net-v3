...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInferDeploymentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInferDeploymentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInferDeploymentResponse input)
        {

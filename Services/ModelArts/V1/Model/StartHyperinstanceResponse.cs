...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class StartHyperinstanceResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StartHyperinstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartHyperinstanceResponse input)
        {

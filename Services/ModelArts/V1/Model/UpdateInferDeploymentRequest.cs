...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class UpdateInferDeploymentRequest 
    {
        ...
        public GroupConfigUpdateRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInferDeploymentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInferDeploymentRequest input)
        {

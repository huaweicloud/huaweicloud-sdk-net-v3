...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInferDeploymentHpaResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateInferDeploymentHpaResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInferDeploymentHpaResponse input)
        {

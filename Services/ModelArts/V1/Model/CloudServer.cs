...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class CloudServer 
    {
        ...
        /// </summary>
        /// <value>**参数解释**：Lite Server服务器类型。 **取值范围**： - BMS：裸金属服务器 - ECS：弹性云服务器 - HPS：超节点服务器</value>
        ...
        /// </summary>
        [JsonProperty("hps_ecs_id", NullValueHandling = NullValueHandling.Ignore)]
        public string HpsEcsId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  hpsEcsId: ").Append(HpsEcsId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(CloudServer input)
        {
            ...
            if (this.HpsEcsId != input.HpsEcsId || (this.HpsEcsId != null && !this.HpsEcsId.Equals(input.HpsEcsId))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HpsEcsId != null) hashCode = hashCode * 59 + this.HpsEcsId.GetHashCode();
                return hashCode;
            }
        }
    }

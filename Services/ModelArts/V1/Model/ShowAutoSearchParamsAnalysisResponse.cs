...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutoSearchParamsAnalysisResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutoSearchParamsAnalysisResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutoSearchParamsAnalysisResponse input)
        {

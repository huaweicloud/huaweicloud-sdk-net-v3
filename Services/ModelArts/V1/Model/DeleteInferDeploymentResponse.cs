...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteInferDeploymentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteInferDeploymentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteInferDeploymentResponse input)
        {

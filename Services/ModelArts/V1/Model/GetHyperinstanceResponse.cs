...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetHyperinstanceResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetHyperinstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetHyperinstanceResponse input)
        {

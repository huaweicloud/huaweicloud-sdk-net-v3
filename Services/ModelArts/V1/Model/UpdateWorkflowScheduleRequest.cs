...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class UpdateWorkflowScheduleRequest 
    {
        ...
        public WorkflowScheduleUpdate Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateWorkflowScheduleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWorkflowScheduleRequest input)
        {

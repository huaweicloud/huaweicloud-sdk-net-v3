...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAllHyperinstancesResponse : SdkResponse
    {
        ...
        public List<ServerHyperinstanceResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListAllHyperinstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllHyperinstancesResponse input)
        {

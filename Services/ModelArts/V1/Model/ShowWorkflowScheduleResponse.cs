...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWorkflowScheduleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowWorkflowScheduleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWorkflowScheduleResponse input)
        {

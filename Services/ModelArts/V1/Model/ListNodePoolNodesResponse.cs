...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListNodePoolNodesResponse : SdkResponse
    {
        ...
        public NodeListMetadata Metadata { get; set; }
        ...
        {
            return this.Equals(input as ListNodePoolNodesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNodePoolNodesResponse input)
        {

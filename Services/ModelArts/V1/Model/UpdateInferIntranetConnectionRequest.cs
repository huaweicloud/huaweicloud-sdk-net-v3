...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class UpdateInferIntranetConnectionRequest 
    {
        ...
        public UpdateIntranetConnectionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInferIntranetConnectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInferIntranetConnectionRequest input)
        {

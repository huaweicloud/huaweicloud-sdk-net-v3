...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUnbindInferApiKeysResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchUnbindInferApiKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUnbindInferApiKeysResponse input)
        {

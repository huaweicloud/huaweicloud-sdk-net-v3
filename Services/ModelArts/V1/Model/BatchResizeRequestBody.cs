...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchResizeRequestBody 
    {
        ...
        public List<ResizeNodeInfo> Nodes { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("source", NullValueHandling = NullValueHandling.Ignore)]
        public NodeResizeParams Source { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("target", NullValueHandling = NullValueHandling.Ignore)]
        public NodeResizeParams Target { get; set; }
        ...
        {
            return this.Equals(input as BatchResizeRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchResizeRequestBody input)
        {

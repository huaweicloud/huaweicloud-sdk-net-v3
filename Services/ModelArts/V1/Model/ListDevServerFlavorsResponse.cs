...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDevServerFlavorsResponse : SdkResponse
    {
        ...
        public List<ServerFlavorinstanceResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListDevServerFlavorsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDevServerFlavorsResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ShowAutoSearchParamAnalysisResultPathRequest 
    {
        ...
        /// 搜索参数名称
        /// </summary>
        [SDKProperty("parameter_name", IsPath = true)]
        ...
        {
            return this.Equals(input as ShowAutoSearchParamAnalysisResultPathRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutoSearchParamAnalysisResultPathRequest input)
        {

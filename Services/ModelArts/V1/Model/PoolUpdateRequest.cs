...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class PoolUpdateRequest 
    {
        ...
        public PoolMetadataUpdate Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public PoolSpecUpdate Spec { get; set; }
        ...
        {
            return this.Equals(input as PoolUpdateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PoolUpdateRequest input)
        {

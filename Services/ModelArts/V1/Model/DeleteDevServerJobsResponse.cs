...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteDevServerJobsResponse : SdkResponse
    {
        ...
        public List<DevServerJobListResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as DeleteDevServerJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteDevServerJobsResponse input)
        {

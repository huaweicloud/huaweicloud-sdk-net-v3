...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferDeploymentVersionsResponse : SdkResponse
    {
        ...
        public List<InferDeploymentVersionItemResp> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferDeploymentVersionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferDeploymentVersionsResponse input)
        {

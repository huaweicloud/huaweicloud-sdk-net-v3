...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetTopologiesResponse : SdkResponse
    {
        ...
        public List<ServerPhyInfo> Servers { get; set; }
        ...
        {
            return this.Equals(input as GetTopologiesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetTopologiesResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInferServiceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateInferServiceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInferServiceResponse input)
        {

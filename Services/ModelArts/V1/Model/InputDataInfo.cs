...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class InputDataInfo 
    {
        ...
        public InputDataInfoDataset Dataset { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("obs", NullValueHandling = NullValueHandling.Ignore)]
        public InputDataInfoObs Obs { get; set; }
        ...
        {
            return this.Equals(input as InputDataInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(InputDataInfo input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class CreateWorkflowSubscriptionsRequest 
    {
        ...
        public Subscription Body { get; set; }
        ...
        {
            return this.Equals(input as CreateWorkflowSubscriptionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkflowSubscriptionsRequest input)
        {

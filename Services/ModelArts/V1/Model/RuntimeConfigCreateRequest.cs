...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class RuntimeConfigCreateRequest 
    {
        ...
        public ServiceInvokeCreateRequest ServiceInvoke { get; set; }
        ...
        {
            return this.Equals(input as RuntimeConfigCreateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RuntimeConfigCreateRequest input)
        {

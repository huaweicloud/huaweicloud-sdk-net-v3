...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchRebootPoolNodesRequest 
    {
        ...
        public BatchRebootPoolNodesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchRebootPoolNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRebootPoolNodesRequest input)
        {

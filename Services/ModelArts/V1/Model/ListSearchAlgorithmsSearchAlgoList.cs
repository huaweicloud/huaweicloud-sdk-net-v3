...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ListSearchAlgorithmsSearchAlgoList 
    {
        ...
        public List<ListSearchAlgorithmsParams> Params { get; set; }
        ...
        {
            return this.Equals(input as ListSearchAlgorithmsSearchAlgoList);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSearchAlgorithmsSearchAlgoList input)
        {

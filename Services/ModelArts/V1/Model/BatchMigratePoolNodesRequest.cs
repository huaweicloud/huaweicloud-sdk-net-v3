...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchMigratePoolNodesRequest 
    {
        ...
        public NodeBatchMigrationRequest Body { get; set; }
        ...
        {
            return this.Equals(input as BatchMigratePoolNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchMigratePoolNodesRequest input)
        {

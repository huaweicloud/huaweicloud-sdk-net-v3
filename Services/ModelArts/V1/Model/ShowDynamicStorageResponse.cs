...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDynamicStorageResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowDynamicStorageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDynamicStorageResponse input)
        {

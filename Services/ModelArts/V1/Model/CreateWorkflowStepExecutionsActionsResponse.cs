...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWorkflowStepExecutionsActionsResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateWorkflowStepExecutionsActionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWorkflowStepExecutionsActionsResponse input)
        {

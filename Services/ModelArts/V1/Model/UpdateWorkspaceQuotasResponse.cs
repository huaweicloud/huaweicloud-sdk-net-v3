...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateWorkspaceQuotasResponse : SdkResponse
    {
        ...
        public List<WorkspaceQuotasUpdateResponse> Quotas { get; set; }
        ...
        {
            return this.Equals(input as UpdateWorkspaceQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWorkspaceQuotasResponse input)
        {

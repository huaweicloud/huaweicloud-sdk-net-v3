...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class CountInferServicesByTagsRequest 
    {
        ...
        public QueryTmsResourceCountRequest Body { get; set; }
        ...
        {
            return this.Equals(input as CountInferServicesByTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CountInferServicesByTagsRequest input)
        {

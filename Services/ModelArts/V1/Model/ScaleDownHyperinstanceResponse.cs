...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ScaleDownHyperinstanceResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ScaleDownHyperinstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ScaleDownHyperinstanceResponse input)
        {

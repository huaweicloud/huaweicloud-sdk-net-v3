...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateWorkflowSubscriptionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateWorkflowSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWorkflowSubscriptionResponse input)
        {

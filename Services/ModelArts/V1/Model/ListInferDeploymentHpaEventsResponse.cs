...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferDeploymentHpaEventsResponse : SdkResponse
    {
        ...
        public List<HpaEventResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferDeploymentHpaEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferDeploymentHpaEventsResponse input)
        {

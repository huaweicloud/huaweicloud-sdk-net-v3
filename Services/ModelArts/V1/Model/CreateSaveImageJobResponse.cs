...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateSaveImageJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateSaveImageJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSaveImageJobResponse input)
        {

...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BindDevServerPublicIPResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BindDevServerPublicIPResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BindDevServerPublicIPResponse input)
        {

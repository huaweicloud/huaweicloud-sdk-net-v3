...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class BatchUpdatePoolNodesRequest 
    {
        ...
        public BatchUpdatePoolNodesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdatePoolNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdatePoolNodesRequest input)
        {

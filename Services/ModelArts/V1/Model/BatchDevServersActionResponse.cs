...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDevServersActionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDevServersActionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDevServersActionResponse input)
        {

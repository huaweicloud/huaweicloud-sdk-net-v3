...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class RuntimeConfigUpdateRequest 
    {
        ...
        public ServiceInvokeUpdateRequest ServiceInvoke { get; set; }
        ...
        {
            return this.Equals(input as RuntimeConfigUpdateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RuntimeConfigUpdateRequest input)
        {

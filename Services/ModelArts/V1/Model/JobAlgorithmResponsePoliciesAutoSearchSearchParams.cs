...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class JobAlgorithmResponsePoliciesAutoSearchSearchParams 
    {
        ...
        {
            return this.Equals(input as JobAlgorithmResponsePoliciesAutoSearchSearchParams);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(JobAlgorithmResponsePoliciesAutoSearchSearchParams input)
        {
            ...
            if (this.DiscreteValues != input.DiscreteValues || (this.DiscreteValues != null && input.DiscreteValues != null && !this.DiscreteValues.SequenceEqual(input.DiscreteValues))) return false;

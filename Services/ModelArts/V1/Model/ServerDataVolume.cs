...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ServerDataVolume 
    {
        ...
        /// </summary>
        /// <value>**参数解释**：系统盘类型。表示数据盘的存储类型。 **约束限制**：不涉及。 **取值范围**： - ESSD：极速型SSD云硬盘 - GPSSD：通用型SSD云硬盘 - SAS：高IO云硬盘 - SATA：普通IO云硬盘 - SSD：超高IO云硬盘 **默认取值**：不涉及。</value>
        ...
        {
            return this.Equals(input as ServerDataVolume);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ServerDataVolume input)
        {

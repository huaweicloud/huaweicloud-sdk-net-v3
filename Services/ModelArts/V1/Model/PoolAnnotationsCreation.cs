...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class PoolAnnotationsCreation 
    {
        ...
        /// </summary>
        [JsonProperty("os.modelarts/auto.pay", NullValueHandling = NullValueHandling.Ignore)]
        public string OsModelartsAutoPay { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  osModelartsAutoPay: ").Append(OsModelartsAutoPay).Append("\n");
        ...
        {
            return this.Equals(input as PoolAnnotationsCreation);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PoolAnnotationsCreation input)
        {
            ...
            if (this.OsModelartsAutoPay != input.OsModelartsAutoPay || (this.OsModelartsAutoPay != null && !this.OsModelartsAutoPay.Equals(input.OsModelartsAutoPay))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OsModelartsAutoPay != null) hashCode = hashCode * 59 + this.OsModelartsAutoPay.GetHashCode();

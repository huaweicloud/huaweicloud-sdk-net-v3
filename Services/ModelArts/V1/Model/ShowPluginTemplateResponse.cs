...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPluginTemplateResponse : SdkResponse
    {
        ...
        public PluginTemplateMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public PluginTemplateSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as ShowPluginTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPluginTemplateResponse input)
        {

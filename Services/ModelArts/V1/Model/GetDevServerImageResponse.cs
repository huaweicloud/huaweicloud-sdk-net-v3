...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetDevServerImageResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetDevServerImageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetDevServerImageResponse input)
        {

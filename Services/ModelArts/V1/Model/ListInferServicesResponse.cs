...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferServicesResponse : SdkResponse
    {
        ...
        public List<ServiceItemResponseData> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferServicesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferServicesResponse input)
        {

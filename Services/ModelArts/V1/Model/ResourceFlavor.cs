...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ResourceFlavor 
    {
        ...
        public ResourceFlavorMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public ResourceFlavorSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public ResourceFlavorStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ResourceFlavor);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResourceFlavor input)
        {

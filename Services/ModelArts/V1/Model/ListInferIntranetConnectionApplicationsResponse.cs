...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferIntranetConnectionApplicationsResponse : SdkResponse
    {
        ...
        public List<IntranetConnectionInfo> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferIntranetConnectionApplicationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferIntranetConnectionApplicationsResponse input)
        {

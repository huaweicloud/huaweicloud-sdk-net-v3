...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInferServiceEventsResponse : SdkResponse
    {
        ...
        public List<ServiceEventResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as ListInferServiceEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferServiceEventsResponse input)
        {

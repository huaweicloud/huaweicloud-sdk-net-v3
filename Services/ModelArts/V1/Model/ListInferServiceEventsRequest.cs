...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class ListInferServiceEventsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("event_info_key", IsQuery = true)]
        [JsonProperty("event_info_key", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  eventInfoKey: ").Append(EventInfoKey).Append("\n");
        ...
        {
            return this.Equals(input as ListInferServiceEventsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInferServiceEventsRequest input)
        {
            ...
            if (this.EventInfoKey != input.EventInfoKey || (this.EventInfoKey != null && !this.EventInfoKey.Equals(input.EventInfoKey))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EventInfoKey != null) hashCode = hashCode * 59 + this.EventInfoKey.GetHashCode();

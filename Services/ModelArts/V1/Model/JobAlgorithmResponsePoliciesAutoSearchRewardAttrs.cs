...
namespace HuaweiCloud.SDK.ModelArts.V1.Model
{
    ...
    public class JobAlgorithmResponsePoliciesAutoSearchRewardAttrs 
    {
        ...
        {
            return this.Equals(input as JobAlgorithmResponsePoliciesAutoSearchRewardAttrs);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(JobAlgorithmResponsePoliciesAutoSearchRewardAttrs input)
        {

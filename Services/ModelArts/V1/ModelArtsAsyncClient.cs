...
namespace HuaweiCloud.SDK.ModelArts.V1
{
    public partial class ModelArtsAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<AttachDevServerPortResponse> AttachDevServerPortAsync(AttachDevServerPortRequest attachDevServerPortRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<AttachDevServerPortResponse> AttachDevServerPortAsyncInvoker(AttachDevServerPortRequest attachDevServerPortRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(attachDevServerPortRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/attach-ports", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", attachDevServerPortRequest);
            return new AsyncInvoker<AttachDevServerPortResponse>(this, "POST", request, JsonUtils.DeSerialize<AttachDevServerPortResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchDeleteTrainingJobResponse> BatchDeleteTrainingJobAsync(BatchDeleteTrainingJobRequest batchDeleteTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<BatchDeleteTrainingJobResponse> BatchDeleteTrainingJobAsyncInvoker(BatchDeleteTrainingJobRequest batchDeleteTrainingJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchDeleteTrainingJobRequest);
            return new AsyncInvoker<BatchDeleteTrainingJobResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchDeleteTrainingJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchDrainPoolNodesResponse> BatchDrainPoolNodesAsync(BatchDrainPoolNodesRequest batchDrainPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<BatchDrainPoolNodesResponse> BatchDrainPoolNodesAsyncInvoker(BatchDrainPoolNodesRequest batchDrainPoolNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchDrainPoolNodesRequest.PoolName, out var valueOfPoolName)) urlParam.Add("pool_name", valueOfPoolName);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/pools/{pool_name}/nodes/batch-drain", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDrainPoolNodesRequest);
            return new AsyncInvoker<BatchDrainPoolNodesResponse>(this, "POST", request, JsonUtils.DeSerializeNull<BatchDrainPoolNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CountTrainingJobsByTagsResponse> CountTrainingJobsByTagsAsync(CountTrainingJobsByTagsRequest countTrainingJobsByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CountTrainingJobsByTagsResponse> CountTrainingJobsByTagsAsyncInvoker(CountTrainingJobsByTagsRequest countTrainingJobsByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-training-job/resource-instances/count", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", countTrainingJobsByTagsRequest);
            return new AsyncInvoker<CountTrainingJobsByTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<CountTrainingJobsByTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateInferTempApiKeyResponse> CreateInferTempApiKeyAsync(CreateInferTempApiKeyRequest createInferTempApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateInferTempApiKeyResponse> CreateInferTempApiKeyAsyncInvoker(CreateInferTempApiKeyRequest createInferTempApiKeyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/services/api-keys/temp", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createInferTempApiKeyRequest);
            return new AsyncInvoker<CreateInferTempApiKeyResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateInferTempApiKeyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DetachDevServerPortResponse> DetachDevServerPortAsync(DetachDevServerPortRequest detachDevServerPortRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DetachDevServerPortResponse> DetachDevServerPortAsyncInvoker(DetachDevServerPortRequest detachDevServerPortRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(detachDevServerPortRequest.Id, out var valueOfId)) urlParam.Add("id", valueOfId);
            if (StringUtils.TryConvertToNonEmptyString(detachDevServerPortRequest.PortId, out var valueOfPortId)) urlParam.Add("port_id", valueOfPortId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/dev-servers/{id}/detach-ports/{port_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", detachDevServerPortRequest);
            return new AsyncInvoker<DetachDevServerPortResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DetachDevServerPortResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListFtArtifactsResponse> ListFtArtifactsAsync(ListFtArtifactsRequest listFtArtifactsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListFtArtifactsResponse> ListFtArtifactsAsyncInvoker(ListFtArtifactsRequest listFtArtifactsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listFtArtifactsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/ft-artifacts", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listFtArtifactsRequest);
            return new AsyncInvoker<ListFtArtifactsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListFtArtifactsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListTrainingJobTagsResponse> ListTrainingJobTagsAsync(ListTrainingJobTagsRequest listTrainingJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListTrainingJobTagsResponse> ListTrainingJobTagsAsyncInvoker(ListTrainingJobTagsRequest listTrainingJobTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-training-job/tags", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTrainingJobTagsRequest);
            return new AsyncInvoker<ListTrainingJobTagsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTrainingJobTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListTrainingJobsByTagsResponse> ListTrainingJobsByTagsAsync(ListTrainingJobsByTagsRequest listTrainingJobsByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListTrainingJobsByTagsResponse> ListTrainingJobsByTagsAsyncInvoker(ListTrainingJobsByTagsRequest listTrainingJobsByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/modelarts-training-job/resource-instances/filter", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", listTrainingJobsByTagsRequest);
            return new AsyncInvoker<ListTrainingJobsByTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListTrainingJobsByTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyTrainingQuotasResponse> ModifyTrainingQuotasAsync(ModifyTrainingQuotasRequest modifyTrainingQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ModifyTrainingQuotasResponse> ModifyTrainingQuotasAsyncInvoker(ModifyTrainingQuotasRequest modifyTrainingQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-quotas", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyTrainingQuotasRequest);
            return new AsyncInvoker<ModifyTrainingQuotasResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyTrainingQuotasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<PublishFtArtifactsResponse> PublishFtArtifactsAsync(PublishFtArtifactsRequest publishFtArtifactsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<PublishFtArtifactsResponse> PublishFtArtifactsAsyncInvoker(PublishFtArtifactsRequest publishFtArtifactsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(publishFtArtifactsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/ft-artifacts/publish", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", publishFtArtifactsRequest);
            return new AsyncInvoker<PublishFtArtifactsResponse>(this, "POST", request, JsonUtils.DeSerialize<PublishFtArtifactsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowFtDetailResponse> ShowFtDetailAsync(ShowFtDetailRequest showFtDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowFtDetailResponse> ShowFtDetailAsyncInvoker(ShowFtDetailRequest showFtDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showFtDetailRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/ft-detail", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showFtDetailRequest);
            return new AsyncInvoker<ShowFtDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowFtDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowFtMetricsResponse> ShowFtMetricsAsync(ShowFtMetricsRequest showFtMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowFtMetricsResponse> ShowFtMetricsAsyncInvoker(ShowFtMetricsRequest showFtMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showFtMetricsRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/ft-metrics", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showFtMetricsRequest);
            return new AsyncInvoker<ShowFtMetricsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowFtMetricsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTrainingFlavorMaxAvailableResourceResponse> ShowTrainingFlavorMaxAvailableResourceAsync(ShowTrainingFlavorMaxAvailableResourceRequest showTrainingFlavorMaxAvailableResourceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowTrainingFlavorMaxAvailableResourceResponse> ShowTrainingFlavorMaxAvailableResourceAsyncInvoker(ShowTrainingFlavorMaxAvailableResourceRequest showTrainingFlavorMaxAvailableResourceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-pool-flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingFlavorMaxAvailableResourceRequest);
            return new AsyncInvoker<ShowTrainingFlavorMaxAvailableResourceResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingFlavorMaxAvailableResourceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTrainingJobLogsFromAomResponse> ShowTrainingJobLogsFromAomAsync(ShowTrainingJobLogsFromAomRequest showTrainingJobLogsFromAomRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowTrainingJobLogsFromAomResponse> ShowTrainingJobLogsFromAomAsyncInvoker(ShowTrainingJobLogsFromAomRequest showTrainingJobLogsFromAomRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobLogsFromAomRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobLogsFromAomRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/logs/{task_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingJobLogsFromAomRequest);
            return new AsyncInvoker<ShowTrainingJobLogsFromAomResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingJobLogsFromAomResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTrainingJobRoutePlanResponse> ShowTrainingJobRoutePlanAsync(ShowTrainingJobRoutePlanRequest showTrainingJobRoutePlanRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowTrainingJobRoutePlanResponse> ShowTrainingJobRoutePlanAsyncInvoker(ShowTrainingJobRoutePlanRequest showTrainingJobRoutePlanRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTrainingJobRoutePlanRequest.TrainingJobId, out var valueOfTrainingJobId)) urlParam.Add("training_job_id", valueOfTrainingJobId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-jobs/{training_job_id}/route_plan", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTrainingJobRoutePlanRequest);
            return new AsyncInvoker<ShowTrainingJobRoutePlanResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTrainingJobRoutePlanResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ValidateTrainingJobNameResponse> ValidateTrainingJobNameAsync(ValidateTrainingJobNameRequest validateTrainingJobNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ValidateTrainingJobNameResponse> ValidateTrainingJobNameAsyncInvoker(ValidateTrainingJobNameRequest validateTrainingJobNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/training-job-names", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", validateTrainingJobNameRequest);
            return new AsyncInvoker<ValidateTrainingJobNameResponse>(this, "GET", request, JsonUtils.DeSerialize<ValidateTrainingJobNameResponse>);
        }

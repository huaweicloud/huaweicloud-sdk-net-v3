...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePersistentStorageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePersistentStorageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePersistentStorageResponse input)
        {

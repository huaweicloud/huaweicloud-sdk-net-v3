...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public enum AppServerTaskStatus
    {
        ...
        /// </summary>
        [EnumMember(Value = "installing_app")]
        INSTALLING_APP = 36,

        /// <summary>
        /// Enum INSTALL_APP_FAILED for value: install_app_failed
        /// </summary>
        [EnumMember(Value = "install_app_failed")]
        INSTALL_APP_FAILED = 37,

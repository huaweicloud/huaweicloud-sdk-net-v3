...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class AppServer 
    {
        ...
        {
            return this.Equals(input as AppServer);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AppServer input)
        {
            ...
            if (this.VmStatus != input.VmStatus || (this.VmStatus != null && !this.VmStatus.Equals(input.VmStatus))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VmStatus != null) hashCode = hashCode * 59 + this.VmStatus.GetHashCode();

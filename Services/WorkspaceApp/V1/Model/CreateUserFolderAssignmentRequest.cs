...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class CreateUserFolderAssignmentRequest 
    {
        ...
        public CreateUserFolderReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateUserFolderAssignmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateUserFolderAssignmentRequest input)
        {

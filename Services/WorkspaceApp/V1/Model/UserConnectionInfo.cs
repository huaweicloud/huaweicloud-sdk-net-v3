...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class UserConnectionInfo 
    {
        ...
        /// 桌面组名。
        /// </summary>
        [JsonProperty("desktop_group_name", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public DateTime? PreConnTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  desktopGroupName: ").Append(DesktopGroupName).Append("\n");
        ...
        {
            return this.Equals(input as UserConnectionInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UserConnectionInfo input)
        {
            ...
            if (this.DesktopGroupName != input.DesktopGroupName || (this.DesktopGroupName != null && !this.DesktopGroupName.Equals(input.DesktopGroupName))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DesktopGroupName != null) hashCode = hashCode * 59 + this.DesktopGroupName.GetHashCode();

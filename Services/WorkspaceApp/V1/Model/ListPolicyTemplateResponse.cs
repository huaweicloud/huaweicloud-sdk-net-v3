...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPolicyTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListPolicyTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPolicyTemplateResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class FileRedirectionOptions 
    {
        ...
        public FileRedirectionOptionsFluidControlOptions FluidControlOptions { get; set; }
        ...
        public FileRedirectionOptionsCompressionSwitchOptions CompressionSwitchOptions { get; set; }
        ...
        public FileRedirectionOptionsLinuxFileSizeSupportedOptions LinuxFileSizeSupportedOptions { get; set; }
        ...
        {
            return this.Equals(input as FileRedirectionOptions);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(FileRedirectionOptions input)
        {

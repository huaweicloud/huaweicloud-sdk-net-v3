...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class ShowServerGroupResponse : SdkResponse
    {
        ...
        /// </summary>
        [JsonProperty("image_min_disk", NullValueHandling = NullValueHandling.Ignore)]
        public int? ImageMinDisk { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  imageMinDisk: ").Append(ImageMinDisk).Append("\n");
        ...
        public bool Equals(ShowServerGroupResponse input)
        {
            ...
            if (this.ImageMinDisk != input.ImageMinDisk || (this.ImageMinDisk != null && !this.ImageMinDisk.Equals(input.ImageMinDisk))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ImageMinDisk != null) hashCode = hashCode * 59 + this.ImageMinDisk.GetHashCode();

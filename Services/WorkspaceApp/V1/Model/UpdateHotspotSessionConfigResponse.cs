...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateHotspotSessionConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateHotspotSessionConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotspotSessionConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class FileRedirectionOptionsLinuxFileSizeSupportedOptions 
    {
        ...
        {
            return this.Equals(input as FileRedirectionOptionsLinuxFileSizeSupportedOptions);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(FileRedirectionOptionsLinuxFileSizeSupportedOptions input)
        {

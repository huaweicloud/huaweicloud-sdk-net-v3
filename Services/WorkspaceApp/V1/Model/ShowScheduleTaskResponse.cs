...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowScheduleTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowScheduleTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowScheduleTaskResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UploadAppIconRawResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UploadAppIconRawResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadAppIconRawResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class DeleteUserStorageAttachmentRequest 
    {
        ...
        public DeleteUserStorageAttachmentReq Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteUserStorageAttachmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteUserStorageAttachmentRequest input)
        {

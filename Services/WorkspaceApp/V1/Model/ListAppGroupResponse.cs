...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAppGroupResponse : SdkResponse
    {
        ...
        public List<AppGroup> Items { get; set; }
        ...
        {
            return this.Equals(input as ListAppGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAppGroupResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAppGroupDetailResponse : SdkResponse
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  appServerGroupDescription: ").Append(AppServerGroupDescription).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowAppGroupDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAppGroupDetailResponse input)
        {
            ...
            if (this.AppServerGroupDescription != input.AppServerGroupDescription || (this.AppServerGroupDescription != null && !this.AppServerGroupDescription.Equals(input.AppServerGroupDescription))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AppServerGroupDescription != null) hashCode = hashCode * 59 + this.AppServerGroupDescription.GetHashCode();
                return hashCode;
            }
        }
    }

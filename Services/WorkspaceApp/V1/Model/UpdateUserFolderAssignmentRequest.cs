...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class UpdateUserFolderAssignmentRequest 
    {
        ...
        public AssignUserFolderReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateUserFolderAssignmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateUserFolderAssignmentRequest input)
        {

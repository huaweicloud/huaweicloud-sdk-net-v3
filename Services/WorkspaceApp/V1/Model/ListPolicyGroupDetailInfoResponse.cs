...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPolicyGroupDetailInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListPolicyGroupDetailInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPolicyGroupDetailInfoResponse input)
        {

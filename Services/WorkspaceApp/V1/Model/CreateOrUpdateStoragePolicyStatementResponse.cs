...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateOrUpdateStoragePolicyStatementResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateOrUpdateStoragePolicyStatementResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateOrUpdateStoragePolicyStatementResponse input)
        {

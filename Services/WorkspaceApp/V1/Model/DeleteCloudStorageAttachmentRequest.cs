...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class DeleteCloudStorageAttachmentRequest 
    {
        ...
        public DeleteCloudStorageAttachmentReq Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteCloudStorageAttachmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteCloudStorageAttachmentRequest input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class UsbPortRedirectionOptions 
    {
        ...
        /// </summary>
        /// <value>USB 重定向模式。取值为： - Classical mode：经典模式。 - Common mode：通用模式。</value>
        ...
        {
            return this.Equals(input as UsbPortRedirectionOptions);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UsbPortRedirectionOptions input)
        {

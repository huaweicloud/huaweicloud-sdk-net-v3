...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateShareFolderResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateShareFolderResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateShareFolderResponse input)
        {

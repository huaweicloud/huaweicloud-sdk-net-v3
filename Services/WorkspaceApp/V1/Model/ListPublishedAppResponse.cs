...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPublishedAppResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListPublishedAppResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPublishedAppResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class UpdateNonMigrationUsersRequest 
    {
        ...
        public UpdateNonMigrationUsersReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateNonMigrationUsersRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNonMigrationUsersRequest input)
        {

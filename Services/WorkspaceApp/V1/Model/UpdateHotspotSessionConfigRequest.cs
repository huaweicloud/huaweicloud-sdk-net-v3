...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class UpdateHotspotSessionConfigRequest 
    {
        ...
        public UpdateHotspotSessionConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateHotspotSessionConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotspotSessionConfigRequest input)
        {

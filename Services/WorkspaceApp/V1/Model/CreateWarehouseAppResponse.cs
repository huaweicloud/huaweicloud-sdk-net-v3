...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWarehouseAppResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateWarehouseAppResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWarehouseAppResponse input)
        {

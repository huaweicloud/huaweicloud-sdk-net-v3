...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowOriginalPolicyInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowOriginalPolicyInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowOriginalPolicyInfoResponse input)
        {

...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    public class ResendAuthorizationMailReq 
    {
        ...
        public List<AuthorizationMail> Records { get; set; }
        ...
        {
            return this.Equals(input as ResendAuthorizationMailReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResendAuthorizationMailReq input)
        {

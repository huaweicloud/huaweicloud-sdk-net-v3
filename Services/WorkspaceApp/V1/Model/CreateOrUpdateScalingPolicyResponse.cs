...
namespace HuaweiCloud.SDK.WorkspaceApp.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateOrUpdateScalingPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateOrUpdateScalingPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateOrUpdateScalingPolicyResponse input)
        {

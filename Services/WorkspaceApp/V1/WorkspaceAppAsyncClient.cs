...
namespace HuaweiCloud.SDK.WorkspaceApp.V1
{
    public partial class WorkspaceAppAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CheckPublishAppResponse> CheckPublishAppAsync(CheckPublishAppRequest checkPublishAppRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(checkPublishAppRequest.AppGroupId, out var valueOfAppGroupId)) urlParam.Add("app_group_id", valueOfAppGroupId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-groups/{app_group_id}/apps/actions/check", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkPublishAppRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CheckPublishAppResponse>(response);
        }

        public AsyncInvoker<CheckPublishAppResponse> CheckPublishAppAsyncInvoker(CheckPublishAppRequest checkPublishAppRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(checkPublishAppRequest.AppGroupId, out var valueOfAppGroupId)) urlParam.Add("app_group_id", valueOfAppGroupId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-groups/{app_group_id}/apps/actions/check", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkPublishAppRequest);
            return new AsyncInvoker<CheckPublishAppResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckPublishAppResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UploadAppIconRawResponse> UploadAppIconRawAsync(UploadAppIconRawRequest uploadAppIconRawRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UploadAppIconRawResponse> UploadAppIconRawAsyncInvoker(UploadAppIconRawRequest uploadAppIconRawRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(uploadAppIconRawRequest.AppGroupId, out var valueOfAppGroupId)) urlParam.Add("app_group_id", valueOfAppGroupId);
            if (StringUtils.TryConvertToNonEmptyString(uploadAppIconRawRequest.AppId, out var valueOfAppId)) urlParam.Add("app_id", valueOfAppId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-groups/{app_group_id}/apps/{app_id}/raw-icon", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", uploadAppIconRawRequest);
            return new AsyncInvoker<UploadAppIconRawResponse>(this, "PUT", request, JsonUtils.DeSerialize<UploadAppIconRawResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CheckAppGroupResponse> CheckAppGroupAsync(CheckAppGroupRequest checkAppGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CheckAppGroupResponse> CheckAppGroupAsyncInvoker(CheckAppGroupRequest checkAppGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-groups/rules/validate", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkAppGroupRequest);
            return new AsyncInvoker<CheckAppGroupResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckAppGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ChangeClusterResponse> ChangeClusterAsync(ChangeClusterRequest changeClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeClusterRequest.StorageId, out var valueOfStorageId)) urlParam.Add("storage_id", valueOfStorageId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/cloud-storages/{storage_id}/actions/change-cluster", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", changeClusterRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<ChangeClusterResponse>(response);
        }

        public AsyncInvoker<ChangeClusterResponse> ChangeClusterAsyncInvoker(ChangeClusterRequest changeClusterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(changeClusterRequest.StorageId, out var valueOfStorageId)) urlParam.Add("storage_id", valueOfStorageId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/cloud-storages/{storage_id}/actions/change-cluster", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", changeClusterRequest);
            return new AsyncInvoker<ChangeClusterResponse>(this, "POST", request, JsonUtils.DeSerialize<ChangeClusterResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListFoldersAndFilesResponse> ListFoldersAndFilesAsync(ListFoldersAndFilesRequest listFoldersAndFilesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListFoldersAndFilesResponse> ListFoldersAndFilesAsyncInvoker(ListFoldersAndFilesRequest listFoldersAndFilesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/cloud-storages/actions/list-folder-files", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listFoldersAndFilesRequest);
            return new AsyncInvoker<ListFoldersAndFilesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListFoldersAndFilesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ResetUserProfileResponse> ResetUserProfileAsync(ResetUserProfileRequest resetUserProfileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ResetUserProfileResponse> ResetUserProfileAsyncInvoker(ResetUserProfileRequest resetUserProfileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/cloud-storages/actions/reset-userprofile", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", resetUserProfileRequest);
            return new AsyncInvoker<ResetUserProfileResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ResetUserProfileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<TransferFileResponse> TransferFileAsync(TransferFileRequest transferFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<TransferFileResponse> TransferFileAsyncInvoker(TransferFileRequest transferFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/cloud-storages/actions/transfer-file", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", transferFileRequest);
            return new AsyncInvoker<TransferFileResponse>(this, "POST", request, JsonUtils.DeSerialize<TransferFileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<TransferFilePreResponse> TransferFilePreAsync(TransferFilePreRequest transferFilePreRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<TransferFilePreResponse> TransferFilePreAsyncInvoker(TransferFilePreRequest transferFilePreRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/cloud-storages/actions/pre-transfer-file", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", transferFilePreRequest);
            return new AsyncInvoker<TransferFilePreResponse>(this, "POST", request, JsonUtils.DeSerialize<TransferFilePreResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateHotspotSessionConfigResponse> CreateHotspotSessionConfigAsync(CreateHotspotSessionConfigRequest createHotspotSessionConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createHotspotSessionConfigRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CreateHotspotSessionConfigResponse>(response);
        }

        public AsyncInvoker<CreateHotspotSessionConfigResponse> CreateHotspotSessionConfigAsyncInvoker(CreateHotspotSessionConfigRequest createHotspotSessionConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createHotspotSessionConfigRequest);
            return new AsyncInvoker<CreateHotspotSessionConfigResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateHotspotSessionConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListHotspotSessionConfigResponse> ListHotspotSessionConfigAsync(ListHotspotSessionConfigRequest listHotspotSessionConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHotspotSessionConfigRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListHotspotSessionConfigResponse>(response);
        }

        public AsyncInvoker<ListHotspotSessionConfigResponse> ListHotspotSessionConfigAsyncInvoker(ListHotspotSessionConfigRequest listHotspotSessionConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHotspotSessionConfigRequest);
            return new AsyncInvoker<ListHotspotSessionConfigResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHotspotSessionConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListNonMigrationUsersResponse> ListNonMigrationUsersAsync(ListNonMigrationUsersRequest listNonMigrationUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listNonMigrationUsersRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listNonMigrationUsersRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListNonMigrationUsersResponse>(response);
        }

        public AsyncInvoker<ListNonMigrationUsersResponse> ListNonMigrationUsersAsyncInvoker(ListNonMigrationUsersRequest listNonMigrationUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listNonMigrationUsersRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listNonMigrationUsersRequest);
            return new AsyncInvoker<ListNonMigrationUsersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListNonMigrationUsersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateHotspotSessionConfigResponse> UpdateHotspotSessionConfigAsync(UpdateHotspotSessionConfigRequest updateHotspotSessionConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateHotspotSessionConfigRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config/{config_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateHotspotSessionConfigRequest);
            var response = await DoHttpRequestAsync("PATCH", request);
            return JsonUtils.DeSerialize<UpdateHotspotSessionConfigResponse>(response);
        }

        public AsyncInvoker<UpdateHotspotSessionConfigResponse> UpdateHotspotSessionConfigAsyncInvoker(UpdateHotspotSessionConfigRequest updateHotspotSessionConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateHotspotSessionConfigRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config/{config_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateHotspotSessionConfigRequest);
            return new AsyncInvoker<UpdateHotspotSessionConfigResponse>(this, "PATCH", request, JsonUtils.DeSerialize<UpdateHotspotSessionConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateNonMigrationUsersResponse> UpdateNonMigrationUsersAsync(UpdateNonMigrationUsersRequest updateNonMigrationUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateNonMigrationUsersRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateNonMigrationUsersRequest);
            var response = await DoHttpRequestAsync("PATCH", request);
            return JsonUtils.DeSerializeNull<UpdateNonMigrationUsersResponse>(response);
        }

        public AsyncInvoker<UpdateNonMigrationUsersResponse> UpdateNonMigrationUsersAsyncInvoker(UpdateNonMigrationUsersRequest updateNonMigrationUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateNonMigrationUsersRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateNonMigrationUsersRequest);
            return new AsyncInvoker<UpdateNonMigrationUsersResponse>(this, "PATCH", request, JsonUtils.DeSerializeNull<UpdateNonMigrationUsersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CountImageSubJobsResponse> CountImageSubJobsAsync(CountImageSubJobsRequest countImageSubJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CountImageSubJobsResponse> CountImageSubJobsAsyncInvoker(CountImageSubJobsRequest countImageSubJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/image-server-sub-jobs/actions/count", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", countImageSubJobsRequest);
            return new AsyncInvoker<CountImageSubJobsResponse>(this, "GET", request, JsonUtils.DeSerialize<CountImageSubJobsResponse>);
        }
        ...
        public async Task<BatchUpgradeHdaVersionResponse> BatchUpgradeHdaVersionAsync(BatchUpgradeHdaVersionRequest batchUpgradeHdaVersionRequest)
        {
            ...
            var response = await DoHttpRequestAsync("PATCH", request);
            return JsonUtils.DeSerialize<BatchUpgradeHdaVersionResponse>(response);
        }
        ...
        public AsyncInvoker<BatchUpgradeHdaVersionResponse> BatchUpgradeHdaVersionAsyncInvoker(BatchUpgradeHdaVersionRequest batchUpgradeHdaVersionRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-servers/access-agent/actions/upgrade", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchUpgradeHdaVersionRequest);
            return new AsyncInvoker<BatchUpgradeHdaVersionResponse>(this, "PATCH", request, JsonUtils.DeSerialize<BatchUpgradeHdaVersionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowHdaUpgradeFlagResponse> ShowHdaUpgradeFlagAsync(ShowHdaUpgradeFlagRequest showHdaUpgradeFlagRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowHdaUpgradeFlagResponse> ShowHdaUpgradeFlagAsyncInvoker(ShowHdaUpgradeFlagRequest showHdaUpgradeFlagRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-servers/access-agent/upgrade-flag", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHdaUpgradeFlagRequest);
            return new AsyncInvoker<ShowHdaUpgradeFlagResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHdaUpgradeFlagResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ValidateServerGroupResponse> ValidateServerGroupAsync(ValidateServerGroupRequest validateServerGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ValidateServerGroupResponse> ValidateServerGroupAsyncInvoker(ValidateServerGroupRequest validateServerGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/app-server-groups/rules/validate", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", validateServerGroupRequest);
            return new AsyncInvoker<ValidateServerGroupResponse>(this, "POST", request, JsonUtils.DeSerialize<ValidateServerGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ExportAppConnectionResponse> ExportAppConnectionAsync(ExportAppConnectionRequest exportAppConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ExportAppConnectionResponse> ExportAppConnectionAsyncInvoker(ExportAppConnectionRequest exportAppConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/session/app-connection/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportAppConnectionRequest);
            return new AsyncInvoker<ExportAppConnectionResponse>(this, "POST", request, JsonUtils.DeSerialize<ExportAppConnectionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ExportSessionsResponse> ExportSessionsAsync(ExportSessionsRequest exportSessionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ExportSessionsResponse> ExportSessionsAsyncInvoker(ExportSessionsRequest exportSessionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/session/list-sessions/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportSessionsRequest);
            return new AsyncInvoker<ExportSessionsResponse>(this, "POST", request, JsonUtils.DeSerialize<ExportSessionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ExportUserConnectionResponse> ExportUserConnectionAsync(ExportUserConnectionRequest exportUserConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ExportUserConnectionResponse> ExportUserConnectionAsyncInvoker(ExportUserConnectionRequest exportUserConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/session/user-connection/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUserConnectionRequest);
            return new AsyncInvoker<ExportUserConnectionResponse>(this, "POST", request, JsonUtils.DeSerialize<ExportUserConnectionResponse>);
        }

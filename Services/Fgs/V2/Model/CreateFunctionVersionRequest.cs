...
namespace HuaweiCloud.SDK.Fgs.V2.Model
{
    ...
    public class CreateFunctionVersionRequest 
    {
        ...
        public CreateFunctionVersionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateFunctionVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFunctionVersionRequest input)
        {
            if (input == null)
                return false;

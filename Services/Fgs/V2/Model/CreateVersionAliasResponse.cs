...
namespace HuaweiCloud.SDK.Fgs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateVersionAliasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateVersionAliasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVersionAliasResponse input)
        {
            if (input == null)
                return false;

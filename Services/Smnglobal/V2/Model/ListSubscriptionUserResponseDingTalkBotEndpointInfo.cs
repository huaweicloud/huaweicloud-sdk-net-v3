...
namespace HuaweiCloud.SDK.Smnglobal.V2.Model
{
    ...
    public class ListSubscriptionUserResponseDingTalkBotEndpointInfo 
    {
        ...
        {
            return this.Equals(input as ListSubscriptionUserResponseDingTalkBotEndpointInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubscriptionUserResponseDingTalkBotEndpointInfo input)
        {

...
namespace HuaweiCloud.SDK.Smnglobal.V2.Model
{
    ...
    public class CreateSubscriptionUserRequestDingdingEndpointInfo 
    {
        ...
        {
            return this.Equals(input as CreateSubscriptionUserRequestDingdingEndpointInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSubscriptionUserRequestDingdingEndpointInfo input)
        {

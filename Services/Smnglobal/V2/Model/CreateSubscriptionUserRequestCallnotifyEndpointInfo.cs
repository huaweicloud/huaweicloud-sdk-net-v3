...
namespace HuaweiCloud.SDK.Smnglobal.V2.Model
{
    ...
    public class CreateSubscriptionUserRequestCallnotifyEndpointInfo 
    {
        ...
        {
            return this.Equals(input as CreateSubscriptionUserRequestCallnotifyEndpointInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSubscriptionUserRequestCallnotifyEndpointInfo input)
        {

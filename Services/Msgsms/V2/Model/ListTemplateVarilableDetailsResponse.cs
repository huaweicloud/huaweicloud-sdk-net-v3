...
namespace HuaweiCloud.SDK.Msgsms.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTemplateVarilableDetailsResponse : SdkResponse
    {
        ...
        public List<ApiTemplateVariable> Results { get; set; }
        ...
        {
            return this.Equals(input as ListTemplateVarilableDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTemplateVarilableDetailsResponse input)
        {

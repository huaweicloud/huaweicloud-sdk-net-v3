...
namespace HuaweiCloud.SDK.Msgsms.V2.Model
{
    ...
    public class UploadSignatureFileRequest 
    {
        ...
        /// 描述
        /// </summary>
        [SDKProperty("file_desc", IsQuery = true)]
        ...
        public UploadSignatureFileRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UploadSignatureFileRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadSignatureFileRequest input)
        {

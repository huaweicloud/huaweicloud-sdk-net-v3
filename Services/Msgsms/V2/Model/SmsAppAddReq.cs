...
namespace HuaweiCloud.SDK.Msgsms.V2.Model
{
    ...
    public class SmsAppAddReq 
    {
        ...
        public bool Equals(SmsAppAddReq input)
        {
            ...
            if (this.ShowSecret != input.ShowSecret || (this.ShowSecret != null && !this.ShowSecret.Equals(input.ShowSecret))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ShowSecret != null) hashCode = hashCode * 59 + this.ShowSecret.GetHashCode();
                return hashCode;
            }
        }
    }

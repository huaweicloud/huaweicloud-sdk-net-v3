...
namespace HuaweiCloud.SDK.Elb.V2
{
    public class ElbRegion
    {
        ...
        public static readonly Region CN_NORTH_9 = new Region("cn-north-9", "https://elb.cn-north-9.myhuaweicloud.com");
        public static readonly Region LA_SOUTH_2 = new Region("la-south-2", "https://elb.la-south-2.myhuaweicloud.com");
        public static readonly Region SA_BRAZIL_1 = new Region("sa-brazil-1", "https://elb.sa-brazil-1.myhuaweicloud.com");
        public static readonly Region NA_MEXICO_1 = new Region("na-mexico-1", "https://elb.na-mexico-1.myhuaweicloud.com");
        public static readonly Region LA_NORTH_2 = new Region("la-north-2", "https://elb.la-north-2.myhuaweicloud.com");

...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class BatchDeleteListenerTagsRequest 
    {
        ...
        public BatchDeleteListenerTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteListenerTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteListenerTagsRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class PoolsV2InStatusResp 
    {
        ...
        public List<MembersV2InStatusResp> Members { get; set; }
        ...
        public HealthmonitorsV2InStatusResp Healthmonitor { get; set; }
        ...
        {
            return this.Equals(input as PoolsV2InStatusResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PoolsV2InStatusResp input)
        {
            if (input == null)
                return false;

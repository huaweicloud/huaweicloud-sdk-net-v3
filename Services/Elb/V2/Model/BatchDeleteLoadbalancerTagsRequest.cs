...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class BatchDeleteLoadbalancerTagsRequest 
    {
        ...
        public BatchDeleteLoadbalancerTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteLoadbalancerTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteLoadbalancerTagsRequest input)
        {
            if (input == null)
                return false;

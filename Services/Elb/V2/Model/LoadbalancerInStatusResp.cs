...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class LoadbalancerInStatusResp 
    {
        ...
        public List<ListenersInStatusResp> Listeners { get; set; }
        ...
        {
            return this.Equals(input as LoadbalancerInStatusResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(LoadbalancerInStatusResp input)
        {
            if (input == null)
                return false;

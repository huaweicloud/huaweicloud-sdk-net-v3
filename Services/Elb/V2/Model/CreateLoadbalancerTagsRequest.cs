...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class CreateLoadbalancerTagsRequest 
    {
        ...
        public CreateLoadbalancerTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateLoadbalancerTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateLoadbalancerTagsRequest input)
        {
            if (input == null)
                return false;

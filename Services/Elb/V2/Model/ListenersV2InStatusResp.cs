...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class ListenersV2InStatusResp 
    {
        ...
        public List<L7policiesV2InStatusResp> L7policies { get; set; }
        ...
        {
            return this.Equals(input as ListenersV2InStatusResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListenersV2InStatusResp input)
        {
            if (input == null)
                return false;

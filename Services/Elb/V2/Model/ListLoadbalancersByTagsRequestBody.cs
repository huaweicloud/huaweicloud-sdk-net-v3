...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    public class ListLoadbalancersByTagsRequestBody 
    {
        ...
        public List<ActionMatch> Matches { get; set; }
        ...
        {
            return this.Equals(input as ListLoadbalancersByTagsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLoadbalancersByTagsRequestBody input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Elb.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWhitelistResponse : SdkResponse
    {
        ...
        public WhitelistV2Resp Whitelist { get; set; }
        ...
        {
            return this.Equals(input as CreateWhitelistResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWhitelistResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class DeleteLoadBalancerCascadeRequestBody 
    {
        ...
        public DeleteLoadBalancerCascadeOption Loadbalancer { get; set; }
        ...
        {
            return this.Equals(input as DeleteLoadBalancerCascadeRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteLoadBalancerCascadeRequestBody input)
        {

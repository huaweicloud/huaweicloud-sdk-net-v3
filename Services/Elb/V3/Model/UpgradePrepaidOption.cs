...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class UpgradePrepaidOption 
    {
        ...
        /// </summary>
        /// <value>参数解释：预付费实例的订购周期类型，当前支持月和年。  取值范围：  - month：月。  - year：年。</value>
        ...
        /// 参数解释：购买定向套餐包。
        /// </summary>
        [JsonProperty("resource_package_type", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> ResourcePackageType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  resourcePackageType: ").Append(ResourcePackageType).Append("\n");
        ...
        {
            return this.Equals(input as UpgradePrepaidOption);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradePrepaidOption input)
        {
            ...
            if (this.ResourcePackageType != input.ResourcePackageType || (this.ResourcePackageType != null && input.ResourcePackageType != null && !this.ResourcePackageType.SequenceEqual(input.ResourcePackageType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResourcePackageType != null) hashCode = hashCode * 59 + this.ResourcePackageType.GetHashCode();

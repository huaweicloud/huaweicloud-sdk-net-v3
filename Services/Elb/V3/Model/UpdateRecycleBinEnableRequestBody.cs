...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class UpdateRecycleBinEnableRequestBody 
    {
        ...
        public RecycleBinRequestBody RecycleBin { get; set; }
        ...
        {
            return this.Equals(input as UpdateRecycleBinEnableRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecycleBinEnableRequestBody input)
        {

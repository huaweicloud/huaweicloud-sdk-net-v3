...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class SystemSecurityPolicy 
    {
        ...
        public bool Equals(SystemSecurityPolicy input)
        {
            ...
            if (this.Protocols != input.Protocols || (this.Protocols != null && !this.Protocols.Equals(input.Protocols))) return false;
            if (this.Ciphers != input.Ciphers || (this.Ciphers != null && !this.Ciphers.Equals(input.Ciphers))) return false;

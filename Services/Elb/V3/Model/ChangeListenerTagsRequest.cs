...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class ChangeListenerTagsRequest 
    {
        ...
        public ChangeListenerTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeListenerTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeListenerTagsRequest input)
        {

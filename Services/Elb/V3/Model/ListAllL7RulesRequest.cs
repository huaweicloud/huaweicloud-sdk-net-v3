...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class ListAllL7RulesRequest 
    {
        ...
        /// </summary>
        [SDKProperty("l7policy_id", IsQuery = true)]
        [JsonProperty("l7policy_id", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> L7policyId { get; set; }
        ...
        public bool Equals(ListAllL7RulesRequest input)
        {
            ...
            if (this.L7policyId != input.L7policyId || (this.L7policyId != null && input.L7policyId != null && !this.L7policyId.SequenceEqual(input.L7policyId))) return false;

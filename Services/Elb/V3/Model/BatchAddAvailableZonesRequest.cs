...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class BatchAddAvailableZonesRequest 
    {
        ...
        public BatchAddAvailableZonesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAddAvailableZonesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddAvailableZonesRequest input)
        {

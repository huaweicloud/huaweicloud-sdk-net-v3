...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDisableDomainIPsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDisableDomainIPsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDisableDomainIPsResponse input)
        {

...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowLoadBalancerPortsResponse : SdkResponse
    {
        ...
        public List<LocalPort> Ports { get; set; }
        ...
        {
            return this.Equals(input as ShowLoadBalancerPortsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowLoadBalancerPortsResponse input)
        {

...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchAddAvailableZonesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchAddAvailableZonesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddAvailableZonesResponse input)
        {

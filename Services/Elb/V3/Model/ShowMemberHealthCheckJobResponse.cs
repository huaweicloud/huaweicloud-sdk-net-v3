...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMemberHealthCheckJobResponse : SdkResponse
    {
        ...
        public MemberCheckJobInfo MemberCheck { get; set; }
        ...
        {
            return this.Equals(input as ShowMemberHealthCheckJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMemberHealthCheckJobResponse input)
        {

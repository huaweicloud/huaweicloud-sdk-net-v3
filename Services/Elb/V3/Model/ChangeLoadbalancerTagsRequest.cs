...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class ChangeLoadbalancerTagsRequest 
    {
        ...
        public ChangeLoadbalancerTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeLoadbalancerTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeLoadbalancerTagsRequest input)
        {

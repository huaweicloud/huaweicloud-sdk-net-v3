...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateUserDefinedDomainConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateUserDefinedDomainConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateUserDefinedDomainConfigResponse input)
        {

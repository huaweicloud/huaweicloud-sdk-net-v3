...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRecycleBinPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRecycleBinPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecycleBinPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMasterSlavePoolsResponse : SdkResponse
    {
        ...
        public List<MasterSlavePool> Pools { get; set; }
        ...
        {
            return this.Equals(input as ListMasterSlavePoolsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMasterSlavePoolsResponse input)
        {
            if (input == null)
                return false;

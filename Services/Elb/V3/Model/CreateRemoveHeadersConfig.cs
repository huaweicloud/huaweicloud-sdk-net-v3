...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class CreateRemoveHeadersConfig 
    {
        ...
        public List<CreateRemoveHeaderConfig> Configs { get; set; }
        ...
        {
            return this.Equals(input as CreateRemoveHeadersConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRemoveHeadersConfig input)
        {
            if (input == null)
                return false;

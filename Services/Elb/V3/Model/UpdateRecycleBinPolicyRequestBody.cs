...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class UpdateRecycleBinPolicyRequestBody 
    {
        ...
        public RecycleBinPolicyRequestBody RecycleBin { get; set; }
        ...
        {
            return this.Equals(input as UpdateRecycleBinPolicyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecycleBinPolicyRequestBody input)
        {

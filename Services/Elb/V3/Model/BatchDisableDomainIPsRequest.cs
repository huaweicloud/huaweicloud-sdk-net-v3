...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class BatchDisableDomainIPsRequest 
    {
        ...
        public BatchDisableDomainIPsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDisableDomainIPsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDisableDomainIPsRequest input)
        {

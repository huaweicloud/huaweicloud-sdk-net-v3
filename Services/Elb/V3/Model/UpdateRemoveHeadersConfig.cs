...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class UpdateRemoveHeadersConfig 
    {
        ...
        public List<UpdateRemoveHeaderConfig> Configs { get; set; }
        ...
        {
            return this.Equals(input as UpdateRemoveHeadersConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRemoveHeadersConfig input)
        {
            if (input == null)
                return false;

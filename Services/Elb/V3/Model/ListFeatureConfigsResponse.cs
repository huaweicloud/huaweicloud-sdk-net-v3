...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListFeatureConfigsResponse : SdkResponse
    {
        ...
        public List<FeatureConfig> Configs { get; set; }
        ...
        {
            return this.Equals(input as ListFeatureConfigsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListFeatureConfigsResponse input)
        {

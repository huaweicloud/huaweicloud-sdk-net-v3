...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    public class BatchEnableDomainIPsRequest 
    {
        ...
        public BatchEnableDomainIPsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchEnableDomainIPsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchEnableDomainIPsRequest input)
        {

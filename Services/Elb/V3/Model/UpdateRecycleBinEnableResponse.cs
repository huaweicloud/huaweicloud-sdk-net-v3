...
namespace HuaweiCloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRecycleBinEnableResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRecycleBinEnableResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecycleBinEnableResponse input)
        {

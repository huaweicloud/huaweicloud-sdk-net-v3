...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class OpenWebinarOngoingInfo 
    {
        ...
        /// 实时在线人数。
        /// </summary>
        [JsonProperty("onlineAttendeeCount", NullValueHandling = NullValueHandling.Ignore)]
        public int? OnlineAttendeeCount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  onlineAttendeeCount: ").Append(OnlineAttendeeCount).Append("\n");
        ...
        {
            return this.Equals(input as OpenWebinarOngoingInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(OpenWebinarOngoingInfo input)
        {
            if (input == null) return false;
            if (this.OnlineAttendeeCount != input.OnlineAttendeeCount || (this.OnlineAttendeeCount != null && !this.OnlineAttendeeCount.Equals(input.OnlineAttendeeCount))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.OnlineAttendeeCount != null) hashCode = hashCode * 59 + this.OnlineAttendeeCount.GetHashCode();

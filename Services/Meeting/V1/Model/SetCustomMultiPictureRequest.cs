...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SetCustomMultiPictureRequest 
    {
        ...
        public RestCustomMultiPictureBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetCustomMultiPictureRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetCustomMultiPictureRequest input)
        {

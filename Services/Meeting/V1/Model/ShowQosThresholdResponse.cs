...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowQosThresholdResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowQosThresholdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowQosThresholdResponse input)
        {

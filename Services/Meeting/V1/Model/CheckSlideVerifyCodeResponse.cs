...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CheckSlideVerifyCodeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CheckSlideVerifyCodeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckSlideVerifyCodeResponse input)
        {

...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class BatchMoveToWaitingRoomRequest 
    {
        ...
        public RestBatchMoveToWaitingRoomReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchMoveToWaitingRoomRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchMoveToWaitingRoomRequest input)
        {

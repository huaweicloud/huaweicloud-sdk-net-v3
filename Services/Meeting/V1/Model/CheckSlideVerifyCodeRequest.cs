...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class CheckSlideVerifyCodeRequest 
    {
        ...
        public SlideVerifyCodeCheckDTO Body { get; set; }
        ...
        {
            return this.Equals(input as CheckSlideVerifyCodeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckSlideVerifyCodeRequest input)
        {

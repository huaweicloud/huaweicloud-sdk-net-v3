...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class BatchShowUserDetailsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("idType", IsQuery = true)]
        ...
        public List<ShowUserRequestDTO> Body { get; set; }
        ...
        {
            return this.Equals(input as BatchShowUserDetailsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchShowUserDetailsRequest input)
        {

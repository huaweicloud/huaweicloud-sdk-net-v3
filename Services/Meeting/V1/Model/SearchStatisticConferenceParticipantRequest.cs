...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SearchStatisticConferenceParticipantRequest 
    {
        ...
        /// </summary>
        /// <value>查询分类，取值： * user_participate_info: 用户与会统计数据 * hard_terminal_participate_info: 硬件终端与会统计数据 * participant_type_info: 与会设备统计数据</value>
        ...
        public class CategoryEnum
        {
            ...
            /// </summary>
            public static readonly CategoryEnum USER_PARTICIPATE_INFO = new CategoryEnum("user_participate_info");

            /// <summary>
            /// Enum HARD_TERMINAL_PARTICIPATE_INFO for value: hard_terminal_participate_info
            /// </summary>
            public static readonly CategoryEnum HARD_TERMINAL_PARTICIPATE_INFO = new CategoryEnum("hard_terminal_participate_info");

            /// <summary>
            /// Enum PARTICIPANT_TYPE_INFO for value: participant_type_info
            /// </summary>
            public static readonly CategoryEnum PARTICIPANT_TYPE_INFO = new CategoryEnum("participant_type_info");
        ...
        {
            return this.Equals(input as SearchStatisticConferenceParticipantRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchStatisticConferenceParticipantRequest input)
        {

...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SendVeriCodeForChangePwdRequest 
    {
        ...
        public VerifyCodeSendDTOV1 Body { get; set; }
        ...
        {
            return this.Equals(input as SendVeriCodeForChangePwdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SendVeriCodeForChangePwdRequest input)
        {

...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateVisionActiveCodeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateVisionActiveCodeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVisionActiveCodeResponse input)
        {

...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class CheckVeriCodeForUpdateUserInfoRequest 
    {
        ...
        public VerificationCodeDTO Body { get; set; }
        ...
        {
            return this.Equals(input as CheckVeriCodeForUpdateUserInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckVeriCodeForUpdateUserInfoRequest input)
        {

...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class AddCorpDTO 
    {
        ...
        {
            return this.Equals(input as AddCorpDTO);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddCorpDTO input)
        {

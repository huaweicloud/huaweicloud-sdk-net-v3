...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class ResumeSimultaneousInterpretationRequest 
    {
        ...
        public RestSimultaneousInterpretationBody Body { get; set; }
        ...
        {
            return this.Equals(input as ResumeSimultaneousInterpretationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResumeSimultaneousInterpretationRequest input)
        {

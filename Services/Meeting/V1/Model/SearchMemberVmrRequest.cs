...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SearchMemberVmrRequest 
    {
        ...
        /// </summary>
        [SDKProperty("specialVmr", IsQuery = true)]
        [JsonProperty("specialVmr", NullValueHandling = NullValueHandling.Ignore)]
        public bool? SpecialVmr { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  specialVmr: ").Append(SpecialVmr).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SearchMemberVmrRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchMemberVmrRequest input)
        {
            ...
            if (this.SpecialVmr != input.SpecialVmr || (this.SpecialVmr != null && !this.SpecialVmr.Equals(input.SpecialVmr))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SpecialVmr != null) hashCode = hashCode * 59 + this.SpecialVmr.GetHashCode();
                return hashCode;
            }
        }
    }

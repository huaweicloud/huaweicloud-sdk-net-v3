...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SearchStatisticConferenceInfoRequest 
    {
        ...
        /// </summary>
        /// <value>查询分类，取值： * conference_info: 会议总体数据 * conference_hourly_info: 单日内会议总体数据 * category &#x3D; conference_hourly_info的情况，timeUnit只能取值&#39;D&#39;，且startTime与endTime必须为同一天</value>
        ...
        public class CategoryEnum
        {
            ...
            /// </summary>
            public static readonly CategoryEnum CONFERENCE_INFO = new CategoryEnum("conference_info");

            /// <summary>
            /// Enum CONFERENCE_HOURLY_INFO for value: conference_hourly_info
            /// </summary>
            public static readonly CategoryEnum CONFERENCE_HOURLY_INFO = new CategoryEnum("conference_hourly_info");
        ...
        {
            return this.Equals(input as SearchStatisticConferenceInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchStatisticConferenceInfoRequest input)
        {

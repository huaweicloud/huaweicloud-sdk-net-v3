...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class CancelRecurringSubMeetingRequest 
    {
        ...
        public RestCancelSingleRecordCycleConfListReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CancelRecurringSubMeetingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CancelRecurringSubMeetingRequest input)
        {

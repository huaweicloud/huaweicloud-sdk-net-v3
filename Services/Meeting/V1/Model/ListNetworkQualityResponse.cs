...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListNetworkQualityResponse : SdkResponse
    {
        ...
        /// 会场Qos列表
        /// </summary>
        [JsonProperty("qosList", NullValueHandling = NullValueHandling.Ignore)]
        public List<UserQos> QosList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  qosList: ").Append(QosList).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ListNetworkQualityResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNetworkQualityResponse input)
        {
            ...
            if (this.QosList != input.QosList || (this.QosList != null && input.QosList != null && !this.QosList.SequenceEqual(input.QosList))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QosList != null) hashCode = hashCode * 59 + this.QosList.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    /// 
    /// </summary>
    public class AddMaterialRequestBody : IFormDataBody
    {
        ...
        public AddMaterialRequestBody WithFile(Stream stream, string filename)
        {
            this.File = new FormDataFilePart(stream, filename);
            return this;
        }

        public AddMaterialRequestBody WithFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as AddMaterialRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddMaterialRequestBody input)
        {

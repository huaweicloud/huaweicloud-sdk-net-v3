...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class UpdateRoomSettingRequest 
    {
        ...
        /// 网络研讨会ID。
        /// </summary>
        [SDKProperty("conference_id", IsPath = true)]
        [JsonProperty("conference_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public OpenRoomSettingReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRoomSettingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRoomSettingRequest input)
        {

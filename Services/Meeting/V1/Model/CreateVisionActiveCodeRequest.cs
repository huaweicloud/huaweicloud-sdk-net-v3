...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class CreateVisionActiveCodeRequest 
    {
        ...
        public VisionActiveCodeDTO Body { get; set; }
        ...
        {
            return this.Equals(input as CreateVisionActiveCodeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVisionActiveCodeRequest input)
        {

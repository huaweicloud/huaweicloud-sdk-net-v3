...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class ShowQosThresholdRequest 
    {
        ...
        /// </summary>
        /// <value>阈值类型。 * AUDIO：音频告警阈值 * VIDEO：视频告警阈值 * SCREEN：屏幕共享告警阈值 * CPU：CPU告警阈值</value>
        ...
        {
            return this.Equals(input as ShowQosThresholdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowQosThresholdRequest input)
        {

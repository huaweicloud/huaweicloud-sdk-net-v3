...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class AllowWaitingParticipantRequest 
    {
        ...
        public RestAllowWaitingParticipantReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as AllowWaitingParticipantRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AllowWaitingParticipantRequest input)
        {

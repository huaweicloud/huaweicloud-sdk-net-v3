...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SetAttendeeLanChannelRequest 
    {
        ...
        public RestSetAttendeeLanChannelBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetAttendeeLanChannelRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetAttendeeLanChannelRequest input)
        {

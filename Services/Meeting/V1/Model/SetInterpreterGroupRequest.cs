...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SetInterpreterGroupRequest 
    {
        ...
        public RestSetInterpreterGroupBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetInterpreterGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetInterpreterGroupRequest input)
        {

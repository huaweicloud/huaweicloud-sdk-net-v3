...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class UpdateRecurringSubMeetingRequest 
    {
        ...
        public RestScheduleCycleConfDTO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRecurringSubMeetingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecurringSubMeetingRequest input)
        {

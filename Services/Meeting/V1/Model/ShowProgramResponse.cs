...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProgramResponse : SdkResponse
    {
        ...
        public List<ProgramItemResponseBase> ProgramItemList { get; set; }
        ...
        {
            return this.Equals(input as ShowProgramResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProgramResponse input)
        {

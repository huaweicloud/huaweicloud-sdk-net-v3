...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class UpdateDepartmentRequest 
    {
        ...
        /// 部门编码。 长度： 0-32位。
        /// </summary>
        [SDKProperty("dept_code", IsPath = true)]
        [JsonProperty("dept_code", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public ModDeptDTO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDepartmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDepartmentRequest input)
        {

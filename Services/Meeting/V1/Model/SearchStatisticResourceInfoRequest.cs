...
namespace HuaweiCloud.SDK.Meeting.V1.Model
{
    ...
    public class SearchStatisticResourceInfoRequest 
    {
        ...
        /// </summary>
        /// <value>查询分类，取值： * used_vmr_info: 已购VMR资源使用统计数据 * used_live_info: 已购直播端口资源使用统计数据 * used_record_info: 已购录播资源使用统计数据 * used_pstn_info: 已购电话外呼资源使用统计数据</value>
        ...
        public class CategoryEnum
        {
            ...
            /// </summary>
            public static readonly CategoryEnum USED_VMR_INFO = new CategoryEnum("used_vmr_info");

            /// <summary>
            /// Enum USED_LIVE_INFO for value: used_live_info
            /// </summary>
            public static readonly CategoryEnum USED_LIVE_INFO = new CategoryEnum("used_live_info");

            /// <summary>
            /// Enum USED_RECORD_INFO for value: used_record_info
            /// </summary>
            public static readonly CategoryEnum USED_RECORD_INFO = new CategoryEnum("used_record_info");

            /// <summary>
            /// Enum USED_PSTN_INFO for value: used_pstn_info
            /// </summary>
            public static readonly CategoryEnum USED_PSTN_INFO = new CategoryEnum("used_pstn_info");
        ...
        {
            return this.Equals(input as SearchStatisticResourceInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchStatisticResourceInfoRequest input)
        {

...
namespace HuaweiCloud.SDK.Cts.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateNotificationResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateNotificationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNotificationResponse input)
        {
            if (input == null)
                return false;

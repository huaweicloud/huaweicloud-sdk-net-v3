...
namespace HuaweiCloud.SDK.Cts.V3.Model
{
    ...
    public class BatchDeleteResourceTagsRequest 
    {
        ...
        public BatchDeleteResourceTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteResourceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteResourceTagsRequest input)
        {

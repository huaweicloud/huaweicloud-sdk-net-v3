...
namespace HuaweiCloud.SDK.Cts.V3.Model
{
    ...
    public class ObsInfo 
    {
        ...
        public bool Equals(ObsInfo input)
        {
            ...
            if (this.IsAuthorizedBucket != input.IsAuthorizedBucket || (this.IsAuthorizedBucket != null && !this.IsAuthorizedBucket.Equals(input.IsAuthorizedBucket))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsAuthorizedBucket != null) hashCode = hashCode * 59 + this.IsAuthorizedBucket.GetHashCode();

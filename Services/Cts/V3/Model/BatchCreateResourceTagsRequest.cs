...
namespace HuaweiCloud.SDK.Cts.V3.Model
{
    ...
    public class BatchCreateResourceTagsRequest 
    {
        ...
        /// </summary>
        /// <value>CTS服务的资源类型，目前仅支持cts-tracker。</value>
        ...
        public BatchCreateResourceTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateResourceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateResourceTagsRequest input)
        {
            if (input == null)
                return false;

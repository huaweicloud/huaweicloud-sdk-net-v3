...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeAutoIdDocClassificationRequest 
    {
        ...
        public AutoIdDocClassificationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeAutoIdDocClassificationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeAutoIdDocClassificationRequest input)
        {

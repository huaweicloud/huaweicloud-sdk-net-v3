...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeHouseholdRegisterRequest 
    {
        ...
        public HouseholdRegisterRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeHouseholdRegisterRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeHouseholdRegisterRequest input)
        {
            if (input == null)
                return false;

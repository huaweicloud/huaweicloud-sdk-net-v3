...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeAutoClassificationRequest 
    {
        ...
        public AutoClassificationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeAutoClassificationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeAutoClassificationRequest input)
        {
            if (input == null)
                return false;

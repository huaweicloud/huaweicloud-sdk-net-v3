...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeThailandIdcardRequest 
    {
        ...
        public ThailandIdcardRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeThailandIdcardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeThailandIdcardRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeSmartDocumentRecognizerRequest 
    {
        ...
        public SmartDocumentRecognizerRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeSmartDocumentRecognizerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeSmartDocumentRecognizerRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeGeneralTableRequest 
    {
        ...
        public GeneralTableRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeGeneralTableRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeGeneralTableRequest input)
        {
            if (input == null)
                return false;

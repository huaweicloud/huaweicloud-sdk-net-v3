...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeCustomTemplateRequest 
    {
        ...
        public CustomTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeCustomTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeCustomTemplateRequest input)
        {
            if (input == null)
                return false;

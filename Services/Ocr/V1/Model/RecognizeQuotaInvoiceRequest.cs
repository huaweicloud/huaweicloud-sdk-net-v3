...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeQuotaInvoiceRequest 
    {
        ...
        public QuotaInvoiceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeQuotaInvoiceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeQuotaInvoiceRequest input)
        {

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeQualificationCertificateRequest 
    {
        ...
        public QualificationCertificateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeQualificationCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeQualificationCertificateRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeWaybillElectronicRequest 
    {
        ...
        public WaybillElectronicRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeWaybillElectronicRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeWaybillElectronicRequest input)
        {

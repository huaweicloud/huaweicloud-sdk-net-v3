...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeMainlandTravelPermitRequest 
    {
        ...
        public MainlandTravelPermitRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeMainlandTravelPermitRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeMainlandTravelPermitRequest input)
        {
            if (input == null)
                return false;

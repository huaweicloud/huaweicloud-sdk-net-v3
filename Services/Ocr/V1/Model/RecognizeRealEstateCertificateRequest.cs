...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeRealEstateCertificateRequest 
    {
        ...
        public RealEstateCertificateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeRealEstateCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeRealEstateCertificateRequest input)
        {

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class FinancialStatementWordsRegionList 
    {
        ...
        public bool Equals(FinancialStatementWordsRegionList input)
        {
            ...
            if (this.TableLocation != input.TableLocation || (this.TableLocation != null && input.TableLocation != null && !this.TableLocation.SequenceEqual(input.TableLocation))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TableLocation != null) hashCode = hashCode * 59 + this.TableLocation.GetHashCode();

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeBusinessLicenseRequest 
    {
        ...
        public BusinessLicenseRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeBusinessLicenseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeBusinessLicenseRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class ChileIdCardResult 
    {
        ...
        {
            return this.Equals(input as ChileIdCardResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChileIdCardResult input)
        {
            if (input == null) return false;
            if (this.Surname != input.Surname || (this.Surname != null && input.Surname != null && !this.Surname.SequenceEqual(input.Surname))) return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeFlightItineraryRequest 
    {
        ...
        public FlightItineraryRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeFlightItineraryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeFlightItineraryRequest input)
        {
            if (input == null)
                return false;

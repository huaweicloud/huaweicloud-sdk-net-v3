...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeLicensePlateRequest 
    {
        ...
        public LicensePlateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeLicensePlateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeLicensePlateRequest input)
        {
            if (input == null)
                return false;

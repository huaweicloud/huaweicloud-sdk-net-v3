...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeTransportationLicenseRequest 
    {
        ...
        public TransportationLicenseRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeTransportationLicenseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeTransportationLicenseRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class GeneralTableRequestBody 
    {
        ...
        public bool Equals(GeneralTableRequestBody input)
        {
            ...
            if (this.ReturnCharLocation != input.ReturnCharLocation || (this.ReturnCharLocation != null && !this.ReturnCharLocation.Equals(input.ReturnCharLocation))) return false;
            ...
            if (this.WithBorders != input.WithBorders || (this.WithBorders != null && !this.WithBorders.Equals(input.WithBorders))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReturnCharLocation != null) hashCode = hashCode * 59 + this.ReturnCharLocation.GetHashCode();
                ...
                if (this.WithBorders != null) hashCode = hashCode * 59 + this.WithBorders.GetHashCode();
                return hashCode;
            }
        }
    }

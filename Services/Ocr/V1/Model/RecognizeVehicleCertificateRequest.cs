...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeVehicleCertificateRequest 
    {
        ...
        public VehicleCertificateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeVehicleCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeVehicleCertificateRequest input)
        {

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeMyanmarDriverLicenseRequest 
    {
        ...
        public MyanmarDriverLicenseRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeMyanmarDriverLicenseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeMyanmarDriverLicenseRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeInvoiceVerificationRequest 
    {
        ...
        public InvoiceVerificationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeInvoiceVerificationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeInvoiceVerificationRequest input)
        {
            if (input == null)
                return false;

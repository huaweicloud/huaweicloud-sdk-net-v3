...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeVietnamIdCardRequest 
    {
        ...
        public VietnamIdCardRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeVietnamIdCardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeVietnamIdCardRequest input)
        {

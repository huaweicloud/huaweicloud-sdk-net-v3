...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeBusinessCardRequest 
    {
        ...
        public BusinessCardRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeBusinessCardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeBusinessCardRequest input)
        {
            if (input == null)
                return false;

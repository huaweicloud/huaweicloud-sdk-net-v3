...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeAcceptanceBillRequest 
    {
        ...
        public AcceptanceBillRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeAcceptanceBillRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeAcceptanceBillRequest input)
        {
            if (input == null)
                return false;

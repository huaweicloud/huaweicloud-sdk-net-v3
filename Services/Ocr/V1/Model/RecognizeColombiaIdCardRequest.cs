...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizeColombiaIdCardRequest 
    {
        ...
        public ColombiaIdCardRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizeColombiaIdCardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizeColombiaIdCardRequest input)
        {
            if (input == null)
                return false;

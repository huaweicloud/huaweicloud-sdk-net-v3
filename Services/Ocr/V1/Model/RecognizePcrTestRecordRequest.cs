...
namespace HuaweiCloud.SDK.Ocr.V1.Model
{
    ...
    public class RecognizePcrTestRecordRequest 
    {
        ...
        public PcrTestRecordRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RecognizePcrTestRecordRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RecognizePcrTestRecordRequest input)
        {
            if (input == null)
                return false;

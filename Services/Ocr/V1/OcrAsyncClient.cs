...
namespace HuaweiCloud.SDK.Ocr.V1
{
    public partial class OcrAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RecognizeAutoIdDocClassificationResponse> RecognizeAutoIdDocClassificationAsync(RecognizeAutoIdDocClassificationRequest recognizeAutoIdDocClassificationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<RecognizeAutoIdDocClassificationResponse> RecognizeAutoIdDocClassificationAsyncInvoker(RecognizeAutoIdDocClassificationRequest recognizeAutoIdDocClassificationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/ocr/auto-id-doc-classification", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", recognizeAutoIdDocClassificationRequest);
            return new AsyncInvoker<RecognizeAutoIdDocClassificationResponse>(this, "POST", request, JsonUtils.DeSerialize<RecognizeAutoIdDocClassificationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RecognizeBankReceiptResponse> RecognizeBankReceiptAsync(RecognizeBankReceiptRequest recognizeBankReceiptRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<RecognizeBankReceiptResponse> RecognizeBankReceiptAsyncInvoker(RecognizeBankReceiptRequest recognizeBankReceiptRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/ocr/bank-receipt", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", recognizeBankReceiptRequest);
            return new AsyncInvoker<RecognizeBankReceiptResponse>(this, "POST", request, JsonUtils.DeSerialize<RecognizeBankReceiptResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RecognizeHouseholdRegisterResponse> RecognizeHouseholdRegisterAsync(RecognizeHouseholdRegisterRequest recognizeHouseholdRegisterRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<RecognizeHouseholdRegisterResponse> RecognizeHouseholdRegisterAsyncInvoker(RecognizeHouseholdRegisterRequest recognizeHouseholdRegisterRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/ocr/household-register", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", recognizeHouseholdRegisterRequest);
            return new AsyncInvoker<RecognizeHouseholdRegisterResponse>(this, "POST", request, JsonUtils.DeSerialize<RecognizeHouseholdRegisterResponse>);
        }

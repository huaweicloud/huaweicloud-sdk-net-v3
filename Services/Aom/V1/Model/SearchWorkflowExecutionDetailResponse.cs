...
namespace HuaweiCloud.SDK.Aom.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SearchWorkflowExecutionDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SearchWorkflowExecutionDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchWorkflowExecutionDetailResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExecutionResultList == input.ExecutionResultList ||
                    this.ExecutionResultList != null &&
                    input.ExecutionResultList != null &&
                    this.ExecutionResultList.SequenceEqual(input.ExecutionResultList)
                ) && 
                (
                    this.ApproveUserNameList == input.ApproveUserNameList ||
                    this.ApproveUserNameList != null &&
                    input.ApproveUserNameList != null &&
                    this.ApproveUserNameList.SequenceEqual(input.ApproveUserNameList)
                ) && 
                (
                ...
                (
                    this.WorkflowEditTime == input.WorkflowEditTime ||
                    (this.WorkflowEditTime != null &&
                    this.WorkflowEditTime.Equals(input.WorkflowEditTime))
                ) && 
                (
                    this.LastRecordIdWithSnapshot == input.LastRecordIdWithSnapshot ||
                    (this.LastRecordIdWithSnapshot != null &&
                    this.LastRecordIdWithSnapshot.Equals(input.LastRecordIdWithSnapshot))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExecutionResultList != null)
                    hashCode = hashCode * 59 + this.ExecutionResultList.GetHashCode();
                if (this.ApproveUserNameList != null)
                    hashCode = hashCode * 59 + this.ApproveUserNameList.GetHashCode();
                if (this.ProjectId != null)
                    hashCode = hashCode * 59 + this.ProjectId.GetHashCode();
                if (this.WorkflowEditTime != null)
                    hashCode = hashCode * 59 + this.WorkflowEditTime.GetHashCode();
                if (this.LastRecordIdWithSnapshot != null)
                    hashCode = hashCode * 59 + this.LastRecordIdWithSnapshot.GetHashCode();
                return hashCode;
            }
        }
    }

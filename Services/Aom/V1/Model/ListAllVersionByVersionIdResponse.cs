...
namespace HuaweiCloud.SDK.Aom.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAllVersionByVersionIdResponse : SdkResponse
    {
        ...
        public List<ScriptVersion> Elements { get; set; }
        ...
        {
            return this.Equals(input as ListAllVersionByVersionIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllVersionByVersionIdResponse input)
        {
            if (input == null)
                return false;

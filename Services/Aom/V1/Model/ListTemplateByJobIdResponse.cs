...
namespace HuaweiCloud.SDK.Aom.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTemplateByJobIdResponse : SdkResponse
    {
        ...
        public List<Template> Elements { get; set; }
        ...
        {
            return this.Equals(input as ListTemplateByJobIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTemplateByJobIdResponse input)
        {

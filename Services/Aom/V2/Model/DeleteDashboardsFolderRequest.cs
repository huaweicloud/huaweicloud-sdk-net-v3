...
namespace HuaweiCloud.SDK.Aom.V2.Model
{
    ...
    public class DeleteDashboardsFolderRequest 
    {
        ...
        /// 仪表盘分组id。
        /// </summary>
        [SDKProperty("folder_id", IsPath = true)]
        ...
        /// 是否删除仪表盘分组下的仪表盘。
        /// </summary>
        [SDKProperty("delete_all", IsQuery = true)]
        [JsonProperty("delete_all", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as DeleteDashboardsFolderRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteDashboardsFolderRequest input)
        {
            ...
            if (this.DeleteAll != input.DeleteAll || (this.DeleteAll != null && !this.DeleteAll.Equals(input.DeleteAll))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeleteAll != null) hashCode = hashCode * 59 + this.DeleteAll.GetHashCode();
                return hashCode;
            }
        }
    }

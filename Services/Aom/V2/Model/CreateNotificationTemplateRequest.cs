...
namespace HuaweiCloud.SDK.Aom.V2.Model
{
    ...
    public class CreateNotificationTemplateRequest 
    {
        ...
        public AddNotificationTemplate Body { get; set; }
        ...
        {
            return this.Equals(input as CreateNotificationTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateNotificationTemplateRequest input)
        {

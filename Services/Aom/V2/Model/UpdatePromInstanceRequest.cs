...
namespace HuaweiCloud.SDK.Aom.V2.Model
{
    ...
    public class UpdatePromInstanceRequest 
    {
        ...
        public UpdatePromInstanceRequestModle Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePromInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePromInstanceRequest input)
        {

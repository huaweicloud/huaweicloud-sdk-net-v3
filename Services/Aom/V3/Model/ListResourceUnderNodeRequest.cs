...
namespace HuaweiCloud.SDK.Aom.V3.Model
{
    ...
    public class ListResourceUnderNodeRequest 
    {
        ...
        public bool Equals(ListResourceUnderNodeRequest input)
        {
            ...
            return 
                (
                    this.RfResourceType == input.RfResourceType ||
                    (this.RfResourceType != null &&
                    this.RfResourceType.Equals(input.RfResourceType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RfResourceType != null)
                    hashCode = hashCode * 59 + this.RfResourceType.GetHashCode();
                if (this.Type != null)

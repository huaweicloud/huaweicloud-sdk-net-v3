...
namespace HuaweiCloud.SDK.Aom.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListResourceUnderNodeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListResourceUnderNodeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListResourceUnderNodeResponse input)
        {

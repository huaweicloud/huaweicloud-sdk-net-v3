...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteKafkaMessageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteKafkaMessageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteKafkaMessageResponse input)
        {

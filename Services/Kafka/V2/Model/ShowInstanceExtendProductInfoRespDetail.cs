    ...
    public class ShowInstanceExtendProductInfoRespDetail 
    {
        ...
        public bool Equals(ShowInstanceExtendProductInfoRespDetail input)
        {
            ...
            return 
                ...
                (
                    this.RecommendMaxConsGroups == input.RecommendMaxConsGroups ||
                    (this.RecommendMaxConsGroups != null &&
                    this.RecommendMaxConsGroups.Equals(input.RecommendMaxConsGroups))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RecommendMaxConsGroups != null)
                    hashCode = hashCode * 59 + this.RecommendMaxConsGroups.GetHashCode();

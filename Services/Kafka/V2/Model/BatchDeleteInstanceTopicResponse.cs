...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteInstanceTopicResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteInstanceTopicResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteInstanceTopicResponse input)
        {

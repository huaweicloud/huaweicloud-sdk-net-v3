...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyConnectorTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyConnectorTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyConnectorTaskResponse input)
        {

...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowKafkaScalePreCheckInfoResponse : SdkResponse
    {
        ...
        public List<ShowKafkaScalePreCheckInfoEntity> Body { get; set; }
        ...
        {
            return this.Equals(input as ShowKafkaScalePreCheckInfoResponse);
        }

...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowKafkaClusterResponse : SdkResponse
    {
        ...
        public ShowKakfaClusterResponseCluster Cluster { get; set; }
        ...
        {
            return this.Equals(input as ShowKafkaClusterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKafkaClusterResponse input)
        {

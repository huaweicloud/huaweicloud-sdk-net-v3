...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceConsumerGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceConsumerGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceConsumerGroupResponse input)
        {

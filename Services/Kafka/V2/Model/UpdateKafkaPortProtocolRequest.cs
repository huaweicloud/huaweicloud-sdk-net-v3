...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class UpdateKafkaPortProtocolRequest 
    {
        ...
        public PlainSslEnableRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateKafkaPortProtocolRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateKafkaPortProtocolRequest input)
        {

...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class BatchModiftGroupDescriptionReq 
    {
        ...
        public List<GroupCreateReq> Groups { get; set; }
        ...
        {
            return this.Equals(input as BatchModiftGroupDescriptionReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchModiftGroupDescriptionReq input)
        {

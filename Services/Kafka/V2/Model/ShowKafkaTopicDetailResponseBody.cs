...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class ShowKafkaTopicDetailResponseBody 
    {
        ...
        public List<ShowKafkaTopicDetailResponsePartitions> Partitions { get; set; }
        ...
        {
            return this.Equals(input as ShowKafkaTopicDetailResponseBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKafkaTopicDetailResponseBody input)
        {

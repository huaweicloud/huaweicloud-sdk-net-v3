...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class UpdateInstanceGroupRequest 
    {
        ...
        public BatchModifyGroupDescriptionReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceGroupRequest input)
        {

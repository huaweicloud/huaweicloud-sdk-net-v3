...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteConsumerGroupOffsetsResponse : SdkResponse
    {
        ...
        public List<DeleteConsumerGroupOffsetsResponseEntity> Topics { get; set; }
        ...
        {
            return this.Equals(input as DeleteConsumerGroupOffsetsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteConsumerGroupOffsetsResponse input)
        {

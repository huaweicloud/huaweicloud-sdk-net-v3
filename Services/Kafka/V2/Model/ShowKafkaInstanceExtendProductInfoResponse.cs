...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowKafkaInstanceExtendProductInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowKafkaInstanceExtendProductInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKafkaInstanceExtendProductInfoResponse input)
        {

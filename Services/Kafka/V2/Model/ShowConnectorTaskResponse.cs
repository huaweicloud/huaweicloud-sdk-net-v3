...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowConnectorTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowConnectorTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowConnectorTaskResponse input)
        {
            if (input == null)
                return false;

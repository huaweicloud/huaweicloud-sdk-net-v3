...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class StartKafkaLogTaskRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 日志任务类型。 **约束限制**： 不涉及。 **取值范围**： - REBALANCE：重平衡日志。 - topic_log：Topic日志。 **默认取值**： 不涉及。</value>
        ...
        public class LogTypeEnum
        {
            ...
            /// </summary>
            public static readonly LogTypeEnum REBALANCE = new LogTypeEnum("REBALANCE");

            /// <summary>
            /// Enum TOPIC_LOG for value: topic_log
            /// </summary>
            public static readonly LogTypeEnum TOPIC_LOG = new LogTypeEnum("topic_log");
        ...
        /// **参数解释**： 日志任务类型。 **约束限制**： 不涉及。 **取值范围**： - REBALANCE：重平衡日志。 - topic_log：Topic日志。 **默认取值**： 不涉及。
        /// </summary>
        [SDKProperty("log_type", IsPath = true)]
        ...
        public StartKafkaLogTaskReq Body { get; set; }
        ...
        {
            return this.Equals(input as StartKafkaLogTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartKafkaLogTaskRequest input)
        {

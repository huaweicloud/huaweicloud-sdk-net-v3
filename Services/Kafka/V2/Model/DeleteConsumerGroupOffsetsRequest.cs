...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class DeleteConsumerGroupOffsetsRequest 
    {
        ...
        public DeleteConsumerGroupOffsetsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteConsumerGroupOffsetsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteConsumerGroupOffsetsRequest input)
        {

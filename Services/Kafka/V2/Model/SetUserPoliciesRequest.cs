...
namespace HuaweiCloud.SDK.Kafka.V2.Model
{
    ...
    public class SetUserPoliciesRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 消息引擎。 **约束限制**： 不涉及。 **取值范围**： kafka **默认取值**： kafka</value>
        ...
        /// </summary>
        [SDKProperty("user_name", IsPath = true)]
        ...
        public SetUserPoliciesReq Body { get; set; }
        ...
        {
            return this.Equals(input as SetUserPoliciesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetUserPoliciesRequest input)
        {

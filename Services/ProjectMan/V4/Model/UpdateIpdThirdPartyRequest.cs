...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class UpdateIpdThirdPartyRequest 
    {
        ...
        public UpdateThirdPartyAssociateVO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateIpdThirdPartyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateIpdThirdPartyRequest input)
        {

...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class CreateSystemIssueRequestV4 
    {
        ...
        public List<ScrumCustomField> CustomFields { get; set; }
        ...
        {
            return this.Equals(input as CreateSystemIssueRequestV4);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSystemIssueRequestV4 input)
        {

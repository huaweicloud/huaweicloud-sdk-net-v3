...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class CreateIpdProcessInstanceRequest 
    {
        ...
        /// 操作类型
        /// </summary>
        [SDKProperty("operate_type", IsQuery = true)]
        ...
        public CreateProcessInstanceReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateIpdProcessInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateIpdProcessInstanceRequest input)
        {

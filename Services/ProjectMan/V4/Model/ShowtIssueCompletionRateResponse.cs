...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowtIssueCompletionRateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowtIssueCompletionRateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowtIssueCompletionRateResponse input)
        {
            if (input == null)
                return false;

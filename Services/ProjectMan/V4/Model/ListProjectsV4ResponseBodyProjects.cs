...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class ListProjectsV4ResponseBodyProjects 
    {
        ...
        public ListProjectsV4ResponseBodyCreator Creator { get; set; }
        ...
        {
            return this.Equals(input as ListProjectsV4ResponseBodyProjects);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectsV4ResponseBodyProjects input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowBugDensityV2Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowBugDensityV2Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBugDensityV2Response input)
        {

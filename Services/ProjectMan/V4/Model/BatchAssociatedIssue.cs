...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class BatchAssociatedIssue 
    {
        ...
        /// 关联工作项ID
        /// </summary>
        [JsonProperty("source_issue_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  sourceIssueId: ").Append(SourceIssueId).Append("\n");
        ...
        {
            return this.Equals(input as BatchAssociatedIssue);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAssociatedIssue input)
        {
            if (input == null) return false;
            if (this.SourceIssueId != input.SourceIssueId || (this.SourceIssueId != null && !this.SourceIssueId.Equals(input.SourceIssueId))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.SourceIssueId != null) hashCode = hashCode * 59 + this.SourceIssueId.GetHashCode();

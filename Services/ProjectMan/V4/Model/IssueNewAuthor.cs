...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class IssueNewAuthor 
    {
        ...
        /// **参数解释：** 用户昵称。 **取值范围：** 不涉及。
        /// </summary>
        [JsonProperty("authorNickName", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as IssueNewAuthor);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IssueNewAuthor input)
        {
            ...
            if (this.AuthorNickName != input.AuthorNickName || (this.AuthorNickName != null && !this.AuthorNickName.Equals(input.AuthorNickName))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AuthorNickName != null) hashCode = hashCode * 59 + this.AuthorNickName.GetHashCode();

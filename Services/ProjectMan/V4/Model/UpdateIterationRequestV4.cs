...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class UpdateIterationRequestV4 
    {
        ...
        public bool Equals(UpdateIterationRequestV4 input)
        {
            ...
            if (this.OverType != input.OverType || (this.OverType != null && !this.OverType.Equals(input.OverType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OverType != null) hashCode = hashCode * 59 + this.OverType.GetHashCode();
                return hashCode;
            }
        }
    }

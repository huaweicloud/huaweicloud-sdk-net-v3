...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteSnapshotsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteSnapshotsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteSnapshotsResponse input)
        {

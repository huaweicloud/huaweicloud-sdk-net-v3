...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    /// 
    /// </summary>
    public class CreateIpdProjectIssueAttachmentRequestBody : IFormDataBody
    {
        ...
        public CreateIpdProjectIssueAttachmentRequestBody WithAttachment(Stream stream, string filename)
        {
            this.Attachment = new FormDataFilePart(stream, filename);
            return this;
        }

        public CreateIpdProjectIssueAttachmentRequestBody WithAttachment(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as CreateIpdProjectIssueAttachmentRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateIpdProjectIssueAttachmentRequestBody input)
        {

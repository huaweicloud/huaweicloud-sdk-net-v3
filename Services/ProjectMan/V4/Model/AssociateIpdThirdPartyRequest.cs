...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class AssociateIpdThirdPartyRequest 
    {
        ...
        public CreateThirdPartyAssociateVO Body { get; set; }
        ...
        {
            return this.Equals(input as AssociateIpdThirdPartyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateIpdThirdPartyRequest input)
        {

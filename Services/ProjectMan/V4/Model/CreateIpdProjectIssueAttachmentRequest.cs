...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class CreateIpdProjectIssueAttachmentRequest 
    {
        ...
        public CreateIpdProjectIssueAttachmentRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateIpdProjectIssueAttachmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateIpdProjectIssueAttachmentRequest input)
        {

...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class ListScrumProjectStatusesResponse : SdkResponse
    {
        ...
        public bool Equals(ListScrumProjectStatusesResponse input)
        {
            ...
            if (this.IssueStatuses != input.IssueStatuses || (this.IssueStatuses != null && input.IssueStatuses != null && !this.IssueStatuses.SequenceEqual(input.IssueStatuses))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IssueStatuses != null) hashCode = hashCode * 59 + this.IssueStatuses.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadIpdImageInIssueRequest 
    {
        ...
        {
            return this.Equals(input as DownloadIpdImageInIssueRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadIpdImageInIssueRequest input)
        {

...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class UpdateIpdLabelRequest 
    {
        ...
        /// </summary>
        [SDKProperty("label_id", IsPath = true)]
        ...
        public LabelParam Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateIpdLabelRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateIpdLabelRequest input)
        {

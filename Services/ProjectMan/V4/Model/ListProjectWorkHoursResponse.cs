...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectWorkHoursResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProjectWorkHoursResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectWorkHoursResponse input)
        {
            if (input == null) return false;
            if (this.WorkHours != input.WorkHours || (this.WorkHours != null && input.WorkHours != null && !this.WorkHours.SequenceEqual(input.WorkHours))) return false;

...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class UpdateProjectModuleRequest 
    {
        ...
        public UpdateProjectModuleRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateProjectModuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectModuleRequest input)
        {
            if (input == null)
                return false;

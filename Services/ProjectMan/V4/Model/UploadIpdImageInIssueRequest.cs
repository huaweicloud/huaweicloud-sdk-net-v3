...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class UploadIpdImageInIssueRequest 
    {
        ...
        public UploadIpdImageInIssueRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UploadIpdImageInIssueRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadIpdImageInIssueRequest input)
        {

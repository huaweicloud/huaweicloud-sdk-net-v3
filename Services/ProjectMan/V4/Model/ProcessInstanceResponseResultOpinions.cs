...
namespace HuaweiCloud.SDK.ProjectMan.V4.Model
{
    ...
    public class ProcessInstanceResponseResultOpinions 
    {
        ...
        public ProcessInstanceResponseResultCreatedBy1 CreatedBy { get; set; }
        ...
        public ProcessInstanceResponseResultCurrOwner CurrOwner { get; set; }
        ...
        {
            return this.Equals(input as ProcessInstanceResponseResultOpinions);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProcessInstanceResponseResultOpinions input)
        {

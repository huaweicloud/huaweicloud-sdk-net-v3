...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class RestoreInstanceFromCollectionRequest 
    {
        ...
        public RestoreInstanceFromCollectionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RestoreInstanceFromCollectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RestoreInstanceFromCollectionRequest input)
        {
            if (input == null)
                return false;

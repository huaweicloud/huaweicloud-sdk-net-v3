...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListLtsSlowLogsResponse : SdkResponse
    {
        ...
        public List<SlowLogDetail> SlowLogs { get; set; }
        ...
        {
            return this.Equals(input as ListLtsSlowLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLtsSlowLogsResponse input)
        {

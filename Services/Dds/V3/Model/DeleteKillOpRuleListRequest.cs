...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class DeleteKillOpRuleListRequest 
    {
        ...
        public DeleteKillOpRuleListRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteKillOpRuleListRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteKillOpRuleListRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class ListLtsSlowLogsRequestBody 
    {
        ...
        {
            return this.Equals(input as ListLtsSlowLogsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLtsSlowLogsRequestBody input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DatabaseKeywords == input.DatabaseKeywords ||
                    this.DatabaseKeywords != null &&
                    input.DatabaseKeywords != null &&
                    this.DatabaseKeywords.SequenceEqual(input.DatabaseKeywords)
                ) && 
                (
                    this.CollectionKeywords == input.CollectionKeywords ||
                    this.CollectionKeywords != null &&
                    input.CollectionKeywords != null &&
                    this.CollectionKeywords.SequenceEqual(input.CollectionKeywords)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DatabaseKeywords != null)
                    hashCode = hashCode * 59 + this.DatabaseKeywords.GetHashCode();
                if (this.CollectionKeywords != null)
                    hashCode = hashCode * 59 + this.CollectionKeywords.GetHashCode();

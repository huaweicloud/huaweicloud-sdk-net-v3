...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class BatchCreateInstanceTagsRequestBody 
    {
        ...
        /// </summary>
        /// <value>操作标识。取值： - create，表示添加标签。</value>
        ...
        public List<BatchCreateInstanceTagsOption> Tags { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateInstanceTagsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateInstanceTagsRequestBody input)
        {
            if (input == null)
                return false;

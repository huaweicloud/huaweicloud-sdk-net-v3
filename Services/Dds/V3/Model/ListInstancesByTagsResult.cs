...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class ListInstancesByTagsResult 
    {
        ...
        public List<ListInstancesTagResult> Tags { get; set; }
        ...
        {
            return this.Equals(input as ListInstancesByTagsResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstancesByTagsResult input)
        {
            if (input == null)
                return false;

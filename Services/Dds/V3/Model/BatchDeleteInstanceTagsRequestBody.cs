...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class BatchDeleteInstanceTagsRequestBody 
    {
        ...
        /// </summary>
        /// <value>操作标识。取值： - delete，表示删除标签。</value>
        ...
        public List<BatchDeleteInstanceTagsOption> Tags { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteInstanceTagsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteInstanceTagsRequestBody input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class ShrinkInstanceNodesRequest 
    {
        ...
        public ReduceInstanceNodeRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShrinkInstanceNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShrinkInstanceNodesRequest input)
        {
            if (input == null)
                return false;

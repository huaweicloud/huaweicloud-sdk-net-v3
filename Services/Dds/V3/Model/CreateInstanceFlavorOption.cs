...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class CreateInstanceFlavorOption 
    {
        ...
        /// </summary>
        /// <value>节点类型。 取值：   - 社区版集群实例包含mongos、shard和config节点，各节点下该参数取值分别为“mongos”、“shard”和“config”。   - 增强版集群实例下该参数取值为“shard”。   - 社区版副本集实例下该参数取值为“replica”。   - 社区版单节点实例下该参数取值为“single”。</value>

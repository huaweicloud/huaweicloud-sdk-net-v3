...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditlogLinksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAuditlogLinksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditlogLinksResponse input)
        {

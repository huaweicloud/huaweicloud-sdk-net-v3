...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    public class BatchOperateInstanceTagRequestBody 
    {
        ...
        /// </summary>
        /// <value>操作标识。取值： - create，表示添加标签。 - delete，表示删除标签。</value>
        ...
        {
            return this.Equals(input as BatchOperateInstanceTagRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchOperateInstanceTagRequestBody input)
        {
            if (input == null)
                return false;

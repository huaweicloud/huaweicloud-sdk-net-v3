...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowKillOpRuleRuleListResponse : SdkResponse
    {
        ...
        public List<KillOpRule> Rules { get; set; }
        ...
        {
            return this.Equals(input as ShowKillOpRuleRuleListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKillOpRuleRuleListResponse input)
        {

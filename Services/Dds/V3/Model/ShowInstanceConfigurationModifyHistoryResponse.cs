...
namespace HuaweiCloud.SDK.Dds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceConfigurationModifyHistoryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceConfigurationModifyHistoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceConfigurationModifyHistoryResponse input)
        {

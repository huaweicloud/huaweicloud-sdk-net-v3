...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteTemplatesResponse : SdkResponse
    {
        ...
        public List<CreateTemplatesItems> Result { get; set; }
        ...
        {
            return this.Equals(input as DeleteTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTemplatesResponse input)
        {

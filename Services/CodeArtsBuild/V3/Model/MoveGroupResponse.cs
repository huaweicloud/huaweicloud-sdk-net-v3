...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class MoveGroupResponse : SdkResponse
    {
        ...
        public List<MoveJobGroupResponseBodyResult> Result { get; set; }
        ...
        {
            return this.Equals(input as MoveGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MoveGroupResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowJobNoticeConfigInfoResponse : SdkResponse
    {
        ...
        public List<QueryJobNoticeItems> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowJobNoticeConfigInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowJobNoticeConfigInfoResponse input)
        {

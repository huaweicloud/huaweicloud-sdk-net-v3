...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    public class UpdateBuildJobParameter 
    {
        ...
        public List<UpdateBuildJobParameterParam> Params { get; set; }
        ...
        {
            return this.Equals(input as UpdateBuildJobParameter);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateBuildJobParameter input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddFavouriteTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddFavouriteTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddFavouriteTaskResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRecordsResponse : SdkResponse
    {
        ...
        public ListRecordsResult Result { get; set; }
        ...
        {
            return this.Equals(input as ListRecordsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRecordsResponse input)
        {

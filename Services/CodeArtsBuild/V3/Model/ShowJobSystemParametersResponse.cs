...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowJobSystemParametersResponse : SdkResponse
    {
        ...
        public List<SystemParametersResult> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowJobSystemParametersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowJobSystemParametersResponse input)
        {

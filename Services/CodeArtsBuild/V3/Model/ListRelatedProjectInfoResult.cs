...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    public class ListRelatedProjectInfoResult 
    {
        ...
        public List<ListRelatedProjectInfoResultProjectInfoList> ProjectInfoList { get; set; }
        ...
        {
            return this.Equals(input as ListRelatedProjectInfoResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRelatedProjectInfoResult input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    public class ShowJobInfoResult 
    {
        ...
        /// 重新运行
        /// </summary>
        [JsonProperty("new_build", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public long? LastBuildTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  newBuild: ").Append(NewBuild).Append("\n");
        ...
        {
            return this.Equals(input as ShowJobInfoResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowJobInfoResult input)
        {
            ...
            if (this.ChargeTime != input.ChargeTime || (this.ChargeTime != null && !this.ChargeTime.Equals(input.ChargeTime))) return false;
            ...
            if (this.NewBuild != input.NewBuild || (this.NewBuild != null && !this.NewBuild.Equals(input.NewBuild))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChargeTime != null) hashCode = hashCode * 59 + this.ChargeTime.GetHashCode();
                ...
                if (this.NewBuild != null) hashCode = hashCode * 59 + this.NewBuild.GetHashCode();

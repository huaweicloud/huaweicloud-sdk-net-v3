...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateJobGroupResponse : SdkResponse
    {
        ...
        public List<JobGroupResponseBodyResult> Result { get; set; }
        ...
        {
            return this.Equals(input as CreateJobGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateJobGroupResponse input)
        {

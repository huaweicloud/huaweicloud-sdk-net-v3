...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowJobListByProjectIdResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowJobListByProjectIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowJobListByProjectIdResponse input)
        {

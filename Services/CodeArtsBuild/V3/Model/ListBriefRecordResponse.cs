...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBriefRecordResponse : SdkResponse
    {
        ...
        public List<ListBriefRecordResponseBodyResult> Result { get; set; }
        ...
        {
            return this.Equals(input as ListBriefRecordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBriefRecordResponse input)
        {

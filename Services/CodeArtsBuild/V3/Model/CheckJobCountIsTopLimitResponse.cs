...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CheckJobCountIsTopLimitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CheckJobCountIsTopLimitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckJobCountIsTopLimitResponse input)
        {

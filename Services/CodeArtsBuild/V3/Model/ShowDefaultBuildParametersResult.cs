...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    public class ShowDefaultBuildParametersResult 
    {
        ...
        public List<ShowDefaultBuildParametersParams> Params { get; set; }
        ...
        {
            return this.Equals(input as ShowDefaultBuildParametersResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDefaultBuildParametersResult input)
        {

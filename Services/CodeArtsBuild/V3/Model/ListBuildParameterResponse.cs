...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBuildParameterResponse : SdkResponse
    {
        ...
        public List<BuildParameter> Result { get; set; }
        ...
        {
            return this.Equals(input as ListBuildParameterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBuildParameterResponse input)
        {

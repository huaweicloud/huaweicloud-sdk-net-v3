...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDomainsStatusesResponse : SdkResponse
    {
        ...
        public List<DomainStatuses> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowDomainsStatusesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDomainsStatusesResponse input)
        {

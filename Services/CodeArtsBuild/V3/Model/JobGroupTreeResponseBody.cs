...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    public class JobGroupTreeResponseBody 
    {
        ...
        public List<JobGroupTreeResponseBody> Children { get; set; }
        ...
        {
            return this.Equals(input as JobGroupTreeResponseBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(JobGroupTreeResponseBody input)
        {

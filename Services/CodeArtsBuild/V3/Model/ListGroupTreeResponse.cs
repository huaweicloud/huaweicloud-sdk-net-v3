...
namespace HuaweiCloud.SDK.CodeArtsBuild.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupTreeResponse : SdkResponse
    {
        ...
        public List<JobGroupTreeResponseBody> Result { get; set; }
        ...
        {
            return this.Equals(input as ListGroupTreeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupTreeResponse input)
        {

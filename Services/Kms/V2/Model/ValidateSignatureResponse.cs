...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    public class ValidateSignatureResponse : SdkResponse
    {
        ...
        public bool Equals(ValidateSignatureResponse input)
        {
            ...
            if (this.SignatureValid != input.SignatureValid || (this.SignatureValid != null && !this.SignatureValid.Equals(input.SignatureValid))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SignatureValid != null) hashCode = hashCode * 59 + this.SignatureValid.GetHashCode();
                return hashCode;
            }
        }
    }

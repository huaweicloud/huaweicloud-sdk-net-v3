...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    public class ListKeyStoresResponse : SdkResponse
    {
        ...
        public bool Equals(ListKeyStoresResponse input)
        {
            ...
            if (this.Keystores != input.Keystores || (this.Keystores != null && input.Keystores != null && !this.Keystores.SequenceEqual(input.Keystores))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Keystores != null) hashCode = hashCode * 59 + this.Keystores.GetHashCode();
                return hashCode;
            }
        }
    }

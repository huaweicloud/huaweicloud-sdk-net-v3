...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    public class ListKmsByTagsRequest 
    {
        ...
        public bool Equals(ListKmsByTagsRequest input)
        {
            ...
            if (this.ResourceInstances != input.ResourceInstances || (this.ResourceInstances != null && !this.ResourceInstances.Equals(input.ResourceInstances))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.ResourceInstances != null) hashCode = hashCode * 59 + this.ResourceInstances.GetHashCode();

...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    public class ScheduleKeyDeletionRequestBody 
    {
        ...
        public bool Equals(ScheduleKeyDeletionRequestBody input)
        {
            ...
            if (this.PendingDays != input.PendingDays || (this.PendingDays != null && !this.PendingDays.Equals(input.PendingDays))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PendingDays != null) hashCode = hashCode * 59 + this.PendingDays.GetHashCode();

...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    public class UpdateKeyPolicyResponseBodyPolicy 
    {
        ...
        public UpdateKeyPolicyResponseBodyPolicyValidityPeriod ValidityPeriod { get; set; }

        /// <summary>
        /// 允许访问的接入点ID列表
        /// </summary>
        [JsonProperty("allowed_access_point", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as UpdateKeyPolicyResponseBodyPolicy);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateKeyPolicyResponseBodyPolicy input)
        {

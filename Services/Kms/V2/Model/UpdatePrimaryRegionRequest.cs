...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    public class UpdatePrimaryRegionRequest 
    {
        ...
        public UpdatePrimaryRegionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePrimaryRegionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrimaryRegionRequest input)
        {

...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowKeyPolicyResponse : SdkResponse
    {
        ...
        public ShowKeyPolicyResponseBodyPolicy Policy { get; set; }
        ...
        {
            return this.Equals(input as ShowKeyPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKeyPolicyResponse input)
        {

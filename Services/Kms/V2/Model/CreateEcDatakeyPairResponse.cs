...
namespace HuaweiCloud.SDK.Kms.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateEcDatakeyPairResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateEcDatakeyPairResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateEcDatakeyPairResponse input)
        {

...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowImageVariationTaskResponse : SdkResponse
    {
        /// <summary>
        ...
        public ImageVariationTaskConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowImageVariationTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowImageVariationTaskResponse input)
        {
            if (input == null)
                return false;

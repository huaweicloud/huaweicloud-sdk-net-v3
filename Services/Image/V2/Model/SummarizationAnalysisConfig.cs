...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class SummarizationAnalysisConfig 
    {
        ...
        public SummarizationAnalysisConfigCommon Common { get; set; }
        ...
        {
            return this.Equals(input as SummarizationAnalysisConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SummarizationAnalysisConfig input)
        {
            if (input == null)
                return false;

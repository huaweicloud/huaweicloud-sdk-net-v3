...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoCuttingTaskResponse : SdkResponse
    {
        ...
        public VideoCuttingConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowVideoCuttingTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoCuttingTaskResponse input)
        {
            if (input == null)
                return false;

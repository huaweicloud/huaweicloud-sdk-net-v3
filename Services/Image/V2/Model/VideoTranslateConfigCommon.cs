...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class VideoTranslateConfigCommon 
    {
        ...
        public VideoTranslateInference Inference { get; set; }
        ...
        {
            return this.Equals(input as VideoTranslateConfigCommon);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(VideoTranslateConfigCommon input)
        {
            if (input == null)
                return false;

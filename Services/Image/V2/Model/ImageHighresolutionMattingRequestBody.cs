...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageHighresolutionMattingRequestBody 
    {
        ...
        public ImageHighresolutionMattingInput Input { get; set; }
        ...
        {
            return this.Equals(input as ImageHighresolutionMattingRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageHighresolutionMattingRequestBody input)
        {
            if (input == null)
                return false;

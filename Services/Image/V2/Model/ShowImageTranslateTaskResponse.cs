...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowImageTranslateTaskResponse : SdkResponse
    {
        ...
        public ImageTranslateConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowImageTranslateTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowImageTranslateTaskResponse input)
        {
            if (input == null)
                return false;

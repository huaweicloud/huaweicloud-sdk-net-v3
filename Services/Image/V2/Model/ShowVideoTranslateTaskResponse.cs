...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoTranslateTaskResponse : SdkResponse
    {
        ...
        public VideoTranslateTaskInput Input { get; set; }
        ...
        public VideoTranslateConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowVideoTranslateTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoTranslateTaskResponse input)
        {
            if (input == null)
                return false;

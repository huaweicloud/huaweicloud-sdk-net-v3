...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowImageHighresolutionMattingTaskResponse : SdkResponse
    {
        ...
        public ImageHighresolutionMattingConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowImageHighresolutionMattingTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowImageHighresolutionMattingTaskResponse input)
        {
            if (input == null)
                return false;

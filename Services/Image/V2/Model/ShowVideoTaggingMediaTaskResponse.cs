...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoTaggingMediaTaskResponse : SdkResponse
    {
        ...
        public VideoTaggingMediaTaskInput Input { get; set; }
        ...
        public VideoTaggingTaskConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowVideoTaggingMediaTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoTaggingMediaTaskResponse input)
        {
            if (input == null)
                return false;

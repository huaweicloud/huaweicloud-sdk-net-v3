...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class VideoCoverAnalysisConfig 
    {
        ...
        public VideoCoverAnalysisConfigCommon Common { get; set; }
        ...
        {
            return this.Equals(input as VideoCoverAnalysisConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(VideoCoverAnalysisConfig input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageMediaTaggingDetItemBody 
    {
        ...
        public ImageMediaTaggingDetItemBodyI18nTag I18nTag { get; set; }

        /// <summary>
        /// 目标检测框信息，为空则表示没有目标检测框。
        /// </summary>
        [JsonProperty("instances", NullValueHandling = NullValueHandling.Ignore)]
        public List<ImageMediaTaggingDetInstance> Instances { get; set; }
        ...
        {
            return this.Equals(input as ImageMediaTaggingDetItemBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageMediaTaggingDetItemBody input)
        {
            if (input == null)
                return false;

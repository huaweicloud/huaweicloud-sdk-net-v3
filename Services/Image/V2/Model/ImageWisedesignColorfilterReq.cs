...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageWisedesignColorfilterReq 
    {
        ...
        /// 滤镜索引，取值范围（1001~1008）
        /// </summary>
        [JsonProperty("filter_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ImageWisedesignColorfilterReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageWisedesignColorfilterReq input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoSummarizationAnalysisTaskResponse : SdkResponse
    {
        /// <summary>
        ...
        public VideoSummarizationTaskInput Input { get; set; }
        ...
        public SummarizationAnalysisConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowVideoSummarizationAnalysisTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoSummarizationAnalysisTaskResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class CreateVideoSplitTaskRequestBody 
    {
        ...
        public VideoSplitTaskInput Input { get; set; }
        ...
        {
            return this.Equals(input as CreateVideoSplitTaskRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVideoSplitTaskRequestBody input)
        {
            if (input == null)
                return false;

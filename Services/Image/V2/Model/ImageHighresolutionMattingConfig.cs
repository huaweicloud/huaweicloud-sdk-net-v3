...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageHighresolutionMattingConfig 
    {
        ...
        public ImageHighresolutionMattingConfigCommon Common { get; set; }
        ...
        {
            return this.Equals(input as ImageHighresolutionMattingConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageHighresolutionMattingConfig input)
        {
            if (input == null)
                return false;

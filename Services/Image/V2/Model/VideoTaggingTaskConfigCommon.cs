...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class VideoTaggingTaskConfigCommon 
    {
        ...
        public VideoTagginginference Inference { get; set; }
        ...
        {
            return this.Equals(input as VideoTaggingTaskConfigCommon);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(VideoTaggingTaskConfigCommon input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoObjectMaskingTaskResponse : SdkResponse
    {
        /// <summary>
        ...
        public VideoObjectMaskingTaskConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowVideoObjectMaskingTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoObjectMaskingTaskResponse input)
        {
            if (input == null)
                return false;

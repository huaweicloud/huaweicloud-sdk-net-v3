...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class SummarizationAnalysisConfigCommon 
    {
        ...
        public SummarizationAnalysisInference Inference { get; set; }
        ...
        {
            return this.Equals(input as SummarizationAnalysisConfigCommon);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SummarizationAnalysisConfigCommon input)
        {
            if (input == null)
                return false;

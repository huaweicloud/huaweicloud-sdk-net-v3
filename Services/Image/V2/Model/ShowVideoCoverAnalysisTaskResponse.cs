...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoCoverAnalysisTaskResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowVideoCoverAnalysisTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoCoverAnalysisTaskResponse input)
        {
            if (input == null)
                return false;

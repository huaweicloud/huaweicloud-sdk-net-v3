...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowImageToVideoTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowImageToVideoTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowImageToVideoTaskResponse input)
        {
            if (input == null)
                return false;

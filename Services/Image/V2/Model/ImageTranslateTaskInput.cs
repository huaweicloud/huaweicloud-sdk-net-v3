...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageTranslateTaskInput 
    {
        ...
        public List<ImageTranslateTaskInputData> Data { get; set; }
        ...
        {
            return this.Equals(input as ImageTranslateTaskInput);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageTranslateTaskInput input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageHighresolutionMattingConfigCommon 
    {
        ...
        public ImageHighresolutionMattingInference Inference { get; set; }
        ...
        {
            return this.Equals(input as ImageHighresolutionMattingConfigCommon);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageHighresolutionMattingConfigCommon input)
        {
            if (input == null)
                return false;

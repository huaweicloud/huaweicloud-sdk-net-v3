...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class ImageMediaTaggingItemBody 
    {
        ...
        public ImageMediaTaggingItemBodyI18nTag I18nTag { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("i18n_type", NullValueHandling = NullValueHandling.Ignore)]
        public ImageMediaTaggingItemBodyI18nType I18nType { get; set; }
        ...
        {
            return this.Equals(input as ImageMediaTaggingItemBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImageMediaTaggingItemBody input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.I18nType == input.I18nType ||
                    (this.I18nType != null &&
                    this.I18nType.Equals(input.I18nType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.I18nType != null)
                    hashCode = hashCode * 59 + this.I18nType.GetHashCode();

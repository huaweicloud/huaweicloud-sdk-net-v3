...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVideoSynthesisTaskResponse : SdkResponse
    {
        ...
        public VideoSynthesisConfig Config { get; set; }
        ...
        {
            return this.Equals(input as ShowVideoSynthesisTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVideoSynthesisTaskResponse input)
        {
            if (input == null)
                return false;

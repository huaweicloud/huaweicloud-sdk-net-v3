...
namespace HuaweiCloud.SDK.Image.V2.Model
{
    ...
    public class VideoSynthesisConfigCommon 
    {
        ...
        public VideoSynthesisInference Inference { get; set; }
        ...
        {
            return this.Equals(input as VideoSynthesisConfigCommon);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(VideoSynthesisConfigCommon input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Image.V2
{
    public partial class ImageAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateVideoTaggingMediaTaskResponse> CreateVideoTaggingMediaTaskAsync(CreateVideoTaggingMediaTaskRequest createVideoTaggingMediaTaskRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowVideoTaggingMediaTaskResponse> ShowVideoTaggingMediaTaskAsync(ShowVideoTaggingMediaTaskRequest showVideoTaggingMediaTaskRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();

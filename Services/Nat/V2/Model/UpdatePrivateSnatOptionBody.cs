...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    public class UpdatePrivateSnatOptionBody 
    {
        ...
        public UpdatePrivateSnatOption SnatRule { get; set; }
        ...
        {
            return this.Equals(input as UpdatePrivateSnatOptionBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateSnatOptionBody input)
        {
            if (input == null)
                return false;

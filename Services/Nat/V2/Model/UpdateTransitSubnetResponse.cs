...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTransitSubnetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateTransitSubnetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTransitSubnetResponse input)
        {

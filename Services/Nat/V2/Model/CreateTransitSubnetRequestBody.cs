...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    public class CreateTransitSubnetRequestBody 
    {
        ...
        public CreateTransitSubnetOption TransitSubnet { get; set; }
        ...
        {
            return this.Equals(input as CreateTransitSubnetRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTransitSubnetRequestBody input)
        {

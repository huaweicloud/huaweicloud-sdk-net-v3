...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateNatGatewaySnatRuleResponse : SdkResponse
    {
        ...
        public NatGatewayUpdateSnatRuleResponseBody SnatRule { get; set; }
        ...
        {
            return this.Equals(input as UpdateNatGatewaySnatRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNatGatewaySnatRuleResponse input)
        {
            if (input == null)
                return false;

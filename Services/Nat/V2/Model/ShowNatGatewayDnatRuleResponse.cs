...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowNatGatewayDnatRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowNatGatewayDnatRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowNatGatewayDnatRuleResponse input)
        {
            if (input == null)
                return false;

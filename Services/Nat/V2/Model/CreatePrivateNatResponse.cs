...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePrivateNatResponse : SdkResponse
    {
        ...
        public PrivateNat Gateway { get; set; }
        ...
        {
            return this.Equals(input as CreatePrivateNatResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePrivateNatResponse input)
        {

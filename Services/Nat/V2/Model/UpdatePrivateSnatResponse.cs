...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePrivateSnatResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePrivateSnatResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateSnatResponse input)
        {

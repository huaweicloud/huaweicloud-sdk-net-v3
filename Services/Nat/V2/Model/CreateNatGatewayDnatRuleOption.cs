...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    public class CreateNatGatewayDnatRuleOption 
    {
        ...
        public CreateNatGatewayDnatOption DnatRule { get; set; }
        ...
        {
            return this.Equals(input as CreateNatGatewayDnatRuleOption);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateNatGatewayDnatRuleOption input)
        {
            if (input == null)
                return false;

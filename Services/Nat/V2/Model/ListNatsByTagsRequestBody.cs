...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    public class ListNatsByTagsRequestBody 
    {
        ...
        public List<PublicTag> Tags { get; set; }
        ...
        public List<PublicTag> TagsAny { get; set; }
        ...
        public List<PublicTag> NotTags { get; set; }
        ...
        public List<PublicTag> NotTagsAny { get; set; }
        ...
        public List<PublicMatch> Matches { get; set; }
        ...
        {
            return this.Equals(input as ListNatsByTagsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNatsByTagsRequestBody input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTransitSubnetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTransitSubnetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTransitSubnetResponse input)
        {

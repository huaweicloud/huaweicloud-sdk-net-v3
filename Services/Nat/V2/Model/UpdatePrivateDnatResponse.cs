...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePrivateDnatResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePrivateDnatResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateDnatResponse input)
        {
            if (input == null)
                return false;

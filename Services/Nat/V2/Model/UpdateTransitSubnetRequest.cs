...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    public class UpdateTransitSubnetRequest 
    {
        ...
        public UpdateTransitSubnetRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTransitSubnetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTransitSubnetRequest input)
        {

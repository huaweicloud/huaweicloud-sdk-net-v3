...
namespace HuaweiCloud.SDK.Nat.V2.Model
{
    ...
    public class NatGatewaySnatRuleResponseBody 
    {
        ...
        public bool Equals(NatGatewaySnatRuleResponseBody input)
        {
            ...
            if (this.FreezedIpAddress != input.FreezedIpAddress || (this.FreezedIpAddress != null && !this.FreezedIpAddress.Equals(input.FreezedIpAddress))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FreezedIpAddress != null) hashCode = hashCode * 59 + this.FreezedIpAddress.GetHashCode();

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateFunctionMaxInstanceConfigResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateFunctionMaxInstanceConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionMaxInstanceConfigResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsReturnStream == input.IsReturnStream ||
                    (this.IsReturnStream != null &&
                    this.IsReturnStream.Equals(input.IsReturnStream))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsReturnStream != null)
                    hashCode = hashCode * 59 + this.IsReturnStream.GetHashCode();

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class UpdateFunctionConfigRequest 
    {
        ...
        public UpdateFunctionConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateFunctionConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionConfigRequest input)
        {
            if (input == null)
                return false;

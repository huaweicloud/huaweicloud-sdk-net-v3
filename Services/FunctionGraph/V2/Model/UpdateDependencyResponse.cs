...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDependencyResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateDependencyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDependencyResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class UpdateFunctionReservedInstancesRequest 
    {
        ...
        public UpdateFunctionReservedInstancesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateFunctionReservedInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionReservedInstancesRequest input)
        {
            if (input == null)
                return false;

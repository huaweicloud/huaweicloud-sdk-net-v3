...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateFunctionAsyncInvokeConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateFunctionAsyncInvokeConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionAsyncInvokeConfigResponse input)
        {
            if (input == null)
                return false;

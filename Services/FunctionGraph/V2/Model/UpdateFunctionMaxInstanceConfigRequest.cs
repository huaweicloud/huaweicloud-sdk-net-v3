...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class UpdateFunctionMaxInstanceConfigRequest 
    {
        ...
        public UpdateFunctionMaxInstanceConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateFunctionMaxInstanceConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionMaxInstanceConfigRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectAsyncStatusLogInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProjectAsyncStatusLogInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectAsyncStatusLogInfoResponse input)
        {

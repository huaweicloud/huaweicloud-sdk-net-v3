...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListFunctionTagsResponse : SdkResponse
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListFunctionTagsResponse {\n");
        ...
        {
            return this.Equals(input as ListFunctionTagsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListFunctionTagsResponse input)
        {
            if (input == null)
                return false;

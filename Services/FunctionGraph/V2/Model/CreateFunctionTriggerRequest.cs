...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class CreateFunctionTriggerRequest 
    {
        ...
        public CreateFunctionTriggerRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateFunctionTriggerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFunctionTriggerRequest input)
        {
            if (input == null)
                return false;

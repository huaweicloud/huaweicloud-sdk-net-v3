...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateCallbackWorkflowResponse : SdkResponse
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCallbackWorkflowResponse {\n");
        ...
        {
            return this.Equals(input as CreateCallbackWorkflowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCallbackWorkflowResponse input)
        {

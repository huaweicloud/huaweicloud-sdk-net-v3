...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// 
    /// </summary>
    public class ListFunctionApplicationResult 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListFunctionApplicationResult {\n");
        ...
        {
            return this.Equals(input as ListFunctionApplicationResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListFunctionApplicationResult input)
        {
            if (input == null)
                return false;

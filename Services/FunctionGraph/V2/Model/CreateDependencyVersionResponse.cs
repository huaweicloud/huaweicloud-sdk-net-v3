...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDependencyVersionResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateDependencyVersionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDependencyVersionResponse input)
        {

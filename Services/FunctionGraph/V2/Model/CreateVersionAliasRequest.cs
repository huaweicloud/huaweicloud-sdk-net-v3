...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class CreateVersionAliasRequest 
    {
        ...
        public CreateVersionAliasRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateVersionAliasRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVersionAliasRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class UpdateFunctionAsyncInvokeConfigRequest 
    {
        ...
        public UpdateFunctionAsyncInvokeConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateFunctionAsyncInvokeConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionAsyncInvokeConfigRequest input)
        {
            if (input == null)
                return false;

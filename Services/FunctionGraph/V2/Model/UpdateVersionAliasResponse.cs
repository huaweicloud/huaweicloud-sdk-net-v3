...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateVersionAliasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateVersionAliasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateVersionAliasResponse input)
        {
            if (input == null)
                return false;

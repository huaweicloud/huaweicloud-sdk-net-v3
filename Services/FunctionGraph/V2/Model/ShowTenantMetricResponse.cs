...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTenantMetricResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTenantMetricResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTenantMetricResponse input)
        {
            if (input == null)
                return false;

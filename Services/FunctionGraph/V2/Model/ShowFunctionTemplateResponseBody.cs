...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class ShowFunctionTemplateResponseBody 
    {
        ...
        {
            return this.Equals(input as ShowFunctionTemplateResponseBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFunctionTemplateResponseBody input)
        {
            ...
            if (this.CodeType != input.CodeType || (this.CodeType != null && !this.CodeType.Equals(input.CodeType))) return false;
            ...
            if (this.TriggerMetadataList != input.TriggerMetadataList || (this.TriggerMetadataList != null && input.TriggerMetadataList != null && !this.TriggerMetadataList.SequenceEqual(input.TriggerMetadataList))) return false;
            if (this.TempDetail != input.TempDetail || (this.TempDetail != null && !this.TempDetail.Equals(input.TempDetail))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CodeType != null) hashCode = hashCode * 59 + this.CodeType.GetHashCode();
                ...
                if (this.TriggerMetadataList != null) hashCode = hashCode * 59 + this.TriggerMetadataList.GetHashCode();
                if (this.TempDetail != null) hashCode = hashCode * 59 + this.TempDetail.GetHashCode();

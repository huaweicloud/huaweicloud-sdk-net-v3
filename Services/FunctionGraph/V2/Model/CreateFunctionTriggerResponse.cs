...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateFunctionTriggerResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateFunctionTriggerResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFunctionTriggerResponse input)
        {
            if (input == null)
                return false;

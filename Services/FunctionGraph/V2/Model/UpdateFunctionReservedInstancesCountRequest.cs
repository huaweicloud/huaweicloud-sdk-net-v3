...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class UpdateFunctionReservedInstancesCountRequest 
    {
        ...
        public UpdateFunctionReservedInstancesCountRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateFunctionReservedInstancesCountRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionReservedInstancesCountRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateFunctionUrlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateFunctionUrlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFunctionUrlResponse input)
        {
            if (input == null)
                return false;

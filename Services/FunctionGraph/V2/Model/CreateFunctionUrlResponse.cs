...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateFunctionUrlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateFunctionUrlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFunctionUrlResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFunctionConfigResponse : SdkResponse
    {
        /// <summary>
        ...
        public class RuntimeEnum
        {
            ...
            /// </summary>
            public static readonly RuntimeEnum PHP8_3 = new RuntimeEnum("PHP8.3");
        ...
        {
            return this.Equals(input as ShowFunctionConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFunctionConfigResponse input)
        {
            ...
            if (this.ReservedInstanceIdleMode != input.ReservedInstanceIdleMode || (this.ReservedInstanceIdleMode != null && !this.ReservedInstanceIdleMode.Equals(input.ReservedInstanceIdleMode))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReservedInstanceIdleMode != null) hashCode = hashCode * 59 + this.ReservedInstanceIdleMode.GetHashCode();

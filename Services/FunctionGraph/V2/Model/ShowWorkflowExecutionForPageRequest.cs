...
namespace HuaweiCloud.SDK.FunctionGraph.V2.Model
{
    ...
    public class ShowWorkflowExecutionForPageRequest 
    {
        ...
        public QueryRunListParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowWorkflowExecutionForPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWorkflowExecutionForPageRequest input)
        {
            if (input == null)
                return false;

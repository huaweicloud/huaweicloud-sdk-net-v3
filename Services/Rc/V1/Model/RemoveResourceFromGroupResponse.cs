...
namespace HuaweiCloud.SDK.Rc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RemoveResourceFromGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RemoveResourceFromGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveResourceFromGroupResponse input)
        {

...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowIndividualStreamJobResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowIndividualStreamJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowIndividualStreamJobResponse input)
        {

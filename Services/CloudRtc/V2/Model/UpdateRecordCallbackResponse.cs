...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRecordCallbackResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRecordCallbackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecordCallbackResponse input)
        {
            if (input == null)
                return false;

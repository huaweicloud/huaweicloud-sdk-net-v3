...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAutoRecordResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAutoRecordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAutoRecordResponse input)
        {

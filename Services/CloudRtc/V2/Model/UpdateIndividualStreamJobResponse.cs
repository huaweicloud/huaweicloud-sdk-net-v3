...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateIndividualStreamJobResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateIndividualStreamJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateIndividualStreamJobResponse input)
        {

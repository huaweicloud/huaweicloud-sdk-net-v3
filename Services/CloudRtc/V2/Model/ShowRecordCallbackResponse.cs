...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRecordCallbackResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRecordCallbackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRecordCallbackResponse input)
        {

...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    public class CreateIndividualStreamJobRequest 
    {
        ...
        public IndividualStreamJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateIndividualStreamJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateIndividualStreamJobRequest input)
        {

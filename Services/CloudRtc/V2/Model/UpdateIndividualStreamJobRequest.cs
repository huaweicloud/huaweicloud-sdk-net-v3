...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    public class UpdateIndividualStreamJobRequest 
    {
        ...
        public UpdateIndividualJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateIndividualStreamJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateIndividualStreamJobRequest input)
        {

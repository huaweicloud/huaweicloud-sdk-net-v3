...
namespace HuaweiCloud.SDK.CloudRtc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRecordRuleResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateRecordRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecordRuleResponse input)
        {

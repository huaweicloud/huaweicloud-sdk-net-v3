...
namespace HuaweiCloud.SDK.CloudRtc.V1.Model
{
    ...
    public class ListRtcRealtimeQualityRequest 
    {
        ...
        {
            return this.Equals(input as ListRtcRealtimeQualityRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRtcRealtimeQualityRequest input)
        {
            ...
            if (this.SdkType != input.SdkType || (this.SdkType != null && !this.SdkType.Equals(input.SdkType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SdkType != null) hashCode = hashCode * 59 + this.SdkType.GetHashCode();

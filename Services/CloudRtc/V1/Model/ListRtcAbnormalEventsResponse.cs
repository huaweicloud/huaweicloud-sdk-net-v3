...
namespace HuaweiCloud.SDK.CloudRtc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRtcAbnormalEventsResponse : SdkResponse
    {
        ...
        public List<AbnormalEvent> Events { get; set; }
        ...
        {
            return this.Equals(input as ListRtcAbnormalEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRtcAbnormalEventsResponse input)
        {

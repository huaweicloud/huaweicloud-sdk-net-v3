...
namespace HuaweiCloud.SDK.CloudRtc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRtcRealtimeScaleResponse : SdkResponse
    {
        ...
        public List<TimeValueData> Scale { get; set; }
        ...
        {
            return this.Equals(input as ListRtcRealtimeScaleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRtcRealtimeScaleResponse input)
        {

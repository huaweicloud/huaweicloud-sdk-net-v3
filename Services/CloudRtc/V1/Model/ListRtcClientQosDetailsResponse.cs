...
namespace HuaweiCloud.SDK.CloudRtc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRtcClientQosDetailsResponse : SdkResponse
    {
        ...
        public List<QosQualityData> Data { get; set; }
        ...
        {
            return this.Equals(input as ListRtcClientQosDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRtcClientQosDetailsResponse input)
        {

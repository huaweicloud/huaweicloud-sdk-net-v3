...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListUserPrivilegesResponse : SdkResponse
    {
        ...
        public PrivilegesResponseV5Result Result { get; set; }
        ...
        {
            return this.Equals(input as ListUserPrivilegesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListUserPrivilegesResponse input)
        {

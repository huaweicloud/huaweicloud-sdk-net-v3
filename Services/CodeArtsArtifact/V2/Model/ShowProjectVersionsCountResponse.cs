...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectVersionsCountResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释**： 查询项目下的版本数量成功或失败的状态。 **取值范围**： - success：查询项目下的版本数量成功。 - error：查询项目下的版本数量失败。
        /// </summary>
        /// <value>**参数解释**： 查询项目下的版本数量成功或失败的状态。 **取值范围**： - success：查询项目下的版本数量成功。 - error：查询项目下的版本数量失败。</value>
        ...
        {
            return this.Equals(input as ShowProjectVersionsCountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectVersionsCountResponse input)
        {

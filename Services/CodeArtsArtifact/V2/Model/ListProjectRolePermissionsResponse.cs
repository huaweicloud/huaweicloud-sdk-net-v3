...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectRolePermissionsResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<ProjectRolePermissionDo> Result { get; set; }
        ...
        {
            return this.Equals(input as ListProjectRolePermissionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectRolePermissionsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateArtifactoryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateArtifactoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateArtifactoryResponse input)
        {

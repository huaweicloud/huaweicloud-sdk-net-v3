...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVersionListResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释**： 查询发布库版本列表成功或失败的状态。 **取值范围**： - success：查询发布库版本列表成功。 - error：查询发布库版本列表失败。
        /// </summary>
        /// <value>**参数解释**： 查询发布库版本列表成功或失败的状态。 **取值范围**： - success：查询发布库版本列表成功。 - error：查询发布库版本列表失败。</value>
        ...
        public List<VersionListViewV5> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowVersionListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVersionListResponse input)
        {

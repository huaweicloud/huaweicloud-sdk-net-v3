...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepositoryInfoResponse : SdkResponse
    {
        /// <summary>
        ...
        public RepositoryDO Result { get; set; }
        ...
        {
            return this.Equals(input as ShowRepositoryInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepositoryInfoResponse input)
        {

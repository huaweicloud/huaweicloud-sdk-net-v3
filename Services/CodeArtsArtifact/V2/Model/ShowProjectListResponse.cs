...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectListResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<ShowProjectListResult> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowProjectListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectListResponse input)
        {

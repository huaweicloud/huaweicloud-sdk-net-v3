...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListNetProxyResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<NetProxyModelV5> Result { get; set; }
        ...
        {
            return this.Equals(input as ListNetProxyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNetProxyResponse input)
        {

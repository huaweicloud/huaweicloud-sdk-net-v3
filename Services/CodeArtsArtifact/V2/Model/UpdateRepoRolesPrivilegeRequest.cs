...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    public class UpdateRepoRolesPrivilegeRequest 
    {
        ...
        public RolePrivilegeV5 Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRepoRolesPrivilegeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRepoRolesPrivilegeRequest input)
        {

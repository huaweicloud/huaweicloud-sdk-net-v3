...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowLatestVersionFilesCountResponse : SdkResponse
    {
        /// <summary>
        ...
        public LatestVersionFilesCount Result { get; set; }
        ...
        {
            return this.Equals(input as ShowLatestVersionFilesCountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowLatestVersionFilesCountResponse input)
        {

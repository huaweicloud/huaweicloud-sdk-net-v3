...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    public class RepositoryBuildVO 
    {
        ...
        /// </summary>
        [JsonProperty("snapshotStatus", NullValueHandling = NullValueHandling.Ignore)]
        public string SnapshotStatus { get; set; }

        /// <summary>
        /// **参数解释**： 正式仓库状态。 **取值范围**： 不涉及。
        /// </summary>
        [JsonProperty("releaseStatus", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("repositoryIds", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// **参数解释**： 父仓库名。 **取值范围**： 不涉及。
        /// </summary>
        [JsonProperty("parentRepoName", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// **参数解释**： 默认仓库。 **取值范围**： 不涉及。
        /// </summary>
        [JsonProperty("defaultDeployRepository", NullValueHandling = NullValueHandling.Ignore)]
        public string DefaultDeployRepository { get; set; }

        /// <summary>
        /// **参数解释**： 代理仓类型。 **取值范围**： - public：公共代理仓； - customize：用户自定义代理仓。
        /// </summary>
        [JsonProperty("remoteType", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("allowAnonymous", NullValueHandling = NullValueHandling.Ignore)]
        public bool? AllowAnonymous { get; set; }

        /// <summary>
        /// **参数解释**： 是否自动清理快照版本。 **取值范围**： 不涉及。
        /// </summary>
        [JsonProperty("autoCleanSnapshot", NullValueHandling = NullValueHandling.Ignore)]
        public bool? AutoCleanSnapshot { get; set; }

        /// <summary>
        /// **参数解释**： 快照版本有效期，单位：天。 **取值范围**： 不涉及。
        /// </summary>
        [JsonProperty("snapshotAliveDays", NullValueHandling = NullValueHandling.Ignore)]
        public string SnapshotAliveDays { get; set; }

        /// <summary>
        /// **参数解释**： 最大快照数。 **取值范围**： 不涉及。
        /// </summary>
        [JsonProperty("maxUniqueSnapshots", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("nexuRepo", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  remoteType: ").Append(RemoteType).Append("\n");
        ...
        {
            return this.Equals(input as RepositoryBuildVO);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RepositoryBuildVO input)
        {
            ...
            if (this.RemoteType != input.RemoteType || (this.RemoteType != null && !this.RemoteType.Equals(input.RemoteType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RemoteType != null) hashCode = hashCode * 59 + this.RemoteType.GetHashCode();

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDomainReleaseRepoStorageResponse : SdkResponse
    {
        /// <summary>
        ...
        public ReleaseStorageVOV5 Result { get; set; }
        ...
        {
            return this.Equals(input as ShowDomainReleaseRepoStorageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDomainReleaseRepoStorageResponse input)
        {

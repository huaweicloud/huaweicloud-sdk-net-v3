...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMultiRolesUserPermissionsResponse : SdkResponse
    {
        /// <summary>
        ...
        public ProjectRolePermissionDo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowMultiRolesUserPermissionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMultiRolesUserPermissionsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListFileBuildArchivesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListFileBuildArchivesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListFileBuildArchivesResponse input)
        {

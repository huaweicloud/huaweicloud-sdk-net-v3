...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSecGuardListResponse : SdkResponse
    {
        /// <summary>
        ...
        public SecGuardTaskCount Result { get; set; }
        ...
        {
            return this.Equals(input as ListSecGuardListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSecGuardListResponse input)
        {

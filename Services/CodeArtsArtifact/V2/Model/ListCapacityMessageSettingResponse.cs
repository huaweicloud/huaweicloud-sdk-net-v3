...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCapacityMessageSettingResponse : SdkResponse
    {
        /// <summary>
        ...
        public CapacitySettingVO Result { get; set; }
        ...
        {
            return this.Equals(input as ListCapacityMessageSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCapacityMessageSettingResponse input)
        {

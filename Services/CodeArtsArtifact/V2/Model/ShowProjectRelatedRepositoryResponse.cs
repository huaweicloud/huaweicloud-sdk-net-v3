...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectRelatedRepositoryResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释**： 查询项目列表成功或失败的状态。 **取值范围**： - success：查询项目列表成功。 - error：查询项目列表失败。
        /// </summary>
        /// <value>**参数解释**： 查询项目列表成功或失败的状态。 **取值范围**： - success：查询项目列表成功。 - error：查询项目列表失败。</value>
        ...
        public PrivilegeProjectInfoV5 Result { get; set; }
        ...
        {
            return this.Equals(input as ShowProjectRelatedRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectRelatedRepositoryResponse input)
        {

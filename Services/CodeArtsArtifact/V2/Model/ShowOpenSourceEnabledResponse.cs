...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowOpenSourceEnabledResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowOpenSourceEnabledResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowOpenSourceEnabledResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDomainIpConfigResponse : SdkResponse
    {
        /// <summary>
        ...
        public DomainIPWhiteListModelPage Result { get; set; }
        ...
        {
            return this.Equals(input as ListDomainIpConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDomainIpConfigResponse input)
        {

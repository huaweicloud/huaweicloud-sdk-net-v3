...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepositoryRolesPrivilegeResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowRepositoryRolesPrivilegeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepositoryRolesPrivilegeResponse input)
        {

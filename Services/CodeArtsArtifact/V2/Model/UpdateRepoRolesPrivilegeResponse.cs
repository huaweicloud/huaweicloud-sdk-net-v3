...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRepoRolesPrivilegeResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<Privilege> Result { get; set; }
        ...
        {
            return this.Equals(input as UpdateRepoRolesPrivilegeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRepoRolesPrivilegeResponse input)
        {

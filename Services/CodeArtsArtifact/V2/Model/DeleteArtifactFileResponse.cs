...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteArtifactFileResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteArtifactFileResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteArtifactFileResponse input)
        {

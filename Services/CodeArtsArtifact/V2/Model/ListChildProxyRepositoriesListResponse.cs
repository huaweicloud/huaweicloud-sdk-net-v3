...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListChildProxyRepositoriesListResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<RepositoryDOV5> Result { get; set; }
        ...
        {
            return this.Equals(input as ListChildProxyRepositoriesListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListChildProxyRepositoriesListResponse input)
        {

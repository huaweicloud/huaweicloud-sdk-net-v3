...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectUsersResponse : SdkResponse
    {
        /// <summary>
        ...
        public RepoUserPrivilegeResult Result { get; set; }
        ...
        {
            return this.Equals(input as ListProjectUsersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectUsersResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyRepositoryResponse : SdkResponse
    {
        /// <summary>
        ...
        public MavenTabRepo Result { get; set; }
        ...
        {
            return this.Equals(input as ModifyRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyRepositoryResponse input)
        {

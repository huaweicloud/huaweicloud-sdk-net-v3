...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListLatestVersionFilesResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<VersionViewVoV5> Result { get; set; }
        ...
        {
            return this.Equals(input as ListLatestVersionFilesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLatestVersionFilesResponse input)
        {

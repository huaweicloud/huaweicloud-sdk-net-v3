...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SearchArtifactsResponse : SdkResponse
    {
        /// <summary>
        ...
        public SearchArtifactsResult Result { get; set; }
        ...
        {
            return this.Equals(input as SearchArtifactsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchArtifactsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchRestoreRepoResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BatchRestoreRepoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRestoreRepoResponse input)
        {

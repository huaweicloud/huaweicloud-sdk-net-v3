...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    public class ShowProjectListResult 
    {
        ...
        /// </summary>
        [JsonProperty("excludesPattern", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public string StorageSummaryInfo { get; set; }
        ...
        {
            return this.Equals(input as ShowProjectListResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectListResult input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectStorageInfoResponse : SdkResponse
    {
        /// <summary>
        ...
        public StorageInfoDOV5 Result { get; set; }
        ...
        {
            return this.Equals(input as ShowProjectStorageInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectStorageInfoResponse input)
        {

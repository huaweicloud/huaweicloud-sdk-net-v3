...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    public class DomainIPWhiteListModelPage 
    {
        ...
        public List<DomainIPWhiteListModel> Data { get; set; }
        ...
        {
            return this.Equals(input as DomainIPWhiteListModelPage);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DomainIPWhiteListModelPage input)
        {

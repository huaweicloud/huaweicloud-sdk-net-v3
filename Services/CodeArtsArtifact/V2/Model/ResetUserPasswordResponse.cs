...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ResetUserPasswordResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ResetUserPasswordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResetUserPasswordResponse input)
        {

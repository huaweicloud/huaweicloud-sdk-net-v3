...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SearchByChecksumResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<ArtifactSearchResult> Result { get; set; }
        ...
        {
            return this.Equals(input as SearchByChecksumResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchByChecksumResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    public class PrivilegeParam 
    {
        ...
        /// </summary>
        /// <value>**参数解释**: 操作权限，多个权限以英文逗号隔开。 **约束限制**: 不涉及。 **取值范围**: 可选值：createrepository,editrepository,restore,deleterepository,physicdelete,restoreall,clearall,deleteorredeploy,downloadorview,import,upload,export。 **默认取值**: 无。 </value>
        ...
        {
            return this.Equals(input as PrivilegeParam);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PrivilegeParam input)
        {

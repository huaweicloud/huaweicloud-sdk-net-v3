...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMavenUserResponse : SdkResponse
    {
        /// <summary>
        ...
        public DevcloudUserDOV5Page Result { get; set; }
        ...
        {
            return this.Equals(input as ListMavenUserResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMavenUserResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListArtifactoryComponentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListArtifactoryComponentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListArtifactoryComponentResponse input)
        {

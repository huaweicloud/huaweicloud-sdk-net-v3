...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPackageDataDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPackageDataDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPackageDataDetailResponse input)
        {

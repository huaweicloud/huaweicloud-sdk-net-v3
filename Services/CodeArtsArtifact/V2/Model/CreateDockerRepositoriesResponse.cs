...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDockerRepositoriesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDockerRepositoriesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDockerRepositoriesResponse input)
        {

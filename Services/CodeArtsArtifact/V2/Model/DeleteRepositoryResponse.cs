...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteRepositoryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteRepositoryResponse input)
        {

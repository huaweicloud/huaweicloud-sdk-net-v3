...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteTrashesResponse : SdkResponse
    {
        /// <summary>
        ...
        public TrashcanResultData Result { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteTrashesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteTrashesResponse input)
        {

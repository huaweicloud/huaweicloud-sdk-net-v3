...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListArtifactoryStorageStatisticResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<StorageStatisticDO> Result { get; set; }
        ...
        {
            return this.Equals(input as ListArtifactoryStorageStatisticResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListArtifactoryStorageStatisticResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFileTreeResponse : SdkResponse
    {
        /// <summary>
        ...
        public ShowFileTreeResult Result { get; set; }
        ...
        {
            return this.Equals(input as ShowFileTreeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFileTreeResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFileDetailByFullNameResponse : SdkResponse
    {
        /// <summary>
        ...
        public RepoFileDOV5 Result { get; set; }
        ...
        {
            return this.Equals(input as ShowFileDetailByFullNameResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFileDetailByFullNameResponse input)
        {

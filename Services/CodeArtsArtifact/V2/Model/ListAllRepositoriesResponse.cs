...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAllRepositoriesResponse : SdkResponse
    {
        /// <summary>
        ...
        public ListAllRepositoriesResult Result { get; set; }
        ...
        {
            return this.Equals(input as ListAllRepositoriesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllRepositoriesResponse input)
        {

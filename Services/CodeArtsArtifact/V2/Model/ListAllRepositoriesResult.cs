...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    public class ListAllRepositoriesResult 
    {
        ...
        public List<RepositoryBasicDO> Repositories { get; set; }
        ...
        {
            return this.Equals(input as ListAllRepositoriesResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllRepositoriesResult input)
        {

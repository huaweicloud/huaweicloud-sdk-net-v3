...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateArtifactoryResponse : SdkResponse
    {
        /// <summary>
        ...
        public CreateArtifactoryResult Result { get; set; }
        ...
        {
            return this.Equals(input as CreateArtifactoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateArtifactoryResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateMavenRepoResponse : SdkResponse
    {
        /// <summary>
        ...
        public CreateMavenRepoResult Result { get; set; }
        ...
        {
            return this.Equals(input as CreateMavenRepoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMavenRepoResponse input)
        {

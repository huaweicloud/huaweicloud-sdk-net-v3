...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMavenInfoResponse : SdkResponse
    {
        /// <summary>
        ...
        public List<RepositoryBuildVO> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowMavenInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMavenInfoResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepoUserInfoResponse : SdkResponse
    {
        /// <summary>
        ...
        public RepositoryUserDO Result { get; set; }
        ...
        {
            return this.Equals(input as ShowRepoUserInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepoUserInfoResponse input)
        {

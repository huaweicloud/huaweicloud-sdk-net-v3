...
namespace HuaweiCloud.SDK.CodeArtsArtifact.V2
{
    public class CodeArtsArtifactRegion
    {
        ...
        private static readonly IRegionProvider Provider = RegionProviderChain.GetDefault("CODEARTSARTIFACT");
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'CodeArtsArtifact': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
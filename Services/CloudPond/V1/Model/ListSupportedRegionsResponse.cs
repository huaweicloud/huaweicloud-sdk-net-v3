...
namespace HuaweiCloud.SDK.CloudPond.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSupportedRegionsResponse : SdkResponse
    {
        ...
        public List<RegionDetail> Regions { get; set; }
        ...
        {
            return this.Equals(input as ListSupportedRegionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSupportedRegionsResponse input)
        {

...
namespace HuaweiCloud.SDK.CloudPond.V2.Model
{
    ...
    public class ListNetworkDeviceOfferingsRequest 
    {
        ...
        /// 存储类型
        /// </summary>
        [SDKProperty("storage_type", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListNetworkDeviceOfferingsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListNetworkDeviceOfferingsRequest input)
        {

...
namespace HuaweiCloud.SDK.CloudPond.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListServerOfferingsResponse : SdkResponse
    {
        ...
        public List<ServerOffering> Offerings { get; set; }
        ...
        {
            return this.Equals(input as ListServerOfferingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListServerOfferingsResponse input)
        {

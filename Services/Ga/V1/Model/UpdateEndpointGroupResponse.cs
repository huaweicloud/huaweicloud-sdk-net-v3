...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateEndpointGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateEndpointGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateEndpointGroupResponse input)
        {

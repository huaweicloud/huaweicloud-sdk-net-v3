...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateHealthCheckResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateHealthCheckResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHealthCheckResponse input)
        {

...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    public class CountResourcesByTagRequest 
    {
        ...
        public ListResourcesByTagRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CountResourcesByTagRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CountResourcesByTagRequest input)
        {

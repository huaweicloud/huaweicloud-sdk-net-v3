...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAcceleratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAcceleratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAcceleratorResponse input)
        {

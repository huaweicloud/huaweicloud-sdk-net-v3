...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    public class AcceleratorDetail 
    {
        ...
        /// 全球加速器IP列表。
        /// </summary>
        [JsonProperty("ip_sets", NullValueHandling = NullValueHandling.Ignore)]
        public List<AccelerateIp> IpSets { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ipSets: ").Append(IpSets).Append("\n");
        ...
        {
            return this.Equals(input as AcceleratorDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AcceleratorDetail input)
        {
            ...
            if (this.IpSets != input.IpSets || (this.IpSets != null && input.IpSets != null && !this.IpSets.SequenceEqual(input.IpSets))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IpSets != null) hashCode = hashCode * 59 + this.IpSets.GetHashCode();

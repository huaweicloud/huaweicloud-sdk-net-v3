...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    public class DisassociateListenerRequest 
    {
        ...
        /// IP地址组ID。
        /// </summary>
        [SDKProperty("ip_group_id", IsPath = true)]
        [JsonProperty("ip_group_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public DisassociateListenerRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DisassociateListenerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateListenerRequest input)
        {

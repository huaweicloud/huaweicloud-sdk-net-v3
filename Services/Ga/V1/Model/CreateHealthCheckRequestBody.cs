...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    public class CreateHealthCheckRequestBody 
    {
        ...
        public CreateHealthCheckOption HealthCheck { get; set; }
        ...
        {
            return this.Equals(input as CreateHealthCheckRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateHealthCheckRequestBody input)
        {

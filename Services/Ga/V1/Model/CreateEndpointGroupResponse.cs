...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateEndpointGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateEndpointGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateEndpointGroupResponse input)
        {

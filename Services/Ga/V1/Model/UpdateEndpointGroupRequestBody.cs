...
namespace HuaweiCloud.SDK.Ga.V1.Model
{
    ...
    public class UpdateEndpointGroupRequestBody 
    {
        ...
        public UpdateEndpointGroupOption EndpointGroup { get; set; }
        ...
        {
            return this.Equals(input as UpdateEndpointGroupRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateEndpointGroupRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    public class CreateTenantVpcIgwRequestBody 
    {
        ...
        public CreateTenantVpcIgwRequestBodyVpcIgw VpcIgw { get; set; }
        ...
        {
            return this.Equals(input as CreateTenantVpcIgwRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTenantVpcIgwRequestBody input)
        {
            if (input == null)
                return false;

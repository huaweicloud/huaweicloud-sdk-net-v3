...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDisassociatePublicipResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDisassociatePublicipResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDisassociatePublicipResponse input)
        {
            if (input == null)
                return false;

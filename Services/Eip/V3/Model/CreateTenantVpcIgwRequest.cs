...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    public class CreateTenantVpcIgwRequest 
    {
        ...
        public CreateTenantVpcIgwRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTenantVpcIgwRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTenantVpcIgwRequest input)
        {

...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTenantVpcIgwResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTenantVpcIgwResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTenantVpcIgwResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    public class ListShareBandwidthTypesResponse : SdkResponse
    {
        ...
        public bool Equals(ListShareBandwidthTypesResponse input)
        {
            ...
            if (this.ShareBandwidthTypes != input.ShareBandwidthTypes || (this.ShareBandwidthTypes != null && input.ShareBandwidthTypes != null && !this.ShareBandwidthTypes.SequenceEqual(input.ShareBandwidthTypes))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.ShareBandwidthTypes != null) hashCode = hashCode * 59 + this.ShareBandwidthTypes.GetHashCode();

...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetachBatchPublicIpResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetachBatchPublicIpResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetachBatchPublicIpResponse input)
        {

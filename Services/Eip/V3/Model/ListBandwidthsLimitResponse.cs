...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    public class ListBandwidthsLimitResponse : SdkResponse
    {
        ...
        public bool Equals(ListBandwidthsLimitResponse input)
        {
            ...
            return 
                (
                    this.EipBandwidthLimits == input.EipBandwidthLimits ||
                    this.EipBandwidthLimits != null &&
                    input.EipBandwidthLimits != null &&
                    this.EipBandwidthLimits.SequenceEqual(input.EipBandwidthLimits)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EipBandwidthLimits != null)
                    hashCode = hashCode * 59 + this.EipBandwidthLimits.GetHashCode();

...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInternalVpcIgwResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInternalVpcIgwResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInternalVpcIgwResponse input)
        {
            if (input == null)
                return false;

    ...
    public class PublicipSingleShowResp 
    {
        ...
        public bool Equals(PublicipSingleShowResp input)
        {
            ...
            return 
                ...
                (
                    this.AssociateInstanceMetadata == input.AssociateInstanceMetadata ||
                    (this.AssociateInstanceMetadata != null &&
                    this.AssociateInstanceMetadata.Equals(input.AssociateInstanceMetadata))
                ) && 
                (
                ...
                (
                    this.CascadeDeleteByInstance == input.CascadeDeleteByInstance ||
                    (this.CascadeDeleteByInstance != null &&
                    this.CascadeDeleteByInstance.Equals(input.CascadeDeleteByInstance))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssociateInstanceMetadata != null)
                    hashCode = hashCode * 59 + this.AssociateInstanceMetadata.GetHashCode();
                ...
                if (this.CascadeDeleteByInstance != null)
                    hashCode = hashCode * 59 + this.CascadeDeleteByInstance.GetHashCode();
                return hashCode;
            }
        }
    }

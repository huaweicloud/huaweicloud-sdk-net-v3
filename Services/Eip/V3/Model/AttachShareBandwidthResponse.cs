...
namespace HuaweiCloud.SDK.Eip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AttachShareBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AttachShareBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachShareBandwidthResponse input)
        {
            if (input == null)
                return false;

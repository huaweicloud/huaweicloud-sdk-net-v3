...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    public class RemovePublicipsFromSharedBandwidthRequest 
    {
        ...
        public RemovePublicipsFromSharedBandwidthRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RemovePublicipsFromSharedBandwidthRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemovePublicipsFromSharedBandwidthRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    public class BatchCreatePublicipTagsRequest 
    {
        ...
        public BatchCreatePublicipTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreatePublicipTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreatePublicipTagsRequest input)
        {
            if (input == null)
                return false;

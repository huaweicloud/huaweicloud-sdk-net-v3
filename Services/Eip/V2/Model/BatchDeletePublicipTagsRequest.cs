...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    public class BatchDeletePublicipTagsRequest 
    {
        ...
        public BatchDeletePublicipTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeletePublicipTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeletePublicipTagsRequest input)
        {
            if (input == null)
                return false;

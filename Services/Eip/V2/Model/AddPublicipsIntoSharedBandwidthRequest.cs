...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    public class AddPublicipsIntoSharedBandwidthRequest 
    {
        ...
        public AddPublicipsIntoSharedBandwidthRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddPublicipsIntoSharedBandwidthRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddPublicipsIntoSharedBandwidthRequest input)
        {

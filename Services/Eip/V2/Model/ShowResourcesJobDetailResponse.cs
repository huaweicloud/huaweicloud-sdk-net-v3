...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowResourcesJobDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowResourcesJobDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourcesJobDetailResponse input)
        {
            if (input == null)
                return false;

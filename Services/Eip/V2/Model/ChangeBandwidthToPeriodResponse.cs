...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ChangeBandwidthToPeriodResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ChangeBandwidthToPeriodResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeBandwidthToPeriodResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    public class BatchCreatePublicipTagsRequestBody 
    {
        ...
        /// </summary>
        /// <value>操作标识  create：创建  action为create时，tag的value必选</value>
        ...
        {
            return this.Equals(input as BatchCreatePublicipTagsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreatePublicipTagsRequestBody input)
        {

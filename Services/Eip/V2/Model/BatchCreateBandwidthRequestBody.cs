...
namespace HuaweiCloud.SDK.Eip.V2.Model
{
    ...
    public class BatchCreateBandwidthRequestBody 
    {
        ...
        public BatchCreateBandwidthOption Bandwidth { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateBandwidthRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateBandwidthRequestBody input)
        {

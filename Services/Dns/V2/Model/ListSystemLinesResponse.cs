...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSystemLinesResponse : SdkResponse
    {
        ...
        public List<SystemLine> Lines { get; set; }
        ...
        {
            return this.Equals(input as ListSystemLinesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSystemLinesResponse input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class BatchCreatePublicRecordsetsTaskRequestBody 
    {
        ...
        public List<BatchCreatePublicRecordsetsTaskItem> Recordsets { get; set; }
        ...
        {
            return this.Equals(input as BatchCreatePublicRecordsetsTaskRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreatePublicRecordsetsTaskRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class BatchDeleteRecordSetWithLineRequest 
    {
        ...
        public BatchDeleteRecordSetWithLineRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteRecordSetWithLineRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteRecordSetWithLineRequest input)
        {

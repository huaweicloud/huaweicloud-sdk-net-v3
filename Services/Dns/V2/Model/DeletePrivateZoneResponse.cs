...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeletePrivateZoneResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeletePrivateZoneResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeletePrivateZoneResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisassociateResolverQueryLogConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DisassociateResolverQueryLogConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateResolverQueryLogConfigResponse input)
        {

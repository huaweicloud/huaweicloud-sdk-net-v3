...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateLineGroupsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateLineGroupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateLineGroupsResponse input)
        {
            if (input == null)
                return false;

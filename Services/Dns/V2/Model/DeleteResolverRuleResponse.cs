...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteResolverRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteResolverRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteResolverRuleResponse input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRecordSetsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRecordSetsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecordSetsResponse input)
        {

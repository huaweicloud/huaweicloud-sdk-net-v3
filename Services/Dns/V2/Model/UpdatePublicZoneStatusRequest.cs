...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class UpdatePublicZoneStatusRequest 
    {
        ...
        public UpdatePublicZoneStatusRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePublicZoneStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePublicZoneStatusRequest input)
        {
            if (input == null)
                return false;

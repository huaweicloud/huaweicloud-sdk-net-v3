...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCustomLineResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCustomLineResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCustomLineResponse input)
        {

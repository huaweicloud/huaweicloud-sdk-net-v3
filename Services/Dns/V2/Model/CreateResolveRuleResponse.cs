...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateResolveRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateResolveRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateResolveRuleResponse input)
        {
            if (input == null)
                return false;

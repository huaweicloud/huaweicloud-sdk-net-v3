...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class CreateRecordSetWithLineRequest 
    {
        ...
        public CreateRecordSetWithLineRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateRecordSetWithLineRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRecordSetWithLineRequest input)
        {

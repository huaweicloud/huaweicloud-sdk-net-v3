...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateResolverRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateResolverRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateResolverRuleResponse input)
        {

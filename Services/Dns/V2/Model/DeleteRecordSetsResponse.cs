...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteRecordSetsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteRecordSetsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteRecordSetsResponse input)
        {
            if (input == null)
                return false;

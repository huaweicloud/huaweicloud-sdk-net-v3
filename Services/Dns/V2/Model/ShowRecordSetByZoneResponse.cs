...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRecordSetByZoneResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRecordSetByZoneResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRecordSetByZoneResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePrivateZoneStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePrivateZoneStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateZoneStatusResponse input)
        {

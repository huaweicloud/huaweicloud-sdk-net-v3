...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowEmailRecordSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowEmailRecordSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEmailRecordSetResponse input)
        {

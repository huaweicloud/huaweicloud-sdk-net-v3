...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateResolverQueryLogConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AssociateResolverQueryLogConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateResolverQueryLogConfigResponse input)
        {

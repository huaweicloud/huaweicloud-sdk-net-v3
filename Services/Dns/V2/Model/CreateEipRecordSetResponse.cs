...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateEipRecordSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateEipRecordSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateEipRecordSetResponse input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePublicZoneResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePublicZoneResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePublicZoneResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class SetPrivateZoneProxyPatternRequest 
    {
        ...
        public SetPrivateZoneProxyPatternRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetPrivateZoneProxyPatternRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetPrivateZoneProxyPatternRequest input)
        {

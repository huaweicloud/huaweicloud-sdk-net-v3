...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class EnableDnssecConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as EnableDnssecConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EnableDnssecConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteCustomLineResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteCustomLineResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteCustomLineResponse input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class CreateRecordSetWithBatchLinesRequest 
    {
        ...
        public CreateRSetBatchLinesReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateRecordSetWithBatchLinesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRecordSetWithBatchLinesRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRecordSetWithLineResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateRecordSetWithLineResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRecordSetWithLineResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class BatchCreateRecordSetsTaskRequestBody 
    {
        ...
        public List<BatchCreateRecordSetsTaskItem> Recordsets { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateRecordSetsTaskRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateRecordSetsTaskRequestBody input)
        {

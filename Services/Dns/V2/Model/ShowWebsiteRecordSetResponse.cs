...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWebsiteRecordSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowWebsiteRecordSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWebsiteRecordSetResponse input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRecordSetWithBatchLinesResponse : SdkResponse
    {
        ...
        public List<QueryRecordSetWithLineResp> Recordsets { get; set; }
        ...
        {
            return this.Equals(input as CreateRecordSetWithBatchLinesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRecordSetWithBatchLinesResponse input)
        {
            if (input == null)
                return false;

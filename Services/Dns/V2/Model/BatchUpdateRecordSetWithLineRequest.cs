...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class BatchUpdateRecordSetWithLineRequest 
    {
        ...
        public BatchUpdateRecordSetWithLineRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateRecordSetWithLineRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateRecordSetWithLineRequest input)
        {

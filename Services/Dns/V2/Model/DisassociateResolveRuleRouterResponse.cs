...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisassociateResolveRuleRouterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DisassociateResolveRuleRouterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateResolveRuleRouterResponse input)
        {
            if (input == null)
                return false;

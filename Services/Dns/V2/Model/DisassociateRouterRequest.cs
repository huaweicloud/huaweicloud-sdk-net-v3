...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class DisassociateRouterRequest 
    {
        ...
        public DisassociaterouterRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DisassociateRouterRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateRouterRequest input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUpdateRecordSetWithLineResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchUpdateRecordSetWithLineResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateRecordSetWithLineResponse input)
        {
            if (input == null)
                return false;

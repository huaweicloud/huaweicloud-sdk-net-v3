...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisassociateHealthCheckResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DisassociateHealthCheckResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateHealthCheckResponse input)
        {
            if (input == null)
                return false;

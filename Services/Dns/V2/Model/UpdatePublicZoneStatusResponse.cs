...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePublicZoneStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePublicZoneStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePublicZoneStatusResponse input)
        {

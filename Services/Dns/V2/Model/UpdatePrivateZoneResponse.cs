...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePrivateZoneResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePrivateZoneResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateZoneResponse input)
        {
            if (input == null)
                return false;

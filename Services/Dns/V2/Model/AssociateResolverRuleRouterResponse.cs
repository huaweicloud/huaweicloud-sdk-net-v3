...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateResolverRuleRouterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AssociateResolverRuleRouterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateResolverRuleRouterResponse input)
        {

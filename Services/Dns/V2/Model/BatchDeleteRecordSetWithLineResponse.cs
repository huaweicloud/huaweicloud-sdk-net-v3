...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteRecordSetWithLineResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteRecordSetWithLineResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteRecordSetWithLineResponse input)
        {
            if (input == null)
                return false;

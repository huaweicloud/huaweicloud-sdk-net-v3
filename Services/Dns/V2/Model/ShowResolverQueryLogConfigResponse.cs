...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowResolverQueryLogConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowResolverQueryLogConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResolverQueryLogConfigResponse input)
        {

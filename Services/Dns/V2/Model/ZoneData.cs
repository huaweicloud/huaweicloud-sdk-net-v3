...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class ZoneData 
    {
        ...
        {
            return this.Equals(input as ZoneData);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ZoneData input)
        {
            ...
            if (this.Masters != input.Masters || (this.Masters != null && !this.Masters.Equals(input.Masters))) return false;

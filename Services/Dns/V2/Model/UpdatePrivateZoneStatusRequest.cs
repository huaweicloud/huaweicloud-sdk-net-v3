...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class UpdatePrivateZoneStatusRequest 
    {
        ...
        public UpdateZoneStatusRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePrivateZoneStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateZoneStatusRequest input)
        {

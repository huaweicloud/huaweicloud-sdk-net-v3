...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    public class UpdateResolverRuleRequest 
    {
        ...
        public UpdateResolverRuleRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateResolverRuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateResolverRuleRequest input)
        {

...
namespace HuaweiCloud.SDK.Dns.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAuthorizeTxtRecordResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAuthorizeTxtRecordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAuthorizeTxtRecordResponse input)
        {

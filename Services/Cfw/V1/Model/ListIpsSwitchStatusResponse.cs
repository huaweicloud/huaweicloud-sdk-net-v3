...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListIpsSwitchStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListIpsSwitchStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListIpsSwitchStatusResponse input)
        {

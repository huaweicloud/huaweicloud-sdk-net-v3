...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class DeleteDomainSetResponseDatas 
    {
        ...
        public List<DomainSetId> ResponseDatas { get; set; }
        ...
        {
            return this.Equals(input as DeleteDomainSetResponseDatas);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteDomainSetResponseDatas input)
        {

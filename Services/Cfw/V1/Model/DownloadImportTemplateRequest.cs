...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadImportTemplateRequest 
    {
        ...
        {
            return this.Equals(input as DownloadImportTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadImportTemplateRequest input)
        {

...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ShowAccessDetailRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： top_deny_rule 命中拦截策略 dst_ip 拦截目的IP src_ip 拦截源IP dst_port 拦截端口 dst_region 拦截目的地区 src_region 拦截源地区 **默认取值**： 不涉及</value>
        ...
        /// </summary>
        [SDKProperty("item_id", IsQuery = true)]
        ...
        {
            return this.Equals(input as ShowAccessDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAccessDetailRequest input)
        {

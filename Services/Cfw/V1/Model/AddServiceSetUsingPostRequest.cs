...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class AddServiceSetUsingPostRequest 
    {
        ...
        public AddServiceSetUsingPOSTRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddServiceSetUsingPostRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddServiceSetUsingPostRequest input)
        {
            if (input == null)
                return false;

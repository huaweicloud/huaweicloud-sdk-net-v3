...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListOrganizationTreeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListOrganizationTreeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOrganizationTreeResponse input)
        {

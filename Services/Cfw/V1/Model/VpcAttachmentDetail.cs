...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class VpcAttachmentDetail 
    {
        ...
        /// vpc项目id
        /// </summary>
        [JsonProperty("vpc_project_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  vpcProjectId: ").Append(VpcProjectId).Append("\n");
        ...
        {
            return this.Equals(input as VpcAttachmentDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(VpcAttachmentDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.VpcProjectId == input.VpcProjectId ||
                    (this.VpcProjectId != null &&
                    this.VpcProjectId.Equals(input.VpcProjectId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VpcProjectId != null)
                    hashCode = hashCode * 59 + this.VpcProjectId.GetHashCode();

...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class IpRegionResponseBodyData 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  superiorRegionId: ").Append(SuperiorRegionId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IpRegionResponseBodyData);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IpRegionResponseBodyData input)
        {
            ...
            if (this.SuperiorRegionId != input.SuperiorRegionId || (this.SuperiorRegionId != null && !this.SuperiorRegionId.Equals(input.SuperiorRegionId))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SuperiorRegionId != null) hashCode = hashCode * 59 + this.SuperiorRegionId.GetHashCode();
                return hashCode;
            }
        }
    }

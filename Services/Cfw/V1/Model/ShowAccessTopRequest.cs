...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ShowAccessTopRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： strategy_hit_info 策略的命中趋势 strategy_dashboard 策略命中概览 top_deny_rule TOP命中拦截策略 dst_ip TOP拦截目的IP src_ip TOP拦截源IP dst_port TOP拦截端口 dst_region TOP拦截目的地区 src_region TOP拦截源地区 **默认取值**： 不涉及</value>
        ...
        public class ItemEnum
        {
            ...
            /// </summary>
            public static readonly ItemEnum STRATEGY_DASHBOARD = new ItemEnum("strategy_dashboard");

            /// <summary>
            /// Enum STRATEGY_HIT_INFO for value: strategy_hit_info
            /// </summary>
            public static readonly ItemEnum STRATEGY_HIT_INFO = new ItemEnum("strategy_hit_info");

            /// <summary>
            /// Enum TOP_DENY_RULE for value: top_deny_rule
            /// </summary>
            public static readonly ItemEnum TOP_DENY_RULE = new ItemEnum("top_deny_rule");
            ...
            /// </summary>
            public static readonly ItemEnum SRC_REGION = new ItemEnum("src_region");

            /// <summary>
            /// Enum DST_REGION for value: dst_region
            /// </summary>
            public static readonly ItemEnum DST_REGION = new ItemEnum("dst_region");
        ...
        {
            return this.Equals(input as ShowAccessTopRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAccessTopRequest input)
        {
            ...
            if (this.RuleId != input.RuleId || (this.RuleId != null && input.RuleId != null && !this.RuleId.SequenceEqual(input.RuleId))) return false;

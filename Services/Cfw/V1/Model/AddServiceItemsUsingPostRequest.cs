...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class AddServiceItemsUsingPostRequest 
    {
        ...
        public AddServiceItemsUsingPOSTRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddServiceItemsUsingPostRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddServiceItemsUsingPostRequest input)
        {
            if (input == null)
                return false;

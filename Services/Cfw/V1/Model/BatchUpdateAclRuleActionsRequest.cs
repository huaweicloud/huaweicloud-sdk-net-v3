...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class BatchUpdateAclRuleActionsRequest 
    {
        ...
        public UpdateSecurityPolciesActionDto Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateAclRuleActionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateAclRuleActionsRequest input)
        {

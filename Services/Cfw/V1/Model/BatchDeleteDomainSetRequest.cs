...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class BatchDeleteDomainSetRequest 
    {
        ...
        public BatchDeleteDomainSetsDto Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteDomainSetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteDomainSetRequest input)
        {

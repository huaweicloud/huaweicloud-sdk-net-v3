...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class UpdateServiceSetUsingPutRequest 
    {
        ...
        public UpdateServiceSetUsingPUTRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateServiceSetUsingPutRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateServiceSetUsingPutRequest input)
        {
            if (input == null)
                return false;

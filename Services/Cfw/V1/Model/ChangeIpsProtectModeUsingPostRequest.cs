...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ChangeIpsProtectModeUsingPostRequest 
    {
        ...
        public IpsProtectDTO Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeIpsProtectModeUsingPostRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeIpsProtectModeUsingPostRequest input)
        {
            if (input == null)
                return false;

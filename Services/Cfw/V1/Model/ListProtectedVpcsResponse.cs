...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProtectedVpcsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProtectedVpcsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProtectedVpcsResponse input)
        {

...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ListFlowStatisticRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： src_ip 源IP dst_ip 目的IP dst_port 目的端口 protocol　协议 dst_host　目的域名 app　应用 dst_region_name　目的地区 src_region_name　源地区 risk_ip 风险IP risk_host 风险域名 open_port 开放端口 **默认取值**： 不涉及</value>
        ...
        public class ItemEnum
        {
            ...
            /// </summary>
            public static readonly ItemEnum PROTOCOL = new ItemEnum("protocol");

            /// <summary>
            /// Enum DST_HOST for value: dst_host
            /// </summary>
            public static readonly ItemEnum DST_HOST = new ItemEnum("dst_host");

            /// <summary>
            /// Enum APP for value: app
            /// </summary>
            public static readonly ItemEnum APP = new ItemEnum("app");
            ...
            /// </summary>
            public static readonly ItemEnum DST_REGION_NAME = new ItemEnum("dst_region_name");

            /// <summary>
            /// Enum SRC_REGION_NAME for value: src_region_name
            /// </summary>
            public static readonly ItemEnum SRC_REGION_NAME = new ItemEnum("src_region_name");
        ...
        {
            return this.Equals(input as ListFlowStatisticRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListFlowStatisticRequest input)
        {

...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddEipAlarmWhitelistResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddEipAlarmWhitelistResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddEipAlarmWhitelistResponse input)
        {

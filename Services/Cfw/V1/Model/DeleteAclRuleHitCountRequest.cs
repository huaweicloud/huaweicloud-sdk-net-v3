...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class DeleteAclRuleHitCountRequest 
    {
        ...
        public ClearAccessLogRuleHitCountsDto Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteAclRuleHitCountRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteAclRuleHitCountRequest input)
        {

...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class UpdateAlarmConfigRequest 
    {
        ...
        public UpdateAttackLogAlarmConfigDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateAlarmConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAlarmConfigRequest input)
        {

...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ShowTrafficTrendRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： avg为平均值 max为最大值 **默认取值**： 不涉及</value>
        [JsonConverter(typeof(EnumClassConverter<AggTypeEnum>))]
        public class AggTypeEnum
        {
            /// <summary>
            /// Enum AVG for value: avg
            /// </summary>
            public static readonly AggTypeEnum AVG = new AggTypeEnum("avg");

            /// <summary>
            /// Enum MAX for value: max
            /// </summary>
            public static readonly AggTypeEnum MAX = new AggTypeEnum("max");

            private static readonly Dictionary<string, AggTypeEnum> StaticFields =
            new Dictionary<string, AggTypeEnum>()
            {
                { "avg", AVG },
                { "max", MAX },
            };
            ...
            public AggTypeEnum(string value)
            {
                _value = value;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as AggTypeEnum))
                {
                    return true;
                }
            ...
            public bool Equals(AggTypeEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(AggTypeEnum a, AggTypeEnum b)
            {
                if (ReferenceEquals(a, b))
                {
                    return true;
        ...
        /// **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： avg为平均值 max为最大值 **默认取值**： 不涉及
        /// </summary>
        [SDKProperty("agg_type", IsQuery = true)]
        [JsonProperty("agg_type", NullValueHandling = NullValueHandling.Ignore)]
        public AggTypeEnum AggType { get; set; }
        /// <summary>
        ...
        {
            return this.Equals(input as ShowTrafficTrendRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTrafficTrendRequest input)
        {
            ...
            if (this.AggType != input.AggType) return false;

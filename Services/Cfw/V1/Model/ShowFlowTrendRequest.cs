...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ShowFlowTrendRequest 
    {
        ...
        {
            return this.Equals(input as ShowFlowTrendRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFlowTrendRequest input)
        {
            ...
            if (this.Vpc != input.Vpc || (this.Vpc != null && input.Vpc != null && !this.Vpc.SequenceEqual(input.Vpc))) return false;

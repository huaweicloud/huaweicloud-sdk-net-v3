...
namespace HuaweiCloud.SDK.Cfw.V1.Model
{
    ...
    public class ListAttackStatisticRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： dst TOP攻击目的统计 src TOP攻击来源统计 **默认取值**： 不涉及</value>
        ...
        public class ItemEnum
        {
            ...
            /// </summary>
            public static readonly ItemEnum DST = new ItemEnum("dst");

            /// <summary>
            /// Enum SRC for value: src
            /// </summary>
            public static readonly ItemEnum SRC = new ItemEnum("src");
        ...
        {
            return this.Equals(input as ListAttackStatisticRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAttackStatisticRequest input)
        {

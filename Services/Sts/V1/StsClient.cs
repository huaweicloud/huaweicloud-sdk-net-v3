...
namespace HuaweiCloud.SDK.Sts.V1
{
    public partial class StsClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public AssumeAgencyWithOIDCResponse AssumeAgencyWithOIDC(AssumeAgencyWithOIDCRequest assumeAgencyWithOIDCRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<AssumeAgencyWithOIDCResponse> AssumeAgencyWithOIDCInvoker(AssumeAgencyWithOIDCRequest assumeAgencyWithOIDCRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/agencies/assume-with-oidc", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", assumeAgencyWithOIDCRequest);
            return new SyncInvoker<AssumeAgencyWithOIDCResponse>(this, "POST", request, JsonUtils.DeSerialize<AssumeAgencyWithOIDCResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public AssumeAgencyWithSAMLResponse AssumeAgencyWithSAML(AssumeAgencyWithSAMLRequest assumeAgencyWithSAMLRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<AssumeAgencyWithSAMLResponse> AssumeAgencyWithSAMLInvoker(AssumeAgencyWithSAMLRequest assumeAgencyWithSAMLRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/agencies/assume-with-saml", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", assumeAgencyWithSAMLRequest);
            return new SyncInvoker<AssumeAgencyWithSAMLResponse>(this, "POST", request, JsonUtils.DeSerialize<AssumeAgencyWithSAMLResponse>);
        }

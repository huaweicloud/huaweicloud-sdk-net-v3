...
namespace HuaweiCloud.SDK.Sts.V1.Model
{
    ...
    public class DecodeAuthorizationMessageRequest 
    {
        ...
        public DecodeAuthorizationMessageReq Body { get; set; }
        ...
        {
            return this.Equals(input as DecodeAuthorizationMessageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DecodeAuthorizationMessageRequest input)
        {

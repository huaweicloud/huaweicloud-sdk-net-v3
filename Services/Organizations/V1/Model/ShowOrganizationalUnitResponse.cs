...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowOrganizationalUnitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowOrganizationalUnitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowOrganizationalUnitResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDryRunConfigResponse : SdkResponse
    {
        ...
        public DryRunConfigDto Root { get; set; }
        ...
        {
            return this.Equals(input as UpdateDryRunConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDryRunConfigResponse input)
        {

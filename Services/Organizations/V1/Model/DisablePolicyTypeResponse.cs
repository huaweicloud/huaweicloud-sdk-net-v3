...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisablePolicyTypeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DisablePolicyTypeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisablePolicyTypeResponse input)
        {

...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateOrganizationalUnitResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateOrganizationalUnitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateOrganizationalUnitResponse input)
        {
            if (input == null)
                return false;

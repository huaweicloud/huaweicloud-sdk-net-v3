...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class CreateResourceAccountRequest 
    {
        ...
        public CreateResourceAccountReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateResourceAccountRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateResourceAccountRequest input)
        {

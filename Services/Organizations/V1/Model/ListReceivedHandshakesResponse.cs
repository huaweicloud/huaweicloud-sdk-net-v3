...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListReceivedHandshakesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListReceivedHandshakesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListReceivedHandshakesResponse input)
        {
            if (input == null)
                return false;

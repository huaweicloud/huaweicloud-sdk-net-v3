...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class DeregisterDelegatedAdministratorRequest 
    {
        ...
        public DelegatedAdministratorReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeregisterDelegatedAdministratorRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeregisterDelegatedAdministratorRequest input)
        {

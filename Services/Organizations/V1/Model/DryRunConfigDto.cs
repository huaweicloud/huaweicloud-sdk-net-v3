...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class DryRunConfigDto 
    {
        ...
        /// </summary>
        /// <value>策略试运行的开启状态。enabled：启用；pending_enable：启用中；disabled：禁用；pending_disable：禁用中。</value>
        ...
        public class StatusEnum
        {
            ...
            /// </summary>
            public static readonly StatusEnum PENDING_ENABLE = new StatusEnum("pending_enable");
            ...
            /// </summary>
            public static readonly StatusEnum PENDING_DISABLE = new StatusEnum("pending_disable");
        ...
        {
            return this.Equals(input as DryRunConfigDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DryRunConfigDto input)
        {

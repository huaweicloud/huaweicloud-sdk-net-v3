...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class CreateDryRunPolicyReqBody 
    {
        ...
        /// </summary>
        /// <value>要创建的策略类型,service_control_policy服务控制策略。</value>
        ...
        {
            return this.Equals(input as CreateDryRunPolicyReqBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDryRunPolicyReqBody input)
        {

...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class ListOrganizationalUnitsResponse : SdkResponse
    {
        ...
        public bool Equals(ListOrganizationalUnitsResponse input)
        {
            ...
            if (this.OrganizationalUnits != input.OrganizationalUnits || (this.OrganizationalUnits != null && input.OrganizationalUnits != null && !this.OrganizationalUnits.SequenceEqual(input.OrganizationalUnits))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.OrganizationalUnits != null) hashCode = hashCode * 59 + this.OrganizationalUnits.GetHashCode();

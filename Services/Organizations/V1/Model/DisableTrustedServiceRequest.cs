...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class DisableTrustedServiceRequest 
    {
        ...
        public TrustedServiceReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DisableTrustedServiceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisableTrustedServiceRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class ListDelegatedAdministratorsRequest 
    {
        ...
        /// 服务主体的名称。
        /// </summary>
        [SDKProperty("service_principal", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListDelegatedAdministratorsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDelegatedAdministratorsRequest input)
        {
            if (input == null)
                return false;

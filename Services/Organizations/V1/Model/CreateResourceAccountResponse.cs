...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateResourceAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateResourceAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateResourceAccountResponse input)
        {

...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    public class ListCreateAccountStatusesResponse : SdkResponse
    {
        ...
        public bool Equals(ListCreateAccountStatusesResponse input)
        {
            ...
            if (this.CreateAccountStatuses != input.CreateAccountStatuses || (this.CreateAccountStatuses != null && input.CreateAccountStatuses != null && !this.CreateAccountStatuses.SequenceEqual(input.CreateAccountStatuses))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.CreateAccountStatuses != null) hashCode = hashCode * 59 + this.CreateAccountStatuses.GetHashCode();

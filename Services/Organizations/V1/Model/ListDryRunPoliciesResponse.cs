...
namespace HuaweiCloud.SDK.Organizations.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDryRunPoliciesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListDryRunPoliciesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDryRunPoliciesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGroupWatermarkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateGroupWatermarkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGroupWatermarkResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProjectWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProjectWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectWebhookResponse input)
        {

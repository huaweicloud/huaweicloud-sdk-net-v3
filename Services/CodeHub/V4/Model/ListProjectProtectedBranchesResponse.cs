...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectProtectedBranchesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProjectProtectedBranchesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectProtectedBranchesResponse input)
        {

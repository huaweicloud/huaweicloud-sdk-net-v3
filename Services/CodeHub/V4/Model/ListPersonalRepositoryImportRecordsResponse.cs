...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPersonalRepositoryImportRecordsResponse : SdkResponse
    {
        ...
        public List<RepositoryImportRecordDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListPersonalRepositoryImportRecordsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPersonalRepositoryImportRecordsResponse input)
        {

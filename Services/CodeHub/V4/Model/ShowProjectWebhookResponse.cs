...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProjectWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectWebhookResponse input)
        {

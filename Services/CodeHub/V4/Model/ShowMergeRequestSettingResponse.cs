...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMergeRequestSettingResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释：** 合入模式
        /// </summary>
        ...
        {
            return this.Equals(input as ShowMergeRequestSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMergeRequestSettingResponse input)
        {

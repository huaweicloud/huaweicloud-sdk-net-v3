...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryWebhookLogsResponse : SdkResponse
    {
        ...
        public List<WebhookLogDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryWebhookLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryWebhookLogsResponse input)
        {

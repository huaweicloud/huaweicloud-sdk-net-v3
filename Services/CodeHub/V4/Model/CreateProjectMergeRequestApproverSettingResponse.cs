...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateProjectMergeRequestApproverSettingResponse : SdkResponse
    {
        /// <summary>
        /// 设置类型，当前仅开放branch类型
        /// </summary>
        ...
        {
            return this.Equals(input as CreateProjectMergeRequestApproverSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProjectMergeRequestApproverSettingResponse input)
        {

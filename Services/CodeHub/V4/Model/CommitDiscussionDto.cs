...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class CommitDiscussionDto 
    {
        ...
        public List<CommitNoteDto> Notes { get; set; }
        ...
        {
            return this.Equals(input as CommitDiscussionDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommitDiscussionDto input)
        {

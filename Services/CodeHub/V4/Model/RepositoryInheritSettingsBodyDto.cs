...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class RepositoryInheritSettingsBodyDto 
    {
        ...
        public List<RepositoryInheritSettingUpdateBodyDto> Data { get; set; }
        ...
        {
            return this.Equals(input as RepositoryInheritSettingsBodyDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RepositoryInheritSettingsBodyDto input)
        {

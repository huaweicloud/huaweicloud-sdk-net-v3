...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProtectedTagResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProtectedTagResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProtectedTagResponse input)
        {

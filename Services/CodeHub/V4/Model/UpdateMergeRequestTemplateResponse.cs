...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateMergeRequestTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateMergeRequestTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestTemplateResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProjectWatermarkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProjectWatermarkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectWatermarkResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupMergeRequestSettingResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释：** 合入模式
        /// </summary>
        ...
        {
            return this.Equals(input as ShowGroupMergeRequestSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupMergeRequestSettingResponse input)
        {

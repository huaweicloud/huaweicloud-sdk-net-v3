...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryWorkItemsResponse : SdkResponse
    {
        ...
        public List<ReqWorkItemDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryWorkItemsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryWorkItemsResponse input)
        {

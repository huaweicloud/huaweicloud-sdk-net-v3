...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateGroupMergeRequestTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateGroupMergeRequestTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGroupMergeRequestTemplateResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryProtectedRefsUserGroupsResponse : SdkResponse
    {
        ...
        public List<ProtectedRefsUserGroupBasicDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryProtectedRefsUserGroupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryProtectedRefsUserGroupsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class BatchUpdateFilePushPermissionBodyDto 
    {
        ...
        public List<FilePushPermissionUpdateDto> Permissions { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateFilePushPermissionBodyDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateFilePushPermissionBodyDto input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class UpdateMergeRequestVoteRequest 
    {
        ...
        public MergeRequestVoteBodyDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMergeRequestVoteRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestVoteRequest input)
        {

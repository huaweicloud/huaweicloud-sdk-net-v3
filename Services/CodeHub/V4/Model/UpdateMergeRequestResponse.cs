...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateMergeRequestResponse : SdkResponse
    {
        /// <summary>
        /// 合并请求模式
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateMergeRequestResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubmodulesResponse : SdkResponse
    {
        ...
        public List<SubmoduleDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListSubmodulesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubmodulesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryTemplatesResponse : SdkResponse
    {
        ...
        public List<RepositoryTemplateDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryTemplatesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateProjectMergeRequestTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateProjectMergeRequestTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProjectMergeRequestTemplateResponse input)
        {

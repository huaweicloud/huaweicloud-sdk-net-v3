...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTrustedIpAddressResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateTrustedIpAddressResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTrustedIpAddressResponse input)
        {

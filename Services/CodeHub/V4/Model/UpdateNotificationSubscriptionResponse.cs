...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateNotificationSubscriptionResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释：** 配资源。
        /// </summary>
        ...
        public RepoWebHookSubscriptionDto WebhookConfig { get; set; }
        ...
        {
            return this.Equals(input as UpdateNotificationSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNotificationSubscriptionResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPipelineJobsResponse : SdkResponse
    {
        ...
        public List<JobWithStageDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListPipelineJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPipelineJobsResponse input)
        {

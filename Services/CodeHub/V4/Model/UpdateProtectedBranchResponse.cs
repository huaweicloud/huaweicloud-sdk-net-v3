...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProtectedBranchResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProtectedBranchResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProtectedBranchResponse input)
        {

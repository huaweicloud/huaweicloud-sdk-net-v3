...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class CreateMergeRequestDiscussionResponseRequest 
    {
        ...
        public ReplyMergeRequestNoteDto Body { get; set; }
        ...
        {
            return this.Equals(input as CreateMergeRequestDiscussionResponseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMergeRequestDiscussionResponseRequest input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryCommitRulesResponse : SdkResponse
    {
        ...
        public List<CommitRuleDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryCommitRulesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryCommitRulesResponse input)
        {

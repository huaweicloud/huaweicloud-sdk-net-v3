...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowNotificationSubscriptionResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释：** 配资源。
        /// </summary>
        ...
        {
            return this.Equals(input as ShowNotificationSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowNotificationSubscriptionResponse input)
        {

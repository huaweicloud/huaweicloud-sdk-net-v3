...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectWebhooksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProjectWebhooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectWebhooksResponse input)
        {

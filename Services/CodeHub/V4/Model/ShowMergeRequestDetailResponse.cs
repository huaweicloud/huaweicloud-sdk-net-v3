...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMergeRequestDetailResponse : SdkResponse
    {
        ...
        /// 自动合入
        /// </summary>
        [JsonProperty("auto_merge", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public MergeErrorDto JsonMergeError { get; set; }
        ...
        {
            return this.Equals(input as ShowMergeRequestDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMergeRequestDetailResponse input)
        {
            ...
            if (this.AutoMerge != input.AutoMerge || (this.AutoMerge != null && !this.AutoMerge.Equals(input.AutoMerge))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AutoMerge != null) hashCode = hashCode * 59 + this.AutoMerge.GetHashCode();

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTenantTrustedIpAddressResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateTenantTrustedIpAddressResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTenantTrustedIpAddressResponse input)
        {

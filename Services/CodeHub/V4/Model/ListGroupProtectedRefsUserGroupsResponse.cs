...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupProtectedRefsUserGroupsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListGroupProtectedRefsUserGroupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupProtectedRefsUserGroupsResponse input)
        {

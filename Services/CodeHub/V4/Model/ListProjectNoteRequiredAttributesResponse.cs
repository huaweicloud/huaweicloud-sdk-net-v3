...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectNoteRequiredAttributesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProjectNoteRequiredAttributesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectNoteRequiredAttributesResponse input)
        {

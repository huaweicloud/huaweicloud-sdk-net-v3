...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRepositoryWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRepositoryWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRepositoryWebhookResponse input)
        {

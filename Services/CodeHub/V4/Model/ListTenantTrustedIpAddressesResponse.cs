...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTenantTrustedIpAddressesResponse : SdkResponse
    {
        ...
        public List<TenantTrustedIpAddressDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListTenantTrustedIpAddressesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTenantTrustedIpAddressesResponse input)
        {

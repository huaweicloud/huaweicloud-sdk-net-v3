...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectWebhookLogsResponse : SdkResponse
    {
        ...
        public List<WebhookLogExtendDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListProjectWebhookLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectWebhookLogsResponse input)
        {

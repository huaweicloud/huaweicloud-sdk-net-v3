...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateProjectProtectedTagsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateProjectProtectedTagsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProjectProtectedTagsResponse input)
        {

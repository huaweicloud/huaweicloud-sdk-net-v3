...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProjectReviewSettingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProjectReviewSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectReviewSettingsResponse input)
        {

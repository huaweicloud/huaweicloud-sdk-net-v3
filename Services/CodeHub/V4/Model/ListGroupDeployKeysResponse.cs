...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupDeployKeysResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListGroupDeployKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupDeployKeysResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectGeneralPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProjectGeneralPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectGeneralPolicyResponse input)
        {

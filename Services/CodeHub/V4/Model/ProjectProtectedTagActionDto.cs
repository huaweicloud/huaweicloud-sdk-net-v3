...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class ProjectProtectedTagActionDto 
    {
        ...
        /// </summary>
        /// <value>**参数解释：** 事件名称。 **取值范围：read 查询,create-delete 增删,create 创建** 字符串长度不少于1，不超过1000。</value>
        ...
        /// </summary>
        [JsonProperty("user_team_names", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> UserTeamNames { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  userTeamNames: ").Append(UserTeamNames).Append("\n");
        ...
        {
            return this.Equals(input as ProjectProtectedTagActionDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProjectProtectedTagActionDto input)
        {
            ...
            if (this.UserTeamNames != input.UserTeamNames || (this.UserTeamNames != null && input.UserTeamNames != null && !this.UserTeamNames.SequenceEqual(input.UserTeamNames))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserTeamNames != null) hashCode = hashCode * 59 + this.UserTeamNames.GetHashCode();

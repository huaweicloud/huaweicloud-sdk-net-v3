...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProjectGeneralPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProjectGeneralPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectGeneralPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class ProjectSettingsInheritCfgDto 
    {
        ...
        /// </summary>
        /// <value>**参数解释：** 继承设置。 **约束限制：** 不涉及。 **取值范围：** - force_inherit，强制继承配置。 - custom，使用当前配置。 **默认取值：** 不涉及。</value>
        ...
        public class InheritModEnum
        {
            ...
            /// </summary>
            public static readonly InheritModEnum FORCE_INHERIT = new InheritModEnum("force_inherit");
        ...
        {
            return this.Equals(input as ProjectSettingsInheritCfgDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProjectSettingsInheritCfgDto input)
        {

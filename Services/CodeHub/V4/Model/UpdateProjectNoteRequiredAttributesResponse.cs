...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProjectNoteRequiredAttributesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProjectNoteRequiredAttributesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectNoteRequiredAttributesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMergeRequestDiscussionResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowMergeRequestDiscussionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMergeRequestDiscussionResponse input)
        {

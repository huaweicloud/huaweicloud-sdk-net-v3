...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class UpdateRepositoryResourcePermissionsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("resource_name", IsPath = true)]
        ...
        public UpdatePermissionBodyDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRepositoryResourcePermissionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRepositoryResourcePermissionsRequest input)
        {

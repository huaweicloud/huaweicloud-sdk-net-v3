...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProjectMergeRequestTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProjectMergeRequestTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProjectMergeRequestTemplateResponse input)
        {

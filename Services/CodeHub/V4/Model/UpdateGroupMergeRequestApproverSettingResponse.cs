...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGroupMergeRequestApproverSettingResponse : SdkResponse
    {
        /// <summary>
        /// 设置类型，当前仅开放branch类型
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateGroupMergeRequestApproverSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGroupMergeRequestApproverSettingResponse input)
        {

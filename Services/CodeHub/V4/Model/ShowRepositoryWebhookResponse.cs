...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepositoryWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRepositoryWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepositoryWebhookResponse input)
        {

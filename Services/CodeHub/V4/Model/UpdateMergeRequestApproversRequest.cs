...
namespace HuaweiCloud.SDK.CodeHub.V4.Model
{
    ...
    public class UpdateMergeRequestApproversRequest 
    {
        ...
        public ApprovalApproverInfoDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMergeRequestApproversRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestApproversRequest input)
        {

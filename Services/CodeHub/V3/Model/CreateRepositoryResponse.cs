...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRepositoryResponse : SdkResponse
    {
        ...
        public Repository Result { get; set; }
        ...
        {
            return this.Equals(input as CreateRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRepositoryResponse input)
        {

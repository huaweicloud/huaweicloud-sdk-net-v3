...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDiffCommitResponse : SdkResponse
    {
        ...
        public List<DiffCommitInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowDiffCommitResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDiffCommitResponse input)
        {

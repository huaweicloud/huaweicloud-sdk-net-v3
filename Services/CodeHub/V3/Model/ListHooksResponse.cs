...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListHooksResponse : SdkResponse
    {
        ...
        public RepoListHook Result { get; set; }
        ...
        {
            return this.Equals(input as ListHooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListHooksResponse input)
        {

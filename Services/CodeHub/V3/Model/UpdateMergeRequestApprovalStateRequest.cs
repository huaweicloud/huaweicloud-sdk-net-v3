...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    public class UpdateMergeRequestApprovalStateRequest 
    {
        ...
        public ApprovalActionTypeDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMergeRequestApprovalStateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestApprovalStateRequest input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMergeRequestResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListMergeRequestResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMergeRequestResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    public class RepositoryTemplateVO 
    {
        ...
        /// 代码模板名称
        /// </summary>
        [JsonProperty("codeTitle", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as RepositoryTemplateVO);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RepositoryTemplateVO input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddRepoMembersResponse : SdkResponse
    {
        ...
        public List<CreateRepoMemberResult> Result { get; set; }
        ...
        {
            return this.Equals(input as AddRepoMembersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddRepoMembersResponse input)
        {

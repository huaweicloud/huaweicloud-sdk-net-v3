...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    public class SpecificCommitInfo 
    {
        ...
        public SpecificCommitInfoStats Stats { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("last_pipeline", NullValueHandling = NullValueHandling.Ignore)]
        public SpecificCommitInfoLastPipeline LastPipeline { get; set; }
        ...
        {
            return this.Equals(input as SpecificCommitInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SpecificCommitInfo input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSshKeysResponse : SdkResponse
    {
        ...
        public PublicKeyList Result { get; set; }
        ...
        {
            return this.Equals(input as ListSshKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSshKeysResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeHub.V3.Model
{
    ...
    public class CreateMergeRequestDiscussionRequest 
    {
        ...
        public CreateMergeRequestDiscussionBodyDto Body { get; set; }
        ...
        {
            return this.Equals(input as CreateMergeRequestDiscussionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMergeRequestDiscussionRequest input)
        {

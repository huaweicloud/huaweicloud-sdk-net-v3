...
namespace HuaweiCloud.SDK.CodeHub.V3
{
    public class CodeHubRegion
    {
        ...
        private static readonly IRegionProvider Provider = RegionProviderChain.GetDefault("CODEHUB");
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'CodeHub': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
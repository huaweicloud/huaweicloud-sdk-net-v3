...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CollectWdrSnapshotRequest 
    {
        ...
        public CollectWdrSnapshotRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CollectWdrSnapshotRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CollectWdrSnapshotRequest input)
        {

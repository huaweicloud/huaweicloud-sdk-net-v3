...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListDatabaseSchemaTablesRequest 
    {
        ...
        /// </summary>
        [SDKProperty("schema_name", IsQuery = true)]
        ...
        /// </summary>
        [SDKProperty("table_name_keyword", IsQuery = true)]
        [JsonProperty("table_name_keyword", NullValueHandling = NullValueHandling.Ignore)]
        public string TableNameKeyword { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  tableNameKeyword: ").Append(TableNameKeyword).Append("\n");
        ...
        {
            return this.Equals(input as ListDatabaseSchemaTablesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDatabaseSchemaTablesRequest input)
        {
            ...
            if (this.TableNameKeyword != input.TableNameKeyword || (this.TableNameKeyword != null && !this.TableNameKeyword.Equals(input.TableNameKeyword))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TableNameKeyword != null) hashCode = hashCode * 59 + this.TableNameKeyword.GetHashCode();

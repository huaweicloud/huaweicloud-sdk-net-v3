...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListHbaInfosResponse : SdkResponse
    {
        ...
        public List<HbaConfResult> HbaConfs { get; set; }
        ...
        {
            return this.Equals(input as ListHbaInfosResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListHbaInfosResponse input)
        {

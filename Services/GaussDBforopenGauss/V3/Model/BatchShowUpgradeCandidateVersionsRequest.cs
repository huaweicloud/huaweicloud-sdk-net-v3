...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class BatchShowUpgradeCandidateVersionsRequest 
    {
        ...
        public UpgradeInstancesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchShowUpgradeCandidateVersionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchShowUpgradeCandidateVersionsRequest input)
        {

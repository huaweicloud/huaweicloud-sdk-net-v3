...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSourceInstanceDetailResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowSourceInstanceDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSourceInstanceDetailResponse input)
        {

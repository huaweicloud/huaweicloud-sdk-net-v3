...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class SwitchWdrSnapshotStatusRequest 
    {
        ...
        public SwitchWdrSnapshotRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchWdrSnapshotStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchWdrSnapshotStatusRequest input)
        {

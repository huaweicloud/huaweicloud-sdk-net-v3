    ...
    public class GaussDBforOpenGaussUserForCreation 
    {
        ...
        public bool Equals(GaussDBforOpenGaussUserForCreation input)
        {
            ...
            return 
                ...
                (
                    this.IsLoginOnly == input.IsLoginOnly ||
                    (this.IsLoginOnly != null &&
                    this.IsLoginOnly.Equals(input.IsLoginOnly))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsLoginOnly != null)
                    hashCode = hashCode * 59 + this.IsLoginOnly.GetHashCode();
                return hashCode;
            }
        }
    }

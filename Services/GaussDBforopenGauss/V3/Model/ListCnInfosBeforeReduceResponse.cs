...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListCnInfosBeforeReduceResponse : SdkResponse
    {
        ...
        public bool Equals(ListCnInfosBeforeReduceResponse input)
        {
            ...
            if (this.MaxReductionNum != input.MaxReductionNum || (this.MaxReductionNum != null && !this.MaxReductionNum.Equals(input.MaxReductionNum))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MaxReductionNum != null) hashCode = hashCode * 59 + this.MaxReductionNum.GetHashCode();

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListInstancesResult 
    {
        ...
        public bool Equals(ListInstancesResult input)
        {
            ...
            if (this.MysqlCompatibility != input.MysqlCompatibility || (this.MysqlCompatibility != null && !this.MysqlCompatibility.Equals(input.MysqlCompatibility))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MysqlCompatibility != null) hashCode = hashCode * 59 + this.MysqlCompatibility.GetHashCode();
                return hashCode;
            }
        }
    }

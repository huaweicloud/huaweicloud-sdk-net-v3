...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceDetailsResponse input)
        {

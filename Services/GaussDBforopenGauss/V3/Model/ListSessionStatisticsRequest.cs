...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListSessionStatisticsRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**  统计维度。 **约束限制**: 不涉及。 **取值范围** - usename：用户名。 - client_addr：访问来源。 - datname：数据库名。  **默认取值**: 不涉及。 </value>
        ...
        public class DimensionEnum
        {
            ...
            /// </summary>
            public static readonly DimensionEnum USENAME = new DimensionEnum("usename");

            /// <summary>
            /// Enum CLIENT_ADDR for value: client_addr
            /// </summary>
            public static readonly DimensionEnum CLIENT_ADDR = new DimensionEnum("client_addr");

            /// <summary>
            /// Enum DATNAME for value: datname
            /// </summary>
            public static readonly DimensionEnum DATNAME = new DimensionEnum("datname");
        ...
        /// </summary>
        /// <value>**参数解释** 实时会话统计排序字段。 **约束限制**: 不涉及。 **取值范围** - active_num：活跃会话数。 - total_num：总会话数。  **默认取值**: 不涉及。 </value>
        [JsonConverter(typeof(EnumClassConverter<OrderFieldEnum>))]
        public class OrderFieldEnum
        {
            /// <summary>
            /// Enum ACTIVE_NUM for value: active_num
            /// </summary>
            public static readonly OrderFieldEnum ACTIVE_NUM = new OrderFieldEnum("active_num");

            /// <summary>
            /// Enum TOTAL_NUM for value: total_num
            /// </summary>
            public static readonly OrderFieldEnum TOTAL_NUM = new OrderFieldEnum("total_num");

            private static readonly Dictionary<string, OrderFieldEnum> StaticFields =
            new Dictionary<string, OrderFieldEnum>()
            {
            ...
            public OrderFieldEnum()
            {

            }

            public OrderFieldEnum(string value)
            {
                _value = value;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as OrderFieldEnum))
                {
                    return true;
                }
            ...
            public bool Equals(OrderFieldEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(OrderFieldEnum a, OrderFieldEnum b)
            {
                if (System.Object.ReferenceEquals(a, b))
                {
                    return true;
        ...
        /// </summary>
        /// <value>**参数解释** 实时会话统计排序方式。 **约束限制**: 不涉及。 **取值范围** - ASC：根据order_field值升序。 - DESC：根据order_field值降序。  **默认取值** ASC </value>
        ...
        public OrderFieldEnum OrderField { get; set; }
        /// <summary>
        /// **参数解释** 实时会话统计排序方式。 **约束限制**: 不涉及。 **取值范围** - ASC：根据order_field值升序。 - DESC：根据order_field值降序。  **默认取值** ASC 
        /// </summary>
        ...
        {
            return this.Equals(input as ListSessionStatisticsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSessionStatisticsRequest input)
        {
            if (input == null) return false;
            if (this.XLanguage != input.XLanguage) return false;
            if (this.InstanceId != input.InstanceId || (this.InstanceId != null && !this.InstanceId.Equals(input.InstanceId))) return false;
            if (this.Dimension != input.Dimension) return false;
            if (this.Offset != input.Offset || (this.Offset != null && !this.Offset.Equals(input.Offset))) return false;
            if (this.Limit != input.Limit || (this.Limit != null && !this.Limit.Equals(input.Limit))) return false;
            if (this.OrderField != input.OrderField) return false;

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceQuotasResponse : SdkResponse
    {
        ...
        public InstanceQuotaResult Quotas { get; set; }
        ...
        {
            return this.Equals(input as ShowInstanceQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceQuotasResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateGaussDbInstanceResponse : SdkResponse
    {
        ...
        public OpenGaussInstanceResult Instance { get; set; }
        ...
        {
            return this.Equals(input as CreateGaussDbInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGaussDbInstanceResponse input)
        {

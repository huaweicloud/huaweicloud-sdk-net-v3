...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterDataCacheStartRequest 
    {
        ...
        public DisasterRecoverStartXlogKeepRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterDataCacheStartRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterDataCacheStartRequest input)
        {

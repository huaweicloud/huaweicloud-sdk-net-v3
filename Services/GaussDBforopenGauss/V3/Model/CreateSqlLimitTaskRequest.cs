...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CreateSqlLimitTaskRequest 
    {
        ...
        public CreateSqlLimitTaskRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateSqlLimitTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSqlLimitTaskRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CreateReadonlyNodesRequest 
    {
        ...
        public CreateReadonlyNodesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateReadonlyNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateReadonlyNodesRequest input)
        {

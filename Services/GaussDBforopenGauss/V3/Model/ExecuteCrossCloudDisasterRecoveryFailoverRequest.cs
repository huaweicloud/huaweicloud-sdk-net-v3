...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterRecoveryFailoverRequest 
    {
        ...
        public DisasterFailoverReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterRecoveryFailoverRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterRecoveryFailoverRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDbBackupsResponse : SdkResponse
    {
        ...
        public List<BackupsResult> Backups { get; set; }
        ...
        {
            return this.Equals(input as ListDbBackupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDbBackupsResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRestorableInstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListRestorableInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRestorableInstancesResponse input)
        {

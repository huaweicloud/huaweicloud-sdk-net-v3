...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudReleaseDisasterRequest 
    {
        ...
        public ReleaseDisasterReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudReleaseDisasterRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudReleaseDisasterRequest input)
        {

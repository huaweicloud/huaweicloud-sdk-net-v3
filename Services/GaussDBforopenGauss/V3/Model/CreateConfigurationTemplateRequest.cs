...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CreateConfigurationTemplateRequest 
    {
        ...
        public CreateConfigurationTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateConfigurationTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateConfigurationTemplateRequest input)
        {
            if (input == null)
                return false;

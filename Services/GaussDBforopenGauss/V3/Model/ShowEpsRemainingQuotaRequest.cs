...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ShowEpsRemainingQuotaRequest 
    {
        ...
        public ShowEpsRemainingQuotaRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowEpsRemainingQuotaRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEpsRemainingQuotaRequest input)
        {

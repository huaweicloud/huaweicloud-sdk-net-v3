...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDatabaseInstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListDatabaseInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDatabaseInstancesResponse input)
        {

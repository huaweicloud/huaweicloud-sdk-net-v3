...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ChangeDeploymentSolutionRequest 
    {
        ...
        public ChangeDeploymentSolutionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeDeploymentSolutionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeDeploymentSolutionRequest input)
        {

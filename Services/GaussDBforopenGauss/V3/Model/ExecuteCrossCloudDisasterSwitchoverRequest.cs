...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterSwitchoverRequest 
    {
        ...
        public SwitchoverReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterSwitchoverRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterSwitchoverRequest input)
        {

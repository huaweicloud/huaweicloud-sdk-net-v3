...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListSqlTraceRequest 
    {
        ...
        /// </summary>
        [SDKProperty("sql_id", IsQuery = true)]
        ...
        /// </summary>
        [SDKProperty("sql_exec_id", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListSqlTraceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSqlTraceRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWdrSnapshotStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowWdrSnapshotStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWdrSnapshotStatusResponse input)
        {

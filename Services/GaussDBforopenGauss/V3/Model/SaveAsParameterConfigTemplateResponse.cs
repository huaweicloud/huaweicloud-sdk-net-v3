...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SaveAsParameterConfigTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SaveAsParameterConfigTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SaveAsParameterConfigTemplateResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListTableVolumesRequestBody 
    {
        ...
        /// </summary>
        /// <value>**参数解释**: 排序字段。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。 </value>
        ...
        /// </summary>
        /// <value>**参数解释**: 排序方法。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。 </value>
        ...
        {
            return this.Equals(input as ListTableVolumesRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTableVolumesRequestBody input)
        {

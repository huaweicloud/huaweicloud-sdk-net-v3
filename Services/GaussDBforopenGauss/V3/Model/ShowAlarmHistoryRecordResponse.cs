...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAlarmHistoryRecordResponse : SdkResponse
    {
        ...
        public List<AlarmHistoryRecordResult> HistoryRecords { get; set; }
        ...
        {
            return this.Equals(input as ShowAlarmHistoryRecordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAlarmHistoryRecordResponse input)
        {

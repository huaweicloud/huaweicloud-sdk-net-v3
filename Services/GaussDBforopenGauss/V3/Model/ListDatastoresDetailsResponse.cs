...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDatastoresDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListDatastoresDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDatastoresDetailsResponse input)
        {

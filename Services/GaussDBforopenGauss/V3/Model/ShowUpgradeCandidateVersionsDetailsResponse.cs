...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowUpgradeCandidateVersionsDetailsResponse : SdkResponse
    {
        ...
        public List<CanBeUpgradedHotfixDetail> HotfixUpgradeInfos { get; set; }

        /// <summary>
        /// 可以回滚的热补丁信息。
        /// </summary>
        [JsonProperty("hotfix_rollback_infos", NullValueHandling = NullValueHandling.Ignore)]
        public List<CanBeRollbackedHotfixDetail> HotfixRollbackInfos { get; set; }
        ...
        {
            return this.Equals(input as ShowUpgradeCandidateVersionsDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowUpgradeCandidateVersionsDetailsResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class BatchDeleteInstanceTagRequest 
    {
        ...
        public BatchDeleteInstanceTagRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteInstanceTagRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteInstanceTagRequest input)
        {

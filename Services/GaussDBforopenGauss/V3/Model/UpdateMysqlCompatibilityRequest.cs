...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class UpdateMysqlCompatibilityRequest 
    {
        ...
        public UpdateMySQLCompatibilityRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMysqlCompatibilityRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMysqlCompatibilityRequest input)
        {

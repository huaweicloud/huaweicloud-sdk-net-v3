...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListSQLExcuteNodeRequestBody 
    {
        ...
        public class ActionEnum
        {
            ...
            /// </summary>
            public static readonly ActionEnum SLOW = new ActionEnum("slow");
        ...
        {
            return this.Equals(input as ListSQLExcuteNodeRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSQLExcuteNodeRequestBody input)
        {

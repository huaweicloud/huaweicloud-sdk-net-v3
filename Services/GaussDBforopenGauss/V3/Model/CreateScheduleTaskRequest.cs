...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CreateScheduleTaskRequest 
    {
        ...
        public CreateScheduleTaskRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateScheduleTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateScheduleTaskRequest input)
        {

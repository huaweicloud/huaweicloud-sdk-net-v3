...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ModifyInstancePortRequest 
    {
        ...
        public ModifyInstancePortRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyInstancePortRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyInstancePortRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListEnhanceFullSqlsRequest 
    {
        ...
        public ListEnhanceFullSqlsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListEnhanceFullSqlsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListEnhanceFullSqlsRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSqlExcuteNodesResponse : SdkResponse
    {
        ...
        public List<ExcuteSQLNodeInfoResult> Nodes { get; set; }
        ...
        {
            return this.Equals(input as ListSqlExcuteNodesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSqlExcuteNodesResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListAspResult 
    {
        ...
        /// </summary>
        /// <value>**参数解释**: 采集状态。 **取值范围**: - SUCCESS：成功。 - FAILED：失败。 - EXPORTING：采集中。</value>
        ...
        public class StatusEnum
        {
            ...
            /// </summary>
            public static readonly StatusEnum EXPORTING = new StatusEnum("EXPORTING");
        ...
        {
            return this.Equals(input as ListAspResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAspResult input)
        {

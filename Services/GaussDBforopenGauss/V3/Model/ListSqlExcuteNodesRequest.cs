...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListSqlExcuteNodesRequest 
    {
        ...
        public ListSQLExcuteNodeRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListSqlExcuteNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSqlExcuteNodesRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRecycleInstancesDetailsResponse : SdkResponse
    {
        ...
        public List<RecycleInstancesDetailResultV1> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListRecycleInstancesDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRecycleInstancesDetailsResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterEndSimulationRequest 
    {
        ...
        public DisasterRecoverStopSimulationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterEndSimulationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterEndSimulationRequest input)
        {

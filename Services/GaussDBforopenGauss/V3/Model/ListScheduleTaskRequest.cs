...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListScheduleTaskRequest 
    {
        ...
        public class NameEnum
        {
            ...
            /// </summary>
            public static readonly NameEnum HOTFIX_VERSION_UPGRADE = new NameEnum("HOTFIX_VERSION_UPGRADE");
        ...
        {
            return this.Equals(input as ListScheduleTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListScheduleTaskRequest input)
        {

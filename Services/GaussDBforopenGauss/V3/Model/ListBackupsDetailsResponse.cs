...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBackupsDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListBackupsDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBackupsDetailsResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListSchemaAndTableRequest 
    {
        ...
        public ListSchemaAndTableRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListSchemaAndTableRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSchemaAndTableRequest input)
        {

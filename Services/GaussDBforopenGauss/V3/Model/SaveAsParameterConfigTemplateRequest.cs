...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class SaveAsParameterConfigTemplateRequest 
    {
        ...
        public SaveAsParameterConfigTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SaveAsParameterConfigTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SaveAsParameterConfigTemplateRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ModifyAutoEnlargePolicyRequest 
    {
        ...
        public ModifyAutoEnlargePolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyAutoEnlargePolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyAutoEnlargePolicyRequest input)
        {

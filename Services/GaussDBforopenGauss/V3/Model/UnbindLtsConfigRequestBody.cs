...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class UnbindLtsConfigRequestBody 
    {
        ...
        public List<InstanceDeleteLtsConfigOption> List { get; set; }
        ...
        {
            return this.Equals(input as UnbindLtsConfigRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UnbindLtsConfigRequestBody input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMetricDatasResponse : SdkResponse
    {
        ...
        public List<InstancesMetricResult> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListMetricDatasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMetricDatasResponse input)
        {

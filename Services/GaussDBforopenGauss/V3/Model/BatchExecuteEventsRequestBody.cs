...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class BatchExecuteEventsRequestBody 
    {
        ...
        public EventScheduleWindowOption EventScheduleWindow { get; set; }
        ...
        {
            return this.Equals(input as BatchExecuteEventsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchExecuteEventsRequestBody input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class InstallKernelPluginRequest 
    {
        ...
        public InstallKernelPluginRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as InstallKernelPluginRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(InstallKernelPluginRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListDisasterRecoveryRecordRequest 
    {
        ...
        public class EntityTypeEnum
        {
            ...
            /// </summary>
            public static readonly EntityTypeEnum DR = new EntityTypeEnum("dr");
        ...
        {
            return this.Equals(input as ListDisasterRecoveryRecordRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDisasterRecoveryRecordRequest input)
        {

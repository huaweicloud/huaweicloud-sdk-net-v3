...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class DeleteReadonlyNodesRequest 
    {
        ...
        public DeleteReadonlyNodesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteReadonlyNodesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteReadonlyNodesRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class BatchExecuteEventsRequest 
    {
        ...
        public BatchExecuteEventsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchExecuteEventsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchExecuteEventsRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CanBeRollbackedHotfixDetail 
    {
        ...
        {
            return this.Equals(input as CanBeRollbackedHotfixDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CanBeRollbackedHotfixDetail input)
        {
            if (input == null) return false;
            if (this.Version != input.Version || (this.Version != null && !this.Version.Equals(input.Version))) return false;
            if (this.CommonPatch != input.CommonPatch || (this.CommonPatch != null && !this.CommonPatch.Equals(input.CommonPatch))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CommonPatch != null) hashCode = hashCode * 59 + this.CommonPatch.GetHashCode();

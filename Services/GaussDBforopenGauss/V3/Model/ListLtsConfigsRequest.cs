...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListLtsConfigsRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**: 实例类型，不传该参数默认查询全部实例类型。 **约束限制**: 不涉及。 **取值范围**: - Ha 为集中式类型。 - Independent 为独立部署类型。 - Combined 为混合部署类型。  **默认取值**: 不涉及。</value>
        ...
        public class InstanceModeEnum
        {
            ...
            /// </summary>
            public static readonly InstanceModeEnum COMBINED = new InstanceModeEnum("Combined");
        ...
        {
            return this.Equals(input as ListLtsConfigsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLtsConfigsRequest input)
        {

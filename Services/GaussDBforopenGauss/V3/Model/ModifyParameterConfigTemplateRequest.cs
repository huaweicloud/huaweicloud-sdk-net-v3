...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ModifyParameterConfigTemplateRequest 
    {
        ...
        public ModifyParameterConfigTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyParameterConfigTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyParameterConfigTemplateRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class UpdateSqlLimitTaskRequest 
    {
        ...
        public UpdateSqlLimitTaskRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSqlLimitTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSqlLimitTaskRequest input)
        {

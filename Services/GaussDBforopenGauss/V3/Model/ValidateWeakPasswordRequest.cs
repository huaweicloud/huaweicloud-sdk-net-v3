...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ValidateWeakPasswordRequest 
    {
        ...
        public WeakPasswordRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ValidateWeakPasswordRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ValidateWeakPasswordRequest input)
        {

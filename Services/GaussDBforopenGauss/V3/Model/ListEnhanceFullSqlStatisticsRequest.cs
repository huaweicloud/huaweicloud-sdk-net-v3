...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListEnhanceFullSqlStatisticsRequest 
    {
        ...
        public ListEnhanceFullSqlStatisticsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListEnhanceFullSqlStatisticsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListEnhanceFullSqlStatisticsRequest input)
        {

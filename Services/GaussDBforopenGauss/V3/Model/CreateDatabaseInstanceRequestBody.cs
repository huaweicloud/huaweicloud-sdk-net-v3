...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CreateDatabaseInstanceRequestBody 
    {
        ...
        /// </summary>
        /// <value>实例副本数，支持取值3。不填默认为3。仅支持V2.0-1.3.0及以上版本的实例。</value>
        ...
        {
            return this.Equals(input as CreateDatabaseInstanceRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDatabaseInstanceRequestBody input)
        {
            ...
            if (this.ReplicaNum != input.ReplicaNum) return false;
            if (this.EnableForceSwitch != input.EnableForceSwitch || (this.EnableForceSwitch != null && !this.EnableForceSwitch.Equals(input.EnableForceSwitch))) return false;
            if (this.EnableSingleFloatIp != input.EnableSingleFloatIp || (this.EnableSingleFloatIp != null && !this.EnableSingleFloatIp.Equals(input.EnableSingleFloatIp))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnableForceSwitch != null) hashCode = hashCode * 59 + this.EnableForceSwitch.GetHashCode();
                if (this.EnableSingleFloatIp != null) hashCode = hashCode * 59 + this.EnableSingleFloatIp.GetHashCode();
                return hashCode;
            }
        }
    }

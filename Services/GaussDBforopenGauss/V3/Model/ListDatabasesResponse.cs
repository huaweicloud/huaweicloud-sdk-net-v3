...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDatabasesResponse : SdkResponse
    {
        ...
        public List<GaussDBforOpenGaussListDatabase> Databases { get; set; }
        ...
        {
            return this.Equals(input as ListDatabasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDatabasesResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExportInstanceInfosRequest 
    {
        ...
        public ExportInstanceInfosRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExportInstanceInfosRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExportInstanceInfosRequest input)
        {

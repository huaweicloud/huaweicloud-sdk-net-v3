...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ShowSlowSqlStackRequest 
    {
        ...
        /// </summary>
        [SDKProperty("comp_id", IsQuery = true)]
        ...
        {
            return this.Equals(input as ShowSlowSqlStackRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSlowSqlStackRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class OpenGaussInstanceRequest 
    {
        ...
        public OpenGaussDatastore Datastore { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("ha", NullValueHandling = NullValueHandling.Ignore)]
        public OpenGaussHa Ha { get; set; }
        ...
        {
            return this.Equals(input as OpenGaussInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(OpenGaussInstanceRequest input)
        {

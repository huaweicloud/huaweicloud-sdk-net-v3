...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListTopIoTrafficsRequest 
    {
        ...
        public bool Equals(ListTopIoTrafficsRequest input)
        {
            ...
            if (this.TopIoNum != input.TopIoNum || (this.TopIoNum != null && !this.TopIoNum.Equals(input.TopIoNum))) return false;
            if (this.SortCondition != input.SortCondition) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TopIoNum != null) hashCode = hashCode * 59 + this.TopIoNum.GetHashCode();

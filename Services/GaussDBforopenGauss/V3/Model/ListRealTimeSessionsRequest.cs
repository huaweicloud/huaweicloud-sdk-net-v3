...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListRealTimeSessionsRequest 
    {
        ...
        public ListRealTimeSessionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListRealTimeSessionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRealTimeSessionsRequest input)
        {

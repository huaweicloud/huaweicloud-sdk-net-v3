...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDatabaseInstanceResponse : SdkResponse
    {
        ...
        public CreateDatabaseInstanceResult Instance { get; set; }
        ...
        {
            return this.Equals(input as CreateDatabaseInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDatabaseInstanceResponse input)
        {

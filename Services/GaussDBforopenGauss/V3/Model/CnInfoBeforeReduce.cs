...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CnInfoBeforeReduce 
    {
        ...
        {
            return this.Equals(input as CnInfoBeforeReduce);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CnInfoBeforeReduce input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SupportReduce == input.SupportReduce ||
                    (this.SupportReduce != null &&
                    this.SupportReduce.Equals(input.SupportReduce))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SupportReduce != null)
                    hashCode = hashCode * 59 + this.SupportReduce.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class DeleteDisasterRecordRequest 
    {
        ...
        public DeleteDisasterRecordRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteDisasterRecordRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteDisasterRecordRequest input)
        {

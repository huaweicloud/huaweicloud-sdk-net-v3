...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class UpdateAgencyPolicyRequest 
    {
        ...
        public UpdateAgencyPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateAgencyPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAgencyPolicyRequest input)
        {

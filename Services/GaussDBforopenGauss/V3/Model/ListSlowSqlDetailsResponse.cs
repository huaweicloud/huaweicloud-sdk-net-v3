...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSlowSqlDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListSlowSqlDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSlowSqlDetailsResponse input)
        {

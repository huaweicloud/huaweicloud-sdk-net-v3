...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDbInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDbInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDbInstanceResponse input)
        {

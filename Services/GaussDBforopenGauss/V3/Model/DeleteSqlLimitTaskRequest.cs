...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class DeleteSqlLimitTaskRequest 
    {
        ...
        public DeleteSqlLimitTaskRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteSqlLimitTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteSqlLimitTaskRequest input)
        {

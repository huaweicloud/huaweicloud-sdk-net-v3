...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterRestoreRequest 
    {
        ...
        public RestoreDisasterReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterRestoreRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterRestoreRequest input)
        {

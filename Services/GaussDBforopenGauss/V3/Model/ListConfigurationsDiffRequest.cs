...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListConfigurationsDiffRequest 
    {
        ...
        public ParamGroupDiffRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListConfigurationsDiffRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListConfigurationsDiffRequest input)
        {

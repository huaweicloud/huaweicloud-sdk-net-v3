...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListSessionMemoryContextRequest 
    {
        ...
        /// </summary>
        [SDKProperty("session_id", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListSessionMemoryContextRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSessionMemoryContextRequest input)
        {

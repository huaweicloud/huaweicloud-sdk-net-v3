...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class UpdateRedistributionControlRequest 
    {
        ...
        public RedistributionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRedistributionControlRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRedistributionControlRequest input)
        {

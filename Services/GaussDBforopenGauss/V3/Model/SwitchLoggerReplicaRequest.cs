...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class SwitchLoggerReplicaRequest 
    {
        ...
        public SwitchLoggerReplicaRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchLoggerReplicaRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchLoggerReplicaRequest input)
        {

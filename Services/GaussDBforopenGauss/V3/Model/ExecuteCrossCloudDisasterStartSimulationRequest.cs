...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterStartSimulationRequest 
    {
        ...
        public DisasterRecoverStartSimulationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterStartSimulationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterStartSimulationRequest input)
        {

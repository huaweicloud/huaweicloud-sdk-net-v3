...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class CreateCrossCloudConstructDisasterRequest 
    {
        ...
        public ConstructReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateCrossCloudConstructDisasterRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCrossCloudConstructDisasterRequest input)
        {

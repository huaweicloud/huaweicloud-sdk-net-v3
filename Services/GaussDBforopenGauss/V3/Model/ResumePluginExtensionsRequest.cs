...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ResumePluginExtensionsRequest 
    {
        ...
        public ResumePluginExtensionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ResumePluginExtensionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResumePluginExtensionsRequest input)
        {
            if (input == null)
                return false;

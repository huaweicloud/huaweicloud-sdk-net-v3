...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class AuthorizeBackupDownloadRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**: 用户Token。 通过调用IAM服务[获取用户token](https://support.huaweicloud.com/intl/zh-cn/api-iam/iam_30_0001.html)。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。</value>
        ...
        {
            return this.Equals(input as AuthorizeBackupDownloadRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AuthorizeBackupDownloadRequest input)
        {

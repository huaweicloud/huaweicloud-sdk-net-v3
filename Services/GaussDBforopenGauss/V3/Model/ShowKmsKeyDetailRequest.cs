...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ShowKmsKeyDetailRequest 
    {
        ...
        /// </summary>
        [SDKProperty("kms_key_id", IsPath = true)]
        ...
        /// </summary>
        [SDKProperty("kms_project_name", IsPath = true)]
        ...
        {
            return this.Equals(input as ShowKmsKeyDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKmsKeyDetailRequest input)
        {

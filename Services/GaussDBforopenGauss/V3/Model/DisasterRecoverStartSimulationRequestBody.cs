...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class DisasterRecoverStartSimulationRequestBody 
    {
        ...
        /// </summary>
        [JsonProperty("xlog_keep_ratio", NullValueHandling = NullValueHandling.Ignore)]
        public int? XlogKeepRatio { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  xlogKeepRatio: ").Append(XlogKeepRatio).Append("\n");
        ...
        {
            return this.Equals(input as DisasterRecoverStartSimulationRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisasterRecoverStartSimulationRequestBody input)
        {
            if (input == null) return false;
            if (this.XlogKeepRatio != input.XlogKeepRatio || (this.XlogKeepRatio != null && !this.XlogKeepRatio.Equals(input.XlogKeepRatio))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.XlogKeepRatio != null) hashCode = hashCode * 59 + this.XlogKeepRatio.GetHashCode();

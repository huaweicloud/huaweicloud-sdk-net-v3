...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ExecuteCrossCloudDisasterDataCacheEndRequest 
    {
        ...
        public DisasterRecoverStopXlogKeepRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteCrossCloudDisasterDataCacheEndRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteCrossCloudDisasterDataCacheEndRequest input)
        {

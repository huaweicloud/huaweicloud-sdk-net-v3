...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class GaussDBforOpenGaussGrantRequest 
    {
        ...
        public List<GaussDBforOpenGaussUserWithPrivilege> Users { get; set; }
        ...
        {
            return this.Equals(input as GaussDBforOpenGaussGrantRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GaussDBforOpenGaussGrantRequest input)
        {

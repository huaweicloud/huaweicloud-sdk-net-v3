...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceParamGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceParamGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceParamGroupResponse input)
        {
            if (input == null)
                return false;

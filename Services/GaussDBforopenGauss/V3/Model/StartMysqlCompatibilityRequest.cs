...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class StartMysqlCompatibilityRequest 
    {
        ...
        public StartMySQLCompatibilityRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as StartMysqlCompatibilityRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartMysqlCompatibilityRequest input)
        {

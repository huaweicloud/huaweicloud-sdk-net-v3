...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceMetricDataResponse : SdkResponse
    {
        ...
        public List<MetricDataResult> Metrics { get; set; }
        ...
        {
            return this.Equals(input as ShowInstanceMetricDataResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceMetricDataResponse input)
        {

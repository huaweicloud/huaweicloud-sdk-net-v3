...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ScheduleTaskDetail 
    {
        ...
        {
            return this.Equals(input as ScheduleTaskDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ScheduleTaskDetail input)
        {
            ...
            if (this.TaskContent != input.TaskContent || (this.TaskContent != null && !this.TaskContent.Equals(input.TaskContent))) return false;

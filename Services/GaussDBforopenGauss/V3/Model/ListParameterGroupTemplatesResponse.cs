...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListParameterGroupTemplatesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListParameterGroupTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListParameterGroupTemplatesResponse input)
        {

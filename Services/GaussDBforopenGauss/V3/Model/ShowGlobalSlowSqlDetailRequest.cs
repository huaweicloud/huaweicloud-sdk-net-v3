...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ShowGlobalSlowSqlDetailRequest 
    {
        ...
        public ShowGlobalSlowSqlDetailRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowGlobalSlowSqlDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGlobalSlowSqlDetailRequest input)
        {

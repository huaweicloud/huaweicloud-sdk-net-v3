...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class SetKernelPluginLicenseRequest 
    {
        ...
        public SetKernelPluginLicenseRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetKernelPluginLicenseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetKernelPluginLicenseRequest input)
        {

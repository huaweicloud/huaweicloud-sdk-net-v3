...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class ListEnterpriseProjectsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("name_keyword", IsQuery = true)]
        [JsonProperty("name_keyword", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  nameKeyword: ").Append(NameKeyword).Append("\n");
        ...
        {
            return this.Equals(input as ListEnterpriseProjectsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListEnterpriseProjectsRequest input)
        {
            if (input == null) return false;
            if (this.XLanguage != input.XLanguage) return false;
            if (this.NameKeyword != input.NameKeyword || (this.NameKeyword != null && !this.NameKeyword.Equals(input.NameKeyword))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NameKeyword != null) hashCode = hashCode * 59 + this.NameKeyword.GetHashCode();

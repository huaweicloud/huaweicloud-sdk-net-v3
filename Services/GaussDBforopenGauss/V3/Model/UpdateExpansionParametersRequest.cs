...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class UpdateExpansionParametersRequest 
    {
        ...
        public ExpansionParametersRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateExpansionParametersRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateExpansionParametersRequest input)
        {

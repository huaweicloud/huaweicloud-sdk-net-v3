...
namespace HuaweiCloud.SDK.GaussDBforopenGauss.V3.Model
{
    ...
    public class BatchSetBackupPolicyRequest 
    {
        ...
        public BatchSetBackupPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchSetBackupPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchSetBackupPolicyRequest input)
        {

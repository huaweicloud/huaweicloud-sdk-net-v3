...
namespace HuaweiCloud.SDK.Cbr.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ChangeVaultChargeModeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ChangeVaultChargeModeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeVaultChargeModeResponse input)
        {

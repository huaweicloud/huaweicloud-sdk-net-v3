...
namespace HuaweiCloud.SDK.Cbr.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListOrganizationPolicyDetailResponse : SdkResponse
    {
        ...
        public List<OrganizationPolicyStatus> Policies { get; set; }
        ...
        {
            return this.Equals(input as ListOrganizationPolicyDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOrganizationPolicyDetailResponse input)
        {

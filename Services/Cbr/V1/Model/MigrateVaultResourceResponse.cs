...
namespace HuaweiCloud.SDK.Cbr.V1.Model
{
    ...
    public class MigrateVaultResourceResponse : SdkResponse
    {
        ...
        public bool Equals(MigrateVaultResourceResponse input)
        {
            ...
            if (this.MigratedResources != input.MigratedResources || (this.MigratedResources != null && input.MigratedResources != null && !this.MigratedResources.SequenceEqual(input.MigratedResources))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.MigratedResources != null) hashCode = hashCode * 59 + this.MigratedResources.GetHashCode();
                return hashCode;
            }
        }
    }

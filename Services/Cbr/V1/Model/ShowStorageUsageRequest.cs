...
namespace HuaweiCloud.SDK.Cbr.V1.Model
{
    ...
    public class ShowStorageUsageRequest 
    {
        ...
        public class ResourceTypeEnum
        {
            ...
            /// </summary>
            public static readonly ResourceTypeEnum OS_IRONIC_BAREMETALSERVER = new ResourceTypeEnum("OS::Ironic::BareMetalServer");
            ...
            new Dictionary<string, ResourceTypeEnum>()
            {
                ...
                { "OS::Ironic::BareMetalServer", OS_IRONIC_BAREMETALSERVER },
            };
        ...
        {
            return this.Equals(input as ShowStorageUsageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowStorageUsageRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Cbr.V1.Model
{
    ...
    public class ProtectableReplicationCapabilitiesRespRegion 
    {
        ...
        public bool Equals(ProtectableReplicationCapabilitiesRespRegion input)
        {
            ...
            if (this.ReplicationDestinations != input.ReplicationDestinations || (this.ReplicationDestinations != null && input.ReplicationDestinations != null && !this.ReplicationDestinations.SequenceEqual(input.ReplicationDestinations))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReplicationDestinations != null) hashCode = hashCode * 59 + this.ReplicationDestinations.GetHashCode();
                return hashCode;
            }
        }
    }

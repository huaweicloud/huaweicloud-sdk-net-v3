...
namespace HuaweiCloud.SDK.Cbr.V1.Model
{
    ...
    public class ListAgentRequest 
    {
        ...
        {
            return this.Equals(input as ListAgentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAgentRequest input)
        {
            if (input == null) return false;
            if (this.Limit != input.Limit || (this.Limit != null && !this.Limit.Equals(input.Limit))) return false;
            if (this.Offset != input.Offset || (this.Offset != null && !this.Offset.Equals(input.Offset))) return false;
            if (this.Status != input.Status || (this.Status != null && !this.Status.Equals(input.Status))) return false;
            if (this.AgentId != input.AgentId || (this.AgentId != null && input.AgentId != null && !this.AgentId.SequenceEqual(input.AgentId))) return false;

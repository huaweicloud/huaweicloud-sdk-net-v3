...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    public class UpdateAppInfoRequestBody 
    {
        ...
        /// </summary>
        /// <value>创建类型，template：部署模板创建</value>
        ...
        public List<UpdateTaskV2RequestBody> ArrangeInfos { get; set; }
        ...
        {
            return this.Equals(input as UpdateAppInfoRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAppInfoRequestBody input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteAppResponse : SdkResponse
    {
        ...
        public List<AppDeleteResult> Result { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteAppResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteAppResponse input)
        {

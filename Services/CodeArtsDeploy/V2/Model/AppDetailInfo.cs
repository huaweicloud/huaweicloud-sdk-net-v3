...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    public class AppDetailInfo 
    {
        ...
        public bool Equals(AppDetailInfo input)
        {
            ...
            if (this.OwnerTenantId != input.OwnerTenantId || (this.OwnerTenantId != null && !this.OwnerTenantId.Equals(input.OwnerTenantId))) return false;
            ...
            if (this.PermissionLevel != input.PermissionLevel || (this.PermissionLevel != null && !this.PermissionLevel.Equals(input.PermissionLevel))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OwnerTenantId != null) hashCode = hashCode * 59 + this.OwnerTenantId.GetHashCode();
                ...
                if (this.PermissionLevel != null) hashCode = hashCode * 59 + this.PermissionLevel.GetHashCode();

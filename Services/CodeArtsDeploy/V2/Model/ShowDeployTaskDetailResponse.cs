...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDeployTaskDetailResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowDeployTaskDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDeployTaskDetailResponse input)
        {

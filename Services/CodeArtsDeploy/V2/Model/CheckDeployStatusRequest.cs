...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    public class CheckDeployStatusRequest 
    {
        ...
        /// </summary>
        [SDKProperty("step_state", IsQuery = true)]
        ...
        {
            return this.Equals(input as CheckDeployStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckDeployStatusRequest input)
        {
            ...
            if (this.StepState != input.StepState || (this.StepState != null && !this.StepState.Equals(input.StepState))) return false;

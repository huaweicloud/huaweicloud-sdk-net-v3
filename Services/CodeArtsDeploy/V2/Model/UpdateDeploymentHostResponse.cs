...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDeploymentHostResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDeploymentHostResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeploymentHostResponse input)
        {

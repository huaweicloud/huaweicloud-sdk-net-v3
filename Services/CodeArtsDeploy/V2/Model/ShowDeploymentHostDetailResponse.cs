...
namespace HuaweiCloud.SDK.CodeArtsDeploy.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDeploymentHostDetailResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowDeploymentHostDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDeploymentHostDetailResponse input)
        {
            if (input == null)
                return false;

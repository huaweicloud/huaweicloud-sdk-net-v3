...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class ApplyConfigurationToInstancesRequest 
    {
        ...
        public ApplyConfigurationToInstancesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ApplyConfigurationToInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ApplyConfigurationToInstancesRequest input)
        {

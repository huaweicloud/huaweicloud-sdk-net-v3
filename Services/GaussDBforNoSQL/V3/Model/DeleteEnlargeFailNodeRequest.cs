...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class DeleteEnlargeFailNodeRequest 
    {
        ...
        public DeleteEnlargeFailNodeRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteEnlargeFailNodeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteEnlargeFailNodeRequest input)
        {
            if (input == null)
                return false;

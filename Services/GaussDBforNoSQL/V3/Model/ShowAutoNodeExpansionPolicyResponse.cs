...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutoNodeExpansionPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutoNodeExpansionPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutoNodeExpansionPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class QueryInstanceBackupResponseBodyBackups 
    {
        ...
        public class StatusEnum
        {
            ...
            /// </summary>
            public static readonly StatusEnum BUILDING_ = new StatusEnum("BUILDING：备份中");

            /// <summary>
            /// Enum COMPLETED_ for value: COMPLETED：备份完成
            /// </summary>
            public static readonly StatusEnum COMPLETED_ = new StatusEnum("COMPLETED：备份完成");

            /// <summary>
            /// Enum FAILED_ for value: FAILED：备份失败
            /// </summary>
            public static readonly StatusEnum FAILED_ = new StatusEnum("FAILED：备份失败");

            private static readonly Dictionary<string, StatusEnum> StaticFields =
            new Dictionary<string, StatusEnum>()
            {
                { "BUILDING：备份中", BUILDING_ },
                { "COMPLETED：备份完成", COMPLETED_ },
                { "FAILED：备份失败", FAILED_ },
            };
        ...
        public class TypeEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum AUTO_ = new TypeEnum("Auto 自动全量备份");

            /// <summary>
            /// Enum MANUAL_ for value: Manual 手动全量备份。
            /// </summary>
            public static readonly TypeEnum MANUAL_ = new TypeEnum("Manual 手动全量备份。");
        ...
        {
            return this.Equals(input as QueryInstanceBackupResponseBodyBackups);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QueryInstanceBackupResponseBodyBackups input)
        {
            if (input == null)
                return false;

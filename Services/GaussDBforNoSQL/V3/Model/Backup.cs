...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class Backup 
    {
        ...
        public List<QueryDatabaseTableInfo> DatabaseTables { get; set; }
        ...
        public bool Equals(Backup input)
        {
            ...
            return 
                ...
                (
                    this.DatabaseTables == input.DatabaseTables ||
                    this.DatabaseTables != null &&
                    input.DatabaseTables != null &&
                    this.DatabaseTables.SequenceEqual(input.DatabaseTables)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DatabaseTables != null)
                    hashCode = hashCode * 59 + this.DatabaseTables.GetHashCode();
                return hashCode;
            }
        }
    }

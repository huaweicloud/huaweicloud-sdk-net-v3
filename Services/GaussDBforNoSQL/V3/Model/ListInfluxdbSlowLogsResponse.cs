...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInfluxdbSlowLogsResponse : SdkResponse
    {
        ...
        public List<InfluxdbSlowLogDetail> SlowLogs { get; set; }
        ...
        {
            return this.Equals(input as ListInfluxdbSlowLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInfluxdbSlowLogsResponse input)
        {
            if (input == null)
                return false;

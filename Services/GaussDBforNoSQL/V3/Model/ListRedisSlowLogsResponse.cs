...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRedisSlowLogsResponse : SdkResponse
    {
        ...
        public List<RedisSlowLogDetail> SlowLogs { get; set; }
        ...
        {
            return this.Equals(input as ListRedisSlowLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRedisSlowLogsResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class UpdateClientNetworkRequest 
    {
        ...
        public UpdateClientNetworkRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateClientNetworkRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClientNetworkRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListConfigurationTemplatesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListConfigurationTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListConfigurationTemplatesResponse input)
        {
            if (input == null)
                return false;

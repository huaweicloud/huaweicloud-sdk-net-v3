...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRedisHotKeysResponse : SdkResponse
    {
        ...
        public List<HotKeysInfoResponseBody> Keys { get; set; }
        ...
        {
            return this.Equals(input as ShowRedisHotKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRedisHotKeysResponse input)
        {

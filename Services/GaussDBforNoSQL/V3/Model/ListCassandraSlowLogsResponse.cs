...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCassandraSlowLogsResponse : SdkResponse
    {
        ...
        public List<CassandraSlowLogDetail> SlowLogs { get; set; }
        ...
        {
            return this.Equals(input as ListCassandraSlowLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCassandraSlowLogsResponse input)
        {
            if (input == null)
                return false;

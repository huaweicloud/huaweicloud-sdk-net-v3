...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceDatabasesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceDatabasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceDatabasesResponse input)
        {

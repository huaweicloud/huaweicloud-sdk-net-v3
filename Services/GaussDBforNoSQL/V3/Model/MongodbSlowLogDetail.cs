...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class MongodbSlowLogDetail 
    {
        ...
        {
            return this.Equals(input as MongodbSlowLogDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MongodbSlowLogDetail input)
        {
            ...
            if (this.DocsReturned != input.DocsReturned || (this.DocsReturned != null && !this.DocsReturned.Equals(input.DocsReturned))) return false;
            if (this.DocsScanned != input.DocsScanned || (this.DocsScanned != null && !this.DocsScanned.Equals(input.DocsScanned))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DocsReturned != null) hashCode = hashCode * 59 + this.DocsReturned.GetHashCode();
                if (this.DocsScanned != null) hashCode = hashCode * 59 + this.DocsScanned.GetHashCode();

...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInstanceConfigurationsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInstanceConfigurationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceConfigurationsResponse input)
        {

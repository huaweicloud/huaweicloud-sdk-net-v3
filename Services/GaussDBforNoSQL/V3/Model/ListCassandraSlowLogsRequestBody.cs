...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class ListCassandraSlowLogsRequestBody 
    {
        ...
        public bool Equals(ListCassandraSlowLogsRequestBody input)
        {
            ...
            if (this.KeyspaceKeywords != input.KeyspaceKeywords || (this.KeyspaceKeywords != null && input.KeyspaceKeywords != null && !this.KeyspaceKeywords.SequenceEqual(input.KeyspaceKeywords))) return false;
            if (this.TableKeywords != input.TableKeywords || (this.TableKeywords != null && input.TableKeywords != null && !this.TableKeywords.SequenceEqual(input.TableKeywords))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KeyspaceKeywords != null) hashCode = hashCode * 59 + this.KeyspaceKeywords.GetHashCode();
                if (this.TableKeywords != null) hashCode = hashCode * 59 + this.TableKeywords.GetHashCode();

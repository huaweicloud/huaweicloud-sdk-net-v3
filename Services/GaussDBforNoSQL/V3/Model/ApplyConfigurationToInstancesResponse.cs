...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ApplyConfigurationToInstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ApplyConfigurationToInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ApplyConfigurationToInstancesResponse input)
        {

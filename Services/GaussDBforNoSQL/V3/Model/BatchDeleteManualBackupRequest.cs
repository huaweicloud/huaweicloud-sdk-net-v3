...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class BatchDeleteManualBackupRequest 
    {
        ...
        public BatchDeleteManualBackupRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteManualBackupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteManualBackupRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class UpdateConfigurationRequestBody 
    {
        ...
        public UpdateConfigurationValuesOption Values { get; set; }
        ...
        {
            return this.Equals(input as UpdateConfigurationRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateConfigurationRequestBody input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class RestoreExistingInstanceRequest 
    {
        ...
        public RestoreRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RestoreExistingInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RestoreExistingInstanceRequest input)
        {
            if (input == null)
                return false;

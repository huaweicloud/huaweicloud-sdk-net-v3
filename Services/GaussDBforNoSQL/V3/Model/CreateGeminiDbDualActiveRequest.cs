...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3.Model
{
    ...
    public class CreateGeminiDbDualActiveRequest 
    {
        ...
        public DualActiveRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateGeminiDbDualActiveRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGeminiDbDualActiveRequest input)
        {

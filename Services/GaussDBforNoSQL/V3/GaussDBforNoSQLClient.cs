...
namespace HuaweiCloud.SDK.GaussDBforNoSQL.V3
{
    public partial class GaussDBforNoSQLClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSslCertDownloadAddressesResponse ListSslCertDownloadAddresses(ListSslCertDownloadAddressesRequest listSslCertDownloadAddressesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSslCertDownloadAddressesResponse> ListSslCertDownloadAddressesInvoker(ListSslCertDownloadAddressesRequest listSslCertDownloadAddressesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSslCertDownloadAddressesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ssl-cert/download-link", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSslCertDownloadAddressesRequest);
            return new SyncInvoker<ListSslCertDownloadAddressesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSslCertDownloadAddressesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ModifyAutoNodeExpansionPolicyResponse ModifyAutoNodeExpansionPolicy(ModifyAutoNodeExpansionPolicyRequest modifyAutoNodeExpansionPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ModifyAutoNodeExpansionPolicyResponse> ModifyAutoNodeExpansionPolicyInvoker(ModifyAutoNodeExpansionPolicyRequest modifyAutoNodeExpansionPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyAutoNodeExpansionPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/node-auto-expansion-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyAutoNodeExpansionPolicyRequest);
            return new SyncInvoker<ModifyAutoNodeExpansionPolicyResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<ModifyAutoNodeExpansionPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoNodeExpansionPolicyResponse ShowAutoNodeExpansionPolicy(ShowAutoNodeExpansionPolicyRequest showAutoNodeExpansionPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoNodeExpansionPolicyResponse> ShowAutoNodeExpansionPolicyInvoker(ShowAutoNodeExpansionPolicyRequest showAutoNodeExpansionPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoNodeExpansionPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/node-auto-expansion-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoNodeExpansionPolicyRequest);
            return new SyncInvoker<ShowAutoNodeExpansionPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoNodeExpansionPolicyResponse>);
        }
        ...
        public SyncInvoker<SwitchOverDisasterRecoveryResponse> SwitchOverDisasterRecoveryInvoker(SwitchOverDisasterRecoveryRequest switchOverDisasterRecoveryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchOverDisasterRecoveryRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/disaster-recovery/switchover", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", switchOverDisasterRecoveryRequest);
            return new SyncInvoker<SwitchOverDisasterRecoveryResponse>(this, "PUT", request, JsonUtils.DeSerialize<SwitchOverDisasterRecoveryResponse>);
        }

...
namespace HuaweiCloud.SDK.Evs.V2
{
    public partial class EvsClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchResizeVolumesResponse BatchResizeVolumes(BatchResizeVolumesRequest batchResizeVolumesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchResizeVolumesResponse> BatchResizeVolumesInvoker(BatchResizeVolumesRequest batchResizeVolumesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/{project_id}/volumes/batch-extend", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchResizeVolumesRequest);
            return new SyncInvoker<BatchResizeVolumesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchResizeVolumesResponse>);
        }
        ...
        public SyncInvoker<UnsubscribePostpaidVolumeResponse> UnsubscribePostpaidVolumeInvoker(UnsubscribePostpaidVolumeRequest unsubscribePostpaidVolumeRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/cloudvolumes/unsubscribe", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", unsubscribePostpaidVolumeRequest);
            return new SyncInvoker<UnsubscribePostpaidVolumeResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UnsubscribePostpaidVolumeResponse>);
        }

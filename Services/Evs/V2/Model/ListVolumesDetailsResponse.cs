...
namespace HuaweiCloud.SDK.Evs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListVolumesDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListVolumesDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListVolumesDetailsResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Evs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchResizeVolumesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchResizeVolumesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchResizeVolumesResponse input)
        {

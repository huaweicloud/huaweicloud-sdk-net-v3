...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1
{
    public class IdentityCenterStoreRegion
    {
        ...
        private static readonly IRegionProvider Provider = RegionProviderChain.GetDefault("IDENTITYCENTERSTORE");
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'IdentityCenterStore': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class GetGroupMembershipIdRequest 
    {
        ...
        public GetGroupMembershipIdReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as GetGroupMembershipIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetGroupMembershipIdRequest input)
        {

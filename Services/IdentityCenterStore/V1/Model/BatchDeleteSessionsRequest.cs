...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class BatchDeleteSessionsRequest 
    {
        ...
        public BatchDeleteSessionsReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteSessionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteSessionsRequest input)
        {

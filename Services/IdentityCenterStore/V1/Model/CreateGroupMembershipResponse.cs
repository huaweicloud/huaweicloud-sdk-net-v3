...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateGroupMembershipResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateGroupMembershipResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGroupMembershipResponse input)
        {

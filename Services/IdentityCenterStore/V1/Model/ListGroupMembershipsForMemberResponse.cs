...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupMembershipsForMemberResponse : SdkResponse
    {
        ...
        public List<GroupMembershipItem> GroupMemberships { get; set; }
        ...
        {
            return this.Equals(input as ListGroupMembershipsForMemberResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupMembershipsForMemberResponse input)
        {

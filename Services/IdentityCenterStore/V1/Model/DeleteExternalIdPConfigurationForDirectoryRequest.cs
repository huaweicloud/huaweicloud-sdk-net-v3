...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class DeleteExternalIdPConfigurationForDirectoryRequest 
    {
        ...
        {
            return this.Equals(input as DeleteExternalIdPConfigurationForDirectoryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteExternalIdPConfigurationForDirectoryRequest input)
        {

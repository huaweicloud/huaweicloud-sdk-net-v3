...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class CreateGroupMembershipRequest 
    {
        ...
        public CreateGroupMembershipReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateGroupMembershipRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGroupMembershipRequest input)
        {

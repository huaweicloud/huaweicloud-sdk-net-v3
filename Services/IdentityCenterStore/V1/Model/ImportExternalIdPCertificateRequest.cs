...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class ImportExternalIdPCertificateRequest 
    {
        ...
        public ImportExternalIdPCertificateReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as ImportExternalIdPCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportExternalIdPCertificateRequest input)
        {

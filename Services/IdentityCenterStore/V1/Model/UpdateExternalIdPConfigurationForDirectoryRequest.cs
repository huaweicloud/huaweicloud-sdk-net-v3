...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class UpdateExternalIdPConfigurationForDirectoryRequest 
    {
        ...
        public UpdateExternalIdPConfigurationForDirectoryReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateExternalIdPConfigurationForDirectoryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateExternalIdPConfigurationForDirectoryRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DescribeGroupMembershipResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DescribeGroupMembershipResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DescribeGroupMembershipResponse input)
        {

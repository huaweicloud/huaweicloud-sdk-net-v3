...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DescribePasswordPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DescribePasswordPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DescribePasswordPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class DisableExternalIdPConfigurationForDirectoryRequest 
    {
        ...
        {
            return this.Equals(input as DisableExternalIdPConfigurationForDirectoryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisableExternalIdPConfigurationForDirectoryRequest input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class EnableExternalIdPConfigurationForDirectoryRequest 
    {
        ...
        {
            return this.Equals(input as EnableExternalIdPConfigurationForDirectoryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EnableExternalIdPConfigurationForDirectoryRequest input)
        {

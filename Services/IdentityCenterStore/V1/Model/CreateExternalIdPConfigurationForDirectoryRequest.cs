...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class CreateExternalIdPConfigurationForDirectoryRequest 
    {
        ...
        public CreateIDPReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateExternalIdPConfigurationForDirectoryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateExternalIdPConfigurationForDirectoryRequest input)
        {

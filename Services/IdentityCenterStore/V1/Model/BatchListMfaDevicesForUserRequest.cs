...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class BatchListMfaDevicesForUserRequest 
    {
        ...
        public BatchListMfaDevicesForUserReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchListMfaDevicesForUserRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchListMfaDevicesForUserRequest input)
        {

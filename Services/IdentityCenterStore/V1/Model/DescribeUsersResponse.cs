...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DescribeUsersResponse : SdkResponse
    {
        ...
        public List<DescribeUserResp> Users { get; set; }
        ...
        {
            return this.Equals(input as DescribeUsersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DescribeUsersResponse input)
        {

...
namespace HuaweiCloud.SDK.IdentityCenterStore.V1.Model
{
    ...
    public class UpdateMfaDeviceForUserRequest 
    {
        ...
        public UpdateMfaDeviceForUserReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMfaDeviceForUserRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMfaDeviceForUserRequest input)
        {

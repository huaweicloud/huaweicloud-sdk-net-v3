...
namespace HuaweiCloud.SDK.Ims.V2.Model
{
    ...
    public class CreateWholeImageRequestBody 
    {
        ...
        public bool Equals(CreateWholeImageRequestBody input)
        {
            ...
            if (this.WholeImageType != input.WholeImageType || (this.WholeImageType != null && !this.WholeImageType.Equals(input.WholeImageType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WholeImageType != null) hashCode = hashCode * 59 + this.WholeImageType.GetHashCode();

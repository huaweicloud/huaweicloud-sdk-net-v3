    ...
    public class ImageDetectionResultAdDetail 
    {
        ...
        public bool Equals(ImageDetectionResultAdDetail input)
        {
            ...
            return 
                ...
                (
                    this.HitContexts == input.HitContexts ||
                    this.HitContexts != null &&
                    input.HitContexts != null &&
                    this.HitContexts.SequenceEqual(input.HitContexts)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HitContexts != null)
                    hashCode = hashCode * 59 + this.HitContexts.GetHashCode();
                return hashCode;
            }
        }
    }

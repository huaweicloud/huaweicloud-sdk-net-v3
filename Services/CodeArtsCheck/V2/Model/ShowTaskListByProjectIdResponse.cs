...
namespace HuaweiCloud.SDK.CodeArtsCheck.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTaskListByProjectIdResponse : SdkResponse
    {
        ...
        public List<SimpleTaskInfoV2> Tasks { get; set; }
        ...
        {
            return this.Equals(input as ShowTaskListByProjectIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTaskListByProjectIdResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsCheck.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTaskSettingsResponse : SdkResponse
    {
        ...
        public List<TaskAdvancedSettings> Info { get; set; }
        ...
        {
            return this.Equals(input as ShowTaskSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTaskSettingsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsCheck.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRulesetsResponse : SdkResponse
    {
        ...
        public List<RulesetItem> Info { get; set; }
        ...
        {
            return this.Equals(input as ListRulesetsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRulesetsResponse input)
        {

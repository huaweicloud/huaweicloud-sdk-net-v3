...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class UpdatePrivateHookMetadataRequest 
    {
        ...
        public UpdatePrivateHookMetadataRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePrivateHookMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateHookMetadataRequest input)
        {

...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class CreateStackInstanceRequest 
    {
        ...
        public CreateStackInstanceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateStackInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateStackInstanceRequest input)
        {

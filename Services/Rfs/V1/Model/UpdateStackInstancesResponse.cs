...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateStackInstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateStackInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateStackInstancesResponse input)
        {

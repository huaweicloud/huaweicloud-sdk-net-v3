...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class CreatePrivateModuleVersionRequest 
    {
        ...
        public CreatePrivateModuleVersionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePrivateModuleVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePrivateModuleVersionRequest input)
        {

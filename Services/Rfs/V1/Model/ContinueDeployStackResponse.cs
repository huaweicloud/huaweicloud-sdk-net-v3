...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ContinueDeployStackResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ContinueDeployStackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ContinueDeployStackResponse input)
        {

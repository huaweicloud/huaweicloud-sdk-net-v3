...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPrivateProviderMetadataResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPrivateProviderMetadataResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPrivateProviderMetadataResponse input)
        {

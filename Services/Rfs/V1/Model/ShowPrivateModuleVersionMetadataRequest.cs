...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class ShowPrivateModuleVersionMetadataRequest 
    {
        ...
        /// </summary>
        [SDKProperty("module_version", IsPath = true)]
        ...
        {
            return this.Equals(input as ShowPrivateModuleVersionMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPrivateModuleVersionMetadataRequest input)
        {

...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class ContinueDeployStackRequest 
    {
        ...
        public ContinueDeployStackRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ContinueDeployStackRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ContinueDeployStackRequest input)
        {

...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPrivateProviderVersionMetadataResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPrivateProviderVersionMetadataResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPrivateProviderVersionMetadataResponse input)
        {

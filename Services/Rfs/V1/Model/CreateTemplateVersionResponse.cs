...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTemplateVersionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTemplateVersionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTemplateVersionResponse input)
        {

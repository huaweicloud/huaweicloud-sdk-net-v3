...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class DeleteStackInstanceDeprecatedRequest 
    {
        ...
        public DeleteStackInstanceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteStackInstanceDeprecatedRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteStackInstanceDeprecatedRequest input)
        {

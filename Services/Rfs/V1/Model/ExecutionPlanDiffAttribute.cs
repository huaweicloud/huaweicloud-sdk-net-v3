...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class ExecutionPlanDiffAttribute 
    {
        ...
        public bool Equals(ExecutionPlanDiffAttribute input)
        {
            ...
            if (this.PreviousValue != input.PreviousValue || (this.PreviousValue != null && !this.PreviousValue.Equals(input.PreviousValue))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreviousValue != null) hashCode = hashCode * 59 + this.PreviousValue.GetHashCode();

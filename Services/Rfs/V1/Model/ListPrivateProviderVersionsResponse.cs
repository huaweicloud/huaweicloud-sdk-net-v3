...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPrivateProviderVersionsResponse : SdkResponse
    {
        ...
        public List<PrivateProviderVersionSummary> Versions { get; set; }
        ...
        {
            return this.Equals(input as ListPrivateProviderVersionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPrivateProviderVersionsResponse input)
        {

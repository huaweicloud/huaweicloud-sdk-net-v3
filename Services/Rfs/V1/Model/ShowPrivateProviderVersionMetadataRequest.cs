...
namespace HuaweiCloud.SDK.Rfs.V1.Model
{
    ...
    public class ShowPrivateProviderVersionMetadataRequest 
    {
        ...
        /// </summary>
        [SDKProperty("provider_version", IsPath = true)]
        ...
        {
            return this.Equals(input as ShowPrivateProviderVersionMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPrivateProviderVersionMetadataRequest input)
        {

...
namespace HuaweiCloud.SDK.Rfs.V1
{
    public class RfsRegion
    {
        ...
        private static readonly IRegionProvider Provider = RegionProviderChain.GetDefault("RFS");
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'RFS': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
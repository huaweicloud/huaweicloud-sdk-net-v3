...
using HuaweiCloud.SDK.Rfs.V1.Model;

namespace HuaweiCloud.SDK.Rfs.V1
{
    public partial class RfsAsyncClient : Client
    {
        public static ClientBuilder<RfsAsyncClient> NewBuilder()
        {
            return new ClientBuilder<RfsAsyncClient>();
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListPrivateHookVersionsResponse> ListPrivateHookVersionsAsync(ListPrivateHookVersionsRequest listPrivateHookVersionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListPrivateHookVersionsResponse> ListPrivateHookVersionsAsyncInvoker(ListPrivateHookVersionsRequest listPrivateHookVersionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPrivateHookVersionsRequest.HookName, out var valueOfHookName)) urlParam.Add("hook_name", valueOfHookName);
            var urlPath = HttpUtils.AddUrlPath("/v1/private-hooks/{hook_name}/versions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPrivateHookVersionsRequest);
            return new AsyncInvoker<ListPrivateHookVersionsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPrivateHookVersionsResponse>);
        }

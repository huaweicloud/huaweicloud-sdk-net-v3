...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAssetEditTaskResponse : SdkResponse
    {
        ...
        public List<EditingTaskInfo> Tasks { get; set; }
        ...
        {
            return this.Equals(input as ListAssetEditTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAssetEditTaskResponse input)
        {

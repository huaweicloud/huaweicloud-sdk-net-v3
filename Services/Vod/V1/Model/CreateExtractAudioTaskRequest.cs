...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class CreateExtractAudioTaskRequest 
    {
        ...
        public ExtractAudioTaskReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateExtractAudioTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateExtractAudioTaskRequest input)
        {
            if (input == null)
                return false;

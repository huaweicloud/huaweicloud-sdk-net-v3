...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class CreateTranscodeTemplateRequest 
    {
        ...
        public CreateTranscodeTemplate Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTranscodeTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTranscodeTemplateRequest input)
        {
            if (input == null)
                return false;

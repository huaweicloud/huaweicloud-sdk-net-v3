...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class CreatePreheatingAssetRequest 
    {
        ...
        public CreatePreheatingAssetReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePreheatingAssetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePreheatingAssetRequest input)
        {
            if (input == null)
                return false;

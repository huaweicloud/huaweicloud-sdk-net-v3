...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class UpdateCoverByThumbnailRequest 
    {
        ...
        public UpdateCoverByThumbnailReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateCoverByThumbnailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCoverByThumbnailRequest input)
        {
            if (input == null)
                return false;

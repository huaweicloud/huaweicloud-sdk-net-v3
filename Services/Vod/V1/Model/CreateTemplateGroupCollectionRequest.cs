...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class CreateTemplateGroupCollectionRequest 
    {
        ...
        public TransTemplateGroupCollection Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTemplateGroupCollectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTemplateGroupCollectionRequest input)
        {
            if (input == null)
                return false;

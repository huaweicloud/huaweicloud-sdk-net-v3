...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class CreateAssetByFileUploadRequest 
    {
        ...
        public CreateAssetByFileUploadReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAssetByFileUploadRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAssetByFileUploadRequest input)
        {
            if (input == null)
                return false;

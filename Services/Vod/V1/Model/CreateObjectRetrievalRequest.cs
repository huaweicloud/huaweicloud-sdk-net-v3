...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class CreateObjectRetrievalRequest 
    {
        ...
        public CreateObjectRetrievalRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateObjectRetrievalRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateObjectRetrievalRequest input)
        {

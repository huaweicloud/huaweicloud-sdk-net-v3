...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class UpdateTemplateGroupCollectionRequest 
    {
        ...
        public ModifyTemplateGroupCollection Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTemplateGroupCollectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTemplateGroupCollectionRequest input)
        {
            if (input == null)
                return false;

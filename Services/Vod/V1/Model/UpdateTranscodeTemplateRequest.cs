...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class UpdateTranscodeTemplateRequest 
    {
        ...
        public ModifyTransTemplate Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTranscodeTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTranscodeTemplateRequest input)
        {
            if (input == null)
                return false;

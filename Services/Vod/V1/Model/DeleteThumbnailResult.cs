...
namespace HuaweiCloud.SDK.Vod.V1.Model
{
    ...
    public class DeleteThumbnailResult 
    {
        ...
        /// </summary>
        /// <value>删除状态。  取值如下： - DELETED：已删除。 - FAILED：删除失败。 - UNKNOW：未知原因</value>
        ...
        {
            return this.Equals(input as DeleteThumbnailResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteThumbnailResult input)
        {

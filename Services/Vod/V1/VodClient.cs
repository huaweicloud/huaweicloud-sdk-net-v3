...
namespace HuaweiCloud.SDK.Vod.V1
{
    public partial class VodClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateAssetEditTaskResponse CreateAssetEditTask(CreateAssetEditTaskRequest createAssetEditTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateAssetEditTaskResponse> CreateAssetEditTaskInvoker(CreateAssetEditTaskRequest createAssetEditTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/editing/tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createAssetEditTaskRequest);
            return new SyncInvoker<CreateAssetEditTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateAssetEditTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteAssetEditTaskResponse DeleteAssetEditTask(DeleteAssetEditTaskRequest deleteAssetEditTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/editing/tasks", urlParam);
        ...
        public SyncInvoker<DeleteAssetEditTaskResponse> DeleteAssetEditTaskInvoker(DeleteAssetEditTaskRequest deleteAssetEditTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/editing/tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteAssetEditTaskRequest);
            return new SyncInvoker<DeleteAssetEditTaskResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteAssetEditTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteThumbnailsResponse DeleteThumbnails(DeleteThumbnailsRequest deleteThumbnailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteThumbnailsResponse> DeleteThumbnailsInvoker(DeleteThumbnailsRequest deleteThumbnailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/thumbnails", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteThumbnailsRequest);
            return new SyncInvoker<DeleteThumbnailsResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteThumbnailsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAssetEditTaskResponse ListAssetEditTask(ListAssetEditTaskRequest listAssetEditTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/editing/tasks", urlParam);
        ...
        public SyncInvoker<ListAssetEditTaskResponse> ListAssetEditTaskInvoker(ListAssetEditTaskRequest listAssetEditTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/editing/tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAssetEditTaskRequest);
            return new SyncInvoker<ListAssetEditTaskResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAssetEditTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAssetTaskInfoResponse ListAssetTaskInfo(ListAssetTaskInfoRequest listAssetTaskInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListAssetTaskInfoResponse> ListAssetTaskInfoInvoker(ListAssetTaskInfoRequest listAssetTaskInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAssetTaskInfoRequest);
            return new SyncInvoker<ListAssetTaskInfoResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAssetTaskInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCategoryInfoResponse ListCategoryInfo(ListCategoryInfoRequest listCategoryInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCategoryInfoResponse> ListCategoryInfoInvoker(ListCategoryInfoRequest listCategoryInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/asset/categories", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCategoryInfoRequest);
            return new SyncInvoker<ListCategoryInfoResponse>(this, "GET", request, response =>
            {
                var listCategoryInfoResponse = JsonUtils.DeSerializeNull<ListCategoryInfoResponse>(response);
                listCategoryInfoResponse.Body = JsonUtils.DeSerializeList<QueryCategoryInfoRsp>(response);
                return listCategoryInfoResponse;
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCdnStatisticsResponse ListCdnStatistics(ListCdnStatisticsRequest listCdnStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCdnStatisticsResponse> ListCdnStatisticsInvoker(ListCdnStatisticsRequest listCdnStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/asset/cdn-statistics", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCdnStatisticsRequest);
            return new SyncInvoker<ListCdnStatisticsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCdnStatisticsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListThumbnailDetailsResponse ListThumbnailDetails(ListThumbnailDetailsRequest listThumbnailDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListThumbnailDetailsResponse> ListThumbnailDetailsInvoker(ListThumbnailDetailsRequest listThumbnailDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/thumbnail/details", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listThumbnailDetailsRequest);
            return new SyncInvoker<ListThumbnailDetailsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListThumbnailDetailsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListThumbnailInfoResponse ListThumbnailInfo(ListThumbnailInfoRequest listThumbnailInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/thumbnails", urlParam);
        ...
        public SyncInvoker<ListThumbnailInfoResponse> ListThumbnailInfoInvoker(ListThumbnailInfoRequest listThumbnailInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/thumbnails", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listThumbnailInfoRequest);
            return new SyncInvoker<ListThumbnailInfoResponse>(this, "GET", request, JsonUtils.DeSerialize<ListThumbnailInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RefreshAssetResponse RefreshAsset(RefreshAssetRequest refreshAssetRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<RefreshAssetResponse> RefreshAssetInvoker(RefreshAssetRequest refreshAssetRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/refresh", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", refreshAssetRequest);
            return new SyncInvoker<RefreshAssetResponse>(this, "POST", request, JsonUtils.DeSerialize<RefreshAssetResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowRefreshResultResponse ShowRefreshResult(ShowRefreshResultRequest showRefreshResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/refresh", urlParam);
        ...
        public SyncInvoker<ShowRefreshResultResponse> ShowRefreshResultInvoker(ShowRefreshResultRequest showRefreshResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/refresh", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRefreshResultRequest);
            return new SyncInvoker<ShowRefreshResultResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRefreshResultResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowStorageModeTypeResponse ShowStorageModeType(ShowStorageModeTypeRequest showStorageModeTypeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowStorageModeTypeResponse> ShowStorageModeTypeInvoker(ShowStorageModeTypeRequest showStorageModeTypeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/storage-mode-type", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showStorageModeTypeRequest);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateStorageModeTypeResponse UpdateStorageModeType(UpdateStorageModeTypeRequest updateStorageModeTypeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/storage-mode-type", urlParam);
        ...
        public SyncInvoker<UpdateStorageModeTypeResponse> UpdateStorageModeTypeInvoker(UpdateStorageModeTypeRequest updateStorageModeTypeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/asset/storage-mode-type", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateStorageModeTypeRequest);
            return new SyncInvoker<UpdateStorageModeTypeResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateStorageModeTypeResponse>);
        }

...
namespace HuaweiCloud.SDK.IoTDM.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AccessInfos == input.AccessInfos ||
                    this.AccessInfos != null &&
                    input.AccessInfos != null &&
                    this.AccessInfos.SequenceEqual(input.AccessInfos)
                ) && 
                (
                ...
                (
                    this.OperateWindow == input.OperateWindow ||
                    (this.OperateWindow != null &&
                    this.OperateWindow.Equals(input.OperateWindow))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccessInfos != null)
                    hashCode = hashCode * 59 + this.AccessInfos.GetHashCode();
                ...
                if (this.OperateWindow != null)
                    hashCode = hashCode * 59 + this.OperateWindow.GetHashCode();

    ...
    public class AdditionalParams 
    {
        ...
        public bool Equals(AdditionalParams input)
        {
            ...
            return 
                ...
                (
                    this.SmnTopicUrn == input.SmnTopicUrn ||
                    (this.SmnTopicUrn != null &&
                    this.SmnTopicUrn.Equals(input.SmnTopicUrn))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SmnTopicUrn != null)
                    hashCode = hashCode * 59 + this.SmnTopicUrn.GetHashCode();

...
namespace HuaweiCloud.SDK.IoTDM.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RetryInstanceTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RetryInstanceTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RetryInstanceTaskResponse input)
        {

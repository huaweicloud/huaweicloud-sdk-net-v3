...
namespace HuaweiCloud.SDK.Rabbitmq.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyRecyclePolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyRecyclePolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyRecyclePolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.Rabbitmq.V2.Model
{
    ...
    public class RabbitMQExtendProductInfoEntity 
    {
        ...
        public List<RabbitMQExtendProductIosEntity> Ios { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("properties", NullValueHandling = NullValueHandling.Ignore)]
        public RabbitMQExtendProductPropertiesEntity Properties { get; set; }
        ...
        {
            return this.Equals(input as RabbitMQExtendProductInfoEntity);
        }

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateKnowledgeSkillRequest 
    {
        ...
        public UpdateKnowledgeSkillReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateKnowledgeSkillRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateKnowledgeSkillRequest input)
        {

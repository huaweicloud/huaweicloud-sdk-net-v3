...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDocumentInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDocumentInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDocumentInfoResponse input)
        {

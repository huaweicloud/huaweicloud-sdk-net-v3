...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class BatchConfirmLiveCommandsRequest 
    {
        ...
        public BatchConfirmLiveCommandsReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchConfirmLiveCommandsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchConfirmLiveCommandsRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRoleResponse : SdkResponse
    {
        ...
        public List<RoleBusinessInfo> RoleBusinessList { get; set; }
        ...
        /// MCP服务端对接配置信息列表
        /// </summary>
        [JsonProperty("mcp_server_info_list", NullValueHandling = NullValueHandling.Ignore)]
        public List<McpServerBaseInfo> McpServerInfoList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  mcpServerInfoList: ").Append(McpServerInfoList).Append("\n");
        ...
        {
            return this.Equals(input as ShowRoleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRoleResponse input)
        {

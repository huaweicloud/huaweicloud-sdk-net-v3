...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class List2dModelTrainingJobResponse : SdkResponse
    {
        ...
        public List<TrainingJobBasicInfo> Jobs { get; set; }
        ...
        {
            return this.Equals(input as List2dModelTrainingJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(List2dModelTrainingJobResponse input)
        {

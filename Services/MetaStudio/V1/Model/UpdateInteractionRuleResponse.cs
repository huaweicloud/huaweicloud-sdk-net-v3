...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInteractionRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInteractionRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInteractionRuleResponse input)
        {

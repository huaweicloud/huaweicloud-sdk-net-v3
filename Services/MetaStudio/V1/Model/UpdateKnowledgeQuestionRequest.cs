...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateKnowledgeQuestionRequest 
    {
        ...
        /// 问法ID。
        /// </summary>
        [SDKProperty("question_id", IsPath = true)]
        ...
        public UpdateKnowledgeQuestionReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateKnowledgeQuestionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateKnowledgeQuestionRequest input)
        {

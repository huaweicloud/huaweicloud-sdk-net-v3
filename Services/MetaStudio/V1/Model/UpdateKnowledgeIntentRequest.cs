...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateKnowledgeIntentRequest 
    {
        ...
        /// 意图ID。
        /// </summary>
        [SDKProperty("intent_id", IsPath = true)]
        ...
        public UpdateKnowledgeIntentReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateKnowledgeIntentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateKnowledgeIntentRequest input)
        {

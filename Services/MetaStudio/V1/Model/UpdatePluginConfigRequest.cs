...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdatePluginConfigRequest 
    {
        ...
        /// 插件配置ID。
        /// </summary>
        [SDKProperty("plugin_config_id", IsPath = true)]
        ...
        public UpdatePluginConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePluginConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePluginConfigRequest input)
        {

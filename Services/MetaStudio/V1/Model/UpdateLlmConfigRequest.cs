...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateLlmConfigRequest 
    {
        ...
        /// 大语言模型配置ID。
        /// </summary>
        [SDKProperty("llm_config_id", IsPath = true)]
        ...
        public UpdateLlmConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateLlmConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateLlmConfigRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateVideoMotionCaptureJobRequest 
    {
        ...
        /// 测试用户判断。
        /// </summary>
        [SDKProperty("X-User-Privilege", IsHeader = true)]
        [JsonProperty("X-User-Privilege", NullValueHandling = NullValueHandling.Ignore)]
        public string XUserPrivilege { get; set; }
        ...
        public VideoMotionCaptureJobReq Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  xUserPrivilege: ").Append(XUserPrivilege).Append("\n");
        ...
        {
            return this.Equals(input as CreateVideoMotionCaptureJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVideoMotionCaptureJobRequest input)
        {
            ...
            if (this.XUserPrivilege != input.XUserPrivilege || (this.XUserPrivilege != null && !this.XUserPrivilege.Equals(input.XUserPrivilege))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.XUserPrivilege != null) hashCode = hashCode * 59 + this.XUserPrivilege.GetHashCode();

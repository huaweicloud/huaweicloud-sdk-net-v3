...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDialogReportConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDialogReportConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDialogReportConfigResponse input)
        {

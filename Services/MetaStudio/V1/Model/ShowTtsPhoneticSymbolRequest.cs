...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ShowTtsPhoneticSymbolRequest 
    {
        ...
        {
            return this.Equals(input as ShowTtsPhoneticSymbolRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTtsPhoneticSymbolRequest input)
        {
            ...
            if (this.Word != input.Word || (this.Word != null && !this.Word.Equals(input.Word))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Word != null) hashCode = hashCode * 59 + this.Word.GetHashCode();
                return hashCode;
            }
        }
    }

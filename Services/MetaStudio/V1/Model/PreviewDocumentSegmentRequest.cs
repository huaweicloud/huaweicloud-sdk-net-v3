...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class PreviewDocumentSegmentRequest 
    {
        ...
        /// 文档ID。
        /// </summary>
        [SDKProperty("document_id", IsQuery = true)]
        ...
        /// 预览行数。
        /// </summary>
        [SDKProperty("preview_lines", IsQuery = true)]
        [JsonProperty("preview_lines", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public DocumentSegmentParam Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  previewLines: ").Append(PreviewLines).Append("\n");
        ...
        {
            return this.Equals(input as PreviewDocumentSegmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PreviewDocumentSegmentRequest input)
        {
            ...
            if (this.PreviewLines != input.PreviewLines || (this.PreviewLines != null && !this.PreviewLines.Equals(input.PreviewLines))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreviewLines != null) hashCode = hashCode * 59 + this.PreviewLines.GetHashCode();

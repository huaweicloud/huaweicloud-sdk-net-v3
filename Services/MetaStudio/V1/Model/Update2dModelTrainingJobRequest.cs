...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class Update2dModelTrainingJobRequest 
    {
        ...
        public Update2dModelTrainingJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as Update2dModelTrainingJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Update2dModelTrainingJobRequest input)
        {

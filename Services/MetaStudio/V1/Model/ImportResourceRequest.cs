...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ImportResourceRequest 
    {
        ...
        /// 资源名称
        /// </summary>
        [SDKProperty("resource", IsPath = true)]
        ...
        public ImportResourceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ImportResourceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportResourceRequest input)
        {

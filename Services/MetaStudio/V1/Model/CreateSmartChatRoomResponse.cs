...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateSmartChatRoomResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateSmartChatRoomResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSmartChatRoomResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class Create2DDigitalHumanVideoRequest 
    {
        ...
        public Create2DDigitalHumanVideoReq Body { get; set; }
        ...
        {
            return this.Equals(input as Create2DDigitalHumanVideoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Create2DDigitalHumanVideoRequest input)
        {

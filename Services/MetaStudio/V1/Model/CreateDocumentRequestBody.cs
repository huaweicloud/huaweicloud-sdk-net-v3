...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// 
    /// </summary>
    public class CreateDocumentRequestBody : IFormDataBody
    {
        ...
        public CreateDocumentRequestBody WithFile(Stream stream, string filename)
        {
            this.File = new FormDataFilePart(stream, filename);
            return this;
        }

        public CreateDocumentRequestBody WithFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as CreateDocumentRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDocumentRequestBody input)
        {

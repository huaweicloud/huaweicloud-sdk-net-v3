...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateHotQuestionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateHotQuestionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateHotQuestionResponse input)
        {

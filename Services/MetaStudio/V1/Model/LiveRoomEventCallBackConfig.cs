...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class LiveRoomEventCallBackConfig 
    {
        ...
        /// </summary>
        [JsonProperty("is_inheritance_platform_callback", NullValueHandling = NullValueHandling.Ignore)]
        public bool? IsInheritancePlatformCallback { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  isInheritancePlatformCallback: ").Append(IsInheritancePlatformCallback).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LiveRoomEventCallBackConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(LiveRoomEventCallBackConfig input)
        {
            ...
            if (this.IsInheritancePlatformCallback != input.IsInheritancePlatformCallback || (this.IsInheritancePlatformCallback != null && !this.IsInheritancePlatformCallback.Equals(input.IsInheritancePlatformCallback))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsInheritancePlatformCallback != null) hashCode = hashCode * 59 + this.IsInheritancePlatformCallback.GetHashCode();
                return hashCode;
            }
        }
    }

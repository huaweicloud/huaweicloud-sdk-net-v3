...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTrainingAdvanceJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTrainingAdvanceJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrainingAdvanceJobResponse input)
        {

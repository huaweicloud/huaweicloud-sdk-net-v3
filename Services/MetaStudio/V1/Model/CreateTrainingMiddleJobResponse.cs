...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTrainingMiddleJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTrainingMiddleJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrainingMiddleJobResponse input)
        {

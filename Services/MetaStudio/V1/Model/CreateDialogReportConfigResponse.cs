...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDialogReportConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDialogReportConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDialogReportConfigResponse input)
        {

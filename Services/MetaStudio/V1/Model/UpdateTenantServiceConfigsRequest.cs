...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateTenantServiceConfigsRequest 
    {
        ...
        public UpdateTenantServiceConfigsReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTenantServiceConfigsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTenantServiceConfigsRequest input)
        {

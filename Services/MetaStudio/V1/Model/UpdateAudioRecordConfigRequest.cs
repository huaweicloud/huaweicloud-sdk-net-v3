...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateAudioRecordConfigRequest 
    {
        ...
        public UpdateAudioRecordConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateAudioRecordConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAudioRecordConfigRequest input)
        {

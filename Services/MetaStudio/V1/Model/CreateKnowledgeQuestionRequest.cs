...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateKnowledgeQuestionRequest 
    {
        ...
        public CreateKnowledgeQuestionReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateKnowledgeQuestionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKnowledgeQuestionRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateHotWordsRequest 
    {
        ...
        /// 热词记录ID。
        /// </summary>
        [SDKProperty("hot_words_id", IsPath = true)]
        ...
        public UpdateHotWordsReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateHotWordsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotWordsRequest input)
        {

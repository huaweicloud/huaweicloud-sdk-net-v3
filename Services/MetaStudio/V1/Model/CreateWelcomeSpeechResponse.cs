...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWelcomeSpeechResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateWelcomeSpeechResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWelcomeSpeechResponse input)
        {

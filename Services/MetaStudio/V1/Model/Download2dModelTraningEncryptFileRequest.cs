...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Request Object
    /// </summary>
    public class Download2dModelTraningEncryptFileRequest 
    {
        ...
        {
            return this.Equals(input as Download2dModelTraningEncryptFileRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Download2dModelTraningEncryptFileRequest input)
        {

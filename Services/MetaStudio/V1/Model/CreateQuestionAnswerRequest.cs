...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateQuestionAnswerRequest 
    {
        ...
        public CreateQuestionAnswerReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateQuestionAnswerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateQuestionAnswerRequest input)
        {

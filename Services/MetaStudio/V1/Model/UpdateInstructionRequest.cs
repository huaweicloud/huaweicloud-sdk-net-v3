...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateInstructionRequest 
    {
        ...
        /// 指令ID。
        /// </summary>
        [SDKProperty("instruction_id", IsPath = true)]
        ...
        public UpdateInstructionReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstructionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstructionRequest input)
        {

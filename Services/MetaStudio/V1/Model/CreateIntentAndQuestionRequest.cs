...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateIntentAndQuestionRequest 
    {
        ...
        public CreateIntentAndQuestionReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateIntentAndQuestionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateIntentAndQuestionRequest input)
        {

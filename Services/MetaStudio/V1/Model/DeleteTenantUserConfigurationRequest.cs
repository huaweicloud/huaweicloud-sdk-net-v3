...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class DeleteTenantUserConfigurationRequest 
    {
        ...
        public DeleteTenantUserConfigurationReq Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteTenantUserConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTenantUserConfigurationRequest input)
        {

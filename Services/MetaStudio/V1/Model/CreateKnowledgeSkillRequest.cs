...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateKnowledgeSkillRequest 
    {
        ...
        public CreateKnowledgeSkillReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateKnowledgeSkillRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKnowledgeSkillRequest input)
        {

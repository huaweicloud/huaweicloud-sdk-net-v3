...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateHotWordsReq 
    {
        ...
        public CreateSisHotWords SisHotWords { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("mobvoi_hot_words", NullValueHandling = NullValueHandling.Ignore)]
        public CreateMobvoiHotWords MobvoiHotWords { get; set; }
        ...
        {
            return this.Equals(input as CreateHotWordsReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateHotWordsReq input)
        {

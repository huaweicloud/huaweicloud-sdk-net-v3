...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListPacifyWordsRequest 
    {
        ...
        /// </summary>
        [SDKProperty("pacify_words_type", IsQuery = true)]
        ...
        /// 安抚话术意图
        /// </summary>
        [SDKProperty("intent", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListPacifyWordsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPacifyWordsRequest input)
        {

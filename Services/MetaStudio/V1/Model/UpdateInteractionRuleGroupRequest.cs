...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateInteractionRuleGroupRequest 
    {
        ...
        public InteractionRuleGroup Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInteractionRuleGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInteractionRuleGroupRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateLivePlatformRequest 
    {
        ...
        /// 直播平台ID。
        /// </summary>
        [SDKProperty("platform_id", IsPath = true)]
        ...
        public UpdateLivePlatformReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateLivePlatformRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateLivePlatformRequest input)
        {

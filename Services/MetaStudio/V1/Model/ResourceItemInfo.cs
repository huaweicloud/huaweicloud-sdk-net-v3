...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ResourceItemInfo 
    {
        ...
        /// 
        /// </summary>
        [JsonProperty("bound_asset", NullValueHandling = NullValueHandling.Ignore)]
        public BoundAssetInfo BoundAsset { get; set; }

        /// <summary>
        /// 资源截止时间。格式遵循：RFC 3339 如\&quot;2021-01-10T08:43:17Z\&quot;
        /// </summary>
        [JsonProperty("resource_expire_time", NullValueHandling = NullValueHandling.Ignore)]
        public string ResourceExpireTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  boundAsset: ").Append(BoundAsset).Append("\n");
        ...
        {
            return this.Equals(input as ResourceItemInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResourceItemInfo input)
        {
            if (input == null) return false;
            if (this.ResourceId != input.ResourceId || (this.ResourceId != null && !this.ResourceId.Equals(input.ResourceId))) return false;
            if (this.OrderId != input.OrderId || (this.OrderId != null && !this.OrderId.Equals(input.OrderId))) return false;
            if (this.BoundAsset != input.BoundAsset || (this.BoundAsset != null && !this.BoundAsset.Equals(input.BoundAsset))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BoundAsset != null) hashCode = hashCode * 59 + this.BoundAsset.GetHashCode();

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateHotQuestionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateHotQuestionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotQuestionResponse input)
        {

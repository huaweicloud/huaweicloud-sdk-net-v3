...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class SmartChatVoiceConfig 
    {
        ...
        /// </summary>
        /// <value>语言类型。默认值CN。 * CN：中文。 * EN：英文。 * ESP：西班牙语（仅海外站点支持） * por：葡萄牙语（仅海外站点支持） * Arabic：阿拉伯语（仅海外站点支持） * Thai：泰语（仅海外站点支持） * fr：法语（仅海外站点支持）</value>
        ...
        /// 语言描述。
        /// </summary>
        [JsonProperty("language_desc", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  languageDesc: ").Append(LanguageDesc).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SmartChatVoiceConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SmartChatVoiceConfig input)
        {
            ...
            if (this.LanguageDesc != input.LanguageDesc || (this.LanguageDesc != null && !this.LanguageDesc.Equals(input.LanguageDesc))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LanguageDesc != null) hashCode = hashCode * 59 + this.LanguageDesc.GetHashCode();
                return hashCode;
            }
        }
    }

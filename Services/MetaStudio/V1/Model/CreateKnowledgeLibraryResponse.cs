...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateKnowledgeLibraryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateKnowledgeLibraryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKnowledgeLibraryResponse input)
        {

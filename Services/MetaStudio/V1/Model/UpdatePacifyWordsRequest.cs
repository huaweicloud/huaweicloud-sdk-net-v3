...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdatePacifyWordsRequest 
    {
        ...
        /// 安抚话术ID。
        /// </summary>
        [SDKProperty("pacify_words_id", IsPath = true)]
        ...
        public UpdatePacifyWordsReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePacifyWordsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePacifyWordsRequest input)
        {

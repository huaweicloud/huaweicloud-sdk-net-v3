...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInteractionRuleGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInteractionRuleGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInteractionRuleGroupResponse input)
        {

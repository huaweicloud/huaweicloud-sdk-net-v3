...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTrainingThirdPartyJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTrainingThirdPartyJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrainingThirdPartyJobResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSmartLiveJobsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListSmartLiveJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSmartLiveJobsResponse input)
        {

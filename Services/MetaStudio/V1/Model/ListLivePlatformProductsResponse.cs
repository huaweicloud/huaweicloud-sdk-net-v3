...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListLivePlatformProductsResponse : SdkResponse
    {
        ...
        public List<PlatformProductInfo> Products { get; set; }
        ...
        {
            return this.Equals(input as ListLivePlatformProductsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLivePlatformProductsResponse input)
        {

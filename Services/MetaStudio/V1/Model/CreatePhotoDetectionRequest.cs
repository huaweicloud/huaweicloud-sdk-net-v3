...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreatePhotoDetectionRequest 
    {
        ...
        public CreatePhotoDetectionReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePhotoDetectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePhotoDetectionRequest input)
        {

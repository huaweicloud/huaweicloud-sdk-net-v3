...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreatePictureModelingJobRequest 
    {
        ...
        public CreatePictureModelingJobRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePictureModelingJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePictureModelingJobRequest input)
        {

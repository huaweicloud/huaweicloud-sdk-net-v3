...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPacifyWordsSwitchResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPacifyWordsSwitchResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPacifyWordsSwitchResponse input)
        {

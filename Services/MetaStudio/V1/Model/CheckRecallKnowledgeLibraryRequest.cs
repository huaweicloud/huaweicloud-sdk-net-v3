...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CheckRecallKnowledgeLibraryRequest 
    {
        ...
        public RecallKnowledgeLibraryRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CheckRecallKnowledgeLibraryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckRecallKnowledgeLibraryRequest input)
        {

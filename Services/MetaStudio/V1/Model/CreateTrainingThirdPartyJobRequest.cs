...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateTrainingThirdPartyJobRequest 
    {
        ...
        public CreateTrainingJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTrainingThirdPartyJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrainingThirdPartyJobRequest input)
        {

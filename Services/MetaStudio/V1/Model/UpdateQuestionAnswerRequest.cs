...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateQuestionAnswerRequest 
    {
        ...
        /// 问答对ID。
        /// </summary>
        [SDKProperty("question_answer_id", IsPath = true)]
        ...
        public UpdateQuestionAnswerReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateQuestionAnswerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateQuestionAnswerRequest input)
        {

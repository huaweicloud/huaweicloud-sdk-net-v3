...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateHotWordsSwitchRequest 
    {
        ...
        public UpdateHotWordsSwitchReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateHotWordsSwitchRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotWordsSwitchRequest input)
        {

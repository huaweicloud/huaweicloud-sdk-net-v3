...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateSmartLiveUserConfigRequest 
    {
        ...
        public UpdateSmartLiveUserConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSmartLiveUserConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSmartLiveUserConfigRequest input)
        {

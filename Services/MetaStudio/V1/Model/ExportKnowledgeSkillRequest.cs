...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Request Object
    /// </summary>
    public class ExportKnowledgeSkillRequest 
    {
        ...
        /// 导出格式类型。0：科大讯飞
        /// </summary>
        [SDKProperty("export_type", IsQuery = true)]
        ...
        {
            return this.Equals(input as ExportKnowledgeSkillRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExportKnowledgeSkillRequest input)
        {
            ...
            if (this.ExportType != input.ExportType || (this.ExportType != null && !this.ExportType.Equals(input.ExportType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExportType != null) hashCode = hashCode * 59 + this.ExportType.GetHashCode();
                return hashCode;
            }
        }
    }

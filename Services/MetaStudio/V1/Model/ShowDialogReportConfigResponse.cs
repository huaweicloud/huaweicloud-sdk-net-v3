...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDialogReportConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDialogReportConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDialogReportConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class SetTenantNoticeConfigurationRequest 
    {
        ...
        public SetTenantNoticeConfigurationReq Body { get; set; }
        ...
        {
            return this.Equals(input as SetTenantNoticeConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetTenantNoticeConfigurationRequest input)
        {

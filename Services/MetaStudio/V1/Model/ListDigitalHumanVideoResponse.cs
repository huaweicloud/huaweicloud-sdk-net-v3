...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDigitalHumanVideoResponse : SdkResponse
    {
        ...
        public List<DigitalHumanVideo> Jobs { get; set; }
        ...
        {
            return this.Equals(input as ListDigitalHumanVideoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDigitalHumanVideoResponse input)
        {

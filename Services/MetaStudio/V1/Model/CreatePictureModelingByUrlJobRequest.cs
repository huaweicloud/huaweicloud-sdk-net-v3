...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreatePictureModelingByUrlJobRequest 
    {
        ...
        public PictureModelingByUrlReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePictureModelingByUrlJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePictureModelingByUrlJobRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class Create2dModelTrainingJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as Create2dModelTrainingJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Create2dModelTrainingJobResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAsrVocabularyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAsrVocabularyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAsrVocabularyResponse input)
        {

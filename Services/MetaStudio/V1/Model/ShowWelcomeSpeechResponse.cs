...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWelcomeSpeechResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowWelcomeSpeechResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWelcomeSpeechResponse input)
        {

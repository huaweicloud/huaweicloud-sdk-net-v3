...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class Create2dModelTrainingJobRequest 
    {
        ...
        public Create2dModelTrainingJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as Create2dModelTrainingJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Create2dModelTrainingJobRequest input)
        {

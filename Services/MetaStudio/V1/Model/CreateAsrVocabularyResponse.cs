...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAsrVocabularyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAsrVocabularyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAsrVocabularyResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateDigitalAssetRequest 
    {
        ...
        /// 数字人内部token
        /// </summary>
        [SDKProperty("X-MSS-Authorization", IsHeader = true)]
        [JsonProperty("X-MSS-Authorization", NullValueHandling = NullValueHandling.Ignore)]
        public string XMSSAuthorization { get; set; }
        ...
        public CreateDigitalAssetRequestBody Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  xMSSAuthorization: ").Append(XMSSAuthorization).Append("\n");
        ...
        {
            return this.Equals(input as CreateDigitalAssetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDigitalAssetRequest input)
        {
            ...
            if (this.XMSSAuthorization != input.XMSSAuthorization || (this.XMSSAuthorization != null && !this.XMSSAuthorization.Equals(input.XMSSAuthorization))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.XMSSAuthorization != null) hashCode = hashCode * 59 + this.XMSSAuthorization.GetHashCode();

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateSmartLiveRoomResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateSmartLiveRoomResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSmartLiveRoomResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSmartLiveRoomResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowSmartLiveRoomResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSmartLiveRoomResponse input)
        {

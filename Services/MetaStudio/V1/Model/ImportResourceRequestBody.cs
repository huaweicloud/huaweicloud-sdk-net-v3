...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// 
    /// </summary>
    public class ImportResourceRequestBody : IFormDataBody
    {
        ...
        public ImportResourceRequestBody WithFile(Stream stream, string filename)
        {
            this.File = new FormDataFilePart(stream, filename);
            return this;
        }

        public ImportResourceRequestBody WithFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as ImportResourceRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportResourceRequestBody input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateTtscVocabularyGroupsRequest 
    {
        ...
        public SaveTtscVocabularyGroupsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTtscVocabularyGroupsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTtscVocabularyGroupsRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ExecuteVideoMotionCaptureCommandRequest 
    {
        ...
        public ControlDigitalHumanLiveReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteVideoMotionCaptureCommandRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteVideoMotionCaptureCommandRequest input)
        {

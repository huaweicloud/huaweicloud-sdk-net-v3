...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateWelcomeSpeechSwitchRequest 
    {
        ...
        public UpdateWelcomeSpeechSwitchReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateWelcomeSpeechSwitchRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWelcomeSpeechSwitchRequest input)
        {

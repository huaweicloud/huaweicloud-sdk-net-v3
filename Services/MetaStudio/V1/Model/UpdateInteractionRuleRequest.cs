...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateInteractionRuleRequest 
    {
        ...
        public CreateInteractionRuleReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInteractionRuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInteractionRuleRequest input)
        {

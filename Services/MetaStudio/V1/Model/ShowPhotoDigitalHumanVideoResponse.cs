...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPhotoDigitalHumanVideoResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowPhotoDigitalHumanVideoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPhotoDigitalHumanVideoResponse input)
        {

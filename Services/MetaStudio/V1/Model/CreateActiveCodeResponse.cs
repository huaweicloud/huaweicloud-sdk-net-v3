...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateActiveCodeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateActiveCodeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateActiveCodeResponse input)
        {

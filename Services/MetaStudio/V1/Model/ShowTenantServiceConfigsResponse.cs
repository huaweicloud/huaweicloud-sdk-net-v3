...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTenantServiceConfigsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTenantServiceConfigsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTenantServiceConfigsResponse input)
        {

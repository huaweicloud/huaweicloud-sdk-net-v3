...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateKnowledgeIntentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateKnowledgeIntentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKnowledgeIntentResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateWelcomeSpeechRequest 
    {
        ...
        /// 欢迎词ID。
        /// </summary>
        [SDKProperty("welcome_speech_id", IsPath = true)]
        ...
        public UpdateWelcomeSpeechReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateWelcomeSpeechRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWelcomeSpeechRequest input)
        {

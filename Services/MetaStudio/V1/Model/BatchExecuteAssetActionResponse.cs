...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchExecuteAssetActionResponse : SdkResponse
    {
        ...
        public List<AssetActionResult> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchExecuteAssetActionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchExecuteAssetActionResponse input)
        {

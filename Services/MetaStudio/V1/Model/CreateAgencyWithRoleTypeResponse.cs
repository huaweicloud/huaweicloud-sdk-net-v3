...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAgencyWithRoleTypeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAgencyWithRoleTypeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAgencyWithRoleTypeResponse input)
        {

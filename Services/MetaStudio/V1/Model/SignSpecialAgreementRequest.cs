...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class SignSpecialAgreementRequest 
    {
        ...
        public SpecialAgreementSignReq Body { get; set; }
        ...
        {
            return this.Equals(input as SignSpecialAgreementRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SignSpecialAgreementRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateActiveCodeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateActiveCodeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateActiveCodeResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateInteractiveChatRequest 
    {
        ...
        public CreateInteractiveChatReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInteractiveChatRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInteractiveChatRequest input)
        {

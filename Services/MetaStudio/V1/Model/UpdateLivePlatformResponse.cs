...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateLivePlatformResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateLivePlatformResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateLivePlatformResponse input)
        {

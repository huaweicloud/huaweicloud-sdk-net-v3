...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ShowPhotoDigitalHumanVideoRequest 
    {
        ...
        /// 是否需要返回剧本参数配置。
        /// </summary>
        [SDKProperty("show_script", IsQuery = true)]
        [JsonProperty("show_script", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  showScript: ").Append(ShowScript).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowPhotoDigitalHumanVideoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPhotoDigitalHumanVideoRequest input)
        {
            ...
            if (this.ShowScript != input.ShowScript || (this.ShowScript != null && !this.ShowScript.Equals(input.ShowScript))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ShowScript != null) hashCode = hashCode * 59 + this.ShowScript.GetHashCode();
                return hashCode;
            }
        }
    }

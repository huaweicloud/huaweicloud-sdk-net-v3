...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListAsrVocabularyRequest 
    {
        ...
        /// </summary>
        /// <value>词表类型。 &gt; MOBVOI:使用的语音识别服务为MOBVOI时选择此类型</value>
        [JsonConverter(typeof(EnumClassConverter<VocabularyTypeEnum>))]
        public class VocabularyTypeEnum
        {
            /// <summary>
            /// Enum MOBVOI for value: MOBVOI
            /// </summary>
            public static readonly VocabularyTypeEnum MOBVOI = new VocabularyTypeEnum("MOBVOI");

            private static readonly Dictionary<string, VocabularyTypeEnum> StaticFields =
            new Dictionary<string, VocabularyTypeEnum>()
            {
                { "MOBVOI", MOBVOI },
            };
            ...
            public VocabularyTypeEnum()
            {

            }

            public VocabularyTypeEnum(string value)
            {
                _value = value;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as VocabularyTypeEnum))
                {
                    return true;
                }
            ...
            public bool Equals(VocabularyTypeEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(VocabularyTypeEnum a, VocabularyTypeEnum b)
            {
        ...
        /// 词表类型。 &gt; MOBVOI:使用的语音识别服务为MOBVOI时选择此类型
        /// </summary>
        [SDKProperty("vocabulary_type", IsQuery = true)]
        [JsonProperty("vocabulary_type", NullValueHandling = NullValueHandling.Ignore)]
        public VocabularyTypeEnum VocabularyType { get; set; }
        /// <summary>
        /// 智能交互语言 * CN：中文。 * EN：英文。 * ESP：西班牙语（仅海外站点支持） * por：葡萄牙语（仅海外站点支持） * Arabic：阿拉伯语（仅海外站点支持） * Thai：泰语（仅海外站点支持）
        /// </summary>
        ...
        {
            return this.Equals(input as ListAsrVocabularyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAsrVocabularyRequest input)
        {

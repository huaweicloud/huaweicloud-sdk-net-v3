...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateMetaStudioOrdersRequest 
    {
        ...
        public CreateMetaStudioOrdersReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateMetaStudioOrdersRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMetaStudioOrdersRequest input)
        {

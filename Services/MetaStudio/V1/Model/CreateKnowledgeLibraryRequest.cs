...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateKnowledgeLibraryRequest 
    {
        ...
        public CreateKnowledgeLibraryReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateKnowledgeLibraryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKnowledgeLibraryRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ShootScriptShowItem 
    {
        ...
        public ShootScriptDetail ShootScript { get; set; }
        ...
        {
            return this.Equals(input as ShootScriptShowItem);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShootScriptShowItem input)
        {
            ...
            if (this.PreviewInfo != input.PreviewInfo || (this.PreviewInfo != null && !this.PreviewInfo.Equals(input.PreviewInfo))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreviewInfo != null) hashCode = hashCode * 59 + this.PreviewInfo.GetHashCode();
                return hashCode;
            }
        }
    }

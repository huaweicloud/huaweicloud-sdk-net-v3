...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateDocumentSegmentParamRequest 
    {
        ...
        /// 文档ID。
        /// </summary>
        [SDKProperty("document_id", IsPath = true)]
        ...
        {
            return this.Equals(input as UpdateDocumentSegmentParamRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDocumentSegmentParamRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateMcpServerRequest 
    {
        ...
        /// MCP服务端对接配置ID。
        /// </summary>
        [SDKProperty("mcp_server_id", IsPath = true)]
        ...
        public UpdateMcpServerReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMcpServerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMcpServerRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateDigitalAssetRequest 
    {
        ...
        public UpdateDigitalAssetRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDigitalAssetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDigitalAssetRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdatePacifyWordsSwitchRequest 
    {
        ...
        public UpdatePacifyWordsSwitchReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePacifyWordsSwitchRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePacifyWordsSwitchRequest input)
        {

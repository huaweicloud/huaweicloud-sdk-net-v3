...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class DeleteTtscVocabularyConfigsRequest 
    {
        ...
        public DeleteTtscVocabularyConfigsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteTtscVocabularyConfigsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTtscVocabularyConfigsRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateDialogReportConfigRequest 
    {
        ...
        public CreateDialogReportConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateDialogReportConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDialogReportConfigRequest input)
        {

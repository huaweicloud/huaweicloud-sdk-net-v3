...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowLivePlatformResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowLivePlatformResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowLivePlatformResponse input)
        {

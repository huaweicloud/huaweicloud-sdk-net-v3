...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTransferAssetJobResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowTransferAssetJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTransferAssetJobResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListDigitalHumanVideoRequest 
    {
        ...
        /// 使用模糊查询的字段
        /// </summary>
        [SDKProperty("fuzzy_query_field", IsQuery = true)]
        [JsonProperty("fuzzy_query_field", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> FuzzyQueryField { get; set; }
        ...
        /// 输出视频资产名称。
        /// </summary>
        [SDKProperty("asset_name", IsQuery = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  fuzzyQueryField: ").Append(FuzzyQueryField).Append("\n");
        ...
        {
            return this.Equals(input as ListDigitalHumanVideoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDigitalHumanVideoRequest input)
        {
            ...
            if (this.FuzzyQueryField != input.FuzzyQueryField || (this.FuzzyQueryField != null && input.FuzzyQueryField != null && !this.FuzzyQueryField.SequenceEqual(input.FuzzyQueryField))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FuzzyQueryField != null) hashCode = hashCode * 59 + this.FuzzyQueryField.GetHashCode();

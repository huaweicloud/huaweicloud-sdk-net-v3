...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateRobotRequest 
    {
        ...
        /// 应用ID。
        /// </summary>
        [SDKProperty("robot_id", IsPath = true)]
        ...
        public UpdateRobotReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRobotRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRobotRequest input)
        {

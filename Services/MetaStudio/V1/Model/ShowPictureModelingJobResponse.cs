...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPictureModelingJobResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowPictureModelingJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPictureModelingJobResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UserQuotaDetail 
    {
        ...
        {
            return this.Equals(input as UserQuotaDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UserQuotaDetail input)
        {

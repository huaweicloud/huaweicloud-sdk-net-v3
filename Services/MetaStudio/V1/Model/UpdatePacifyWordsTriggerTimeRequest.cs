...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdatePacifyWordsTriggerTimeRequest 
    {
        ...
        public UpdatePacifyWordsTriggerTimeReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePacifyWordsTriggerTimeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePacifyWordsTriggerTimeRequest input)
        {

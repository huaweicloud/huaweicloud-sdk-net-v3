...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateBatchKnowledgeQuestionRequest 
    {
        ...
        public UpdateBatchKnowledgeQuestionReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateBatchKnowledgeQuestionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateBatchKnowledgeQuestionRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateAssetByReplicationInfoRequest 
    {
        ...
        public ReplicationAssetInfo Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAssetByReplicationInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAssetByReplicationInfoRequest input)
        {

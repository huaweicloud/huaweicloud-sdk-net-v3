...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateKnowledgeIntentRequest 
    {
        ...
        public CreateKnowledgeIntentReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateKnowledgeIntentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKnowledgeIntentRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateDigitalHumanBusinessCardRequest 
    {
        ...
        public CreateDigitalHumanBusinessCardReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateDigitalHumanBusinessCardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDigitalHumanBusinessCardRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateAudioRecordConfigRequest 
    {
        ...
        public CreateAudioRecordConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAudioRecordConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAudioRecordConfigRequest input)
        {

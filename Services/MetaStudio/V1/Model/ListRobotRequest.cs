...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListRobotRequest 
    {
        ...
        [JsonConverter(typeof(EnumClassConverter<RobotTypeEnum>))]
        public class RobotTypeEnum
        {
            /// <summary>
            /// Enum LIVE for value: LIVE
            /// </summary>
            public static readonly RobotTypeEnum LIVE = new RobotTypeEnum("LIVE");

            /// <summary>
            /// Enum CHAT for value: CHAT
            /// </summary>
            public static readonly RobotTypeEnum CHAT = new RobotTypeEnum("CHAT");

            private static readonly Dictionary<string, RobotTypeEnum> StaticFields =
            new Dictionary<string, RobotTypeEnum>()
            {
                { "LIVE", LIVE },
                { "CHAT", CHAT },
            };
            ...
            public RobotTypeEnum()
            {

            }

            public RobotTypeEnum(string value)
            {
                _value = value;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as RobotTypeEnum))
                {
                    return true;
                }
            ...
            public bool Equals(RobotTypeEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(RobotTypeEnum a, RobotTypeEnum b)
            {
        ...
        /// 交互对接类型  * LIVE:直播交互  * CHAT:智能交互
        /// </summary>
        [SDKProperty("robot_type", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListRobotRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRobotRequest input)
        {

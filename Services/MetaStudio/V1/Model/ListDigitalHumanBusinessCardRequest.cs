...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListDigitalHumanBusinessCardRequest 
    {
        ...
        /// 输出的视频资产名称。
        /// </summary>
        [SDKProperty("video_asset_name", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListDigitalHumanBusinessCardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDigitalHumanBusinessCardRequest input)
        {

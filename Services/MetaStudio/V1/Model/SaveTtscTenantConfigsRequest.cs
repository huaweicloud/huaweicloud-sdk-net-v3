...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class SaveTtscTenantConfigsRequest 
    {
        ...
        public SaveTtscTenantConfigsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SaveTtscTenantConfigsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SaveTtscTenantConfigsRequest input)
        {

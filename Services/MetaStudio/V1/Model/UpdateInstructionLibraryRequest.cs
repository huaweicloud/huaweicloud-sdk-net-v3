...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateInstructionLibraryRequest 
    {
        ...
        /// 指令集ID。
        /// </summary>
        [SDKProperty("instruction_library_id", IsPath = true)]
        ...
        public UpdateInstructionLibraryReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstructionLibraryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstructionLibraryRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateVideoMotionCaptureJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateVideoMotionCaptureJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVideoMotionCaptureJobResponse input)
        {

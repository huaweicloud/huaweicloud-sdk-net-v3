...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowKnowledgeLibraryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowKnowledgeLibraryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKnowledgeLibraryResponse input)
        {

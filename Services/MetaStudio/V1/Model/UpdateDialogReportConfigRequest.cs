...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateDialogReportConfigRequest 
    {
        ...
        public UpdateDialogReportConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDialogReportConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDialogReportConfigRequest input)
        {

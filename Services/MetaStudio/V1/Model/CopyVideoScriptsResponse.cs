...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CopyVideoScriptsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CopyVideoScriptsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CopyVideoScriptsResponse input)
        {

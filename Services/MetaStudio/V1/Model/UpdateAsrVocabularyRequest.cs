...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateAsrVocabularyRequest 
    {
        ...
        /// 热词表ID。
        /// </summary>
        [SDKProperty("asr_vocabulary_id", IsPath = true)]
        ...
        public UpdateAsrVocabularyReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateAsrVocabularyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAsrVocabularyRequest input)
        {

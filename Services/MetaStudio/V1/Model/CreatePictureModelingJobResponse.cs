...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePictureModelingJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePictureModelingJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePictureModelingJobResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class Execute2dModelTrainingCommandByUserRequest 
    {
        ...
        public Execute2dModelTrainingCommandByUserReq Body { get; set; }
        ...
        {
            return this.Equals(input as Execute2dModelTrainingCommandByUserRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Execute2dModelTrainingCommandByUserRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateKnowledgeLibraryRequest 
    {
        ...
        /// 知识库ID。
        /// </summary>
        [SDKProperty("knowledge_library_id", IsPath = true)]
        ...
        public UpdateKnowledgeLibraryReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateKnowledgeLibraryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateKnowledgeLibraryRequest input)
        {

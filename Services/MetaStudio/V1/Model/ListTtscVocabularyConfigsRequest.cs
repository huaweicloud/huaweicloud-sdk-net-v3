...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListTtscVocabularyConfigsRequest 
    {
        ...
        /// 声音模型名称
        /// </summary>
        [SDKProperty("tts_service_name", IsQuery = true)]
        [JsonProperty("tts_service_name", NullValueHandling = NullValueHandling.Ignore)]
        public string TtsServiceName { get; set; }

        /// <summary>
        /// 是否应用词表配置，从周边服务传递
        /// </summary>
        [SDKProperty("is_vocabulary_config_enable", IsQuery = true)]
        ...
        /// 搜索条件
        /// </summary>
        [SDKProperty("search_key", IsQuery = true)]
        [JsonProperty("search_key", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ListTtscVocabularyConfigsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTtscVocabularyConfigsRequest input)
        {

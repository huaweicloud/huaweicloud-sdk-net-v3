...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateActiveCodeRequest 
    {
        ...
        /// 激活码ID。
        /// </summary>
        [SDKProperty("active_code_id", IsPath = true)]
        ...
        public UpdateActiveCodeReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateActiveCodeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateActiveCodeRequest input)
        {

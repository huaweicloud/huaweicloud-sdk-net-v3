...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ExecuteSmartLiveCommandRequest 
    {
        ...
        public ControlSmartLiveReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteSmartLiveCommandRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteSmartLiveCommandRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class SetTtscGroupAssetsRequest 
    {
        ...
        public SetTtscGroupAssetsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetTtscGroupAssetsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetTtscGroupAssetsRequest input)
        {

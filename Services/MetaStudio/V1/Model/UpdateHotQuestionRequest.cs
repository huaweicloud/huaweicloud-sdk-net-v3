...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateHotQuestionRequest 
    {
        ...
        /// 热点问题ID。
        /// </summary>
        [SDKProperty("hot_question_id", IsPath = true)]
        ...
        public UpdateHotQuestionReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateHotQuestionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotQuestionRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class BatchExecuteAssetActionRequest 
    {
        ...
        public BatchAssetActionReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchExecuteAssetActionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchExecuteAssetActionRequest input)
        {

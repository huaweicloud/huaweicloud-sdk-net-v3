...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateBatchKnowledgeQuestionRequest 
    {
        ...
        public CreateBatchKnowledgeQuestionReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateBatchKnowledgeQuestionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateBatchKnowledgeQuestionRequest input)
        {

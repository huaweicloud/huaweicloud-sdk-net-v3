...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class StartDocumentSegmentRequest 
    {
        ...
        public StartDocumentSegmentTaskReq Body { get; set; }
        ...
        {
            return this.Equals(input as StartDocumentSegmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartDocumentSegmentRequest input)
        {

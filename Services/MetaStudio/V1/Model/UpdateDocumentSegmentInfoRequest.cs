...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class UpdateDocumentSegmentInfoRequest 
    {
        ...
        public UpdateDocumentSegmentReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDocumentSegmentInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDocumentSegmentInfoRequest input)
        {

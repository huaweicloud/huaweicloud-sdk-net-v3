...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class CreateInstructionLibraryRequest 
    {
        ...
        public CreateInstructionLibraryReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateInstructionLibraryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstructionLibraryRequest input)
        {

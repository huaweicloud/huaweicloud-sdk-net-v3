...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class SetTenantUserConfigurationRequest 
    {
        ...
        public SetTenantUserConfigurationReq Body { get; set; }
        ...
        {
            return this.Equals(input as SetTenantUserConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetTenantUserConfigurationRequest input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListLivePlatformProductsRequest 
    {
        ...
        /// 第三方直播平台id
        /// </summary>
        [SDKProperty("platform_id", IsQuery = true)]
        ...
        /// 第三方直播平台直播Id。
        /// </summary>
        [SDKProperty("live_id", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListLivePlatformProductsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLivePlatformProductsRequest input)
        {

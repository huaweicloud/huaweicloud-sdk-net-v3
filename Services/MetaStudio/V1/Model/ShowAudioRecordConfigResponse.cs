...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAudioRecordConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAudioRecordConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAudioRecordConfigResponse input)
        {

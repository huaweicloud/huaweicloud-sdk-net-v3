...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAudioRecordConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAudioRecordConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAudioRecordConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.MetaStudio.V1.Model
{
    ...
    public class ListQuestionAnswerRequest 
    {
        ...
        /// 知识库ID。
        /// </summary>
        [SDKProperty("knowledge_library_id", IsQuery = true)]
        ...
        /// 问题。
        /// </summary>
        [SDKProperty("question", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListQuestionAnswerRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListQuestionAnswerRequest input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4
{
    public class CodeArtsRepoRegion
    {
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'CodeArtsRepo': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
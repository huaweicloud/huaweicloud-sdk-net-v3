...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateMergeRequestSettingResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释：** 合入模式
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateMergeRequestSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestSettingResponse input)
        {

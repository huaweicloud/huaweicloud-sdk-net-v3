...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGroupWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateGroupWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGroupWebhookResponse input)
        {

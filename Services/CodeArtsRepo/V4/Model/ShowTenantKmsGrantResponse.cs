...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTenantKmsGrantResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTenantKmsGrantResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTenantKmsGrantResponse input)
        {

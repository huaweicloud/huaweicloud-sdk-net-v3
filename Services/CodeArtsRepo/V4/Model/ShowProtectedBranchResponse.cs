...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProtectedBranchResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProtectedBranchResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProtectedBranchResponse input)
        {

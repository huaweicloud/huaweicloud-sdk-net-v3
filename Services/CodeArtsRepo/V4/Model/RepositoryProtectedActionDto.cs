...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class RepositoryProtectedActionDto 
    {
        ...
        public List<RepositoryUserDto> Users { get; set; }
        ...
        public List<BasicRoleDto> Roles { get; set; }
        ...
        {
            return this.Equals(input as RepositoryProtectedActionDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RepositoryProtectedActionDto input)
        {

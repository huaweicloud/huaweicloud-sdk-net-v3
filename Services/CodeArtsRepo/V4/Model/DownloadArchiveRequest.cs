...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class DownloadArchiveRequest 
    {
        ...
        /// </summary>
        [SDKProperty("archive_format", IsQuery = true)]
        ...
        {
            return this.Equals(input as DownloadArchiveRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadArchiveRequest input)
        {
            if (input == null) return false;
            if (this.RepositoryId != input.RepositoryId || (this.RepositoryId != null && !this.RepositoryId.Equals(input.RepositoryId))) return false;
            if (this.Sha != input.Sha || (this.Sha != null && !this.Sha.Equals(input.Sha))) return false;
            if (this.Path != input.Path || (this.Path != null && !this.Path.Equals(input.Path))) return false;
            if (this.ArchiveFormat != input.ArchiveFormat || (this.ArchiveFormat != null && !this.ArchiveFormat.Equals(input.ArchiveFormat))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ArchiveFormat != null) hashCode = hashCode * 59 + this.ArchiveFormat.GetHashCode();
                return hashCode;
            }
        }
    }

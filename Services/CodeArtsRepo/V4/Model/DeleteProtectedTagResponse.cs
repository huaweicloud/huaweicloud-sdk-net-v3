...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteProtectedTagResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeleteProtectedTagResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteProtectedTagResponse input)
        {

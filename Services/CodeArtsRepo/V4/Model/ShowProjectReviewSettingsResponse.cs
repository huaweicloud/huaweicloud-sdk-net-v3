...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectReviewSettingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProjectReviewSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectReviewSettingsResponse input)
        {

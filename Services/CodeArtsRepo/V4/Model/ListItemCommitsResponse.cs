...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListItemCommitsResponse : SdkResponse
    {
        ...
        public List<ItemCommitDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListItemCommitsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListItemCommitsResponse input)
        {

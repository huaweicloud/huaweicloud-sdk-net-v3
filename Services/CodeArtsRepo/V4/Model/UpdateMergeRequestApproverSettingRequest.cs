...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class UpdateMergeRequestApproverSettingRequest 
    {
        ...
        public MergeRequestApproverSettingResultDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMergeRequestApproverSettingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestApproverSettingRequest input)
        {

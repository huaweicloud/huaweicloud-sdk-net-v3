...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTenantRepoEncryptionSettingResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateTenantRepoEncryptionSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTenantRepoEncryptionSettingResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateMergeRequestDiscussionResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateMergeRequestDiscussionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestDiscussionResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class RemoteMirrorUpdateBody 
    {
        ...
        /// </summary>
        /// <value>**参数解释：**  分支同步。 **取值范围：** - all，同步全部分支。 - default，同步默认分支。 **约束限制：** 不涉及。 **默认取值：** 不涉及。</value>
        ...
        {
            return this.Equals(input as RemoteMirrorUpdateBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoteMirrorUpdateBody input)
        {

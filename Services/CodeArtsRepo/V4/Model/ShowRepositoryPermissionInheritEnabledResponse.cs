...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepositoryPermissionInheritEnabledResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRepositoryPermissionInheritEnabledResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepositoryPermissionInheritEnabledResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectMergeRequestSettingResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释：** 合入模式
        /// </summary>
        ...
        public List<EvaluationTypeDto> EvaluationTypes { get; set; }
        ...
        {
            return this.Equals(input as ShowProjectMergeRequestSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectMergeRequestSettingResponse input)
        {

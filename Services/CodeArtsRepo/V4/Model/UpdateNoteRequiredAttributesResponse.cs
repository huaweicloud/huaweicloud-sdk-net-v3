...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateNoteRequiredAttributesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateNoteRequiredAttributesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNoteRequiredAttributesResponse input)
        {

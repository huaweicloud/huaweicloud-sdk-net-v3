...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTenantRepositoriesResponse : SdkResponse
    {
        ...
        public List<TenantRepositoryDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListTenantRepositoriesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTenantRepositoriesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupReviewSettingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGroupReviewSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupReviewSettingsResponse input)
        {

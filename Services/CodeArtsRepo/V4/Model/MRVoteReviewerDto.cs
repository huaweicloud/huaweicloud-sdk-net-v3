...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class MRVoteReviewerDto 
    {
        ...
        {
            return this.Equals(input as MRVoteReviewerDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MRVoteReviewerDto input)
        {
            ...
            if (this.IsVerified != input.IsVerified || (this.IsVerified != null && !this.IsVerified.Equals(input.IsVerified))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsVerified != null) hashCode = hashCode * 59 + this.IsVerified.GetHashCode();

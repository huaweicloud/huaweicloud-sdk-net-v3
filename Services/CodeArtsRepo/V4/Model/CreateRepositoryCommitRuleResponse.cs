...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRepositoryCommitRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateRepositoryCommitRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRepositoryCommitRuleResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddTenantTrustedIpAddressResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AddTenantTrustedIpAddressResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddTenantTrustedIpAddressResponse input)
        {

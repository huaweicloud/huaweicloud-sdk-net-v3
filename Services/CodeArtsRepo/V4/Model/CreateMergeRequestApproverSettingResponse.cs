...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateMergeRequestApproverSettingResponse : SdkResponse
    {
        /// <summary>
        /// 设置类型，当前仅开放branch类型
        /// </summary>
        ...
        {
            return this.Equals(input as CreateMergeRequestApproverSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMergeRequestApproverSettingResponse input)
        {

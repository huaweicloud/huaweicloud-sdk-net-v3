...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateMergeRequestResponse : SdkResponse
    {
        /// <summary>
        /// 合并请求模式
        /// </summary>
        ...
        {
            return this.Equals(input as CreateMergeRequestResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMergeRequestResponse input)
        {

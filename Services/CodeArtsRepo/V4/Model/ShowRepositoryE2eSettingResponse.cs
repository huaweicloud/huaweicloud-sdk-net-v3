...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepositoryE2eSettingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRepositoryE2eSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepositoryE2eSettingResponse input)
        {

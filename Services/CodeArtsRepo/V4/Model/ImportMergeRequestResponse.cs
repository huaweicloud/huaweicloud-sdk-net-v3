...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ImportMergeRequestResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ImportMergeRequestResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportMergeRequestResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class ProtectedBranchProtectedActionBodyDto 
    {
        ...
        /// </summary>
        /// <value>**参数解释：** 事件名称。 **约束限制：** action中必传此字段。 **取值范围：** - push，推送 。 - merge，合并 。 **默认取值：** 不涉及。</value>
        ...
        public List<ProtectedActionSwitcher> AdditionSwitchers { get; set; }
        ...
        {
            return this.Equals(input as ProtectedBranchProtectedActionBodyDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProtectedBranchProtectedActionBodyDto input)
        {

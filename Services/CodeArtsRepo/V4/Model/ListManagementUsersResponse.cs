...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListManagementUsersResponse : SdkResponse
    {
        ...
        public List<ManagementUserDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListManagementUsersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListManagementUsersResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class UpdateMergeRequestReviewersRequest 
    {
        ...
        public ApprovalReviewerInfoDto Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMergeRequestReviewersRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMergeRequestReviewersRequest input)
        {

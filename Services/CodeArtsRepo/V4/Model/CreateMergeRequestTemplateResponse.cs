...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateMergeRequestTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateMergeRequestTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMergeRequestTemplateResponse input)
        {

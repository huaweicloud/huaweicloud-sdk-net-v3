...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class UpdateProtectedTagRequest 
    {
        ...
        /// </summary>
        [SDKProperty("tag_name", IsQuery = true)]
        ...
        public List<RepositoryProtectedTagActionBodyDto> Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateProtectedTagRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProtectedTagRequest input)
        {

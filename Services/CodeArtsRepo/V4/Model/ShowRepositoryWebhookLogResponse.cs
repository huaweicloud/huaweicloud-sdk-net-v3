...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRepositoryWebhookLogResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRepositoryWebhookLogResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRepositoryWebhookLogResponse input)
        {

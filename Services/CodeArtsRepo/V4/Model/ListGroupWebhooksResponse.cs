...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupWebhooksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListGroupWebhooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupWebhooksResponse input)
        {

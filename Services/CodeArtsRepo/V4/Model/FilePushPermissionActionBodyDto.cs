...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class FilePushPermissionActionBodyDto 
    {
        ...
        /// </summary>
        /// <value>**参数解释：** 事件名称。 **约束限制：** 不涉及。 **取值范围：**   - push，推送。 **默认取值：** 不涉及。</value>
        ...
        {
            return this.Equals(input as FilePushPermissionActionBodyDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(FilePushPermissionActionBodyDto input)
        {

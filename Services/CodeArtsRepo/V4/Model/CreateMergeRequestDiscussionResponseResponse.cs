...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateMergeRequestDiscussionResponseResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateMergeRequestDiscussionResponseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateMergeRequestDiscussionResponseResponse input)
        {

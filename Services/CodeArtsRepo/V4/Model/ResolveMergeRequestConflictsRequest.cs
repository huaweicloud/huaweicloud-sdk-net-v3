...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class ResolveMergeRequestConflictsRequest 
    {
        ...
        public ResolveConflictDto Body { get; set; }
        ...
        {
            return this.Equals(input as ResolveMergeRequestConflictsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResolveMergeRequestConflictsRequest input)
        {

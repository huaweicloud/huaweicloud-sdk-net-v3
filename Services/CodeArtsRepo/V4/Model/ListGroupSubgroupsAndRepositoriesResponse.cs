...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupSubgroupsAndRepositoriesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListGroupSubgroupsAndRepositoriesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupSubgroupsAndRepositoriesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class TransferRepositoryResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TransferRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(TransferRepositoryResponse input)
        {

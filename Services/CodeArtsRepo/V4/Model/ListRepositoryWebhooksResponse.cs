...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryWebhooksResponse : SdkResponse
    {
        ...
        public List<WebhookDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryWebhooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryWebhooksResponse input)
        {

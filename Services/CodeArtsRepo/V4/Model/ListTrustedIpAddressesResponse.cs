...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTrustedIpAddressesResponse : SdkResponse
    {
        ...
        public List<TrustedIpAddressDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListTrustedIpAddressesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTrustedIpAddressesResponse input)
        {

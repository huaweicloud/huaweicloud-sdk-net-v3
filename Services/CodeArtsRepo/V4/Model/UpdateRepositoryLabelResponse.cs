...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRepositoryLabelResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRepositoryLabelResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRepositoryLabelResponse input)
        {

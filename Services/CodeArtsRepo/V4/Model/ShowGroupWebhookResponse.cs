...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGroupWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupWebhookResponse input)
        {

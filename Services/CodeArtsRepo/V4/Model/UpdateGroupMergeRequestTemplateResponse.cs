...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGroupMergeRequestTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateGroupMergeRequestTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGroupMergeRequestTemplateResponse input)
        {

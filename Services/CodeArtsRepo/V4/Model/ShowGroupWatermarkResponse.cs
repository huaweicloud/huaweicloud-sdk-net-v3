...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupWatermarkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGroupWatermarkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupWatermarkResponse input)
        {

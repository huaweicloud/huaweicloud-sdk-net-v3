...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class ListTenantEncryptedRepositoriesRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释：** 排序字段 repoName 仓库名称  ownerName | 仓库所有者名称 ownerName, 不传该字段时不进行排序</value>
        ...
        public class OrderByEnum
        {
            ...
            /// </summary>
            public static readonly OrderByEnum REPONAME = new OrderByEnum("repoName");

            /// <summary>
            /// Enum OWNERNAME for value: ownerName
            /// </summary>
            public static readonly OrderByEnum OWNERNAME = new OrderByEnum("ownerName");
        ...
        {
            return this.Equals(input as ListTenantEncryptedRepositoriesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTenantEncryptedRepositoriesRequest input)
        {

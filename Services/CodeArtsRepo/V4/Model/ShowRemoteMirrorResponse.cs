...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRemoteMirrorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRemoteMirrorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRemoteMirrorResponse input)
        {

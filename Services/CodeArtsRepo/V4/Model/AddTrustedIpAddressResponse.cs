...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddTrustedIpAddressResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AddTrustedIpAddressResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddTrustedIpAddressResponse input)
        {

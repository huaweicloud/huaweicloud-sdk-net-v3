...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UnlockRepositoryResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UnlockRepositoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UnlockRepositoryResponse input)
        {

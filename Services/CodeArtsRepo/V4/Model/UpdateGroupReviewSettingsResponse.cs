...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGroupReviewSettingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateGroupReviewSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGroupReviewSettingsResponse input)
        {

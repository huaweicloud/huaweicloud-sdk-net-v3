...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class RepositoryInheritSettingDto 
    {
        ...
        /// </summary>
        /// <value>**参数解释：** 继承设置。 **取值范围：** - inherit，继承上级配置。 - custom，使用当前仓库配置。 - force_inherit，强制继承上级配置。</value>
        ...
        {
            return this.Equals(input as RepositoryInheritSettingDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RepositoryInheritSettingDto input)
        {

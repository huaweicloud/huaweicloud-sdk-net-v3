...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class ShowDiffCommitRequest 
    {
        ...
        /// </summary>
        [SDKProperty("not_statistic", IsQuery = true)]
        [JsonProperty("not_statistic", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  notStatistic: ").Append(NotStatistic).Append("\n");
        ...
        {
            return this.Equals(input as ShowDiffCommitRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDiffCommitRequest input)
        {
            ...
            if (this.NotStatistic != input.NotStatistic || (this.NotStatistic != null && !this.NotStatistic.Equals(input.NotStatistic))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NotStatistic != null) hashCode = hashCode * 59 + this.NotStatistic.GetHashCode();

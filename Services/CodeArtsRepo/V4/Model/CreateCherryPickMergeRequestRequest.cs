...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class CreateCherryPickMergeRequestRequest 
    {
        ...
        public MrCherryRevertDto Body { get; set; }
        ...
        {
            return this.Equals(input as CreateCherryPickMergeRequestRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCherryPickMergeRequestRequest input)
        {

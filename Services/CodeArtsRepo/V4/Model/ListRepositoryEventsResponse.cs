...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryEventsResponse : SdkResponse
    {
        ...
        public List<RepositoryPushEventDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryEventsResponse input)
        {

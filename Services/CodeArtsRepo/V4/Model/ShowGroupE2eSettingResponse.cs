...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupE2eSettingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGroupE2eSettingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupE2eSettingResponse input)
        {

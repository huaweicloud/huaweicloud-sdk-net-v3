...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTreesResponse : SdkResponse
    {
        ...
        public List<TreeObjectDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListTreesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTreesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupWebhookLogResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGroupWebhookLogResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupWebhookLogResponse input)
        {

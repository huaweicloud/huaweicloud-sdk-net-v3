...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGroupGeneralPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGroupGeneralPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGroupGeneralPolicyResponse input)
        {

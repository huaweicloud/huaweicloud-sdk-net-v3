...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteProtectedBranchResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeleteProtectedBranchResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteProtectedBranchResponse input)
        {

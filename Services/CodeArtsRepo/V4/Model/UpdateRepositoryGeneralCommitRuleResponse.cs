...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRepositoryGeneralCommitRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRepositoryGeneralCommitRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRepositoryGeneralCommitRuleResponse input)
        {

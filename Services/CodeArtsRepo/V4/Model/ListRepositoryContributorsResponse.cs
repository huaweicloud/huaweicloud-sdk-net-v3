...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryContributorsResponse : SdkResponse
    {
        ...
        public List<ContributorDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryContributorsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryContributorsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectsGeneralPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProjectsGeneralPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectsGeneralPolicyResponse input)
        {

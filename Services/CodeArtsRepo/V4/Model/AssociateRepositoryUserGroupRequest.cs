...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class AssociateRepositoryUserGroupRequest 
    {
        ...
        /// </summary>
        [SDKProperty("user_group_id", IsPath = true)]
        ...
        {
            return this.Equals(input as AssociateRepositoryUserGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateRepositoryUserGroupRequest input)
        {

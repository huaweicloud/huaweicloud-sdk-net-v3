...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectMergeRequestsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProjectMergeRequestsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectMergeRequestsResponse input)
        {

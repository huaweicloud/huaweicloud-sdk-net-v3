...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class ProtectedBranchBodyApiDto 
    {
        ...
        public List<ProtectedActionBasicApiDto> Actions { get; set; }
        ...
        {
            return this.Equals(input as ProtectedBranchBodyApiDto);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ProtectedBranchBodyApiDto input)
        {

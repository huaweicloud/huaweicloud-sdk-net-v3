...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class CreateProjectProtectedTagsRequest 
    {
        ...
        public ProjectProtectedTagDto Body { get; set; }
        ...
        {
            return this.Equals(input as CreateProjectProtectedTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProjectProtectedTagsRequest input)
        {

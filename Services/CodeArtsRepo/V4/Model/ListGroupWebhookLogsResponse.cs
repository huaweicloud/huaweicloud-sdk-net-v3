...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGroupWebhookLogsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListGroupWebhookLogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGroupWebhookLogsResponse input)
        {

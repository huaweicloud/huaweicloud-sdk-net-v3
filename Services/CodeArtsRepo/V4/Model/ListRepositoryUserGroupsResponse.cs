...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryUserGroupsResponse : SdkResponse
    {
        ...
        public List<RepositoryUserGroupDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryUserGroupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryUserGroupsResponse input)
        {

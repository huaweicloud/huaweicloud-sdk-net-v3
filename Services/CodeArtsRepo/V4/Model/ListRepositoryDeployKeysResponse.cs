...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRepositoryDeployKeysResponse : SdkResponse
    {
        ...
        public List<DeployKeyDto> Body { get; set; }
        ...
        {
            return this.Equals(input as ListRepositoryDeployKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRepositoryDeployKeysResponse input)
        {

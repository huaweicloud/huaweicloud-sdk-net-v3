...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class BatchValidateUserGroupPermissionsRequest 
    {
        ...
        public List<GroupPermissionsDto> Body { get; set; }
        ...
        {
            return this.Equals(input as BatchValidateUserGroupPermissionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchValidateUserGroupPermissionsRequest input)
        {

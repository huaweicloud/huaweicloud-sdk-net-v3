...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectProtectedRefsUserGroupsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListProjectProtectedRefsUserGroupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectProtectedRefsUserGroupsResponse input)
        {

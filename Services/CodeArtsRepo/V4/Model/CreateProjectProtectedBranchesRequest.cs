...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    public class CreateProjectProtectedBranchesRequest 
    {
        ...
        public ProtectedBranchBodyApiDto Body { get; set; }
        ...
        {
            return this.Equals(input as CreateProjectProtectedBranchesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProjectProtectedBranchesRequest input)
        {

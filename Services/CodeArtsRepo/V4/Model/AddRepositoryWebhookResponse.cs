...
namespace HuaweiCloud.SDK.CodeArtsRepo.V4.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddRepositoryWebhookResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddRepositoryWebhookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddRepositoryWebhookResponse input)
        {

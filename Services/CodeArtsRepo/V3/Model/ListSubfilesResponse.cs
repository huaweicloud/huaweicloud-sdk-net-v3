...
namespace HuaweiCloud.SDK.CodeArtsRepo.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubfilesResponse : SdkResponse
    {
        ...
        public LogsTreeList Result { get; set; }
        ...
        {
            return this.Equals(input as ListSubfilesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubfilesResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsRepo.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddSshKeyResponse : SdkResponse
    {
        ...
        public PublicKey Result { get; set; }
        ...
        {
            return this.Equals(input as AddSshKeyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddSshKeyResponse input)
        {

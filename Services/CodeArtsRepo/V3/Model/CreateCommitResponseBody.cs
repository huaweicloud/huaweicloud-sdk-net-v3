...
namespace HuaweiCloud.SDK.CodeArtsRepo.V3.Model
{
    ...
    public class CreateCommitResponseBody 
    {
        ...
        public CreateCommitResponseBodyStats Stats { get; set; }
        ...
        {
            return this.Equals(input as CreateCommitResponseBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCommitResponseBody input)
        {

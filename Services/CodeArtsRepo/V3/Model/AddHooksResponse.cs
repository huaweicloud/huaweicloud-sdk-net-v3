...
namespace HuaweiCloud.SDK.CodeArtsRepo.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddHooksResponse : SdkResponse
    {
        ...
        public RepoHook Result { get; set; }
        ...
        {
            return this.Equals(input as AddHooksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddHooksResponse input)
        {

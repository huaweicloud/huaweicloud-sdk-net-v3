...
namespace HuaweiCloud.SDK.Dcs.V2
{
    public class DcsRegion
    {
        ...
        public static readonly Region LA_SOUTH_2 = new Region("la-south-2", "https://dcs.la-south-2.myhuaweicloud.com");
        public static readonly Region CN_NORTH_9 = new Region("cn-north-9", "https://dcs.cn-north-9.myhuaweicloud.com");
        public static readonly Region NA_MEXICO_1 = new Region("na-mexico-1", "https://dcs.na-mexico-1.myhuaweicloud.com");

...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    public class ListOfflineKeyAnalysisTaskRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 离线分析的任务状态。 **约束限制**： 不涉及。 **取值范围**： waiting：任务等待中。 running：任务进行中。 success：任务执行成功。 failed：任务执行失败。 **默认取值**： 不涉及。 </value>
        ...
        {
            return this.Equals(input as ListOfflineKeyAnalysisTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOfflineKeyAnalysisTaskRequest input)
        {

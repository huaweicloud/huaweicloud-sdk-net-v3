...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutoExpireScanTaskResponse : SdkResponse
    {
        /// <summary>
        /// 扫描任务状态
        /// </summary>
        ...
        {
            return this.Equals(input as CreateAutoExpireScanTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutoExpireScanTaskResponse input)
        {

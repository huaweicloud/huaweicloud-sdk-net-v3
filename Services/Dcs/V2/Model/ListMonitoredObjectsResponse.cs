...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMonitoredObjectsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListMonitoredObjectsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMonitoredObjectsResponse input)
        {
            if (input == null)
                return false;

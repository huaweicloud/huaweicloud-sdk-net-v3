...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAclAccountPassWordResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateAclAccountPassWordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAclAccountPassWordResponse input)
        {

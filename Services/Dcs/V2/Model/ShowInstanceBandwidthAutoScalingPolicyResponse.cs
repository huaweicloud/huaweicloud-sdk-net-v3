...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceBandwidthAutoScalingPolicyResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowInstanceBandwidthAutoScalingPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceBandwidthAutoScalingPolicyResponse input)
        {

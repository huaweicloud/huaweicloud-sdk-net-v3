...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteMigrationTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteMigrationTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteMigrationTaskResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    public class LargestKey 
    {
        ...
        /// </summary>
        [JsonProperty("num_of_elem", NullValueHandling = NullValueHandling.Ignore)]
        public int? NumOfElem { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  numOfElem: ").Append(NumOfElem).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LargestKey);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(LargestKey input)
        {
            if (input == null) return false;
            if (this.Key != input.Key || (this.Key != null && !this.Key.Equals(input.Key))) return false;
            if (this.Type != input.Type) return false;
            if (this.Bytes != input.Bytes || (this.Bytes != null && !this.Bytes.Equals(input.Bytes))) return false;
            if (this.NumOfElem != input.NumOfElem || (this.NumOfElem != null && !this.NumOfElem.Equals(input.NumOfElem))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NumOfElem != null) hashCode = hashCode * 59 + this.NumOfElem.GetHashCode();
                return hashCode;
            }
        }
    }

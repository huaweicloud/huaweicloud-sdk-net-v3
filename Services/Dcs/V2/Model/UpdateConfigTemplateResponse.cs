...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateConfigTemplateResponse : SdkResponse
    {
        /// <summary>
        /// 修改自定义模板的结果，success表示成功，如果失败则会返回对应的报错信息
        /// </summary>
        /// <value>修改自定义模板的结果，success表示成功，如果失败则会返回对应的报错信息</value>
        ...
        {
            return this.Equals(input as UpdateConfigTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateConfigTemplateResponse input)
        {

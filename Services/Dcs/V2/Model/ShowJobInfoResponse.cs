...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowJobInfoResponse : SdkResponse
    {
        /// <summary>
        /// Job类型，取值范围：   masterStandbySwapJob：主备倒换任务   modifyClientIpTransJob：修改源ip透传 
        /// </summary>
        /// <value>Job类型，取值范围：   masterStandbySwapJob：主备倒换任务   modifyClientIpTransJob：修改源ip透传 </value>
        ...
        public class JobTypeEnum
        {
            ...
            /// </summary>
            public static readonly JobTypeEnum MASTERSTANDBYSWAPJOB = new JobTypeEnum("masterStandbySwapJob");

            /// <summary>
            /// Enum MODIFYCLIENTIPTRANSJOB for value: modifyClientIpTransJob
            /// </summary>
            public static readonly JobTypeEnum MODIFYCLIENTIPTRANSJOB = new JobTypeEnum("modifyClientIpTransJob");
        ...
        {
            return this.Equals(input as ShowJobInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowJobInfoResponse input)
        {

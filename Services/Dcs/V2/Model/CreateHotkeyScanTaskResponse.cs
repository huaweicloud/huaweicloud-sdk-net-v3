...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateHotkeyScanTaskResponse : SdkResponse
    {
        /// <summary>
        /// 分析任务状态
        /// </summary>
        ...
        {
            return this.Equals(input as CreateHotkeyScanTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateHotkeyScanTaskResponse input)
        {
            if (input == null)
                return false;

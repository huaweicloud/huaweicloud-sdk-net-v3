...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    public class BatchDeleteInstancesRequest 
    {
        ...
        public bool Equals(BatchDeleteInstancesRequest input)
        {
            ...
            if (this.AllFailure != input.AllFailure || (this.AllFailure != null && !this.AllFailure.Equals(input.AllFailure))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.AllFailure != null) hashCode = hashCode * 59 + this.AllFailure.GetHashCode();

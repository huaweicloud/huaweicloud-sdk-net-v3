...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetOnlineMigrationTaskResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SetOnlineMigrationTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetOnlineMigrationTaskResponse input)
        {

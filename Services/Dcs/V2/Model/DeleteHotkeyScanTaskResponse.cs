...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteHotkeyScanTaskResponse : SdkResponse
    {
        /// <summary>
        /// 分析任务状态
        /// </summary>
        ...
        {
            return this.Equals(input as DeleteHotkeyScanTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteHotkeyScanTaskResponse input)
        {

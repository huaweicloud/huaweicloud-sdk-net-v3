...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    public class ListSlowlogRequest 
    {
        ...
        public class SortKeyEnum
        {
            ...
            /// </summary>
            public static readonly SortKeyEnum DURATION = new SortKeyEnum("duration");
        ...
        {
            return this.Equals(input as ListSlowlogRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSlowlogRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowBigkeyScanTaskDetailsResponse : SdkResponse
    {
        /// <summary>
        /// 分析任务状态
        /// </summary>
        ...
        public List<BigkeysBody> Keys { get; set; }
        ...
        {
            return this.Equals(input as ShowBigkeyScanTaskDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBigkeyScanTaskDetailsResponse input)
        {
            if (input == null)
                return false;

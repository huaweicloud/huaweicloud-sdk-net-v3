...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateBigkeyAutoscanConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateBigkeyAutoscanConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateBigkeyAutoscanConfigResponse input)
        {
            if (input == null)
                return false;

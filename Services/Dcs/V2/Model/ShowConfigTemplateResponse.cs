...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowConfigTemplateResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowConfigTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowConfigTemplateResponse input)
        {

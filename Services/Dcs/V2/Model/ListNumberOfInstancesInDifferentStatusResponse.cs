...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListNumberOfInstancesInDifferentStatusResponse : SdkResponse
    {

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("redis", NullValueHandling = NullValueHandling.Ignore)]
        public StatusStatistic Redis { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("memcached", NullValueHandling = NullValueHandling.Ignore)]
        public StatusStatistic Memcached { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  memcached: ").Append(Memcached).Append("\n");
        ...
        {
            return this.Equals(input as ListNumberOfInstancesInDifferentStatusResponse);
        }

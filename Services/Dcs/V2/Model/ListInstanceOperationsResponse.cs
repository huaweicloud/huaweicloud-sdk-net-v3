...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceOperationsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceOperationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceOperationsResponse input)
        {

...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    public class UpdateInstanceBandwidthAutoScalingPolicyRequestBody 
    {
        ...
        {
            return this.Equals(input as UpdateInstanceBandwidthAutoScalingPolicyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceBandwidthAutoScalingPolicyRequestBody input)
        {

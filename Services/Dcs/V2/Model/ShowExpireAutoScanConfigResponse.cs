...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowExpireAutoScanConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowExpireAutoScanConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowExpireAutoScanConfigResponse input)
        {
            if (input == null)
                return false;

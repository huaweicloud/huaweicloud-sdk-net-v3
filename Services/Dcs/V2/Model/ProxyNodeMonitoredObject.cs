...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    public class ProxyNodeMonitoredObject 
    {
        ...
        public bool Equals(ProxyNodeMonitoredObject input)
        {
            ...
            if (this.DcsClusterProxyNode != input.DcsClusterProxyNode || (this.DcsClusterProxyNode != null && !this.DcsClusterProxyNode.Equals(input.DcsClusterProxyNode))) return false;

...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowBigkeyAutoscanConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowBigkeyAutoscanConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBigkeyAutoscanConfigResponse input)
        {

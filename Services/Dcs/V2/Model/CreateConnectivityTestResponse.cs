...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateConnectivityTestResponse : SdkResponse
    {
        /// <summary>
        /// 创建备份导入页面实例连接测试结果
        /// </summary>
        /// <value>创建备份导入页面实例连接测试结果</value>
        ...
        {
            return this.Equals(input as CreateConnectivityTestResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateConnectivityTestResponse input)
        {
            if (input == null)
                return false;

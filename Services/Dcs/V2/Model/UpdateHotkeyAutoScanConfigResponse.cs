...
namespace HuaweiCloud.SDK.Dcs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateHotkeyAutoScanConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateHotkeyAutoScanConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHotkeyAutoScanConfigResponse input)
        {
            if (input == null)
                return false;

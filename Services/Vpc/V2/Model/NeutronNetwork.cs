    ...
    public class NeutronNetwork 
    {
        ...
        public bool Equals(NeutronNetwork input)
        {
            ...
            return 
                ...
                (
                    this.AvailabilityZoneHints == input.AvailabilityZoneHints ||
                    this.AvailabilityZoneHints != null &&
                    input.AvailabilityZoneHints != null &&
                    this.AvailabilityZoneHints.SequenceEqual(input.AvailabilityZoneHints)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AvailabilityZoneHints != null)
                    hashCode = hashCode * 59 + this.AvailabilityZoneHints.GetHashCode();

...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronUpdateNetworkRequestBody 
    {
        ...
        public NeutronUpdateNetworkOption Network { get; set; }
        ...
        {
            return this.Equals(input as NeutronUpdateNetworkRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateNetworkRequestBody input)
        {

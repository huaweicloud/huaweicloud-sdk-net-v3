...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class ListSecurityGroupsByTagsRequestBody 
    {
        ...
        /// </summary>
        /// <value>功能说明：操作标识 取值范围：filter(过滤)，count(查询总条数)</value>
        ...
        {
            return this.Equals(input as ListSecurityGroupsByTagsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSecurityGroupsByTagsRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronShowRouterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronShowRouterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronShowRouterResponse input)
        {

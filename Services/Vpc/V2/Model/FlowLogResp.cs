...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class FlowLogResp 
    {
        ...
        /// </summary>
        /// <value>功能说明：流日志所属资源类型 取值范围：支持Port、Network、VPC 类型。 约束：当resource_type为Port时，Port资源必须是C3、S3、M3三种虚拟机的网卡。</value>
        ...
        /// </summary>
        /// <value>功能说明：流日志状态 取值范围：ACTIVE、DOWN、ERROR</value>
        ...
        {
            return this.Equals(input as FlowLogResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(FlowLogResp input)
        {

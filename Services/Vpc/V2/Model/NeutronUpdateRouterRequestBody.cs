...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronUpdateRouterRequestBody 
    {
        ...
        public NeutronUpdateRouterOption Router { get; set; }
        ...
        {
            return this.Equals(input as NeutronUpdateRouterRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateRouterRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronUpdateSubnetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronUpdateSubnetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateSubnetResponse input)
        {

...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronUpdateSubnetRequestBody 
    {
        ...
        public NeutronUpdateSubnetOption Subnet { get; set; }
        ...
        {
            return this.Equals(input as NeutronUpdateSubnetRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateSubnetRequestBody input)
        {

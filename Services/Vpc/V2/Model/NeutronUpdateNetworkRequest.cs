...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronUpdateNetworkRequest 
    {
        ...
        public NeutronUpdateNetworkRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as NeutronUpdateNetworkRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateNetworkRequest input)
        {

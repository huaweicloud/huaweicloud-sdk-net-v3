...
namespace HuaweiCloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronUpdateRouterRequest 
    {
        ...
        public NeutronUpdateRouterRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as NeutronUpdateRouterRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateRouterRequest input)
        {

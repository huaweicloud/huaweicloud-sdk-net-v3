...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchCreateFirewallTagsRequest 
    {
        ...
        public BatchCreateFirewallTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateFirewallTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateFirewallTagsRequest input)
        {
            if (input == null)
                return false;

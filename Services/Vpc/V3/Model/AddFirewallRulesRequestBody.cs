...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class AddFirewallRulesRequestBody 
    {
        ...
        public FirewallInsertRuleOption Firewall { get; set; }
        ...
        {
            return this.Equals(input as AddFirewallRulesRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddFirewallRulesRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class ListTrafficMirrorFiltersResponse : SdkResponse
    {
        ...
        public bool Equals(ListTrafficMirrorFiltersResponse input)
        {
            ...
            return 
                (
                    this.TrafficMirrorFilters == input.TrafficMirrorFilters ||
                    this.TrafficMirrorFilters != null &&
                    input.TrafficMirrorFilters != null &&
                    this.TrafficMirrorFilters.SequenceEqual(input.TrafficMirrorFilters)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TrafficMirrorFilters != null)
                    hashCode = hashCode * 59 + this.TrafficMirrorFilters.GetHashCode();

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchDeletePortTagsRequest 
    {
        ...
        public BatchDeletePortTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeletePortTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeletePortTagsRequest input)
        {
            if (input == null)
                return false;

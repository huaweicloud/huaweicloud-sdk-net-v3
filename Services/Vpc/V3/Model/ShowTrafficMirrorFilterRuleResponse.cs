...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTrafficMirrorFilterRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTrafficMirrorFilterRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTrafficMirrorFilterRuleResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchCreateSubNetworkInterfaceV3Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchCreateSubNetworkInterfaceV3Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateSubNetworkInterfaceV3Response input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchDeleteRequestBody 
    {
        ...
        public List<BatchDeleteRequestBodyTags> Tags { get; set; }

        /// <summary>
        /// 系统标签
        /// </summary>
        [JsonProperty("sys_tags", NullValueHandling = NullValueHandling.Ignore)]
        public List<BatchDeleteRequestBodySysTags> SysTags { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteRequestBody input)
        {

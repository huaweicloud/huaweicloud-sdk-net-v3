...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class ListSubNetworkInterfacesByTagsRequest 
    {
        ...
        public ListSubNetworkInterfacesByTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListSubNetworkInterfacesByTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubNetworkInterfacesByTagsRequest input)
        {

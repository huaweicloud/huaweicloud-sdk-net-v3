...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTrafficMirrorSessionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTrafficMirrorSessionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrafficMirrorSessionResponse input)
        {
            if (input == null)
                return false;

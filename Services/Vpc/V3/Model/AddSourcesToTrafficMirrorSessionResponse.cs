...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddSourcesToTrafficMirrorSessionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddSourcesToTrafficMirrorSessionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddSourcesToTrafficMirrorSessionResponse input)
        {

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class UpdateTrafficMirrorSessionRequestBody 
    {
        ...
        public UpdateTrafficMirrorSessionOption TrafficMirrorSession { get; set; }
        ...
        {
            return this.Equals(input as UpdateTrafficMirrorSessionRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTrafficMirrorSessionRequestBody input)
        {

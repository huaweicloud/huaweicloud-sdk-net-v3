...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchCreateSubNetworkInterfaceTagsRequest 
    {
        ...
        public BatchCreateSubNetworkInterfaceTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateSubNetworkInterfaceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateSubNetworkInterfaceTagsRequest input)
        {

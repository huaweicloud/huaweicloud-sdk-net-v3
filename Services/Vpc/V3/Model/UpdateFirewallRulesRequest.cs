...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class UpdateFirewallRulesRequest 
    {
        ...
        public UpdateFirewallRulesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateFirewallRulesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateFirewallRulesRequest input)
        {

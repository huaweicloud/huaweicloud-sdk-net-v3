...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchDeleteSubNetworkInterfaceTagsRequest 
    {
        ...
        public BatchDeleteSubNetworkInterfaceTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteSubNetworkInterfaceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteSubNetworkInterfaceTagsRequest input)
        {

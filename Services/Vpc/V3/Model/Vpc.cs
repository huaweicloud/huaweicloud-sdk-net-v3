...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class Vpc 
    {
        ...
        public bool Equals(Vpc input)
        {
            ...
            if (this.ExtendCidrs != input.ExtendCidrs || (this.ExtendCidrs != null && input.ExtendCidrs != null && !this.ExtendCidrs.SequenceEqual(input.ExtendCidrs))) return false;
            if (this.Status != input.Status || (this.Status != null && !this.Status.Equals(input.Status))) return false;
            if (this.ProjectId != input.ProjectId || (this.ProjectId != null && !this.ProjectId.Equals(input.ProjectId))) return false;
            if (this.EnterpriseProjectId != input.EnterpriseProjectId || (this.EnterpriseProjectId != null && !this.EnterpriseProjectId.Equals(input.EnterpriseProjectId))) return false;
            if (this.CreatedAt != input.CreatedAt || (this.CreatedAt != null && !this.CreatedAt.Equals(input.CreatedAt))) return false;
            if (this.UpdatedAt != input.UpdatedAt || (this.UpdatedAt != null && !this.UpdatedAt.Equals(input.UpdatedAt))) return false;
            if (this.CloudResources != input.CloudResources || (this.CloudResources != null && input.CloudResources != null && !this.CloudResources.SequenceEqual(input.CloudResources))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExtendCidrs != null) hashCode = hashCode * 59 + this.ExtendCidrs.GetHashCode();
                if (this.Status != null) hashCode = hashCode * 59 + this.Status.GetHashCode();
                if (this.ProjectId != null) hashCode = hashCode * 59 + this.ProjectId.GetHashCode();
                if (this.EnterpriseProjectId != null) hashCode = hashCode * 59 + this.EnterpriseProjectId.GetHashCode();
                if (this.CreatedAt != null) hashCode = hashCode * 59 + this.CreatedAt.GetHashCode();
                if (this.UpdatedAt != null) hashCode = hashCode * 59 + this.UpdatedAt.GetHashCode();
                if (this.CloudResources != null) hashCode = hashCode * 59 + this.CloudResources.GetHashCode();

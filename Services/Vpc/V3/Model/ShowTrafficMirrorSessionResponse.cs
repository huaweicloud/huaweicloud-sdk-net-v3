...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTrafficMirrorSessionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTrafficMirrorSessionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTrafficMirrorSessionResponse input)
        {

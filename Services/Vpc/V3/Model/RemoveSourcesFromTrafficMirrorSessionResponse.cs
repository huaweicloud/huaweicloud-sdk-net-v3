...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RemoveSourcesFromTrafficMirrorSessionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RemoveSourcesFromTrafficMirrorSessionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveSourcesFromTrafficMirrorSessionResponse input)
        {
            if (input == null)
                return false;

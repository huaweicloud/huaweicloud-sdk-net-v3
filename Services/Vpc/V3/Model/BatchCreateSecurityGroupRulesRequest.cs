...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchCreateSecurityGroupRulesRequest 
    {
        ...
        public BatchCreateSecurityGroupRulesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateSecurityGroupRulesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateSecurityGroupRulesRequest input)
        {

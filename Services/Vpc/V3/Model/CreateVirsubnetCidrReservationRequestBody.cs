...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class CreateVirsubnetCidrReservationRequestBody 
    {
        ...
        public CreateVirsubnetCidrReservationOption VirsubnetCidrReservation { get; set; }
        ...
        {
            return this.Equals(input as CreateVirsubnetCidrReservationRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVirsubnetCidrReservationRequestBody input)
        {

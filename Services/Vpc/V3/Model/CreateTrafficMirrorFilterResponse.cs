...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTrafficMirrorFilterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTrafficMirrorFilterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTrafficMirrorFilterResponse input)
        {

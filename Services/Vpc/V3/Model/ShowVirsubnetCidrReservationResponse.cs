...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVirsubnetCidrReservationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowVirsubnetCidrReservationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVirsubnetCidrReservationResponse input)
        {

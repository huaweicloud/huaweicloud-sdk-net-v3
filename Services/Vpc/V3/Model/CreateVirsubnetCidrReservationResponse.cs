...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateVirsubnetCidrReservationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateVirsubnetCidrReservationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVirsubnetCidrReservationResponse input)
        {

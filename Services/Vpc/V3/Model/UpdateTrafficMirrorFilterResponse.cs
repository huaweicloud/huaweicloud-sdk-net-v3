...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTrafficMirrorFilterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateTrafficMirrorFilterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTrafficMirrorFilterResponse input)
        {

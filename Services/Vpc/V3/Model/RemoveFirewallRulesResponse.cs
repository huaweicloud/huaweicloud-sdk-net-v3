...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RemoveFirewallRulesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RemoveFirewallRulesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveFirewallRulesResponse input)
        {
            if (input == null)
                return false;

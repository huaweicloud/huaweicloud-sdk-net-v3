...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class UpdateVirsubnetCidrReservationRequestBody 
    {
        ...
        public UpdateVirsubnetCidrReservationOption VirsubnetCidrReservation { get; set; }
        ...
        {
            return this.Equals(input as UpdateVirsubnetCidrReservationRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateVirsubnetCidrReservationRequestBody input)
        {

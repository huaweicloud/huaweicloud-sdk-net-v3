...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class AttachSubNetworkInterfaceRequestBody 
    {
        ...
        public AttachSubNetworkInterfaceOption SubNetworkInterface { get; set; }
        ...
        {
            return this.Equals(input as AttachSubNetworkInterfaceRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachSubNetworkInterfaceRequestBody input)
        {

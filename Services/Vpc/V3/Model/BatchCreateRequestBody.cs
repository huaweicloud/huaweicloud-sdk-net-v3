...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchCreateRequestBody 
    {
        ...
        public List<BatchCreateRequestBodyTags> Tags { get; set; }

        /// <summary>
        /// 系统标签
        /// </summary>
        [JsonProperty("sys_tags", NullValueHandling = NullValueHandling.Ignore)]
        public List<BatchCreateRequestBodySysTags> SysTags { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class BatchCreatePortTagsRequest 
    {
        ...
        public BatchCreatePortTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreatePortTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreatePortTagsRequest input)
        {
            if (input == null)
                return false;

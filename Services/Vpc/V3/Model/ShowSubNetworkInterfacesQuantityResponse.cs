...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class ShowSubNetworkInterfacesQuantityResponse : SdkResponse
    {
        ...
        public bool Equals(ShowSubNetworkInterfacesQuantityResponse input)
        {
            ...
            if (this.SubNetworkInterfaces != input.SubNetworkInterfaces || (this.SubNetworkInterfaces != null && !this.SubNetworkInterfaces.Equals(input.SubNetworkInterfaces))) return false;

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class UpdateClouddcnSubnetRequestBody 
    {
        ...
        public UpdateClouddcnSubnetOption ClouddcnSubnet { get; set; }
        ...
        {
            return this.Equals(input as UpdateClouddcnSubnetRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClouddcnSubnetRequestBody input)
        {

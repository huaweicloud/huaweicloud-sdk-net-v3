...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class RemoveSourcesFromTrafficMirrorSessionRequestBody 
    {
        ...
        public TrafficMirrorSourcesOption TrafficMirrorSession { get; set; }
        ...
        {
            return this.Equals(input as RemoveSourcesFromTrafficMirrorSessionRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveSourcesFromTrafficMirrorSessionRequestBody input)
        {

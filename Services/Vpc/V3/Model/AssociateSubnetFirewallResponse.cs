...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateSubnetFirewallResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AssociateSubnetFirewallResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateSubnetFirewallResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AttachSubNetworkInterfaceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AttachSubNetworkInterfaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachSubNetworkInterfaceResponse input)
        {

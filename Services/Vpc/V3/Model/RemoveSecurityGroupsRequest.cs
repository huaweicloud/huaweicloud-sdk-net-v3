...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class RemoveSecurityGroupsRequest 
    {
        ...
        public RemoveSecurityGroupsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RemoveSecurityGroupsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveSecurityGroupsRequest input)
        {

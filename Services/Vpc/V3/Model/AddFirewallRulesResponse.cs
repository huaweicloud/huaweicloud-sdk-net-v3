...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddFirewallRulesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddFirewallRulesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddFirewallRulesResponse input)
        {
            if (input == null)
                return false;

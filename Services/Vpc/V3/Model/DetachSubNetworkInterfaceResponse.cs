...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetachSubNetworkInterfaceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetachSubNetworkInterfaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetachSubNetworkInterfaceResponse input)
        {

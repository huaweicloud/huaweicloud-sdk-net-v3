...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisassociateSubnetFirewallResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DisassociateSubnetFirewallResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateSubnetFirewallResponse input)
        {

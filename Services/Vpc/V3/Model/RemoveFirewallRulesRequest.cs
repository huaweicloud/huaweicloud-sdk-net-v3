...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class RemoveFirewallRulesRequest 
    {
        ...
        public RemoveFirewallRulesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RemoveFirewallRulesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveFirewallRulesRequest input)
        {

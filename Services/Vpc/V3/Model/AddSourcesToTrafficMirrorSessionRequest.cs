...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class AddSourcesToTrafficMirrorSessionRequest 
    {
        ...
        public AddSourcesToTrafficMirrorSessionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddSourcesToTrafficMirrorSessionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddSourcesToTrafficMirrorSessionRequest input)
        {

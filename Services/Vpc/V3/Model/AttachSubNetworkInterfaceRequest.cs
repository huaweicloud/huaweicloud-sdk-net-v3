...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class AttachSubNetworkInterfaceRequest 
    {
        ...
        public AttachSubNetworkInterfaceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AttachSubNetworkInterfaceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachSubNetworkInterfaceRequest input)
        {

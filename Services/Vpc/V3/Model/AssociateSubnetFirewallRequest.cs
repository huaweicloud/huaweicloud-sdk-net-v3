...
namespace HuaweiCloud.SDK.Vpc.V3.Model
{
    ...
    public class AssociateSubnetFirewallRequest 
    {
        ...
        public AssociateSubnetFirewallRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AssociateSubnetFirewallRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateSubnetFirewallRequest input)
        {
            if (input == null)
                return false;

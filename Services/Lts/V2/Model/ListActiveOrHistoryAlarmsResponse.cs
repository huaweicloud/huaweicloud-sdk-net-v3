...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListActiveOrHistoryAlarmsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListActiveOrHistoryAlarmsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListActiveOrHistoryAlarmsResponse input)
        {

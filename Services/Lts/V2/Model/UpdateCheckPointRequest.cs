...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class UpdateCheckPointRequest 
    {
        ...
        public List<ConsumerShardCheckpointInfo> Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateCheckPointRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCheckPointRequest input)
        {

...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class AccessConfigFormatMutilCreate 
    {
        ...
        /// </summary>
        /// <value>单行日志。time：日志时间，regular：正则模式。</value>
        ...
        public class ModeEnum
        {
            ...
            /// </summary>
            public static readonly ModeEnum TIME = new ModeEnum("time");

            /// <summary>
            /// Enum REGULAR for value: regular
            /// </summary>
            public static readonly ModeEnum REGULAR = new ModeEnum("regular");
        ...
        {
            return this.Equals(input as AccessConfigFormatMutilCreate);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AccessConfigFormatMutilCreate input)
        {

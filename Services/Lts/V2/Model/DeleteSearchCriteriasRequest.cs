...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class DeleteSearchCriteriasRequest 
    {
        ...
        public DeleteSearchCriterias Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteSearchCriteriasRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteSearchCriteriasRequest input)
        {
            if (input == null)
                return false;

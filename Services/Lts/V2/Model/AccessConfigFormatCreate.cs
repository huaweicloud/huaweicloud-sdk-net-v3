...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class AccessConfigFormatCreate 
    {
        ...
        public AccessConfigFormatSingleCreate Single { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("multi", NullValueHandling = NullValueHandling.Ignore)]
        public AccessConfigFormatMutilCreate Multi { get; set; }
        ...
        {
            return this.Equals(input as AccessConfigFormatCreate);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AccessConfigFormatCreate input)
        {

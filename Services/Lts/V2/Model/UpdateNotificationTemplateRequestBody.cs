...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class UpdateNotificationTemplateRequestBody 
    {
        ...
        public List<UpdateSubTemplate> Templates { get; set; }
        ...
        {
            return this.Equals(input as UpdateNotificationTemplateRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNotificationTemplateRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowLogStreamShardsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowLogStreamShardsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowLogStreamShardsResponse input)
        {

...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListLogStreamIndexResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListLogStreamIndexResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLogStreamIndexResponse input)
        {

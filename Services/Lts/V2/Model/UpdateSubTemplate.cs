...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class UpdateSubTemplate 
    {
        ...
        /// </summary>
        /// <value>模板子类型，只支持以下类型：sms，dingding（钉钉），wechat（微信），webhook，email</value>
        ...
        public class SubTypeEnum
        {
            ...
            /// </summary>
            public static readonly SubTypeEnum VOICE = new SubTypeEnum("voice");
        ...
        {
            return this.Equals(input as UpdateSubTemplate);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSubTemplate input)
        {

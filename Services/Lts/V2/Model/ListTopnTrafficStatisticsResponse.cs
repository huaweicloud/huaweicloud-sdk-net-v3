...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTopnTrafficStatisticsResponse : SdkResponse
    {
        ...
        public List<ResultsTopnBody> Results { get; set; }
        ...
        {
            return this.Equals(input as ListTopnTrafficStatisticsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTopnTrafficStatisticsResponse input)
        {

...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class ListStructuredLogsWithTimeRangeRequest 
    {
        ...
        public QueryLtsStructLogParamsNew Body { get; set; }
        ...
        {
            return this.Equals(input as ListStructuredLogsWithTimeRangeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListStructuredLogsWithTimeRangeRequest input)
        {

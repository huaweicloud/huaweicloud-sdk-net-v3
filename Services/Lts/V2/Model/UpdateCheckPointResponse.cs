...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCheckPointResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCheckPointResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCheckPointResponse input)
        {

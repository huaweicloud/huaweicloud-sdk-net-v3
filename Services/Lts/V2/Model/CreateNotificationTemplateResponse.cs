...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateNotificationTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateNotificationTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateNotificationTemplateResponse input)
        {

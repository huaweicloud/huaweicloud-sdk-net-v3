...
namespace HuaweiCloud.SDK.Lts.V2.Model
{
    ...
    public class DeleteNotificationTemplateRequest 
    {
        ...
        public DeleteNotificationTemplateBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteNotificationTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteNotificationTemplateRequest input)
        {
            if (input == null)
                return false;

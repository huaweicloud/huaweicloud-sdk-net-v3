...
namespace HuaweiCloud.SDK.AntiDDoS.V1.Model
{
    ...
    public class UpdateAntiDDosServiceRequestBody 
    {
        ...
        public class AppTypeIdEnum
        {
            ...
            private static readonly Dictionary<int?, AppTypeIdEnum> StaticFields =
            new Dictionary<int?, AppTypeIdEnum>()
            {
                { 0, NUMBER_0 },
                { 1, NUMBER_1 },
            };
            ...
            public AppTypeIdEnum(int? value)
            {
                _value = value;
            }

            public static AppTypeIdEnum FromValue(int? value)
            {
                if(value == null){
                    return null;
                }
        ...
        public int? CleaningAccessPosId { get; set; }
        ...
        public int? HttpRequestPosId { get; set; }
        ...
        public int? TrafficPosId { get; set; }
        ...
        {
            return this.Equals(input as UpdateAntiDDosServiceRequestBody);
        }

...
namespace HuaweiCloud.SDK.AntiDDoS.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDefaultConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDefaultConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDefaultConfigResponse input)
        {
            if (input == null)
                return false;

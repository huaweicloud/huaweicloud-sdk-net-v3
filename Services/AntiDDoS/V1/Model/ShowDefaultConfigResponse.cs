...
namespace HuaweiCloud.SDK.AntiDDoS.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDefaultConfigResponse : SdkResponse
    {
        /// <summary>
        /// 应用类型ID，固定值为0
        /// </summary>
        ...
        {
            return this.Equals(input as ShowDefaultConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDefaultConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyConfigurationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyConfigurationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyConfigurationResponse input)
        {

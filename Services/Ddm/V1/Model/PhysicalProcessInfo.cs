...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    public class PhysicalProcessInfo 
    {
        ...
        /// 事务持续时间，单位秒
        /// </summary>
        [JsonProperty("trx_executed_time", NullValueHandling = NullValueHandling.Ignore)]
        public long? TrxExecutedTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  trxExecutedTime: ").Append(TrxExecutedTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PhysicalProcessInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PhysicalProcessInfo input)
        {
            ...
            if (this.TrxExecutedTime != input.TrxExecutedTime || (this.TrxExecutedTime != null && !this.TrxExecutedTime.Equals(input.TrxExecutedTime))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TrxExecutedTime != null) hashCode = hashCode * 59 + this.TrxExecutedTime.GetHashCode();
                return hashCode;
            }
        }
    }

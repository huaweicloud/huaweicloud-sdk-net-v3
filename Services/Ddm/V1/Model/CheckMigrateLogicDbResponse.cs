...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CheckMigrateLogicDbResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CheckMigrateLogicDbResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckMigrateLogicDbResponse input)
        {

...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAvailableRdsForMigrateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAvailableRdsForMigrateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAvailableRdsForMigrateResponse input)
        {

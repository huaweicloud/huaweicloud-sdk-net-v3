...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ExpandInstanceNodesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ExpandInstanceNodesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExpandInstanceNodesResponse input)
        {

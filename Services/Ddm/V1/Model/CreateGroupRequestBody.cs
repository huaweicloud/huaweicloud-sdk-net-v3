...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    public class CreateGroupRequestBody 
    {
        ...
        public class TypeEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum RW = new TypeEnum("rw");

            /// <summary>
            /// Enum R for value: r
            /// </summary>
            public static readonly TypeEnum R = new TypeEnum("r");
        ...
        {
            return this.Equals(input as CreateGroupRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGroupRequestBody input)
        {

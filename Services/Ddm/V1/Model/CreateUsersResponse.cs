...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateUsersResponse : SdkResponse
    {
        ...
        public List<CreateUsersDetailResponses> Users { get; set; }
        ...
        {
            return this.Equals(input as CreateUsersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateUsersResponse input)
        {

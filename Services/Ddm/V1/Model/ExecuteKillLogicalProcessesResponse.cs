...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ExecuteKillLogicalProcessesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ExecuteKillLogicalProcessesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteKillLogicalProcessesResponse input)
        {

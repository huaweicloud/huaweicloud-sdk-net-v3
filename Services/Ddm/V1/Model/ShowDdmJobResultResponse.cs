...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDdmJobResultResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDdmJobResultResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDdmJobResultResponse input)
        {

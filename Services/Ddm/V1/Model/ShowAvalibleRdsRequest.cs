...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    public class ShowAvalibleRdsRequest 
    {
        ...
        /// 源DN实例 ID。
        /// </summary>
        [SDKProperty("source_dn_instance_id", IsQuery = true)]
        [JsonProperty("source_dn_instance_id", NullValueHandling = NullValueHandling.Ignore)]
        public string SourceDnInstanceId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  sourceDnInstanceId: ").Append(SourceDnInstanceId).Append("\n");
        ...
        {
            return this.Equals(input as ShowAvalibleRdsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAvalibleRdsRequest input)
        {
            ...
            if (this.SourceDnInstanceId != input.SourceDnInstanceId || (this.SourceDnInstanceId != null && !this.SourceDnInstanceId.Equals(input.SourceDnInstanceId))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SourceDnInstanceId != null) hashCode = hashCode * 59 + this.SourceDnInstanceId.GetHashCode();

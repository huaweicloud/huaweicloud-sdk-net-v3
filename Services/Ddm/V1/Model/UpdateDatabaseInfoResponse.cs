...
namespace HuaweiCloud.SDK.Ddm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDatabaseInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDatabaseInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDatabaseInfoResponse input)
        {

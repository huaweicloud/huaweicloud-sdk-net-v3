...
namespace HuaweiCloud.SDK.Ddm.V1
{
    public partial class DdmAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchDeleteNodesResponse> BatchDeleteNodesAsync(BatchDeleteNodesRequest batchDeleteNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<BatchDeleteNodesResponse> BatchDeleteNodesAsyncInvoker(BatchDeleteNodesRequest batchDeleteNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchDeleteNodesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchDeleteNodesRequest);
            return new AsyncInvoker<BatchDeleteNodesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchDeleteNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BindEipResponse> BindEipAsync(BindEipRequest bindEipRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<BindEipResponse> BindEipAsyncInvoker(BindEipRequest bindEipRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(bindEipRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/eip", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", bindEipRequest);
            return new AsyncInvoker<BindEipResponse>(this, "POST", request, JsonUtils.DeSerialize<BindEipResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDdmInstanceResponse> CreateDdmInstanceAsync(CreateDdmInstanceRequest createDdmInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateDdmInstanceResponse> CreateDdmInstanceAsyncInvoker(CreateDdmInstanceRequest createDdmInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createDdmInstanceRequest);
            return new AsyncInvoker<CreateDdmInstanceResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDdmInstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteNodesResponse> DeleteNodesAsync(DeleteNodesRequest deleteNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteNodesResponse> DeleteNodesAsyncInvoker(DeleteNodesRequest deleteNodesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteNodesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteNodesRequest);
            return new AsyncInvoker<DeleteNodesResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteNodesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDdmsResponse> ListDdmsAsync(ListDdmsRequest listDdmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances", urlParam);
        ...
        public AsyncInvoker<ListDdmsResponse> ListDdmsAsyncInvoker(ListDdmsRequest listDdmsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDdmsRequest);
            return new AsyncInvoker<ListDdmsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDdmsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListSlowLogAnalysisResponse> ListSlowLogAnalysisAsync(ListSlowLogAnalysisRequest listSlowLogAnalysisRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListSlowLogAnalysisResponse> ListSlowLogAnalysisAsyncInvoker(ListSlowLogAnalysisRequest listSlowLogAnalysisRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSlowLogAnalysisRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/slow-log-analysis", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSlowLogAnalysisRequest);
            return new AsyncInvoker<ListSlowLogAnalysisResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSlowLogAnalysisResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyEipResponse> ModifyEipAsync(ModifyEipRequest modifyEipRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ModifyEipResponse> ModifyEipAsyncInvoker(ModifyEipRequest modifyEipRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyEipRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/elb/ip", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyEipRequest);
            return new AsyncInvoker<ModifyEipResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyEipResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RebuildDdmConfigResponse> RebuildDdmConfigAsync(RebuildDdmConfigRequest rebuildDdmConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<RebuildDdmConfigResponse> RebuildDdmConfigAsyncInvoker(RebuildDdmConfigRequest rebuildDdmConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(rebuildDdmConfigRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/reload-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", rebuildDdmConfigRequest);
            return new AsyncInvoker<RebuildDdmConfigResponse>(this, "POST", request, JsonUtils.DeSerializeNull<RebuildDdmConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RestartDdmInstanceResponse> RestartDdmInstanceAsync(RestartDdmInstanceRequest restartDdmInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<RestartDdmInstanceResponse> RestartDdmInstanceAsyncInvoker(RestartDdmInstanceRequest restartDdmInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(restartDdmInstanceRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/restart", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", restartDdmInstanceRequest);
            return new AsyncInvoker<RestartDdmInstanceResponse>(this, "POST", request, JsonUtils.DeSerialize<RestartDdmInstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RestartNodeResponse> RestartNodeAsync(RestartNodeRequest restartNodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<RestartNodeResponse> RestartNodeAsyncInvoker(RestartNodeRequest restartNodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(restartNodeRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(restartNodeRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/restart", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", restartNodeRequest);
            return new AsyncInvoker<RestartNodeResponse>(this, "POST", request, JsonUtils.DeSerialize<RestartNodeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowDdmNodeDetailResponse> ShowDdmNodeDetailAsync(ShowDdmNodeDetailRequest showDdmNodeDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowDdmNodeDetailResponse> ShowDdmNodeDetailAsyncInvoker(ShowDdmNodeDetailRequest showDdmNodeDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDdmNodeDetailRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showDdmNodeDetailRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDdmNodeDetailRequest);
            return new AsyncInvoker<ShowDdmNodeDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDdmNodeDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowMigrationLogResponse> ShowMigrationLogAsync(ShowMigrationLogRequest showMigrationLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowMigrationLogResponse> ShowMigrationLogAsyncInvoker(ShowMigrationLogRequest showMigrationLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showMigrationLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showMigrationLogRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instance/{instance_id}/task/{task_id}/run-logs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showMigrationLogRequest);
            return new AsyncInvoker<ShowMigrationLogResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowMigrationLogResponse>);
        }
        ...
        public AsyncInvoker<SwitchIpGroupResponse> SwitchIpGroupAsyncInvoker(SwitchIpGroupRequest switchIpGroupRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/groups/{group_id}/acls", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", switchIpGroupRequest);
            return new AsyncInvoker<SwitchIpGroupResponse>(this, "POST", request, JsonUtils.DeSerialize<SwitchIpGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SyncDnInformationResponse> SyncDnInformationAsync(SyncDnInformationRequest syncDnInformationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<SyncDnInformationResponse> SyncDnInformationAsyncInvoker(SyncDnInformationRequest syncDnInformationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(syncDnInformationRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/data-nodes/sync", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", syncDnInformationRequest);
            return new AsyncInvoker<SyncDnInformationResponse>(this, "POST", request, JsonUtils.DeSerializeNull<SyncDnInformationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UnbindEipResponse> UnbindEipAsync(UnbindEipRequest unbindEipRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UnbindEipResponse> UnbindEipAsyncInvoker(UnbindEipRequest unbindEipRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(unbindEipRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/eip", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", unbindEipRequest);
            return new AsyncInvoker<UnbindEipResponse>(this, "DELETE", request, JsonUtils.DeSerialize<UnbindEipResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UnbindLogicDbResponse> UnbindLogicDbAsync(UnbindLogicDbRequest unbindLogicDbRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UnbindLogicDbResponse> UnbindLogicDbAsyncInvoker(UnbindLogicDbRequest unbindLogicDbRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(unbindLogicDbRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(unbindLogicDbRequest.LogicDbName, out var valueOfLogicDbName)) urlParam.Add("logic_db_name", valueOfLogicDbName);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/databases/{logic_db_name}/unbind", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", unbindLogicDbRequest);
            return new AsyncInvoker<UnbindLogicDbResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UnbindLogicDbResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateDdmInstanceNameResponse> UpdateDdmInstanceNameAsync(UpdateDdmInstanceNameRequest updateDdmInstanceNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateDdmInstanceNameResponse> UpdateDdmInstanceNameAsyncInvoker(UpdateDdmInstanceNameRequest updateDdmInstanceNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDdmInstanceNameRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/name", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateDdmInstanceNameRequest);
            return new AsyncInvoker<UpdateDdmInstanceNameResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateDdmInstanceNameResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateDdmInstanceSecurityGroupResponse> UpdateDdmInstanceSecurityGroupAsync(UpdateDdmInstanceSecurityGroupRequest updateDdmInstanceSecurityGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateDdmInstanceSecurityGroupResponse> UpdateDdmInstanceSecurityGroupAsyncInvoker(UpdateDdmInstanceSecurityGroupRequest updateDdmInstanceSecurityGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDdmInstanceSecurityGroupRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/security-group", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateDdmInstanceSecurityGroupRequest);
            return new AsyncInvoker<UpdateDdmInstanceSecurityGroupResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateDdmInstanceSecurityGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CheckDataNodeConnectionResponse> CheckDataNodeConnectionAsync(CheckDataNodeConnectionRequest checkDataNodeConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CheckDataNodeConnectionResponse> CheckDataNodeConnectionAsyncInvoker(CheckDataNodeConnectionRequest checkDataNodeConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(checkDataNodeConnectionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instance/{instance_id}/rds/connection", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CompareParameterGroupsResponse> CompareParameterGroupsAsync(CompareParameterGroupsRequest compareParameterGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CompareParameterGroupsResponse> CompareParameterGroupsAsyncInvoker(CompareParameterGroupsRequest compareParameterGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/diff", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", compareParameterGroupsRequest);
            return new AsyncInvoker<CompareParameterGroupsResponse>(this, "PUT", request, JsonUtils.DeSerialize<CompareParameterGroupsResponse>);
        }
        ...
        public AsyncInvoker<CopyConfigurationResponse> CopyConfigurationAsyncInvoker(CopyConfigurationRequest copyConfigurationRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{config_id}/copy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", copyConfigurationRequest);
            return new AsyncInvoker<CopyConfigurationResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CopyConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ResetParameterGroupResponse> ResetParameterGroupAsync(ResetParameterGroupRequest resetParameterGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ResetParameterGroupResponse> ResetParameterGroupAsyncInvoker(ResetParameterGroupRequest resetParameterGroupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(resetParameterGroupRequest.ConfigId, out var valueOfConfigId)) urlParam.Add("config_id", valueOfConfigId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{config_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", resetParameterGroupRequest);
            return new AsyncInvoker<ResetParameterGroupResponse>(this, "PUT", request, JsonUtils.DeSerialize<ResetParameterGroupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowDdmDetailResponse> ShowDdmDetailAsync(ShowDdmDetailRequest showDdmDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowDdmDetailResponse> ShowDdmDetailAsyncInvoker(ShowDdmDetailRequest showDdmDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDdmDetailRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchModifyReadWriteStrategyResponse> BatchModifyReadWriteStrategyAsync(BatchModifyReadWriteStrategyRequest batchModifyReadWriteStrategyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<BatchModifyReadWriteStrategyResponse> BatchModifyReadWriteStrategyAsyncInvoker(BatchModifyReadWriteStrategyRequest batchModifyReadWriteStrategyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchModifyReadWriteStrategyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/action/batch-modify-read-write-strategy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchModifyReadWriteStrategyRequest);
            return new AsyncInvoker<BatchModifyReadWriteStrategyResponse>(this, "PUT", request, JsonUtils.DeSerialize<BatchModifyReadWriteStrategyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifySqlBlackListResponse> ModifySqlBlackListAsync(ModifySqlBlackListRequest modifySqlBlackListRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ModifySqlBlackListResponse> ModifySqlBlackListAsyncInvoker(ModifySqlBlackListRequest modifySqlBlackListRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifySqlBlackListRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(modifySqlBlackListRequest.LogicDbName, out var valueOfLogicDbName)) urlParam.Add("logic_db_name", valueOfLogicDbName);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/databases/{logic_db_name}/sql-black-list", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifySqlBlackListRequest);
            return new AsyncInvoker<ModifySqlBlackListResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifySqlBlackListResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListSqlBlackResponse> ListSqlBlackAsync(ListSqlBlackRequest listSqlBlackRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListSqlBlackResponse> ListSqlBlackAsyncInvoker(ListSqlBlackRequest listSqlBlackRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSqlBlackRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listSqlBlackRequest.LogicDbName, out var valueOfLogicDbName)) urlParam.Add("logic_db_name", valueOfLogicDbName);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/databases/{logic_db_name}/sql-black-list", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSqlBlackRequest);
            return new AsyncInvoker<ListSqlBlackResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSqlBlackResponse>);
        }

...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchResourceShareInvitationResponse : SdkResponse
    {
        ...
        public bool Equals(SearchResourceShareInvitationResponse input)
        {
            ...
            return 
                (
                    this.ResourceShareInvitations == input.ResourceShareInvitations ||
                    this.ResourceShareInvitations != null &&
                    input.ResourceShareInvitations != null &&
                    this.ResourceShareInvitations.SequenceEqual(input.ResourceShareInvitations)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResourceShareInvitations != null)
                    hashCode = hashCode * 59 + this.ResourceShareInvitations.GetHashCode();

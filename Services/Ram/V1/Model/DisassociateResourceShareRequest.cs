...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class DisassociateResourceShareRequest 
    {
        ...
        public ResourceShareAssociationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DisassociateResourceShareRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateResourceShareRequest input)
        {
            if (input == null)
                return false;

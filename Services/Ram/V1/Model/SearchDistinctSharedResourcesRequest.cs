...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchDistinctSharedResourcesRequest 
    {
        ...
        public SearchDistinctSharedResourcesReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as SearchDistinctSharedResourcesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchDistinctSharedResourcesRequest input)
        {

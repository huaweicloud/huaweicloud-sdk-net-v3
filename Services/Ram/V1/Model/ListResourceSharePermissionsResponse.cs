...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class ListResourceSharePermissionsResponse : SdkResponse
    {
        ...
        public bool Equals(ListResourceSharePermissionsResponse input)
        {
            ...
            if (this.AssociatedPermissions != input.AssociatedPermissions || (this.AssociatedPermissions != null && input.AssociatedPermissions != null && !this.AssociatedPermissions.SequenceEqual(input.AssociatedPermissions))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.AssociatedPermissions != null) hashCode = hashCode * 59 + this.AssociatedPermissions.GetHashCode();

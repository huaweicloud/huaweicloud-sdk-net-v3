...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchSharedResourcesResponse : SdkResponse
    {
        ...
        public bool Equals(SearchSharedResourcesResponse input)
        {
            ...
            if (this.SharedResources != input.SharedResources || (this.SharedResources != null && input.SharedResources != null && !this.SharedResources.SequenceEqual(input.SharedResources))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.SharedResources != null) hashCode = hashCode * 59 + this.SharedResources.GetHashCode();

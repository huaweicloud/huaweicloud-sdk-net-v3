...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchSharedPrincipalsRequest 
    {
        ...
        public SearchSharedPrincipalsReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as SearchSharedPrincipalsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchSharedPrincipalsRequest input)
        {

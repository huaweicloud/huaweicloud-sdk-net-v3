...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPermissionVersionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListPermissionVersionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPermissionVersionsResponse input)
        {

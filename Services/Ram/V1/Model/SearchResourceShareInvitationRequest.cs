...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchResourceShareInvitationRequest 
    {
        ...
        public SearchResourceShareInvitationReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as SearchResourceShareInvitationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchResourceShareInvitationRequest input)
        {

...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class DisassociateResourceSharePermissionRequest 
    {
        ...
        public DisassociatePermissionReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DisassociateResourceSharePermissionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateResourceSharePermissionRequest input)
        {

...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchDistinctPrincipalsRequest 
    {
        ...
        public SearchDistinctSharedPrincipalsReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as SearchDistinctPrincipalsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchDistinctPrincipalsRequest input)
        {

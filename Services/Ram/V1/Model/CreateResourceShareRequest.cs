...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class CreateResourceShareRequest 
    {
        ...
        public CreateResourceShareReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateResourceShareRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateResourceShareRequest input)
        {

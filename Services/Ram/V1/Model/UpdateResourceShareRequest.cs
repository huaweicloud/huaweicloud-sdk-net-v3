...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class UpdateResourceShareRequest 
    {
        ...
        public UpdateResourceShareReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateResourceShareRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateResourceShareRequest input)
        {

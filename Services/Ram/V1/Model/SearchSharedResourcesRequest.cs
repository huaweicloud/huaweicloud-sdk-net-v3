...
namespace HuaweiCloud.SDK.Ram.V1.Model
{
    ...
    public class SearchSharedResourcesRequest 
    {
        ...
        public SearchSharedResourcesReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as SearchSharedResourcesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchSharedResourcesRequest input)
        {

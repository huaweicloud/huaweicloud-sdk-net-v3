...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDeviceProxyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDeviceProxyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceProxyResponse input)
        {

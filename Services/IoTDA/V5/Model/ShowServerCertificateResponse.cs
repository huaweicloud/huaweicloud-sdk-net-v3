...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowServerCertificateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowServerCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowServerCertificateResponse input)
        {

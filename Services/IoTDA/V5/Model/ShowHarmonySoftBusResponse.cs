...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowHarmonySoftBusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowHarmonySoftBusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowHarmonySoftBusResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class ListDeviceByDeviceCertificateRequest 
    {
        ...
        public ListDeviceRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ListDeviceByDeviceCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDeviceByDeviceCertificateRequest input)
        {

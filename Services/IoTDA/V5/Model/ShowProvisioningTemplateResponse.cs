...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProvisioningTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProvisioningTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProvisioningTemplateResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRoutingBacklogPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateRoutingBacklogPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRoutingBacklogPolicyResponse input)
        {

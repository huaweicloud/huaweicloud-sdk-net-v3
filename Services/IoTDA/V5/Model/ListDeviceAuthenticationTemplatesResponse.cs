...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDeviceAuthenticationTemplatesResponse : SdkResponse
    {
        ...
        public List<AuthenticationTemplateSimple> Templates { get; set; }
        ...
        {
            return this.Equals(input as ListDeviceAuthenticationTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDeviceAuthenticationTemplatesResponse input)
        {

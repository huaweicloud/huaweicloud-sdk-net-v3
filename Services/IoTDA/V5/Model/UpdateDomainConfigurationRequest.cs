...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateDomainConfigurationRequest 
    {
        ...
        public UpdateDomainConfigurationDTO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDomainConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainConfigurationRequest input)
        {

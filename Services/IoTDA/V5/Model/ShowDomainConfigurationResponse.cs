...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDomainConfigurationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDomainConfigurationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDomainConfigurationResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class ResetBridgeSecretRequest 
    {
        ...
        /// </summary>
        [SDKProperty("bridge_id", IsPath = true)]
        ...
        public ResetBridgeSecret Body { get; set; }
        ...
        {
            return this.Equals(input as ResetBridgeSecretRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResetBridgeSecretRequest input)
        {
            if (input == null)
                return false;

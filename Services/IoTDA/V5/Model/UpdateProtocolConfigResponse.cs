...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProtocolConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateProtocolConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProtocolConfigResponse input)
        {

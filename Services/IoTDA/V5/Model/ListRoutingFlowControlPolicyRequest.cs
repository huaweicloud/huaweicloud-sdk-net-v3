...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class ListRoutingFlowControlPolicyRequest 
    {
        ...
        /// </summary>
        [SDKProperty("scope_value", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListRoutingFlowControlPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRoutingFlowControlPolicyRequest input)
        {

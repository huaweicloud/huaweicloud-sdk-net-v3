...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDevicePolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDevicePolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDevicePolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRoutingFlowControlPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRoutingFlowControlPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRoutingFlowControlPolicyResponse input)
        {

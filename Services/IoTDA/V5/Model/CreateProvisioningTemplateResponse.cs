...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateProvisioningTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateProvisioningTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProvisioningTemplateResponse input)
        {
            if (input == null)
                return false;

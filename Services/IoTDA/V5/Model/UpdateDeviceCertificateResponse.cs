...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDeviceCertificateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDeviceCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceCertificateResponse input)
        {

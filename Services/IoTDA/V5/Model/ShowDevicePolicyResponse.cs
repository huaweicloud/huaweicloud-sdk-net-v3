...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDevicePolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDevicePolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDevicePolicyResponse input)
        {

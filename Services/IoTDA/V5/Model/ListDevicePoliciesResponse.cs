...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDevicePoliciesResponse : SdkResponse
    {
        ...
        public List<ListDevicePolicyBase> Policies { get; set; }
        ...
        {
            return this.Equals(input as ListDevicePoliciesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDevicePoliciesResponse input)
        {

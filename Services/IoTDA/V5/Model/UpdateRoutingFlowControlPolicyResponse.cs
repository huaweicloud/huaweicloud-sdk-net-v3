...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRoutingFlowControlPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRoutingFlowControlPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRoutingFlowControlPolicyResponse input)
        {
            ...
            if (this.ScopeValue != input.ScopeValue || (this.ScopeValue != null && !this.ScopeValue.Equals(input.ScopeValue))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ScopeValue != null) hashCode = hashCode * 59 + this.ScopeValue.GetHashCode();

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAppCertificateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAppCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAppCertificateResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRuleActionsResponse : SdkResponse
    {
        ...
        public List<RoutingRuleAction> Actions { get; set; }
        ...
        {
            return this.Equals(input as ListRuleActionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRuleActionsResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class DeviceShadowData 
    {
        ...
        public bool Equals(DeviceShadowData input)
        {
            ...
            if (this.Reported != input.Reported || (this.Reported != null && !this.Reported.Equals(input.Reported))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Reported != null) hashCode = hashCode * 59 + this.Reported.GetHashCode();

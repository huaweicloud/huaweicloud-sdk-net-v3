...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDeviceAuthorizerResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDeviceAuthorizerResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDeviceAuthorizerResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDeviceByDeviceCertificateResponse : SdkResponse
    {
        ...
        public List<DeviceSimple> Devices { get; set; }
        ...
        {
            return this.Equals(input as ListDeviceByDeviceCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDeviceByDeviceCertificateResponse input)
        {

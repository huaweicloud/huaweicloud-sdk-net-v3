...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateRoutingFlowControlPolicyRequest 
    {
        ...
        public UpdateFlowControlPolicy Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRoutingFlowControlPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRoutingFlowControlPolicyRequest input)
        {

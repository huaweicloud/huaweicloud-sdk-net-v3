...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDevicePolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDevicePolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDevicePolicyResponse input)
        {
            if (input == null)
                return false;

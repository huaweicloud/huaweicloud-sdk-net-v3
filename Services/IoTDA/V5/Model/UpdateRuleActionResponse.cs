...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRuleActionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRuleActionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRuleActionResponse input)
        {
            if (input == null)
                return false;

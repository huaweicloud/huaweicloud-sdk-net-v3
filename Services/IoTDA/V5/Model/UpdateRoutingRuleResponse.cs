...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRoutingRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateRoutingRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRoutingRuleResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSecurityProfileResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSecurityProfileResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecurityProfileResponse input)
        {

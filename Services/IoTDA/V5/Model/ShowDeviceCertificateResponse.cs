...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDeviceCertificateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDeviceCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDeviceCertificateResponse input)
        {

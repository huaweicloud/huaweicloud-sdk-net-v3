...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class DeleteServerCertificateRequest 
    {
        ...
        /// 服务器证书ID，由平台分配的唯一标识。
        /// </summary>
        [SDKProperty("server_certificate_id", IsPath = true)]
        ...
        {
            return this.Equals(input as DeleteServerCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteServerCertificateRequest input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAppCertificateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAppCertificateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAppCertificateResponse input)
        {
            if (input == null)
                return false;

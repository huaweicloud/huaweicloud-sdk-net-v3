...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSubscriptionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSubscriptionResponse input)
        {
            if (input == null)
                return false;

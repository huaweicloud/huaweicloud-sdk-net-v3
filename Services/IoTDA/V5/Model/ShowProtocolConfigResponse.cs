...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProtocolConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProtocolConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProtocolConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDeviceAuthenticationTemplateResponse : SdkResponse
    {
        ...
        public AuthenticationTemplateBody TemplateBody { get; set; }
        ...
        {
            return this.Equals(input as UpdateDeviceAuthenticationTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceAuthenticationTemplateResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDomainConfigurationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDomainConfigurationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainConfigurationResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateProtocolConfigRequest 
    {
        ...
        public UpdateProtocolConfigDTO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateProtocolConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProtocolConfigRequest input)
        {

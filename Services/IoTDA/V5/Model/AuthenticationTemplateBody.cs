...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class AuthenticationTemplateBody 
    {
        ...
        public AuthenticationTemplateResource Resources { get; set; }
        ...
        {
            return this.Equals(input as AuthenticationTemplateBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AuthenticationTemplateBody input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDeviceAuthenticationTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDeviceAuthenticationTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDeviceAuthenticationTemplateResponse input)
        {

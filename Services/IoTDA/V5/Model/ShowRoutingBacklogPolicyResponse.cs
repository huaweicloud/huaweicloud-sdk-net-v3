...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRoutingBacklogPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRoutingBacklogPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRoutingBacklogPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDeviceAuthorizerResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDeviceAuthorizerResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceAuthorizerResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateSecurityProfileRequest 
    {
        ...
        public UpdateSecurityProfileDTO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSecurityProfileRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecurityProfileRequest input)
        {

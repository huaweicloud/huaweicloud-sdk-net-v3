...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ConfirmBatchTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ConfirmBatchTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ConfirmBatchTaskResponse input)
        {

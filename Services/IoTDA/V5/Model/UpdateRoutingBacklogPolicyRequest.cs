...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateRoutingBacklogPolicyRequest 
    {
        ...
        public UpdateBacklogPolicy Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateRoutingBacklogPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRoutingBacklogPolicyRequest input)
        {
            if (input == null)
                return false;

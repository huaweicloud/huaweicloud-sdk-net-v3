...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class ListBatchTasksResponse : SdkResponse
    {
        ...
        public bool Equals(ListBatchTasksResponse input)
        {
            ...
            if (this.Batchtasks != input.Batchtasks || (this.Batchtasks != null && input.Batchtasks != null && !this.Batchtasks.SequenceEqual(input.Batchtasks))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.Batchtasks != null) hashCode = hashCode * 59 + this.Batchtasks.GetHashCode();

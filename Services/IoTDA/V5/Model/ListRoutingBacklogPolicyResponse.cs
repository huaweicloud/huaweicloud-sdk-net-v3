...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class ListRoutingBacklogPolicyResponse : SdkResponse
    {
        ...
        public bool Equals(ListRoutingBacklogPolicyResponse input)
        {
            ...
            if (this.BacklogPolicies != input.BacklogPolicies || (this.BacklogPolicies != null && input.BacklogPolicies != null && !this.BacklogPolicies.SequenceEqual(input.BacklogPolicies))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.BacklogPolicies != null) hashCode = hashCode * 59 + this.BacklogPolicies.GetHashCode();

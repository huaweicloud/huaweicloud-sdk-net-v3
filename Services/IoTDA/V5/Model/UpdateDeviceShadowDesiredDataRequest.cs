...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateDeviceShadowDesiredDataRequest 
    {
        ...
        public UpdateDesireds Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDeviceShadowDesiredDataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceShadowDesiredDataRequest input)
        {
            if (input == null)
                return false;

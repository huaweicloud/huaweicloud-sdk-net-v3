...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSecurityProfileResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSecurityProfileResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSecurityProfileResponse input)
        {

...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    public class UpdateDeviceCertificateRequest 
    {
        ...
        public UpdateDeviceCertificate Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDeviceCertificateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceCertificateRequest input)
        {

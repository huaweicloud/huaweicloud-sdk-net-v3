...
namespace HuaweiCloud.SDK.IoTDA.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDeviceGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDeviceGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDeviceGroupResponse input)
        {

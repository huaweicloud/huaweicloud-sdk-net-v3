...
namespace HuaweiCloud.SDK.IoTDA.V5
{
    public partial class IoTDAAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ConfirmBatchTaskResponse> ConfirmBatchTaskAsync(ConfirmBatchTaskRequest confirmBatchTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ConfirmBatchTaskResponse> ConfirmBatchTaskAsyncInvoker(ConfirmBatchTaskRequest confirmBatchTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(confirmBatchTaskRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/batchtasks/{task_id}/confirm", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", confirmBatchTaskRequest);
            return new AsyncInvoker<ConfirmBatchTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<ConfirmBatchTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<AddBridgeResponse> AddBridgeAsync(AddBridgeRequest addBridgeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<AddBridgeResponse> AddBridgeAsyncInvoker(AddBridgeRequest addBridgeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/bridges", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", addBridgeRequest);
            return new AsyncInvoker<AddBridgeResponse>(this, "POST", request, JsonUtils.DeSerialize<AddBridgeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListBridgesResponse> ListBridgesAsync(ListBridgesRequest listBridgesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/bridges", urlParam);
        ...
        public AsyncInvoker<ListBridgesResponse> ListBridgesAsyncInvoker(ListBridgesRequest listBridgesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/bridges", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listBridgesRequest);
            return new AsyncInvoker<ListBridgesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListBridgesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDeviceAuthenticationTemplateResponse> CreateDeviceAuthenticationTemplateAsync(CreateDeviceAuthenticationTemplateRequest createDeviceAuthenticationTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateDeviceAuthenticationTemplateResponse> CreateDeviceAuthenticationTemplateAsyncInvoker(CreateDeviceAuthenticationTemplateRequest createDeviceAuthenticationTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-authentication-templates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDeviceAuthenticationTemplateRequest);
            return new AsyncInvoker<CreateDeviceAuthenticationTemplateResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDeviceAuthenticationTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDeviceAuthenticationTemplatesResponse> ListDeviceAuthenticationTemplatesAsync(ListDeviceAuthenticationTemplatesRequest listDeviceAuthenticationTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-authentication-templates", urlParam);
        ...
        public AsyncInvoker<ListDeviceAuthenticationTemplatesResponse> ListDeviceAuthenticationTemplatesAsyncInvoker(ListDeviceAuthenticationTemplatesRequest listDeviceAuthenticationTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-authentication-templates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDeviceAuthenticationTemplatesRequest);
            return new AsyncInvoker<ListDeviceAuthenticationTemplatesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDeviceAuthenticationTemplatesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDeviceAuthorizerResponse> CreateDeviceAuthorizerAsync(CreateDeviceAuthorizerRequest createDeviceAuthorizerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateDeviceAuthorizerResponse> CreateDeviceAuthorizerAsyncInvoker(CreateDeviceAuthorizerRequest createDeviceAuthorizerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-authorizers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDeviceAuthorizerRequest);
            return new AsyncInvoker<CreateDeviceAuthorizerResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDeviceAuthorizerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDeviceAuthorizersResponse> ListDeviceAuthorizersAsync(ListDeviceAuthorizersRequest listDeviceAuthorizersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-authorizers", urlParam);
        ...
        public AsyncInvoker<ListDeviceAuthorizersResponse> ListDeviceAuthorizersAsyncInvoker(ListDeviceAuthorizersRequest listDeviceAuthorizersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-authorizers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDeviceAuthorizersRequest);
            return new AsyncInvoker<ListDeviceAuthorizersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDeviceAuthorizersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDeviceCertificateResponse> ListDeviceCertificateAsync(ListDeviceCertificateRequest listDeviceCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListDeviceCertificateResponse> ListDeviceCertificateAsyncInvoker(ListDeviceCertificateRequest listDeviceCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-certificates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDeviceCertificateRequest);
            return new AsyncInvoker<ListDeviceCertificateResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDeviceCertificateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDomainConfigurationResponse> CreateDomainConfigurationAsync(CreateDomainConfigurationRequest createDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateDomainConfigurationResponse> CreateDomainConfigurationAsyncInvoker(CreateDomainConfigurationRequest createDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/domain-configurations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDomainConfigurationRequest);
            return new AsyncInvoker<CreateDomainConfigurationResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDomainConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteDomainConfigurationResponse> DeleteDomainConfigurationAsync(DeleteDomainConfigurationRequest deleteDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteDomainConfigurationResponse> DeleteDomainConfigurationAsyncInvoker(DeleteDomainConfigurationRequest deleteDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteDomainConfigurationRequest.ConfigurationId, out var valueOfConfigurationId)) urlParam.Add("configuration_id", valueOfConfigurationId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/domain-configurations/{configuration_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteDomainConfigurationRequest);
            return new AsyncInvoker<DeleteDomainConfigurationResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteDomainConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDomainConfigurationsResponse> ListDomainConfigurationsAsync(ListDomainConfigurationsRequest listDomainConfigurationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/domain-configurations", urlParam);
        ...
        public AsyncInvoker<ListDomainConfigurationsResponse> ListDomainConfigurationsAsyncInvoker(ListDomainConfigurationsRequest listDomainConfigurationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/domain-configurations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDomainConfigurationsRequest);
            return new AsyncInvoker<ListDomainConfigurationsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDomainConfigurationsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowDomainConfigurationResponse> ShowDomainConfigurationAsync(ShowDomainConfigurationRequest showDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowDomainConfigurationResponse> ShowDomainConfigurationAsyncInvoker(ShowDomainConfigurationRequest showDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDomainConfigurationRequest.ConfigurationId, out var valueOfConfigurationId)) urlParam.Add("configuration_id", valueOfConfigurationId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/domain-configurations/{configuration_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDomainConfigurationRequest);
            return new AsyncInvoker<ShowDomainConfigurationResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDomainConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateDomainConfigurationResponse> UpdateDomainConfigurationAsync(UpdateDomainConfigurationRequest updateDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateDomainConfigurationResponse> UpdateDomainConfigurationAsyncInvoker(UpdateDomainConfigurationRequest updateDomainConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDomainConfigurationRequest.ConfigurationId, out var valueOfConfigurationId)) urlParam.Add("configuration_id", valueOfConfigurationId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/domain-configurations/{configuration_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateDomainConfigurationRequest);
            return new AsyncInvoker<UpdateDomainConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateDomainConfigurationResponse>);
        }
        ...
        public AsyncInvoker<CreateExportTaskResponse> CreateExportTaskAsyncInvoker(CreateExportTaskRequest createExportTaskRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/export-tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createExportTaskRequest);
            return new AsyncInvoker<CreateExportTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateExportTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteExportTaskResponse> DeleteExportTaskAsync(DeleteExportTaskRequest deleteExportTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteExportTaskResponse> DeleteExportTaskAsyncInvoker(DeleteExportTaskRequest deleteExportTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteExportTaskRequest.ExportTaskId, out var valueOfExportTaskId)) urlParam.Add("export_task_id", valueOfExportTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/export-tasks/{export_task_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteExportTaskRequest);
            return new AsyncInvoker<DeleteExportTaskResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteExportTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowExportTaskResponse> ShowExportTaskAsync(ShowExportTaskRequest showExportTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowExportTaskResponse> ShowExportTaskAsyncInvoker(ShowExportTaskRequest showExportTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showExportTaskRequest.ExportTaskId, out var valueOfExportTaskId)) urlParam.Add("export_task_id", valueOfExportTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/export-tasks/{export_task_id}/file", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showExportTaskRequest);
            return new AsyncInvoker<ShowExportTaskResponse>(this, "GET", request, JsonUtils.DeSerializeNull<ShowExportTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<AddFunctionsResponse> AddFunctionsAsync(AddFunctionsRequest addFunctionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<AddFunctionsResponse> AddFunctionsAsyncInvoker(AddFunctionsRequest addFunctionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/product-functions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", addFunctionsRequest);
            return new AsyncInvoker<AddFunctionsResponse>(this, "POST", request, JsonUtils.DeSerialize<AddFunctionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<AddHarmonySoftBusResponse> AddHarmonySoftBusAsync(AddHarmonySoftBusRequest addHarmonySoftBusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<AddHarmonySoftBusResponse> AddHarmonySoftBusAsyncInvoker(AddHarmonySoftBusRequest addHarmonySoftBusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/harmony-soft-bus", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", addHarmonySoftBusRequest);
            return new AsyncInvoker<AddHarmonySoftBusResponse>(this, "POST", request, JsonUtils.DeSerialize<AddHarmonySoftBusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListHarmonySoftBusResponse> ListHarmonySoftBusAsync(ListHarmonySoftBusRequest listHarmonySoftBusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/harmony-soft-bus", urlParam);
        ...
        public AsyncInvoker<ListHarmonySoftBusResponse> ListHarmonySoftBusAsyncInvoker(ListHarmonySoftBusRequest listHarmonySoftBusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/harmony-soft-bus", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHarmonySoftBusRequest);
            return new AsyncInvoker<ListHarmonySoftBusResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHarmonySoftBusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDevicePolicyResponse> CreateDevicePolicyAsync(CreateDevicePolicyRequest createDevicePolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateDevicePolicyResponse> CreateDevicePolicyAsyncInvoker(CreateDevicePolicyRequest createDevicePolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-policies", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDevicePolicyRequest);
            return new AsyncInvoker<CreateDevicePolicyResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDevicePolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDevicePoliciesResponse> ListDevicePoliciesAsync(ListDevicePoliciesRequest listDevicePoliciesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-policies", urlParam);
        ...
        public AsyncInvoker<ListDevicePoliciesResponse> ListDevicePoliciesAsyncInvoker(ListDevicePoliciesRequest listDevicePoliciesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/device-policies", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDevicePoliciesRequest);
            return new AsyncInvoker<ListDevicePoliciesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDevicePoliciesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateProvisioningTemplateResponse> CreateProvisioningTemplateAsync(CreateProvisioningTemplateRequest createProvisioningTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateProvisioningTemplateResponse> CreateProvisioningTemplateAsyncInvoker(CreateProvisioningTemplateRequest createProvisioningTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/provisioning-templates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createProvisioningTemplateRequest);
            return new AsyncInvoker<CreateProvisioningTemplateResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateProvisioningTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListProvisioningTemplatesResponse> ListProvisioningTemplatesAsync(ListProvisioningTemplatesRequest listProvisioningTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/provisioning-templates", urlParam);
        ...
        public AsyncInvoker<ListProvisioningTemplatesResponse> ListProvisioningTemplatesAsyncInvoker(ListProvisioningTemplatesRequest listProvisioningTemplatesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/provisioning-templates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listProvisioningTemplatesRequest);
            return new AsyncInvoker<ListProvisioningTemplatesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListProvisioningTemplatesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateSecurityProfileResponse> CreateSecurityProfileAsync(CreateSecurityProfileRequest createSecurityProfileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateSecurityProfileResponse> CreateSecurityProfileAsyncInvoker(CreateSecurityProfileRequest createSecurityProfileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/security-profiles", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSecurityProfileRequest);
            return new AsyncInvoker<CreateSecurityProfileResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateSecurityProfileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListSecurityProfilesResponse> ListSecurityProfilesAsync(ListSecurityProfilesRequest listSecurityProfilesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/security-profiles", urlParam);
        ...
        public AsyncInvoker<ListSecurityProfilesResponse> ListSecurityProfilesAsyncInvoker(ListSecurityProfilesRequest listSecurityProfilesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/security-profiles", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSecurityProfilesRequest);
            return new AsyncInvoker<ListSecurityProfilesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSecurityProfilesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateServerCertificateResponse> CreateServerCertificateAsync(CreateServerCertificateRequest createServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateServerCertificateResponse> CreateServerCertificateAsyncInvoker(CreateServerCertificateRequest createServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/server-certificates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createServerCertificateRequest);
            return new AsyncInvoker<CreateServerCertificateResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateServerCertificateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteServerCertificateResponse> DeleteServerCertificateAsync(DeleteServerCertificateRequest deleteServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteServerCertificateResponse> DeleteServerCertificateAsyncInvoker(DeleteServerCertificateRequest deleteServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteServerCertificateRequest.ServerCertificateId, out var valueOfServerCertificateId)) urlParam.Add("server_certificate_id", valueOfServerCertificateId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/server-certificates/{server_certificate_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteServerCertificateRequest);
            return new AsyncInvoker<DeleteServerCertificateResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteServerCertificateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListServerCertificateResponse> ListServerCertificateAsync(ListServerCertificateRequest listServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/server-certificates", urlParam);
        ...
        public AsyncInvoker<ListServerCertificateResponse> ListServerCertificateAsyncInvoker(ListServerCertificateRequest listServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/server-certificates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listServerCertificateRequest);
            return new AsyncInvoker<ListServerCertificateResponse>(this, "GET", request, JsonUtils.DeSerialize<ListServerCertificateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowServerCertificateResponse> ShowServerCertificateAsync(ShowServerCertificateRequest showServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowServerCertificateResponse> ShowServerCertificateAsyncInvoker(ShowServerCertificateRequest showServerCertificateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showServerCertificateRequest.ServerCertificateId, out var valueOfServerCertificateId)) urlParam.Add("server_certificate_id", valueOfServerCertificateId);
            var urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/server-certificates/{server_certificate_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showServerCertificateRequest);
            return new AsyncInvoker<ShowServerCertificateResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowServerCertificateResponse>);
        }

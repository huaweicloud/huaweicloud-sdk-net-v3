...
namespace HuaweiCloud.SDK.IoTDA.V5
{
    public partial class IoTDAAsyncClient : Client
    {
        ...
        /// 上传应用侧CA证书
        /// </summary>
        public async Task<CreateAppCertificateResponse> CreateAppCertificateAsync(CreateAppCertificateRequest createAppCertificateRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
        ...
        /// 删除应用侧CA证书
        /// </summary>
        public async Task<DeleteAppCertificateResponse> DeleteAppCertificateAsync(DeleteAppCertificateRequest deleteAppCertificateRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
        ...
        /// 查询应用侧CA证书列表
        /// </summary>
        public async Task<ListAppCertificatesResponse> ListAppCertificatesAsync(ListAppCertificatesRequest listAppCertificatesRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
            string urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/certificates/app-cert/",urlParam);
        ...
        /// 查询应用侧CA证书
        /// </summary>
        public async Task<ShowAppCertificateResponse> ShowAppCertificateAsync(ShowAppCertificateRequest showAppCertificateRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
        ...
        /// 更新应用侧CA证书
        /// </summary>
        public async Task<UpdateAppCertificateResponse> UpdateAppCertificateAsync(UpdateAppCertificateRequest updateAppCertificateRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
        ...
        public async Task<DeleteSubscriptionResponse> DeleteSubscriptionAsync(DeleteSubscriptionRequest deleteSubscriptionRequest)
        {
            ...
            SdkRequest request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteSubscriptionRequest);
            HttpResponseMessage response = await DoHttpRequestAsync("DELETE",request);
        ...
        public async Task<ShowSubscriptionResponse> ShowSubscriptionAsync(ShowSubscriptionRequest showSubscriptionRequest)
        {
            ...
            string urlPath = HttpUtils.AddUrlPath("/v5/iot/{project_id}/subscriptions/{subscription_id}",urlParam);
            SdkRequest request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSubscriptionRequest);
            HttpResponseMessage response = await DoHttpRequestAsync("GET",request);

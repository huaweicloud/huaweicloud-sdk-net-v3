...
namespace HuaweiCloud.SDK.Iam.V5
{
    public partial class IamClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public AddClientIDToOIDCProviderV5Response AddClientIDToOIDCProviderV5(AddClientIDToOIDCProviderV5Request addClientIDToOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<AddClientIDToOIDCProviderV5Response> AddClientIDToOIDCProviderV5Invoker(AddClientIDToOIDCProviderV5Request addClientIDToOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(addClientIDToOIDCProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers/{provider_id}/add-client-id", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", addClientIDToOIDCProviderV5Request);
            return new SyncInvoker<AddClientIDToOIDCProviderV5Response>(this, "POST", request, JsonUtils.DeSerializeNull<AddClientIDToOIDCProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateOIDCProviderV5Response CreateOIDCProviderV5(CreateOIDCProviderV5Request createOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateOIDCProviderV5Response> CreateOIDCProviderV5Invoker(CreateOIDCProviderV5Request createOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createOIDCProviderV5Request);
            return new SyncInvoker<CreateOIDCProviderV5Response>(this, "POST", request, JsonUtils.DeSerialize<CreateOIDCProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteOIDCProviderV5Response DeleteOIDCProviderV5(DeleteOIDCProviderV5Request deleteOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteOIDCProviderV5Response> DeleteOIDCProviderV5Invoker(DeleteOIDCProviderV5Request deleteOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteOIDCProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers/{provider_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteOIDCProviderV5Request);
            return new SyncInvoker<DeleteOIDCProviderV5Response>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteOIDCProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListOIDCProvidersV5Response ListOIDCProvidersV5(ListOIDCProvidersV5Request listOIDCProvidersV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers", urlParam);
        ...
        public SyncInvoker<ListOIDCProvidersV5Response> ListOIDCProvidersV5Invoker(ListOIDCProvidersV5Request listOIDCProvidersV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOIDCProvidersV5Request);
            return new SyncInvoker<ListOIDCProvidersV5Response>(this, "GET", request, JsonUtils.DeSerialize<ListOIDCProvidersV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RemoveClientIDFromOIDCProviderV5Response RemoveClientIDFromOIDCProviderV5(RemoveClientIDFromOIDCProviderV5Request removeClientIDFromOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<RemoveClientIDFromOIDCProviderV5Response> RemoveClientIDFromOIDCProviderV5Invoker(RemoveClientIDFromOIDCProviderV5Request removeClientIDFromOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(removeClientIDFromOIDCProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers/{provider_id}/remove-client-id", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", removeClientIDFromOIDCProviderV5Request);
            return new SyncInvoker<RemoveClientIDFromOIDCProviderV5Response>(this, "POST", request, JsonUtils.DeSerializeNull<RemoveClientIDFromOIDCProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowOIDCProviderV5Response ShowOIDCProviderV5(ShowOIDCProviderV5Request showOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowOIDCProviderV5Response> ShowOIDCProviderV5Invoker(ShowOIDCProviderV5Request showOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showOIDCProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers/{provider_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showOIDCProviderV5Request);
            return new SyncInvoker<ShowOIDCProviderV5Response>(this, "GET", request, JsonUtils.DeSerialize<ShowOIDCProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateOIDCProviderThumbprintV5Response UpdateOIDCProviderThumbprintV5(UpdateOIDCProviderThumbprintV5Request updateOIDCProviderThumbprintV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateOIDCProviderThumbprintV5Response> UpdateOIDCProviderThumbprintV5Invoker(UpdateOIDCProviderThumbprintV5Request updateOIDCProviderThumbprintV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateOIDCProviderThumbprintV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers/{provider_id}/thumbprint", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateOIDCProviderThumbprintV5Request);
            return new SyncInvoker<UpdateOIDCProviderThumbprintV5Response>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateOIDCProviderThumbprintV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateOIDCProviderV5Response UpdateOIDCProviderV5(UpdateOIDCProviderV5Request updateOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateOIDCProviderV5Response> UpdateOIDCProviderV5Invoker(UpdateOIDCProviderV5Request updateOIDCProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateOIDCProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/oidc-providers/{provider_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateOIDCProviderV5Request);
            return new SyncInvoker<UpdateOIDCProviderV5Response>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateOIDCProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateSAMLProviderV5Response CreateSAMLProviderV5(CreateSAMLProviderV5Request createSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateSAMLProviderV5Response> CreateSAMLProviderV5Invoker(CreateSAMLProviderV5Request createSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/saml-providers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSAMLProviderV5Request);
            return new SyncInvoker<CreateSAMLProviderV5Response>(this, "POST", request, JsonUtils.DeSerialize<CreateSAMLProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteSAMLProviderV5Response DeleteSAMLProviderV5(DeleteSAMLProviderV5Request deleteSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteSAMLProviderV5Response> DeleteSAMLProviderV5Invoker(DeleteSAMLProviderV5Request deleteSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteSAMLProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/saml-providers/{provider_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteSAMLProviderV5Request);
            return new SyncInvoker<DeleteSAMLProviderV5Response>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteSAMLProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSAMLProvidersV5Response ListSAMLProvidersV5(ListSAMLProvidersV5Request listSAMLProvidersV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/saml-providers", urlParam);
        ...
        public SyncInvoker<ListSAMLProvidersV5Response> ListSAMLProvidersV5Invoker(ListSAMLProvidersV5Request listSAMLProvidersV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v5/saml-providers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSAMLProvidersV5Request);
            return new SyncInvoker<ListSAMLProvidersV5Response>(this, "GET", request, JsonUtils.DeSerialize<ListSAMLProvidersV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSAMLProviderV5Response ShowSAMLProviderV5(ShowSAMLProviderV5Request showSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSAMLProviderV5Response> ShowSAMLProviderV5Invoker(ShowSAMLProviderV5Request showSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSAMLProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/saml-providers/{provider_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSAMLProviderV5Request);
            return new SyncInvoker<ShowSAMLProviderV5Response>(this, "GET", request, JsonUtils.DeSerialize<ShowSAMLProviderV5Response>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateSAMLProviderV5Response UpdateSAMLProviderV5(UpdateSAMLProviderV5Request updateSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateSAMLProviderV5Response> UpdateSAMLProviderV5Invoker(UpdateSAMLProviderV5Request updateSAMLProviderV5Request)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateSAMLProviderV5Request.ProviderId, out var valueOfProviderId)) urlParam.Add("provider_id", valueOfProviderId);
            var urlPath = HttpUtils.AddUrlPath("/v5/saml-providers/{provider_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateSAMLProviderV5Request);
            return new SyncInvoker<UpdateSAMLProviderV5Response>(this, "PUT", request, JsonUtils.DeSerialize<UpdateSAMLProviderV5Response>);
        }

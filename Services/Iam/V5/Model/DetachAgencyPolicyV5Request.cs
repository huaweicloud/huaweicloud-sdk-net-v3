...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class DetachAgencyPolicyV5Request 
    {
        ...
        public DetachAgencyPolicyReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetachAgencyPolicyV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetachAgencyPolicyV5Request input)
        {

...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateServiceLinkedAgencyV5Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateServiceLinkedAgencyV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateServiceLinkedAgencyV5Response input)
        {

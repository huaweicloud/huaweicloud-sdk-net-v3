...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSAMLProviderV5Response : SdkResponse
    {
        ...
        public InlineResponse2001SamlProvider SamlProvider { get; set; }
        ...
        {
            return this.Equals(input as ShowSAMLProviderV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSAMLProviderV5Response input)
        {

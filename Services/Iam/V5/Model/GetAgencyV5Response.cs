...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetAgencyV5Response : SdkResponse
    {
        ...
        public AgencyEx Agency { get; set; }
        ...
        {
            return this.Equals(input as GetAgencyV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetAgencyV5Response input)
        {

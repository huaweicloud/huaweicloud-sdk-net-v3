...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class RemoveClientIDFromOIDCProviderV5Request 
    {
        ...
        public RemoveClientIDFromOIDCProviderReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as RemoveClientIDFromOIDCProviderV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveClientIDFromOIDCProviderV5Request input)
        {

...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class TagResourceV5Request 
    {
        ...
        public class ResourceTypeEnum
        {
            ...
            /// </summary>
            public static readonly ResourceTypeEnum AGENCY = new ResourceTypeEnum("agency");
        ...
        {
            return this.Equals(input as TagResourceV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(TagResourceV5Request input)
        {

...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAgencyV5Response : SdkResponse
    {
        ...
        public TrustAgency Agency { get; set; }
        ...
        {
            return this.Equals(input as CreateAgencyV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAgencyV5Response input)
        {

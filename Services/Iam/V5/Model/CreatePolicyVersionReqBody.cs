...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class CreatePolicyVersionReqBody 
    {
        ...
        /// 是否设置为默认版本。
        /// </summary>
        [JsonProperty("set_as_default", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as CreatePolicyVersionReqBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePolicyVersionReqBody input)
        {
            ...
            if (this.SetAsDefault != input.SetAsDefault || (this.SetAsDefault != null && !this.SetAsDefault.Equals(input.SetAsDefault))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SetAsDefault != null) hashCode = hashCode * 59 + this.SetAsDefault.GetHashCode();
                return hashCode;
            }
        }
    }

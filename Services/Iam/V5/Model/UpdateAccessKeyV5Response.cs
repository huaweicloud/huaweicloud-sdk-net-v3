...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAccessKeyV5Response : SdkResponse
    {
        ...
        public AccessKeyMetadata AccessKey { get; set; }
        ...
        {
            return this.Equals(input as UpdateAccessKeyV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAccessKeyV5Response input)
        {

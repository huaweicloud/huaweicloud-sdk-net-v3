...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class UpdateOIDCProviderV5Request 
    {
        ...
        public UpdateOIDCProviderReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateOIDCProviderV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateOIDCProviderV5Request input)
        {

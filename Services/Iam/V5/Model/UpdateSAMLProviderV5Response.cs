...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSAMLProviderV5Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSAMLProviderV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSAMLProviderV5Response input)
        {

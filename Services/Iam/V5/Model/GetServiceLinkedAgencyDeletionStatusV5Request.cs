...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class GetServiceLinkedAgencyDeletionStatusV5Request 
    {
        ...
        /// 删除任务ID。
        /// </summary>
        [SDKProperty("deletion_task_id", IsPath = true)]
        ...
        {
            return this.Equals(input as GetServiceLinkedAgencyDeletionStatusV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetServiceLinkedAgencyDeletionStatusV5Request input)
        {

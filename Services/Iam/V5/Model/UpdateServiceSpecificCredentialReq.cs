...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class UpdateServiceSpecificCredentialReq 
    {
        ...
        /// </summary>
        /// <value>凭证状态。不支持用户主动设置为 Expired（Expired 仅由系统在凭证过期时自动设置）。status和description至少指定一个。</value>
        ...
        {
            return this.Equals(input as UpdateServiceSpecificCredentialReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateServiceSpecificCredentialReq input)
        {

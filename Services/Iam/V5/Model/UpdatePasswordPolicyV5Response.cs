...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePasswordPolicyV5Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePasswordPolicyV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePasswordPolicyV5Response input)
        {

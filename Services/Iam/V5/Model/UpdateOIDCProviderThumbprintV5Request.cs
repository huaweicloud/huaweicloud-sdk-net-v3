...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class UpdateOIDCProviderThumbprintV5Request 
    {
        ...
        public UpdateOIDCProviderThumbprintReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateOIDCProviderThumbprintV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateOIDCProviderThumbprintV5Request input)
        {

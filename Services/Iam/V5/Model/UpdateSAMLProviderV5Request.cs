...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class UpdateSAMLProviderV5Request 
    {
        ...
        public UpdateSAMLProviderReqBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSAMLProviderV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSAMLProviderV5Request input)
        {

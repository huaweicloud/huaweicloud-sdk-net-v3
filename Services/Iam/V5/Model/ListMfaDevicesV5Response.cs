...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMfaDevicesV5Response : SdkResponse
    {
        ...
        public List<MfaDeviceMetadata> MfaDevices { get; set; }
        ...
        {
            return this.Equals(input as ListMfaDevicesV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMfaDevicesV5Response input)
        {

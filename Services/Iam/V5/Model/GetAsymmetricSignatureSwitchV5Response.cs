...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetAsymmetricSignatureSwitchV5Response : SdkResponse
    {
        ...
        public AsymmetricSignatureWithDomainId AsymmetricSignature { get; set; }
        ...
        {
            return this.Equals(input as GetAsymmetricSignatureSwitchV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetAsymmetricSignatureSwitchV5Response input)
        {

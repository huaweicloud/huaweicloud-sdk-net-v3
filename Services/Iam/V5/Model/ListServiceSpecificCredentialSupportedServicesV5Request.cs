...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class ListServiceSpecificCredentialSupportedServicesV5Request 
    {
        ...
        {
            return this.Equals(input as ListServiceSpecificCredentialSupportedServicesV5Request);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListServiceSpecificCredentialSupportedServicesV5Request input)
        {

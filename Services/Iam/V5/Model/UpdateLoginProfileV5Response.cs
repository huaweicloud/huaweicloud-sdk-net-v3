...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateLoginProfileV5Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateLoginProfileV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateLoginProfileV5Response input)
        {

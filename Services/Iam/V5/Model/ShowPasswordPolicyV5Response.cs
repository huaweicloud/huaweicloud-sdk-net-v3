...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPasswordPolicyV5Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPasswordPolicyV5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPasswordPolicyV5Response input)
        {

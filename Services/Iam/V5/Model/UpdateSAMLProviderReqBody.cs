...
namespace HuaweiCloud.SDK.Iam.V5.Model
{
    ...
    public class UpdateSAMLProviderReqBody 
    {
        ...
        /// </summary>
        [JsonProperty("remove_private_key", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  removePrivateKey: ").Append(RemovePrivateKey).Append("\n");
        ...
        {
            return this.Equals(input as UpdateSAMLProviderReqBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSAMLProviderReqBody input)
        {
            ...
            if (this.RemovePrivateKey != input.RemovePrivateKey || (this.RemovePrivateKey != null && !this.RemovePrivateKey.Equals(input.RemovePrivateKey))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RemovePrivateKey != null) hashCode = hashCode * 59 + this.RemovePrivateKey.GetHashCode();

...
namespace HuaweiCloud.SDK.Iam.V3
{
    public partial class IamClient : Client
    {
        ...
        public SyncInvoker<CreateUnscopeTokenByIdpInitiatedResponse> CreateUnscopeTokenByIdpInitiatedInvoker(CreateUnscopeTokenByIdpInitiatedRequest createUnscopeTokenByIdpInitiatedRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3.0/OS-FEDERATION/tokens", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/x-www-form-urlencoded", createUnscopeTokenByIdpInitiatedRequest);
            return new SyncInvoker<CreateUnscopeTokenByIdpInitiatedResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateUnscopeTokenByIdpInitiatedResponse>);
        }

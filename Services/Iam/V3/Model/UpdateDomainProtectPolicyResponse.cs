...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDomainProtectPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDomainProtectPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainProtectPolicyResponse input)
        {
            if (input == null)
                return false;

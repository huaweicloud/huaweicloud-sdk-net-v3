...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdateOpenIdConnectConfig 
    {
        ...
        /// </summary>
        /// <value>授权请求返回的类型；值为id_token ；编程访问和管理控制台访问方式值不可为空，编程访问方式值可为空 </value>
        ...
        /// </summary>
        /// <value>授权请求返回方式，可选值 form_post 或 fragment ；编程访问和管理控制台访问方式值为可选值，编程访问方式值可为空</value>
        ...
        {
            return this.Equals(input as UpdateOpenIdConnectConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateOpenIdConnectConfig input)
        {
            if (input == null)
                return false;

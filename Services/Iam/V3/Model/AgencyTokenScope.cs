...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class AgencyTokenScope 
    {
        ...
        public AgencyTokenScopeDomain Domain { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("project", NullValueHandling = NullValueHandling.Ignore)]
        public AgencyTokenScopeProject Project { get; set; }
        ...
        {
            return this.Equals(input as AgencyTokenScope);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AgencyTokenScope input)
        {

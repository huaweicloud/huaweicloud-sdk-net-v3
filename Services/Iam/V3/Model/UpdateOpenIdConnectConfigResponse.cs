...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateOpenIdConnectConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateOpenIdConnectConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateOpenIdConnectConfigResponse input)
        {
            if (input == null)
                return false;

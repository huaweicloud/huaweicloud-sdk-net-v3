...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class KeystoneCreateAgencyTokenResponse : SdkResponse
    {
        ...
        public AgencyTokenResult Token { get; set; }
        ...
        {
            return this.Equals(input as KeystoneCreateAgencyTokenResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneCreateAgencyTokenResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCloudServiceCustomPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCloudServiceCustomPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCloudServiceCustomPolicyResponse input)
        {

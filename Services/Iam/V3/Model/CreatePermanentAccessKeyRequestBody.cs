...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class CreatePermanentAccessKeyRequestBody 
    {
        ...
        public CreateCredentialOption Credential { get; set; }
        ...
        {
            return this.Equals(input as CreatePermanentAccessKeyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePermanentAccessKeyRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class OpenIdConnectConfig 
    {
        ...
        /// </summary>
        /// <value>授权请求返回的类型；id_token ；编程访问和管理控制台访问方式值不为空，编程访问方式值可为空 </value>
        ...
        /// </summary>
        /// <value>授权请求返回方式， form_post 或 fragment ；编程访问和管理控制台访问方式值不为空，编程访问方式值可为空</value>
        ...
        {
            return this.Equals(input as OpenIdConnectConfig);
        }

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class ConsoleAclPolicyResult 
    {
        ...
        public List<AllowAddressNetmasksResultIPv6> AllowAddressNetmasksIpv6 { get; set; }

        /// <summary>
        /// 允许访问的IPv6地址区间。
        /// </summary>
        [JsonProperty("allow_ip_ranges_ipv6", NullValueHandling = NullValueHandling.Ignore)]
        public List<AllowIpRangesResultIPv6> AllowIpRangesIpv6 { get; set; }
        ...
        {
            return this.Equals(input as ConsoleAclPolicyResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ConsoleAclPolicyResult input)
        {

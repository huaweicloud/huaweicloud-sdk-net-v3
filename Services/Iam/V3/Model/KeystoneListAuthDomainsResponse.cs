...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class KeystoneListAuthDomainsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as KeystoneListAuthDomainsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneListAuthDomainsResponse input)
        {
            if (input == null)
                return false;

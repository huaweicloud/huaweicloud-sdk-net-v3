...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdateDomainPasswordPolicyRequest 
    {
        ...
        public UpdateDomainPasswordPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDomainPasswordPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainPasswordPolicyRequest input)
        {

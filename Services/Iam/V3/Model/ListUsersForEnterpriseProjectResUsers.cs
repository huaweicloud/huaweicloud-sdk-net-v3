...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class ListUsersForEnterpriseProjectResUsers 
    {
        ...
        public bool Equals(ListUsersForEnterpriseProjectResUsers input)
        {
            ...
            if (this.LastestPolicyTime != input.LastestPolicyTime || (this.LastestPolicyTime != null && !this.LastestPolicyTime.Equals(input.LastestPolicyTime))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastestPolicyTime != null) hashCode = hashCode * 59 + this.LastestPolicyTime.GetHashCode();
                return hashCode;
            }
        }
    }

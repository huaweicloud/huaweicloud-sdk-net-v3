...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class KeystoneListPermissionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as KeystoneListPermissionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneListPermissionsResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class ShowPolicyRoleResult 
    {
        ...
        {
            return this.Equals(input as ShowPolicyRoleResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPolicyRoleResult input)
        {
            if (input == null) return false;
            if (this.DomainId != input.DomainId || (this.DomainId != null && !this.DomainId.Equals(input.DomainId))) return false;
            if (this.References != input.References || (this.References != null && !this.References.Equals(input.References))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.References != null) hashCode = hashCode * 59 + this.References.GetHashCode();

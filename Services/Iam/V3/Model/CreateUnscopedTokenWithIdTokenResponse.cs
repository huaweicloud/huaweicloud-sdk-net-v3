...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateUnscopedTokenWithIdTokenResponse : SdkResponse
    {
        ...
        public UnscopedTokenInfo Token { get; set; }
        ...
        {
            return this.Equals(input as CreateUnscopedTokenWithIdTokenResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateUnscopedTokenWithIdTokenResponse input)
        {
            if (input == null)
                return false;

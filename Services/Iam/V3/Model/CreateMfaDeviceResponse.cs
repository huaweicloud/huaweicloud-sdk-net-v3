...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateMfaDeviceResponse : SdkResponse
    {
        ...
        public CreateMfaDeviceRespon VirtualMfaDevice { get; set; }
        ...
        {
            return this.Equals(input as CreateMfaDeviceResponse);
        }

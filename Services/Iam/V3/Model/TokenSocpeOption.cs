...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class TokenSocpeOption 
    {
        ...
        public ScopeDomainOption Domain { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("project", NullValueHandling = NullValueHandling.Ignore)]
        public ScopeProjectOption Project { get; set; }
        ...
        {
            return this.Equals(input as TokenSocpeOption);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(TokenSocpeOption input)
        {

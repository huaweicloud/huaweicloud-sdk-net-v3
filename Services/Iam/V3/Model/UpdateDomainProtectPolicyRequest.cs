...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdateDomainProtectPolicyRequest 
    {
        ...
        public UpdateDomainProtectPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDomainProtectPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainProtectPolicyRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class KeystoneCreateScopedTokenRequestBody 
    {
        ...
        public ScopedTokenAuth Auth { get; set; }
        ...
        {
            return this.Equals(input as KeystoneCreateScopedTokenRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneCreateScopedTokenRequestBody input)
        {
            if (input == null)
                return false;

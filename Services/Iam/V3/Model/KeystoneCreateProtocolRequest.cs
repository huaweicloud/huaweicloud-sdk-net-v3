...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class KeystoneCreateProtocolRequest 
    {
        ...
        public KeystoneCreateProtocolRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as KeystoneCreateProtocolRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneCreateProtocolRequest input)
        {
            if (input == null)
                return false;

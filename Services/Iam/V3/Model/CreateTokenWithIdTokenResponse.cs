...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTokenWithIdTokenResponse : SdkResponse
    {
        ...
        public ScopedTokenInfo Token { get; set; }
        ...
        {
            return this.Equals(input as CreateTokenWithIdTokenResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTokenWithIdTokenResponse input)
        {
            if (input == null)
                return false;

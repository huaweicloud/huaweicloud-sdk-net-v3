...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTemporaryAccessKeyByAgencyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTemporaryAccessKeyByAgencyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTemporaryAccessKeyByAgencyResponse input)
        {
            if (input == null)
                return false;

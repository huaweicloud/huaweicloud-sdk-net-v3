...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class KeystoneUpdateGroupRequest 
    {
        ...
        public KeystoneUpdateGroupRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as KeystoneUpdateGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneUpdateGroupRequest input)
        {
            if (input == null)
                return false;

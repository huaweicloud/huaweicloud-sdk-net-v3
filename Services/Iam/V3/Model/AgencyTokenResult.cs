...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class AgencyTokenResult 
    {
        ...
        public AgencyAssumedby AssumedBy { get; set; }
        ...
        public AgencyTokenDomain Domain { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("project", NullValueHandling = NullValueHandling.Ignore)]
        public AgencyTokenProject Project { get; set; }
        ...
        public AgencyTokenUser User { get; set; }
        ...
        {
            return this.Equals(input as AgencyTokenResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AgencyTokenResult input)
        {
            if (input == null)
                return false;

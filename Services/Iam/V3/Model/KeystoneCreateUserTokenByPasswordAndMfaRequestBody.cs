...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class KeystoneCreateUserTokenByPasswordAndMfaRequestBody 
    {
        ...
        {
            return this.Equals(input as KeystoneCreateUserTokenByPasswordAndMfaRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneCreateUserTokenByPasswordAndMfaRequestBody input)
        {
            if (input == null)
                return false;

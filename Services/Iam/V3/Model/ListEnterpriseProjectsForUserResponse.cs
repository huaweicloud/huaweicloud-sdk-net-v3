...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListEnterpriseProjectsForUserResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListEnterpriseProjectsForUserResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListEnterpriseProjectsForUserResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdatePermanentAccessKeyRequestBody 
    {
        ...
        public UpdateCredentialOption Credential { get; set; }
        ...
        {
            return this.Equals(input as UpdatePermanentAccessKeyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePermanentAccessKeyRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class KeystoneCreateUserTokenByPasswordAndMfaResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as KeystoneCreateUserTokenByPasswordAndMfaResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneCreateUserTokenByPasswordAndMfaResponse input)
        {
            if (input == null)
                return false;

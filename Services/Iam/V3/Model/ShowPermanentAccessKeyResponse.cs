...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPermanentAccessKeyResponse : SdkResponse
    {
        ...
        public ShowCredential Credential { get; set; }
        ...
        {
            return this.Equals(input as ShowPermanentAccessKeyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPermanentAccessKeyResponse input)
        {
            if (input == null)
                return false;

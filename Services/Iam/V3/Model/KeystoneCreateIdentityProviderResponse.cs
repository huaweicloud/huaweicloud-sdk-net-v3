...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class KeystoneCreateIdentityProviderResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as KeystoneCreateIdentityProviderResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneCreateIdentityProviderResponse input)
        {
            if (input == null)
                return false;

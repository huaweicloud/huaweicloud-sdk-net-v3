...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdateDomainConsoleAclPolicyRequest 
    {
        ...
        public UpdateDomainConsoleAclPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDomainConsoleAclPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainConsoleAclPolicyRequest input)
        {

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdateAgencyCustomPolicyRequest 
    {
        ...
        public UpdateAgencyCustomPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateAgencyCustomPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAgencyCustomPolicyRequest input)
        {
            if (input == null)
                return false;

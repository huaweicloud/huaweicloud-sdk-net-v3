...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    public class UpdateDomainApiAclPolicyRequest 
    {
        ...
        public UpdateDomainApiAclPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDomainApiAclPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDomainApiAclPolicyRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class KeystoneListAuthProjectsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as KeystoneListAuthProjectsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(KeystoneListAuthProjectsResponse input)
        {
            if (input == null)
                return false;

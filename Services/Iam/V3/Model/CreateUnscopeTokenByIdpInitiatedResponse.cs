...
namespace HuaweiCloud.SDK.Iam.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateUnscopeTokenByIdpInitiatedResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateUnscopeTokenByIdpInitiatedResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateUnscopeTokenByIdpInitiatedResponse input)
        {

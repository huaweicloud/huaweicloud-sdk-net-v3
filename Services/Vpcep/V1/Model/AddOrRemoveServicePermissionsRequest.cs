...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class AddOrRemoveServicePermissionsRequest 
    {
        ...
        public AddOrRemoveServicePermissionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddOrRemoveServicePermissionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddOrRemoveServicePermissionsRequest input)
        {

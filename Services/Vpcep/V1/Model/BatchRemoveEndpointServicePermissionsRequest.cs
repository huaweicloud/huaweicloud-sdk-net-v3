...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class BatchRemoveEndpointServicePermissionsRequest 
    {
        ...
        public BatchRemoveEndpointServicePermissionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchRemoveEndpointServicePermissionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRemoveEndpointServicePermissionsRequest input)
        {
            if (input == null)
                return false;

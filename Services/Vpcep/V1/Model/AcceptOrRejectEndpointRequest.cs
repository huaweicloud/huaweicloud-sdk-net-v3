...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class AcceptOrRejectEndpointRequest 
    {
        ...
        public AcceptOrRejectEndpointRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AcceptOrRejectEndpointRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AcceptOrRejectEndpointRequest input)
        {

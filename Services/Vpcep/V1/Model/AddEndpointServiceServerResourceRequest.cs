...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class AddEndpointServiceServerResourceRequest 
    {
        ...
        public AddEndpointServiceServerResourceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddEndpointServiceServerResourceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddEndpointServiceServerResourceRequest input)
        {

...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateEndpointConnectionsDescResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateEndpointConnectionsDescResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateEndpointConnectionsDescResponse input)
        {
            if (input == null)
                return false;

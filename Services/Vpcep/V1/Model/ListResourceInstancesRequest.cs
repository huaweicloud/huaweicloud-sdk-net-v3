...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class ListResourceInstancesRequest 
    {
        ...
        /// </summary>
        /// <value>资源类型，值为：endpoint_service或endpoint。 - endpoint_service：云服务器，适用于作为服务器使用。 - endpoint：虚拟IP，适用于作为虚IP场景使用</value>
        ...
        public QueryResourceInstanceTagsBody Body { get; set; }

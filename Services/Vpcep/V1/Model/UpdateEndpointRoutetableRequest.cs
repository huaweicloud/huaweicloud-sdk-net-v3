...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class UpdateEndpointRoutetableRequest 
    {
        ...
        public UpdateEndpointRoutetableRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateEndpointRoutetableRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateEndpointRoutetableRequest input)
        {
            if (input == null)
                return false;

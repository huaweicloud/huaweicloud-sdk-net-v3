...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class UpdateEndpointServiceRequest 
    {
        ...
        public UpdateEndpointServiceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateEndpointServiceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateEndpointServiceRequest input)
        {

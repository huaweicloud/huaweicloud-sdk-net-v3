...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListEndpointInfoDetailsResponse : SdkResponse
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>终端节点是否可用。 ● enable：启用 ● disable：不启用</value>
        [JsonConverter(typeof(EnumClassConverter<EnableStatusEnum>))]
        public class EnableStatusEnum
        {
            /// <summary>
            /// Enum ENABLE for value: enable
            /// </summary>
            public static readonly EnableStatusEnum ENABLE = new EnableStatusEnum("enable");

            /// <summary>
            /// Enum DISABLE for value: disable
            /// </summary>
            public static readonly EnableStatusEnum DISABLE = new EnableStatusEnum("disable");

            private static readonly Dictionary<string, EnableStatusEnum> StaticFields =
            new Dictionary<string, EnableStatusEnum>()
            {
                { "enable", ENABLE },
                { "disable", DISABLE },
            };
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as EnableStatusEnum))
                {
                    return true;
                }
            ...
            public bool Equals(EnableStatusEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(EnableStatusEnum a, EnableStatusEnum b)
            {
                if (System.Object.ReferenceEquals(a, b))
                {
                    return true;
        ...
        {
            return this.Equals(input as ListEndpointInfoDetailsResponse);
        }

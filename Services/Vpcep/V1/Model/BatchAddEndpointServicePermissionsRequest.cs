...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class BatchAddEndpointServicePermissionsRequest 
    {
        ...
        public BatchAddEndpointServicePermissionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAddEndpointServicePermissionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddEndpointServicePermissionsRequest input)
        {
            if (input == null)
                return false;

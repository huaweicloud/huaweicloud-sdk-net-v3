...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class UpdateEndpointServiceNameRequest 
    {
        ...
        public UpdateEndpointServiceNameRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateEndpointServiceNameRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateEndpointServiceNameRequest input)
        {

...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteEndpointPolicyResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeleteEndpointPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteEndpointPolicyResponse input)
        {
            if (input == null)
                return false;

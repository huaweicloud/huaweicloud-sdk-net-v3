...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListServiceDetailsResponse : SdkResponse
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>终端节点服务类型。 终端节点服务类型包括“网关（gataway）型”和“接口（interface）型”： ● gataway：由运维人员配置。用户无需创建，可直接使用。 ● interface：包括运维人员配置的云服务和用户自己创建的私有服务。 其中，运维人员配置的云服务无需创建，用户可直接使用。 您可以通过创建终端节点创建访问Gateway和Interface类型终端节点服务的终端节。</value>
        ...
        public class ServiceTypeEnum
        {
            ...
            /// </summary>
            public static readonly ServiceTypeEnum GATAWAY = new ServiceTypeEnum("gataway");
        ...
        {
            return this.Equals(input as ListServiceDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListServiceDetailsResponse input)
        {
            if (input == null)
                return false;

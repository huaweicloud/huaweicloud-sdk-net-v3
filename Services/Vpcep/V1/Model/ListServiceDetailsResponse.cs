...
namespace HuaweiCloud.SDK.Vpcep.V1.Model
{
    ...
    public class ListServiceDetailsResponse : SdkResponse
    {
        ...
        public bool Equals(ListServiceDetailsResponse input)
        {
            ...
            if (this.CidrType != input.CidrType || (this.CidrType != null && !this.CidrType.Equals(input.CidrType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CidrType != null) hashCode = hashCode * 59 + this.CidrType.GetHashCode();

...
namespace HuaweiCloud.SDK.Kps.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ImportPrivateKeyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ImportPrivateKeyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportPrivateKeyResponse input)
        {
            if (input == null)
                return false;

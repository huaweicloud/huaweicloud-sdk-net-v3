...
namespace HuaweiCloud.SDK.Kps.V3.Model
{
    ...
    public class ImportPrivateKeyRequestBody 
    {
        ...
        public ImportPrivateKeyKeypairBean Keypair { get; set; }
        ...
        {
            return this.Equals(input as ImportPrivateKeyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportPrivateKeyRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Kps.V3.Model
{
    ...
    public class ImportPrivateKeyKeypairBean 
    {
        ...
        public ImportPrivateKeyProtection KeyProtection { get; set; }
        ...
        {
            return this.Equals(input as ImportPrivateKeyKeypairBean);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportPrivateKeyKeypairBean input)
        {

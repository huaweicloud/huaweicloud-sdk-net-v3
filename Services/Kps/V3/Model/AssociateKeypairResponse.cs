...
namespace HuaweiCloud.SDK.Kps.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateKeypairResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AssociateKeypairResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateKeypairResponse input)
        {

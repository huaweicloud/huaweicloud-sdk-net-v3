...
namespace HuaweiCloud.SDK.Bms.V1.Model
{
    ...
    public class CreateSchedulerHints 
    {
        ...
        /// </summary>
        /// <value>是否在专属云中创建裸金属服务器，参数值为share或dedicate。约束：该值不传时默认为share。在专属云中创建裸金属服务器时，必须指定该字段为dedicate。</value>
        ...
        public DecBaremetalEnum DecBaremetal { get; set; }
        ...
        {
            return this.Equals(input as CreateSchedulerHints);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSchedulerHints input)
        {
            if (input == null) return false;
            if (this.DecBaremetal != input.DecBaremetal) return false;

...
namespace HuaweiCloud.SDK.Bms.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowBaremetalServerMetadataOptionsResponse : SdkResponse
    {
        /// <summary>
        /// 是否禁用IMDS服务。
        /// </summary>
        ...
        {
            return this.Equals(input as ShowBaremetalServerMetadataOptionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBaremetalServerMetadataOptionsResponse input)
        {

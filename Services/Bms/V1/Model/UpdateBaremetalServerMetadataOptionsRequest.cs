...
namespace HuaweiCloud.SDK.Bms.V1.Model
{
    ...
    public class UpdateBaremetalServerMetadataOptionsRequest 
    {
        ...
        public UpdateBaremetalServerMetadataOptionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateBaremetalServerMetadataOptionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateBaremetalServerMetadataOptionsRequest input)
        {

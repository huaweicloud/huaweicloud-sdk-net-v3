...
namespace HuaweiCloud.SDK.Bms.V1.Model
{
    ...
    public class FlavorsResp 
    {
        ...
        public bool Equals(FlavorsResp input)
        {
            ...
            if (this.OsExtraSpecs != input.OsExtraSpecs || (this.OsExtraSpecs != null && !this.OsExtraSpecs.Equals(input.OsExtraSpecs))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OsExtraSpecs != null) hashCode = hashCode * 59 + this.OsExtraSpecs.GetHashCode();
                return hashCode;
            }
        }
    }

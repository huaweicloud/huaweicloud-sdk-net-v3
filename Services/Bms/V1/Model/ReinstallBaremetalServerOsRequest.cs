...
namespace HuaweiCloud.SDK.Bms.V1.Model
{
    ...
    public class ReinstallBaremetalServerOsRequest 
    {
        ...
        public OsReinstallBody Body { get; set; }
        ...
        {
            return this.Equals(input as ReinstallBaremetalServerOsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ReinstallBaremetalServerOsRequest input)
        {

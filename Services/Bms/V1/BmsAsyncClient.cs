...
namespace HuaweiCloud.SDK.Bms.V1
{
    public partial class BmsAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteBaremetalServerResponse> DeleteBaremetalServerAsync(DeleteBaremetalServerRequest deleteBaremetalServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteBaremetalServerResponse> DeleteBaremetalServerAsyncInvoker(DeleteBaremetalServerRequest deleteBaremetalServerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/baremetalservers/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteBaremetalServerRequest);
            return new AsyncInvoker<DeleteBaremetalServerResponse>(this, "POST", request, JsonUtils.DeSerialize<DeleteBaremetalServerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListBareMetalServersDetailResponse> ListBareMetalServersDetailAsync(ListBareMetalServersDetailRequest listBareMetalServersDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListBareMetalServersDetailResponse> ListBareMetalServersDetailAsyncInvoker(ListBareMetalServersDetailRequest listBareMetalServersDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1.1/{project_id}/baremetalservers/detail", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listBareMetalServersDetailRequest);
            return new AsyncInvoker<ListBareMetalServersDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ListBareMetalServersDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyVmNicResponse> ModifyVmNicAsync(ModifyVmNicRequest modifyVmNicRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ModifyVmNicResponse> ModifyVmNicAsyncInvoker(ModifyVmNicRequest modifyVmNicRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyVmNicRequest.NicId, out var valueOfNicId)) urlParam.Add("nic_id", valueOfNicId);
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/baremetalservers/nics/{nic_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyVmNicRequest);
            return new AsyncInvoker<ModifyVmNicResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyVmNicResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowAvailableResourceResponse> ShowAvailableResourceAsync(ShowAvailableResourceRequest showAvailableResourceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowAvailableResourceResponse> ShowAvailableResourceAsyncInvoker(ShowAvailableResourceRequest showAvailableResourceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/baremetalservers/available_resource", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAvailableResourceRequest);
            return new AsyncInvoker<ShowAvailableResourceResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAvailableResourceResponse>);
        }

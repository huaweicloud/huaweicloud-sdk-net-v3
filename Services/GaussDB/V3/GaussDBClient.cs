...
namespace HuaweiCloud.SDK.GaussDB.V3
{
    public partial class GaussDBClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchChangeInstanceSpecificationResponse BatchChangeInstanceSpecification(BatchChangeInstanceSpecificationRequest batchChangeInstanceSpecificationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchChangeInstanceSpecificationResponse> BatchChangeInstanceSpecificationInvoker(BatchChangeInstanceSpecificationRequest batchChangeInstanceSpecificationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch/flavor", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchChangeInstanceSpecificationRequest);
            return new SyncInvoker<BatchChangeInstanceSpecificationResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchChangeInstanceSpecificationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDeleteBackupResponse BatchDeleteBackup(BatchDeleteBackupRequest batchDeleteBackupRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDeleteBackupResponse> BatchDeleteBackupInvoker(BatchDeleteBackupRequest batchDeleteBackupRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchDeleteBackupRequest);
            return new SyncInvoker<BatchDeleteBackupResponse>(this, "DELETE", request, JsonUtils.DeSerialize<BatchDeleteBackupResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchUpdateBackupPolicyResponse BatchUpdateBackupPolicy(BatchUpdateBackupPolicyRequest batchUpdateBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchUpdateBackupPolicyResponse> BatchUpdateBackupPolicyInvoker(BatchUpdateBackupPolicyRequest batchUpdateBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/backups/policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchUpdateBackupPolicyRequest);
            return new SyncInvoker<BatchUpdateBackupPolicyResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchUpdateBackupPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchUpgradeDatabasesResponse BatchUpgradeDatabases(BatchUpgradeDatabasesRequest batchUpgradeDatabasesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchUpgradeDatabasesResponse> BatchUpgradeDatabasesInvoker(BatchUpgradeDatabasesRequest batchUpgradeDatabasesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchUpgradeDatabasesRequest);
            return new SyncInvoker<BatchUpgradeDatabasesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchUpgradeDatabasesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckKernelUpgradeResponse CheckKernelUpgrade(CheckKernelUpgradeRequest checkKernelUpgradeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckKernelUpgradeResponse> CheckKernelUpgradeInvoker(CheckKernelUpgradeRequest checkKernelUpgradeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade/pre-check", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", checkKernelUpgradeRequest);
            return new SyncInvoker<CheckKernelUpgradeResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckKernelUpgradeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckScheduleTaskExistResponse CheckScheduleTaskExist(CheckScheduleTaskExistRequest checkScheduleTaskExistRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckScheduleTaskExistResponse> CheckScheduleTaskExistInvoker(CheckScheduleTaskExistRequest checkScheduleTaskExistRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(checkScheduleTaskExistRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/schedule-tasks/exist", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", checkScheduleTaskExistRequest);
            return new SyncInvoker<CheckScheduleTaskExistResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckScheduleTaskExistResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ClearOnlineDdlTaskTempTableResponse ClearOnlineDdlTaskTempTable(ClearOnlineDdlTaskTempTableRequest clearOnlineDdlTaskTempTableRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ClearOnlineDdlTaskTempTableResponse> ClearOnlineDdlTaskTempTableInvoker(ClearOnlineDdlTaskTempTableRequest clearOnlineDdlTaskTempTableRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(clearOnlineDdlTaskTempTableRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/clear", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", clearOnlineDdlTaskTempTableRequest);
            return new SyncInvoker<ClearOnlineDdlTaskTempTableResponse>(this, "POST", request, JsonUtils.DeSerialize<ClearOnlineDdlTaskTempTableResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CollectRealtimeSessionResponse CollectRealtimeSession(CollectRealtimeSessionRequest collectRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CollectRealtimeSessionResponse> CollectRealtimeSessionInvoker(CollectRealtimeSessionRequest collectRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(collectRealtimeSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(collectRealtimeSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", collectRealtimeSessionRequest);
            return new SyncInvoker<CollectRealtimeSessionResponse>(this, "POST", request, JsonUtils.DeSerialize<CollectRealtimeSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateBackupResourcePackageResponse CreateBackupResourcePackage(CreateBackupResourcePackageRequest createBackupResourcePackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateBackupResourcePackageResponse> CreateBackupResourcePackageInvoker(CreateBackupResourcePackageRequest createBackupResourcePackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/resource-package", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createBackupResourcePackageRequest);
            return new SyncInvoker<CreateBackupResourcePackageResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateBackupResourcePackageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteDynamicServerlessPolicyResponse DeleteDynamicServerlessPolicy(DeleteDynamicServerlessPolicyRequest deleteDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteDynamicServerlessPolicyResponse> DeleteDynamicServerlessPolicyInvoker(DeleteDynamicServerlessPolicyRequest deleteDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteDynamicServerlessPolicyRequest);
            return new SyncInvoker<DeleteDynamicServerlessPolicyResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteDynamicServerlessPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteOnlineDdlTaskRecordResponse DeleteOnlineDdlTaskRecord(DeleteOnlineDdlTaskRecordRequest deleteOnlineDdlTaskRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteOnlineDdlTaskRecordResponse> DeleteOnlineDdlTaskRecordInvoker(DeleteOnlineDdlTaskRecordRequest deleteOnlineDdlTaskRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteOnlineDdlTaskRecordRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteOnlineDdlTaskRecordRequest);
            return new SyncInvoker<DeleteOnlineDdlTaskRecordResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteOnlineDdlTaskRecordResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DownloadDdlLogsResponse DownloadDdlLogs(DownloadDdlLogsRequest downloadDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DownloadDdlLogsResponse> DownloadDdlLogsInvoker(DownloadDdlLogsRequest downloadDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadDdlLogsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", downloadDdlLogsRequest);
            return new SyncInvoker<DownloadDdlLogsResponse>(this, "POST", request, JsonUtils.DeSerialize<DownloadDdlLogsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DownloadOnlineDdlTaskLogResponse DownloadOnlineDdlTaskLog(DownloadOnlineDdlTaskLogRequest downloadOnlineDdlTaskLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DownloadOnlineDdlTaskLogResponse> DownloadOnlineDdlTaskLogInvoker(DownloadOnlineDdlTaskLogRequest downloadOnlineDdlTaskLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadOnlineDdlTaskLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/log/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", downloadOnlineDdlTaskLogRequest);
            return new SyncInvoker<DownloadOnlineDdlTaskLogResponse>(this, "POST", request, JsonUtils.DeSerialize<DownloadOnlineDdlTaskLogResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DownloadRealtimeSessionResponse DownloadRealtimeSession(DownloadRealtimeSessionRequest downloadRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DownloadRealtimeSessionResponse> DownloadRealtimeSessionInvoker(DownloadRealtimeSessionRequest downloadRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadRealtimeSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(downloadRealtimeSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session-result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadRealtimeSessionRequest);
            return new SyncInvoker<DownloadRealtimeSessionResponse>(this, "GET", request, JsonUtils.DeSerialize<DownloadRealtimeSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExecuteIntelligentKillSessionResponse ExecuteIntelligentKillSession(ExecuteIntelligentKillSessionRequest executeIntelligentKillSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExecuteIntelligentKillSessionResponse> ExecuteIntelligentKillSessionInvoker(ExecuteIntelligentKillSessionRequest executeIntelligentKillSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(executeIntelligentKillSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", executeIntelligentKillSessionRequest);
            return new SyncInvoker<ExecuteIntelligentKillSessionResponse>(this, "POST", request, JsonUtils.DeSerialize<ExecuteIntelligentKillSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListColdTableMetasResponse ListColdTableMetas(ListColdTableMetasRequest listColdTableMetasRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListColdTableMetasResponse> ListColdTableMetasInvoker(ListColdTableMetasRequest listColdTableMetasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listColdTableMetasRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3.1/{project_id}/instances/{instance_id}/cold-tables/meta", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listColdTableMetasRequest);
            return new SyncInvoker<ListColdTableMetasResponse>(this, "GET", request, JsonUtils.DeSerialize<ListColdTableMetasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDdlLogsResponse ListDdlLogs(ListDdlLogsRequest listDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDdlLogsResponse> ListDdlLogsInvoker(ListDdlLogsRequest listDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDdlLogsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDdlLogsRequest);
            return new SyncInvoker<ListDdlLogsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDdlLogsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListIntelligentKillSessionHistoryResponse ListIntelligentKillSessionHistory(ListIntelligentKillSessionHistoryRequest listIntelligentKillSessionHistoryRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListIntelligentKillSessionHistoryResponse> ListIntelligentKillSessionHistoryInvoker(ListIntelligentKillSessionHistoryRequest listIntelligentKillSessionHistoryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listIntelligentKillSessionHistoryRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session/history", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIntelligentKillSessionHistoryRequest);
            return new SyncInvoker<ListIntelligentKillSessionHistoryResponse>(this, "GET", request, JsonUtils.DeSerialize<ListIntelligentKillSessionHistoryResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListOnlineDdlTaskRecordsResponse ListOnlineDdlTaskRecords(ListOnlineDdlTaskRecordsRequest listOnlineDdlTaskRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListOnlineDdlTaskRecordsResponse> ListOnlineDdlTaskRecordsInvoker(ListOnlineDdlTaskRecordsRequest listOnlineDdlTaskRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listOnlineDdlTaskRecordsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/operation-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOnlineDdlTaskRecordsRequest);
            return new SyncInvoker<ListOnlineDdlTaskRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListOnlineDdlTaskRecordsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ModifyBackupVaultLockResponse ModifyBackupVaultLock(ModifyBackupVaultLockRequest modifyBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ModifyBackupVaultLockResponse> ModifyBackupVaultLockInvoker(ModifyBackupVaultLockRequest modifyBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyBackupVaultLockRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/vault-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyBackupVaultLockRequest);
            return new SyncInvoker<ModifyBackupVaultLockResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyBackupVaultLockResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SetAutoSqlLimitingResponse SetAutoSqlLimiting(SetAutoSqlLimitingRequest setAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SetAutoSqlLimitingResponse> SetAutoSqlLimitingInvoker(SetAutoSqlLimitingRequest setAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setAutoSqlLimitingRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/auto-sql-limiting", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setAutoSqlLimitingRequest);
            return new SyncInvoker<SetAutoSqlLimitingResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetAutoSqlLimitingResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SetDdlLogPolicyResponse SetDdlLogPolicy(SetDdlLogPolicyRequest setDdlLogPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SetDdlLogPolicyResponse> SetDdlLogPolicyInvoker(SetDdlLogPolicyRequest setDdlLogPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setDdlLogPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setDdlLogPolicyRequest);
            return new SyncInvoker<SetDdlLogPolicyResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetDdlLogPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SetInstanceReadonlyStatusResponse SetInstanceReadonlyStatus(SetInstanceReadonlyStatusRequest setInstanceReadonlyStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SetInstanceReadonlyStatusResponse> SetInstanceReadonlyStatusInvoker(SetInstanceReadonlyStatusRequest setInstanceReadonlyStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setInstanceReadonlyStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/readonly-status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setInstanceReadonlyStatusRequest);
            return new SyncInvoker<SetInstanceReadonlyStatusResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetInstanceReadonlyStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SetInstanceScheduleEventsResponse SetInstanceScheduleEvents(SetInstanceScheduleEventsRequest setInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SetInstanceScheduleEventsResponse> SetInstanceScheduleEventsInvoker(SetInstanceScheduleEventsRequest setInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setInstanceScheduleEventsRequest);
            return new SyncInvoker<SetInstanceScheduleEventsResponse>(this, "POST", request, JsonUtils.DeSerialize<SetInstanceScheduleEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoSqlLimitingLogResponse ShowAutoSqlLimitingLog(ShowAutoSqlLimitingLogRequest showAutoSqlLimitingLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoSqlLimitingLogResponse> ShowAutoSqlLimitingLogInvoker(ShowAutoSqlLimitingLogRequest showAutoSqlLimitingLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAutoSqlLimitingLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showAutoSqlLimitingLogRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/auto-sql-limiting/log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoSqlLimitingLogRequest);
            return new SyncInvoker<ShowAutoSqlLimitingLogResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoSqlLimitingLogResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowBackupResourcePackageFlavorsResponse ShowBackupResourcePackageFlavors(ShowBackupResourcePackageFlavorsRequest showBackupResourcePackageFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowBackupResourcePackageFlavorsResponse> ShowBackupResourcePackageFlavorsInvoker(ShowBackupResourcePackageFlavorsRequest showBackupResourcePackageFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/resource-package/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupResourcePackageFlavorsRequest);
            return new SyncInvoker<ShowBackupResourcePackageFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowBackupResourcePackageFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowBackupVaultLockResponse ShowBackupVaultLock(ShowBackupVaultLockRequest showBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowBackupVaultLockResponse> ShowBackupVaultLockInvoker(ShowBackupVaultLockRequest showBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showBackupVaultLockRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/vault-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupVaultLockRequest);
            return new SyncInvoker<ShowBackupVaultLockResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowBackupVaultLockResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowDynamicServerlessPolicyResponse ShowDynamicServerlessPolicy(ShowDynamicServerlessPolicyRequest showDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowDynamicServerlessPolicyResponse> ShowDynamicServerlessPolicyInvoker(ShowDynamicServerlessPolicyRequest showDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDynamicServerlessPolicyRequest);
            return new SyncInvoker<ShowDynamicServerlessPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDynamicServerlessPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowHistoricalSqlFilterRuleResponse ShowHistoricalSqlFilterRule(ShowHistoricalSqlFilterRuleRequest showHistoricalSqlFilterRuleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowHistoricalSqlFilterRuleResponse> ShowHistoricalSqlFilterRuleInvoker(ShowHistoricalSqlFilterRuleRequest showHistoricalSqlFilterRuleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHistoricalSqlFilterRuleRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/sql-filter/history-rules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHistoricalSqlFilterRuleRequest);
            return new SyncInvoker<ShowHistoricalSqlFilterRuleResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHistoricalSqlFilterRuleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowInstanceScheduleEventsResponse ShowInstanceScheduleEvents(ShowInstanceScheduleEventsRequest showInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
        ...
        public SyncInvoker<ShowInstanceScheduleEventsResponse> ShowInstanceScheduleEventsInvoker(ShowInstanceScheduleEventsRequest showInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInstanceScheduleEventsRequest);
            return new SyncInvoker<ShowInstanceScheduleEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInstanceScheduleEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowIntelligentKillSessionStatisticResponse ShowIntelligentKillSessionStatistic(ShowIntelligentKillSessionStatisticRequest showIntelligentKillSessionStatisticRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowIntelligentKillSessionStatisticResponse> ShowIntelligentKillSessionStatisticInvoker(ShowIntelligentKillSessionStatisticRequest showIntelligentKillSessionStatisticRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showIntelligentKillSessionStatisticRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session/statistic", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowKernelUpgradeCheckResultResponse ShowKernelUpgradeCheckResult(ShowKernelUpgradeCheckResultRequest showKernelUpgradeCheckResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowKernelUpgradeCheckResultResponse> ShowKernelUpgradeCheckResultInvoker(ShowKernelUpgradeCheckResultRequest showKernelUpgradeCheckResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade/pre-check-result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showKernelUpgradeCheckResultRequest);
            return new SyncInvoker<ShowKernelUpgradeCheckResultResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowKernelUpgradeCheckResultResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowLockWaitSessionResponse ShowLockWaitSession(ShowLockWaitSessionRequest showLockWaitSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowLockWaitSessionResponse> ShowLockWaitSessionInvoker(ShowLockWaitSessionRequest showLockWaitSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showLockWaitSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showLockWaitSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/process/lock-wait", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showLockWaitSessionRequest);
            return new SyncInvoker<ShowLockWaitSessionResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowLockWaitSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowProxyFlavorsByAzCodeResponse ShowProxyFlavorsByAzCode(ShowProxyFlavorsByAzCodeRequest showProxyFlavorsByAzCodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowProxyFlavorsByAzCodeResponse> ShowProxyFlavorsByAzCodeInvoker(ShowProxyFlavorsByAzCodeRequest showProxyFlavorsByAzCodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/proxy/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showProxyFlavorsByAzCodeRequest);
            return new SyncInvoker<ShowProxyFlavorsByAzCodeResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowProxyFlavorsByAzCodeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowRealtimeSessionTaskStatusResponse ShowRealtimeSessionTaskStatus(ShowRealtimeSessionTaskStatusRequest showRealtimeSessionTaskStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowRealtimeSessionTaskStatusResponse> ShowRealtimeSessionTaskStatusInvoker(ShowRealtimeSessionTaskStatusRequest showRealtimeSessionTaskStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRealtimeSessionTaskStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showRealtimeSessionTaskStatusRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRealtimeSessionTaskStatusRequest);
            return new SyncInvoker<ShowRealtimeSessionTaskStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRealtimeSessionTaskStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSlowLogDetailResponse ShowSlowLogDetail(ShowSlowLogDetailRequest showSlowLogDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSlowLogDetailResponse> ShowSlowLogDetailInvoker(ShowSlowLogDetailRequest showSlowLogDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSlowLogDetailRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/starrocks/slow-logs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showSlowLogDetailRequest);
            return new SyncInvoker<ShowSlowLogDetailResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowSlowLogDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSqlAutoSqlLimitingResponse ShowSqlAutoSqlLimiting(ShowSqlAutoSqlLimitingRequest showSqlAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSqlAutoSqlLimitingResponse> ShowSqlAutoSqlLimitingInvoker(ShowSqlAutoSqlLimitingRequest showSqlAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSqlAutoSqlLimitingRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/auto-sql-limiting", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showSqlAutoSqlLimitingRequest);
            return new SyncInvoker<ShowSqlAutoSqlLimitingResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowSqlAutoSqlLimitingResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowStarRocksSlowlogSensitiveStatusResponse ShowStarRocksSlowlogSensitiveStatus(ShowStarRocksSlowlogSensitiveStatusRequest showStarRocksSlowlogSensitiveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowStarRocksSlowlogSensitiveStatusResponse> ShowStarRocksSlowlogSensitiveStatusInvoker(ShowStarRocksSlowlogSensitiveStatusRequest showStarRocksSlowlogSensitiveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showStarRocksSlowlogSensitiveStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/starrocks/slowlog-sensitive", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showStarRocksSlowlogSensitiveStatusRequest);
            return new SyncInvoker<ShowStarRocksSlowlogSensitiveStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowStarRocksSlowlogSensitiveStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTaurusDbAdvancedBackupPolicyResponse ShowTaurusDbAdvancedBackupPolicy(ShowTaurusDbAdvancedBackupPolicyRequest showTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTaurusDbAdvancedBackupPolicyResponse> ShowTaurusDbAdvancedBackupPolicyInvoker(ShowTaurusDbAdvancedBackupPolicyRequest showTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbAdvancedBackupPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/advanced-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTaurusDbAdvancedBackupPolicyRequest);
            return new SyncInvoker<ShowTaurusDbAdvancedBackupPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTaurusDbAdvancedBackupPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTaurusDbTxnProgressResponse ShowTaurusDbTxnProgress(ShowTaurusDbTxnProgressRequest showTaurusDbTxnProgressRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTaurusDbTxnProgressResponse> ShowTaurusDbTxnProgressInvoker(ShowTaurusDbTxnProgressRequest showTaurusDbTxnProgressRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbTxnProgressRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbTxnProgressRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/txn-progress", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showTaurusDbTxnProgressRequest);
            return new SyncInvoker<ShowTaurusDbTxnProgressResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowTaurusDbTxnProgressResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StartOnlineDdlTaskResponse StartOnlineDdlTask(StartOnlineDdlTaskRequest startOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StartOnlineDdlTaskResponse> StartOnlineDdlTaskInvoker(StartOnlineDdlTaskRequest startOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startOnlineDdlTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", startOnlineDdlTaskRequest);
            return new SyncInvoker<StartOnlineDdlTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<StartOnlineDdlTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public StopOnlineDdlTaskResponse StopOnlineDdlTask(StopOnlineDdlTaskRequest stopOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<StopOnlineDdlTaskResponse> StopOnlineDdlTaskInvoker(StopOnlineDdlTaskRequest stopOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopOnlineDdlTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", stopOnlineDdlTaskRequest);
            return new SyncInvoker<StopOnlineDdlTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<StopOnlineDdlTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SwitchGaussMySqlProxyAltResponse SwitchGaussMySqlProxyAlt(SwitchGaussMySqlProxyAltRequest switchGaussMySqlProxyAltRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SwitchGaussMySqlProxyAltResponse> SwitchGaussMySqlProxyAltInvoker(SwitchGaussMySqlProxyAltRequest switchGaussMySqlProxyAltRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchGaussMySqlProxyAltRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(switchGaussMySqlProxyAltRequest.ProxyId, out var valueOfProxyId)) urlParam.Add("proxy_id", valueOfProxyId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/proxy/{proxy_id}/alt", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", switchGaussMySqlProxyAltRequest);
            return new SyncInvoker<SwitchGaussMySqlProxyAltResponse>(this, "PUT", request, JsonUtils.DeSerialize<SwitchGaussMySqlProxyAltResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateDynamicServerlessPolicyResponse UpdateDynamicServerlessPolicy(UpdateDynamicServerlessPolicyRequest updateDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateDynamicServerlessPolicyResponse> UpdateDynamicServerlessPolicyInvoker(UpdateDynamicServerlessPolicyRequest updateDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateDynamicServerlessPolicyRequest);
            return new SyncInvoker<UpdateDynamicServerlessPolicyResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateDynamicServerlessPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateSlowlogSensitiveStatusResponse UpdateSlowlogSensitiveStatus(UpdateSlowlogSensitiveStatusRequest updateSlowlogSensitiveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateSlowlogSensitiveStatusResponse> UpdateSlowlogSensitiveStatusInvoker(UpdateSlowlogSensitiveStatusRequest updateSlowlogSensitiveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateSlowlogSensitiveStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/starrocks/slowlog-sensitive", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateSlowlogSensitiveStatusRequest);
            return new SyncInvoker<UpdateSlowlogSensitiveStatusResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateSlowlogSensitiveStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateTaurusDbAdvancedBackupPolicyResponse UpdateTaurusDbAdvancedBackupPolicy(UpdateTaurusDbAdvancedBackupPolicyRequest updateTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateTaurusDbAdvancedBackupPolicyResponse> UpdateTaurusDbAdvancedBackupPolicyInvoker(UpdateTaurusDbAdvancedBackupPolicyRequest updateTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateTaurusDbAdvancedBackupPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/advanced-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateTaurusDbAdvancedBackupPolicyRequest);
            return new SyncInvoker<UpdateTaurusDbAdvancedBackupPolicyResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateTaurusDbAdvancedBackupPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpgradeConfigurationResponse UpgradeConfiguration(UpgradeConfigurationRequest upgradeConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpgradeConfigurationResponse> UpgradeConfigurationInvoker(UpgradeConfigurationRequest upgradeConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(upgradeConfigurationRequest.ConfigurationId, out var valueOfConfigurationId)) urlParam.Add("configuration_id", valueOfConfigurationId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{configuration_id}/upgrade", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", upgradeConfigurationRequest);
            return new SyncInvoker<UpgradeConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpgradeConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowHtapLtsConfigResponse ShowHtapLtsConfig(ShowHtapLtsConfigRequest showHtapLtsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/starrocks/instances/logs/lts-configs", urlParam);
        ...
        public SyncInvoker<ShowHtapLtsConfigResponse> ShowHtapLtsConfigInvoker(ShowHtapLtsConfigRequest showHtapLtsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/starrocks/instances/logs/lts-configs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHtapLtsConfigRequest);

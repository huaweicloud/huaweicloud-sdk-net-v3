...
namespace HuaweiCloud.SDK.GaussDB.V3
{
    public partial class GaussDBAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchChangeInstanceSpecificationResponse> BatchChangeInstanceSpecificationAsync(BatchChangeInstanceSpecificationRequest batchChangeInstanceSpecificationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch/flavor", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchChangeInstanceSpecificationRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<BatchChangeInstanceSpecificationResponse>(response);
        }

        public AsyncInvoker<BatchChangeInstanceSpecificationResponse> BatchChangeInstanceSpecificationAsyncInvoker(BatchChangeInstanceSpecificationRequest batchChangeInstanceSpecificationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch/flavor", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchChangeInstanceSpecificationRequest);
            return new AsyncInvoker<BatchChangeInstanceSpecificationResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchChangeInstanceSpecificationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchUpdateBackupPolicyResponse> BatchUpdateBackupPolicyAsync(BatchUpdateBackupPolicyRequest batchUpdateBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/backups/policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchUpdateBackupPolicyRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<BatchUpdateBackupPolicyResponse>(response);
        }

        public AsyncInvoker<BatchUpdateBackupPolicyResponse> BatchUpdateBackupPolicyAsyncInvoker(BatchUpdateBackupPolicyRequest batchUpdateBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/backups/policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", batchUpdateBackupPolicyRequest);
            return new AsyncInvoker<BatchUpdateBackupPolicyResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchUpdateBackupPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CheckKernelUpgradeResponse> CheckKernelUpgradeAsync(CheckKernelUpgradeRequest checkKernelUpgradeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade/pre-check", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", checkKernelUpgradeRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CheckKernelUpgradeResponse>(response);
        }

        public AsyncInvoker<CheckKernelUpgradeResponse> CheckKernelUpgradeAsyncInvoker(CheckKernelUpgradeRequest checkKernelUpgradeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade/pre-check", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", checkKernelUpgradeRequest);
            return new AsyncInvoker<CheckKernelUpgradeResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckKernelUpgradeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CheckScheduleTaskExistResponse> CheckScheduleTaskExistAsync(CheckScheduleTaskExistRequest checkScheduleTaskExistRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(checkScheduleTaskExistRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/schedule-tasks/exist", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", checkScheduleTaskExistRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CheckScheduleTaskExistResponse>(response);
        }

        public AsyncInvoker<CheckScheduleTaskExistResponse> CheckScheduleTaskExistAsyncInvoker(CheckScheduleTaskExistRequest checkScheduleTaskExistRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(checkScheduleTaskExistRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/schedule-tasks/exist", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", checkScheduleTaskExistRequest);
            return new AsyncInvoker<CheckScheduleTaskExistResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckScheduleTaskExistResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ClearOnlineDdlTaskTempTableResponse> ClearOnlineDdlTaskTempTableAsync(ClearOnlineDdlTaskTempTableRequest clearOnlineDdlTaskTempTableRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(clearOnlineDdlTaskTempTableRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/clear", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", clearOnlineDdlTaskTempTableRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<ClearOnlineDdlTaskTempTableResponse>(response);
        }

        public AsyncInvoker<ClearOnlineDdlTaskTempTableResponse> ClearOnlineDdlTaskTempTableAsyncInvoker(ClearOnlineDdlTaskTempTableRequest clearOnlineDdlTaskTempTableRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(clearOnlineDdlTaskTempTableRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/clear", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", clearOnlineDdlTaskTempTableRequest);
            return new AsyncInvoker<ClearOnlineDdlTaskTempTableResponse>(this, "POST", request, JsonUtils.DeSerialize<ClearOnlineDdlTaskTempTableResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CollectRealtimeSessionResponse> CollectRealtimeSessionAsync(CollectRealtimeSessionRequest collectRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(collectRealtimeSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(collectRealtimeSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", collectRealtimeSessionRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CollectRealtimeSessionResponse>(response);
        }

        public AsyncInvoker<CollectRealtimeSessionResponse> CollectRealtimeSessionAsyncInvoker(CollectRealtimeSessionRequest collectRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(collectRealtimeSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(collectRealtimeSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", collectRealtimeSessionRequest);
            return new AsyncInvoker<CollectRealtimeSessionResponse>(this, "POST", request, JsonUtils.DeSerialize<CollectRealtimeSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateBackupResourcePackageResponse> CreateBackupResourcePackageAsync(CreateBackupResourcePackageRequest createBackupResourcePackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/resource-package", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createBackupResourcePackageRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CreateBackupResourcePackageResponse>(response);
        }

        public AsyncInvoker<CreateBackupResourcePackageResponse> CreateBackupResourcePackageAsyncInvoker(CreateBackupResourcePackageRequest createBackupResourcePackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/resource-package", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", createBackupResourcePackageRequest);
            return new AsyncInvoker<CreateBackupResourcePackageResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateBackupResourcePackageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteAutoSqlLimitingResponse> DeleteAutoSqlLimitingAsync(DeleteAutoSqlLimitingRequest deleteAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteAutoSqlLimitingResponse> DeleteAutoSqlLimitingAsyncInvoker(DeleteAutoSqlLimitingRequest deleteAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteAutoSqlLimitingRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(deleteAutoSqlLimitingRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/auto-sql-limiting", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteAutoSqlLimitingRequest);
            return new AsyncInvoker<DeleteAutoSqlLimitingResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteAutoSqlLimitingResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteDynamicServerlessPolicyResponse> DeleteDynamicServerlessPolicyAsync(DeleteDynamicServerlessPolicyRequest deleteDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteDynamicServerlessPolicyRequest);
            var response = await DoHttpRequestAsync("DELETE", request);
            return JsonUtils.DeSerialize<DeleteDynamicServerlessPolicyResponse>(response);
        }

        public AsyncInvoker<DeleteDynamicServerlessPolicyResponse> DeleteDynamicServerlessPolicyAsyncInvoker(DeleteDynamicServerlessPolicyRequest deleteDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteDynamicServerlessPolicyRequest);
            return new AsyncInvoker<DeleteDynamicServerlessPolicyResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteDynamicServerlessPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteOnlineDdlTaskRecordResponse> DeleteOnlineDdlTaskRecordAsync(DeleteOnlineDdlTaskRecordRequest deleteOnlineDdlTaskRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteOnlineDdlTaskRecordRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteOnlineDdlTaskRecordRequest);
            var response = await DoHttpRequestAsync("DELETE", request);
            return JsonUtils.DeSerialize<DeleteOnlineDdlTaskRecordResponse>(response);
        }

        public AsyncInvoker<DeleteOnlineDdlTaskRecordResponse> DeleteOnlineDdlTaskRecordAsyncInvoker(DeleteOnlineDdlTaskRecordRequest deleteOnlineDdlTaskRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteOnlineDdlTaskRecordRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteOnlineDdlTaskRecordRequest);
            return new AsyncInvoker<DeleteOnlineDdlTaskRecordResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteOnlineDdlTaskRecordResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DownloadDdlLogsResponse> DownloadDdlLogsAsync(DownloadDdlLogsRequest downloadDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadDdlLogsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", downloadDdlLogsRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<DownloadDdlLogsResponse>(response);
        }

        public AsyncInvoker<DownloadDdlLogsResponse> DownloadDdlLogsAsyncInvoker(DownloadDdlLogsRequest downloadDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadDdlLogsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", downloadDdlLogsRequest);
            return new AsyncInvoker<DownloadDdlLogsResponse>(this, "POST", request, JsonUtils.DeSerialize<DownloadDdlLogsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DownloadOnlineDdlTaskLogResponse> DownloadOnlineDdlTaskLogAsync(DownloadOnlineDdlTaskLogRequest downloadOnlineDdlTaskLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadOnlineDdlTaskLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/log/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", downloadOnlineDdlTaskLogRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<DownloadOnlineDdlTaskLogResponse>(response);
        }

        public AsyncInvoker<DownloadOnlineDdlTaskLogResponse> DownloadOnlineDdlTaskLogAsyncInvoker(DownloadOnlineDdlTaskLogRequest downloadOnlineDdlTaskLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadOnlineDdlTaskLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/log/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", downloadOnlineDdlTaskLogRequest);
            return new AsyncInvoker<DownloadOnlineDdlTaskLogResponse>(this, "POST", request, JsonUtils.DeSerialize<DownloadOnlineDdlTaskLogResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DownloadRealtimeSessionResponse> DownloadRealtimeSessionAsync(DownloadRealtimeSessionRequest downloadRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadRealtimeSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(downloadRealtimeSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session-result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadRealtimeSessionRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<DownloadRealtimeSessionResponse>(response);
        }

        public AsyncInvoker<DownloadRealtimeSessionResponse> DownloadRealtimeSessionAsyncInvoker(DownloadRealtimeSessionRequest downloadRealtimeSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadRealtimeSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(downloadRealtimeSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session-result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadRealtimeSessionRequest);
            return new AsyncInvoker<DownloadRealtimeSessionResponse>(this, "GET", request, JsonUtils.DeSerialize<DownloadRealtimeSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ExecuteIntelligentKillSessionResponse> ExecuteIntelligentKillSessionAsync(ExecuteIntelligentKillSessionRequest executeIntelligentKillSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(executeIntelligentKillSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", executeIntelligentKillSessionRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<ExecuteIntelligentKillSessionResponse>(response);
        }

        public AsyncInvoker<ExecuteIntelligentKillSessionResponse> ExecuteIntelligentKillSessionAsyncInvoker(ExecuteIntelligentKillSessionRequest executeIntelligentKillSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(executeIntelligentKillSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", executeIntelligentKillSessionRequest);
            return new AsyncInvoker<ExecuteIntelligentKillSessionResponse>(this, "POST", request, JsonUtils.DeSerialize<ExecuteIntelligentKillSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListColdTableMetasResponse> ListColdTableMetasAsync(ListColdTableMetasRequest listColdTableMetasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listColdTableMetasRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3.1/{project_id}/instances/{instance_id}/cold-tables/meta", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listColdTableMetasRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListColdTableMetasResponse>(response);
        }

        public AsyncInvoker<ListColdTableMetasResponse> ListColdTableMetasAsyncInvoker(ListColdTableMetasRequest listColdTableMetasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listColdTableMetasRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3.1/{project_id}/instances/{instance_id}/cold-tables/meta", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listColdTableMetasRequest);
            return new AsyncInvoker<ListColdTableMetasResponse>(this, "GET", request, JsonUtils.DeSerialize<ListColdTableMetasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDdlLogsResponse> ListDdlLogsAsync(ListDdlLogsRequest listDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDdlLogsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDdlLogsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListDdlLogsResponse>(response);
        }

        public AsyncInvoker<ListDdlLogsResponse> ListDdlLogsAsyncInvoker(ListDdlLogsRequest listDdlLogsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDdlLogsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDdlLogsRequest);
            return new AsyncInvoker<ListDdlLogsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDdlLogsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListIntelligentKillSessionHistoryResponse> ListIntelligentKillSessionHistoryAsync(ListIntelligentKillSessionHistoryRequest listIntelligentKillSessionHistoryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listIntelligentKillSessionHistoryRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session/history", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIntelligentKillSessionHistoryRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListIntelligentKillSessionHistoryResponse>(response);
        }

        public AsyncInvoker<ListIntelligentKillSessionHistoryResponse> ListIntelligentKillSessionHistoryAsyncInvoker(ListIntelligentKillSessionHistoryRequest listIntelligentKillSessionHistoryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listIntelligentKillSessionHistoryRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session/history", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIntelligentKillSessionHistoryRequest);
            return new AsyncInvoker<ListIntelligentKillSessionHistoryResponse>(this, "GET", request, JsonUtils.DeSerialize<ListIntelligentKillSessionHistoryResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListOnlineDdlTaskRecordsResponse> ListOnlineDdlTaskRecordsAsync(ListOnlineDdlTaskRecordsRequest listOnlineDdlTaskRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listOnlineDdlTaskRecordsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/operation-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOnlineDdlTaskRecordsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListOnlineDdlTaskRecordsResponse>(response);
        }

        public AsyncInvoker<ListOnlineDdlTaskRecordsResponse> ListOnlineDdlTaskRecordsAsyncInvoker(ListOnlineDdlTaskRecordsRequest listOnlineDdlTaskRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listOnlineDdlTaskRecordsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/operation-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOnlineDdlTaskRecordsRequest);
            return new AsyncInvoker<ListOnlineDdlTaskRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListOnlineDdlTaskRecordsResponse>);
        }
        ...
        public AsyncInvoker<ModifyAutoExpandPolicyResponse> ModifyAutoExpandPolicyAsyncInvoker(ModifyAutoExpandPolicyRequest modifyAutoExpandPolicyRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/storage/auto-expand-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyAutoExpandPolicyRequest);
            return new AsyncInvoker<ModifyAutoExpandPolicyResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<ModifyAutoExpandPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyBackupVaultLockResponse> ModifyBackupVaultLockAsync(ModifyBackupVaultLockRequest modifyBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyBackupVaultLockRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/vault-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyBackupVaultLockRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<ModifyBackupVaultLockResponse>(response);
        }

        public AsyncInvoker<ModifyBackupVaultLockResponse> ModifyBackupVaultLockAsyncInvoker(ModifyBackupVaultLockRequest modifyBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyBackupVaultLockRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/vault-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", modifyBackupVaultLockRequest);
            return new AsyncInvoker<ModifyBackupVaultLockResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyBackupVaultLockResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SetDdlLogPolicyResponse> SetDdlLogPolicyAsync(SetDdlLogPolicyRequest setDdlLogPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setDdlLogPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setDdlLogPolicyRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<SetDdlLogPolicyResponse>(response);
        }

        public AsyncInvoker<SetDdlLogPolicyResponse> SetDdlLogPolicyAsyncInvoker(SetDdlLogPolicyRequest setDdlLogPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setDdlLogPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ddl-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setDdlLogPolicyRequest);
            return new AsyncInvoker<SetDdlLogPolicyResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetDdlLogPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SetInstanceReadonlyStatusResponse> SetInstanceReadonlyStatusAsync(SetInstanceReadonlyStatusRequest setInstanceReadonlyStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setInstanceReadonlyStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/readonly-status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setInstanceReadonlyStatusRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<SetInstanceReadonlyStatusResponse>(response);
        }

        public AsyncInvoker<SetInstanceReadonlyStatusResponse> SetInstanceReadonlyStatusAsyncInvoker(SetInstanceReadonlyStatusRequest setInstanceReadonlyStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setInstanceReadonlyStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/readonly-status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setInstanceReadonlyStatusRequest);
            return new AsyncInvoker<SetInstanceReadonlyStatusResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetInstanceReadonlyStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SetInstanceScheduleEventsResponse> SetInstanceScheduleEventsAsync(SetInstanceScheduleEventsRequest setInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setInstanceScheduleEventsRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<SetInstanceScheduleEventsResponse>(response);
        }

        public AsyncInvoker<SetInstanceScheduleEventsResponse> SetInstanceScheduleEventsAsyncInvoker(SetInstanceScheduleEventsRequest setInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setInstanceScheduleEventsRequest);
            return new AsyncInvoker<SetInstanceScheduleEventsResponse>(this, "POST", request, JsonUtils.DeSerialize<SetInstanceScheduleEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowBackupResourcePackageFlavorsResponse> ShowBackupResourcePackageFlavorsAsync(ShowBackupResourcePackageFlavorsRequest showBackupResourcePackageFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/resource-package/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupResourcePackageFlavorsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowBackupResourcePackageFlavorsResponse>(response);
        }

        public AsyncInvoker<ShowBackupResourcePackageFlavorsResponse> ShowBackupResourcePackageFlavorsAsyncInvoker(ShowBackupResourcePackageFlavorsRequest showBackupResourcePackageFlavorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/resource-package/flavors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupResourcePackageFlavorsRequest);
            return new AsyncInvoker<ShowBackupResourcePackageFlavorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowBackupResourcePackageFlavorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowBackupVaultLockResponse> ShowBackupVaultLockAsync(ShowBackupVaultLockRequest showBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showBackupVaultLockRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/vault-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupVaultLockRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowBackupVaultLockResponse>(response);
        }

        public AsyncInvoker<ShowBackupVaultLockResponse> ShowBackupVaultLockAsyncInvoker(ShowBackupVaultLockRequest showBackupVaultLockRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showBackupVaultLockRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/vault-lock", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupVaultLockRequest);
            return new AsyncInvoker<ShowBackupVaultLockResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowBackupVaultLockResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowDynamicServerlessPolicyResponse> ShowDynamicServerlessPolicyAsync(ShowDynamicServerlessPolicyRequest showDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDynamicServerlessPolicyRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowDynamicServerlessPolicyResponse>(response);
        }

        public AsyncInvoker<ShowDynamicServerlessPolicyResponse> ShowDynamicServerlessPolicyAsyncInvoker(ShowDynamicServerlessPolicyRequest showDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDynamicServerlessPolicyRequest);
            return new AsyncInvoker<ShowDynamicServerlessPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDynamicServerlessPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowInstanceBackupsResponse> ShowInstanceBackupsAsync(ShowInstanceBackupsRequest showInstanceBackupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowInstanceBackupsResponse> ShowInstanceBackupsAsyncInvoker(ShowInstanceBackupsRequest showInstanceBackupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showInstanceBackupsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInstanceBackupsRequest);
            return new AsyncInvoker<ShowInstanceBackupsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInstanceBackupsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowInstanceScheduleEventsResponse> ShowInstanceScheduleEventsAsync(ShowInstanceScheduleEventsRequest showInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInstanceScheduleEventsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowInstanceScheduleEventsResponse>(response);
        }

        public AsyncInvoker<ShowInstanceScheduleEventsResponse> ShowInstanceScheduleEventsAsyncInvoker(ShowInstanceScheduleEventsRequest showInstanceScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showInstanceScheduleEventsRequest);
            return new AsyncInvoker<ShowInstanceScheduleEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowInstanceScheduleEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowIntelligentKillSessionStatisticResponse> ShowIntelligentKillSessionStatisticAsync(ShowIntelligentKillSessionStatisticRequest showIntelligentKillSessionStatisticRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showIntelligentKillSessionStatisticRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session/statistic", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showIntelligentKillSessionStatisticRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowIntelligentKillSessionStatisticResponse>(response);
        }

        public AsyncInvoker<ShowIntelligentKillSessionStatisticResponse> ShowIntelligentKillSessionStatisticAsyncInvoker(ShowIntelligentKillSessionStatisticRequest showIntelligentKillSessionStatisticRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showIntelligentKillSessionStatisticRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/intelligent-kill-session/statistic", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showIntelligentKillSessionStatisticRequest);
            return new AsyncInvoker<ShowIntelligentKillSessionStatisticResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowIntelligentKillSessionStatisticResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowKernelUpgradeCheckResultResponse> ShowKernelUpgradeCheckResultAsync(ShowKernelUpgradeCheckResultRequest showKernelUpgradeCheckResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade/pre-check-result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showKernelUpgradeCheckResultRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<ShowKernelUpgradeCheckResultResponse>(response);
        }

        public AsyncInvoker<ShowKernelUpgradeCheckResultResponse> ShowKernelUpgradeCheckResultAsyncInvoker(ShowKernelUpgradeCheckResultRequest showKernelUpgradeCheckResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/database-version/upgrade/pre-check-result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showKernelUpgradeCheckResultRequest);
            return new AsyncInvoker<ShowKernelUpgradeCheckResultResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowKernelUpgradeCheckResultResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowLockWaitSessionResponse> ShowLockWaitSessionAsync(ShowLockWaitSessionRequest showLockWaitSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showLockWaitSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showLockWaitSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/process/lock-wait", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showLockWaitSessionRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowLockWaitSessionResponse>(response);
        }

        public AsyncInvoker<ShowLockWaitSessionResponse> ShowLockWaitSessionAsyncInvoker(ShowLockWaitSessionRequest showLockWaitSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showLockWaitSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showLockWaitSessionRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/process/lock-wait", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showLockWaitSessionRequest);
            return new AsyncInvoker<ShowLockWaitSessionResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowLockWaitSessionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowRealtimeSessionTaskStatusResponse> ShowRealtimeSessionTaskStatusAsync(ShowRealtimeSessionTaskStatusRequest showRealtimeSessionTaskStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRealtimeSessionTaskStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showRealtimeSessionTaskStatusRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRealtimeSessionTaskStatusRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowRealtimeSessionTaskStatusResponse>(response);
        }

        public AsyncInvoker<ShowRealtimeSessionTaskStatusResponse> ShowRealtimeSessionTaskStatusAsyncInvoker(ShowRealtimeSessionTaskStatusRequest showRealtimeSessionTaskStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRealtimeSessionTaskStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showRealtimeSessionTaskStatusRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/realtime-session-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRealtimeSessionTaskStatusRequest);
            return new AsyncInvoker<ShowRealtimeSessionTaskStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRealtimeSessionTaskStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowServerlessComputeAbilityPolicyResponse> ShowServerlessComputeAbilityPolicyAsync(ShowServerlessComputeAbilityPolicyRequest showServerlessComputeAbilityPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowServerlessComputeAbilityPolicyResponse> ShowServerlessComputeAbilityPolicyAsyncInvoker(ShowServerlessComputeAbilityPolicyRequest showServerlessComputeAbilityPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showServerlessComputeAbilityPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showServerlessComputeAbilityPolicyRequest);
            return new AsyncInvoker<ShowServerlessComputeAbilityPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowServerlessComputeAbilityPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowServerlessScalingPolicyResponse> ShowServerlessScalingPolicyAsync(ShowServerlessScalingPolicyRequest showServerlessScalingPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowServerlessScalingPolicyResponse> ShowServerlessScalingPolicyAsyncInvoker(ShowServerlessScalingPolicyRequest showServerlessScalingPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showServerlessScalingPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/scaling-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showServerlessScalingPolicyRequest);
            return new AsyncInvoker<ShowServerlessScalingPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowServerlessScalingPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTaskDetailsResponse> ShowTaskDetailsAsync(ShowTaskDetailsRequest showTaskDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowTaskDetailsResponse> ShowTaskDetailsAsyncInvoker(ShowTaskDetailsRequest showTaskDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaskDetailsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/task-center-detail", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTaskDetailsRequest);
            return new AsyncInvoker<ShowTaskDetailsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTaskDetailsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTaurusDbAdvancedBackupPolicyResponse> ShowTaurusDbAdvancedBackupPolicyAsync(ShowTaurusDbAdvancedBackupPolicyRequest showTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbAdvancedBackupPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/advanced-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTaurusDbAdvancedBackupPolicyRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowTaurusDbAdvancedBackupPolicyResponse>(response);
        }

        public AsyncInvoker<ShowTaurusDbAdvancedBackupPolicyResponse> ShowTaurusDbAdvancedBackupPolicyAsyncInvoker(ShowTaurusDbAdvancedBackupPolicyRequest showTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbAdvancedBackupPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/advanced-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTaurusDbAdvancedBackupPolicyRequest);
            return new AsyncInvoker<ShowTaurusDbAdvancedBackupPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTaurusDbAdvancedBackupPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTaurusDbTxnProgressResponse> ShowTaurusDbTxnProgressAsync(ShowTaurusDbTxnProgressRequest showTaurusDbTxnProgressRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbTxnProgressRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbTxnProgressRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/txn-progress", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showTaurusDbTxnProgressRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<ShowTaurusDbTxnProgressResponse>(response);
        }

        public AsyncInvoker<ShowTaurusDbTxnProgressResponse> ShowTaurusDbTxnProgressAsyncInvoker(ShowTaurusDbTxnProgressRequest showTaurusDbTxnProgressRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbTxnProgressRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showTaurusDbTxnProgressRequest.NodeId, out var valueOfNodeId)) urlParam.Add("node_id", valueOfNodeId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/txn-progress", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", showTaurusDbTxnProgressRequest);
            return new AsyncInvoker<ShowTaurusDbTxnProgressResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowTaurusDbTxnProgressResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<StartOnlineDdlTaskResponse> StartOnlineDdlTaskAsync(StartOnlineDdlTaskRequest startOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startOnlineDdlTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", startOnlineDdlTaskRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<StartOnlineDdlTaskResponse>(response);
        }

        public AsyncInvoker<StartOnlineDdlTaskResponse> StartOnlineDdlTaskAsyncInvoker(StartOnlineDdlTaskRequest startOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(startOnlineDdlTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", startOnlineDdlTaskRequest);
            return new AsyncInvoker<StartOnlineDdlTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<StartOnlineDdlTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<StopOnlineDdlTaskResponse> StopOnlineDdlTaskAsync(StopOnlineDdlTaskRequest stopOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopOnlineDdlTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", stopOnlineDdlTaskRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<StopOnlineDdlTaskResponse>(response);
        }

        public AsyncInvoker<StopOnlineDdlTaskResponse> StopOnlineDdlTaskAsyncInvoker(StopOnlineDdlTaskRequest stopOnlineDdlTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(stopOnlineDdlTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/online-ddl-task/stop", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", stopOnlineDdlTaskRequest);
            return new AsyncInvoker<StopOnlineDdlTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<StopOnlineDdlTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SwitchGaussMySqlProxyAltResponse> SwitchGaussMySqlProxyAltAsync(SwitchGaussMySqlProxyAltRequest switchGaussMySqlProxyAltRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchGaussMySqlProxyAltRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(switchGaussMySqlProxyAltRequest.ProxyId, out var valueOfProxyId)) urlParam.Add("proxy_id", valueOfProxyId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/proxy/{proxy_id}/alt", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", switchGaussMySqlProxyAltRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<SwitchGaussMySqlProxyAltResponse>(response);
        }

        public AsyncInvoker<SwitchGaussMySqlProxyAltResponse> SwitchGaussMySqlProxyAltAsyncInvoker(SwitchGaussMySqlProxyAltRequest switchGaussMySqlProxyAltRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchGaussMySqlProxyAltRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(switchGaussMySqlProxyAltRequest.ProxyId, out var valueOfProxyId)) urlParam.Add("proxy_id", valueOfProxyId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/proxy/{proxy_id}/alt", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", switchGaussMySqlProxyAltRequest);
            return new AsyncInvoker<SwitchGaussMySqlProxyAltResponse>(this, "PUT", request, JsonUtils.DeSerialize<SwitchGaussMySqlProxyAltResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateDynamicServerlessPolicyResponse> UpdateDynamicServerlessPolicyAsync(UpdateDynamicServerlessPolicyRequest updateDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateDynamicServerlessPolicyRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<UpdateDynamicServerlessPolicyResponse>(response);
        }

        public AsyncInvoker<UpdateDynamicServerlessPolicyResponse> UpdateDynamicServerlessPolicyAsyncInvoker(UpdateDynamicServerlessPolicyRequest updateDynamicServerlessPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDynamicServerlessPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/dynamic-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateDynamicServerlessPolicyRequest);
            return new AsyncInvoker<UpdateDynamicServerlessPolicyResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateDynamicServerlessPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateServerlessComputeAbilityPolicyResponse> UpdateServerlessComputeAbilityPolicyAsync(UpdateServerlessComputeAbilityPolicyRequest updateServerlessComputeAbilityPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateServerlessComputeAbilityPolicyResponse> UpdateServerlessComputeAbilityPolicyAsyncInvoker(UpdateServerlessComputeAbilityPolicyRequest updateServerlessComputeAbilityPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateServerlessComputeAbilityPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3.1/{project_id}/instances/{instance_id}/serverless/policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateServerlessComputeAbilityPolicyRequest);
            return new AsyncInvoker<UpdateServerlessComputeAbilityPolicyResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateServerlessComputeAbilityPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateServerlessScalingPolicyResponse> UpdateServerlessScalingPolicyAsync(UpdateServerlessScalingPolicyRequest updateServerlessScalingPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateServerlessScalingPolicyResponse> UpdateServerlessScalingPolicyAsyncInvoker(UpdateServerlessScalingPolicyRequest updateServerlessScalingPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateServerlessScalingPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/serverless/scaling-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateServerlessScalingPolicyRequest);
            return new AsyncInvoker<UpdateServerlessScalingPolicyResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateServerlessScalingPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateTaurusDbAdvancedBackupPolicyResponse> UpdateTaurusDbAdvancedBackupPolicyAsync(UpdateTaurusDbAdvancedBackupPolicyRequest updateTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateTaurusDbAdvancedBackupPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/advanced-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateTaurusDbAdvancedBackupPolicyRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<UpdateTaurusDbAdvancedBackupPolicyResponse>(response);
        }

        public AsyncInvoker<UpdateTaurusDbAdvancedBackupPolicyResponse> UpdateTaurusDbAdvancedBackupPolicyAsyncInvoker(UpdateTaurusDbAdvancedBackupPolicyRequest updateTaurusDbAdvancedBackupPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateTaurusDbAdvancedBackupPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/advanced-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateTaurusDbAdvancedBackupPolicyRequest);
            return new AsyncInvoker<UpdateTaurusDbAdvancedBackupPolicyResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateTaurusDbAdvancedBackupPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpgradeConfigurationResponse> UpgradeConfigurationAsync(UpgradeConfigurationRequest upgradeConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(upgradeConfigurationRequest.ConfigurationId, out var valueOfConfigurationId)) urlParam.Add("configuration_id", valueOfConfigurationId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{configuration_id}/upgrade", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", upgradeConfigurationRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<UpgradeConfigurationResponse>(response);
        }

        public AsyncInvoker<UpgradeConfigurationResponse> UpgradeConfigurationAsyncInvoker(UpgradeConfigurationRequest upgradeConfigurationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(upgradeConfigurationRequest.ConfigurationId, out var valueOfConfigurationId)) urlParam.Add("configuration_id", valueOfConfigurationId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{configuration_id}/upgrade", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", upgradeConfigurationRequest);
            return new AsyncInvoker<UpgradeConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpgradeConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteHtapProcessListResponse> DeleteHtapProcessListAsync(DeleteHtapProcessListRequest deleteHtapProcessListRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteHtapProcessListResponse> DeleteHtapProcessListAsyncInvoker(DeleteHtapProcessListRequest deleteHtapProcessListRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteHtapProcessListRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/htap/process", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteHtapProcessListRequest);
            return new AsyncInvoker<DeleteHtapProcessListResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteHtapProcessListResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteStarRockLtsConfigResponse> DeleteStarRockLtsConfigAsync(DeleteStarRockLtsConfigRequest deleteStarRockLtsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteStarRockLtsConfigResponse> DeleteStarRockLtsConfigAsyncInvoker(DeleteStarRockLtsConfigRequest deleteStarRockLtsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/starrocks/instances/logs/lts-configs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteStarRockLtsConfigRequest);
            return new AsyncInvoker<DeleteStarRockLtsConfigResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteStarRockLtsConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DownloadImportExcelTemplateResponse> DownloadImportExcelTemplateAsync(DownloadImportExcelTemplateRequest downloadImportExcelTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DownloadImportExcelTemplateResponse> DownloadImportExcelTemplateAsyncInvoker(DownloadImportExcelTemplateRequest downloadImportExcelTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadImportExcelTemplateRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/htap/template", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadImportExcelTemplateRequest);
            return new AsyncInvoker<DownloadImportExcelTemplateResponse>(this, "GET", request, JsonUtils.DeSerialize<DownloadImportExcelTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SetHtapQueryQueuesRuleResponse> SetHtapQueryQueuesRuleAsync(SetHtapQueryQueuesRuleRequest setHtapQueryQueuesRuleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<SetHtapQueryQueuesRuleResponse> SetHtapQueryQueuesRuleAsyncInvoker(SetHtapQueryQueuesRuleRequest setHtapQueryQueuesRuleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setHtapQueryQueuesRuleRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/query-queue/rules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", setHtapQueryQueuesRuleRequest);
            return new AsyncInvoker<SetHtapQueryQueuesRuleResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetHtapQueryQueuesRuleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowHtapProcessListResponse> ShowHtapProcessListAsync(ShowHtapProcessListRequest showHtapProcessListRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowHtapProcessListResponse> ShowHtapProcessListAsyncInvoker(ShowHtapProcessListRequest showHtapProcessListRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHtapProcessListRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/htap/process", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHtapProcessListRequest);
            return new AsyncInvoker<ShowHtapProcessListResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHtapProcessListResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowHtapQueryQueuesRuleResponse> ShowHtapQueryQueuesRuleAsync(ShowHtapQueryQueuesRuleRequest showHtapQueryQueuesRuleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowHtapQueryQueuesRuleResponse> ShowHtapQueryQueuesRuleAsyncInvoker(ShowHtapQueryQueuesRuleRequest showHtapQueryQueuesRuleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHtapQueryQueuesRuleRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/query-queue/rules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHtapQueryQueuesRuleRequest);
            return new AsyncInvoker<ShowHtapQueryQueuesRuleResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHtapQueryQueuesRuleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateHtapQueryQueuesControlResponse> UpdateHtapQueryQueuesControlAsync(UpdateHtapQueryQueuesControlRequest updateHtapQueryQueuesControlRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateHtapQueryQueuesControlResponse> UpdateHtapQueryQueuesControlAsyncInvoker(UpdateHtapQueryQueuesControlRequest updateHtapQueryQueuesControlRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateHtapQueryQueuesControlRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/htap/query-queue/switch", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateHtapQueryQueuesControlRequest);
            return new AsyncInvoker<UpdateHtapQueryQueuesControlResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateHtapQueryQueuesControlResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateStarRockLtsConfigResponse> UpdateStarRockLtsConfigAsync(UpdateStarRockLtsConfigRequest updateStarRockLtsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/starrocks/instances/logs/lts-configs", urlParam);
        ...
        public AsyncInvoker<UpdateStarRockLtsConfigResponse> UpdateStarRockLtsConfigAsyncInvoker(UpdateStarRockLtsConfigRequest updateStarRockLtsConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/starrocks/instances/logs/lts-configs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", updateStarRockLtsConfigRequest);
            return new AsyncInvoker<UpdateStarRockLtsConfigResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UpdateStarRockLtsConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UploadImportExcelTemplateResponse> UploadImportExcelTemplateAsync(UploadImportExcelTemplateRequest uploadImportExcelTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UploadImportExcelTemplateResponse> UploadImportExcelTemplateAsyncInvoker(UploadImportExcelTemplateRequest uploadImportExcelTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(uploadImportExcelTemplateRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/htap/template", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "multipart/form-data", uploadImportExcelTemplateRequest);
            return new AsyncInvoker<UploadImportExcelTemplateResponse>(this, "POST", request, JsonUtils.DeSerialize<UploadImportExcelTemplateResponse>);
        }

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SetInstanceReadonlyStatusRequest 
    {
        ...
        public SetInstanceReadonlyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SetInstanceReadonlyStatusRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetInstanceReadonlyStatusRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSqlFilterControlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSqlFilterControlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSqlFilterControlResponse input)
        {

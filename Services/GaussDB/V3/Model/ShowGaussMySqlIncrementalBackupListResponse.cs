...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGaussMySqlIncrementalBackupListResponse : SdkResponse
    {
        ...
        public List<IncrementalBackups> Backups { get; set; }
        ...
        {
            return this.Equals(input as ShowGaussMySqlIncrementalBackupListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGaussMySqlIncrementalBackupListResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateServerlessScalingPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateServerlessScalingPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateServerlessScalingPolicyResponse input)
        {

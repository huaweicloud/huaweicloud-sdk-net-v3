...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListStarRocksDataReplicationConfigByDataBaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListStarRocksDataReplicationConfigByDataBaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListStarRocksDataReplicationConfigByDataBaseResponse input)
        {

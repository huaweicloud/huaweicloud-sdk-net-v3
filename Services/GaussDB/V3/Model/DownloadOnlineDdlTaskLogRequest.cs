...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class DownloadOnlineDdlTaskLogRequest 
    {
        ...
        public DownloadOnlineDDLTaskLogRequestV3 Body { get; set; }
        ...
        {
            return this.Equals(input as DownloadOnlineDdlTaskLogRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadOnlineDdlTaskLogRequest input)
        {

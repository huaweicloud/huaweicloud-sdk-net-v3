...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateGaussMySqlInstanceNameRequest 
    {
        ...
        public MysqlUpdateInstanceNameRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateGaussMySqlInstanceNameRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGaussMySqlInstanceNameRequest input)
        {
            if (input == null)
                return false;

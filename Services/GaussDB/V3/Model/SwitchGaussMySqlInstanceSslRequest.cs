...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SwitchGaussMySqlInstanceSslRequest 
    {
        ...
        public SwitchSSLRequest Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchGaussMySqlInstanceSslRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchGaussMySqlInstanceSslRequest input)
        {
            if (input == null)
                return false;

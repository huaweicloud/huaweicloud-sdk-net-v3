...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ShrinkGaussMySqlProxyRequest 
    {
        ...
        public ShrinkGaussMySqlProxyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShrinkGaussMySqlProxyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShrinkGaussMySqlProxyRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUpgradeDatabasesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchUpgradeDatabasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpgradeDatabasesResponse input)
        {

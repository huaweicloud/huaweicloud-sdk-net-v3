...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class HtapLTSConfigResponseInstanceLtsConfigs 
    {
        ...
        public List<HtapLTSConfigResponseLtsConfigs> LtsConfigs { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("instance", NullValueHandling = NullValueHandling.Ignore)]
        public HtapLTSConfigResponseInstance Instance { get; set; }
        ...
        {
            return this.Equals(input as HtapLTSConfigResponseInstanceLtsConfigs);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(HtapLTSConfigResponseInstanceLtsConfigs input)
        {

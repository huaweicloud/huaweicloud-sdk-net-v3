...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateDynamicServerlessPolicyRequest 
    {
        ...
        public UpdateDynamicServerlessPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDynamicServerlessPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDynamicServerlessPolicyRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListParamsTemplateApplyHistoryResponse : SdkResponse
    {
        ...
        public List<TemplateApplyHistory> Histories { get; set; }
        ...
        {
            return this.Equals(input as ListParamsTemplateApplyHistoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListParamsTemplateApplyHistoryResponse input)
        {
            if (input == null)
                return false;

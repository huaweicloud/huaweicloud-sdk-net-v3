...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateGaussMySqlInstanceEipRequest 
    {
        ...
        public ModifyBindEipRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateGaussMySqlInstanceEipRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGaussMySqlInstanceEipRequest input)
        {
            if (input == null)
                return false;

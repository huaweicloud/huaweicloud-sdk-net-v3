...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UploadImportExcelTemplateRequest 
    {
        ...
        public UploadImportExcelTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UploadImportExcelTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadImportExcelTemplateRequest input)
        {

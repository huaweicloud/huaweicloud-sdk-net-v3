...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ListGaussMySqlDatabaseUser 
    {
        ...
        public List<ListGaussMySqlDatabase> Databases { get; set; }
        ...
        {
            return this.Equals(input as ListGaussMySqlDatabaseUser);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGaussMySqlDatabaseUser input)
        {

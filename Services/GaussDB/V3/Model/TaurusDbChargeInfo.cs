...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class TaurusDbChargeInfo 
    {
        ...
        /// </summary>
        /// <value>**参数解释**：  订购周期类型。  **约束限制**：  不涉及。  **取值范围**：  - month：包月。 - year：包年。  **默认取值**：  不涉及。</value>
        ...
        {
            return this.Equals(input as TaurusDbChargeInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(TaurusDbChargeInfo input)
        {

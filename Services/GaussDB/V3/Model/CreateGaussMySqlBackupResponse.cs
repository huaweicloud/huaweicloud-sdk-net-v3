...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateGaussMySqlBackupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateGaussMySqlBackupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGaussMySqlBackupResponse input)
        {
            if (input == null)
                return false;

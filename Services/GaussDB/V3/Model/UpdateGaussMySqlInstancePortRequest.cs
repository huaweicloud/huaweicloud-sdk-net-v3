...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateGaussMySqlInstancePortRequest 
    {
        ...
        public ModifyPortRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateGaussMySqlInstancePortRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGaussMySqlInstancePortRequest input)
        {
            if (input == null)
                return false;

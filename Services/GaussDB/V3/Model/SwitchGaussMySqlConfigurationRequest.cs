...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SwitchGaussMySqlConfigurationRequest 
    {
        ...
        public ApplyConfigurationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchGaussMySqlConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchGaussMySqlConfigurationRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSlowLogDetailResponse : SdkResponse
    {
        ...
        public List<ShowStarRocksSlowLogDetail> SlowLogList { get; set; }
        ...
        {
            return this.Equals(input as ShowSlowLogDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSlowLogDetailResponse input)
        {

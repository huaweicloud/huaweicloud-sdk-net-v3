...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ShowHtapErrorLogDetailRequest 
    {
        ...
        public HtapErrorLogQueryRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowHtapErrorLogDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowHtapErrorLogDetailRequest input)
        {

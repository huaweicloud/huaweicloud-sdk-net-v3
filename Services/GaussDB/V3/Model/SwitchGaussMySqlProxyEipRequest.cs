...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SwitchGaussMySqlProxyEipRequest 
    {
        ...
        public SwitchGaussMySqlProxyEipRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchGaussMySqlProxyEipRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchGaussMySqlProxyEipRequest input)
        {

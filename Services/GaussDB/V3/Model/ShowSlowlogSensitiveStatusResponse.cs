...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSlowlogSensitiveStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSlowlogSensitiveStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSlowlogSensitiveStatusResponse input)
        {
            if (input == null)
                return false;

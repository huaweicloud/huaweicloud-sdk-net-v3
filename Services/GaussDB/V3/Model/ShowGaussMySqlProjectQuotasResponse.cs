...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGaussMySqlProjectQuotasResponse : SdkResponse
    {
        ...
        public ProjectQuotas Quotas { get; set; }
        ...
        {
            return this.Equals(input as ShowGaussMySqlProjectQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGaussMySqlProjectQuotasResponse input)
        {
            if (input == null)
                return false;

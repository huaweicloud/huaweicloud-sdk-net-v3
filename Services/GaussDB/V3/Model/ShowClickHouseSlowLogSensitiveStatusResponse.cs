...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowClickHouseSlowLogSensitiveStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowClickHouseSlowLogSensitiveStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowClickHouseSlowLogSensitiveStatusResponse input)
        {
            if (input == null)
                return false;

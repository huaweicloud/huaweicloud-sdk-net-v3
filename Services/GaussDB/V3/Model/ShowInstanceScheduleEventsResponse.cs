...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceScheduleEventsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceScheduleEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceScheduleEventsResponse input)
        {

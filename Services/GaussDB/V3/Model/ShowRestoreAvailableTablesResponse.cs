...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRestoreAvailableTablesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRestoreAvailableTablesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRestoreAvailableTablesResponse input)
        {

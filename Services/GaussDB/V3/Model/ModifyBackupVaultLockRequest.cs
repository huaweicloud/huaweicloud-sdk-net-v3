...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ModifyBackupVaultLockRequest 
    {
        ...
        public BackupVaultLockRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyBackupVaultLockRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyBackupVaultLockRequest input)
        {

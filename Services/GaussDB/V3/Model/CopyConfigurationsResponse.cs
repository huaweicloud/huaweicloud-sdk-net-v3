...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CopyConfigurationsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CopyConfigurationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CopyConfigurationsResponse input)
        {

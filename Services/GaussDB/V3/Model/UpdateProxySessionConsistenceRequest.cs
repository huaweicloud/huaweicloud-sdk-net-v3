...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateProxySessionConsistenceRequest 
    {
        ...
        public ModifyProxyConsistRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateProxySessionConsistenceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProxySessionConsistenceRequest input)
        {
            if (input == null)
                return false;

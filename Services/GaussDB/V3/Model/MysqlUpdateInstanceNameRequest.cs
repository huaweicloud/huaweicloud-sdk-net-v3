...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class MysqlUpdateInstanceNameRequest 
    {
        ...
        public bool Equals(MysqlUpdateInstanceNameRequest input)
        {
            ...
            if (this.IsModifyNodeName != input.IsModifyNodeName || (this.IsModifyNodeName != null && !this.IsModifyNodeName.Equals(input.IsModifyNodeName))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsModifyNodeName != null) hashCode = hashCode * 59 + this.IsModifyNodeName.GetHashCode();
                return hashCode;
            }
        }
    }

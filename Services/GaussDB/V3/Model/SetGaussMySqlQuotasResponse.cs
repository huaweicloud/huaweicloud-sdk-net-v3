...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetGaussMySqlQuotasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SetGaussMySqlQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetGaussMySqlQuotasResponse input)
        {
            if (input == null)
                return false;

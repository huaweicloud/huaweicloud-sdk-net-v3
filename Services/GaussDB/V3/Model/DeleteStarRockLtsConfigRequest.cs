...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class DeleteStarRockLtsConfigRequest 
    {
        ...
        public HtapDeleteLTSConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteStarRockLtsConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteStarRockLtsConfigRequest input)
        {

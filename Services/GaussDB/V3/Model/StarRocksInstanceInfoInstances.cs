    ...
    public class StarRocksInstanceInfoInstances 
    {
        ...
        public bool Equals(StarRocksInstanceInfoInstances input)
        {
            ...
            return 
                ...
                (
                    this.FeNodeVolumeCode == input.FeNodeVolumeCode ||
                    (this.FeNodeVolumeCode != null &&
                    this.FeNodeVolumeCode.Equals(input.FeNodeVolumeCode))
                ) && 
                (
                    this.BeNodeVolumeCode == input.BeNodeVolumeCode ||
                    (this.BeNodeVolumeCode != null &&
                    this.BeNodeVolumeCode.Equals(input.BeNodeVolumeCode))
                ) && 
                (
                    this.FeNodeVolumeSize == input.FeNodeVolumeSize ||
                    (this.FeNodeVolumeSize != null &&
                    this.FeNodeVolumeSize.Equals(input.FeNodeVolumeSize))
                ) && 
                (
                    this.BeNodeVolumeSize == input.BeNodeVolumeSize ||
                    (this.BeNodeVolumeSize != null &&
                    this.BeNodeVolumeSize.Equals(input.BeNodeVolumeSize))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FeNodeVolumeCode != null)
                    hashCode = hashCode * 59 + this.FeNodeVolumeCode.GetHashCode();
                if (this.BeNodeVolumeCode != null)
                    hashCode = hashCode * 59 + this.BeNodeVolumeCode.GetHashCode();
                if (this.FeNodeVolumeSize != null)
                    hashCode = hashCode * 59 + this.FeNodeVolumeSize.GetHashCode();
                if (this.BeNodeVolumeSize != null)
                    hashCode = hashCode * 59 + this.BeNodeVolumeSize.GetHashCode();

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class StartOnlineDdlTaskRequest 
    {
        ...
        public StartOnlineDDLTaskRequestV3 Body { get; set; }
        ...
        {
            return this.Equals(input as StartOnlineDdlTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartOnlineDdlTaskRequest input)
        {

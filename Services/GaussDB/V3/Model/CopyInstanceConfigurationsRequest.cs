...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CopyInstanceConfigurationsRequest 
    {
        ...
        public CopyInstanceConfigurationsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CopyInstanceConfigurationsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CopyInstanceConfigurationsRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ShowKernelUpgradeCheckResultRequest 
    {
        ...
        public UpgradePrecheckRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ShowKernelUpgradeCheckResultRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowKernelUpgradeCheckResultRequest input)
        {

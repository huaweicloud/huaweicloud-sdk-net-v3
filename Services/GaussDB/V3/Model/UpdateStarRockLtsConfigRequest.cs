...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateStarRockLtsConfigRequest 
    {
        ...
        public HtapCreateLTSConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateStarRockLtsConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateStarRockLtsConfigRequest input)
        {

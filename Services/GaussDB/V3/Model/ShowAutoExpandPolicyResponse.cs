...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutoExpandPolicyResponse : SdkResponse
    {
        /// <summary>
        /// **参数解释**：  可用存储空间率。 
        /// </summary>
        /// <value>**参数解释**：  可用存储空间率。 </value>
        ...
        {
            return this.Equals(input as ShowAutoExpandPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutoExpandPolicyResponse input)
        {

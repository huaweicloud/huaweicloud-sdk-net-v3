...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInstanceDatabasesForHtapResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInstanceDatabasesForHtapResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceDatabasesForHtapResponse input)
        {

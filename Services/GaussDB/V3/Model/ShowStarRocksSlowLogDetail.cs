...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ShowStarRocksSlowLogDetail 
    {
        ...
        /// **参数解释**：  慢日志日期。   **取值范围**：   不涉及。 
        /// </summary>
        [JsonProperty("slow_log_date", NullValueHandling = NullValueHandling.Ignore)]
        public long? SlowLogDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  slowLogDate: ").Append(SlowLogDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowStarRocksSlowLogDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowStarRocksSlowLogDetail input)
        {
            ...
            if (this.SlowLogDate != input.SlowLogDate || (this.SlowLogDate != null && !this.SlowLogDate.Equals(input.SlowLogDate))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SlowLogDate != null) hashCode = hashCode * 59 + this.SlowLogDate.GetHashCode();
                return hashCode;
            }
        }
    }

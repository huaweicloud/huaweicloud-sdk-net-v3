...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ListGaussMySqlInstanceDetailInfoRequest 
    {
        ...
        {
            return this.Equals(input as ListGaussMySqlInstanceDetailInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGaussMySqlInstanceDetailInfoRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.InstanceIds.Equals(input.InstanceIds))
                );
        }

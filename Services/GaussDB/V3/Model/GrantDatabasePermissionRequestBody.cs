...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class GrantDatabasePermissionRequestBody 
    {
        ...
        public List<GrantDatabasePermission> Users { get; set; }
        ...
        {
            return this.Equals(input as GrantDatabasePermissionRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GrantDatabasePermissionRequestBody input)
        {

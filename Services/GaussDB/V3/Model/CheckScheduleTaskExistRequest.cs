...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CheckScheduleTaskExistRequest 
    {
        ...
        public CheckScheduleTaskExistRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CheckScheduleTaskExistRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckScheduleTaskExistRequest input)
        {

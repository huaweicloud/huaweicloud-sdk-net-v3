...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateProxyConnectionPoolTypeRequest 
    {
        ...
        public ProxyUpdateProxyConnectionPoolTypeRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateProxyConnectionPoolTypeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProxyConnectionPoolTypeRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceConfigurationsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListInstanceConfigurationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceConfigurationsResponse input)
        {

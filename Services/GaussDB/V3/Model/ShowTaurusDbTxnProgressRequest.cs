...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ShowTaurusDbTxnProgressRequest 
    {
        ...
        public TxnProgressRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowTaurusDbTxnProgressRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTaurusDbTxnProgressRequest input)
        {

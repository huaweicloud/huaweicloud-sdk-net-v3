...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ClearOnlineDdlTaskTempTableRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**：  请求语言类型。  **约束限制**：  不涉及。  **取值范围**：  - en-us：英文。 - zh-cn：中文。  **默认取值**：  en-us。 </value>
        ...
        public ClearOnlineDDLTaskTempTableRequestV3 Body { get; set; }
        ...
        {
            return this.Equals(input as ClearOnlineDdlTaskTempTableRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ClearOnlineDdlTaskTempTableRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class HtapDeleteLTSConfigRequestBody 
    {
        ...
        public List<HtapDeleteLTSConfigRequestBodyLogConfigs> LogConfigs { get; set; }
        ...
        {
            return this.Equals(input as HtapDeleteLTSConfigRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(HtapDeleteLTSConfigRequestBody input)
        {

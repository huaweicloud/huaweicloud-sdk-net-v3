...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class DeleteOnlineDdlTaskRecordRequest 
    {
        ...
        public DeleteOnlineDDLTaskRecordRequestV3 Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteOnlineDdlTaskRecordRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteOnlineDdlTaskRecordRequest input)
        {

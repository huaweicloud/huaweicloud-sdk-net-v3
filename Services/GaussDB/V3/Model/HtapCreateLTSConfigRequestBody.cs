...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class HtapCreateLTSConfigRequestBody 
    {
        ...
        public List<HtapCreateLTSConfigRequestBodyLogConfigs> LogConfigs { get; set; }
        ...
        {
            return this.Equals(input as HtapCreateLTSConfigRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(HtapCreateLTSConfigRequestBody input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateProxyNewConfigurationsRequest 
    {
        ...
        public UpdateProxyNewConfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateProxyNewConfigurationsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProxyNewConfigurationsRequest input)
        {
            if (input == null)
                return false;

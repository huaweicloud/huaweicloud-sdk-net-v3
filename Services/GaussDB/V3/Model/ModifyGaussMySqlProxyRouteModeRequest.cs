...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ModifyGaussMySqlProxyRouteModeRequest 
    {
        ...
        public ModifyGaussMySqlProxyRouteModeRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyGaussMySqlProxyRouteModeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyGaussMySqlProxyRouteModeRequest input)
        {

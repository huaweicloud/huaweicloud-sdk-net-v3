...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpgradeGaussMySqlInstanceDatabaseRequest 
    {
        ...
        public UpgradeDatabaseRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpgradeGaussMySqlInstanceDatabaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradeGaussMySqlInstanceDatabaseRequest input)
        {
            if (input == null)
                return false;

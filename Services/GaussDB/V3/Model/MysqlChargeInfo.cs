...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class MysqlChargeInfo 
    {
        ...
        /// </summary>
        /// <value>订购周期类型。  取值范围：  - month：包月。 - year：包年。  说明：“charge_mode”为“prePaid”时生效，且为必选值。</value>
        ...
        {
            return this.Equals(input as MysqlChargeInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MysqlChargeInfo input)
        {

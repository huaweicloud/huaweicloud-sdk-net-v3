...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListImmediateJobsResponse : SdkResponse
    {
        ...
        public List<TaskDetailInfo> Jobs { get; set; }
        ...
        {
            return this.Equals(input as ListImmediateJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListImmediateJobsResponse input)
        {

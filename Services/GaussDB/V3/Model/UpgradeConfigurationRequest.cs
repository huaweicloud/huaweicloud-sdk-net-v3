...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpgradeConfigurationRequest 
    {
        ...
        public UpgradeConfigurationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpgradeConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradeConfigurationRequest input)
        {

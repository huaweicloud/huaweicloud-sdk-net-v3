...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowServerlessScalingPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowServerlessScalingPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowServerlessScalingPolicyResponse input)
        {

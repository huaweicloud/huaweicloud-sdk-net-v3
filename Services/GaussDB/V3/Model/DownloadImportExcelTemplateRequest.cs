...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadImportExcelTemplateRequest 
    {
        ...
        {
            return this.Equals(input as DownloadImportExcelTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadImportExcelTemplateRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteGaussMySqlBackupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteGaussMySqlBackupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteGaussMySqlBackupResponse input)
        {

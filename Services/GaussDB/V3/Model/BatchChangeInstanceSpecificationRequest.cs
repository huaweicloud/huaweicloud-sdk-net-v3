...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class BatchChangeInstanceSpecificationRequest 
    {
        ...
        public BatchChangeInstanceSpecificationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchChangeInstanceSpecificationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchChangeInstanceSpecificationRequest input)
        {

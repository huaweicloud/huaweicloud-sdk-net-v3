...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SetGaussMySqlProxyWeightRequest 
    {
        ...
        public TaurusModifyProxyWeightRequest Body { get; set; }
        ...
        {
            return this.Equals(input as SetGaussMySqlProxyWeightRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetGaussMySqlProxyWeightRequest input)
        {

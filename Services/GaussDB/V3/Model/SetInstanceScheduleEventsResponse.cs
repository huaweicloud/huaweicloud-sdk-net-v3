...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetInstanceScheduleEventsResponse : SdkResponse
    {
        ...
        public List<EventJobResult> Results { get; set; }
        ...
        {
            return this.Equals(input as SetInstanceScheduleEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetInstanceScheduleEventsResponse input)
        {

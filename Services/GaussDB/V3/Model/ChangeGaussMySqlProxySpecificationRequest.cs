...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ChangeGaussMySqlProxySpecificationRequest 
    {
        ...
        public TaurusProxyScaleRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeGaussMySqlProxySpecificationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeGaussMySqlProxySpecificationRequest input)
        {
            if (input == null)
                return false;

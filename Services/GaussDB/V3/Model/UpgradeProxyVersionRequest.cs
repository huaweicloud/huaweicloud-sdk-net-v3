...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpgradeProxyVersionRequest 
    {
        ...
        public ProxyUpgradeProxyVersionRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpgradeProxyVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradeProxyVersionRequest input)
        {
            if (input == null)
                return false;

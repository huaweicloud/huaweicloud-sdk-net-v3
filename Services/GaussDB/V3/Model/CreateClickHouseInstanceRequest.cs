...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CreateClickHouseInstanceRequest 
    {
        ...
        public CreateChInstanceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateClickHouseInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateClickHouseInstanceRequest input)
        {
            if (input == null)
                return false;

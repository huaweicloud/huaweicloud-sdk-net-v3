...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SetHtapQueryQueuesRuleRequest 
    {
        ...
        public OperateHtapQueryQueueRuleReq Body { get; set; }
        ...
        {
            return this.Equals(input as SetHtapQueryQueuesRuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetHtapQueryQueuesRuleRequest input)
        {

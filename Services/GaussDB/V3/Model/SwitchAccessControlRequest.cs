...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SwitchAccessControlRequest 
    {
        ...
        public SwitchAccessControlRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchAccessControlRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchAccessControlRequest input)
        {

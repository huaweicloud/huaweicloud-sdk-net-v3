...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateTaurusNodeDataIpRequest 
    {
        ...
        public ModifyNodeDataIpRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTaurusNodeDataIpRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTaurusNodeDataIpRequest input)
        {

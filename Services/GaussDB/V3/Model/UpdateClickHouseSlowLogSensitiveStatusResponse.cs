...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateClickHouseSlowLogSensitiveStatusResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateClickHouseSlowLogSensitiveStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClickHouseSlowLogSensitiveStatusResponse input)
        {
            if (input == null)
                return false;

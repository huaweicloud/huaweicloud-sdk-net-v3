...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CreateGaussMySqlInstanceRequest 
    {
        ...
        public MysqlInstanceRequest Body { get; set; }
        ...
        {
            return this.Equals(input as CreateGaussMySqlInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGaussMySqlInstanceRequest input)
        {
            if (input == null)
                return false;

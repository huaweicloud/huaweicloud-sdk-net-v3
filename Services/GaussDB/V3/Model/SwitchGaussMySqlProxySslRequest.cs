...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SwitchGaussMySqlProxySslRequest 
    {
        ...
        public SwitchProxySSLRequest Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchGaussMySqlProxySslRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchGaussMySqlProxySslRequest input)
        {
            if (input == null)
                return false;

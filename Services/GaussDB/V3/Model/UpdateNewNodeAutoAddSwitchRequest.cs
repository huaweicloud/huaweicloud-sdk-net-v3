...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpdateNewNodeAutoAddSwitchRequest 
    {
        ...
        public UpdateNewNodeAutoAddSwitchRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateNewNodeAutoAddSwitchRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNewNodeAutoAddSwitchRequest input)
        {
            if (input == null)
                return false;

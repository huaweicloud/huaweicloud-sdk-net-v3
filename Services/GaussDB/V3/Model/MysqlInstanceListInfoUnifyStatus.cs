...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class MysqlInstanceListInfoUnifyStatus 
    {
        ...
        {
            return this.Equals(input as MysqlInstanceListInfoUnifyStatus);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MysqlInstanceListInfoUnifyStatus input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReadonlyPrivateIps == input.ReadonlyPrivateIps ||
                    this.ReadonlyPrivateIps != null &&
                    input.ReadonlyPrivateIps != null &&
                    this.ReadonlyPrivateIps.SequenceEqual(input.ReadonlyPrivateIps)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReadonlyPrivateIps != null)
                    hashCode = hashCode * 59 + this.ReadonlyPrivateIps.GetHashCode();

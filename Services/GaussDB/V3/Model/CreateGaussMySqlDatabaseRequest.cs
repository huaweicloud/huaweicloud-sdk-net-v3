...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CreateGaussMySqlDatabaseRequest 
    {
        ...
        public CreateGaussMySqlDatabaseRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateGaussMySqlDatabaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGaussMySqlDatabaseRequest input)
        {
            if (input == null)
                return false;

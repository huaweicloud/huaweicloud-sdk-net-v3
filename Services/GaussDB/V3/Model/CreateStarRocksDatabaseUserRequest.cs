...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CreateStarRocksDatabaseUserRequest 
    {
        ...
        public StarRocksDatabaseUserInfo Body { get; set; }
        ...
        {
            return this.Equals(input as CreateStarRocksDatabaseUserRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateStarRocksDatabaseUserRequest input)
        {
            if (input == null)
                return false;

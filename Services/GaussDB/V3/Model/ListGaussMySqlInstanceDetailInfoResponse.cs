...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGaussMySqlInstanceDetailInfoResponse : SdkResponse
    {
        ...
        public List<MysqlInstanceInfoDetail> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListGaussMySqlInstanceDetailInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGaussMySqlInstanceDetailInfoResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CreateBackupResourcePackageRequest 
    {
        ...
        public CreateBackupResourcePackageRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateBackupResourcePackageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateBackupResourcePackageRequest input)
        {

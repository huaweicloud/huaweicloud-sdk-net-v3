...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class UpgradeSrKernelVersionRequest 
    {
        ...
        public UpgradeSrKernelVersionRequestV3 Body { get; set; }
        ...
        {
            return this.Equals(input as UpgradeSrKernelVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradeSrKernelVersionRequest input)
        {

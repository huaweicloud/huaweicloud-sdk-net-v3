...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAccessControlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAccessControlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAccessControlResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUpdateBackupPolicyResponse : SdkResponse
    {
        ...
        public List<UpdateBackupPolicyResult> FailedResults { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateBackupPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateBackupPolicyResponse input)
        {

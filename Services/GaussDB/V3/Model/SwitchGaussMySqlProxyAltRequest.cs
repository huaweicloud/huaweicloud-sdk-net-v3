...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SwitchGaussMySqlProxyAltRequest 
    {
        ...
        public SwitchGaussMySqlProxyAltRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchGaussMySqlProxyAltRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchGaussMySqlProxyAltRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowHtapLtsConfigResponse : SdkResponse
    {
        ...
        public List<HtapLTSConfigResponseInstanceLtsConfigs> InstanceLtsConfigs { get; set; }
        ...
        {
            return this.Equals(input as ShowHtapLtsConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowHtapLtsConfigResponse input)
        {

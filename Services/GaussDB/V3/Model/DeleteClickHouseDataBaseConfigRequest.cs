...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class DeleteClickHouseDataBaseConfigRequest 
    {
        ...
        /// 数据库名。
        /// </summary>
        [SDKProperty("database", IsQuery = true)]
        ...
        {
            return this.Equals(input as DeleteClickHouseDataBaseConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteClickHouseDataBaseConfigRequest input)
        {
            if (input == null)
                return false;

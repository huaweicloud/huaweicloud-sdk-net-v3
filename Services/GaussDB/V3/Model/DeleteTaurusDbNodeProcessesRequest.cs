...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class DeleteTaurusDbNodeProcessesRequest 
    {
        ...
        public DeleteTaurusDbNodeProcessesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteTaurusDbNodeProcessesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTaurusDbNodeProcessesRequest input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadRealtimeSessionRequest 
    {
        ...
        {
            return this.Equals(input as DownloadRealtimeSessionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadRealtimeSessionRequest input)
        {

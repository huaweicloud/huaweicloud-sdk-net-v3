...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ShowDedicatedResourceInfoRequest 
    {
        ...
        /// 专属资源池ID。
        /// </summary>
        [SDKProperty("dedicated_resource_id", IsPath = true)]
        ...
        {
            return this.Equals(input as ShowDedicatedResourceInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDedicatedResourceInfoRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CheckClickHouseDataBaseConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CheckClickHouseDataBaseConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckClickHouseDataBaseConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class SrCreateInstanceRspInstanceTagsInfo 
    {
        ...
        public List<SrCreateInstanceRspInstanceTagsInfoSysTags> SysTags { get; set; }
        ...
        {
            return this.Equals(input as SrCreateInstanceRspInstanceTagsInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SrCreateInstanceRspInstanceTagsInfo input)
        {
            if (input == null)
                return false;

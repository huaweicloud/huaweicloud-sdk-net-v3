...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class ExpandGaussMySqlInstanceVolumeRequest 
    {
        ...
        public MysqlExtendInstanceVolumeRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ExpandGaussMySqlInstanceVolumeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExpandGaussMySqlInstanceVolumeRequest input)
        {
            if (input == null)
                return false;

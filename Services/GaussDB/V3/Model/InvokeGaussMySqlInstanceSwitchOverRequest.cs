...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class InvokeGaussMySqlInstanceSwitchOverRequest 
    {
        ...
        public TaurusSwitchoverRequest Body { get; set; }
        ...
        {
            return this.Equals(input as InvokeGaussMySqlInstanceSwitchOverRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(InvokeGaussMySqlInstanceSwitchOverRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGaussMySqlQuotasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateGaussMySqlQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGaussMySqlQuotasResponse input)
        {
            if (input == null)
                return false;

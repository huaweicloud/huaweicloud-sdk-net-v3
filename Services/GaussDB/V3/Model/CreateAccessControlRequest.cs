...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CreateAccessControlRequest 
    {
        ...
        public CreateAccessControlRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAccessControlRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAccessControlRequest input)
        {
            if (input == null)
                return false;

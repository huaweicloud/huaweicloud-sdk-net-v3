...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListConfigurationsInstancesResponse : SdkResponse
    {
        ...
        public List<ApplicableInstances> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListConfigurationsInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListConfigurationsInstancesResponse input)
        {

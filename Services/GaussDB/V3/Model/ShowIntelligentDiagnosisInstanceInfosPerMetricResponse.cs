    ...
    public class ShowIntelligentDiagnosisInstanceInfosPerMetricResponse : SdkResponse
    {
        ...
        public bool Equals(ShowIntelligentDiagnosisInstanceInfosPerMetricResponse input)
        {
            ...
            return 
                ...
                (
                    this.InstanceInfos == input.InstanceInfos ||
                    this.InstanceInfos != null &&
                    input.InstanceInfos != null &&
                    this.InstanceInfos.SequenceEqual(input.InstanceInfos)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InstanceInfos != null)
                    hashCode = hashCode * 59 + this.InstanceInfos.GetHashCode();
                return hashCode;
            }
        }
    }

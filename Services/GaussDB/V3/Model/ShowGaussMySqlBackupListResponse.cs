...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGaussMySqlBackupListResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGaussMySqlBackupListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGaussMySqlBackupListResponse input)
        {
            if (input == null)
                return false;

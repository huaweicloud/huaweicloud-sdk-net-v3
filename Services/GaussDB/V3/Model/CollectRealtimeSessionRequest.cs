...
namespace HuaweiCloud.SDK.GaussDB.V3.Model
{
    ...
    public class CollectRealtimeSessionRequest 
    {
        ...
        public RealtimeSessionRequest Body { get; set; }
        ...
        {
            return this.Equals(input as CollectRealtimeSessionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CollectRealtimeSessionRequest input)
        {

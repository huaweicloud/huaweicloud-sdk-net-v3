...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteDiagnosisRecordsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteDiagnosisRecordsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteDiagnosisRecordsResponse input)
        {

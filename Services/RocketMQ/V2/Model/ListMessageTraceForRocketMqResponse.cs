...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMessageTraceForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListMessageTraceForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMessageTraceForRocketMqResponse input)
        {

...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteRocketMqMigrationTaskResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteRocketMqMigrationTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteRocketMqMigrationTaskResponse input)
        {

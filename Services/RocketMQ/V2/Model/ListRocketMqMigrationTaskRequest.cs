...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    public class ListRocketMqMigrationTaskRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 查询类型。 **约束限制**： 不涉及。 **取值范围**： - vhost：虚拟主机。 - exchange：交换机。 - queue：队列。 - all：所有。            **默认取值**： 不涉及。</value>
        ...
        public class TypeEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum VHOST = new TypeEnum("vhost");

            /// <summary>
            /// Enum EXCHANGE for value: exchange
            /// </summary>
            public static readonly TypeEnum EXCHANGE = new TypeEnum("exchange");

            /// <summary>
            /// Enum QUEUE for value: queue
            /// </summary>
            public static readonly TypeEnum QUEUE = new TypeEnum("queue");
        ...
        {
            return this.Equals(input as ListRocketMqMigrationTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRocketMqMigrationTaskRequest input)
        {

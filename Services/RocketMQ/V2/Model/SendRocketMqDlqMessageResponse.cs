...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SendRocketMqDlqMessageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SendRocketMqDlqMessageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SendRocketMqDlqMessageResponse input)
        {
            if (input == null)
                return false;

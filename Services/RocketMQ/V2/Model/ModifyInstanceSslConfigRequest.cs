...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    public class ModifyInstanceSslConfigRequest 
    {
        ...
        public PlainSSLSwitchRep Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyInstanceSslConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyInstanceSslConfigRequest input)
        {

...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    public class ResetConsumeOffsetRequest 
    {
        ...
        public ResetConsumeOffsetReq Body { get; set; }
        ...
        {
            return this.Equals(input as ResetConsumeOffsetRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResetConsumeOffsetRequest input)
        {

...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    public class ShowConsumerConnectionsForRocketMqRequest 
    {
        ...
        {
            return this.Equals(input as ShowConsumerConnectionsForRocketMqRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowConsumerConnectionsForRocketMqRequest input)
        {
            ...
            if (this.IsDetail != input.IsDetail || (this.IsDetail != null && !this.IsDetail.Equals(input.IsDetail))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsDetail != null) hashCode = hashCode * 59 + this.IsDetail.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SendDlqMessageForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SendDlqMessageForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SendDlqMessageForRocketMqResponse input)
        {

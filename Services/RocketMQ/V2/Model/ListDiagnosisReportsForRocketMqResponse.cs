...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDiagnosisReportsForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListDiagnosisReportsForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDiagnosisReportsForRocketMqResponse input)
        {

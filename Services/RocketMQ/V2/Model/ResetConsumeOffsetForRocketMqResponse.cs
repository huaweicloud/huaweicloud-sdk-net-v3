...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ResetConsumeOffsetForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ResetConsumeOffsetForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResetConsumeOffsetForRocketMqResponse input)
        {

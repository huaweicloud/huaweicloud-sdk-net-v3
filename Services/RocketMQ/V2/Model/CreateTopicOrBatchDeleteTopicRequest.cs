...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    public class CreateTopicOrBatchDeleteTopicRequest 
    {
        ...
        public CreateTopicOrBatchDeleteTopicReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTopicOrBatchDeleteTopicRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTopicOrBatchDeleteTopicRequest input)
        {

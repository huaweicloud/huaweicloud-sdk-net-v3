...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDiagnosisTaskForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDiagnosisTaskForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDiagnosisTaskForRocketMqResponse input)
        {

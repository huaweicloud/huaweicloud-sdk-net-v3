...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SendMessageForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SendMessageForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SendMessageForRocketMqResponse input)
        {

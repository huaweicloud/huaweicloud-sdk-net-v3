...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ValidateRocketMqConsumedMessageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ValidateRocketMqConsumedMessageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ValidateRocketMqConsumedMessageResponse input)
        {
            if (input == null)
                return false;

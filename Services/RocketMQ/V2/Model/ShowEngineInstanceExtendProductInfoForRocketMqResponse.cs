...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowEngineInstanceExtendProductInfoForRocketMqResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowEngineInstanceExtendProductInfoForRocketMqResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEngineInstanceExtendProductInfoForRocketMqResponse input)
        {

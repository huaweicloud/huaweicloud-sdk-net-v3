...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRocketMqProductCoresResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRocketMqProductCoresResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRocketMqProductCoresResponse input)
        {

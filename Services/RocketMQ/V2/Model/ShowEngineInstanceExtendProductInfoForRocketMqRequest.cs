...
namespace HuaweiCloud.SDK.RocketMQ.V2.Model
{
    ...
    public class ShowEngineInstanceExtendProductInfoForRocketMqRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 产品的类型。 advanced：专享版。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： advanced。</value>
        ...
        {
            return this.Equals(input as ShowEngineInstanceExtendProductInfoForRocketMqRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEngineInstanceExtendProductInfoForRocketMqRequest input)
        {

...
namespace HuaweiCloud.SDK.Dms.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ConfirmConsumptionMessagesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ConfirmConsumptionMessagesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ConfirmConsumptionMessagesResponse input)
        {
            if (input == null)
                return false;

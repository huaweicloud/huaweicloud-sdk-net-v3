...
namespace HuaweiCloud.SDK.Dms.V2.Model
{
    ...
    public class ConfirmConsumptionMessagesRequest 
    {
        ...
        public ConfirmConsumptionMessagesReq Body { get; set; }
        ...
        {
            return this.Equals(input as ConfirmConsumptionMessagesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ConfirmConsumptionMessagesRequest input)
        {
            if (input == null)
                return false;

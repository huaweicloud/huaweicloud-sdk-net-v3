...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ListExtraColumnsRequest 
    {
        ...
        /// 是否仅查询已下发的加工对象，默认为否。
        /// </summary>
        [SDKProperty("is_only_show_sent", IsQuery = true)]
        [JsonProperty("is_only_show_sent", NullValueHandling = NullValueHandling.Ignore)]
        public bool? IsOnlyShowSent { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  isOnlyShowSent: ").Append(IsOnlyShowSent).Append("\n");
        ...
        {
            return this.Equals(input as ListExtraColumnsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListExtraColumnsRequest input)
        {
            if (input == null) return false;
            if (this.JobId != input.JobId || (this.JobId != null && !this.JobId.Equals(input.JobId))) return false;
            if (this.XLanguage != input.XLanguage) return false;
            if (this.IsOnlyShowSent != input.IsOnlyShowSent || (this.IsOnlyShowSent != null && !this.IsOnlyShowSent.Equals(input.IsOnlyShowSent))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsOnlyShowSent != null) hashCode = hashCode * 59 + this.IsOnlyShowSent.GetHashCode();

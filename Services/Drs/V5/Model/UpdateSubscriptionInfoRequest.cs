...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class UpdateSubscriptionInfoRequest 
    {
        ...
        public UpdateSubscriptionInfoReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSubscriptionInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSubscriptionInfoRequest input)
        {

...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchExecuteJobActionsResponse : SdkResponse
    {
        ...
        public List<AsyncActionResp> Jobs { get; set; }
        ...
        {
            return this.Equals(input as BatchExecuteJobActionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchExecuteJobActionsResponse input)
        {

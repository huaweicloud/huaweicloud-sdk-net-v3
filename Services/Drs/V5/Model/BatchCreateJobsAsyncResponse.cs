...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchCreateJobsAsyncResponse : SdkResponse
    {
        ...
        public AsyncCreateJobResp Job { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateJobsAsyncResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateJobsAsyncResponse input)
        {

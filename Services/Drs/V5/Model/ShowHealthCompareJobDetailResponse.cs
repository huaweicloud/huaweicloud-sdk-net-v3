...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowHealthCompareJobDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowHealthCompareJobDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowHealthCompareJobDetailResponse input)
        {

...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadCreateTemplateRequest 
    {
        /// <summary>
        /// 请求语言类型。
        /// </summary>
        ...
        public ExportFilesReq Body { get; set; }
        ...
        {
            return this.Equals(input as DownloadCreateTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadCreateTemplateRequest input)
        {

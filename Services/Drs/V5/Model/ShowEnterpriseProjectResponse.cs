    ...
    public class ShowEnterpriseProjectResponse : SdkResponse
    {
        ...
        public bool Equals(ShowEnterpriseProjectResponse input)
        {
            ...
            return 
                ...
                (
                    this.EnterpriseProjectList == input.EnterpriseProjectList ||
                    this.EnterpriseProjectList != null &&
                    input.EnterpriseProjectList != null &&
                    this.EnterpriseProjectList.SequenceEqual(input.EnterpriseProjectList)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnterpriseProjectList != null)
                    hashCode = hashCode * 59 + this.EnterpriseProjectList.GetHashCode();
                return hashCode;
            }
        }
    }

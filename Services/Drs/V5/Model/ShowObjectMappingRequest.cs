...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ShowObjectMappingRequest 
    {
        ...
        public QueryUserSelectedObjectInfoReq Body { get; set; }
        ...
        {
            return this.Equals(input as ShowObjectMappingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowObjectMappingRequest input)
        {

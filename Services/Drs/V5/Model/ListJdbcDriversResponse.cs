...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListJdbcDriversResponse : SdkResponse
    {
        ...
        public List<DriverInfo> Items { get; set; }
        ...
        {
            return this.Equals(input as ListJdbcDriversResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListJdbcDriversResponse input)
        {

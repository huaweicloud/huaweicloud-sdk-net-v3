...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CollectDbObjectsInfoResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CollectDbObjectsInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CollectDbObjectsInfoResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ShowSubscriptionListsRequest 
    {
        ...
        public QuerySubscriptionsReq Body { get; set; }
        ...
        {
            return this.Equals(input as ShowSubscriptionListsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSubscriptionListsRequest input)
        {

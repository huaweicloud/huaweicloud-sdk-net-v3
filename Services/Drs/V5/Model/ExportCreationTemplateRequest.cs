...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ExportCreationTemplateRequest 
    {
        ...
        public ExportJobsTemplateReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExportCreationTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExportCreationTemplateRequest input)
        {

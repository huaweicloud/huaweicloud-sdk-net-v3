...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ImportBatchCreateJobsRequest 
    {
        ...
        public ImportBatchCreateJobsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ImportBatchCreateJobsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportBatchCreateJobsRequest input)
        {

...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ListJobDdlsRequest 
    {
        ...
        /// DDL序列起始值。
        /// </summary>
        [SDKProperty("start_seq_no", IsQuery = true)]
        [JsonProperty("start_seq_no", NullValueHandling = NullValueHandling.Ignore)]
        public long? StartSeqNo { get; set; }

        /// <summary>
        /// DDL序列结束值。
        /// </summary>
        [SDKProperty("end_seq_no", IsQuery = true)]
        [JsonProperty("end_seq_no", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  startSeqNo: ").Append(StartSeqNo).Append("\n");
            sb.Append("  endSeqNo: ").Append(EndSeqNo).Append("\n");
        ...
        {
            return this.Equals(input as ListJobDdlsRequest);
        }

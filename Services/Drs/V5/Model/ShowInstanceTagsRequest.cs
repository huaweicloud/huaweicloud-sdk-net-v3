...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class ShowInstanceTagsRequest 
    {
        ...
        /// </summary>
        /// <value>资源类型。 - migration：实时迁移 - sync：实时同步 - cloudDataGuard：实时灾备 - subscription：数据订阅 - backupMigration：备份迁移 - replay：仿真回放</value>
        ...
        {
            return this.Equals(input as ShowInstanceTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInstanceTagsRequest input)
        {
            if (input == null)
                return false;

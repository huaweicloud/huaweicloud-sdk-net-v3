...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    public class CollectDbObjectsInfoRequest 
    {
        ...
        public QuerySelectObjectInfoReq Body { get; set; }
        ...
        {
            return this.Equals(input as CollectDbObjectsInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CollectDbObjectsInfoRequest input)
        {

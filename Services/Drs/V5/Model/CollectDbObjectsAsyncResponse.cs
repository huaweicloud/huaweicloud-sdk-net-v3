...
namespace HuaweiCloud.SDK.Drs.V5.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CollectDbObjectsAsyncResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CollectDbObjectsAsyncResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CollectDbObjectsAsyncResponse input)
        {

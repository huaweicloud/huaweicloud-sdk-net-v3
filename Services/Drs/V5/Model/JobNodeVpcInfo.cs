    ...
    public class JobNodeVpcInfo 
    {
        ...
        public bool Equals(JobNodeVpcInfo input)
        {
            ...
            return 
                ...
                (
                    this.CustomNodeIp == input.CustomNodeIp ||
                    (this.CustomNodeIp != null &&
                    this.CustomNodeIp.Equals(input.CustomNodeIp))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CustomNodeIp != null)
                    hashCode = hashCode * 59 + this.CustomNodeIp.GetHashCode();

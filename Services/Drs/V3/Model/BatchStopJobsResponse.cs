...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchStopJobsResponse : SdkResponse
    {
        ...
        public List<PauseJobResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchStopJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchStopJobsResponse input)
        {

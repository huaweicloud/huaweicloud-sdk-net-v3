...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class BatchUpdateDatabaseObjectReq 
    {
        ...
        public List<UpdateDatabaseObjectReq> Jobs { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateDatabaseObjectReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateDatabaseObjectReq input)
        {
            if (input == null)
                return false;

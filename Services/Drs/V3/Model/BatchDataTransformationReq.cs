...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class BatchDataTransformationReq 
    {
        ...
        public List<CheckDataTransformationReq> Jobs { get; set; }
        ...
        {
            return this.Equals(input as BatchDataTransformationReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDataTransformationReq input)
        {

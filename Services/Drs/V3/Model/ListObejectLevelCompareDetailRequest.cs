...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class ListObejectLevelCompareDetailRequest 
    {
        ...
        /// </summary>
        [SDKProperty("compare_type", IsPath = true)]
        ...
        {
            return this.Equals(input as ListObejectLevelCompareDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListObejectLevelCompareDetailRequest input)
        {
            if (input == null)
                return false;

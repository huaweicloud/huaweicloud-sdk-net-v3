...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchListRposAndRtosResponse : SdkResponse
    {
        ...
        public List<QueryRpoAndRtoResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchListRposAndRtosResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchListRposAndRtosResponse input)
        {

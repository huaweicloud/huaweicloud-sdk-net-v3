...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class LtsInfoJob 
    {
        ...
        /// 是否开启LTS。
        /// </summary>
        [JsonProperty("lts_enabled", NullValueHandling = NullValueHandling.Ignore)]
        public bool? LtsEnabled { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ltsEnabled: ").Append(LtsEnabled).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LtsInfoJob);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(LtsInfoJob input)
        {
            ...
            if (this.LtsEnabled != input.LtsEnabled || (this.LtsEnabled != null && !this.LtsEnabled.Equals(input.LtsEnabled))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LtsEnabled != null) hashCode = hashCode * 59 + this.LtsEnabled.GetHashCode();
                return hashCode;
            }
        }
    }

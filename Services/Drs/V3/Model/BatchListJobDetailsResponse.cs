...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchListJobDetailsResponse : SdkResponse
    {
        ...
        public List<QueryJobResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchListJobDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchListJobDetailsResponse input)
        {

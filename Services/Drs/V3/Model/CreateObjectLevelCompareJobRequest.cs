...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class CreateObjectLevelCompareJobRequest 
    {
        ...
        public CreateObjectCompareJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateObjectLevelCompareJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateObjectLevelCompareJobRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class CompareTaskListResult 
    {
        ...
        public bool Equals(CompareTaskListResult input)
        {
            ...
            return 
                (
                    this.CompareTaskList == input.CompareTaskList ||
                    this.CompareTaskList != null &&
                    input.CompareTaskList != null &&
                    this.CompareTaskList.SequenceEqual(input.CompareTaskList)
                ) && 
                (
                    this.CompareTaskListCount == input.CompareTaskListCount ||
                    (this.CompareTaskListCount != null &&
                    this.CompareTaskListCount.Equals(input.CompareTaskListCount))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CompareTaskList != null)
                    hashCode = hashCode * 59 + this.CompareTaskList.GetHashCode();
                if (this.CompareTaskListCount != null)
                    hashCode = hashCode * 59 + this.CompareTaskListCount.GetHashCode();

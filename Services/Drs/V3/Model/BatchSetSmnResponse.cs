...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchSetSmnResponse : SdkResponse
    {
        ...
        public List<ImportSmnResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchSetSmnResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchSetSmnResponse input)
        {

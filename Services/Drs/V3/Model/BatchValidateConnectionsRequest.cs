...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class BatchValidateConnectionsRequest 
    {
        ...
        public BatchTestConnectionReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchValidateConnectionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchValidateConnectionsRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteJobsResponse : SdkResponse
    {
        ...
        public List<DeleteJobResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteJobsResponse input)
        {

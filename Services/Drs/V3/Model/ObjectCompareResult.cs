...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class ObjectCompareResult 
    {
        ...
        public bool Equals(ObjectCompareResult input)
        {
            ...
            if (this.ObjectCompareOverview != input.ObjectCompareOverview || (this.ObjectCompareOverview != null && input.ObjectCompareOverview != null && !this.ObjectCompareOverview.SequenceEqual(input.ObjectCompareOverview))) return false;
            if (this.ObjectCompareDetails != input.ObjectCompareDetails || (this.ObjectCompareDetails != null && input.ObjectCompareDetails != null && !this.ObjectCompareDetails.SequenceEqual(input.ObjectCompareDetails))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ObjectCompareOverview != null) hashCode = hashCode * 59 + this.ObjectCompareOverview.GetHashCode();
                if (this.ObjectCompareDetails != null) hashCode = hashCode * 59 + this.ObjectCompareDetails.GetHashCode();

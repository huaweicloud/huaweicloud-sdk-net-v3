...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadCompareResultFileRequest 
    {
        /// <summary>
        /// 请求语言类型。
        /// </summary>
        ...
        /// </summary>
        [SDKProperty("compare_job_id", IsQuery = true)]
        ...
        public ExportCompareResultReq Body { get; set; }
        ...
        {
            return this.Equals(input as DownloadCompareResultFileRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadCompareResultFileRequest input)
        {

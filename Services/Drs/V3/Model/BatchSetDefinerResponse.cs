...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchSetDefinerResponse : SdkResponse
    {
        ...
        public List<ModifyJobResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchSetDefinerResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchSetDefinerResponse input)
        {

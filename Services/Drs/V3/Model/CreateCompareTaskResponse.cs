    ...
    public class CreateCompareTaskResponse : SdkResponse
    {
        ...
        public bool Equals(CreateCompareTaskResponse input)
        {
            ...
            return 
                ...
                (
                    this.ObjectLevelCompareCreateResult == input.ObjectLevelCompareCreateResult ||
                    (this.ObjectLevelCompareCreateResult != null &&
                    this.ObjectLevelCompareCreateResult.Equals(input.ObjectLevelCompareCreateResult))
                ) && 
                (
                    this.DataLevelCompareCreateResult == input.DataLevelCompareCreateResult ||
                    (this.DataLevelCompareCreateResult != null &&
                    this.DataLevelCompareCreateResult.Equals(input.DataLevelCompareCreateResult))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ObjectLevelCompareCreateResult != null)
                    hashCode = hashCode * 59 + this.ObjectLevelCompareCreateResult.GetHashCode();
                if (this.DataLevelCompareCreateResult != null)
                    hashCode = hashCode * 59 + this.DataLevelCompareCreateResult.GetHashCode();

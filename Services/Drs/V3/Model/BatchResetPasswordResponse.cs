...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchResetPasswordResponse : SdkResponse
    {
        ...
        public List<ModifyDbPwdResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchResetPasswordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchResetPasswordResponse input)
        {

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class BatchSpecialTestConnectionReq 
    {
        ...
        public List<BatchJobActionReq> Jobs { get; set; }
        ...
        {
            return this.Equals(input as BatchSpecialTestConnectionReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchSpecialTestConnectionReq input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchChangeDataResponse : SdkResponse
    {
        ...
        public List<DataTransformationResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchChangeDataResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchChangeDataResponse input)
        {

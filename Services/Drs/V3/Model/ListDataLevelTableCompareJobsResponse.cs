...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDataLevelTableCompareJobsResponse : SdkResponse
    {
        ...
        public List<CompareJobInfo> CompareJobs { get; set; }
        ...
        {
            return this.Equals(input as ListDataLevelTableCompareJobsResponse);
        }

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class QueryTuningParamsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as QueryTuningParamsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QueryTuningParamsResponse input)
        {
            ...
            if (this.ModifyResult != input.ModifyResult || (this.ModifyResult != null && !this.ModifyResult.Equals(input.ModifyResult))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ModifyResult != null) hashCode = hashCode * 59 + this.ModifyResult.GetHashCode();
                return hashCode;
            }
        }
    }

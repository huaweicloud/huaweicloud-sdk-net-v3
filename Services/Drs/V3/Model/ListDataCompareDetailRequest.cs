    ...
    public class ListDataCompareDetailRequest 
    {
        ...
        public bool Equals(ListDataCompareDetailRequest input)
        {
            ...
            return 
                ...
                (
                    this.QueryTbName == input.QueryTbName ||
                    (this.QueryTbName != null &&
                    this.QueryTbName.Equals(input.QueryTbName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QueryTbName != null)
                    hashCode = hashCode * 59 + this.QueryTbName.GetHashCode();
                if (this.Limit != null)

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class CreateDataLevelTableCompareJobRequest 
    {
        ...
        public CreateDataLevelTableCompareJobReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateDataLevelTableCompareJobRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDataLevelTableCompareJobRequest input)
        {

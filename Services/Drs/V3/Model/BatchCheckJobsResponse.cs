...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchCheckJobsResponse : SdkResponse
    {
        ...
        public List<PostPreCheckResp> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchCheckJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCheckJobsResponse input)
        {

...
namespace HuaweiCloud.SDK.Drs.V3.Model
{
    ...
    public class BatchValidateClustersConnectionsRequest 
    {
        ...
        public BatchSpecialTestConnectionReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchValidateClustersConnectionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchValidateClustersConnectionsRequest input)
        {

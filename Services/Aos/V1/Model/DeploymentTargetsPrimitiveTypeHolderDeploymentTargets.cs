...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class DeploymentTargetsPrimitiveTypeHolderDeploymentTargets 
    {
        ...
        {
            return this.Equals(input as DeploymentTargetsPrimitiveTypeHolderDeploymentTargets);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeploymentTargetsPrimitiveTypeHolderDeploymentTargets input)
        {
            if (input == null)
                return false;

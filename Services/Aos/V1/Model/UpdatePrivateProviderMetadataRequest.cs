...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class UpdatePrivateProviderMetadataRequest 
    {
        ...
        public UpdatePrivateProviderMetadataRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePrivateProviderMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateProviderMetadataRequest input)
        {

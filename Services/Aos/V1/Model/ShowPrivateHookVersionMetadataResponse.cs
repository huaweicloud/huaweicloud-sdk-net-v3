...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPrivateHookVersionMetadataResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPrivateHookVersionMetadataResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPrivateHookVersionMetadataResponse input)
        {

...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class VarOverridesPrimitiveTypeHolderVarOverrides 
    {
        ...
        /// </summary>
        [JsonProperty("use_stack_set_vars", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> UseStackSetVars { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  useStackSetVars: ").Append(UseStackSetVars).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as VarOverridesPrimitiveTypeHolderVarOverrides);
        }

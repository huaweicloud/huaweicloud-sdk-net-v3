...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class UpdatePrivateModuleMetadataRequest 
    {
        ...
        public UpdatePrivateModuleMetadataRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePrivateModuleMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePrivateModuleMetadataRequest input)
        {

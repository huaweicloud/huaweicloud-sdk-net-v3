...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class CreatePrivateProviderRequest 
    {
        ...
        public CreatePrivateProviderRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePrivateProviderRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePrivateProviderRequest input)
        {

...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class ContinueRollbackStackRequest 
    {
        ...
        public ContinueRollbackStackRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ContinueRollbackStackRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ContinueRollbackStackRequest input)
        {
            if (input == null)
                return false;

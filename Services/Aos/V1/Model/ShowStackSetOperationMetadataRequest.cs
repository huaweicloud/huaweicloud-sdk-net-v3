...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class ShowStackSetOperationMetadataRequest 
    {
        ...
        /// </summary>
        [SDKProperty("stack_set_operation_id", IsPath = true)]
        ...
        {
            return this.Equals(input as ShowStackSetOperationMetadataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowStackSetOperationMetadataRequest input)
        {

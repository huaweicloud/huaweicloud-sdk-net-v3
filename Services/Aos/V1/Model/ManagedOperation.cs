...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class ManagedOperation 
    {
        ...
        public bool Equals(ManagedOperation input)
        {
            ...
            return 
                (
                    this.EnableParallelOperation == input.EnableParallelOperation ||
                    (this.EnableParallelOperation != null &&
                    this.EnableParallelOperation.Equals(input.EnableParallelOperation))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.EnableParallelOperation != null)
                    hashCode = hashCode * 59 + this.EnableParallelOperation.GetHashCode();
                return hashCode;
            }
        }
    }

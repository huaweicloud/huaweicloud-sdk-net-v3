...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class ShowStackInstanceRequest 
    {
        ...
        /// </summary>
        [SDKProperty("stack_instance_addr", IsPath = true)]
        [JsonProperty("stack_instance_addr", NullValueHandling = NullValueHandling.Ignore)]
        public string StackInstanceAddr { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  stackInstanceAddr: ").Append(StackInstanceAddr).Append("\n");
        ...
        {
            return this.Equals(input as ShowStackInstanceRequest);
        }

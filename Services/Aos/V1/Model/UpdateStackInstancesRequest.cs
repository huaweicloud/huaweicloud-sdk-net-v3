...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class UpdateStackInstancesRequest 
    {
        ...
        public UpdateStackInstancesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateStackInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateStackInstancesRequest input)
        {
            if (input == null)
                return false;

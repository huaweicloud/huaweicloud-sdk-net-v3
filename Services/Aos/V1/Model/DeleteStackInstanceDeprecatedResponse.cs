...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteStackInstanceDeprecatedResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteStackInstanceDeprecatedResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteStackInstanceDeprecatedResponse input)
        {

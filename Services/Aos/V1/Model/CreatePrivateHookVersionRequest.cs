...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class CreatePrivateHookVersionRequest 
    {
        ...
        public CreatePrivateHookVersionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePrivateHookVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePrivateHookVersionRequest input)
        {

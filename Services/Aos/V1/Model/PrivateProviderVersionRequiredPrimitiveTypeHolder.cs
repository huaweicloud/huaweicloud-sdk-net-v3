...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    public class PrivateProviderVersionRequiredPrimitiveTypeHolder 
    {
        ...
        {
            return this.Equals(input as PrivateProviderVersionRequiredPrimitiveTypeHolder);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PrivateProviderVersionRequiredPrimitiveTypeHolder input)
        {

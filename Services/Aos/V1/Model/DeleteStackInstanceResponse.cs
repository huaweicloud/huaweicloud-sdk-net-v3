...
namespace HuaweiCloud.SDK.Aos.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteStackInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteStackInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteStackInstanceResponse input)
        {

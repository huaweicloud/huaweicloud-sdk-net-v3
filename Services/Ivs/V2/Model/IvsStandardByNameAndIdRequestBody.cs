...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByNameAndIdRequestBody 
    {
        ...
        public IvsStandardByNameAndIdRequestBodyData Data { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByNameAndIdRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByNameAndIdRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByNameAndIdRequestBodyData 
    {
        ...
        public List<StandardReqDataByNameAndId> ReqData { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByNameAndIdRequestBodyData);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByNameAndIdRequestBodyData input)
        {
            if (input == null)
                return false;

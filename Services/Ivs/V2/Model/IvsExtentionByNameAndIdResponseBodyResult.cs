...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsExtentionByNameAndIdResponseBodyResult 
    {
        ...
        public List<ExtentionRespDataByNameAndId> RespData { get; set; }
        ...
        {
            return this.Equals(input as IvsExtentionByNameAndIdResponseBodyResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsExtentionByNameAndIdResponseBodyResult input)
        {
            if (input == null)
                return false;

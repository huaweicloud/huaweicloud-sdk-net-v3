...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByIdCardImageRequestBody 
    {
        ...
        public IvsStandardByIdCardImageRequestBodyData Data { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByIdCardImageRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByIdCardImageRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class DetectStandardByVideoAndIdCardImageRequest 
    {
        ...
        public IvsStandardByVideoAndIdCardImageRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetectStandardByVideoAndIdCardImageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectStandardByVideoAndIdCardImageRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class DetectExtentionByIdCardImageRequest 
    {
        ...
        public IvsExtentionByIdCardImageRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetectExtentionByIdCardImageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectExtentionByIdCardImageRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByVideoAndIdCardImageRequestBodyData 
    {
        ...
        public List<ReqDataByVideoAndIdCardImage> ReqData { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByVideoAndIdCardImageRequestBodyData);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByVideoAndIdCardImageRequestBodyData input)
        {
            if (input == null)
                return false;

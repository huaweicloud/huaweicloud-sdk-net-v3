...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByVideoAndNameAndIdRequestBody 
    {
        ...
        public IvsStandardByVideoAndNameAndIdRequestBodyData Data { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByVideoAndNameAndIdRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByVideoAndNameAndIdRequestBody input)
        {

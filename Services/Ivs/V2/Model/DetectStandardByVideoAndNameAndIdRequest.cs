...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class DetectStandardByVideoAndNameAndIdRequest 
    {
        ...
        public IvsStandardByVideoAndNameAndIdRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetectStandardByVideoAndNameAndIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectStandardByVideoAndNameAndIdRequest input)
        {
            if (input == null)
                return false;

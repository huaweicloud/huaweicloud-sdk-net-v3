...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByVideoAndIdCardImageResponseBodyResult 
    {
        ...
        public List<RespDataByVideoAndIdCardImage> RespData { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByVideoAndIdCardImageResponseBodyResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByVideoAndIdCardImageResponseBodyResult input)
        {
            if (input == null)
                return false;

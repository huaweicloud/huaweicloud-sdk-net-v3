...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class DetectStandardByNameAndIdRequest 
    {
        ...
        public IvsStandardByNameAndIdRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetectStandardByNameAndIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectStandardByNameAndIdRequest input)
        {
            if (input == null)
                return false;

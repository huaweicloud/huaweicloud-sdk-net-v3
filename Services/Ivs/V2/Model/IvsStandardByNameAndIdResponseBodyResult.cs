...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsStandardByNameAndIdResponseBodyResult 
    {
        ...
        public List<StandardRespDataByNameAndId> RespData { get; set; }
        ...
        {
            return this.Equals(input as IvsStandardByNameAndIdResponseBodyResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsStandardByNameAndIdResponseBodyResult input)
        {
            if (input == null)
                return false;

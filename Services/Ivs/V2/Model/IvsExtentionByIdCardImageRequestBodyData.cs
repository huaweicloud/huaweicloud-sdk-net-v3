...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsExtentionByIdCardImageRequestBodyData 
    {
        ...
        public List<ExtentionReqDataByIdCardImage> ReqData { get; set; }
        ...
        {
            return this.Equals(input as IvsExtentionByIdCardImageRequestBodyData);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsExtentionByIdCardImageRequestBodyData input)
        {
            if (input == null)
                return false;

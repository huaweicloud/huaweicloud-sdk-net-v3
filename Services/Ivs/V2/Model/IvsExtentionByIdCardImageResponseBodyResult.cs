...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class IvsExtentionByIdCardImageResponseBodyResult 
    {
        ...
        public List<ExtentionRespDataByIdCardImage> RespData { get; set; }
        ...
        {
            return this.Equals(input as IvsExtentionByIdCardImageResponseBodyResult);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(IvsExtentionByIdCardImageResponseBodyResult input)
        {

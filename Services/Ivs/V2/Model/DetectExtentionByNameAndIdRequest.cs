...
namespace HuaweiCloud.SDK.Ivs.V2.Model
{
    ...
    public class DetectExtentionByNameAndIdRequest 
    {
        ...
        public IvsExtentionByNameAndIdRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetectExtentionByNameAndIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectExtentionByNameAndIdRequest input)
        {
            if (input == null)
                return false;

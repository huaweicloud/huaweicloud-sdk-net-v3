...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RetryPipelineRunResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RetryPipelineRunResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RetryPipelineRunResponse input)
        {

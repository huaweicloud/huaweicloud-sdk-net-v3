...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeletePipelineGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeletePipelineGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeletePipelineGroupResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBasePluginsResponse : SdkResponse
    {
        ...
        public List<PageInfoOptionalSinglePluginVOData> Data { get; set; }
        ...
        {
            return this.Equals(input as ListBasePluginsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBasePluginsResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class UpdatePipelineTemplateRequest 
    {
        ...
        public PipelineTemplateDTO Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePipelineTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePipelineTemplateRequest input)
        {

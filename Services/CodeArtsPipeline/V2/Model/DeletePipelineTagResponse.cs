...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeletePipelineTagResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeletePipelineTagResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeletePipelineTagResponse input)
        {

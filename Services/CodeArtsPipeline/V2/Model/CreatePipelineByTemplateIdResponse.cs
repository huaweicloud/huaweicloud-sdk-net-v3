...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePipelineByTemplateIdResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePipelineByTemplateIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePipelineByTemplateIdResponse input)
        {

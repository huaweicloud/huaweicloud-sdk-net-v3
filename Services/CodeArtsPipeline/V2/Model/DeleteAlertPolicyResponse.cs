...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteAlertPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteAlertPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteAlertPolicyResponse input)
        {

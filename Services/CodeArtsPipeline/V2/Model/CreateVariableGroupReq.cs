...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class CreateVariableGroupReq 
    {
        ...
        public List<CreateVariableGroupReqVariables> Variables { get; set; }
        ...
        {
            return this.Equals(input as CreateVariableGroupReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVariableGroupReq input)
        {

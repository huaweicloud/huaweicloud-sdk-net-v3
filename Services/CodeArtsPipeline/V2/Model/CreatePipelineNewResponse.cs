...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePipelineNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePipelineNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePipelineNewResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class RunActionsPipelineRequest 
    {
        ...
        public ActionsManualRunPipelineDTO Body { get; set; }
        ...
        {
            return this.Equals(input as RunActionsPipelineRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RunActionsPipelineRequest input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePipelineTagResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePipelineTagResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePipelineTagResponse input)
        {

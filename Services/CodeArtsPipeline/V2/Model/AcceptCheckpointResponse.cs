...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AcceptCheckpointResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AcceptCheckpointResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AcceptCheckpointResponse input)
        {

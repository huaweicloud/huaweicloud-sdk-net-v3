...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class ShowStepOutputsRequest 
    {
        ...
        /// 
        /// </summary>
        [SDKProperty("step_run_ids", IsQuery = true)]
        [JsonProperty("step_run_ids", NullValueHandling = NullValueHandling.Ignore)]
        public string StepRunIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  stepRunIds: ").Append(StepRunIds).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowStepOutputsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowStepOutputsRequest input)
        {
            ...
            if (this.StepRunIds != input.StepRunIds || (this.StepRunIds != null && !this.StepRunIds.Equals(input.StepRunIds))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StepRunIds != null) hashCode = hashCode * 59 + this.StepRunIds.GetHashCode();
                return hashCode;
            }
        }
    }

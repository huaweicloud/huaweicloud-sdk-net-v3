...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTemplateDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTemplateDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTemplateDetailResponse input)
        {

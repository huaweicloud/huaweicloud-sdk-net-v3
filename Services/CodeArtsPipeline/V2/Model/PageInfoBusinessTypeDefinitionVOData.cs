...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class PageInfoBusinessTypeDefinitionVOData 
    {
        ...
        public List<Dictionary<string, bool?>> Addables { get; set; }
        ...
        public List<PageInfoBusinessTypeDefinitionVOPluginsList> PluginsList { get; set; }
        ...
        {
            return this.Equals(input as PageInfoBusinessTypeDefinitionVOData);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PageInfoBusinessTypeDefinitionVOData input)
        {

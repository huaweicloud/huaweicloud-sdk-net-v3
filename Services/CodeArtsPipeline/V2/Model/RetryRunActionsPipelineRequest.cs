...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class RetryRunActionsPipelineRequest 
    {
        ...
        public ActionsReRunPipelineDTO Body { get; set; }
        ...
        {
            return this.Equals(input as RetryRunActionsPipelineRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RetryRunActionsPipelineRequest input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// 
    /// </summary>
    public class UploadPublisherIconRequestBody : IFormDataBody
    {
        ...
        public UploadPublisherIconRequestBody WithUploadFile(Stream stream, string filename)
        {
            this.UploadFile = new FormDataFilePart(stream, filename);
            return this;
        }

        public UploadPublisherIconRequestBody WithUploadFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as UploadPublisherIconRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadPublisherIconRequestBody input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// 
    /// </summary>
    public class UploadBasicPluginRequestBody : IFormDataBody
    {
        ...
        public UploadBasicPluginRequestBody WithUploadFile(Stream stream, string filename)
        {
            this.UploadFile = new FormDataFilePart(stream, filename);
            return this;
        }

        public UploadBasicPluginRequestBody WithUploadFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as UploadBasicPluginRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadBasicPluginRequestBody input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class PluginPartQueryVOListAgentPluginOutputVO 
    {
        ...
        public List<PluginPartQueryVOListAgentPluginOutputVOData> Data { get; set; }
        ...
        {
            return this.Equals(input as PluginPartQueryVOListAgentPluginOutputVO);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PluginPartQueryVOListAgentPluginOutputVO input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class ListPipelineRunsPagePipelineRuns 
    {
        ...
        public List<ListPipelineRunsPageStageStatusList> StageStatusList { get; set; }
        ...
        public ListPipelineRunsPageBuildParams BuildParams { get; set; }
        ...
        {
            return this.Equals(input as ListPipelineRunsPagePipelineRuns);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPipelineRunsPagePipelineRuns input)
        {

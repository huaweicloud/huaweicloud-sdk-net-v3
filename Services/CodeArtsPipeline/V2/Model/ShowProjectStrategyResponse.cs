...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProjectStrategyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProjectStrategyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectStrategyResponse input)
        {

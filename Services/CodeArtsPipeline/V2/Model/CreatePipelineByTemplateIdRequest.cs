...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class CreatePipelineByTemplateIdRequest 
    {
        ...
        public PipelineByTemplateDTO Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePipelineByTemplateIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePipelineByTemplateIdRequest input)
        {

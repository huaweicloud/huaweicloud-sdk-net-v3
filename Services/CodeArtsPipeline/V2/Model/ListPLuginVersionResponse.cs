...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPLuginVersionResponse : SdkResponse
    {
        ...
        public List<PluginBasicVO> Data { get; set; }
        ...
        {
            return this.Equals(input as ListPLuginVersionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPLuginVersionResponse input)
        {

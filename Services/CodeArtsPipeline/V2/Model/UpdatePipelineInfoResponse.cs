...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePipelineInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePipelineInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePipelineInfoResponse input)
        {

...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    public class PageInfoBusinessTypeDefinitionVOPluginsList 
    {
        ...
        public List<PageInfoBusinessTypeDefinitionVOAllSteps> AllSteps { get; set; }
        ...
        {
            return this.Equals(input as PageInfoBusinessTypeDefinitionVOPluginsList);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PageInfoBusinessTypeDefinitionVOPluginsList input)
        {

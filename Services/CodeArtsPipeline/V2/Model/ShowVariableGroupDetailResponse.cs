...
namespace HuaweiCloud.SDK.CodeArtsPipeline.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowVariableGroupDetailResponse : SdkResponse
    {
        ...
        public List<QueryVariableGroupDetailRespRelatedPipelines> RelatedPipelines { get; set; }
        ...
        {
            return this.Equals(input as ShowVariableGroupDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowVariableGroupDetailResponse input)
        {

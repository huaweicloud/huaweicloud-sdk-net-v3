...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class PartitionReqBody 
    {
        ...
        public PartitionReqBodyMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public PartitionReqBodySpec Spec { get; set; }
        ...
        {
            return this.Equals(input as PartitionReqBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PartitionReqBody input)
        {

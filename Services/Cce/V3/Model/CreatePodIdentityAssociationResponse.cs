...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePodIdentityAssociationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePodIdentityAssociationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePodIdentityAssociationResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class AddonCheckTask 
    {
        ...
        public CheckTaskMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public CheckTaskSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public CheckTaskStatus Status { get; set; }
        ...
        {
            return this.Equals(input as AddonCheckTask);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddonCheckTask input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAutopilotAddonInstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAutopilotAddonInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAutopilotAddonInstancesResponse input)
        {

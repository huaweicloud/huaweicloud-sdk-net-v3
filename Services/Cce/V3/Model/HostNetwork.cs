...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class HostNetwork 
    {
        ...
        /// </summary>
        [JsonProperty("highwaySubnet", NullValueHandling = NullValueHandling.Ignore)]
        public string HighwaySubnet { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  highwaySubnet: ").Append(HighwaySubnet).Append("\n");
        ...
        public bool Equals(HostNetwork input)
        {
            ...
            return 
                ...
                (
                    this.HighwaySubnet == input.HighwaySubnet ||
                    (this.HighwaySubnet != null &&
                    this.HighwaySubnet.Equals(input.HighwaySubnet))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HighwaySubnet != null)
                    hashCode = hashCode * 59 + this.HighwaySubnet.GetHashCode();
                if (this.Subnet != null)

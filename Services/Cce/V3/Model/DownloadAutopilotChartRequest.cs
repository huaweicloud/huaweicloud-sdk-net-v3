...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Request Object
    /// </summary>
    public class DownloadAutopilotChartRequest 
    {
        ...
        {
            return this.Equals(input as DownloadAutopilotChartRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadAutopilotChartRequest input)
        {

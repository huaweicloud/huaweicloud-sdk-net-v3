...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotClusterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutopilotClusterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotClusterResponse input)
        {
            if (input == null)
                return false;

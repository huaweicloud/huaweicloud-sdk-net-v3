...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotReleaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutopilotReleaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotReleaseResponse input)
        {

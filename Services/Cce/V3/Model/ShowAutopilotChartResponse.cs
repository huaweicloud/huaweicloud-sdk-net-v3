...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotChartResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutopilotChartResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotChartResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAutopilotAddonTemplatesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAutopilotAddonTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAutopilotAddonTemplatesResponse input)
        {

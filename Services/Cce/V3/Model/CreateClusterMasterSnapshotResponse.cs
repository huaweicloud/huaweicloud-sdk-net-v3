...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateClusterMasterSnapshotResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateClusterMasterSnapshotResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateClusterMasterSnapshotResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowClusterUpgradeInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowClusterUpgradeInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowClusterUpgradeInfoResponse input)
        {

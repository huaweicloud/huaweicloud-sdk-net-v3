...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListClusterUpgradePathsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListClusterUpgradePathsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListClusterUpgradePathsResponse input)
        {
            ...
            if (this.UpgradePaths != input.UpgradePaths || (this.UpgradePaths != null && input.UpgradePaths != null && !this.UpgradePaths.SequenceEqual(input.UpgradePaths))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UpgradePaths != null) hashCode = hashCode * 59 + this.UpgradePaths.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class InplaceMigrateNodeResponse : SdkResponse
    {
        ...
        public InPlaceMigratetoNodesSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as InplaceMigrateNodeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(InplaceMigrateNodeResponse input)
        {

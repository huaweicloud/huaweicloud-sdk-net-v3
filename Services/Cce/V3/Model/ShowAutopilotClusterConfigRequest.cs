...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class ShowAutopilotClusterConfigRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 组件类型，不填写则查询全部类型。  **约束限制**： 合法取值为control，audit，system-addon  **取值范围**： - control: 控制面组件日志。 - audit: 控制面审计日志。 - system-addon: 系统插件日志。  **默认取值**： 无</value>
        ...
        {
            return this.Equals(input as ShowAutopilotClusterConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotClusterConfigRequest input)
        {

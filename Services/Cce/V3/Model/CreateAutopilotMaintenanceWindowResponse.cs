...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutopilotMaintenanceWindowResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAutopilotMaintenanceWindowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutopilotMaintenanceWindowResponse input)
        {

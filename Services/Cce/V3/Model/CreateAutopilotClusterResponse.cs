...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutopilotClusterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAutopilotClusterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutopilotClusterResponse input)
        {

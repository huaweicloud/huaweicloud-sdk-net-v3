...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAccessPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAccessPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAccessPolicyResponse input)
        {

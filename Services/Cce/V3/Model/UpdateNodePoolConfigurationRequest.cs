...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class UpdateNodePoolConfigurationRequest 
    {
        ...
        public UpdateClusterConfigurationsBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateNodePoolConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNodePoolConfigurationRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotUpgradeWorkFlowResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutopilotUpgradeWorkFlowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotUpgradeWorkFlowResponse input)
        {

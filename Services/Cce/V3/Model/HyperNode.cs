...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class HyperNode 
    {
        ...
        public HyperNodeMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public HyperNodeSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public HyperNodeStatus Status { get; set; }
        ...
        {
            return this.Equals(input as HyperNode);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(HyperNode input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAutopilotMaintenanceWindowResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAutopilotMaintenanceWindowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAutopilotMaintenanceWindowResponse input)
        {

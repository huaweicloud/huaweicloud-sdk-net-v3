...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFeatureGatesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowFeatureGatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFeatureGatesResponse input)
        {

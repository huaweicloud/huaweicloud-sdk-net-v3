...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class StorageSelectors 
    {
        ...
        public bool Equals(StorageSelectors input)
        {
            ...
            if (this.MatchLabels != input.MatchLabels || (this.MatchLabels != null && !this.MatchLabels.Equals(input.MatchLabels))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MatchLabels != null) hashCode = hashCode * 59 + this.MatchLabels.GetHashCode();
                return hashCode;
            }
        }
    }

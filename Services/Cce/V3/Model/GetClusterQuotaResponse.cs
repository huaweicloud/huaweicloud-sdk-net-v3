...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetClusterQuotaResponse : SdkResponse
    {
        ...
        public GetClusterQuotaBodyQuotas Quotas { get; set; }
        ...
        {
            return this.Equals(input as GetClusterQuotaResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetClusterQuotaResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RollbackAddonInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RollbackAddonInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RollbackAddonInstanceResponse input)
        {

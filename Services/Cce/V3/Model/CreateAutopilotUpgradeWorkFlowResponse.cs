...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutopilotUpgradeWorkFlowResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAutopilotUpgradeWorkFlowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutopilotUpgradeWorkFlowResponse input)
        {

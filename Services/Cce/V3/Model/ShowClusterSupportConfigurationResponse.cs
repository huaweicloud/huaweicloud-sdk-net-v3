...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowClusterSupportConfigurationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowClusterSupportConfigurationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowClusterSupportConfigurationResponse input)
        {

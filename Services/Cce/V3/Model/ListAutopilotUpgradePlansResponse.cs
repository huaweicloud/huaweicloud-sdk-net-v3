...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAutopilotUpgradePlansResponse : SdkResponse
    {
        ...
        public UpgradePlan Items { get; set; }
        ...
        {
            return this.Equals(input as ListAutopilotUpgradePlansResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAutopilotUpgradePlansResponse input)
        {

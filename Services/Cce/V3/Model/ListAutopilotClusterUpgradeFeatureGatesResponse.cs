...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAutopilotClusterUpgradeFeatureGatesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAutopilotClusterUpgradeFeatureGatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAutopilotClusterUpgradeFeatureGatesResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.UpgradeFeatureGates != null &&
                    this.UpgradeFeatureGates.SequenceEqual(input.UpgradeFeatureGates)
                );
        }

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutopilotKubernetesClusterCertResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAutopilotKubernetesClusterCertResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutopilotKubernetesClusterCertResponse input)
        {

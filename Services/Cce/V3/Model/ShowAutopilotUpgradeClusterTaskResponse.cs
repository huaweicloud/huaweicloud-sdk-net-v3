...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotUpgradeClusterTaskResponse : SdkResponse
    {
        ...
        public UpgradeTaskMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public UpgradeTaskSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public UpgradeTaskStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ShowAutopilotUpgradeClusterTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotUpgradeClusterTaskResponse input)
        {

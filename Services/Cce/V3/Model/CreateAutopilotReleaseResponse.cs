...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutopilotReleaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAutopilotReleaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutopilotReleaseResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class ExtensionScaleGroup 
    {
        ...
        public ExtensionScaleGroupMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public ExtensionScaleGroupSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as ExtensionScaleGroup);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExtensionScaleGroup input)
        {

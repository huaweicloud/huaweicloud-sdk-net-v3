...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpgradeAutopilotClusterResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpgradeAutopilotClusterResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradeAutopilotClusterResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class AutopilotClusterSpec 
    {
        ...
        /// </summary>
        /// <value>集群Master节点架构：  - VirtualMachine：Master节点为x86架构服务器 </value>
        ...
        /// </summary>
        /// <value>服务转发模式：  - iptables：社区传统的kube-proxy模式，完全以iptables规则的方式来实现service负载均衡。该方式最主要的问题是在服务多的时候产生太多的iptables规则，非增量式更新会引入一定的时延，大规模情况下有明显的性能问题。  &gt; 默认使用iptables转发模式。 </value>
        ...
        /// </summary>
        [JsonProperty("enableSnat", NullValueHandling = NullValueHandling.Ignore)]
        public bool? EnableSnat { get; set; }

        /// <summary>
        /// 集群是否配置镜像访问。为确保您的集群节点可以从容器镜像服务中拉取镜像，默认使用所选VPC中已有的SWR和OBS终端节点，否则将会为您自动新建SWR和OBS终端节点。
        /// </summary>
        [JsonProperty("enableSWRImageAccess", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public List<AutopilotResourceTag> ClusterTags { get; set; }
        ...
        {
            return this.Equals(input as AutopilotClusterSpec);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AutopilotClusterSpec input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EnableSWRImageAccess == input.EnableSWRImageAccess ||
                    (this.EnableSWRImageAccess != null &&
                    this.EnableSWRImageAccess.Equals(input.EnableSWRImageAccess))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnableSWRImageAccess != null)
                    hashCode = hashCode * 59 + this.EnableSWRImageAccess.GetHashCode();

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAutopilotUpgradePlanResponse : SdkResponse
    {
        ...
        public UpgradePlanSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public UpgradePlanStatus Status { get; set; }
        ...
        {
            return this.Equals(input as UpdateAutopilotUpgradePlanResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAutopilotUpgradePlanResponse input)
        {

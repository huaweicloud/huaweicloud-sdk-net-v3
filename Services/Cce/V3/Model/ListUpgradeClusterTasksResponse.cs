...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListUpgradeClusterTasksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListUpgradeClusterTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListUpgradeClusterTasksResponse input)
        {

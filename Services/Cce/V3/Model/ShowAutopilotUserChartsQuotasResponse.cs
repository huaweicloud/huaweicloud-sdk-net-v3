...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotUserChartsQuotasResponse : SdkResponse
    {
        ...
        public QuotaRespQuotas Quotas { get; set; }
        ...
        {
            return this.Equals(input as ShowAutopilotUserChartsQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotUserChartsQuotasResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class PartitionReqBodySpec 
    {
        ...
        public PartitionReqBodySpecHostNetwork HostNetwork { get; set; }

        /// <summary>
        /// **参数解释**： 分区容器子网 **约束限制**： 列表长度不能大于20 **取值范围**： 不涉及 **默认取值**： 不涉及 
        /// </summary>
        [JsonProperty("containerNetwork", NullValueHandling = NullValueHandling.Ignore)]
        public List<PartitionReqBodySpecContainerNetwork> ContainerNetwork { get; set; }
        ...
        {
            return this.Equals(input as PartitionReqBodySpec);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PartitionReqBodySpec input)
        {

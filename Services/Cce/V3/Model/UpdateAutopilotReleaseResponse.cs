...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAutopilotReleaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAutopilotReleaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAutopilotReleaseResponse input)
        {
            if (input == null)
                return false;

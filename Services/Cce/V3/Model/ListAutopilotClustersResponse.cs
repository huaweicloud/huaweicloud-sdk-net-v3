...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAutopilotClustersResponse : SdkResponse
    {
        ...
        public List<AutopilotCluster> Items { get; set; }
        ...
        {
            return this.Equals(input as ListAutopilotClustersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAutopilotClustersResponse input)
        {

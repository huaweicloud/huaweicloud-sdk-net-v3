...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotQuotasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAutopilotQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotQuotasResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotClusterUpgradeInfoResponse : SdkResponse
    {
        ...
        public UpgradeInfoSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public UpgradeInfoStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ShowAutopilotClusterUpgradeInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotClusterUpgradeInfoResponse input)
        {

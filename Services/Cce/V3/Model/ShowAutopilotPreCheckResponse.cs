...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotPreCheckResponse : SdkResponse
    {
        ...
        public PrecheckTaskMetadata Metadata { get; set; }
        ...
        {
            return this.Equals(input as ShowAutopilotPreCheckResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotPreCheckResponse input)
        {

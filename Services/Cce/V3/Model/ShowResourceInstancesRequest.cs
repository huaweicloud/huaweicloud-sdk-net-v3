...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class ShowResourceInstancesRequest 
    {
        ...
        public ShowResourceInstances Body { get; set; }
        ...
        {
            return this.Equals(input as ShowResourceInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourceInstancesRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePodIdentityAssociationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePodIdentityAssociationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePodIdentityAssociationResponse input)
        {

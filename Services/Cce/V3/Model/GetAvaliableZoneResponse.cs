...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetAvaliableZoneResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetAvaliableZoneResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetAvaliableZoneResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteAutopilotMaintenanceWindowResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteAutopilotMaintenanceWindowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteAutopilotMaintenanceWindowResponse input)
        {

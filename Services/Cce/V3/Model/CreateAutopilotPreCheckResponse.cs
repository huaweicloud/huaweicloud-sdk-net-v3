...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAutopilotPreCheckResponse : SdkResponse
    {
        ...
        public PrecheckCluserResponseMetadata Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public PrecheckSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as CreateAutopilotPreCheckResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAutopilotPreCheckResponse input)
        {

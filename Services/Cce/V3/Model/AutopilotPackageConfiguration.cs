...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class AutopilotPackageConfiguration 
    {
        ...
        public List<AutopilotConfigurationItem> Configurations { get; set; }
        ...
        {
            return this.Equals(input as AutopilotPackageConfiguration);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AutopilotPackageConfiguration input)
        {

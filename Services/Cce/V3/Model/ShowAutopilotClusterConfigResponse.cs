...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAutopilotClusterConfigResponse : SdkResponse
    {
        ...
        public List<AutopilotClusterLogConfigLogConfigs> LogConfigs { get; set; }
        ...
        {
            return this.Equals(input as ShowAutopilotClusterConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAutopilotClusterConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchCreateAddonPrecheckResponse : SdkResponse
    {
        ...
        public AddonCheckSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public AddonCheckStatus Status { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateAddonPrecheckResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateAddonPrecheckResponse input)
        {

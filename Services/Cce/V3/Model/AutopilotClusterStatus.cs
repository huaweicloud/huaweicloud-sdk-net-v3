...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class AutopilotClusterStatus 
    {
        ...
        public List<AutopilotClusterEndpoints> Endpoints { get; set; }
        ...
        {
            return this.Equals(input as AutopilotClusterStatus);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AutopilotClusterStatus input)
        {

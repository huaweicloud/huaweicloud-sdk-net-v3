...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowNodePoolConfigurationsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowNodePoolConfigurationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowNodePoolConfigurationsResponse input)
        {

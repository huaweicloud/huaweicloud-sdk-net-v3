...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// 
    /// </summary>
    public class UploadChartRequestBody : IFormDataBody
    {
        ...
        public UploadChartRequestBody WithContent(Stream stream, string filename)
        {
            this.Content = new FormDataFilePart(stream, filename);
            return this;
        }

        public UploadChartRequestBody WithContent(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as UploadChartRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadChartRequestBody input)
        {
            if (input == null)
                return false;

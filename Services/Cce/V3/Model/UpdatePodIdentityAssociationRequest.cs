...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    public class UpdatePodIdentityAssociationRequest 
    {
        ...
        public PodIdentityAssociationUpdate Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePodIdentityAssociationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePodIdentityAssociationRequest input)
        {

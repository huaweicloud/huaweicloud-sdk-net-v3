...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowUpgradeWorkFlowResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowUpgradeWorkFlowResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowUpgradeWorkFlowResponse input)
        {

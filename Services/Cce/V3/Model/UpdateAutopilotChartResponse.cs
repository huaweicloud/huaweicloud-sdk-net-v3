...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAutopilotChartResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAutopilotChartResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAutopilotChartResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ChartUrl == input.ChartUrl ||
                    (this.ChartUrl != null &&
                    this.ChartUrl.Equals(input.ChartUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChartUrl != null)
                    hashCode = hashCode * 59 + this.ChartUrl.GetHashCode();

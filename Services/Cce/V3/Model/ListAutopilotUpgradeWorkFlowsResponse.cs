...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAutopilotUpgradeWorkFlowsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAutopilotUpgradeWorkFlowsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAutopilotUpgradeWorkFlowsResponse input)
        {

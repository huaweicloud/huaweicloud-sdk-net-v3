...
namespace HuaweiCloud.SDK.Cce.V3.Model
{
    ...
    /// 
    /// </summary>
    public class UpdateChartRequestBody : IFormDataBody
    {
        ...
        public UpdateChartRequestBody WithContent(Stream stream, string filename)
        {
            this.Content = new FormDataFilePart(stream, filename);
            return this;
        }

        public UpdateChartRequestBody WithContent(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as UpdateChartRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateChartRequestBody input)
        {
            if (input == null)
                return false;

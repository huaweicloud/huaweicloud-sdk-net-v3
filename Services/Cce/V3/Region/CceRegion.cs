...
namespace HuaweiCloud.SDK.Cce.V3
{
    public class CceRegion
    {
        ...
        public static readonly Region CN_NORTH_9 = new Region("cn-north-9", "https://cce.cn-north-9.myhuaweicloud.com");
        public static readonly Region CN_SOUTH_1 = new Region("cn-south-1", "https://cce.cn-south-1.myhuaweicloud.com");
        public static readonly Region CN_SOUTH_2 = new Region("cn-south-2", "https://cce.cn-south-2.myhuaweicloud.com");
        public static readonly Region CN_SOUTH_4 = new Region("cn-south-4", "https://cce.cn-south-4.myhuaweicloud.com");
        ...
        public static readonly Region SA_BRAZIL_1 = new Region("sa-brazil-1", "https://cce.sa-brazil-1.myhuaweicloud.com");
        public static readonly Region LA_SOUTH_2 = new Region("la-south-2", "https://cce.la-south-2.myhuaweicloud.com");
        public static readonly Region LA_NORTH_2 = new Region("la-north-2", "https://cce.la-north-2.myhuaweicloud.com");
        public static readonly Region NA_MEXICO_1 = new Region("na-mexico-1", "https://cce.na-mexico-1.myhuaweicloud.com");
        public static readonly Region RU_NORTHWEST_2 = new Region("ru-northwest-2", "https://cce.ru-northwest-2.myhuaweicloud.com");

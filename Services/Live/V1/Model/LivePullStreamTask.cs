...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class LivePullStreamTask 
    {
        ...
        /// </summary>
        /// <value>拉流源类型 PullLivePushLive：拉转推（拉直播推直播） PullVodPushLive：轮播（拉点播推直播）</value>
        ...
        public class SourceTypeEnum
        {
            ...
            /// </summary>
            public static readonly SourceTypeEnum PULLLIVEPUSHLIVE = new SourceTypeEnum("PullLivePushLive");

            /// <summary>
            /// Enum PULLVODPUSHLIVE for value: PullVodPushLive
            /// </summary>
            public static readonly SourceTypeEnum PULLVODPUSHLIVE = new SourceTypeEnum("PullVodPushLive");
        ...
        /// </summary>
        /// <value>轮播文件播放形式，仅当source_type为PullVodPushLive生效。缺省值immediate_new_source immediate_new_source：立即播放新的文件源 continue_from_file_start：从上次断流URL文件重新播放（更新任务时有效） continue_from_break_point：从上次断流URL文件断流位置重新播放（更新任务时有效）</value>
        ...
        {
            return this.Equals(input as LivePullStreamTask);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(LivePullStreamTask input)
        {

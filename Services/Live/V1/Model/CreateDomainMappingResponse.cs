...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDomainMappingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDomainMappingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDomainMappingResponse input)
        {

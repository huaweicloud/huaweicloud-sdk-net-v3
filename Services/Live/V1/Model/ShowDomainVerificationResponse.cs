...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDomainVerificationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDomainVerificationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDomainVerificationResponse input)
        {

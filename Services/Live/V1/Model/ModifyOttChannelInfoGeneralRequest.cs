...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class ModifyOttChannelInfoGeneralRequest 
    {
        ...
        public ModifyOttChannelGeneral Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoGeneralRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoGeneralRequest input)
        {

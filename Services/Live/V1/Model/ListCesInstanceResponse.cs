...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCesInstanceResponse : SdkResponse
    {
        ...
        public List<ListCesInstanceRspBodyInstances> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListCesInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCesInstanceResponse input)
        {

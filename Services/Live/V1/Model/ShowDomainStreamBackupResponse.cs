...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDomainStreamBackupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDomainStreamBackupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDomainStreamBackupResponse input)
        {

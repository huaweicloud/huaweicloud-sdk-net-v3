...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateWatermarkRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateWatermarkRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateWatermarkRuleResponse input)
        {

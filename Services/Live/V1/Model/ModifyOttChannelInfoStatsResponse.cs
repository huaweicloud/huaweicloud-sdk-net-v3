...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyOttChannelInfoStatsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoStatsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoStatsResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class CreateUrlAuthchainReq 
    {
        ...
        public bool Equals(CreateUrlAuthchainReq input)
        {
            ...
            if (this.CheckLevel != input.CheckLevel || (this.CheckLevel != null && !this.CheckLevel.Equals(input.CheckLevel))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CheckLevel != null) hashCode = hashCode * 59 + this.CheckLevel.GetHashCode();

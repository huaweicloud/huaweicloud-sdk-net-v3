...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteOttChannelInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteOttChannelInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteOttChannelInfoResponse input)
        {

...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyDomainStreamBackupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyDomainStreamBackupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyDomainStreamBackupResponse input)
        {

...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateWatermarkRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateWatermarkRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWatermarkRuleResponse input)
        {

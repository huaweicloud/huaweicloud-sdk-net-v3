...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyOttChannelInfoGeneralResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoGeneralResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoGeneralResponse input)
        {
            if (input == null)
                return false;

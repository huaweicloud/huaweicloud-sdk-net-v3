    ...
    public class MssPackageItem 
    {
        ...
        public bool Equals(MssPackageItem input)
        {
            ...
            return 
                ...
                (
                    this.DelaySegment == input.DelaySegment ||
                    (this.DelaySegment != null &&
                    this.DelaySegment.Equals(input.DelaySegment))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DelaySegment != null)
                    hashCode = hashCode * 59 + this.DelaySegment.GetHashCode();

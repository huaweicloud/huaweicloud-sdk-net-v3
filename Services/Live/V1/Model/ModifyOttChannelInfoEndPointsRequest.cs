...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class ModifyOttChannelInfoEndPointsRequest 
    {
        ...
        public ModifyOttChannelEndPointsReq Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoEndPointsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoEndPointsRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class LiveDomainModifyReq 
    {
        ...
        /// </summary>
        /// <value>直播域名状态，通过修改此字段，实现域名的启用和停用。注意：域名处于“配置中”状态时，不允对该域名执行启停操作。</value>
        ...
        {
            return this.Equals(input as LiveDomainModifyReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(LiveDomainModifyReq input)
        {

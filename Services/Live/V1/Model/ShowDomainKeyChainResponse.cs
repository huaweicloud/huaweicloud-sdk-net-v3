...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDomainKeyChainResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowDomainKeyChainResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDomainKeyChainResponse input)
        {

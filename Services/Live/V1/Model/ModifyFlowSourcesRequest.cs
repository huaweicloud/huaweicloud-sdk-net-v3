...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class ModifyFlowSourcesRequest 
    {
        ...
        /// 流源名称
        /// </summary>
        [SDKProperty("source_name", IsQuery = true)]
        ...
        public ModifyFlowSourcesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyFlowSourcesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyFlowSourcesRequest input)
        {

...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyOttChannelInfoInputResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoInputResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoInputResponse input)
        {
            if (input == null)
                return false;

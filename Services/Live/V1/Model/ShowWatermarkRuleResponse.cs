...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowWatermarkRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowWatermarkRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowWatermarkRuleResponse input)
        {

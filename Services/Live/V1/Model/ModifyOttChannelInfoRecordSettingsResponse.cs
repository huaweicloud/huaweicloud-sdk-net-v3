...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyOttChannelInfoRecordSettingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoRecordSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoRecordSettingsResponse input)
        {

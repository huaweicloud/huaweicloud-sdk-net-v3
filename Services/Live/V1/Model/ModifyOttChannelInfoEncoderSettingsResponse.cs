...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyOttChannelInfoEncoderSettingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoEncoderSettingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoEncoderSettingsResponse input)
        {
            if (input == null)
                return false;

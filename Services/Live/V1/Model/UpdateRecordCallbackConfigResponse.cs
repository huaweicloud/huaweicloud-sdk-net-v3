...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateRecordCallbackConfigResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateRecordCallbackConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateRecordCallbackConfigResponse input)
        {
            if (input == null)
                return false;

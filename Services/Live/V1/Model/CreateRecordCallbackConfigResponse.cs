...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRecordCallbackConfigResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateRecordCallbackConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRecordCallbackConfigResponse input)
        {

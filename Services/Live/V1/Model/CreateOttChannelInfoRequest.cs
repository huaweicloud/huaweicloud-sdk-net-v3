...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class CreateOttChannelInfoRequest 
    {
        ...
        public CreateOttChannelInfoReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateOttChannelInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateOttChannelInfoRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class ShowDomainResponse : SdkResponse
    {
        ...
        public bool Equals(ShowDomainResponse input)
        {
            ...
            if (this.DomainInfo != input.DomainInfo || (this.DomainInfo != null && input.DomainInfo != null && !this.DomainInfo.SequenceEqual(input.DomainInfo))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DomainInfo != null) hashCode = hashCode * 59 + this.DomainInfo.GetHashCode();
                return hashCode;
            }
        }
    }

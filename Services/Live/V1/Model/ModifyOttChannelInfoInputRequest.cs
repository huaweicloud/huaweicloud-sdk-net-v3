...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class ModifyOttChannelInfoInputRequest 
    {
        ...
        public ModifyOttChannelInputReq Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoInputRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoInputRequest input)
        {
            if (input == null)
                return false;

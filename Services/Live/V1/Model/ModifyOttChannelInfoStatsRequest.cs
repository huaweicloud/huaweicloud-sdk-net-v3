...
namespace HuaweiCloud.SDK.Live.V1.Model
{
    ...
    public class ModifyOttChannelInfoStatsRequest 
    {
        ...
        public ModifyOttChannelState Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyOttChannelInfoStatsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyOttChannelInfoStatsRequest input)
        {
            if (input == null)
                return false;

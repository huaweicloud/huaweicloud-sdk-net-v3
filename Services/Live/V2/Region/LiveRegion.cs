...
namespace HuaweiCloud.SDK.Live.V2
{
    public class LiveRegion
    {
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'Live': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
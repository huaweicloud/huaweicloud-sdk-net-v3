...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBandwidthDetailResponse : SdkResponse
    {
        ...
        public List<V2BandwidthData> DataList { get; set; }
        ...
        {
            return this.Equals(input as ListBandwidthDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBandwidthDetailResponse input)
        {
            if (input == null)
                return false;

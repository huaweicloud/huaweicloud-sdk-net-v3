...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    public class ListUsersOfStreamRequest 
    {
        ...
        /// </summary>
        /// <value>查询数据的时间粒度，支持60（默认值）, 300秒。不传值时，使用默认值60秒。 </value>
        ...
        {
            return this.Equals(input as ListUsersOfStreamRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListUsersOfStreamRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTranscodeConcurrencyNumResponse : SdkResponse
    {
        ...
        public List<TranscodeConNumData> DataList { get; set; }
        ...
        {
            return this.Equals(input as ListTranscodeConcurrencyNumResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTranscodeConcurrencyNumResponse input)
        {

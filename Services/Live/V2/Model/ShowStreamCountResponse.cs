...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowStreamCountResponse : SdkResponse
    {
        ...
        public List<StreamCountData> DataList { get; set; }
        ...
        {
            return this.Equals(input as ShowStreamCountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowStreamCountResponse input)
        {

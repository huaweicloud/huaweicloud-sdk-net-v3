...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAreaDetailResponse : SdkResponse
    {
        ...
        public List<AreaDetail> DataList { get; set; }
        ...
        {
            return this.Equals(input as ListAreaDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAreaDetailResponse input)
        {

...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    public class ListDomainTrafficSummaryResponse : SdkResponse
    {
        ...
        public bool Equals(ListDomainTrafficSummaryResponse input)
        {
            ...
            return 
                (
                    this.TrafficList == input.TrafficList ||
                    this.TrafficList != null &&
                    input.TrafficList != null &&
                    this.TrafficList.SequenceEqual(input.TrafficList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TrafficList != null)
                    hashCode = hashCode * 59 + this.TrafficList.GetHashCode();

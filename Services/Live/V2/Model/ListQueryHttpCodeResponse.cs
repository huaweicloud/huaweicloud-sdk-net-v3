...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    public class ListQueryHttpCodeResponse : SdkResponse
    {
        ...
        public bool Equals(ListQueryHttpCodeResponse input)
        {
            ...
            if (this.DataSeries != input.DataSeries || (this.DataSeries != null && input.DataSeries != null && !this.DataSeries.SequenceEqual(input.DataSeries))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.DataSeries != null) hashCode = hashCode * 59 + this.DataSeries.GetHashCode();

...
namespace HuaweiCloud.SDK.Live.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPlayDomainStreamInfoResponse : SdkResponse
    {
        ...
        public List<PlayDomainStreamInfo> DataList { get; set; }
        ...
        {
            return this.Equals(input as ListPlayDomainStreamInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPlayDomainStreamInfoResponse input)
        {

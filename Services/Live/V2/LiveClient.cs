...
namespace HuaweiCloud.SDK.Live.V2
{
    public partial class LiveClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTranscodeConcurrencyNumResponse ListTranscodeConcurrencyNum(ListTranscodeConcurrencyNumRequest listTranscodeConcurrencyNumRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListTranscodeConcurrencyNumResponse> ListTranscodeConcurrencyNumInvoker(ListTranscodeConcurrencyNumRequest listTranscodeConcurrencyNumRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/stats/transcode/concurrency", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTranscodeConcurrencyNumRequest);
            return new SyncInvoker<ListTranscodeConcurrencyNumResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTranscodeConcurrencyNumResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListTranscodeTaskDetailResponse ListTranscodeTaskDetail(ListTranscodeTaskDetailRequest listTranscodeTaskDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListTranscodeTaskDetailResponse> ListTranscodeTaskDetailInvoker(ListTranscodeTaskDetailRequest listTranscodeTaskDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/stats/transcode/detail", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTranscodeTaskDetailRequest);
            return new SyncInvoker<ListTranscodeTaskDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTranscodeTaskDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCarouselTaskDetailResponse ListCarouselTaskDetail(ListCarouselTaskDetailRequest listCarouselTaskDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCarouselTaskDetailResponse> ListCarouselTaskDetailInvoker(ListCarouselTaskDetailRequest listCarouselTaskDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/stats/carousel-task/detail", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCarouselTaskDetailRequest);
            return new SyncInvoker<ListCarouselTaskDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCarouselTaskDetailResponse>);
        }

...
namespace HuaweiCloud.SDK.Cc.V2.Model
{
    ...
    public class ListResourceByFilterTagRequest 
    {
        ...
        public ListResourceByFilterTagRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListResourceByFilterTagRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListResourceByFilterTagRequest input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCloudConnectionQuotasResponse : SdkResponse
    {
        ...
        public List<CloudConnectionQuota> Quotas { get; set; }
        ...
        {
            return this.Equals(input as ListCloudConnectionQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCloudConnectionQuotasResponse input)
        {

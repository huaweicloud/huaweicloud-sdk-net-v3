...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateBandwidthPackageRequestBody 
    {
        ...
        public CreateBandwidthPackage BandwidthPackage { get; set; }
        ...
        {
            return this.Equals(input as CreateBandwidthPackageRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateBandwidthPackageRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGlobalConnectionBandwidthConfigsResponse : SdkResponse
    {
        ...
        public ListGlobalConnectionBandwidthConfigs Configs { get; set; }
        ...
        {
            return this.Equals(input as ListGlobalConnectionBandwidthConfigsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGlobalConnectionBandwidthConfigsResponse input)
        {

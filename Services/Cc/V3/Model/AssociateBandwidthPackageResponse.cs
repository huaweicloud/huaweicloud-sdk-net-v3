...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateBandwidthPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AssociateBandwidthPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateBandwidthPackageResponse input)
        {

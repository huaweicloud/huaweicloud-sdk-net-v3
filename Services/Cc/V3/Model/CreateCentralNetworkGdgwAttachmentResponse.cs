...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateCentralNetworkGdgwAttachmentResponse : SdkResponse
    {
        ...
        public CentralNetworkGdgwAttachment CentralNetworkGdgwAttachment { get; set; }
        ...
        {
            return this.Equals(input as CreateCentralNetworkGdgwAttachmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkGdgwAttachmentResponse input)
        {

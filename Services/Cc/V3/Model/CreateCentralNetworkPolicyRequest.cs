...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateCentralNetworkPolicyRequest 
    {
        ...
        public CreateCentralNetworkPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateCentralNetworkPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkPolicyRequest input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class UpdateCentralNetworkConnectionRequest 
    {
        ...
        public UpdateCentralNetworkConnectionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateCentralNetworkConnectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCentralNetworkConnectionRequest input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// </summary>
    /// <value>对端大区。云连接支持的大区有： - Chinese-Mainland（中国大陆） - Asia-Pacific（亚太） - Africa（非洲） - Western-Latin-America（拉美西） - Eastern-Latin-America（拉美东） - Northern-Latin-America（拉美北）</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum RemoteAreaIdDef
    {
        /// <summary>

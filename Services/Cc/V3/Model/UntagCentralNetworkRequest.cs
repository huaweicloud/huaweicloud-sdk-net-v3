...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class UntagCentralNetworkRequest 
    {
        ...
        public UntagCentralNetworkRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UntagCentralNetworkRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UntagCentralNetworkRequest input)
        {

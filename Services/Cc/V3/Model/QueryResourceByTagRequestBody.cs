...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class QueryResourceByTagRequestBody 
    {
        ...
        public List<QueryTag> TagsAny { get; set; }
        ...
        public List<QueryTag> NotTags { get; set; }
        ...
        public List<QueryTag> NotTagsAny { get; set; }
        ...
        {
            return this.Equals(input as QueryResourceByTagRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QueryResourceByTagRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateNetworkInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateNetworkInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateNetworkInstanceResponse input)
        {

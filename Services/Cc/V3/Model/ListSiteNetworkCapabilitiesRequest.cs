...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class ListSiteNetworkCapabilitiesRequest 
    {
        ...
        /// </summary>
        [SDKProperty("specification", IsQuery = true)]
        [JsonProperty("specification", NullValueHandling = NullValueHandling.Ignore)]
        public List<SiteNetworkSpecificationEnum> Specification { get; set; }
        ...
        {
            return this.Equals(input as ListSiteNetworkCapabilitiesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSiteNetworkCapabilitiesRequest input)
        {

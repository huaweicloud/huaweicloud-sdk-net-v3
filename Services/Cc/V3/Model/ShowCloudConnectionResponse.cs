...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowCloudConnectionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowCloudConnectionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowCloudConnectionResponse input)
        {

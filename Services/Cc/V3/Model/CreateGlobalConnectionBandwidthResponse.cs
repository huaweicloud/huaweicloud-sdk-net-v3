...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateGlobalConnectionBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateGlobalConnectionBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGlobalConnectionBandwidthResponse input)
        {

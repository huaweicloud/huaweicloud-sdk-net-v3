...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSiteNetworkBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSiteNetworkBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSiteNetworkBandwidthResponse input)
        {

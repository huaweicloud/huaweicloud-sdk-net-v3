...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class UpdateSiteNetworkBandwidthRequest 
    {
        ...
        public UpdateSiteConnectionBandwidthRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSiteNetworkBandwidthRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSiteNetworkBandwidthRequest input)
        {

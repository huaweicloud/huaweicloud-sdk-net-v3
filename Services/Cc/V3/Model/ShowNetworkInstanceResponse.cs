...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowNetworkInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowNetworkInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowNetworkInstanceResponse input)
        {

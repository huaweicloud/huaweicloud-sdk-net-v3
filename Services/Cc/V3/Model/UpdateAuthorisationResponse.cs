...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAuthorisationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAuthorisationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAuthorisationResponse input)
        {

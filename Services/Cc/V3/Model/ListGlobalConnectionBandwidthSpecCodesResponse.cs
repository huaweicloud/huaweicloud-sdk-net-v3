...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGlobalConnectionBandwidthSpecCodesResponse : SdkResponse
    {
        ...
        public List<GlobalConnectionBandwidthSpecCode> SpecCodes { get; set; }
        ...
        {
            return this.Equals(input as ListGlobalConnectionBandwidthSpecCodesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGlobalConnectionBandwidthSpecCodesResponse input)
        {

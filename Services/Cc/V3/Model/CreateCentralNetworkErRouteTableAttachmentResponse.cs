...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateCentralNetworkErRouteTableAttachmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateCentralNetworkErRouteTableAttachmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkErRouteTableAttachmentResponse input)
        {

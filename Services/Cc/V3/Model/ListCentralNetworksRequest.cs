...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class ListCentralNetworksRequest 
    {
        ...
        public List<CentralNetworkStateEnum> State { get; set; }
        ...
        /// 根据ER实例ID过滤列表。
        /// </summary>
        [SDKProperty("enterprise_router_id", IsQuery = true)]
        [JsonProperty("enterprise_router_id", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> EnterpriseRouterId { get; set; }

        /// <summary>
        /// Attachment实例的ID。
        /// </summary>
        [SDKProperty("attachment_instance_id", IsQuery = true)]
        [JsonProperty("attachment_instance_id", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> AttachmentInstanceId { get; set; }
        ...
        {
            return this.Equals(input as ListCentralNetworksRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCentralNetworksRequest input)
        {
            ...
            if (this.EnterpriseRouterId != input.EnterpriseRouterId || (this.EnterpriseRouterId != null && input.EnterpriseRouterId != null && !this.EnterpriseRouterId.SequenceEqual(input.EnterpriseRouterId))) return false;
            if (this.AttachmentInstanceId != input.AttachmentInstanceId || (this.AttachmentInstanceId != null && input.AttachmentInstanceId != null && !this.AttachmentInstanceId.SequenceEqual(input.AttachmentInstanceId))) return false;
            ...
            if (this.ConnectionId != input.ConnectionId || (this.ConnectionId != null && input.ConnectionId != null && !this.ConnectionId.SequenceEqual(input.ConnectionId))) return false;

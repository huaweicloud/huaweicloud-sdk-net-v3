...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCentralNetworkQuotasResponse : SdkResponse
    {
        ...
        public List<CentralNetworkQuota> Quotas { get; set; }
        ...
        {
            return this.Equals(input as ListCentralNetworkQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCentralNetworkQuotasResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteSiteNetworkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteSiteNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteSiteNetworkResponse input)
        {

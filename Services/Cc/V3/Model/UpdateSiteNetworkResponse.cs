...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSiteNetworkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSiteNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSiteNetworkResponse input)
        {

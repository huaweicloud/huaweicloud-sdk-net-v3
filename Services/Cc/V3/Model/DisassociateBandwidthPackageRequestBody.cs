...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class DisassociateBandwidthPackageRequestBody 
    {
        ...
        public DisassociateBandwidthPackage BandwidthPackage { get; set; }
        ...
        {
            return this.Equals(input as DisassociateBandwidthPackageRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateBandwidthPackageRequestBody input)
        {

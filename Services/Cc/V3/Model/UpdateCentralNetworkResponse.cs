...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCentralNetworkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCentralNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCentralNetworkResponse input)
        {

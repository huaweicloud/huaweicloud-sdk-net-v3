...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSiteNetworkQuotasResponse : SdkResponse
    {
        ...
        public List<SiteNetworkQuota> Quotas { get; set; }
        ...
        {
            return this.Equals(input as ListSiteNetworkQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSiteNetworkQuotasResponse input)
        {

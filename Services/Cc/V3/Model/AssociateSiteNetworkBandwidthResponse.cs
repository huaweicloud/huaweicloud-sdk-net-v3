...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateSiteNetworkBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AssociateSiteNetworkBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateSiteNetworkBandwidthResponse input)
        {

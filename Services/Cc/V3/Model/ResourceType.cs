...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class ResourceType 
    {
        ...
        public ResourceTypeEnum _ResourceType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _resourceType: ").Append(_ResourceType).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ResourceType input)
        {
            ...
            if (this._ResourceType != input._ResourceType) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                hashCode = hashCode * 59 + this._ResourceType.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowBandwidthPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowBandwidthPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBandwidthPackageResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInterRegionBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInterRegionBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInterRegionBandwidthResponse input)
        {

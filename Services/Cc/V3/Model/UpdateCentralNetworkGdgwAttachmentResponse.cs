...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCentralNetworkGdgwAttachmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCentralNetworkGdgwAttachmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCentralNetworkGdgwAttachmentResponse input)
        {

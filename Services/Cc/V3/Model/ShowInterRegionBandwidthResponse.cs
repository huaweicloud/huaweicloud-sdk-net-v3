...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInterRegionBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInterRegionBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInterRegionBandwidthResponse input)
        {

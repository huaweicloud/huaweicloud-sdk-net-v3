...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateCloudConnectionRequestBody 
    {
        ...
        public CreateCloudConnection CloudConnection { get; set; }
        ...
        {
            return this.Equals(input as CreateCloudConnectionRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCloudConnectionRequestBody input)
        {

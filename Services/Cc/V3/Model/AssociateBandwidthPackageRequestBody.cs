...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class AssociateBandwidthPackageRequestBody 
    {
        ...
        public AssociateBandwidthPackage BandwidthPackage { get; set; }
        ...
        {
            return this.Equals(input as AssociateBandwidthPackageRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateBandwidthPackageRequestBody input)
        {

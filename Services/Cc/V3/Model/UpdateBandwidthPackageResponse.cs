...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateBandwidthPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateBandwidthPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateBandwidthPackageResponse input)
        {

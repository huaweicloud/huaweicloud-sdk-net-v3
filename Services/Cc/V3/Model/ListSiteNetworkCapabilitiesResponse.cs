...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSiteNetworkCapabilitiesResponse : SdkResponse
    {
        ...
        public List<SiteNetworkCapabilityEntry> Capabilities { get; set; }
        ...
        {
            return this.Equals(input as ListSiteNetworkCapabilitiesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSiteNetworkCapabilitiesResponse input)
        {

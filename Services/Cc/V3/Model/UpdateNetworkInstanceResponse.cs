...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateNetworkInstanceResponse : SdkResponse
    {
        ...
        public NetworkInstance NetworkInstance { get; set; }
        ...
        {
            return this.Equals(input as UpdateNetworkInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateNetworkInstanceResponse input)
        {

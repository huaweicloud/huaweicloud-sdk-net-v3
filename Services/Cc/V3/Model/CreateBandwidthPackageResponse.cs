...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateBandwidthPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateBandwidthPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateBandwidthPackageResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCentralNetworkPolicyChangeSetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListCentralNetworkPolicyChangeSetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCentralNetworkPolicyChangeSetResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateP2PSiteNetworkResponse : SdkResponse
    {
        ...
        public SiteNetworkEntry SiteNetwork { get; set; }
        ...
        {
            return this.Equals(input as CreateP2PSiteNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateP2PSiteNetworkResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class ListSiteNetworksRequest 
    {
        ...
        public List<SiteNetworkStateEnum> State { get; set; }
        ...
        /// 根据GDW实例ID过滤列表。
        /// </summary>
        [SDKProperty("global_dc_gateway_id", IsQuery = true)]
        [JsonProperty("global_dc_gateway_id", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> GlobalDcGatewayId { get; set; }
        ...
        {
            return this.Equals(input as ListSiteNetworksRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSiteNetworksRequest input)
        {
            ...
            if (this.GlobalDcGatewayId != input.GlobalDcGatewayId || (this.GlobalDcGatewayId != null && input.GlobalDcGatewayId != null && !this.GlobalDcGatewayId.SequenceEqual(input.GlobalDcGatewayId))) return false;

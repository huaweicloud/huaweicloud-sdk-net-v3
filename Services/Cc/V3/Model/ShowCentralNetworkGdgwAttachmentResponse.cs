...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowCentralNetworkGdgwAttachmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowCentralNetworkGdgwAttachmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowCentralNetworkGdgwAttachmentResponse input)
        {

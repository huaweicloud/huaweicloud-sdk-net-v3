...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCloudConnectionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCloudConnectionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCloudConnectionResponse input)
        {

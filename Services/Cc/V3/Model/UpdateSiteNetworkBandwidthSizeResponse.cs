...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSiteNetworkBandwidthSizeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSiteNetworkBandwidthSizeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSiteNetworkBandwidthSizeResponse input)
        {

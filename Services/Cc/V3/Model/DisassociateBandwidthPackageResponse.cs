...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisassociateBandwidthPackageResponse : SdkResponse
    {
        ...
        public BandwidthPackage BandwidthPackage { get; set; }
        ...
        {
            return this.Equals(input as DisassociateBandwidthPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateBandwidthPackageResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateCentralNetwork 
    {
        ...
        public CentralNetworkPolicyDocument PolicyDocument { get; set; }
        ...
        {
            return this.Equals(input as CreateCentralNetwork);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetwork input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AssociateGlobalConnectionBandwidthInstanceResponse : SdkResponse
    {
        ...
        public List<AssociateGlobalConnectionBandwidthInstanceResponseInfo> Gcbandwidths { get; set; }
        ...
        {
            return this.Equals(input as AssociateGlobalConnectionBandwidthInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateGlobalConnectionBandwidthInstanceResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCloudConnectionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListCloudConnectionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCloudConnectionsResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCentralNetworkErRouteTableAttachmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateCentralNetworkErRouteTableAttachmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCentralNetworkErRouteTableAttachmentResponse input)
        {

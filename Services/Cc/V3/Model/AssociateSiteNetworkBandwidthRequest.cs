...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class AssociateSiteNetworkBandwidthRequest 
    {
        ...
        public AssociateSiteConnectionBandwidthRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AssociateSiteNetworkBandwidthRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateSiteNetworkBandwidthRequest input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateCentralNetworkGdgwAttachmentRequest 
    {
        ...
        public CreateCentralNetworkGdgwAttachmentRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateCentralNetworkGdgwAttachmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkGdgwAttachmentRequest input)
        {

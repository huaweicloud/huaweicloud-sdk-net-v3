...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateCloudConnectionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateCloudConnectionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCloudConnectionResponse input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class AssociateGlobalConnectionBandwidthInstanceRequestBody 
    {
        ...
        public List<AssociateGlobalConnectionBandwidthInstanceRequestInfo> Gcbandwidths { get; set; }
        ...
        {
            return this.Equals(input as AssociateGlobalConnectionBandwidthInstanceRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateGlobalConnectionBandwidthInstanceRequestBody input)
        {

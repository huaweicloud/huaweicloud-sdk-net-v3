...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class AssociateGlobalConnectionBandwidthInstanceResponseInfo 
    {
        ...
        /// </summary>
        /// <value>功能说明：绑定操作成功还是失败。 - success: 成功 - fail: 失败</value>
        ...
        {
            return this.Equals(input as AssociateGlobalConnectionBandwidthInstanceResponseInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateGlobalConnectionBandwidthInstanceResponseInfo input)
        {

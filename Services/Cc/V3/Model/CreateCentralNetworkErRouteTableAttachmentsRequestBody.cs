...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateCentralNetworkErRouteTableAttachmentsRequestBody 
    {
        ...
        public CreateCentralNetworkErRouteTableAttachment CentralNetworkErRouteTableAttachment { get; set; }
        ...
        {
            return this.Equals(input as CreateCentralNetworkErRouteTableAttachmentsRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkErRouteTableAttachmentsRequestBody input)
        {

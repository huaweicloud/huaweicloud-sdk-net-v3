...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class ListCentralNetworkAttachmentsRequest 
    {
        ...
        /// 根据附件类型查询，可查询多个附件类型。
        /// </summary>
        [SDKProperty("attachment_instance_type", IsQuery = true)]
        [JsonProperty("attachment_instance_type", NullValueHandling = NullValueHandling.Ignore)]
        public List<AttachmentInstanceTypeEnum> AttachmentInstanceType { get; set; }
        ...
        {
            return this.Equals(input as ListCentralNetworkAttachmentsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCentralNetworkAttachmentsRequest input)
        {
            ...
            if (this.AttachmentInstanceType != input.AttachmentInstanceType || (this.AttachmentInstanceType != null && input.AttachmentInstanceType != null && !this.AttachmentInstanceType.SequenceEqual(input.AttachmentInstanceType))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AttachmentInstanceType != null) hashCode = hashCode * 59 + this.AttachmentInstanceType.GetHashCode();

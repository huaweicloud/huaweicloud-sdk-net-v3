...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class AssociateSiteConnectionBandwidthRequestBody 
    {
        ...
        public AssociateSiteConnectionBandwidth SiteConnection { get; set; }
        ...
        {
            return this.Equals(input as AssociateSiteConnectionBandwidthRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateSiteConnectionBandwidthRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class UpdateCentralNetworkRequestBody 
    {
        ...
        public UpdateCentralNetwork CentralNetwork { get; set; }
        ...
        {
            return this.Equals(input as UpdateCentralNetworkRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCentralNetworkRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateCentralNetworkErRouteTableAttachmentRequest 
    {
        ...
        public CreateCentralNetworkErRouteTableAttachmentsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateCentralNetworkErRouteTableAttachmentRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkErRouteTableAttachmentRequest input)
        {

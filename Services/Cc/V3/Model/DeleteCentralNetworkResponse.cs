...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteCentralNetworkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteCentralNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteCentralNetworkResponse input)
        {

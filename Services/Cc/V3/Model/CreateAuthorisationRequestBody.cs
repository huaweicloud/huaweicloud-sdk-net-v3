...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class CreateAuthorisationRequestBody 
    {
        ...
        public CreateAuthorisation Authorisation { get; set; }
        ...
        {
            return this.Equals(input as CreateAuthorisationRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAuthorisationRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    public class UpdateCentralNetworkGdgwAttachmentRequestBody 
    {
        ...
        public UpdateCentralNetworkGdgwAttachment CentralNetworkGdgwAttachment { get; set; }
        ...
        {
            return this.Equals(input as UpdateCentralNetworkGdgwAttachmentRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCentralNetworkGdgwAttachmentRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGlobalConnectionBandwidthsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListGlobalConnectionBandwidthsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGlobalConnectionBandwidthsResponse input)
        {

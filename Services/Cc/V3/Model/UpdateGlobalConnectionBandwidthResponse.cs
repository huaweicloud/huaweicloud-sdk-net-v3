...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateGlobalConnectionBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateGlobalConnectionBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGlobalConnectionBandwidthResponse input)
        {

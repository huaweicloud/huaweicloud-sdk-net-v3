...
namespace HuaweiCloud.SDK.Cc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateCentralNetworkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateCentralNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateCentralNetworkResponse input)
        {

...
namespace HuaweiCloud.SDK.Csms.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSecretStageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSecretStageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecretStageResponse input)
        {
            if (input == null)
                return false;

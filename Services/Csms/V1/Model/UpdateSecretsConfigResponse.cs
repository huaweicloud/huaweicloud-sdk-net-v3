...
namespace HuaweiCloud.SDK.Csms.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSecretsConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSecretsConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecretsConfigResponse input)
        {

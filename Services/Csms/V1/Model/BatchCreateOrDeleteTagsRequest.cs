...
namespace HuaweiCloud.SDK.Csms.V1.Model
{
    ...
    public class BatchCreateOrDeleteTagsRequest 
    {
        ...
        public BatchCreateOrDeleteTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateOrDeleteTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateOrDeleteTagsRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowStatisticInterfaceResponse : SdkResponse
    {
        ...
        public List<ShowStatisticInterfaceResponseBodyMetrics> Metrics { get; set; }
        ...
        {
            return this.Equals(input as ShowStatisticInterfaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowStatisticInterfaceResponse input)
        {

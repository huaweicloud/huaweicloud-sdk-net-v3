...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowClusterAccessKeyListResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowClusterAccessKeyListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowClusterAccessKeyListResponse input)
        {

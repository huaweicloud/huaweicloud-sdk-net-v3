...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAssociationListResponse : SdkResponse
    {
        ...
        public List<AssociationInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowAssociationListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAssociationListResponse input)
        {

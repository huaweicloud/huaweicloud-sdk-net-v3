...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowCcspClusterListResponse : SdkResponse
    {
        ...
        public List<CcspClusterInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowCcspClusterListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowCcspClusterListResponse input)
        {

...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowCcspInstanceInfoResponse : SdkResponse
    {
        ...
        public List<CcspInstanceInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowCcspInstanceInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowCcspInstanceInfoResponse input)
        {

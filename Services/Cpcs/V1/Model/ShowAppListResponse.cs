...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAppListResponse : SdkResponse
    {
        ...
        public List<AppInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ShowAppListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAppListResponse input)
        {

...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    public class AccessKeyInfo 
    {
        ...
        /// 下载时间
        /// </summary>
        [JsonProperty("download_time", NullValueHandling = NullValueHandling.Ignore)]
        public long? DownloadTime { get; set; }

        /// <summary>
        /// 是否下载
        /// </summary>
        [JsonProperty("is_downloaded", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  isDownloaded: ").Append(IsDownloaded).Append("\n");
        ...
        {
            return this.Equals(input as AccessKeyInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AccessKeyInfo input)
        {
            ...
            if (this.DownloadTime != input.DownloadTime || (this.DownloadTime != null && !this.DownloadTime.Equals(input.DownloadTime))) return false;
            if (this.IsDownloaded != input.IsDownloaded || (this.IsDownloaded != null && !this.IsDownloaded.Equals(input.IsDownloaded))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DownloadTime != null) hashCode = hashCode * 59 + this.DownloadTime.GetHashCode();
                if (this.IsDownloaded != null) hashCode = hashCode * 59 + this.IsDownloaded.GetHashCode();

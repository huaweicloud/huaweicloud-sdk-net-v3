...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListClusterPortResponse : SdkResponse
    {
        ...
        public List<ElbClusterPortReponseBody> Result { get; set; }
        ...
        {
            return this.Equals(input as ListClusterPortResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListClusterPortResponse input)
        {

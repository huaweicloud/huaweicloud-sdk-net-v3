...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDisableAccessKeysResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDisableAccessKeysResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDisableAccessKeysResponse input)
        {

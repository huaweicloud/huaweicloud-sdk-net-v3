...
namespace HuaweiCloud.SDK.Cpcs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCcspTenantImagesResponse : SdkResponse
    {
        ...
        public List<ImageInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ListCcspTenantImagesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCcspTenantImagesResponse input)
        {

...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUpdateOneClickAlarmsEnabledStateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchUpdateOneClickAlarmsEnabledStateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateOneClickAlarmsEnabledStateResponse input)
        {

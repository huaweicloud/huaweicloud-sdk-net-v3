...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class UpdateResourceGroupAssociationAlarmTemplateRequest 
    {
        ...
        public AsyncAssociateRGAndTemplatesReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateResourceGroupAssociationAlarmTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateResourceGroupAssociationAlarmTemplateRequest input)
        {

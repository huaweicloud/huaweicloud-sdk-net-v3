...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class ExtendInfoResp 
    {
        ...
        /// </summary>
        /// <value>**参数解释** 表示指标聚合方式 **取值范围** 枚举值： - average 平均值 - min 最小值 - max 最大值 - sum 求和值 </value>
        ...
        /// </summary>
        /// <value>**参数解释** 展示时间 **取值范围** 枚举值： - 0 自定义时间 - 5 5分钟 - 15 15分钟 - 30 30分钟 - 60 1小时 - 120 2小时 - 180 3小时 - 720 12小时 - 1440 24小时 - 10080 7天 - 43200 30天 </value>
        ...
        /// </summary>
        /// <value>**参数解释** 刷新时间 **取值范围** 枚举值： - 0 不刷新 - 10 10秒 - 60 1分钟 - 300 5分钟 - 1200 20分钟 </value>
        ...
        /// </summary>
        /// <value>**参数解释**  监控大屏自动切换时间间隔  **取值范围**  枚举值：  - 10000 10秒  - 30000 30秒  - 60000 1分钟 </value>
        ...
        {
            return this.Equals(input as ExtendInfoResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExtendInfoResp input)
        {

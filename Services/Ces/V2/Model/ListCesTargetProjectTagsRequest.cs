...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class ListCesTargetProjectTagsRequest 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 资源类型。     **约束限制**： 不涉及。 **取值范围**： 只能为CES-alarm，代表告警规则。长度[1,32]个字符。      **默认取值**： 不涉及。 </value>
        ...
        public class ResourceTypeEnum
        {
            ...
            /// </summary>
            public static readonly ResourceTypeEnum CES_ALARM = new ResourceTypeEnum("CES-alarm");
        ...
        {
            return this.Equals(input as ListCesTargetProjectTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCesTargetProjectTagsRequest input)
        {

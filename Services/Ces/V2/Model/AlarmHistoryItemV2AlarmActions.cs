...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class AlarmHistoryItemV2AlarmActions 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 通知类型。 **取值范围**： 枚举值。 - notification：通知组或主题订阅。 - contact：云账号联系人。 - contactGroup：（已废弃）通知组。 - autoscaling：AS通知，只在AS中使用。 - groupwatch：已废弃，不推荐使用。 - ecsRecovery：已废弃，不推荐使用。 - iecAction：已废弃，不推荐使用。 </value>
        ...
        {
            return this.Equals(input as AlarmHistoryItemV2AlarmActions);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AlarmHistoryItemV2AlarmActions input)
        {

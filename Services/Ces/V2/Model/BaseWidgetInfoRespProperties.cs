...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class BaseWidgetInfoRespProperties 
    {
        ...
        /// </summary>
        /// <value>**参数解释** 聚合类型 **取值范围** 目前只有TopN这一种类型，折线图不支持该参数 </value>
        ...
        /// </summary>
        /// <value>**参数解释** 排序字段 **取值范围** - asc:正序 - desc:倒序 </value>
        ...
        /// </summary>
        /// <value>**参数解释** 图例位置标记 **取值范围** - hide:表示隐藏图例 - right:表示图例放在监控视图右侧 - bottom:表示图例放在监控视图底部 </value>
        ...
        /// </summary>
        /// <value>**参数解释** 统计值名称 **取值范围** - last:当前值 - max:最大值 - min:最小值 - avg:平均值 - sum:求和值 </value>
        ...
        public List<ThresholdInfoResp> Thresholds { get; set; }
        ...
        {
            return this.Equals(input as BaseWidgetInfoRespProperties);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BaseWidgetInfoRespProperties input)
        {

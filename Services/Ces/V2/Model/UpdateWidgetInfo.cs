...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class UpdateWidgetInfo 
    {
        ...
        /// </summary>
        /// <value>**参数解释** 监控视图图表类型 **约束限制** 不涉及 **取值范围** 枚举值： - bar 条形图 - line 折线图 - bar_chart 柱状图 - table 表格 - circular_bar 环形柱状图 - area_chart 面积图 - gauge 仪表盘 - stat 数字 **默认取值** 不涉及 </value>
        ...
        /// </summary>
        /// <value>**参数解释** 指标展示类型 **约束限制** 不涉及 **取值范围** 枚举值： - single 单指标展示 - multiple 多指标展示 **默认取值** 不涉及 </value>
        ...
        {
            return this.Equals(input as UpdateWidgetInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateWidgetInfo input)
        {

...
namespace HuaweiCloud.SDK.Ces.V2.Model
{
    ...
    public class WidgetMetricResp 
    {
        ...
        /// </summary>
        /// <value>**参数解释** 阈值线所在的Y轴位置               **取值范围** 枚举值： - left 左Y轴 - right 右Y轴 </value>
        ...
        public DimensionInfoResp Dimensions { get; set; }
        ...
        public ExtraInfoResp ExtraInfo { get; set; }
        ...
        public RollupFilterResp? RollupFilter { get; set; }
        ...
        {
            return this.Equals(input as WidgetMetricResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(WidgetMetricResp input)
        {

...
namespace HuaweiCloud.SDK.Ces.V1.Model
{
    ...
    public class ShowEventItemDetailResp 
    {
        ...
        /// </summary>
        /// <value>**参数解释**： 事件状态。 **取值范围**： 枚举类型：normal\\warning\\incident。 - normal: 正常 - warning: 警告 - incident: 故障 </value>
        ...
        /// </summary>
        /// <value>**参数解释**： 事件级别。 **取值范围**： 枚举类型：Critical, Major, Minor, Info。 - Critical: 紧急 - Major: 重要 - Minor: 次要 - Info: 提示 </value>
        ...
        {
            return this.Equals(input as ShowEventItemDetailResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEventItemDetailResp input)
        {

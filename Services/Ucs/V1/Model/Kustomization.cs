...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class Kustomization 
    {
        ...
        public KustomizationMetaData Metadata { get; set; }
        ...
        public KustomizationStatus Status { get; set; }
        ...
        {
            return this.Equals(input as Kustomization);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(Kustomization input)
        {

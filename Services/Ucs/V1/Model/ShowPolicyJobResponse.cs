...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPolicyJobResponse : SdkResponse
    {
        ...
        public UCSJobSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public UCSJobStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ShowPolicyJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPolicyJobResponse input)
        {

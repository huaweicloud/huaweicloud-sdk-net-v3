...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class UpdatePolicyDefinationRequest 
    {
        ...
        /// 策略定义id
        /// </summary>
        [SDKProperty("policydefinitionid", IsPath = true)]
        [JsonProperty("policydefinitionid", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public UCSConstraintTemplateTagRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePolicyDefinationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePolicyDefinationRequest input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class UpdateClusterGroupRequest 
    {
        ...
        public UpdateClusterGroupDescriptionRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateClusterGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClusterGroupRequest input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateFederationCertResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateFederationCertResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFederationCertResponse input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class UpdateClusterGroupAssociatedClustersRequest 
    {
        ...
        public UpdateClusterGroupAssociatedClustersRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateClusterGroupAssociatedClustersRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClusterGroupAssociatedClustersRequest input)
        {

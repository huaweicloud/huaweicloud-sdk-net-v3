...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class CreateFederationCertRequest 
    {
        ...
        public CreateFederationCertRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateFederationCertRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFederationCertRequest input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPolicyInstanceResponse : SdkResponse
    {
        ...
        public UCSConstraintSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public UCSConstraintStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ShowPolicyInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPolicyInstanceResponse input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFederationProgressResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowFederationProgressResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFederationProgressResponse input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowClusterGroupResponse : SdkResponse
    {
        ...
        public ClusterGroupSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public ClusterGroupStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ShowClusterGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowClusterGroupResponse input)
        {

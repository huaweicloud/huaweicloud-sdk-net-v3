...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProxyUnitedWorkloadResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowProxyUnitedWorkloadResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProxyUnitedWorkloadResponse input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPolicyJobsResponse : SdkResponse
    {
        ...
        public List<UCSJob> Items { get; set; }
        ...
        {
            return this.Equals(input as ListPolicyJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPolicyJobsResponse input)
        {

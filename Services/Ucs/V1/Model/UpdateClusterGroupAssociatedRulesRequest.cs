...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class UpdateClusterGroupAssociatedRulesRequest 
    {
        ...
        public UpdateAssociatedRulesRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateClusterGroupAssociatedRulesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClusterGroupAssociatedRulesRequest input)
        {

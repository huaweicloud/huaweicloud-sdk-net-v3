...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RegisterClusterGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RegisterClusterGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RegisterClusterGroupResponse input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DownloadFederationKubeconfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DownloadFederationKubeconfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadFederationKubeconfigResponse input)
        {

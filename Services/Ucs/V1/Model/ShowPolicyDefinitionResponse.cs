...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPolicyDefinitionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowPolicyDefinitionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPolicyDefinitionResponse input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class UpdateClusterGroupAssociatedZonesRequest 
    {
        ...
        public UpdateAssociatedZonesRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateClusterGroupAssociatedZonesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClusterGroupAssociatedZonesRequest input)
        {

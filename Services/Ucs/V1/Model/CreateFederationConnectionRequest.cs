...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class CreateFederationConnectionRequest 
    {
        ...
        public CreateFederationConnectionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateFederationConnectionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateFederationConnectionRequest input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class UpdateClusterRequestBody 
    {
        ...
        public UpdateObjectMeta Metadata { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("spec", NullValueHandling = NullValueHandling.Ignore)]
        public UpdateClusterSpec Spec { get; set; }
        ...
        {
            return this.Equals(input as UpdateClusterRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateClusterRequestBody input)
        {

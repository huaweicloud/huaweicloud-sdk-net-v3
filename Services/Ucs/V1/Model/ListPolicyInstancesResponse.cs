...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPolicyInstancesResponse : SdkResponse
    {
        ...
        public List<UCSConstraint> Items { get; set; }
        ...
        {
            return this.Equals(input as ListPolicyInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPolicyInstancesResponse input)
        {

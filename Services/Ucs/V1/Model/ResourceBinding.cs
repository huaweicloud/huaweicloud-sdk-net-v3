...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class ResourceBinding 
    {
        ...
        public ResourceBindingSpec Spec { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("status", NullValueHandling = NullValueHandling.Ignore)]
        public ResourceBindingStatus Status { get; set; }
        ...
        {
            return this.Equals(input as ResourceBinding);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResourceBinding input)
        {

...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class CreateClusterGroupPolicyInstanceRequest 
    {
        ...
        public UCSConstraintRequest Body { get; set; }
        ...
        {
            return this.Equals(input as CreateClusterGroupPolicyInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateClusterGroupPolicyInstanceRequest input)
        {

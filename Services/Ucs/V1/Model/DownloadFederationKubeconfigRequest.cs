...
namespace HuaweiCloud.SDK.Ucs.V1.Model
{
    ...
    public class DownloadFederationKubeconfigRequest 
    {
        ...
        public DownloadFederationKubeconfigRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DownloadFederationKubeconfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadFederationKubeconfigRequest input)
        {

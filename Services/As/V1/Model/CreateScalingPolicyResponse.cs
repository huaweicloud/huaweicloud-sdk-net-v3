...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateScalingPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateScalingPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateScalingPolicyResponse input)
        {
            if (input == null)
                return false;

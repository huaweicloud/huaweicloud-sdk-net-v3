...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class BatchRemoveScalingInstancesRequest 
    {
        ...
        public BatchRemoveInstancesOption Body { get; set; }
        ...
        {
            return this.Equals(input as BatchRemoveScalingInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRemoveScalingInstancesRequest input)
        {
            if (input == null)
                return false;

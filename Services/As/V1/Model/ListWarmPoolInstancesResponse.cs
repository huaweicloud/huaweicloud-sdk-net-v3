...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListWarmPoolInstancesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListWarmPoolInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListWarmPoolInstancesResponse input)
        {

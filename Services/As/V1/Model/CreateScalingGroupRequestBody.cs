...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class CreateScalingGroupRequestBody 
    {
        ...
        /// </summary>
        /// <value>伸缩组实例的健康检查周期，可设置为1、5、15、60、180（分钟），若不设置该参数，默认为5。若设置为0，可以实现10秒级健康检查。</value>
        ...
        public class MultiAzPriorityPolicyEnum
        {
            ...
            public static readonly Dictionary<string, MultiAzPriorityPolicyEnum> StaticFields =
        ...
        {
            return this.Equals(input as CreateScalingGroupRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateScalingGroupRequestBody input)
        {
            if (input == null)
                return false;

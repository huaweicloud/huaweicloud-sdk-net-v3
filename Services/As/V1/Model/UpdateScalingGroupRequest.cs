...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateScalingGroupRequest 
    {
        ...
        public UpdateScalingGroupRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateScalingGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingGroupRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class EnableOrDisableScalingGroupRequest 
    {
        ...
        public EnableOrDisableScalingGroupRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as EnableOrDisableScalingGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EnableOrDisableScalingGroupRequest input)
        {
            if (input == null)
                return false;

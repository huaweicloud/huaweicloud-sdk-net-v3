...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class BatchAddScalingInstancesRequest 
    {
        ...
        public BatchAddInstancesOption Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAddScalingInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddScalingInstancesRequest input)
        {
            if (input == null)
                return false;

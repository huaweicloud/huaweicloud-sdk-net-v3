...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateScalingGroupInstanceRequest 
    {
        ...
        public UpdateScalingGroupInstanceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateScalingGroupInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingGroupInstanceRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class AttachCallbackInstanceLifeCycleHookRequest 
    {
        ...
        public CallbackLifeCycleHookOption Body { get; set; }
        ...
        {
            return this.Equals(input as AttachCallbackInstanceLifeCycleHookRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachCallbackInstanceLifeCycleHookRequest input)
        {
            if (input == null)
                return false;

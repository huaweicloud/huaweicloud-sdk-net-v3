...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class CreateGroupScheduledTaskRequest 
    {
        ...
        public CreateScheduledTaskOption Body { get; set; }
        ...
        {
            return this.Equals(input as CreateGroupScheduledTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGroupScheduledTaskRequest input)
        {

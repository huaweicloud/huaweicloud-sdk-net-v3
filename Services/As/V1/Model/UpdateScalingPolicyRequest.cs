...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateScalingPolicyRequest 
    {
        ...
        public UpdateScalingPolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateScalingPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingPolicyRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateScalingV2PolicyRequest 
    {
        ...
        public UpdateScalingV2PolicyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateScalingV2PolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingV2PolicyRequest input)
        {
            if (input == null)
                return false;

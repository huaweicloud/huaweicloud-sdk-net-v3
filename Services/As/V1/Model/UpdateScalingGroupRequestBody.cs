...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateScalingGroupRequestBody 
    {
        ...
        /// </summary>
        /// <value>伸缩组实例健康检查周期（分钟）：1、5、15、60、180。若设置为0，可以实现10秒级健康检查。</value>
        ...
        {
            return this.Equals(input as UpdateScalingGroupRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingGroupRequestBody input)
        {
            if (input == null)
                return false;

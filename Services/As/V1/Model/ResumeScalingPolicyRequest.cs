...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class ResumeScalingPolicyRequest 
    {
        ...
        public ResumeScalingPolicyOption Body { get; set; }
        ...
        {
            return this.Equals(input as ResumeScalingPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResumeScalingPolicyRequest input)
        {
            if (input == null)
                return false;

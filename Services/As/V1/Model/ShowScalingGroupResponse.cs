...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class ShowScalingGroupResponse : SdkResponse
    {
        ...
        public bool Equals(ShowScalingGroupResponse input)
        {
            ...
            if (this.ScalingGroup != input.ScalingGroup || (this.ScalingGroup != null && !this.ScalingGroup.Equals(input.ScalingGroup))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.ScalingGroup != null) hashCode = hashCode * 59 + this.ScalingGroup.GetHashCode();
                return hashCode;
            }
        }
    }

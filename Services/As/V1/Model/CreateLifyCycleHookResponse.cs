...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateLifyCycleHookResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateLifyCycleHookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateLifyCycleHookResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListScalingActivityV2LogsResponse : SdkResponse
    {
        ...
        public List<ScalingActivityLogV2> ScalingActivityLog { get; set; }
        ...
        {
            return this.Equals(input as ListScalingActivityV2LogsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListScalingActivityV2LogsResponse input)
        {
            ...
            if (this.ScalingActivityLog != input.ScalingActivityLog || (this.ScalingActivityLog != null && input.ScalingActivityLog != null && !this.ScalingActivityLog.SequenceEqual(input.ScalingActivityLog))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ScalingActivityLog != null) hashCode = hashCode * 59 + this.ScalingActivityLog.GetHashCode();
                return hashCode;
            }
        }
    }

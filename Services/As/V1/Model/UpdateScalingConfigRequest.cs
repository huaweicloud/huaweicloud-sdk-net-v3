...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateScalingConfigRequest 
    {
        ...
        public UpdateScalingConfigOption Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateScalingConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingConfigRequest input)
        {

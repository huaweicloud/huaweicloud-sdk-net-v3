...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class BatchUnprotectScalingInstancesRequest 
    {
        ...
        public BatchUnprotectInstancesOption Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUnprotectScalingInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUnprotectScalingInstancesRequest input)
        {
            if (input == null)
                return false;

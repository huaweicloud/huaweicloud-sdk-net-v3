...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class ListScalingPolicyExecuteLogsResponse : SdkResponse
    {
        ...
        public bool Equals(ListScalingPolicyExecuteLogsResponse input)
        {
            ...
            if (this.ScalingPolicyExecuteLog != input.ScalingPolicyExecuteLog || (this.ScalingPolicyExecuteLog != null && input.ScalingPolicyExecuteLog != null && !this.ScalingPolicyExecuteLog.SequenceEqual(input.ScalingPolicyExecuteLog))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ScalingPolicyExecuteLog != null) hashCode = hashCode * 59 + this.ScalingPolicyExecuteLog.GetHashCode();
                return hashCode;
            }
        }
    }

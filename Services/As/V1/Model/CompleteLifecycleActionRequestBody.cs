...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class CompleteLifecycleActionRequestBody 
    {
        ...
        public class LifecycleActionResultEnum
        {
            ...
            public static readonly Dictionary<string, LifecycleActionResultEnum> StaticFields =
        ...
        {
            return this.Equals(input as CompleteLifecycleActionRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CompleteLifecycleActionRequestBody input)
        {
            if (input == null)
                return false;

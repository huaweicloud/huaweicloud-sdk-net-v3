...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class BatchSetScalingInstancesStandbyRequest 
    {
        ...
        public BatchEnterStandbyInstancesOption Body { get; set; }
        ...
        {
            return this.Equals(input as BatchSetScalingInstancesStandbyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchSetScalingInstancesStandbyRequest input)
        {

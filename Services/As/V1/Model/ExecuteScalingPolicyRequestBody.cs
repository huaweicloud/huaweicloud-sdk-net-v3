...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class ExecuteScalingPolicyRequestBody 
    {
        ...
        public class ActionEnum
        {
            ...
            /// </summary>
            public static readonly ActionEnum EXECUTE = new ActionEnum("execute");
        ...
        {
            return this.Equals(input as ExecuteScalingPolicyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteScalingPolicyRequestBody input)
        {
            if (input == null)
                return false;

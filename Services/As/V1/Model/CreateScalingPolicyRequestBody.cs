...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class CreateScalingPolicyRequestBody 
    {
        ...
        public ScalingPolicyAction ScalingPolicyAction { get; set; }
        ...
        {
            return this.Equals(input as CreateScalingPolicyRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateScalingPolicyRequestBody input)
        {
            if (input == null)
                return false;

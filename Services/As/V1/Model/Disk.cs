...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class Disk 
    {
        ...
        /// </summary>
        /// <value>云服务器数据盘对应的磁盘类型，需要与系统所提供的磁盘类型相匹配。磁盘类型枚举值：SATA：普通IO磁盘类型。SAS：高IO磁盘类型。SSD：超高IO磁盘类型。co-pl：高IO (性能优化Ⅰ型)磁盘类型。uh-l1：超高 IO (时延优化)磁盘类型。说明：对于HANA云服务器和HL1型云服务器，需使用co-p1和uh-l1两种磁盘类型。对于其他类型的云服务器，不能使用co-p1和uh-l1两种磁盘类型。</value>
        ...
        /// </summary>
        [JsonProperty("dedicate_storage_id", NullValueHandling = NullValueHandling.Ignore)]
        public string DedicateStorageId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  dedicateStorageId: ").Append(DedicateStorageId).Append("\n");
        ...
        public bool Equals(Disk input)
        {
            ...
            return 
                ...
                (
                    this.DedicateStorageId == input.DedicateStorageId ||
                    (this.DedicateStorageId != null &&
                    this.DedicateStorageId.Equals(input.DedicateStorageId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DedicateStorageId != null)
                    hashCode = hashCode * 59 + this.DedicateStorageId.GetHashCode();

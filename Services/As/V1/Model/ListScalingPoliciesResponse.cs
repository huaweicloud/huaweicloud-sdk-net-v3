...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListScalingPoliciesResponse : SdkResponse
    {
        ...
        public List<ScalingPolicyDetail> ScalingPolicies { get; set; }
        ...
        {
            return this.Equals(input as ListScalingPoliciesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListScalingPoliciesResponse input)
        {
            if (input == null)
                return false;

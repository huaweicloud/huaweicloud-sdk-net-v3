...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateScalingV2PolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateScalingV2PolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateScalingV2PolicyResponse input)
        {
            if (input == null)
                return false;

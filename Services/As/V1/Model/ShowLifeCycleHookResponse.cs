...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowLifeCycleHookResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowLifeCycleHookResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowLifeCycleHookResponse input)
        {
            if (input == null)
                return false;

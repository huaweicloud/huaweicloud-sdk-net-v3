...
namespace HuaweiCloud.SDK.As.V1.Model
{
    ...
    public class UpdateLifeCycleHookRequest 
    {
        ...
        public UpdateLifeCycleHookOption Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateLifeCycleHookRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateLifeCycleHookRequest input)
        {

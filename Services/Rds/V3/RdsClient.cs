...
namespace HuaweiCloud.SDK.Rds.V3
{
    public partial class RdsClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchDeleteInstanceResponse BatchDeleteInstance(BatchDeleteInstanceRequest batchDeleteInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchDeleteInstanceResponse> BatchDeleteInstanceInvoker(BatchDeleteInstanceRequest batchDeleteInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDeleteInstanceRequest);
            return new SyncInvoker<BatchDeleteInstanceResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchDeleteInstanceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchExecuteEventsResponse BatchExecuteEvents(BatchExecuteEventsRequest batchExecuteEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchExecuteEventsResponse> BatchExecuteEventsInvoker(BatchExecuteEventsRequest batchExecuteEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchExecuteEventsRequest);
            return new SyncInvoker<BatchExecuteEventsResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchExecuteEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckWeakpwdResponse CheckWeakpwd(CheckWeakpwdRequest checkWeakpwdRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckWeakpwdResponse> CheckWeakpwdInvoker(CheckWeakpwdRequest checkWeakpwdRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/weakpwd", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkWeakpwdRequest);
            return new SyncInvoker<CheckWeakpwdResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckWeakpwdResponse>);
        }
        ...
        public SyncInvoker<CompareConfigurationResponse> CompareConfigurationInvoker(CompareConfigurationRequest compareConfigurationRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/difference", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", compareConfigurationRequest);
            return new SyncInvoker<CompareConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<CompareConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateDrsJobTaskResponse CreateDrsJobTask(CreateDrsJobTaskRequest createDrsJobTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateDrsJobTaskResponse> CreateDrsJobTaskInvoker(CreateDrsJobTaskRequest createDrsJobTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createDrsJobTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/drs-job/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDrsJobTaskRequest);
            return new SyncInvoker<CreateDrsJobTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDrsJobTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateRebuildSlaveResponse CreateRebuildSlave(CreateRebuildSlaveRequest createRebuildSlaveRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateRebuildSlaveResponse> CreateRebuildSlaveInvoker(CreateRebuildSlaveRequest createRebuildSlaveRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createRebuildSlaveRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/rebuild", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createRebuildSlaveRequest);
            return new SyncInvoker<CreateRebuildSlaveResponse>(this, "PUT", request, JsonUtils.DeSerialize<CreateRebuildSlaveResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListAutoScalingPolicyResponse ListAutoScalingPolicy(ListAutoScalingPolicyRequest listAutoScalingPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListAutoScalingPolicyResponse> ListAutoScalingPolicyInvoker(ListAutoScalingPolicyRequest listAutoScalingPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listAutoScalingPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/auto-scaling/policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listAutoScalingPolicyRequest);
            return new SyncInvoker<ListAutoScalingPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ListAutoScalingPolicyResponse>);
        }
        ...
        public SyncInvoker<ListHistorySessionsResponse> ListHistorySessionsInvoker(ListHistorySessionsRequest listHistorySessionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistorySessionsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistorySessionsRequest);
            return new SyncInvoker<ListHistorySessionsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHistorySessionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListHistoryTopSqlsResponse ListHistoryTopSqls(ListHistoryTopSqlsRequest listHistoryTopSqlsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListHistoryTopSqlsResponse> ListHistoryTopSqlsInvoker(ListHistoryTopSqlsRequest listHistoryTopSqlsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistoryTopSqlsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-top-sql", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistoryTopSqlsRequest);
            return new SyncInvoker<ListHistoryTopSqlsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHistoryTopSqlsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListHistoryWaitEventsResponse ListHistoryWaitEvents(ListHistoryWaitEventsRequest listHistoryWaitEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListHistoryWaitEventsResponse> ListHistoryWaitEventsInvoker(ListHistoryWaitEventsRequest listHistoryWaitEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistoryWaitEventsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-wait-event", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistoryWaitEventsRequest);
            return new SyncInvoker<ListHistoryWaitEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHistoryWaitEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListMajorVersionFeatureResponse ListMajorVersionFeature(ListMajorVersionFeatureRequest listMajorVersionFeatureRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListMajorVersionFeatureResponse> ListMajorVersionFeatureInvoker(ListMajorVersionFeatureRequest listMajorVersionFeatureRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/major-version-feature", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listMajorVersionFeatureRequest);
            return new SyncInvoker<ListMajorVersionFeatureResponse>(this, "GET", request, JsonUtils.DeSerialize<ListMajorVersionFeatureResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListPackLogInfosResponse ListPackLogInfos(ListPackLogInfosRequest listPackLogInfosRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListPackLogInfosResponse> ListPackLogInfosInvoker(ListPackLogInfosRequest listPackLogInfosRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPackLogInfosRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/packlog/infos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPackLogInfosRequest);
            return new SyncInvoker<ListPackLogInfosResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPackLogInfosResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListScheduleEventsResponse ListScheduleEvents(ListScheduleEventsRequest listScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
        ...
        public SyncInvoker<ListScheduleEventsResponse> ListScheduleEventsInvoker(ListScheduleEventsRequest listScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listScheduleEventsRequest);
            return new SyncInvoker<ListScheduleEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListScheduleEventsResponse>);
        }
        ...
        public SyncInvoker<ListTopSqlsResponse> ListTopSqlsInvoker(ListTopSqlsRequest listTopSqlsRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/top-sqls", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listTopSqlsRequest);
            return new SyncInvoker<ListTopSqlsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListTopSqlsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public NotifyReplaceNodeResponse NotifyReplaceNode(NotifyReplaceNodeRequest notifyReplaceNodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<NotifyReplaceNodeResponse> NotifyReplaceNodeInvoker(NotifyReplaceNodeRequest notifyReplaceNodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(notifyReplaceNodeRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replace-node", urlParam);
        ...
        public SyncInvoker<ResetConfigurationResponse> ResetConfigurationInvoker(ResetConfigurationRequest resetConfigurationRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{config_id}/reset", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", resetConfigurationRequest);
            return new SyncInvoker<ResetConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<ResetConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAvailableBuildDrInstanceResponse ShowAvailableBuildDrInstance(ShowAvailableBuildDrInstanceRequest showAvailableBuildDrInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAvailableBuildDrInstanceResponse> ShowAvailableBuildDrInstanceInvoker(ShowAvailableBuildDrInstanceRequest showAvailableBuildDrInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/disaster-recovery-instance", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAvailableBuildDrInstanceRequest);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowDrsJobNameResponse ShowDrsJobName(ShowDrsJobNameRequest showDrsJobNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowDrsJobNameResponse> ShowDrsJobNameInvoker(ShowDrsJobNameRequest showDrsJobNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDrsJobNameRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/drs-job/name", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDrsJobNameRequest);
            return new SyncInvoker<ShowDrsJobNameResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDrsJobNameResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowHistorySessionAnalyseDownloadInfoResponse ShowHistorySessionAnalyseDownloadInfo(ShowHistorySessionAnalyseDownloadInfoRequest showHistorySessionAnalyseDownloadInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowHistorySessionAnalyseDownloadInfoResponse> ShowHistorySessionAnalyseDownloadInfoInvoker(ShowHistorySessionAnalyseDownloadInfoRequest showHistorySessionAnalyseDownloadInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHistorySessionAnalyseDownloadInfoRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHistorySessionAnalyseDownloadInfoRequest);
            return new SyncInvoker<ShowHistorySessionAnalyseDownloadInfoResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHistorySessionAnalyseDownloadInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowHotClodSeparationStatusResponse ShowHotClodSeparationStatus(ShowHotClodSeparationStatusRequest showHotClodSeparationStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowHotClodSeparationStatusResponse> ShowHotClodSeparationStatusInvoker(ShowHotClodSeparationStatusRequest showHotClodSeparationStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHotClodSeparationStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/hot-cold-separation/status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHotClodSeparationStatusRequest);
            return new SyncInvoker<ShowHotClodSeparationStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHotClodSeparationStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowRebuildSlaveStatusResponse ShowRebuildSlaveStatus(ShowRebuildSlaveStatusRequest showRebuildSlaveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowRebuildSlaveStatusResponse> ShowRebuildSlaveStatusInvoker(ShowRebuildSlaveStatusRequest showRebuildSlaveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRebuildSlaveStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/rebuild", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRebuildSlaveStatusRequest);
            return new SyncInvoker<ShowRebuildSlaveStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRebuildSlaveStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowRestartPolicyResponse ShowRestartPolicy(ShowRestartPolicyRequest showRestartPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowRestartPolicyResponse> ShowRestartPolicyInvoker(ShowRestartPolicyRequest showRestartPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRestartPolicyRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/restart-policy", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowTopObjectsResponse ShowTopObjects(ShowTopObjectsRequest showTopObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowTopObjectsResponse> ShowTopObjectsInvoker(ShowTopObjectsRequest showTopObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTopObjectsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/top/objects", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTopObjectsRequest);
            return new SyncInvoker<ShowTopObjectsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTopObjectsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UploadHistorySessionAnalyaseResponse UploadHistorySessionAnalyase(UploadHistorySessionAnalyaseRequest uploadHistorySessionAnalyaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UploadHistorySessionAnalyaseResponse> UploadHistorySessionAnalyaseInvoker(UploadHistorySessionAnalyaseRequest uploadHistorySessionAnalyaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(uploadHistorySessionAnalyaseRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", uploadHistorySessionAnalyaseRequest);
            return new SyncInvoker<UploadHistorySessionAnalyaseResponse>(this, "POST", request, JsonUtils.DeSerialize<UploadHistorySessionAnalyaseResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowMsdtcLocalHostResponse ShowMsdtcLocalHost(ShowMsdtcLocalHostRequest showMsdtcLocalHostRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowMsdtcLocalHostResponse> ShowMsdtcLocalHostInvoker(ShowMsdtcLocalHostRequest showMsdtcLocalHostRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showMsdtcLocalHostRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/msdtc/local-host", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showMsdtcLocalHostRequest);
            return new SyncInvoker<ShowMsdtcLocalHostResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowMsdtcLocalHostResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateIntelligentKillSessionResponse CreateIntelligentKillSession(CreateIntelligentKillSessionRequest createIntelligentKillSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateIntelligentKillSessionResponse> CreateIntelligentKillSessionInvoker(CreateIntelligentKillSessionRequest createIntelligentKillSessionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createIntelligentKillSessionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/intelligent-kill-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createIntelligentKillSessionRequest);
            return new SyncInvoker<CreateIntelligentKillSessionResponse>(this, "PUT", request, JsonUtils.DeSerialize<CreateIntelligentKillSessionResponse>);
        }
        ...
        public SyncInvoker<GetInstancesNoIndexTablesResponse> GetInstancesNoIndexTablesInvoker(GetInstancesNoIndexTablesRequest getInstancesNoIndexTablesRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/no-index-tables", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getInstancesNoIndexTablesRequest);
            return new SyncInvoker<GetInstancesNoIndexTablesResponse>(this, "GET", request, JsonUtils.DeSerialize<GetInstancesNoIndexTablesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RotateAuditLogResponse RotateAuditLog(RotateAuditLogRequest rotateAuditLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<RotateAuditLogResponse> RotateAuditLogInvoker(RotateAuditLogRequest rotateAuditLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(rotateAuditLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/auditlog-rotate", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAutoCesAlarmResponse ShowAutoCesAlarm(ShowAutoCesAlarmRequest showAutoCesAlarmRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAutoCesAlarmResponse> ShowAutoCesAlarmInvoker(ShowAutoCesAlarmRequest showAutoCesAlarmRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/auto-ces-alarm", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoCesAlarmRequest);
            return new SyncInvoker<ShowAutoCesAlarmResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoCesAlarmResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowIntelligentKillSessionHistoryResponse ShowIntelligentKillSessionHistory(ShowIntelligentKillSessionHistoryRequest showIntelligentKillSessionHistoryRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowIntelligentKillSessionHistoryResponse> ShowIntelligentKillSessionHistoryInvoker(ShowIntelligentKillSessionHistoryRequest showIntelligentKillSessionHistoryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showIntelligentKillSessionHistoryRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/intelligent-kill-session/history", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showIntelligentKillSessionHistoryRequest);
            return new SyncInvoker<ShowIntelligentKillSessionHistoryResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowIntelligentKillSessionHistoryResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchModifyPublicationResponse BatchModifyPublication(BatchModifyPublicationRequest batchModifyPublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchModifyPublicationResponse> BatchModifyPublicationInvoker(BatchModifyPublicationRequest batchModifyPublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchModifyPublicationRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchModifyPublicationRequest);
            return new SyncInvoker<BatchModifyPublicationResponse>(this, "PUT", request, JsonUtils.DeSerialize<BatchModifyPublicationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchModifySubscriptionResponse BatchModifySubscription(BatchModifySubscriptionRequest batchModifySubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchModifySubscriptionResponse> BatchModifySubscriptionInvoker(BatchModifySubscriptionRequest batchModifySubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(batchModifySubscriptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/subscriptions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchModifySubscriptionRequest);
            return new SyncInvoker<BatchModifySubscriptionResponse>(this, "PUT", request, JsonUtils.DeSerialize<BatchModifySubscriptionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CollectPublicationMonitorResponse CollectPublicationMonitor(CollectPublicationMonitorRequest collectPublicationMonitorRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CollectPublicationMonitorResponse> CollectPublicationMonitorInvoker(CollectPublicationMonitorRequest collectPublicationMonitorRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(collectPublicationMonitorRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(collectPublicationMonitorRequest.PublicationId, out var valueOfPublicationId)) urlParam.Add("publication_id", valueOfPublicationId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications/{publication_id}/monitor", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", collectPublicationMonitorRequest);
            return new SyncInvoker<CollectPublicationMonitorResponse>(this, "GET", request, JsonUtils.DeSerialize<CollectPublicationMonitorResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CollectSubscriptionMonitorResponse CollectSubscriptionMonitor(CollectSubscriptionMonitorRequest collectSubscriptionMonitorRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CollectSubscriptionMonitorResponse> CollectSubscriptionMonitorInvoker(CollectSubscriptionMonitorRequest collectSubscriptionMonitorRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(collectSubscriptionMonitorRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(collectSubscriptionMonitorRequest.SubscriptionId, out var valueOfSubscriptionId)) urlParam.Add("subscription_id", valueOfSubscriptionId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/subscriptions/{subscription_id}/monitor", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", collectSubscriptionMonitorRequest);
            return new SyncInvoker<CollectSubscriptionMonitorResponse>(this, "GET", request, JsonUtils.DeSerialize<CollectSubscriptionMonitorResponse>);
        }
        ...
        public SyncInvoker<CreateDistributionResponse> CreateDistributionInvoker(CreateDistributionRequest createDistributionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createDistributionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/distribution", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDistributionRequest);
            return new SyncInvoker<CreateDistributionResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDistributionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateJobScheduleResponse CreateJobSchedule(CreateJobScheduleRequest createJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateJobScheduleResponse> CreateJobScheduleInvoker(CreateJobScheduleRequest createJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createJobScheduleRequest);
            return new SyncInvoker<CreateJobScheduleResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateJobScheduleResponse>);
        }
        ...
        public SyncInvoker<CreatePublicationResponse> CreatePublicationInvoker(CreatePublicationRequest createPublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createPublicationRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createPublicationRequest);
            return new SyncInvoker<CreatePublicationResponse>(this, "POST", request, JsonUtils.DeSerialize<CreatePublicationResponse>);
        }
        ...
        public SyncInvoker<DeleteDistributionResponse> DeleteDistributionInvoker(DeleteDistributionRequest deleteDistributionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteDistributionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/distribution", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteDistributionRequest);
            return new SyncInvoker<DeleteDistributionResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteDistributionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteJobScheduleResponse DeleteJobSchedule(DeleteJobScheduleRequest deleteJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteJobScheduleResponse> DeleteJobScheduleInvoker(DeleteJobScheduleRequest deleteJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteJobScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteJobScheduleRequest);
            return new SyncInvoker<DeleteJobScheduleResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteJobScheduleResponse>);
        }
        ...
        public SyncInvoker<DeleteSubscriptionResponse> DeleteSubscriptionInvoker(DeleteSubscriptionRequest deleteSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteSubscriptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/subscriptions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteSubscriptionRequest);
            return new SyncInvoker<DeleteSubscriptionResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteSubscriptionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDbAgentJobHistoryStepsResponse ListDbAgentJobHistorySteps(ListDbAgentJobHistoryStepsRequest listDbAgentJobHistoryStepsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDbAgentJobHistoryStepsResponse> ListDbAgentJobHistoryStepsInvoker(ListDbAgentJobHistoryStepsRequest listDbAgentJobHistoryStepsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistoryStepsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistoryStepsRequest.HistoryId, out var valueOfHistoryId)) urlParam.Add("history_id", valueOfHistoryId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/histories/{history_id}/steps", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobHistoryStepsRequest);
            return new SyncInvoker<ListDbAgentJobHistoryStepsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDbAgentJobHistoryStepsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDbAgentJobHistorysResponse ListDbAgentJobHistorys(ListDbAgentJobHistorysRequest listDbAgentJobHistorysRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDbAgentJobHistorysResponse> ListDbAgentJobHistorysInvoker(ListDbAgentJobHistorysRequest listDbAgentJobHistorysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistorysRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistorysRequest.JobId, out var valueOfJobId)) urlParam.Add("job_id", valueOfJobId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/histories", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobHistorysRequest);
            return new SyncInvoker<ListDbAgentJobHistorysResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDbAgentJobHistorysResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDbAgentJobsResponse ListDbAgentJobs(ListDbAgentJobsRequest listDbAgentJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDbAgentJobsResponse> ListDbAgentJobsInvoker(ListDbAgentJobsRequest listDbAgentJobsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobsRequest);
            return new SyncInvoker<ListDbAgentJobsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDbAgentJobsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListJobSchedulesResponse ListJobSchedules(ListJobSchedulesRequest listJobSchedulesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
        ...
        public SyncInvoker<ListJobSchedulesResponse> ListJobSchedulesInvoker(ListJobSchedulesRequest listJobSchedulesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listJobSchedulesRequest);
            return new SyncInvoker<ListJobSchedulesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListJobSchedulesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListPublications4SubscriptionResponse ListPublications4Subscription(ListPublications4SubscriptionRequest listPublications4SubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListPublications4SubscriptionResponse> ListPublications4SubscriptionInvoker(ListPublications4SubscriptionRequest listPublications4SubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPublications4SubscriptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publication-candidates", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPublications4SubscriptionRequest);
            return new SyncInvoker<ListPublications4SubscriptionResponse>(this, "POST", request, JsonUtils.DeSerialize<ListPublications4SubscriptionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListRemoteDbResponse ListRemoteDb(ListRemoteDbRequest listRemoteDbRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListRemoteDbResponse> ListRemoteDbInvoker(ListRemoteDbRequest listRemoteDbRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listRemoteDbRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/remote-databases", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listRemoteDbRequest);
            return new SyncInvoker<ListRemoteDbResponse>(this, "POST", request, JsonUtils.DeSerialize<ListRemoteDbResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListReplicationErrorsResponse ListReplicationErrors(ListReplicationErrorsRequest listReplicationErrorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListReplicationErrorsResponse> ListReplicationErrorsInvoker(ListReplicationErrorsRequest listReplicationErrorsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listReplicationErrorsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/errors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listReplicationErrorsRequest);
            return new SyncInvoker<ListReplicationErrorsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListReplicationErrorsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListReplicationProfilesResponse ListReplicationProfiles(ListReplicationProfilesRequest listReplicationProfilesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListReplicationProfilesResponse> ListReplicationProfilesInvoker(ListReplicationProfilesRequest listReplicationProfilesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listReplicationProfilesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/profiles", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listReplicationProfilesRequest);
            return new SyncInvoker<ListReplicationProfilesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListReplicationProfilesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ModifyDbAgentJobResponse ModifyDbAgentJob(ModifyDbAgentJobRequest modifyDbAgentJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ModifyDbAgentJobResponse> ModifyDbAgentJobInvoker(ModifyDbAgentJobRequest modifyDbAgentJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyDbAgentJobRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(modifyDbAgentJobRequest.JobId, out var valueOfJobId)) urlParam.Add("job_id", valueOfJobId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyDbAgentJobRequest);
            return new SyncInvoker<ModifyDbAgentJobResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyDbAgentJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ModifyJobScheduleResponse ModifyJobSchedule(ModifyJobScheduleRequest modifyJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ModifyJobScheduleResponse> ModifyJobScheduleInvoker(ModifyJobScheduleRequest modifyJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyJobScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyJobScheduleRequest);
            return new SyncInvoker<ModifyJobScheduleResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyJobScheduleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RefreshPublicationSnapshotResponse RefreshPublicationSnapshot(RefreshPublicationSnapshotRequest refreshPublicationSnapshotRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RefreshSubscriptionResponse RefreshSubscription(RefreshSubscriptionRequest refreshSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RestartDbAgentJobResponse RestartDbAgentJob(RestartDbAgentJobRequest restartDbAgentJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<RestartDbAgentJobResponse> RestartDbAgentJobInvoker(RestartDbAgentJobRequest restartDbAgentJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(restartDbAgentJobRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(restartDbAgentJobRequest.JobId, out var valueOfJobId)) urlParam.Add("job_id", valueOfJobId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/restart", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", restartDbAgentJobRequest);
            return new SyncInvoker<RestartDbAgentJobResponse>(this, "POST", request, JsonUtils.DeSerialize<RestartDbAgentJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SwitchDbAgentJobResponse SwitchDbAgentJob(SwitchDbAgentJobRequest switchDbAgentJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SwitchDbAgentJobResponse> SwitchDbAgentJobInvoker(SwitchDbAgentJobRequest switchDbAgentJobRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchDbAgentJobRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(switchDbAgentJobRequest.JobId, out var valueOfJobId)) urlParam.Add("job_id", valueOfJobId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/switch", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", switchDbAgentJobRequest);
            return new SyncInvoker<SwitchDbAgentJobResponse>(this, "POST", request, JsonUtils.DeSerialize<SwitchDbAgentJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SyncReplicationMetadataResponse SyncReplicationMetadata(SyncReplicationMetadataRequest syncReplicationMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SyncReplicationMetadataResponse> SyncReplicationMetadataInvoker(SyncReplicationMetadataRequest syncReplicationMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(syncReplicationMetadataRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/metadata/sync", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", syncReplicationMetadataRequest);
            return new SyncInvoker<SyncReplicationMetadataResponse>(this, "POST", request, JsonUtils.DeSerialize<SyncReplicationMetadataResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateStatisticsResponse UpdateStatistics(UpdateStatisticsRequest updateStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateStatisticsResponse> UpdateStatisticsInvoker(UpdateStatisticsRequest updateStatisticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateStatisticsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-statistics", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateStatisticsRequest);
            return new SyncInvoker<UpdateStatisticsResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateStatisticsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ValidateInstanceConnectionResponse ValidateInstanceConnection(ValidateInstanceConnectionRequest validateInstanceConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ValidateInstanceConnectionResponse> ValidateInstanceConnectionInvoker(ValidateInstanceConnectionRequest validateInstanceConnectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(validateInstanceConnectionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/login-test", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", validateInstanceConnectionRequest);
            return new SyncInvoker<ValidateInstanceConnectionResponse>(this, "POST", request, JsonUtils.DeSerialize<ValidateInstanceConnectionResponse>);
        }

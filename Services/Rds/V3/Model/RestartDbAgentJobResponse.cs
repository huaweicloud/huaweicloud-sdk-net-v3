...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RestartDbAgentJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RestartDbAgentJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RestartDbAgentJobResponse input)
        {

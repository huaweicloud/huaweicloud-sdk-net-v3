...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class StartInstanceSingleToHaActionRequest 
    {
        ...
        {
            return this.Equals(input as StartInstanceSingleToHaActionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartInstanceSingleToHaActionRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetSecurityGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SetSecurityGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetSecurityGroupResponse input)
        {

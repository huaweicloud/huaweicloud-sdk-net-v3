...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateInstanceAliasResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateInstanceAliasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceAliasResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListPostgresqlListHistoryTablesRequest 
    {
        ...
        public PostgreSQLHistoryTableRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ListPostgresqlListHistoryTablesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPostgresqlListHistoryTablesRequest input)
        {

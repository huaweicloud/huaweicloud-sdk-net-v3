...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class RestoreToExistingInstanceRequestBody 
    {
        ...
        public RestoreToExistingInstanceRequestBodySource Source { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("target", NullValueHandling = NullValueHandling.Ignore)]
        public RestoreToExistingInstanceRequestBodyTarget Target { get; set; }
        ...
        {
            return this.Equals(input as RestoreToExistingInstanceRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RestoreToExistingInstanceRequestBody input)
        {

    ...
    public class ListInspectionHistoriesResponse : SdkResponse
    {
        ...
        public bool Equals(ListInspectionHistoriesResponse input)
        {
            ...
            return 
                ...
                (
                    this.InspectionReports == input.InspectionReports ||
                    this.InspectionReports != null &&
                    input.InspectionReports != null &&
                    this.InspectionReports.SequenceEqual(input.InspectionReports)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InspectionReports != null)
                    hashCode = hashCode * 59 + this.InspectionReports.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class CreateXelLogDownloadRequest 
    {
        ...
        public CreateXelLogDownloadRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateXelLogDownloadRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateXelLogDownloadRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ModifyPublicationRequest 
    {
        ...
        /// 发布ID
        /// </summary>
        [SDKProperty("publication_id", IsPath = true)]
        ...
        public ModifyPublicationsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyPublicationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyPublicationRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListSimplifiedInstancesRequest 
    {
        ...
        public SimplifiedInstancesRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ListSimplifiedInstancesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSimplifiedInstancesRequest input)
        {

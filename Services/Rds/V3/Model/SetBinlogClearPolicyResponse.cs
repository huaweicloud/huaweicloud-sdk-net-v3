...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetBinlogClearPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SetBinlogClearPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetBinlogClearPolicyResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RefreshSubscriptionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RefreshSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RefreshSubscriptionResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRebuildSlaveResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateRebuildSlaveResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRebuildSlaveResponse input)
        {

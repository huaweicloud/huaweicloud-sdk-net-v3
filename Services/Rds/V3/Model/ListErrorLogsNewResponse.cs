...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListErrorLogsNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListErrorLogsNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListErrorLogsNewResponse input)
        {

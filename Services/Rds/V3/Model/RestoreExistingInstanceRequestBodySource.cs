    ...
    public class RestoreExistingInstanceRequestBodySource 
    {
        ...
        public bool Equals(RestoreExistingInstanceRequestBodySource input)
        {
            ...
            return 
                ...
                (
                    this.RestoreAllDatabase == input.RestoreAllDatabase ||
                    (this.RestoreAllDatabase != null &&
                    this.RestoreAllDatabase.Equals(input.RestoreAllDatabase))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RestoreAllDatabase != null)
                    hashCode = hashCode * 59 + this.RestoreAllDatabase.GetHashCode();
                return hashCode;
            }
        }
    }

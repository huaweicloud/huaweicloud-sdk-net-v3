...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class RestoreExistingInstanceRequestBodySource 
    {
        ...
        /// </summary>
        [JsonProperty("restore_all_database", NullValueHandling = NullValueHandling.Ignore)]
        public bool? RestoreAllDatabase { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  restoreAllDatabase: ").Append(RestoreAllDatabase).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RestoreExistingInstanceRequestBodySource);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RestoreExistingInstanceRequestBodySource input)
        {
            ...
            if (this.RestoreAllDatabase != input.RestoreAllDatabase || (this.RestoreAllDatabase != null && !this.RestoreAllDatabase.Equals(input.RestoreAllDatabase))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RestoreAllDatabase != null) hashCode = hashCode * 59 + this.RestoreAllDatabase.GetHashCode();
                return hashCode;
            }
        }
    }

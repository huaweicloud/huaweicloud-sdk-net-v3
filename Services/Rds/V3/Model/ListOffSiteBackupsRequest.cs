...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListOffSiteBackupsRequest 
    {
        ...
        /// </summary>
        /// <value>备份类型，取值： - “auto”: 自动全量备份。SQL Server仅支持查询备份类型为“auto”的备份列表 - “incremental”: 自动增量备份</value>
        ...
        {
            return this.Equals(input as ListOffSiteBackupsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOffSiteBackupsRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateHostPrivilegeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateHostPrivilegeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHostPrivilegeResponse input)
        {

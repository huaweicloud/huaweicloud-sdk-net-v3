...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeletePostgresqlDbUserResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeletePostgresqlDbUserResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeletePostgresqlDbUserResponse input)
        {

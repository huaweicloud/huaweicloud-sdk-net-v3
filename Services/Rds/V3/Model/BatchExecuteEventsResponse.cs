...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchExecuteEventsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchExecuteEventsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchExecuteEventsResponse input)
        {

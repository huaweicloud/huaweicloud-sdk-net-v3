...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListInstanceParamHistoriesRequest 
    {
        ...
        /// 参数名称
        /// </summary>
        [SDKProperty("param_name", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListInstanceParamHistoriesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceParamHistoriesRequest input)
        {

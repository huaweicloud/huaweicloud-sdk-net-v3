...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class RevokeSqlserverDbUserPrivilegeRequest 
    {
        ...
        public SqlserverRevokeRequest Body { get; set; }
        ...
        {
            return this.Equals(input as RevokeSqlserverDbUserPrivilegeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RevokeSqlserverDbUserPrivilegeRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInstanceIam5Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateInstanceIam5Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInstanceIam5Response input)
        {

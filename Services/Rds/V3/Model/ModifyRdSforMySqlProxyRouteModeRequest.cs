...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ModifyRdSforMySqlProxyRouteModeRequest 
    {
        ...
        public ModifyMySqlProxyRouteModeRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ModifyRdSforMySqlProxyRouteModeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyRdSforMySqlProxyRouteModeRequest input)
        {

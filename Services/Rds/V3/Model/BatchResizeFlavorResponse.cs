...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchResizeFlavorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchResizeFlavorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchResizeFlavorResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class UpdateInstanceConfigurationAsyncRequest 
    {
        ...
        public UpdateInstanceConfigurationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateInstanceConfigurationAsyncRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateInstanceConfigurationAsyncRequest input)
        {
            if (input == null)
                return false;

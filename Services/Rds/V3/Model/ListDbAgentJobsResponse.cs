...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDbAgentJobsResponse : SdkResponse
    {
        ...
        public List<ListDbAgentJobsResult> Jobs { get; set; }
        ...
        {
            return this.Equals(input as ListDbAgentJobsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDbAgentJobsResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RefreshPublicationSnapshotResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RefreshPublicationSnapshotResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RefreshPublicationSnapshotResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class StartInstanceReduceVolumeActionRequest 
    {
        ...
        public ReduceVolumeRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as StartInstanceReduceVolumeActionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartInstanceReduceVolumeActionRequest input)
        {
            if (input == null)
                return false;

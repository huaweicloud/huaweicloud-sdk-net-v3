...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class CustomerCreateInstanceReq 
    {
        ...
        /// </summary>
        [JsonProperty("subscription_agency", NullValueHandling = NullValueHandling.Ignore)]
        public string SubscriptionAgency { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  subscriptionAgency: ").Append(SubscriptionAgency).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CustomerCreateInstanceReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CustomerCreateInstanceReq input)
        {
            ...
            if (this.ReplicaOfId != input.ReplicaOfId || (this.ReplicaOfId != null && !this.ReplicaOfId.Equals(input.ReplicaOfId))) return false;
            ...
            if (this.UnchangeableParam != input.UnchangeableParam || (this.UnchangeableParam != null && !this.UnchangeableParam.Equals(input.UnchangeableParam))) return false;
            ...
            if (this.SubscriptionAgency != input.SubscriptionAgency || (this.SubscriptionAgency != null && !this.SubscriptionAgency.Equals(input.SubscriptionAgency))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReplicaOfId != null) hashCode = hashCode * 59 + this.ReplicaOfId.GetHashCode();
                ...
                if (this.UnchangeableParam != null) hashCode = hashCode * 59 + this.UnchangeableParam.GetHashCode();
                ...
                if (this.SubscriptionAgency != null) hashCode = hashCode * 59 + this.SubscriptionAgency.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class SetDatabaseUserPrivilegeRequest 
    {
        ...
        public SetDatabaseUserPrivilegeReqV3 Body { get; set; }
        ...
        {
            return this.Equals(input as SetDatabaseUserPrivilegeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetDatabaseUserPrivilegeRequest input)
        {
            if (input == null)
                return false;

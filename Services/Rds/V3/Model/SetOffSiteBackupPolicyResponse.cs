...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetOffSiteBackupPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SetOffSiteBackupPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetOffSiteBackupPolicyResponse input)
        {

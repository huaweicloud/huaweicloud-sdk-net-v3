...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListInstancesResourceMetricsRequest 
    {
        ...
        public bool Equals(ListInstancesResourceMetricsRequest input)
        {
            ...
            if (this.SearchField != input.SearchField || (this.SearchField != null && !this.SearchField.Equals(input.SearchField))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SearchField != null) hashCode = hashCode * 59 + this.SearchField.GetHashCode();

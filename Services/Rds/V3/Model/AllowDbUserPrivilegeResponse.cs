...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AllowDbUserPrivilegeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AllowDbUserPrivilegeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AllowDbUserPrivilegeResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListRetainBackupsResponse : SdkResponse
    {
        ...
        public RetainBackup Backups { get; set; }
        ...
        {
            return this.Equals(input as ListRetainBackupsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListRetainBackupsResponse input)
        {

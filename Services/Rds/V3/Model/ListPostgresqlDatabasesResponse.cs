...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPostgresqlDatabasesResponse : SdkResponse
    {
        ...
        public List<PostgresqlListDatabase> Databases { get; set; }
        ...
        {
            return this.Equals(input as ListPostgresqlDatabasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPostgresqlDatabasesResponse input)
        {

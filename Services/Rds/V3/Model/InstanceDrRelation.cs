...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class InstanceDrRelation 
    {
        ...
        public bool Equals(InstanceDrRelation input)
        {
            ...
            if (this.SlaveInstances != input.SlaveInstances || (this.SlaveInstances != null && input.SlaveInstances != null && !this.SlaveInstances.SequenceEqual(input.SlaveInstances))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SlaveInstances != null) hashCode = hashCode * 59 + this.SlaveInstances.GetHashCode();
                return hashCode;
            }
        }
    }

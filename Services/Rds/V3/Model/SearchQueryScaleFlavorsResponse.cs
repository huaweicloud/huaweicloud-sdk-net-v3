...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SearchQueryScaleFlavorsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SearchQueryScaleFlavorsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchQueryScaleFlavorsResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SwitchDbAgentJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SwitchDbAgentJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchDbAgentJobResponse input)
        {

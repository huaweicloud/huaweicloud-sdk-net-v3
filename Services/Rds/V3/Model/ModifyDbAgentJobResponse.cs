...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyDbAgentJobResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyDbAgentJobResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyDbAgentJobResponse input)
        {

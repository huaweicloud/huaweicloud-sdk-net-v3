...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ShowSqlDiagnosisRequest 
    {
        ...
        /// </summary>
        [SDKProperty("subcategory", IsQuery = true)]
        ...
        {
            return this.Equals(input as ShowSqlDiagnosisRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSqlDiagnosisRequest input)
        {
            if (input == null) return false;
            if (this.InstanceId != input.InstanceId || (this.InstanceId != null && !this.InstanceId.Equals(input.InstanceId))) return false;
            if (this.XLanguage != input.XLanguage || (this.XLanguage != null && !this.XLanguage.Equals(input.XLanguage))) return false;
            if (this.Category != input.Category || (this.Category != null && !this.Category.Equals(input.Category))) return false;
            if (this.Subcategory != input.Subcategory || (this.Subcategory != null && !this.Subcategory.Equals(input.Subcategory))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Subcategory != null) hashCode = hashCode * 59 + this.Subcategory.GetHashCode();

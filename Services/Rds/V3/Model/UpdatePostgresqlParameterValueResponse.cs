...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePostgresqlParameterValueResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePostgresqlParameterValueResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePostgresqlParameterValueResponse input)
        {
            if (input == null)
                return false;

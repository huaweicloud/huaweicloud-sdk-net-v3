...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class RevokePostgresqlDbPrivilegeRequestBody 
    {
        ...
        public List<RevokePostgresqlDbPrivilegeUser> Users { get; set; }
        ...
        {
            return this.Equals(input as RevokePostgresqlDbPrivilegeRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RevokePostgresqlDbPrivilegeRequestBody input)
        {

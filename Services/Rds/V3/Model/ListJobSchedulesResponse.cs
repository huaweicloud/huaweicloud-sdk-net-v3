...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListJobSchedulesResponse : SdkResponse
    {
        ...
        public List<JobScheduleInfo> Schedules { get; set; }
        ...
        {
            return this.Equals(input as ListJobSchedulesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListJobSchedulesResponse input)
        {

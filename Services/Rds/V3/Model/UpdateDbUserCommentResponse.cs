...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateDbUserCommentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateDbUserCommentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDbUserCommentResponse input)
        {

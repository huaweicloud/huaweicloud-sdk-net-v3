...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class StartResizeFlavorActionRequest 
    {
        ...
        public ResizeFlavorRequest Body { get; set; }
        ...
        {
            return this.Equals(input as StartResizeFlavorActionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartResizeFlavorActionRequest input)
        {

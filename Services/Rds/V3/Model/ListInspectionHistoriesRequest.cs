...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListInspectionHistoriesRequest 
    {
        ...
        /// 目标版本。
        /// </summary>
        [SDKProperty("target_version", IsQuery = true)]
        ...
        /// </summary>
        [SDKProperty("is_available", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListInspectionHistoriesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInspectionHistoriesRequest input)
        {

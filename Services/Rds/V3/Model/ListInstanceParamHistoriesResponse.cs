...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInstanceParamHistoriesResponse : SdkResponse
    {
        ...
        public List<ParamGroupHistoryResult> Histories { get; set; }
        ...
        {
            return this.Equals(input as ListInstanceParamHistoriesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListInstanceParamHistoriesResponse input)
        {
            if (input == null)
                return false;

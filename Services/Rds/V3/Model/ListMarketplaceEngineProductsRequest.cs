...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListMarketplaceEngineProductsRequest 
    {
        ...
        /// 服务商ID。
        /// </summary>
        [SDKProperty("bp_domain_id", IsPath = true)]
        ...
        {
            return this.Equals(input as ListMarketplaceEngineProductsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMarketplaceEngineProductsRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSparseBackupPolicyResponse : SdkResponse
    {
        ...
        public List<SparseBackupPolicy> Policies { get; set; }
        ...
        {
            return this.Equals(input as ListSparseBackupPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSparseBackupPolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class PostgreSQLRestoreTableRequest 
    {
        ...
        public List<PostgreSQLRestoreTableInstance> Instances { get; set; }
        ...
        {
            return this.Equals(input as PostgreSQLRestoreTableRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PostgreSQLRestoreTableRequest input)
        {

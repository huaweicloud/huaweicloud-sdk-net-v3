...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSqlDiagnosisResponse : SdkResponse
    {
        ...
        public List<SqlDiagnosisResult> Results { get; set; }
        ...
        {
            return this.Equals(input as ShowSqlDiagnosisResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSqlDiagnosisResponse input)
        {

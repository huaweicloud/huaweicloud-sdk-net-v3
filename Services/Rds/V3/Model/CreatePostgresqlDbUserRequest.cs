...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class CreatePostgresqlDbUserRequest 
    {
        ...
        public PostgresqlUserForCreation Body { get; set; }
        ...
        {
            return this.Equals(input as CreatePostgresqlDbUserRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePostgresqlDbUserRequest input)
        {
            if (input == null)
                return false;

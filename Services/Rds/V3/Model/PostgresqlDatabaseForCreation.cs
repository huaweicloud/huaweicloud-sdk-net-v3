...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class PostgresqlDatabaseForCreation 
    {
        ...
        public bool Equals(PostgresqlDatabaseForCreation input)
        {
            ...
            if (this.LcCollate != input.LcCollate || (this.LcCollate != null && !this.LcCollate.Equals(input.LcCollate))) return false;
            if (this.LcCtype != input.LcCtype || (this.LcCtype != null && !this.LcCtype.Equals(input.LcCtype))) return false;
            if (this.IsRevokePublicPrivilege != input.IsRevokePublicPrivilege || (this.IsRevokePublicPrivilege != null && !this.IsRevokePublicPrivilege.Equals(input.IsRevokePublicPrivilege))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LcCollate != null) hashCode = hashCode * 59 + this.LcCollate.GetHashCode();
                if (this.LcCtype != null) hashCode = hashCode * 59 + this.LcCtype.GetHashCode();
                if (this.IsRevokePublicPrivilege != null) hashCode = hashCode * 59 + this.IsRevokePublicPrivilege.GetHashCode();

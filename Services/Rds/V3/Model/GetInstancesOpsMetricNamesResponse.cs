...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GetInstancesOpsMetricNamesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GetInstancesOpsMetricNamesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetInstancesOpsMetricNamesResponse input)
        {

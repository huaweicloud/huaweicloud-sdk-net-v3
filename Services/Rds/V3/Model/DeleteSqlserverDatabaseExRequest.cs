...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class DeleteSqlserverDatabaseExRequest 
    {
        ...
        public DropDatabaseV3Req Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteSqlserverDatabaseExRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteSqlserverDatabaseExRequest input)
        {

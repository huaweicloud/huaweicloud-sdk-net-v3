...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePostgresqlDatabaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePostgresqlDatabaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePostgresqlDatabaseResponse input)
        {

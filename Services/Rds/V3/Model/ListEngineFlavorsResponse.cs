...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListEngineFlavorsResponse : SdkResponse
    {
        ...
        public bool Equals(ListEngineFlavorsResponse input)
        {
            ...
            if (this.OptionalFlavors != input.OptionalFlavors || (this.OptionalFlavors != null && input.OptionalFlavors != null && !this.OptionalFlavors.SequenceEqual(input.OptionalFlavors))) return false;

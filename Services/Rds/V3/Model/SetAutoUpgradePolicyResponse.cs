...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SetAutoUpgradePolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SetAutoUpgradePolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetAutoUpgradePolicyResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ReadonlyInstances 
    {
        ...
        public bool Equals(ReadonlyInstances input)
        {
            ...
            if (this.CpuNum != input.CpuNum || (this.CpuNum != null && !this.CpuNum.Equals(input.CpuNum))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CpuNum != null) hashCode = hashCode * 59 + this.CpuNum.GetHashCode();
                return hashCode;
            }
        }
    }

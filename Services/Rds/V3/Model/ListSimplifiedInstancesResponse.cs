...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSimplifiedInstancesResponse : SdkResponse
    {
        ...
        public List<SimplifiedInstanceEntry> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListSimplifiedInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSimplifiedInstancesResponse input)
        {

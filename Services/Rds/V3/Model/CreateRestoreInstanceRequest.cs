...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class CreateRestoreInstanceRequest 
    {
        ...
        public CreateRestoreInstanceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateRestoreInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRestoreInstanceRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class UpdatePostgresqlDatabaseRequest 
    {
        ...
        public UpdateDatabaseReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePostgresqlDatabaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePostgresqlDatabaseRequest input)
        {

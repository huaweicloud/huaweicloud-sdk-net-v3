...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class PublicationTableFilterInfoResponse 
    {
        ...
        public List<PublicationTableFilterInfoResponse> Filters { get; set; }
        ...
        {
            return this.Equals(input as PublicationTableFilterInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PublicationTableFilterInfoResponse input)
        {

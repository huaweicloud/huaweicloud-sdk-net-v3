...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListHistoryDatabaseRequest 
    {
        ...
        public PostgreSQLHistoryDatabaseRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ListHistoryDatabaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListHistoryDatabaseRequest input)
        {

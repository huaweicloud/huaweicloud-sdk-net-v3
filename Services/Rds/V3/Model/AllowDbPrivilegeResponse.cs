...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AllowDbPrivilegeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AllowDbPrivilegeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AllowDbPrivilegeResponse input)
        {

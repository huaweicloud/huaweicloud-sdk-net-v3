...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdatePostgresqlDatabaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdatePostgresqlDatabaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePostgresqlDatabaseResponse input)
        {

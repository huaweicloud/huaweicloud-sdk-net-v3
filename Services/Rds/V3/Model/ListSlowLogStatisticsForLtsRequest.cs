...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ListSlowLogStatisticsForLtsRequest 
    {
        ...
        public SlowLogStatisticsForLtsRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ListSlowLogStatisticsForLtsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSlowLogStatisticsForLtsRequest input)
        {

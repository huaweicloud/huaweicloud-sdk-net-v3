...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class DeleteDisasterRecoveryRequest 
    {
        ...
        public DeleteDisasterRecoveryRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteDisasterRecoveryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteDisasterRecoveryRequest input)
        {
            if (input == null)
                return false;

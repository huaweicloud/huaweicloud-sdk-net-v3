...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSqlserverDbUsersResponse : SdkResponse
    {
        ...
        public List<UserForList> Users { get; set; }
        ...
        {
            return this.Equals(input as ListSqlserverDbUsersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSqlserverDbUsersResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ResetViewSqlStatisticsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ResetViewSqlStatisticsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResetViewSqlStatisticsResponse input)
        {

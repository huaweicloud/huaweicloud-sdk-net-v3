...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class StartInstanceRestartActionRequest 
    {
        ...
        public InstanceRestartRequsetBody Body { get; set; }
        ...
        {
            return this.Equals(input as StartInstanceRestartActionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartInstanceRestartActionRequest input)
        {

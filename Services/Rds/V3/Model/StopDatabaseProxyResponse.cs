...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class StopDatabaseProxyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as StopDatabaseProxyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StopDatabaseProxyResponse input)
        {

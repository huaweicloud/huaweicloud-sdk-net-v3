...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class SetAutoEnlargePolicyRequest 
    {
        ...
        public CustomerModifyAutoEnlargePolicyReq Body { get; set; }
        ...
        {
            return this.Equals(input as SetAutoEnlargePolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetAutoEnlargePolicyRequest input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ApplyConfigurationAsyncRequest 
    {
        ...
        public ApplyConfigurationRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ApplyConfigurationAsyncRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ApplyConfigurationAsyncRequest input)
        {

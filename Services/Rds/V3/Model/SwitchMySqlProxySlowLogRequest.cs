...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class SwitchMySqlProxySlowLogRequest 
    {
        ...
        public SwitchMySqlProxySlowLogRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as SwitchMySqlProxySlowLogRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SwitchMySqlProxySlowLogRequest input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteBackupSelectionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteBackupSelectionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteBackupSelectionResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CheckInstanceForUpgradeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CheckInstanceForUpgradeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckInstanceForUpgradeResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSecondLevelMonitoringResponse : SdkResponse
    {
        /// <summary>
        /// 监控间隔, 支持1秒和5秒
        /// </summary>
        ...
        {
            return this.Equals(input as ShowSecondLevelMonitoringResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSecondLevelMonitoringResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class UpdatePostgresqlParameterValueRequest 
    {
        ...
        public ModifyParamRequest Body { get; set; }
        ...
        {
            return this.Equals(input as UpdatePostgresqlParameterValueRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdatePostgresqlParameterValueRequest input)
        {
            if (input == null)
                return false;

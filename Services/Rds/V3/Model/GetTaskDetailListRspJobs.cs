...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class GetTaskDetailListRspJobs 
    {
        ...
        /// </summary>
        [JsonProperty("task_detail", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  taskDetail: ").Append(TaskDetail).Append("\n");
        ...
        {
            return this.Equals(input as GetTaskDetailListRspJobs);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GetTaskDetailListRspJobs input)
        {
            ...
            if (this.Ended != input.Ended || (this.Ended != null && !this.Ended.Equals(input.Ended))) return false;
            if (this.Process != input.Process || (this.Process != null && !this.Process.Equals(input.Process))) return false;
            if (this.TaskDetail != input.TaskDetail || (this.TaskDetail != null && !this.TaskDetail.Equals(input.TaskDetail))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Ended != null) hashCode = hashCode * 59 + this.Ended.GetHashCode();
                if (this.Process != null) hashCode = hashCode * 59 + this.Process.GetHashCode();
                if (this.TaskDetail != null) hashCode = hashCode * 59 + this.TaskDetail.GetHashCode();

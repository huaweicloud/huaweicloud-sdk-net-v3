...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ChangeTheDelayThresholdRequest 
    {
        ...
        public ChangingTheDelayThresholdRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeTheDelayThresholdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeTheDelayThresholdRequest input)
        {

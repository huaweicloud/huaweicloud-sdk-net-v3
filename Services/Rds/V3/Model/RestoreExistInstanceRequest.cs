...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class RestoreExistInstanceRequest 
    {
        ...
        public RestoreExistingInstanceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RestoreExistInstanceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RestoreExistInstanceRequest input)
        {
            if (input == null)
                return false;

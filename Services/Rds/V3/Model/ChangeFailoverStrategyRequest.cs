...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ChangeFailoverStrategyRequest 
    {
        ...
        public FailoverStrategyRequest Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeFailoverStrategyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeFailoverStrategyRequest input)
        {

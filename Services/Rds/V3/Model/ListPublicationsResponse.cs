...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPublicationsResponse : SdkResponse
    {
        ...
        public List<QueryPublicationInfo> Publications { get; set; }
        ...
        {
            return this.Equals(input as ListPublicationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPublicationsResponse input)
        {

...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class ResourceMonitoringInfo 
    {
        ...
        public bool Equals(ResourceMonitoringInfo input)
        {
            ...
            if (this.ActiveConnections != input.ActiveConnections || (this.ActiveConnections != null && !this.ActiveConnections.Equals(input.ActiveConnections))) return false;
            if (this.SlowSql != input.SlowSql || (this.SlowSql != null && !this.SlowSql.Equals(input.SlowSql))) return false;
            if (this.ReadonlyInstanceResourceMonitoringInfo != input.ReadonlyInstanceResourceMonitoringInfo || (this.ReadonlyInstanceResourceMonitoringInfo != null && input.ReadonlyInstanceResourceMonitoringInfo != null && !this.ReadonlyInstanceResourceMonitoringInfo.SequenceEqual(input.ReadonlyInstanceResourceMonitoringInfo))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ActiveConnections != null) hashCode = hashCode * 59 + this.ActiveConnections.GetHashCode();
                if (this.SlowSql != null) hashCode = hashCode * 59 + this.SlowSql.GetHashCode();
                if (this.ReadonlyInstanceResourceMonitoringInfo != null) hashCode = hashCode * 59 + this.ReadonlyInstanceResourceMonitoringInfo.GetHashCode();
                return hashCode;
            }
        }
    }

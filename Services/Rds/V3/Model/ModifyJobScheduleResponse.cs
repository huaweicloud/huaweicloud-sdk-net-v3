...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ModifyJobScheduleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ModifyJobScheduleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModifyJobScheduleResponse input)
        {

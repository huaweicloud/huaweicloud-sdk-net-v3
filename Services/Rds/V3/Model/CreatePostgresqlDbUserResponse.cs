...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePostgresqlDbUserResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePostgresqlDbUserResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePostgresqlDbUserResponse input)
        {

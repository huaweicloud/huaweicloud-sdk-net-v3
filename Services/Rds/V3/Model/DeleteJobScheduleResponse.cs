...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteJobScheduleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteJobScheduleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteJobScheduleResponse input)
        {

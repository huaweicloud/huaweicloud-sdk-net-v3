...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class UpgradeDbVersionNewRequest 
    {
        ...
        public CustomerUpgradeDatabaseVersionReqNew Body { get; set; }
        ...
        {
            return this.Equals(input as UpgradeDbVersionNewRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpgradeDbVersionNewRequest input)
        {
            if (input == null)
                return false;

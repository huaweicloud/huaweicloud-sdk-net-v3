...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListHistorySessionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListHistorySessionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListHistorySessionsResponse input)
        {

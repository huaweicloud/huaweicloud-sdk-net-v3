...
namespace HuaweiCloud.SDK.Rds.V3.Model
{
    ...
    public class PostgreSQLHistoryDatabaseInstance 
    {
        ...
        public List<PostgreSQLHistoryDatabaseInfo> Databases { get; set; }
        ...
        {
            return this.Equals(input as PostgreSQLHistoryDatabaseInstance);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PostgreSQLHistoryDatabaseInstance input)
        {
            if (input == null)
                return false;

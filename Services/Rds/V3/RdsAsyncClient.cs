...
namespace HuaweiCloud.SDK.Rds.V3
{
    public partial class RdsAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchDeleteInstanceResponse> BatchDeleteInstanceAsync(BatchDeleteInstanceRequest batchDeleteInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDeleteInstanceRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<BatchDeleteInstanceResponse>(response);
        }

        public AsyncInvoker<BatchDeleteInstanceResponse> BatchDeleteInstanceAsyncInvoker(BatchDeleteInstanceRequest batchDeleteInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchDeleteInstanceRequest);
            return new AsyncInvoker<BatchDeleteInstanceResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchDeleteInstanceResponse>);
        }
        ...
        public async Task<BatchExecuteEventsResponse> BatchExecuteEventsAsync(BatchExecuteEventsRequest batchExecuteEventsRequest)
        {
            ...
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchExecuteEventsRequest);
            var response = await DoHttpRequestAsync("POST", request);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<BatchResizeFlavorResponse> BatchResizeFlavorAsync(BatchResizeFlavorRequest batchResizeFlavorRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<BatchResizeFlavorResponse> BatchResizeFlavorAsyncInvoker(BatchResizeFlavorRequest batchResizeFlavorRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/batch/resize", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchResizeFlavorRequest);
            return new AsyncInvoker<BatchResizeFlavorResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchResizeFlavorResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CollectInstanceStatisticResponse> CollectInstanceStatisticAsync(CollectInstanceStatisticRequest collectInstanceStatisticRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CollectInstanceStatisticResponse> CollectInstanceStatisticAsyncInvoker(CollectInstanceStatisticRequest collectInstanceStatisticRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/statistic", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", collectInstanceStatisticRequest);
            return new AsyncInvoker<CollectInstanceStatisticResponse>(this, "GET", request, JsonUtils.DeSerialize<CollectInstanceStatisticResponse>);
        }
        ...
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/difference", urlParam);
        ...
        public AsyncInvoker<CompareConfigurationResponse> CompareConfigurationAsyncInvoker(CompareConfigurationRequest compareConfigurationRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/difference", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", compareConfigurationRequest);
            return new AsyncInvoker<CompareConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<CompareConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateBinlogMergeResponse> CreateBinlogMergeAsync(CreateBinlogMergeRequest createBinlogMergeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateBinlogMergeResponse> CreateBinlogMergeAsyncInvoker(CreateBinlogMergeRequest createBinlogMergeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createBinlogMergeRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/packlog", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createBinlogMergeRequest);
            return new AsyncInvoker<CreateBinlogMergeResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateBinlogMergeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDiskSpaceDiagnosisResponse> CreateDiskSpaceDiagnosisAsync(CreateDiskSpaceDiagnosisRequest createDiskSpaceDiagnosisRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<CreateDiskSpaceDiagnosisResponse> CreateDiskSpaceDiagnosisAsyncInvoker(CreateDiskSpaceDiagnosisRequest createDiskSpaceDiagnosisRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createDiskSpaceDiagnosisRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/diagnosis/disk", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDiskSpaceDiagnosisRequest);
            return new AsyncInvoker<CreateDiskSpaceDiagnosisResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDiskSpaceDiagnosisResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateDrsJobTaskResponse> CreateDrsJobTaskAsync(CreateDrsJobTaskRequest createDrsJobTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createDrsJobTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/drs-job/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDrsJobTaskRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CreateDrsJobTaskResponse>(response);
        }

        public AsyncInvoker<CreateDrsJobTaskResponse> CreateDrsJobTaskAsyncInvoker(CreateDrsJobTaskRequest createDrsJobTaskRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createDrsJobTaskRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/drs-job/create", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDrsJobTaskRequest);
            return new AsyncInvoker<CreateDrsJobTaskResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDrsJobTaskResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateRebuildSlaveResponse> CreateRebuildSlaveAsync(CreateRebuildSlaveRequest createRebuildSlaveRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createRebuildSlaveRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/rebuild", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createRebuildSlaveRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<CreateRebuildSlaveResponse>(response);
        }

        public AsyncInvoker<CreateRebuildSlaveResponse> CreateRebuildSlaveAsyncInvoker(CreateRebuildSlaveRequest createRebuildSlaveRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createRebuildSlaveRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/rebuild", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createRebuildSlaveRequest);
            return new AsyncInvoker<CreateRebuildSlaveResponse>(this, "PUT", request, JsonUtils.DeSerialize<CreateRebuildSlaveResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteBackupSelectionResponse> DeleteBackupSelectionAsync(DeleteBackupSelectionRequest deleteBackupSelectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteBackupSelectionResponse> DeleteBackupSelectionAsyncInvoker(DeleteBackupSelectionRequest deleteBackupSelectionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteBackupSelectionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/delete-selection", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteBackupSelectionRequest);
            return new AsyncInvoker<DeleteBackupSelectionResponse>(this, "POST", request, JsonUtils.DeSerialize<DeleteBackupSelectionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteBinlogMergeResponse> DeleteBinlogMergeAsync(DeleteBinlogMergeRequest deleteBinlogMergeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeleteBinlogMergeResponse> DeleteBinlogMergeAsyncInvoker(DeleteBinlogMergeRequest deleteBinlogMergeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteBinlogMergeRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/packlog", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteBinlogMergeRequest);
            return new AsyncInvoker<DeleteBinlogMergeResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteBinlogMergeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<GetInstancesOpsMetricNamesResponse> GetInstancesOpsMetricNamesAsync(GetInstancesOpsMetricNamesRequest getInstancesOpsMetricNamesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<GetInstancesOpsMetricNamesResponse> GetInstancesOpsMetricNamesAsyncInvoker(GetInstancesOpsMetricNamesRequest getInstancesOpsMetricNamesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getInstancesOpsMetricNamesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/metric-names", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getInstancesOpsMetricNamesRequest);
            return new AsyncInvoker<GetInstancesOpsMetricNamesResponse>(this, "GET", request, JsonUtils.DeSerialize<GetInstancesOpsMetricNamesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListComputeResourceResponse> ListComputeResourceAsync(ListComputeResourceRequest listComputeResourceRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListComputeResourceResponse> ListComputeResourceAsyncInvoker(ListComputeResourceRequest listComputeResourceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/resource-package", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listComputeResourceRequest);
            return new AsyncInvoker<ListComputeResourceResponse>(this, "GET", request, JsonUtils.DeSerialize<ListComputeResourceResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListHistorySessionsResponse> ListHistorySessionsAsync(ListHistorySessionsRequest listHistorySessionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistorySessionsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistorySessionsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListHistorySessionsResponse>(response);
        }

        public AsyncInvoker<ListHistorySessionsResponse> ListHistorySessionsAsyncInvoker(ListHistorySessionsRequest listHistorySessionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistorySessionsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistorySessionsRequest);
            return new AsyncInvoker<ListHistorySessionsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHistorySessionsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListHistoryTopSqlsResponse> ListHistoryTopSqlsAsync(ListHistoryTopSqlsRequest listHistoryTopSqlsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistoryTopSqlsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-top-sql", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistoryTopSqlsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListHistoryTopSqlsResponse>(response);
        }

        public AsyncInvoker<ListHistoryTopSqlsResponse> ListHistoryTopSqlsAsyncInvoker(ListHistoryTopSqlsRequest listHistoryTopSqlsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistoryTopSqlsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-top-sql", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistoryTopSqlsRequest);
            return new AsyncInvoker<ListHistoryTopSqlsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHistoryTopSqlsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListHistoryWaitEventsResponse> ListHistoryWaitEventsAsync(ListHistoryWaitEventsRequest listHistoryWaitEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistoryWaitEventsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-wait-event", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistoryWaitEventsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListHistoryWaitEventsResponse>(response);
        }

        public AsyncInvoker<ListHistoryWaitEventsResponse> ListHistoryWaitEventsAsyncInvoker(ListHistoryWaitEventsRequest listHistoryWaitEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listHistoryWaitEventsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-wait-event", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHistoryWaitEventsRequest);
            return new AsyncInvoker<ListHistoryWaitEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHistoryWaitEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListInstancesResourceMetricsResponse> ListInstancesResourceMetricsAsync(ListInstancesResourceMetricsRequest listInstancesResourceMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListInstancesResourceMetricsResponse> ListInstancesResourceMetricsAsyncInvoker(ListInstancesResourceMetricsRequest listInstancesResourceMetricsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/resource-monitoring", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInstancesResourceMetricsRequest);
            return new AsyncInvoker<ListInstancesResourceMetricsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInstancesResourceMetricsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListOperateRecordResponse> ListOperateRecordAsync(ListOperateRecordRequest listOperateRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListOperateRecordResponse> ListOperateRecordAsyncInvoker(ListOperateRecordRequest listOperateRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listOperateRecordRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/operate-record", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOperateRecordRequest);
            return new AsyncInvoker<ListOperateRecordResponse>(this, "POST", request, JsonUtils.DeSerialize<ListOperateRecordResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListPackLogInfosResponse> ListPackLogInfosAsync(ListPackLogInfosRequest listPackLogInfosRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPackLogInfosRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/packlog/infos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPackLogInfosRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListPackLogInfosResponse>(response);
        }

        public AsyncInvoker<ListPackLogInfosResponse> ListPackLogInfosAsyncInvoker(ListPackLogInfosRequest listPackLogInfosRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPackLogInfosRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/packlog/infos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPackLogInfosRequest);
            return new AsyncInvoker<ListPackLogInfosResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPackLogInfosResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListRetainBackupsResponse> ListRetainBackupsAsync(ListRetainBackupsRequest listRetainBackupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListRetainBackupsResponse> ListRetainBackupsAsyncInvoker(ListRetainBackupsRequest listRetainBackupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listRetainBackupsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/retain-backups", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listRetainBackupsRequest);
            return new AsyncInvoker<ListRetainBackupsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListRetainBackupsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListScheduleEventsResponse> ListScheduleEventsAsync(ListScheduleEventsRequest listScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listScheduleEventsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListScheduleEventsResponse>(response);
        }

        public AsyncInvoker<ListScheduleEventsResponse> ListScheduleEventsAsyncInvoker(ListScheduleEventsRequest listScheduleEventsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/schedule-events", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listScheduleEventsRequest);
            return new AsyncInvoker<ListScheduleEventsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListScheduleEventsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListSmallVersionResponse> ListSmallVersionAsync(ListSmallVersionRequest listSmallVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListSmallVersionResponse> ListSmallVersionAsyncInvoker(ListSmallVersionRequest listSmallVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSmallVersionRequest.DatabaseName, out var valueOfDatabaseName)) urlParam.Add("database_name", valueOfDatabaseName);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/datastores/{database_name}/small-version", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyNewBackupEncryptResponse> ModifyNewBackupEncryptAsync(ModifyNewBackupEncryptRequest modifyNewBackupEncryptRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ModifyNewBackupEncryptResponse> ModifyNewBackupEncryptAsyncInvoker(ModifyNewBackupEncryptRequest modifyNewBackupEncryptRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyNewBackupEncryptRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/encryption", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyNewBackupEncryptRequest);
            return new AsyncInvoker<ModifyNewBackupEncryptResponse>(this, "POST", request, JsonUtils.DeSerialize<ModifyNewBackupEncryptResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<QueryNewBackupEncryptionResponse> QueryNewBackupEncryptionAsync(QueryNewBackupEncryptionRequest queryNewBackupEncryptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<QueryNewBackupEncryptionResponse> QueryNewBackupEncryptionAsyncInvoker(QueryNewBackupEncryptionRequest queryNewBackupEncryptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(queryNewBackupEncryptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/encryption", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", queryNewBackupEncryptionRequest);
            return new AsyncInvoker<QueryNewBackupEncryptionResponse>(this, "GET", request, JsonUtils.DeSerialize<QueryNewBackupEncryptionResponse>);
        }
        ...
        public async Task<ResetConfigurationResponse> ResetConfigurationAsync(ResetConfigurationRequest resetConfigurationRequest)
        {
            ...
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<ResetConfigurationResponse>(response);
        }
        ...
        public AsyncInvoker<ResetConfigurationResponse> ResetConfigurationAsyncInvoker(ResetConfigurationRequest resetConfigurationRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/configurations/{config_id}/reset", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", resetConfigurationRequest);
            return new AsyncInvoker<ResetConfigurationResponse>(this, "PUT", request, JsonUtils.DeSerialize<ResetConfigurationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SetBackupRetainPolicyResponse> SetBackupRetainPolicyAsync(SetBackupRetainPolicyRequest setBackupRetainPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<SetBackupRetainPolicyResponse> SetBackupRetainPolicyAsyncInvoker(SetBackupRetainPolicyRequest setBackupRetainPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backup-retain-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", setBackupRetainPolicyRequest);
            return new AsyncInvoker<SetBackupRetainPolicyResponse>(this, "PUT", request, JsonUtils.DeSerialize<SetBackupRetainPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowAvailableBuildDrInstanceResponse> ShowAvailableBuildDrInstanceAsync(ShowAvailableBuildDrInstanceRequest showAvailableBuildDrInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            ...
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowAvailableBuildDrInstanceResponse>(response);
        }

        public AsyncInvoker<ShowAvailableBuildDrInstanceResponse> ShowAvailableBuildDrInstanceAsyncInvoker(ShowAvailableBuildDrInstanceRequest showAvailableBuildDrInstanceRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/disaster-recovery-instance", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAvailableBuildDrInstanceRequest);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowBackupRetainPolicyResponse> ShowBackupRetainPolicyAsync(ShowBackupRetainPolicyRequest showBackupRetainPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backup-retain-policy", urlParam);
        ...
        public AsyncInvoker<ShowBackupRetainPolicyResponse> ShowBackupRetainPolicyAsyncInvoker(ShowBackupRetainPolicyRequest showBackupRetainPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backup-retain-policy", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupRetainPolicyRequest);
            return new AsyncInvoker<ShowBackupRetainPolicyResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowBackupRetainPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowBackupUsageAlarmConfigResponse> ShowBackupUsageAlarmConfigAsync(ShowBackupUsageAlarmConfigRequest showBackupUsageAlarmConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowBackupUsageAlarmConfigResponse> ShowBackupUsageAlarmConfigAsyncInvoker(ShowBackupUsageAlarmConfigRequest showBackupUsageAlarmConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/usage-alarm-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupUsageAlarmConfigRequest);
            return new AsyncInvoker<ShowBackupUsageAlarmConfigResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowBackupUsageAlarmConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowBackupUsageExceededInstancesResponse> ShowBackupUsageExceededInstancesAsync(ShowBackupUsageExceededInstancesRequest showBackupUsageExceededInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowBackupUsageExceededInstancesResponse> ShowBackupUsageExceededInstancesAsyncInvoker(ShowBackupUsageExceededInstancesRequest showBackupUsageExceededInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/usage-alarm/exceeded-instances", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showBackupUsageExceededInstancesRequest);
            return new AsyncInvoker<ShowBackupUsageExceededInstancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowBackupUsageExceededInstancesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowDrsJobNameResponse> ShowDrsJobNameAsync(ShowDrsJobNameRequest showDrsJobNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDrsJobNameRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/drs-job/name", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDrsJobNameRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowDrsJobNameResponse>(response);
        }

        public AsyncInvoker<ShowDrsJobNameResponse> ShowDrsJobNameAsyncInvoker(ShowDrsJobNameRequest showDrsJobNameRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDrsJobNameRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/drs-job/name", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDrsJobNameRequest);
            return new AsyncInvoker<ShowDrsJobNameResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDrsJobNameResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowHistorySessionAnalyseDownloadInfoResponse> ShowHistorySessionAnalyseDownloadInfoAsync(ShowHistorySessionAnalyseDownloadInfoRequest showHistorySessionAnalyseDownloadInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHistorySessionAnalyseDownloadInfoRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHistorySessionAnalyseDownloadInfoRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowHistorySessionAnalyseDownloadInfoResponse>(response);
        }

        public AsyncInvoker<ShowHistorySessionAnalyseDownloadInfoResponse> ShowHistorySessionAnalyseDownloadInfoAsyncInvoker(ShowHistorySessionAnalyseDownloadInfoRequest showHistorySessionAnalyseDownloadInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHistorySessionAnalyseDownloadInfoRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHistorySessionAnalyseDownloadInfoRequest);
            return new AsyncInvoker<ShowHistorySessionAnalyseDownloadInfoResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHistorySessionAnalyseDownloadInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowHotClodSeparationStatusResponse> ShowHotClodSeparationStatusAsync(ShowHotClodSeparationStatusRequest showHotClodSeparationStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHotClodSeparationStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/hot-cold-separation/status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHotClodSeparationStatusRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowHotClodSeparationStatusResponse>(response);
        }

        public AsyncInvoker<ShowHotClodSeparationStatusResponse> ShowHotClodSeparationStatusAsyncInvoker(ShowHotClodSeparationStatusRequest showHotClodSeparationStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showHotClodSeparationStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/hot-cold-separation/status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHotClodSeparationStatusRequest);
            return new AsyncInvoker<ShowHotClodSeparationStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHotClodSeparationStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowRebuildSlaveStatusResponse> ShowRebuildSlaveStatusAsync(ShowRebuildSlaveStatusRequest showRebuildSlaveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRebuildSlaveStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/rebuild", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRebuildSlaveStatusRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowRebuildSlaveStatusResponse>(response);
        }

        public AsyncInvoker<ShowRebuildSlaveStatusResponse> ShowRebuildSlaveStatusAsyncInvoker(ShowRebuildSlaveStatusRequest showRebuildSlaveStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showRebuildSlaveStatusRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/rebuild", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRebuildSlaveStatusRequest);
            return new AsyncInvoker<ShowRebuildSlaveStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRebuildSlaveStatusResponse>);
        }
        ...
        public AsyncInvoker<ShowRestoreTablesResponse> ShowRestoreTablesAsyncInvoker(ShowRestoreTablesRequest showRestoreTablesRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/get-restore-tables", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRestoreTablesRequest);
            return new AsyncInvoker<ShowRestoreTablesResponse>(this, "POST", request, JsonUtils.DeSerialize<ShowRestoreTablesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowTopObjectsResponse> ShowTopObjectsAsync(ShowTopObjectsRequest showTopObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTopObjectsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/top/objects", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTopObjectsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowTopObjectsResponse>(response);
        }

        public AsyncInvoker<ShowTopObjectsResponse> ShowTopObjectsAsyncInvoker(ShowTopObjectsRequest showTopObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showTopObjectsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/top/objects", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showTopObjectsRequest);
            return new AsyncInvoker<ShowTopObjectsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowTopObjectsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateBackupUsageAlarmConfigResponse> UpdateBackupUsageAlarmConfigAsync(UpdateBackupUsageAlarmConfigRequest updateBackupUsageAlarmConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/usage-alarm-config", urlParam);
        ...
        public AsyncInvoker<UpdateBackupUsageAlarmConfigResponse> UpdateBackupUsageAlarmConfigAsyncInvoker(UpdateBackupUsageAlarmConfigRequest updateBackupUsageAlarmConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/backups/usage-alarm-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateBackupUsageAlarmConfigRequest);
            return new AsyncInvoker<UpdateBackupUsageAlarmConfigResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateBackupUsageAlarmConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateInstanceBackupMethodResponse> UpdateInstanceBackupMethodAsync(UpdateInstanceBackupMethodRequest updateInstanceBackupMethodRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateInstanceBackupMethodResponse> UpdateInstanceBackupMethodAsyncInvoker(UpdateInstanceBackupMethodRequest updateInstanceBackupMethodRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateInstanceBackupMethodRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/backups/method", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateInstanceBackupMethodRequest);
            return new AsyncInvoker<UpdateInstanceBackupMethodResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateInstanceBackupMethodResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdateTimeZoneResponse> UpdateTimeZoneAsync(UpdateTimeZoneRequest updateTimeZoneRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdateTimeZoneResponse> UpdateTimeZoneAsyncInvoker(UpdateTimeZoneRequest updateTimeZoneRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateTimeZoneRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/timezone/modify", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateTimeZoneRequest);
            return new AsyncInvoker<UpdateTimeZoneResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateTimeZoneResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UploadHistorySessionAnalyaseResponse> UploadHistorySessionAnalyaseAsync(UploadHistorySessionAnalyaseRequest uploadHistorySessionAnalyaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(uploadHistorySessionAnalyaseRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", uploadHistorySessionAnalyaseRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<UploadHistorySessionAnalyaseResponse>(response);
        }

        public AsyncInvoker<UploadHistorySessionAnalyaseResponse> UploadHistorySessionAnalyaseAsyncInvoker(UploadHistorySessionAnalyaseRequest uploadHistorySessionAnalyaseRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(uploadHistorySessionAnalyaseRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/history-session-analyse-upload", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", uploadHistorySessionAnalyaseRequest);
            return new AsyncInvoker<UploadHistorySessionAnalyaseResponse>(this, "POST", request, JsonUtils.DeSerialize<UploadHistorySessionAnalyaseResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowMsdtcLocalHostResponse> ShowMsdtcLocalHostAsync(ShowMsdtcLocalHostRequest showMsdtcLocalHostRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showMsdtcLocalHostRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/msdtc/local-host", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showMsdtcLocalHostRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowMsdtcLocalHostResponse>(response);
        }

        public AsyncInvoker<ShowMsdtcLocalHostResponse> ShowMsdtcLocalHostAsyncInvoker(ShowMsdtcLocalHostRequest showMsdtcLocalHostRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showMsdtcLocalHostRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/msdtc/local-host", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showMsdtcLocalHostRequest);
            return new AsyncInvoker<ShowMsdtcLocalHostResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowMsdtcLocalHostResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListInstanceAllProxyVersionResponse> ListInstanceAllProxyVersionAsync(ListInstanceAllProxyVersionRequest listInstanceAllProxyVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListInstanceAllProxyVersionResponse> ListInstanceAllProxyVersionAsyncInvoker(ListInstanceAllProxyVersionRequest listInstanceAllProxyVersionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInstanceAllProxyVersionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/proxy/engine-version", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInstanceAllProxyVersionRequest);
            return new AsyncInvoker<ListInstanceAllProxyVersionResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInstanceAllProxyVersionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowMySqlProxySlowLogListResponse> ShowMySqlProxySlowLogListAsync(ShowMySqlProxySlowLogListRequest showMySqlProxySlowLogListRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowMySqlProxySlowLogListResponse> ShowMySqlProxySlowLogListAsyncInvoker(ShowMySqlProxySlowLogListRequest showMySqlProxySlowLogListRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showMySqlProxySlowLogListRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(showMySqlProxySlowLogListRequest.ProxyId, out var valueOfProxyId)) urlParam.Add("proxy_id", valueOfProxyId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/proxy/{proxy_id}/slow-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showMySqlProxySlowLogListRequest);
            return new AsyncInvoker<ShowMySqlProxySlowLogListResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowMySqlProxySlowLogListResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SwitchMySqlProxySlowLogResponse> SwitchMySqlProxySlowLogAsync(SwitchMySqlProxySlowLogRequest switchMySqlProxySlowLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<SwitchMySqlProxySlowLogResponse> SwitchMySqlProxySlowLogAsyncInvoker(SwitchMySqlProxySlowLogRequest switchMySqlProxySlowLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(switchMySqlProxySlowLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(switchMySqlProxySlowLogRequest.ProxyId, out var valueOfProxyId)) urlParam.Add("proxy_id", valueOfProxyId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/proxy/{proxy_id}/slow-log", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", switchMySqlProxySlowLogRequest);
            return new AsyncInvoker<SwitchMySqlProxySlowLogResponse>(this, "PUT", request, JsonUtils.DeSerialize<SwitchMySqlProxySlowLogResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<GetInstancesNoIndexTablesResponse> GetInstancesNoIndexTablesAsync(GetInstancesNoIndexTablesRequest getInstancesNoIndexTablesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<GetInstancesOpsResourceUsageResponse> GetInstancesOpsResourceUsageAsync(GetInstancesOpsResourceUsageRequest getInstancesOpsResourceUsageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<GetInstancesOpsResourceUsageResponse> GetInstancesOpsResourceUsageAsyncInvoker(GetInstancesOpsResourceUsageRequest getInstancesOpsResourceUsageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getInstancesOpsResourceUsageRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/resource-usage", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getInstancesOpsResourceUsageRequest);
            return new AsyncInvoker<GetInstancesOpsResourceUsageResponse>(this, "GET", request, JsonUtils.DeSerialize<GetInstancesOpsResourceUsageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<QueryAutoSqlLimitingResponse> QueryAutoSqlLimitingAsync(QueryAutoSqlLimitingRequest queryAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<QueryAutoSqlLimitingResponse> QueryAutoSqlLimitingAsyncInvoker(QueryAutoSqlLimitingRequest queryAutoSqlLimitingRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(queryAutoSqlLimitingRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/ops/auto-sql-limiting", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", queryAutoSqlLimitingRequest);
            return new AsyncInvoker<QueryAutoSqlLimitingResponse>(this, "GET", request, JsonUtils.DeSerialize<QueryAutoSqlLimitingResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RotateAuditLogResponse> RotateAuditLogAsync(RotateAuditLogRequest rotateAuditLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(rotateAuditLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            ...
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<RotateAuditLogResponse>(response);
        }

        public AsyncInvoker<RotateAuditLogResponse> RotateAuditLogAsyncInvoker(RotateAuditLogRequest rotateAuditLogRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(rotateAuditLogRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/auditlog-rotate", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", rotateAuditLogRequest);
            return new AsyncInvoker<RotateAuditLogResponse>(this, "POST", request, JsonUtils.DeSerialize<RotateAuditLogResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowAgencyPolicyResponse> ShowAgencyPolicyAsync(ShowAgencyPolicyRequest showAgencyPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowAgencyPolicyResponse> ShowAgencyPolicyAsyncInvoker(ShowAgencyPolicyRequest showAgencyPolicyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showAgencyPolicyRequest.AgencyName, out var valueOfAgencyName)) urlParam.Add("agency_name", valueOfAgencyName);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/agency/{agency_name}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAgencyPolicyRequest);
            return new AsyncInvoker<ShowAgencyPolicyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAgencyPolicyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowAutoCesAlarmResponse> ShowAutoCesAlarmAsync(ShowAutoCesAlarmRequest showAutoCesAlarmRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/auto-ces-alarm", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoCesAlarmRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ShowAutoCesAlarmResponse>(response);
        }

        public AsyncInvoker<ShowAutoCesAlarmResponse> ShowAutoCesAlarmAsyncInvoker(ShowAutoCesAlarmRequest showAutoCesAlarmRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/auto-ces-alarm", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAutoCesAlarmRequest);
            return new AsyncInvoker<ShowAutoCesAlarmResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAutoCesAlarmResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowDiskSpaceDiagnosisResponse> ShowDiskSpaceDiagnosisAsync(ShowDiskSpaceDiagnosisRequest showDiskSpaceDiagnosisRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowDiskSpaceDiagnosisResponse> ShowDiskSpaceDiagnosisAsyncInvoker(ShowDiskSpaceDiagnosisRequest showDiskSpaceDiagnosisRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showDiskSpaceDiagnosisRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/diagnosis/disk", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDiskSpaceDiagnosisRequest);
            return new AsyncInvoker<ShowDiskSpaceDiagnosisResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDiskSpaceDiagnosisResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowSqlDiagnosisResponse> ShowSqlDiagnosisAsync(ShowSqlDiagnosisRequest showSqlDiagnosisRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowSqlDiagnosisResponse> ShowSqlDiagnosisAsyncInvoker(ShowSqlDiagnosisRequest showSqlDiagnosisRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSqlDiagnosisRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/diagnosis/sql", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSqlDiagnosisRequest);
            return new AsyncInvoker<ShowSqlDiagnosisResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSqlDiagnosisResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<CreateJobScheduleResponse> CreateJobScheduleAsync(CreateJobScheduleRequest createJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createJobScheduleRequest);
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<CreateJobScheduleResponse>(response);
        }

        public AsyncInvoker<CreateJobScheduleResponse> CreateJobScheduleAsyncInvoker(CreateJobScheduleRequest createJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createJobScheduleRequest);
            return new AsyncInvoker<CreateJobScheduleResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateJobScheduleResponse>);
        }
        ...
        public AsyncInvoker<CreateSubscriptionResponse> CreateSubscriptionAsyncInvoker(CreateSubscriptionRequest createSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createSubscriptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/subscriptions", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeleteJobScheduleResponse> DeleteJobScheduleAsync(DeleteJobScheduleRequest deleteJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteJobScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteJobScheduleRequest);
            var response = await DoHttpRequestAsync("DELETE", request);
            return JsonUtils.DeSerialize<DeleteJobScheduleResponse>(response);
        }

        public AsyncInvoker<DeleteJobScheduleResponse> DeleteJobScheduleAsyncInvoker(DeleteJobScheduleRequest deleteJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteJobScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteJobScheduleRequest);
            return new AsyncInvoker<DeleteJobScheduleResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeleteJobScheduleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<DeletePublicationResponse> DeletePublicationAsync(DeletePublicationRequest deletePublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<DeletePublicationResponse> DeletePublicationAsyncInvoker(DeletePublicationRequest deletePublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deletePublicationRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deletePublicationRequest);
            return new AsyncInvoker<DeletePublicationResponse>(this, "DELETE", request, JsonUtils.DeSerialize<DeletePublicationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDbAgentJobHistoryStepsResponse> ListDbAgentJobHistoryStepsAsync(ListDbAgentJobHistoryStepsRequest listDbAgentJobHistoryStepsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistoryStepsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistoryStepsRequest.HistoryId, out var valueOfHistoryId)) urlParam.Add("history_id", valueOfHistoryId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/histories/{history_id}/steps", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobHistoryStepsRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListDbAgentJobHistoryStepsResponse>(response);
        }

        public AsyncInvoker<ListDbAgentJobHistoryStepsResponse> ListDbAgentJobHistoryStepsAsyncInvoker(ListDbAgentJobHistoryStepsRequest listDbAgentJobHistoryStepsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistoryStepsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistoryStepsRequest.HistoryId, out var valueOfHistoryId)) urlParam.Add("history_id", valueOfHistoryId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/histories/{history_id}/steps", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobHistoryStepsRequest);
            return new AsyncInvoker<ListDbAgentJobHistoryStepsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDbAgentJobHistoryStepsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDbAgentJobHistorysResponse> ListDbAgentJobHistorysAsync(ListDbAgentJobHistorysRequest listDbAgentJobHistorysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistorysRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistorysRequest.JobId, out var valueOfJobId)) urlParam.Add("job_id", valueOfJobId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/histories", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobHistorysRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListDbAgentJobHistorysResponse>(response);
        }

        public AsyncInvoker<ListDbAgentJobHistorysResponse> ListDbAgentJobHistorysAsyncInvoker(ListDbAgentJobHistorysRequest listDbAgentJobHistorysRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistorysRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(listDbAgentJobHistorysRequest.JobId, out var valueOfJobId)) urlParam.Add("job_id", valueOfJobId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/histories", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDbAgentJobHistorysRequest);
            return new AsyncInvoker<ListDbAgentJobHistorysResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDbAgentJobHistorysResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDistributionResponse> ListDistributionAsync(ListDistributionRequest listDistributionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListDistributionResponse> ListDistributionAsyncInvoker(ListDistributionRequest listDistributionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDistributionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/distribution", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDistributionRequest);
            return new AsyncInvoker<ListDistributionResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDistributionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListDistributorInstancesResponse> ListDistributorInstancesAsync(ListDistributorInstancesRequest listDistributorInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListDistributorInstancesResponse> ListDistributorInstancesAsyncInvoker(ListDistributorInstancesRequest listDistributorInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listDistributorInstancesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/distributors", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDistributorInstancesRequest);
            return new AsyncInvoker<ListDistributorInstancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDistributorInstancesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListJobSchedulesResponse> ListJobSchedulesAsync(ListJobSchedulesRequest listJobSchedulesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listJobSchedulesRequest);
            var response = await DoHttpRequestAsync("GET", request);
            return JsonUtils.DeSerialize<ListJobSchedulesResponse>(response);
        }

        public AsyncInvoker<ListJobSchedulesResponse> ListJobSchedulesAsyncInvoker(ListJobSchedulesRequest listJobSchedulesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listJobSchedulesRequest);
            return new AsyncInvoker<ListJobSchedulesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListJobSchedulesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListPublicationsResponse> ListPublicationsAsync(ListPublicationsRequest listPublicationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListPublicationsResponse> ListPublicationsAsyncInvoker(ListPublicationsRequest listPublicationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listPublicationsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPublicationsRequest);
            return new AsyncInvoker<ListPublicationsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPublicationsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListSubscriberInstancesResponse> ListSubscriberInstancesAsync(ListSubscriberInstancesRequest listSubscriberInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListSubscriberInstancesResponse> ListSubscriberInstancesAsyncInvoker(ListSubscriberInstancesRequest listSubscriberInstancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSubscriberInstancesRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/subscribers", urlParam);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyJobScheduleResponse> ModifyJobScheduleAsync(ModifyJobScheduleRequest modifyJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyJobScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyJobScheduleRequest);
            var response = await DoHttpRequestAsync("PUT", request);
            return JsonUtils.DeSerialize<ModifyJobScheduleResponse>(response);
        }

        public AsyncInvoker<ModifyJobScheduleResponse> ModifyJobScheduleAsyncInvoker(ModifyJobScheduleRequest modifyJobScheduleRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyJobScheduleRequest.ScheduleId, out var valueOfScheduleId)) urlParam.Add("schedule_id", valueOfScheduleId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/db-job/schedules/{schedule_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyJobScheduleRequest);
            return new AsyncInvoker<ModifyJobScheduleResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyJobScheduleResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ModifyPublicationResponse> ModifyPublicationAsync(ModifyPublicationRequest modifyPublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ModifyPublicationResponse> ModifyPublicationAsyncInvoker(ModifyPublicationRequest modifyPublicationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(modifyPublicationRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(modifyPublicationRequest.PublicationId, out var valueOfPublicationId)) urlParam.Add("publication_id", valueOfPublicationId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications/{publication_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", modifyPublicationRequest);
            return new AsyncInvoker<ModifyPublicationResponse>(this, "PUT", request, JsonUtils.DeSerialize<ModifyPublicationResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RefreshPublicationSnapshotResponse> RefreshPublicationSnapshotAsync(RefreshPublicationSnapshotRequest refreshPublicationSnapshotRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(refreshPublicationSnapshotRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
        ...
        public AsyncInvoker<RefreshPublicationSnapshotResponse> RefreshPublicationSnapshotAsyncInvoker(RefreshPublicationSnapshotRequest refreshPublicationSnapshotRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(refreshPublicationSnapshotRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(refreshPublicationSnapshotRequest.PublicationId, out var valueOfPublicationId)) urlParam.Add("publication_id", valueOfPublicationId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/publications/{publication_id}/reinitialize", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", refreshPublicationSnapshotRequest);
            return new AsyncInvoker<RefreshPublicationSnapshotResponse>(this, "POST", request, JsonUtils.DeSerialize<RefreshPublicationSnapshotResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<RefreshSubscriptionResponse> RefreshSubscriptionAsync(RefreshSubscriptionRequest refreshSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(refreshSubscriptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
        ...
        public AsyncInvoker<RefreshSubscriptionResponse> RefreshSubscriptionAsyncInvoker(RefreshSubscriptionRequest refreshSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(refreshSubscriptionRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            if (StringUtils.TryConvertToNonEmptyString(refreshSubscriptionRequest.SubscriptionId, out var valueOfSubscriptionId)) urlParam.Add("subscription_id", valueOfSubscriptionId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/subscriptions/{subscription_id}/reinitialize", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", refreshSubscriptionRequest);
            return new AsyncInvoker<RefreshSubscriptionResponse>(this, "POST", request, JsonUtils.DeSerialize<RefreshSubscriptionResponse>);
        }
        ...
        public async Task<RestartDbAgentJobResponse> RestartDbAgentJobAsync(RestartDbAgentJobRequest restartDbAgentJobRequest)
        {
            ...
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<RestartDbAgentJobResponse>(response);
        }
        ...
        public AsyncInvoker<RestartDbAgentJobResponse> RestartDbAgentJobAsyncInvoker(RestartDbAgentJobRequest restartDbAgentJobRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/restart", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", restartDbAgentJobRequest);
            return new AsyncInvoker<RestartDbAgentJobResponse>(this, "POST", request, JsonUtils.DeSerialize<RestartDbAgentJobResponse>);
        }
        ...
        public async Task<SwitchDbAgentJobResponse> SwitchDbAgentJobAsync(SwitchDbAgentJobRequest switchDbAgentJobRequest)
        {
            ...
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<SwitchDbAgentJobResponse>(response);
        }
        ...
        public AsyncInvoker<SwitchDbAgentJobResponse> SwitchDbAgentJobAsyncInvoker(SwitchDbAgentJobRequest switchDbAgentJobRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/db-jobs/{job_id}/switch", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", switchDbAgentJobRequest);
            return new AsyncInvoker<SwitchDbAgentJobResponse>(this, "POST", request, JsonUtils.DeSerialize<SwitchDbAgentJobResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<SyncReplicationMetadataResponse> SyncReplicationMetadataAsync(SyncReplicationMetadataRequest syncReplicationMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(syncReplicationMetadataRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            ...
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<SyncReplicationMetadataResponse>(response);
        }

        public AsyncInvoker<SyncReplicationMetadataResponse> SyncReplicationMetadataAsyncInvoker(SyncReplicationMetadataRequest syncReplicationMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(syncReplicationMetadataRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/metadata/sync", urlParam);
        ...
        public async Task<ValidateInstanceConnectionResponse> ValidateInstanceConnectionAsync(ValidateInstanceConnectionRequest validateInstanceConnectionRequest)
        {
            ...
            var response = await DoHttpRequestAsync("POST", request);
            return JsonUtils.DeSerialize<ValidateInstanceConnectionResponse>(response);
        }
        ...
        public AsyncInvoker<ValidateInstanceConnectionResponse> ValidateInstanceConnectionAsyncInvoker(ValidateInstanceConnectionRequest validateInstanceConnectionRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/replication/login-test", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", validateInstanceConnectionRequest);
            return new AsyncInvoker<ValidateInstanceConnectionResponse>(this, "POST", request, JsonUtils.DeSerialize<ValidateInstanceConnectionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<GetAvailableVpcsResponse> GetAvailableVpcsAsync(GetAvailableVpcsRequest getAvailableVpcsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<GetAvailableVpcsResponse> GetAvailableVpcsAsyncInvoker(GetAvailableVpcsRequest getAvailableVpcsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(getAvailableVpcsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/instances/{instance_id}/available-vpcs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", getAvailableVpcsRequest);
            return new AsyncInvoker<GetAvailableVpcsResponse>(this, "GET", request, JsonUtils.DeSerialize<GetAvailableVpcsResponse>);
        }

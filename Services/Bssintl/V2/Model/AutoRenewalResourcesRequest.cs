...
namespace HuaweiCloud.SDK.Bssintl.V2.Model
{
    ...
    public class AutoRenewalResourcesRequest 
    {
        ...
        public AutoRenewalResourcesReq Body { get; set; }
        ...
        {
            return this.Equals(input as AutoRenewalResourcesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AutoRenewalResourcesRequest input)
        {

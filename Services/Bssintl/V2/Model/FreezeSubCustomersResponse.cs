...
namespace HuaweiCloud.SDK.Bssintl.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class FreezeSubCustomersResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as FreezeSubCustomersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(FreezeSubCustomersResponse input)
        {

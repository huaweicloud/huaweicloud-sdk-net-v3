...
namespace HuaweiCloud.SDK.Bssintl.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateSubCustomerResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateSubCustomerResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSubCustomerResponse input)
        {

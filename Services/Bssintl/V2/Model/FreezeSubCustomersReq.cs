...
namespace HuaweiCloud.SDK.Bssintl.V2.Model
{
    ...
    public class FreezeSubCustomersReq 
    {
        ...
        /// </summary>
        /// <value>|参数名称：冻结类型| |参数的约束及描述：该参数非必填，冻结类型，支持枚举| |ACCOUNT：冻结账号，ACCOUNT_AND_RESOURCE：冻结账号与资源|</value>
        [JsonConverter(typeof(EnumClassConverter<FreezeTypeEnum>))]
        public class FreezeTypeEnum
        {
            /// <summary>
            /// Enum ACCOUNT for value: ACCOUNT
            /// </summary>
            public static readonly FreezeTypeEnum ACCOUNT = new FreezeTypeEnum("ACCOUNT");

            /// <summary>
            /// Enum ACCOUNT_AND_RESOURCE for value: ACCOUNT_AND_RESOURCE
            /// </summary>
            public static readonly FreezeTypeEnum ACCOUNT_AND_RESOURCE = new FreezeTypeEnum("ACCOUNT_AND_RESOURCE");

            private static readonly Dictionary<string, FreezeTypeEnum> StaticFields =
            new Dictionary<string, FreezeTypeEnum>()
            {
                { "ACCOUNT", ACCOUNT },
            ...
            public FreezeTypeEnum()
            {

            }

            public FreezeTypeEnum(string value)
            {
                _value = value;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as FreezeTypeEnum))
                {
                    return true;
                }
            ...
            public bool Equals(FreezeTypeEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(FreezeTypeEnum a, FreezeTypeEnum b)
            {
        ...
        public FreezeTypeEnum FreezeType { get; set; }
        ...
        {
            return this.Equals(input as FreezeSubCustomersReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(FreezeSubCustomersReq input)
        {
            ...
            if (this.FreezeType != input.FreezeType) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.FreezeType.GetHashCode();
                return hashCode;
            }
        }
    }

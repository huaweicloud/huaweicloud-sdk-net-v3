...
{
    public partial class BssintlClient : Client
    {
        public static ClientBuilder<BssintlClient> NewBuilder()
        {
            return new ClientBuilder<BssintlClient>("GlobalCredentials");
        }
        ...
        public SyncInvoker<FreezeSubCustomersResponse> FreezeSubCustomersInvoker(FreezeSubCustomersRequest freezeSubCustomersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/freeze", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", freezeSubCustomersRequest);
            return new SyncInvoker<FreezeSubCustomersResponse>(this, "POST", request, JsonUtils.DeSerialize<FreezeSubCustomersResponse>);
        }
        ...
        public SyncInvoker<ListInvoicesResponse> ListInvoicesInvoker(ListInvoicesRequest listInvoicesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v1.0/{domain_id}/payments/intl-invoices", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInvoicesRequest);
            return new SyncInvoker<ListInvoicesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInvoicesResponse>);
        }
        ...
        public SyncInvoker<ListPostpaidBillSumResponse> ListPostpaidBillSumInvoker(ListPostpaidBillSumRequest listPostpaidBillSumRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/partner-bills/postpaid-bill-summary", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPostpaidBillSumRequest);
            return new SyncInvoker<ListPostpaidBillSumResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPostpaidBillSumResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSubCustomerBudgetResponse ListSubCustomerBudget(ListSubCustomerBudgetRequest listSubCustomerBudgetRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSubCustomerBudgetResponse> ListSubCustomerBudgetInvoker(ListSubCustomerBudgetRequest listSubCustomerBudgetRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/budget/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubCustomerBudgetRequest);
            return new SyncInvoker<ListSubCustomerBudgetResponse>(this, "POST", request, JsonUtils.DeSerialize<ListSubCustomerBudgetResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSubCustomerBudgetRecordsResponse ListSubCustomerBudgetRecords(ListSubCustomerBudgetRecordsRequest listSubCustomerBudgetRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSubCustomerBudgetRecordsResponse> ListSubCustomerBudgetRecordsInvoker(ListSubCustomerBudgetRecordsRequest listSubCustomerBudgetRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/budget/records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubCustomerBudgetRecordsRequest);
            return new SyncInvoker<ListSubCustomerBudgetRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSubCustomerBudgetRecordsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowCustomerExpenditureQuotaResponse ShowCustomerExpenditureQuota(ShowCustomerExpenditureQuotaRequest showCustomerExpenditureQuotaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowCustomerExpenditureQuotaResponse> ShowCustomerExpenditureQuotaInvoker(ShowCustomerExpenditureQuotaRequest showCustomerExpenditureQuotaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/customer-accounts/expenditure-quota", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCustomerExpenditureQuotaRequest);
            return new SyncInvoker<ShowCustomerExpenditureQuotaResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCustomerExpenditureQuotaResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowPartnerConsumptionQuotaResponse ShowPartnerConsumptionQuota(ShowPartnerConsumptionQuotaRequest showPartnerConsumptionQuotaRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowPartnerConsumptionQuotaResponse> ShowPartnerConsumptionQuotaInvoker(ShowPartnerConsumptionQuotaRequest showPartnerConsumptionQuotaRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/credit/consumption-quota", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showPartnerConsumptionQuotaRequest);
            return new SyncInvoker<ShowPartnerConsumptionQuotaResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowPartnerConsumptionQuotaResponse>);
        }
        ...
        public SyncInvoker<ShowSubCustomerBudgetResponse> ShowSubCustomerBudgetInvoker(ShowSubCustomerBudgetRequest showSubCustomerBudgetRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/budget", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSubCustomerBudgetRequest);
            return new SyncInvoker<ShowSubCustomerBudgetResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSubCustomerBudgetResponse>);
        }
        ...
        public SyncInvoker<UnfreezeSubCustomersResponse> UnfreezeSubCustomersInvoker(UnfreezeSubCustomersRequest unfreezeSubCustomersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/unfreeze", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", unfreezeSubCustomersRequest);
            return new SyncInvoker<UnfreezeSubCustomersResponse>(this, "POST", request, JsonUtils.DeSerialize<UnfreezeSubCustomersResponse>);
        }
        ...
        public SyncInvoker<UpdateSubCustomerBudgetResponse> UpdateSubCustomerBudgetInvoker(UpdateSubCustomerBudgetRequest updateSubCustomerBudgetRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/budget", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateSubCustomerBudgetRequest);
            return new SyncInvoker<UpdateSubCustomerBudgetResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UpdateSubCustomerBudgetResponse>);
        }

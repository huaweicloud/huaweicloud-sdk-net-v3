...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ReclaimToPartnerAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ReclaimToPartnerAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ReclaimToPartnerAccountResponse input)
        {

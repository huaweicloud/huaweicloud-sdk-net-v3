...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubCustomerBillDetailResponse : SdkResponse
    {
        ...
        public List<SubCustomerMonthlyBillDetail> FeeRecords { get; set; }
        ...
        {
            return this.Equals(input as ListSubCustomerBillDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubCustomerBillDetailResponse input)
        {

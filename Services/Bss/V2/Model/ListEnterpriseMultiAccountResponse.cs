...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListEnterpriseMultiAccountResponse : SdkResponse
    {
        ...
        public List<RetrieveAmountInfoV2> AmountInfos { get; set; }
        ...
        {
            return this.Equals(input as ListEnterpriseMultiAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListEnterpriseMultiAccountResponse input)
        {

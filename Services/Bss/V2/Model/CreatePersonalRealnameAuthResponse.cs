...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePersonalRealnameAuthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreatePersonalRealnameAuthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePersonalRealnameAuthResponse input)
        {

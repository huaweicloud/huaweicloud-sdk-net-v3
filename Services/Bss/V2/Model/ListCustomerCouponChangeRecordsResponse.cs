...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCustomerCouponChangeRecordsResponse : SdkResponse
    {
        ...
        public List<CustomerCouponChangeRecord> Records { get; set; }
        ...
        {
            return this.Equals(input as ListCustomerCouponChangeRecordsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCustomerCouponChangeRecordsResponse input)
        {

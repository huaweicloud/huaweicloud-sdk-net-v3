...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCustomerAccountChangeRecordsResponse : SdkResponse
    {
        ...
        public List<CustomerAccountChangeRecord> Records { get; set; }
        ...
        {
            return this.Equals(input as ListCustomerAccountChangeRecordsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCustomerAccountChangeRecordsResponse input)
        {

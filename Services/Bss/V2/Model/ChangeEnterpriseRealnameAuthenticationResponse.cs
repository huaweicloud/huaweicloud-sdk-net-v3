...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ChangeEnterpriseRealnameAuthenticationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ChangeEnterpriseRealnameAuthenticationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeEnterpriseRealnameAuthenticationResponse input)
        {

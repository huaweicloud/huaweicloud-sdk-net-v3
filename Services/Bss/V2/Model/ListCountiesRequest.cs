...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    public class ListCountiesRequest 
    {
        ...
        /// 城市的编码。
        /// </summary>
        [SDKProperty("city_code", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListCountiesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCountiesRequest input)
        {
            if (input == null) return false;
            if (this.XLanguage != input.XLanguage || (this.XLanguage != null && !this.XLanguage.Equals(input.XLanguage))) return false;
            if (this.CityCode != input.CityCode || (this.CityCode != null && !this.CityCode.Equals(input.CityCode))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CityCode != null) hashCode = hashCode * 59 + this.CityCode.GetHashCode();

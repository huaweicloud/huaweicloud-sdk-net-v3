...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateCouponQuotasResponse : SdkResponse
    {
        ...
        public List<QuotaSimpleInfo> SimpleQuotaInfos { get; set; }
        ...
        {
            return this.Equals(input as UpdateCouponQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateCouponQuotasResponse input)
        {

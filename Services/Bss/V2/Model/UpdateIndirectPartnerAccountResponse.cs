...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateIndirectPartnerAccountResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateIndirectPartnerAccountResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateIndirectPartnerAccountResponse input)
        {

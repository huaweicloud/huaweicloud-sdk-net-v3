...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RenewalResourcesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RenewalResourcesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RenewalResourcesResponse input)
        {

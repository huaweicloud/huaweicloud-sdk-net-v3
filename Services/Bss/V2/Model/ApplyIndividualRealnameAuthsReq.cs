...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    public class ApplyIndividualRealnameAuthsReq 
    {
        ...
        /// 
        /// </summary>
        [JsonProperty("bank_card_info", NullValueHandling = NullValueHandling.Ignore)]
        public BankCardInfoV2 BankCardInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  bankCardInfo: ").Append(BankCardInfo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ApplyIndividualRealnameAuthsReq input)
        {
            ...
            if (this.BankCardInfo != input.BankCardInfo || (this.BankCardInfo != null && !this.BankCardInfo.Equals(input.BankCardInfo))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BankCardInfo != null) hashCode = hashCode * 59 + this.BankCardInfo.GetHashCode();
                return hashCode;
            }
        }
    }

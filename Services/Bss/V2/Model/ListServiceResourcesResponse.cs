...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListServiceResourcesResponse : SdkResponse
    {
        ...
        public List<ServiceResourceInfo> Infos { get; set; }
        ...
        {
            return this.Equals(input as ListServiceResourcesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListServiceResourcesResponse input)
        {

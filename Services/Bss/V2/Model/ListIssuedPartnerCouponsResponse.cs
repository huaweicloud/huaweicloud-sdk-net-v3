...
namespace HuaweiCloud.SDK.Bss.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListIssuedPartnerCouponsResponse : SdkResponse
    {
        ...
        public List<IQueryUserPartnerCouponsResultV2> UserCoupons { get; set; }
        ...
        {
            return this.Equals(input as ListIssuedPartnerCouponsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListIssuedPartnerCouponsResponse input)
        {

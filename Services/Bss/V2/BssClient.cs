...
{
    public partial class BssClient : Client
    {
        public static ClientBuilder<BssClient> NewBuilder()
        {
            return new ClientBuilder<BssClient>("GlobalCredentials");
        }
        ...
        public SyncInvoker<AutoRenewalResourcesResponse> AutoRenewalResourcesInvoker(AutoRenewalResourcesRequest autoRenewalResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(autoRenewalResourcesRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/autorenew/{resource_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", autoRenewalResourcesRequest);
            return new SyncInvoker<AutoRenewalResourcesResponse>(this, "POST", request, JsonUtils.DeSerializeNull<AutoRenewalResourcesResponse>);
        }
        ...
        public SyncInvoker<CancelAutoRenewalResourcesResponse> CancelAutoRenewalResourcesInvoker(CancelAutoRenewalResourcesRequest cancelAutoRenewalResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(cancelAutoRenewalResourcesRequest.ResourceId, out var valueOfResourceId)) urlParam.Add("resource_id", valueOfResourceId);
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/autorenew/{resource_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", cancelAutoRenewalResourcesRequest);
            return new SyncInvoker<CancelAutoRenewalResourcesResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<CancelAutoRenewalResourcesResponse>);
        }
        ...
        public SyncInvoker<CancelCustomerOrderResponse> CancelCustomerOrderInvoker(CancelCustomerOrderRequest cancelCustomerOrderRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/customer-orders/cancel", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", cancelCustomerOrderRequest);
            return new SyncInvoker<CancelCustomerOrderResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<CancelCustomerOrderResponse>);
        }
        ...
        public SyncInvoker<CancelResourcesSubscriptionResponse> CancelResourcesSubscriptionInvoker(CancelResourcesSubscriptionRequest cancelResourcesSubscriptionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/unsubscribe", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", cancelResourcesSubscriptionRequest);
            return new SyncInvoker<CancelResourcesSubscriptionResponse>(this, "POST", request, JsonUtils.DeSerialize<CancelResourcesSubscriptionResponse>);
        }
        ...
        public SyncInvoker<ChangeEnterpriseRealnameAuthenticationResponse> ChangeEnterpriseRealnameAuthenticationInvoker(ChangeEnterpriseRealnameAuthenticationRequest changeEnterpriseRealnameAuthenticationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/customers/realname-auths/enterprise", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", changeEnterpriseRealnameAuthenticationRequest);
            return new SyncInvoker<ChangeEnterpriseRealnameAuthenticationResponse>(this, "PUT", request, JsonUtils.DeSerialize<ChangeEnterpriseRealnameAuthenticationResponse>);
        }
        ...
        public SyncInvoker<CheckUserIdentityResponse> CheckUserIdentityInvoker(CheckUserIdentityRequest checkUserIdentityRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/users/check-identity", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkUserIdentityRequest);
            return new SyncInvoker<CheckUserIdentityResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckUserIdentityResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ClaimEnterpriseMultiAccountCouponResponse ClaimEnterpriseMultiAccountCoupon(ClaimEnterpriseMultiAccountCouponRequest claimEnterpriseMultiAccountCouponRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ClaimEnterpriseMultiAccountCouponResponse> ClaimEnterpriseMultiAccountCouponInvoker(ClaimEnterpriseMultiAccountCouponRequest claimEnterpriseMultiAccountCouponRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/transfer-coupon", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", claimEnterpriseMultiAccountCouponRequest);
            return new SyncInvoker<ClaimEnterpriseMultiAccountCouponResponse>(this, "POST", request, JsonUtils.DeSerialize<ClaimEnterpriseMultiAccountCouponResponse>);
        }
        ...
        public SyncInvoker<CreateEnterpriseProjectAuthResponse> CreateEnterpriseProjectAuthInvoker(CreateEnterpriseProjectAuthRequest createEnterpriseProjectAuthRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/enterprise-projects/authority", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createEnterpriseProjectAuthRequest);
            return new SyncInvoker<CreateEnterpriseProjectAuthResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CreateEnterpriseProjectAuthResponse>);
        }
        ...
        public SyncInvoker<CreateEnterpriseRealnameAuthenticationResponse> CreateEnterpriseRealnameAuthenticationInvoker(CreateEnterpriseRealnameAuthenticationRequest createEnterpriseRealnameAuthenticationRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/customers/realname-auths/enterprise", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createEnterpriseRealnameAuthenticationRequest);
            return new SyncInvoker<CreateEnterpriseRealnameAuthenticationResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateEnterpriseRealnameAuthenticationResponse>);
        }
        ...
        public SyncInvoker<CreatePartnerCouponsResponse> CreatePartnerCouponsInvoker(CreatePartnerCouponsRequest createPartnerCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/partner-coupons", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createPartnerCouponsRequest);
            return new SyncInvoker<CreatePartnerCouponsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreatePartnerCouponsResponse>);
        }
        ...
        public SyncInvoker<CreatePersonalRealnameAuthResponse> CreatePersonalRealnameAuthInvoker(CreatePersonalRealnameAuthRequest createPersonalRealnameAuthRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/customers/realname-auths/individual", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createPersonalRealnameAuthRequest);
            return new SyncInvoker<CreatePersonalRealnameAuthResponse>(this, "POST", request, JsonUtils.DeSerialize<CreatePersonalRealnameAuthResponse>);
        }
        ...
        public SyncInvoker<CreateSubCustomerResponse> CreateSubCustomerInvoker(CreateSubCustomerRequest createSubCustomerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSubCustomerRequest);
            return new SyncInvoker<CreateSubCustomerResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateSubCustomerResponse>);
        }
        ...
        public SyncInvoker<CreateSubEnterpriseAccountResponse> CreateSubEnterpriseAccountInvoker(CreateSubEnterpriseAccountRequest createSubEnterpriseAccountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/sub-customers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSubEnterpriseAccountRequest);
            return new SyncInvoker<CreateSubEnterpriseAccountResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CreateSubEnterpriseAccountResponse>);
        }
        ...
        public SyncInvoker<ListCitiesResponse> ListCitiesInvoker(ListCitiesRequest listCitiesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/systems/configs/cities", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCitiesRequest);
            return new SyncInvoker<ListCitiesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCitiesResponse>);
        }
        ...
        public SyncInvoker<ListConsumeSubCustomersResponse> ListConsumeSubCustomersInvoker(ListConsumeSubCustomersRequest listConsumeSubCustomersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/subcustomer-bills/res-fee-records/sub-customers/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listConsumeSubCustomersRequest);
            return new SyncInvoker<ListConsumeSubCustomersResponse>(this, "POST", request, JsonUtils.DeSerialize<ListConsumeSubCustomersResponse>);
        }
        ...
        public SyncInvoker<ListConversionsResponse> ListConversionsInvoker(ListConversionsRequest listConversionsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bases/conversions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listConversionsRequest);
            return new SyncInvoker<ListConversionsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListConversionsResponse>);
        }
        ...
        public SyncInvoker<ListCostsResponse> ListCostsInvoker(ListCostsRequest listCostsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v4/costs/cost-analysed-bills/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCostsRequest);
            return new SyncInvoker<ListCostsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListCostsResponse>);
        }
        ...
        public SyncInvoker<ListCountiesResponse> ListCountiesInvoker(ListCountiesRequest listCountiesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/systems/configs/counties", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCountiesRequest);
            return new SyncInvoker<ListCountiesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCountiesResponse>);
        }
        ...
        public SyncInvoker<ListCouponQuotasRecordsResponse> ListCouponQuotasRecordsInvoker(ListCouponQuotasRecordsRequest listCouponQuotasRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/coupon-quotas/records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCouponQuotasRecordsRequest);
            return new SyncInvoker<ListCouponQuotasRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCouponQuotasRecordsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCustomerAccountChangeRecordsResponse ListCustomerAccountChangeRecords(ListCustomerAccountChangeRecordsRequest listCustomerAccountChangeRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCustomerAccountChangeRecordsResponse> ListCustomerAccountChangeRecordsInvoker(ListCustomerAccountChangeRecordsRequest listCustomerAccountChangeRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/customer-accounts/account-change-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerAccountChangeRecordsRequest);
            return new SyncInvoker<ListCustomerAccountChangeRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCustomerAccountChangeRecordsResponse>);
        }
        ...
        public SyncInvoker<ListCustomerBillsFeeRecordsResponse> ListCustomerBillsFeeRecordsInvoker(ListCustomerBillsFeeRecordsRequest listCustomerBillsFeeRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/fee-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerBillsFeeRecordsRequest);
            return new SyncInvoker<ListCustomerBillsFeeRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCustomerBillsFeeRecordsResponse>);
        }
        ...
        public SyncInvoker<ListCustomerBillsMonthlyBreakDownResponse> ListCustomerBillsMonthlyBreakDownInvoker(ListCustomerBillsMonthlyBreakDownRequest listCustomerBillsMonthlyBreakDownRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/costs/cost-analysed-bills/monthly-breakdown", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerBillsMonthlyBreakDownRequest);
            return new SyncInvoker<ListCustomerBillsMonthlyBreakDownResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCustomerBillsMonthlyBreakDownResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCustomerCouponChangeRecordsResponse ListCustomerCouponChangeRecords(ListCustomerCouponChangeRecordsRequest listCustomerCouponChangeRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCustomerCouponChangeRecordsResponse> ListCustomerCouponChangeRecordsInvoker(ListCustomerCouponChangeRecordsRequest listCustomerCouponChangeRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/account-change-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerCouponChangeRecordsRequest);
            return new SyncInvoker<ListCustomerCouponChangeRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCustomerCouponChangeRecordsResponse>);
        }
        ...
        public SyncInvoker<ListCustomerOnDemandResourcesResponse> ListCustomerOnDemandResourcesInvoker(ListCustomerOnDemandResourcesRequest listCustomerOnDemandResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/on-demand-resources/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerOnDemandResourcesRequest);
            return new SyncInvoker<ListCustomerOnDemandResourcesResponse>(this, "POST", request, JsonUtils.DeSerialize<ListCustomerOnDemandResourcesResponse>);
        }
        ...
        public SyncInvoker<ListCustomerOrdersResponse> ListCustomerOrdersInvoker(ListCustomerOrdersRequest listCustomerOrdersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/customer-orders", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerOrdersRequest);
            return new SyncInvoker<ListCustomerOrdersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCustomerOrdersResponse>);
        }
        ...
        public SyncInvoker<ListCustomersBalancesDetailResponse> ListCustomersBalancesDetailInvoker(ListCustomersBalancesDetailRequest listCustomersBalancesDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/customer-accounts/balances/batch-query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomersBalancesDetailRequest);
            return new SyncInvoker<ListCustomersBalancesDetailResponse>(this, "POST", request, JsonUtils.DeSerialize<ListCustomersBalancesDetailResponse>);
        }
        ...
        public SyncInvoker<ListCustomerselfResourceRecordDetailsResponse> ListCustomerselfResourceRecordDetailsInvoker(ListCustomerselfResourceRecordDetailsRequest listCustomerselfResourceRecordDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/res-records/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerselfResourceRecordDetailsRequest);
            return new SyncInvoker<ListCustomerselfResourceRecordDetailsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListCustomerselfResourceRecordDetailsResponse>);
        }
        ...
        public SyncInvoker<ListCustomerselfResourceRecordsResponse> ListCustomerselfResourceRecordsInvoker(ListCustomerselfResourceRecordsRequest listCustomerselfResourceRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/res-fee-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCustomerselfResourceRecordsRequest);
            return new SyncInvoker<ListCustomerselfResourceRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCustomerselfResourceRecordsResponse>);
        }
        ...
        public SyncInvoker<ListEnterpriseMultiAccountResponse> ListEnterpriseMultiAccountInvoker(ListEnterpriseMultiAccountRequest listEnterpriseMultiAccountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/retrieve-amount", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listEnterpriseMultiAccountRequest);
            return new SyncInvoker<ListEnterpriseMultiAccountResponse>(this, "GET", request, JsonUtils.DeSerialize<ListEnterpriseMultiAccountResponse>);
        }
        ...
        public SyncInvoker<ListEnterpriseOrganizationsResponse> ListEnterpriseOrganizationsInvoker(ListEnterpriseOrganizationsRequest listEnterpriseOrganizationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/enterprise-organizations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listEnterpriseOrganizationsRequest);
            return new SyncInvoker<ListEnterpriseOrganizationsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListEnterpriseOrganizationsResponse>);
        }
        ...
        public SyncInvoker<ListEnterpriseSubCustomersResponse> ListEnterpriseSubCustomersInvoker(ListEnterpriseSubCustomersRequest listEnterpriseSubCustomersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/sub-customers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listEnterpriseSubCustomersRequest);
            return new SyncInvoker<ListEnterpriseSubCustomersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListEnterpriseSubCustomersResponse>);
        }
        ...
        public SyncInvoker<ListFreeResourceInfosResponse> ListFreeResourceInfosInvoker(ListFreeResourceInfosRequest listFreeResourceInfosRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/payments/free-resources/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listFreeResourceInfosRequest);
            return new SyncInvoker<ListFreeResourceInfosResponse>(this, "POST", request, JsonUtils.DeSerialize<ListFreeResourceInfosResponse>);
        }
        ...
        public SyncInvoker<ListFreeResourceUsagesResponse> ListFreeResourceUsagesInvoker(ListFreeResourceUsagesRequest listFreeResourceUsagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/payments/free-resources/usages/details/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listFreeResourceUsagesRequest);
            return new SyncInvoker<ListFreeResourceUsagesResponse>(this, "POST", request, JsonUtils.DeSerialize<ListFreeResourceUsagesResponse>);
        }
        ...
        public SyncInvoker<ListFreeResourcesUsageRecordsResponse> ListFreeResourcesUsageRecordsInvoker(ListFreeResourcesUsageRecordsRequest listFreeResourcesUsageRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/free-resources-usage-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listFreeResourcesUsageRecordsRequest);
            return new SyncInvoker<ListFreeResourcesUsageRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListFreeResourcesUsageRecordsResponse>);
        }
        ...
        public SyncInvoker<ListIncentiveDiscountPoliciesResponse> ListIncentiveDiscountPoliciesInvoker(ListIncentiveDiscountPoliciesRequest listIncentiveDiscountPoliciesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/products/incentive-discount-policies", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIncentiveDiscountPoliciesRequest);
            return new SyncInvoker<ListIncentiveDiscountPoliciesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListIncentiveDiscountPoliciesResponse>);
        }
        ...
        public SyncInvoker<ListIndirectPartnersResponse> ListIndirectPartnersInvoker(ListIndirectPartnersRequest listIndirectPartnersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/indirect-partners/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIndirectPartnersRequest);
            return new SyncInvoker<ListIndirectPartnersResponse>(this, "POST", request, JsonUtils.DeSerialize<ListIndirectPartnersResponse>);
        }
        ...
        public SyncInvoker<ListIssuedCouponQuotasResponse> ListIssuedCouponQuotasInvoker(ListIssuedCouponQuotasRequest listIssuedCouponQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/issued-coupon-quotas", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIssuedCouponQuotasRequest);
            return new SyncInvoker<ListIssuedCouponQuotasResponse>(this, "GET", request, JsonUtils.DeSerialize<ListIssuedCouponQuotasResponse>);
        }
        ...
        public SyncInvoker<ListIssuedPartnerCouponsResponse> ListIssuedPartnerCouponsInvoker(ListIssuedPartnerCouponsRequest listIssuedPartnerCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/partner-coupons", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listIssuedPartnerCouponsRequest);
            return new SyncInvoker<ListIssuedPartnerCouponsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListIssuedPartnerCouponsResponse>);
        }
        ...
        public SyncInvoker<ListMeasureUnitsResponse> ListMeasureUnitsInvoker(ListMeasureUnitsRequest listMeasureUnitsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bases/measurements", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listMeasureUnitsRequest);
            return new SyncInvoker<ListMeasureUnitsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListMeasureUnitsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListMultiAccountRetrieveCouponsResponse ListMultiAccountRetrieveCoupons(ListMultiAccountRetrieveCouponsRequest listMultiAccountRetrieveCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListMultiAccountRetrieveCouponsResponse> ListMultiAccountRetrieveCouponsInvoker(ListMultiAccountRetrieveCouponsRequest listMultiAccountRetrieveCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/retrieve-coupons", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listMultiAccountRetrieveCouponsRequest);
            return new SyncInvoker<ListMultiAccountRetrieveCouponsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListMultiAccountRetrieveCouponsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListMultiAccountTransferCouponsResponse ListMultiAccountTransferCoupons(ListMultiAccountTransferCouponsRequest listMultiAccountTransferCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListMultiAccountTransferCouponsResponse> ListMultiAccountTransferCouponsInvoker(ListMultiAccountTransferCouponsRequest listMultiAccountTransferCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/transfer-coupons", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listMultiAccountTransferCouponsRequest);
            return new SyncInvoker<ListMultiAccountTransferCouponsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListMultiAccountTransferCouponsResponse>);
        }
        ...
        public SyncInvoker<ListOnDemandResourceRatingsResponse> ListOnDemandResourceRatingsInvoker(ListOnDemandResourceRatingsRequest listOnDemandResourceRatingsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/ratings/on-demand-resources", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOnDemandResourceRatingsRequest);
            return new SyncInvoker<ListOnDemandResourceRatingsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListOnDemandResourceRatingsResponse>);
        }
        ...
        public SyncInvoker<ListOrderCouponsByOrderIdResponse> ListOrderCouponsByOrderIdInvoker(ListOrderCouponsByOrderIdRequest listOrderCouponsByOrderIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/customer-orders/order-coupons", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOrderCouponsByOrderIdRequest);
            return new SyncInvoker<ListOrderCouponsByOrderIdResponse>(this, "GET", request, JsonUtils.DeSerialize<ListOrderCouponsByOrderIdResponse>);
        }
        ...
        public SyncInvoker<ListOrderDiscountsResponse> ListOrderDiscountsInvoker(ListOrderDiscountsRequest listOrderDiscountsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/customer-orders/order-discounts", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listOrderDiscountsRequest);
            return new SyncInvoker<ListOrderDiscountsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListOrderDiscountsResponse>);
        }
        ...
        public SyncInvoker<ListPartnerAccountChangeRecordsResponse> ListPartnerAccountChangeRecordsInvoker(ListPartnerAccountChangeRecordsRequest listPartnerAccountChangeRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/partner-accounts/account-change-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPartnerAccountChangeRecordsRequest);
            return new SyncInvoker<ListPartnerAccountChangeRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPartnerAccountChangeRecordsResponse>);
        }
        ...
        public SyncInvoker<ListPartnerAdjustRecordsResponse> ListPartnerAdjustRecordsInvoker(ListPartnerAdjustRecordsRequest listPartnerAdjustRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/accounts/partner-accounts/adjust-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPartnerAdjustRecordsRequest);
            return new SyncInvoker<ListPartnerAdjustRecordsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPartnerAdjustRecordsResponse>);
        }
        ...
        public SyncInvoker<ListPartnerBalancesResponse> ListPartnerBalancesInvoker(ListPartnerBalancesRequest listPartnerBalancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/partner-accounts/balances", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPartnerBalancesRequest);
            return new SyncInvoker<ListPartnerBalancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPartnerBalancesResponse>);
        }
        ...
        public SyncInvoker<ListPartnerCouponsRecordResponse> ListPartnerCouponsRecordInvoker(ListPartnerCouponsRecordRequest listPartnerCouponsRecordRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/partner-coupons/records/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPartnerCouponsRecordRequest);
            return new SyncInvoker<ListPartnerCouponsRecordResponse>(this, "GET", request, JsonUtils.DeSerialize<ListPartnerCouponsRecordResponse>);
        }
        ...
        public SyncInvoker<ListPayPerUseCustomerResourcesResponse> ListPayPerUseCustomerResourcesInvoker(ListPayPerUseCustomerResourcesRequest listPayPerUseCustomerResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/suscriptions/resources/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listPayPerUseCustomerResourcesRequest);
            return new SyncInvoker<ListPayPerUseCustomerResourcesResponse>(this, "POST", request, JsonUtils.DeSerialize<ListPayPerUseCustomerResourcesResponse>);
        }
        ...
        public SyncInvoker<ListProvincesResponse> ListProvincesInvoker(ListProvincesRequest listProvincesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/systems/configs/provinces", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listProvincesRequest);
            return new SyncInvoker<ListProvincesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListProvincesResponse>);
        }
        ...
        public SyncInvoker<ListQuotaCouponsResponse> ListQuotaCouponsInvoker(ListQuotaCouponsRequest listQuotaCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/coupon-quotas/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listQuotaCouponsRequest);
            return new SyncInvoker<ListQuotaCouponsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListQuotaCouponsResponse>);
        }
        ...
        public SyncInvoker<ListRateOnPeriodDetailResponse> ListRateOnPeriodDetailInvoker(ListRateOnPeriodDetailRequest listRateOnPeriodDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/ratings/period-resources/subscribe-rate", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listRateOnPeriodDetailRequest);
            return new SyncInvoker<ListRateOnPeriodDetailResponse>(this, "POST", request, JsonUtils.DeSerialize<ListRateOnPeriodDetailResponse>);
        }
        ...
        public SyncInvoker<ListRenewRateOnPeriodResponse> ListRenewRateOnPeriodInvoker(ListRenewRateOnPeriodRequest listRenewRateOnPeriodRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/ratings/period-resources/renew-rate", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listRenewRateOnPeriodRequest);
            return new SyncInvoker<ListRenewRateOnPeriodResponse>(this, "POST", request, JsonUtils.DeSerialize<ListRenewRateOnPeriodResponse>);
        }
        ...
        public SyncInvoker<ListResourceUsageResponse> ListResourceUsageInvoker(ListResourceUsageRequest listResourceUsageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/resources/usage/details", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listResourceUsageRequest);
            return new SyncInvoker<ListResourceUsageResponse>(this, "GET", request, JsonUtils.DeSerialize<ListResourceUsageResponse>);
        }
        ...
        public SyncInvoker<ListResourceUsageSummaryResponse> ListResourceUsageSummaryInvoker(ListResourceUsageSummaryRequest listResourceUsageSummaryRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/resources/usage/summary", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listResourceUsageSummaryRequest);
            return new SyncInvoker<ListResourceUsageSummaryResponse>(this, "GET", request, JsonUtils.DeSerialize<ListResourceUsageSummaryResponse>);
        }
        ...
        public SyncInvoker<ListServiceResourcesResponse> ListServiceResourcesInvoker(ListServiceResourcesRequest listServiceResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/products/service-resources", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listServiceResourcesRequest);
            return new SyncInvoker<ListServiceResourcesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListServiceResourcesResponse>);
        }
        ...
        public SyncInvoker<ListServiceTypesResponse> ListServiceTypesInvoker(ListServiceTypesRequest listServiceTypesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/products/service-types", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listServiceTypesRequest);
            return new SyncInvoker<ListServiceTypesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListServiceTypesResponse>);
        }
        ...
        public SyncInvoker<ListStoredValueCardsResponse> ListStoredValueCardsInvoker(ListStoredValueCardsRequest listStoredValueCardsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/stored-value-cards", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listStoredValueCardsRequest);
            return new SyncInvoker<ListStoredValueCardsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListStoredValueCardsResponse>);
        }
        ...
        public SyncInvoker<ListSubCustomerBillDetailResponse> ListSubCustomerBillDetailInvoker(ListSubCustomerBillDetailRequest listSubCustomerBillDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/subcustomer-bills/res-fee-records", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubCustomerBillDetailRequest);
            return new SyncInvoker<ListSubCustomerBillDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSubCustomerBillDetailResponse>);
        }
        ...
        public SyncInvoker<ListSubCustomerCouponsResponse> ListSubCustomerCouponsInvoker(ListSubCustomerCouponsRequest listSubCustomerCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/coupons", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubCustomerCouponsRequest);
            return new SyncInvoker<ListSubCustomerCouponsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSubCustomerCouponsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSubCustomerNewTagResponse ListSubCustomerNewTag(ListSubCustomerNewTagRequest listSubCustomerNewTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSubCustomerNewTagResponse> ListSubCustomerNewTagInvoker(ListSubCustomerNewTagRequest listSubCustomerNewTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/new-customers-tags/batch-query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubCustomerNewTagRequest);
            return new SyncInvoker<ListSubCustomerNewTagResponse>(this, "POST", request, JsonUtils.DeSerialize<ListSubCustomerNewTagResponse>);
        }
        ...
        public SyncInvoker<ListSubCustomersResponse> ListSubCustomersInvoker(ListSubCustomersRequest listSubCustomersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/sub-customers/query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubCustomersRequest);
            return new SyncInvoker<ListSubCustomersResponse>(this, "POST", request, JsonUtils.DeSerialize<ListSubCustomersResponse>);
        }
        ...
        public SyncInvoker<ListSubcustomerMonthlyBillsResponse> ListSubcustomerMonthlyBillsInvoker(ListSubcustomerMonthlyBillsRequest listSubcustomerMonthlyBillsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/partner-bills/subcustomer-bills/monthly-sum", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubcustomerMonthlyBillsRequest);
            return new SyncInvoker<ListSubcustomerMonthlyBillsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSubcustomerMonthlyBillsResponse>);
        }
        ...
        public SyncInvoker<ListUsageTypesResponse> ListUsageTypesInvoker(ListUsageTypesRequest listUsageTypesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/products/usage-types", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listUsageTypesRequest);
            return new SyncInvoker<ListUsageTypesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListUsageTypesResponse>);
        }
        ...
        public SyncInvoker<PayOrdersResponse> PayOrdersInvoker(PayOrdersRequest payOrdersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/orders/customer-orders/pay", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", payOrdersRequest);
            return new SyncInvoker<PayOrdersResponse>(this, "POST", request, JsonUtils.DeSerializeNull<PayOrdersResponse>);
        }
        ...
        public SyncInvoker<ReclaimCouponQuotasResponse> ReclaimCouponQuotasInvoker(ReclaimCouponQuotasRequest reclaimCouponQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/coupon-quotas/indirect-partner-reclaim", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", reclaimCouponQuotasRequest);
            return new SyncInvoker<ReclaimCouponQuotasResponse>(this, "POST", request, JsonUtils.DeSerialize<ReclaimCouponQuotasResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ReclaimEnterpriseMultiAccountCouponResponse ReclaimEnterpriseMultiAccountCoupon(ReclaimEnterpriseMultiAccountCouponRequest reclaimEnterpriseMultiAccountCouponRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ReclaimEnterpriseMultiAccountCouponResponse> ReclaimEnterpriseMultiAccountCouponInvoker(ReclaimEnterpriseMultiAccountCouponRequest reclaimEnterpriseMultiAccountCouponRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/retrieve-coupon", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", reclaimEnterpriseMultiAccountCouponRequest);
            return new SyncInvoker<ReclaimEnterpriseMultiAccountCouponResponse>(this, "POST", request, JsonUtils.DeSerialize<ReclaimEnterpriseMultiAccountCouponResponse>);
        }
        ...
        public SyncInvoker<ReclaimIndirectPartnerAccountResponse> ReclaimIndirectPartnerAccountInvoker(ReclaimIndirectPartnerAccountRequest reclaimIndirectPartnerAccountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/partner-accounts/indirect-partner-reclaim", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", reclaimIndirectPartnerAccountRequest);
            return new SyncInvoker<ReclaimIndirectPartnerAccountResponse>(this, "POST", request, JsonUtils.DeSerialize<ReclaimIndirectPartnerAccountResponse>);
        }
        ...
        public SyncInvoker<ReclaimPartnerCouponsResponse> ReclaimPartnerCouponsInvoker(ReclaimPartnerCouponsRequest reclaimPartnerCouponsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/benefits/partner-coupons/reclaim", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", reclaimPartnerCouponsRequest);
            return new SyncInvoker<ReclaimPartnerCouponsResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ReclaimPartnerCouponsResponse>);
        }
        ...
        public SyncInvoker<ReclaimSubEnterpriseAmountResponse> ReclaimSubEnterpriseAmountInvoker(ReclaimSubEnterpriseAmountRequest reclaimSubEnterpriseAmountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/retrieve-amount", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", reclaimSubEnterpriseAmountRequest);
            return new SyncInvoker<ReclaimSubEnterpriseAmountResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ReclaimSubEnterpriseAmountResponse>);
        }
        ...
        public SyncInvoker<ReclaimToPartnerAccountResponse> ReclaimToPartnerAccountInvoker(ReclaimToPartnerAccountRequest reclaimToPartnerAccountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/partner-accounts/reclaim", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", reclaimToPartnerAccountRequest);
            return new SyncInvoker<ReclaimToPartnerAccountResponse>(this, "POST", request, JsonUtils.DeSerialize<ReclaimToPartnerAccountResponse>);
        }
        ...
        public SyncInvoker<RenewalResourcesResponse> RenewalResourcesInvoker(RenewalResourcesRequest renewalResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/renew", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", renewalResourcesRequest);
            return new SyncInvoker<RenewalResourcesResponse>(this, "POST", request, JsonUtils.DeSerialize<RenewalResourcesResponse>);
        }
        ...
        public SyncInvoker<SendSmsVerificationCodeResponse> SendSmsVerificationCodeInvoker(SendSmsVerificationCodeRequest sendSmsVerificationCodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/sm-verification-code", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", sendSmsVerificationCodeRequest);
            return new SyncInvoker<SendSmsVerificationCodeResponse>(this, "POST", request, JsonUtils.DeSerializeNull<SendSmsVerificationCodeResponse>);
        }
        ...
        public SyncInvoker<SendVerificationMessageCodeResponse> SendVerificationMessageCodeInvoker(SendVerificationMessageCodeRequest sendVerificationMessageCodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bases/verificationcode/send", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", sendVerificationMessageCodeRequest);
            return new SyncInvoker<SendVerificationMessageCodeResponse>(this, "POST", request, JsonUtils.DeSerializeNull<SendVerificationMessageCodeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SetResourcesRenewConfigResponse SetResourcesRenewConfig(SetResourcesRenewConfigRequest setResourcesRenewConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SetResourcesRenewConfigResponse> SetResourcesRenewConfigInvoker(SetResourcesRenewConfigRequest setResourcesRenewConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/renew/config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", setResourcesRenewConfigRequest);
            return new SyncInvoker<SetResourcesRenewConfigResponse>(this, "POST", request, JsonUtils.DeSerialize<SetResourcesRenewConfigResponse>);
        }
        ...
        public SyncInvoker<ShowCustomerAccountBalancesResponse> ShowCustomerAccountBalancesInvoker(ShowCustomerAccountBalancesRequest showCustomerAccountBalancesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/customer-accounts/balances", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCustomerAccountBalancesRequest);
            return new SyncInvoker<ShowCustomerAccountBalancesResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCustomerAccountBalancesResponse>);
        }
        ...
        public SyncInvoker<ShowCustomerMonthlySumResponse> ShowCustomerMonthlySumInvoker(ShowCustomerMonthlySumRequest showCustomerMonthlySumRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/bills/customer-bills/monthly-sum", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCustomerMonthlySumRequest);
            return new SyncInvoker<ShowCustomerMonthlySumResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCustomerMonthlySumResponse>);
        }
        ...
        public SyncInvoker<ShowCustomerOrderDetailsResponse> ShowCustomerOrderDetailsInvoker(ShowCustomerOrderDetailsRequest showCustomerOrderDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showCustomerOrderDetailsRequest.OrderId, out var valueOfOrderId)) urlParam.Add("order_id", valueOfOrderId);
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/customer-orders/details/{order_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCustomerOrderDetailsRequest);
            return new SyncInvoker<ShowCustomerOrderDetailsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCustomerOrderDetailsResponse>);
        }
        ...
        public SyncInvoker<ShowMultiAccountTransferAmountResponse> ShowMultiAccountTransferAmountInvoker(ShowMultiAccountTransferAmountRequest showMultiAccountTransferAmountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/transfer-amount", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showMultiAccountTransferAmountRequest);
        ...
        public SyncInvoker<ShowRealnameAuthenticationReviewResultResponse> ShowRealnameAuthenticationReviewResultInvoker(ShowRealnameAuthenticationReviewResultRequest showRealnameAuthenticationReviewResultRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/customers/realname-auths/result", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRealnameAuthenticationReviewResultRequest);
            return new SyncInvoker<ShowRealnameAuthenticationReviewResultResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRealnameAuthenticationReviewResultResponse>);
        }
        ...
        public SyncInvoker<ShowRefundOrderDetailsResponse> ShowRefundOrderDetailsInvoker(ShowRefundOrderDetailsRequest showRefundOrderDetailsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/customer-orders/refund-orders", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRefundOrderDetailsRequest);
            return new SyncInvoker<ShowRefundOrderDetailsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRefundOrderDetailsResponse>);
        }
        ...
        public SyncInvoker<UpdateCouponQuotasResponse> UpdateCouponQuotasInvoker(UpdateCouponQuotasRequest updateCouponQuotasRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/partners/coupon-quotas/indirect-partner-adjust", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateCouponQuotasRequest);
            return new SyncInvoker<UpdateCouponQuotasResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateCouponQuotasResponse>);
        }
        ...
        public SyncInvoker<UpdateCustomerAccountAmountResponse> UpdateCustomerAccountAmountInvoker(UpdateCustomerAccountAmountRequest updateCustomerAccountAmountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/partner-accounts/adjust-amount", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateCustomerAccountAmountRequest);
            return new SyncInvoker<UpdateCustomerAccountAmountResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateCustomerAccountAmountResponse>);
        }
        ...
        public SyncInvoker<UpdateIndirectPartnerAccountResponse> UpdateIndirectPartnerAccountInvoker(UpdateIndirectPartnerAccountRequest updateIndirectPartnerAccountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/accounts/partner-accounts/indirect-partner-adjust", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateIndirectPartnerAccountRequest);
            return new SyncInvoker<UpdateIndirectPartnerAccountResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateIndirectPartnerAccountResponse>);
        }
        ...
        public SyncInvoker<UpdatePeriodToOnDemandResponse> UpdatePeriodToOnDemandInvoker(UpdatePeriodToOnDemandRequest updatePeriodToOnDemandRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/to-on-demand", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updatePeriodToOnDemandRequest);
            return new SyncInvoker<UpdatePeriodToOnDemandResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdatePeriodToOnDemandResponse>);
        }
        ...
        public SyncInvoker<UpdateSubEnterpriseAmountResponse> UpdateSubEnterpriseAmountInvoker(UpdateSubEnterpriseAmountRequest updateSubEnterpriseAmountRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/enterprises/multi-accounts/transfer-amount", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateSubEnterpriseAmountRequest);
            return new SyncInvoker<UpdateSubEnterpriseAmountResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UpdateSubEnterpriseAmountResponse>);
        }

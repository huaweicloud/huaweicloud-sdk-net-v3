...
namespace HuaweiCloud.SDK.Bss.V2
{
    public partial class BssAsyncClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ListBusinessDiscountInfoResponse> ListBusinessDiscountInfoAsync(ListBusinessDiscountInfoRequest listBusinessDiscountInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ListBusinessDiscountInfoResponse> ListBusinessDiscountInfoAsyncInvoker(ListBusinessDiscountInfoRequest listBusinessDiscountInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/promotions/business/discount-info", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listBusinessDiscountInfoRequest);
            return new AsyncInvoker<ListBusinessDiscountInfoResponse>(this, "POST", request, JsonUtils.DeSerialize<ListBusinessDiscountInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowRealNameAuthQrCodeResponse> ShowRealNameAuthQrCodeAsync(ShowRealNameAuthQrCodeRequest showRealNameAuthQrCodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowRealNameAuthQrCodeResponse> ShowRealNameAuthQrCodeAsyncInvoker(ShowRealNameAuthQrCodeRequest showRealNameAuthQrCodeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/customers/real-name-auth-qrcode", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRealNameAuthQrCodeRequest);
            return new AsyncInvoker<ShowRealNameAuthQrCodeResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRealNameAuthQrCodeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<ShowRealNameAuthStatusResponse> ShowRealNameAuthStatusAsync(ShowRealNameAuthStatusRequest showRealNameAuthStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<ShowRealNameAuthStatusResponse> ShowRealNameAuthStatusAsyncInvoker(ShowRealNameAuthStatusRequest showRealNameAuthStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/customers/real-name-auth-status", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showRealNameAuthStatusRequest);
            return new AsyncInvoker<ShowRealNameAuthStatusResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowRealNameAuthStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public async Task<UpdatePeriodToOnDemandInstantlyResponse> UpdatePeriodToOnDemandInstantlyAsync(UpdatePeriodToOnDemandInstantlyRequest updatePeriodToOnDemandInstantlyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public AsyncInvoker<UpdatePeriodToOnDemandInstantlyResponse> UpdatePeriodToOnDemandInstantlyAsyncInvoker(UpdatePeriodToOnDemandInstantlyRequest updatePeriodToOnDemandInstantlyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/orders/subscriptions/resources/to-on-demand/instantly", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updatePeriodToOnDemandInstantlyRequest);
            return new AsyncInvoker<UpdatePeriodToOnDemandInstantlyResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdatePeriodToOnDemandInstantlyResponse>);
        }

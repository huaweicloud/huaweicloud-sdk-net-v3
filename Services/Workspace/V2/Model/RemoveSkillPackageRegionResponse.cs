...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RemoveSkillPackageRegionResponse : SdkResponse
    {
        ...
        public List<RegionFailedDetail> FailedDetails { get; set; }
        ...
        {
            return this.Equals(input as RemoveSkillPackageRegionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveSkillPackageRegionResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class CreateSkillBindingsRequest 
    {
        ...
        public Guid? XClientToken { get; set; }
        ...
        public CreateSkillBindingReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateSkillBindingsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSkillBindingsRequest input)
        {

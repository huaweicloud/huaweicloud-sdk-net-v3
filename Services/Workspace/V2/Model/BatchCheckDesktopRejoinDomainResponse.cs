...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchCheckDesktopRejoinDomainResponse : SdkResponse
    {
        ...
        public List<BatchCheckRejoinDomainResult> Desktops { get; set; }
        ...
        {
            return this.Equals(input as BatchCheckDesktopRejoinDomainResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCheckDesktopRejoinDomainResponse input)
        {

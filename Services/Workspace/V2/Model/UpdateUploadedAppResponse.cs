...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateUploadedAppResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateUploadedAppResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateUploadedAppResponse input)
        {
            ...
            if (this.ApplicationSource != input.ApplicationSource || (this.ApplicationSource != null && !this.ApplicationSource.Equals(input.ApplicationSource))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApplicationSource != null) hashCode = hashCode * 59 + this.ApplicationSource.GetHashCode();

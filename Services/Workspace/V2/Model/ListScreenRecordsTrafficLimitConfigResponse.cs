...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListScreenRecordsTrafficLimitConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListScreenRecordsTrafficLimitConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListScreenRecordsTrafficLimitConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class RemoveSkillPackageRegionRequest 
    {
        ...
        public RemovePackageRegionReq Body { get; set; }
        ...
        {
            return this.Equals(input as RemoveSkillPackageRegionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveSkillPackageRegionRequest input)
        {

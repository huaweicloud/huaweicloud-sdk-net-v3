...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTenantProfilesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListTenantProfilesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTenantProfilesResponse input)
        {

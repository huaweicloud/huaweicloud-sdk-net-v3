...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ExpandDesktopPoolVolumesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ExpandDesktopPoolVolumesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExpandDesktopPoolVolumesResponse input)
        {

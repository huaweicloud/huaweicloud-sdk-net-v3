...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class EstimateAddResourcesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as EstimateAddResourcesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EstimateAddResourcesResponse input)
        {

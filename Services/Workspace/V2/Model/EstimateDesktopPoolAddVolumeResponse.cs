...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class EstimateDesktopPoolAddVolumeResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as EstimateDesktopPoolAddVolumeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EstimateDesktopPoolAddVolumeResponse input)
        {

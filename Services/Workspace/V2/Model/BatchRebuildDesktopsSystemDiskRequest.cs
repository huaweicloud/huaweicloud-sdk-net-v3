...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class BatchRebuildDesktopsSystemDiskRequest 
    {
        ...
        public RebuildDesktopsReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchRebuildDesktopsSystemDiskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRebuildDesktopsSystemDiskRequest input)
        {

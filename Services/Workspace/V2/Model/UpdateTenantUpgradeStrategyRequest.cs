...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateTenantUpgradeStrategyRequest 
    {
        ...
        public UpdateTenantUpgradeStrategyRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTenantUpgradeStrategyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTenantUpgradeStrategyRequest input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateStrategyApplyObjectsRequest 
    {
        ...
        public UpdateStrategyApplyObjectsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateStrategyApplyObjectsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateStrategyApplyObjectsRequest input)
        {

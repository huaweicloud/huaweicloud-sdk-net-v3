...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateDesktopNamePolicyRequest 
    {
        ...
        public UpdateDesktopNamePolicyReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDesktopNamePolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDesktopNamePolicyRequest input)
        {

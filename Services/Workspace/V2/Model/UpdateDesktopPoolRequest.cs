...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateDesktopPoolRequest 
    {
        ...
        public UpdateDesktopPoolAttributesReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateDesktopPoolRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateDesktopPoolRequest input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ApplyDesktopsInternetResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ApplyDesktopsInternetResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ApplyDesktopsInternetResponse input)
        {

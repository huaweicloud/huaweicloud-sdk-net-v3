...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubnetBandwidthsResponse : SdkResponse
    {
        ...
        public List<SubnetBandwidthDetail> Bandwidths { get; set; }
        ...
        {
            return this.Equals(input as ListSubnetBandwidthsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubnetBandwidthsResponse input)
        {

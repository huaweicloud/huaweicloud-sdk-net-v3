...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListOriginalPolicyInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListOriginalPolicyInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOriginalPolicyInfoResponse input)
        {

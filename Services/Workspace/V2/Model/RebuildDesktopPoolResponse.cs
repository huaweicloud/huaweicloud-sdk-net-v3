...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RebuildDesktopPoolResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RebuildDesktopPoolResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RebuildDesktopPoolResponse input)
        {

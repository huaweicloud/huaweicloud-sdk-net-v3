...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDesktopsConnectStatusResponse : SdkResponse
    {
        ...
        public List<ConnectDesktopsInfo> Desktops { get; set; }
        ...
        {
            return this.Equals(input as ListDesktopsConnectStatusResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDesktopsConnectStatusResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListHistoryOnlineInfoNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListHistoryOnlineInfoNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListHistoryOnlineInfoNewResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListDesktopVersionResponse : SdkResponse
    {
        ...
        public List<DesktopVersionInfo> Desktops { get; set; }
        ...
        {
            return this.Equals(input as ListDesktopVersionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListDesktopVersionResponse input)
        {

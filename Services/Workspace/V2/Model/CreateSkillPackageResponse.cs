...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateSkillPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateSkillPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSkillPackageResponse input)
        {

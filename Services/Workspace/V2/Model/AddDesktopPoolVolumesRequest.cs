...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class AddDesktopPoolVolumesRequest 
    {
        ...
        public AddDesktopPoolVolumesReq Body { get; set; }
        ...
        {
            return this.Equals(input as AddDesktopPoolVolumesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddDesktopPoolVolumesRequest input)
        {

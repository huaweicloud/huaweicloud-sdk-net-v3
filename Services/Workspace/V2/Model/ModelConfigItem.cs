...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ModelConfigItem 
    {
        ...
        /// </summary>
        /// <value>资源类型（DESKTOP-桌面实例，DESKTOP_TAG-桌面标签）。</value>
        ...
        public class ResourceTypeEnum
        {
            ...
            /// </summary>
            public static readonly ResourceTypeEnum DESKTOP = new ResourceTypeEnum("DESKTOP");

            /// <summary>
            /// Enum DESKTOP_TAG for value: DESKTOP_TAG
            /// </summary>
            public static readonly ResourceTypeEnum DESKTOP_TAG = new ResourceTypeEnum("DESKTOP_TAG");
        ...
        {
            return this.Equals(input as ModelConfigItem);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModelConfigItem input)
        {

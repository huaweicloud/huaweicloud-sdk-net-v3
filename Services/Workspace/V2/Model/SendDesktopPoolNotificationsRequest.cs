...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class SendDesktopPoolNotificationsRequest 
    {
        ...
        public SendDesktopPoolNotificationsReq Body { get; set; }
        ...
        {
            return this.Equals(input as SendDesktopPoolNotificationsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SendDesktopPoolNotificationsRequest input)
        {

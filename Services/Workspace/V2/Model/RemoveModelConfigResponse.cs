...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RemoveModelConfigResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RemoveModelConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveModelConfigResponse input)
        {

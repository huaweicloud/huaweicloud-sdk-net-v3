...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class DeleteDesktopPoolVolumesReq 
    {
        ...
        public List<DeleteDesktopPoolVolumesReqVolumes> Volumes { get; set; }
        ...
        {
            return this.Equals(input as DeleteDesktopPoolVolumesReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteDesktopPoolVolumesReq input)
        {

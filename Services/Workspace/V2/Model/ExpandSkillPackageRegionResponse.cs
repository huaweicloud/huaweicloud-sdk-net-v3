...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ExpandSkillPackageRegionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ExpandSkillPackageRegionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExpandSkillPackageRegionResponse input)
        {

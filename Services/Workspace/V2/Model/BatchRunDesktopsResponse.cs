...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchRunDesktopsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchRunDesktopsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRunDesktopsResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListApplyObjectsResponse : SdkResponse
    {
        ...
        public List<ApplyObjectDetailInfo> ApplyObjects { get; set; }
        ...
        {
            return this.Equals(input as ListApplyObjectsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListApplyObjectsResponse input)
        {

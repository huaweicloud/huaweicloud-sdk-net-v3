...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowUpgradeTaskDetailResponse : SdkResponse
    {
        /// <summary>
        ...
        /// Cron表达式
        /// </summary>
        [JsonProperty("cron_expression", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// 最近执行时间
        /// </summary>
        [JsonProperty("last_execute_time", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  lastExecuteTime: ").Append(LastExecuteTime).Append("\n");
        ...
        {
            return this.Equals(input as ShowUpgradeTaskDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowUpgradeTaskDetailResponse input)
        {
            ...
            if (this.CronExpression != input.CronExpression || (this.CronExpression != null && !this.CronExpression.Equals(input.CronExpression))) return false;
            ...
            if (this.LastExecuteTime != input.LastExecuteTime || (this.LastExecuteTime != null && !this.LastExecuteTime.Equals(input.LastExecuteTime))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CronExpression != null) hashCode = hashCode * 59 + this.CronExpression.GetHashCode();
                if (this.LastExecuteStatus != null) hashCode = hashCode * 59 + this.LastExecuteStatus.GetHashCode();
                if (this.LastExecuteTime != null) hashCode = hashCode * 59 + this.LastExecuteTime.GetHashCode();

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowScriptRecordDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowScriptRecordDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowScriptRecordDetailResponse input)
        {

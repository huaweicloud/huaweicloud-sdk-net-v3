...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ExecuteDesktopPoolActionRequest 
    {
        ...
        public DesktopPoolActionReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteDesktopPoolActionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteDesktopPoolActionRequest input)
        {

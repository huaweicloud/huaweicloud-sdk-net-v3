...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDesktopNetworkResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowDesktopNetworkResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDesktopNetworkResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateMetricNotifyRuleRequest 
    {
        ...
        public UpdateMetricNotifyRuleReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMetricNotifyRuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMetricNotifyRuleRequest input)
        {

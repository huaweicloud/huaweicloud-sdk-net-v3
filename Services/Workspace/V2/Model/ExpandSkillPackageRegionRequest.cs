...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ExpandSkillPackageRegionRequest 
    {
        ...
        public ExpandSkillPackageRegionReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExpandSkillPackageRegionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExpandSkillPackageRegionRequest input)
        {

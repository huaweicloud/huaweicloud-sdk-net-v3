...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTenantVersionConfigResponse : SdkResponse
    {
        ...
        public List<TenantVersionInfo> Records { get; set; }
        ...
        {
            return this.Equals(input as ListTenantVersionConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTenantVersionConfigResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ModelGroupItemVO 
    {
        ...
        /// 关联的供应商数量。
        /// </summary>
        [JsonProperty("provider_count", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ModelGroupItemVO);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ModelGroupItemVO input)
        {
            ...
            if (this.ProviderCount != input.ProviderCount || (this.ProviderCount != null && !this.ProviderCount.Equals(input.ProviderCount))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProviderCount != null) hashCode = hashCode * 59 + this.ProviderCount.GetHashCode();

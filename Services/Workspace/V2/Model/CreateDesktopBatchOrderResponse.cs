...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateDesktopBatchOrderResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateDesktopBatchOrderResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDesktopBatchOrderResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateMetricNotifyRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateMetricNotifyRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMetricNotifyRuleResponse input)
        {

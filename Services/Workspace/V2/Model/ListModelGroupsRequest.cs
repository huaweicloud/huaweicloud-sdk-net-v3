...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ListModelGroupsRequest 
    {
        ...
        /// </summary>
        /// <value>分组状态（draft-草稿，active-活跃，inactive-停用，deprecated-废弃）。</value>
        ...
        {
            return this.Equals(input as ListModelGroupsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListModelGroupsRequest input)
        {

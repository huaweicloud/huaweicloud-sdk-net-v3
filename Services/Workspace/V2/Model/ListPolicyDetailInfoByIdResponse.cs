...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPolicyDetailInfoByIdResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListPolicyDetailInfoByIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPolicyDetailInfoByIdResponse input)
        {

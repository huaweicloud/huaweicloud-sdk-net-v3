...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSkillPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSkillPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSkillPackageResponse input)
        {

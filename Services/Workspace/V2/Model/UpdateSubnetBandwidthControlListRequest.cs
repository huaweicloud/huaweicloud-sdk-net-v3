...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateSubnetBandwidthControlListRequest 
    {
        ...
        public UpdateSubnetBandwidthControlListReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSubnetBandwidthControlListRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSubnetBandwidthControlListRequest input)
        {

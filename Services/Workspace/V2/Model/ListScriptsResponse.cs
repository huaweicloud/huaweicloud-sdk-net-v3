...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListScriptsResponse : SdkResponse
    {
        ...
        public List<ScriptSimpleInfo> Scripts { get; set; }
        ...
        {
            return this.Equals(input as ListScriptsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListScriptsResponse input)
        {

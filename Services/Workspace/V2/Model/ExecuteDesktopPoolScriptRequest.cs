...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ExecuteDesktopPoolScriptRequest 
    {
        ...
        public ExecuteDesktopPoolScriptsReq Body { get; set; }
        ...
        {
            return this.Equals(input as ExecuteDesktopPoolScriptRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExecuteDesktopPoolScriptRequest input)
        {

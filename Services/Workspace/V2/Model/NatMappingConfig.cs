...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class NatMappingConfig 
    {
        ...
        /// </summary>
        /// <value>NAT映射类型。 - PORT:端口映射. - HOST:地址映射.</value>
        ...
        /// vag端口。
        /// </summary>
        [JsonProperty("vag_port", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as NatMappingConfig);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NatMappingConfig input)
        {

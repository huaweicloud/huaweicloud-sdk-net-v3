...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateProviderResponse : SdkResponse
    {
        ...
        public List<AttachModelGroupInfo> Groups { get; set; }

        /// <summary>
        /// 下属模型列表。
        /// </summary>
        [JsonProperty("models", NullValueHandling = NullValueHandling.Ignore)]
        public List<ModelItemResp> Models { get; set; }
        ...
        {
            return this.Equals(input as UpdateProviderResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateProviderResponse input)
        {

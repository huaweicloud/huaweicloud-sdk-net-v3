...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class EstimateDesktopPoolChangeImageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as EstimateDesktopPoolChangeImageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EstimateDesktopPoolChangeImageResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ListSubnetBandwidthsRequest 
    {
        ...
        /// 云办公带宽id。
        /// </summary>
        [SDKProperty("bandwidth_id", IsQuery = true)]
        ...
        /// 云办公带宽名称。
        /// </summary>
        [SDKProperty("bandwidth_name", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListSubnetBandwidthsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubnetBandwidthsRequest input)
        {

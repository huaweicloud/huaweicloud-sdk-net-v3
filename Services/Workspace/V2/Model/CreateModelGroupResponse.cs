...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateModelGroupResponse : SdkResponse
    {
        ...
        public List<ModelGroupProviderItemResp> Providers { get; set; }
        ...
        {
            return this.Equals(input as CreateModelGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateModelGroupResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class BatchListSkillPackagesRequest 
    {
        ...
        public BatchListSkillPackagesReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchListSkillPackagesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchListSkillPackagesRequest input)
        {

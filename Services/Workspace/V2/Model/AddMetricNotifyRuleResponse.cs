...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddMetricNotifyRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddMetricNotifyRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddMetricNotifyRuleResponse input)
        {

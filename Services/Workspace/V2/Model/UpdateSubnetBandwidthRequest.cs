...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateSubnetBandwidthRequest 
    {
        ...
        public UpdateSubnetBandwidthReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSubnetBandwidthRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSubnetBandwidthRequest input)
        {

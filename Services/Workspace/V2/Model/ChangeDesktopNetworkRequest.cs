...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ChangeDesktopNetworkRequest 
    {
        ...
        public ChangeDesktopNetworkReq Body { get; set; }
        ...
        {
            return this.Equals(input as ChangeDesktopNetworkRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ChangeDesktopNetworkRequest input)
        {

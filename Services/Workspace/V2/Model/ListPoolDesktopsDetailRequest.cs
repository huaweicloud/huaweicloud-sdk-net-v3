...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class ListPoolDesktopsDetailRequest 
    {
        ...
        [JsonConverter(typeof(EnumClassConverter<InconsistentTypeEnum>))]
        public class InconsistentTypeEnum
        {
            /// <summary>
            /// Enum PRODUCT_ID for value: PRODUCT_ID
            /// </summary>
            public static readonly InconsistentTypeEnum PRODUCT_ID = new InconsistentTypeEnum("PRODUCT_ID");

            /// <summary>
            /// Enum IMAGE_ID for value: IMAGE_ID
            /// </summary>
            public static readonly InconsistentTypeEnum IMAGE_ID = new InconsistentTypeEnum("IMAGE_ID");

            /// <summary>
            /// Enum DISK_NUM for value: DISK_NUM
            /// </summary>
            public static readonly InconsistentTypeEnum DISK_NUM = new InconsistentTypeEnum("DISK_NUM");
            ...
            public InconsistentTypeEnum()
            {

            }

            public InconsistentTypeEnum(string value)
            {
                _value = value;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as InconsistentTypeEnum))
                {
                    return true;
                }
            ...
            public bool Equals(InconsistentTypeEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(InconsistentTypeEnum a, InconsistentTypeEnum b)
            {
        ...
        public bool Equals(ListPoolDesktopsDetailRequest input)
        {
            ...
            if (this.InconsistentType != input.InconsistentType) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.InconsistentType.GetHashCode();

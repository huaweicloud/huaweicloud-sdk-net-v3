...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ApplySubnetBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ApplySubnetBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ApplySubnetBandwidthResponse input)
        {

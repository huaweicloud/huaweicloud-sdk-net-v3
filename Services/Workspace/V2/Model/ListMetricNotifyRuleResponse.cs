...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMetricNotifyRuleResponse : SdkResponse
    {
        ...
        public List<MetricNotifyRule> Items { get; set; }
        ...
        {
            return this.Equals(input as ListMetricNotifyRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMetricNotifyRuleResponse input)
        {

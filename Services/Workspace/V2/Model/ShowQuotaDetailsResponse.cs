...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowQuotaDetailsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowQuotaDetailsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowQuotaDetailsResponse input)
        {

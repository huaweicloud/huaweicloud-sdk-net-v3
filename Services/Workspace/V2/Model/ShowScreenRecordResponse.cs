...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowScreenRecordResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowScreenRecordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowScreenRecordResponse input)
        {

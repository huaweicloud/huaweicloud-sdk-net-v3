...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteProvidersResponse : SdkResponse
    {
        ...
        public List<BatchOperationFailedItem> FailedDetails { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteProvidersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteProvidersResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchBindProvidersResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchBindProvidersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchBindProvidersResponse input)
        {

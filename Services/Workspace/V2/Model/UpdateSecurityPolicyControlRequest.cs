...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateSecurityPolicyControlRequest 
    {
        ...
        public UpdateSecurityPolicyControlReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSecurityPolicyControlRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecurityPolicyControlRequest input)
        {

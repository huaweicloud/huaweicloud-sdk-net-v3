...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// 
    /// </summary>
    public class ImportIpRequestBody : IFormDataBody
    {
        ...
        public ImportIpRequestBody WithFile(Stream stream, string filename)
        {
            this.File = new FormDataFilePart(stream, filename);
            return this;
        }

        public ImportIpRequestBody WithFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as ImportIpRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportIpRequestBody input)
        {

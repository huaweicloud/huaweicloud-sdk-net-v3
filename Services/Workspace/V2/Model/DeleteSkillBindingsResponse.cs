...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteSkillBindingsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteSkillBindingsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteSkillBindingsResponse input)
        {

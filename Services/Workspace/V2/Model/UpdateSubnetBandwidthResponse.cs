...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSubnetBandwidthResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSubnetBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSubnetBandwidthResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class UpdateAuthConfigRequest 
    {
        ...
        /// 认证配置ID
        /// </summary>
        [SDKProperty("auth_config_id", IsPath = true)]
        ...
        public UpdateAuthConfigReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateAuthConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAuthConfigRequest input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateModelGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateModelGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateModelGroupResponse input)
        {

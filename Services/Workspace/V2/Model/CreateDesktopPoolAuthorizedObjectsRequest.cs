...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class CreateDesktopPoolAuthorizedObjectsRequest 
    {
        ...
        public CreateDesktopPoolAuthorizedObjectsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateDesktopPoolAuthorizedObjectsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateDesktopPoolAuthorizedObjectsRequest input)
        {

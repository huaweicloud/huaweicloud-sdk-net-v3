...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListUsersOfGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListUsersOfGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListUsersOfGroupResponse input)
        {

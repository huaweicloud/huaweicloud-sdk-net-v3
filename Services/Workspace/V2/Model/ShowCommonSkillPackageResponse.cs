...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowCommonSkillPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowCommonSkillPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowCommonSkillPackageResponse input)
        {

...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProviderTemplatesResponse : SdkResponse
    {
        ...
        public List<ProviderTemplateInfo> Templates { get; set; }
        ...
        {
            return this.Equals(input as ListProviderTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProviderTemplatesResponse input)
        {

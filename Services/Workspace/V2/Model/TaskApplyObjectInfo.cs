...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class TaskApplyObjectInfo 
    {
        ...
        /// </summary>
        /// <value>应用对象类型，包括DESKTOP（单桌面）、ALL_DESKTOPS（全部桌面）、DESKTOP_POOL（桌面池）、DESKTOP_TAG（桌面标签）、ALL_USERS（全部用户）、USER（单个用户）、USER_GROUP（用户组）、ALL_IMAGES（全部镜像）、APPLICATION_SERVER（应用服务器）、APPLICATION_SERVER_GROUP（应用服务器组）</value>
        ...
        public class ObjectTypeEnum
        {
            ...
            /// </summary>
            public static readonly ObjectTypeEnum ALL_IMAGES = new ObjectTypeEnum("ALL_IMAGES");

            /// <summary>
            /// Enum APPLICATION_SERVER for value: APPLICATION_SERVER
            /// </summary>
            public static readonly ObjectTypeEnum APPLICATION_SERVER = new ObjectTypeEnum("APPLICATION_SERVER");

            /// <summary>
            /// Enum APPLICATION_SERVER_GROUP for value: APPLICATION_SERVER_GROUP
            /// </summary>
            public static readonly ObjectTypeEnum APPLICATION_SERVER_GROUP = new ObjectTypeEnum("APPLICATION_SERVER_GROUP");
        ...
        {
            return this.Equals(input as TaskApplyObjectInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(TaskApplyObjectInfo input)
        {

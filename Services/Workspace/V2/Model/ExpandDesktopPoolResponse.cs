...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ExpandDesktopPoolResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ExpandDesktopPoolResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExpandDesktopPoolResponse input)
        {

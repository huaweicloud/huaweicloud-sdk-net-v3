...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSkillPackageResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSkillPackageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSkillPackageResponse input)
        {

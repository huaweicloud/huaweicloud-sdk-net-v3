...
namespace HuaweiCloud.SDK.Workspace.V2.Model
{
    ...
    public class BatchUpdateTargetOfPolicyGroupRequest 
    {
        ...
        public ModifyPolicyTargetReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateTargetOfPolicyGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateTargetOfPolicyGroupRequest input)
        {

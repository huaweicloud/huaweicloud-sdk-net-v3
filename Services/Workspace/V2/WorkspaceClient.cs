...
namespace HuaweiCloud.SDK.Workspace.V2
{
    public partial class WorkspaceClient : Client
    {
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportIpTemplateResponse ExportIpTemplate(ExportIpTemplateRequest exportIpTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportIpTemplateResponse> ExportIpTemplateInvoker(ExportIpTemplateRequest exportIpTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/ip/template/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportIpTemplateRequest);
            return new SyncInvoker<ExportIpTemplateResponse>(this, "GET", request, JsonUtils.DeSerializeNull<ExportIpTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ImportIpResponse ImportIp(ImportIpRequest importIpRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ImportIpResponse> ImportIpInvoker(ImportIpRequest importIpRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/ip/import", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "multipart/form-data", importIpRequest);
            return new SyncInvoker<ImportIpResponse>(this, "POST", request, JsonUtils.DeSerialize<ImportIpResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSubscribeAiAssistantUsersResponse ListSubscribeAiAssistantUsers(ListSubscribeAiAssistantUsersRequest listSubscribeAiAssistantUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSubscribeAiAssistantUsersResponse> ListSubscribeAiAssistantUsersInvoker(ListSubscribeAiAssistantUsersRequest listSubscribeAiAssistantUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/users/ai-assistant/subscribe", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSubscribeAiAssistantUsersRequest);
            return new SyncInvoker<ListSubscribeAiAssistantUsersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSubscribeAiAssistantUsersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAiAssistantUsageFrequencyResponse ShowAiAssistantUsageFrequency(ShowAiAssistantUsageFrequencyRequest showAiAssistantUsageFrequencyRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAiAssistantUsageFrequencyResponse> ShowAiAssistantUsageFrequencyInvoker(ShowAiAssistantUsageFrequencyRequest showAiAssistantUsageFrequencyRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/users/ai-assistant/statistics/usage-frequency", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAiAssistantUsageFrequencyRequest);
            return new SyncInvoker<ShowAiAssistantUsageFrequencyResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAiAssistantUsageFrequencyResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SubscribeAiAssistantResponse SubscribeAiAssistant(SubscribeAiAssistantRequest subscribeAiAssistantRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/users/ai-assistant/subscribe", urlParam);
        ...
        public SyncInvoker<SubscribeAiAssistantResponse> SubscribeAiAssistantInvoker(SubscribeAiAssistantRequest subscribeAiAssistantRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/users/ai-assistant/subscribe", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", subscribeAiAssistantRequest);
            return new SyncInvoker<SubscribeAiAssistantResponse>(this, "POST", request, JsonUtils.DeSerializeNull<SubscribeAiAssistantResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DownloadMetadataResponse DownloadMetadata(DownloadMetadataRequest downloadMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DownloadMetadataResponse> DownloadMetadataInvoker(DownloadMetadataRequest downloadMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/auth-config/saml2/metadata", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadMetadataRequest);
            return new SyncInvoker<DownloadMetadataResponse>(this, "GET", request, JsonUtils.DeSerializeNull<DownloadMetadataResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DownloadSpMetadataResponse DownloadSpMetadata(DownloadSpMetadataRequest downloadSpMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DownloadSpMetadataResponse> DownloadSpMetadataInvoker(DownloadSpMetadataRequest downloadSpMetadataRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/auth-config/saml2/sp/metadata", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadSpMetadataRequest);
            return new SyncInvoker<DownloadSpMetadataResponse>(this, "GET", request, JsonUtils.DeSerializeNull<DownloadSpMetadataResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowAssistAuthConfigApplyObjectsResponse ShowAssistAuthConfigApplyObjects(ShowAssistAuthConfigApplyObjectsRequest showAssistAuthConfigApplyObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowAssistAuthConfigApplyObjectsResponse> ShowAssistAuthConfigApplyObjectsInvoker(ShowAssistAuthConfigApplyObjectsRequest showAssistAuthConfigApplyObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/assist-auth-config/apply-objects", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showAssistAuthConfigApplyObjectsRequest);
            return new SyncInvoker<ShowAssistAuthConfigApplyObjectsResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowAssistAuthConfigApplyObjectsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateAssistAuthConfigApplyObjectsResponse UpdateAssistAuthConfigApplyObjects(UpdateAssistAuthConfigApplyObjectsRequest updateAssistAuthConfigApplyObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/assist-auth-config/apply-objects", urlParam);
        ...
        public SyncInvoker<UpdateAssistAuthConfigApplyObjectsResponse> UpdateAssistAuthConfigApplyObjectsInvoker(UpdateAssistAuthConfigApplyObjectsRequest updateAssistAuthConfigApplyObjectsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/assist-auth-config/apply-objects", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateAssistAuthConfigApplyObjectsRequest);
            return new SyncInvoker<UpdateAssistAuthConfigApplyObjectsResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UpdateAssistAuthConfigApplyObjectsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ValidateConfigResponse ValidateConfig(ValidateConfigRequest validateConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ValidateConfigResponse> ValidateConfigInvoker(ValidateConfigRequest validateConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/auth-config/validate-config", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", validateConfigRequest);
            return new SyncInvoker<ValidateConfigResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ValidateConfigResponse>);
        }
        ...
        public SyncInvoker<CreateCertResponse> CreateCertInvoker(CreateCertRequest createCertRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createCertRequest);
            return new SyncInvoker<CreateCertResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CreateCertResponse>);
        }
        ...
        public SyncInvoker<DeleteCertResponse> DeleteCertInvoker(DeleteCertRequest deleteCertRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteCertRequest.CertId, out var valueOfCertId)) urlParam.Add("cert_id", valueOfCertId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteCertRequest);
            return new SyncInvoker<DeleteCertResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteCertResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportCertCrlFileResponse ExportCertCrlFile(ExportCertCrlFileRequest exportCertCrlFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportCertCrlFileResponse> ExportCertCrlFileInvoker(ExportCertCrlFileRequest exportCertCrlFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(exportCertCrlFileRequest.CertId, out var valueOfCertId)) urlParam.Add("cert_id", valueOfCertId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}/crl", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportCertCrlFileRequest);
            return new SyncInvoker<ExportCertCrlFileResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ExportCertCrlFileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportCertCsrFileResponse ExportCertCsrFile(ExportCertCsrFileRequest exportCertCsrFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportCertCsrFileResponse> ExportCertCsrFileInvoker(ExportCertCsrFileRequest exportCertCsrFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/csr", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportCertCsrFileRequest);
            return new SyncInvoker<ExportCertCsrFileResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ExportCertCsrFileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportCertPemFileResponse ExportCertPemFile(ExportCertPemFileRequest exportCertPemFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportCertPemFileResponse> ExportCertPemFileInvoker(ExportCertPemFileRequest exportCertPemFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(exportCertPemFileRequest.CertId, out var valueOfCertId)) urlParam.Add("cert_id", valueOfCertId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportCertPemFileRequest);
            return new SyncInvoker<ExportCertPemFileResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ExportCertPemFileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ImportCertResponse ImportCert(ImportCertRequest importCertRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ImportCertResponse> ImportCertInvoker(ImportCertRequest importCertRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/import", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", importCertRequest);
            return new SyncInvoker<ImportCertResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ImportCertResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCertsResponse ListCerts(ListCertsRequest listCertsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities", urlParam);
        ...
        public SyncInvoker<ListCertsResponse> ListCertsInvoker(ListCertsRequest listCertsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCertsRequest);
            return new SyncInvoker<ListCertsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCertsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SetCertStatusResponse SetCertStatus(SetCertStatusRequest setCertStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SetCertStatusResponse> SetCertStatusInvoker(SetCertStatusRequest setCertStatusRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(setCertStatusRequest.CertId, out var valueOfCertId)) urlParam.Add("cert_id", valueOfCertId);
            if (StringUtils.TryConvertToNonEmptyString(setCertStatusRequest.Status, out var valueOfStatus)) urlParam.Add("status", valueOfStatus);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}/status/{status}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", setCertStatusRequest);
            return new SyncInvoker<SetCertStatusResponse>(this, "POST", request, JsonUtils.DeSerializeNull<SetCertStatusResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowCertDetailResponse ShowCertDetail(ShowCertDetailRequest showCertDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowCertDetailResponse> ShowCertDetailInvoker(ShowCertDetailRequest showCertDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showCertDetailRequest.CertId, out var valueOfCertId)) urlParam.Add("cert_id", valueOfCertId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCertDetailRequest);
            return new SyncInvoker<ShowCertDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCertDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckDesktopImagesResponse CheckDesktopImages(CheckDesktopImagesRequest checkDesktopImagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckDesktopImagesResponse> CheckDesktopImagesInvoker(CheckDesktopImagesRequest checkDesktopImagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/desktops/check-images", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkDesktopImagesRequest);
            return new SyncInvoker<CheckDesktopImagesResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckDesktopImagesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckSysprepInfoResponse CheckSysprepInfo(CheckSysprepInfoRequest checkSysprepInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckSysprepInfoResponse> CheckSysprepInfoInvoker(CheckSysprepInfoRequest checkSysprepInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/sysprep", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkSysprepInfoRequest);
            return new SyncInvoker<CheckSysprepInfoResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckSysprepInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCommonSkillsResponse ListCommonSkills(ListCommonSkillsRequest listCommonSkillsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCommonSkillsResponse> ListCommonSkillsInvoker(ListCommonSkillsRequest listCommonSkillsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/common-skills", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCommonSkillsRequest);
            return new SyncInvoker<ListCommonSkillsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCommonSkillsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowCommonSkillResponse ShowCommonSkill(ShowCommonSkillRequest showCommonSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowCommonSkillResponse> ShowCommonSkillInvoker(ShowCommonSkillRequest showCommonSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showCommonSkillRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/common-skills/{skill_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCommonSkillRequest);
            return new SyncInvoker<ShowCommonSkillResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCommonSkillResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUserConnectionNewResponse ExportUserConnectionNew(ExportUserConnectionNewRequest exportUserConnectionNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUserConnectionNewResponse> ExportUserConnectionNewInvoker(ExportUserConnectionNewRequest exportUserConnectionNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/desktops/connections/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUserConnectionNewRequest);
            return new SyncInvoker<ExportUserConnectionNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ExportUserConnectionNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public AttachDesktopPoolUserResponse AttachDesktopPoolUser(AttachDesktopPoolUserRequest attachDesktopPoolUserRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<AttachDesktopPoolUserResponse> AttachDesktopPoolUserInvoker(AttachDesktopPoolUserRequest attachDesktopPoolUserRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(attachDesktopPoolUserRequest.PoolId, out var valueOfPoolId)) urlParam.Add("pool_id", valueOfPoolId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/desktop-pools/{pool_id}/attach", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", attachDesktopPoolUserRequest);
            return new SyncInvoker<AttachDesktopPoolUserResponse>(this, "POST", request, JsonUtils.DeSerialize<AttachDesktopPoolUserResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDesktopPoolsByUsersResponse ListDesktopPoolsByUsers(ListDesktopPoolsByUsersRequest listDesktopPoolsByUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDesktopPoolsByUsersResponse> ListDesktopPoolsByUsersInvoker(ListDesktopPoolsByUsersRequest listDesktopPoolsByUsersRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/desktop-pools/statistics/by-users", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDesktopPoolsByUsersRequest);
            return new SyncInvoker<ListDesktopPoolsByUsersResponse>(this, "GET", request, JsonUtils.DeSerialize<ListDesktopPoolsByUsersResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInconsistentStaticsResponse ListInconsistentStatics(ListInconsistentStaticsRequest listInconsistentStaticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInconsistentStaticsResponse> ListInconsistentStaticsInvoker(ListInconsistentStaticsRequest listInconsistentStaticsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInconsistentStaticsRequest.PoolId, out var valueOfPoolId)) urlParam.Add("pool_id", valueOfPoolId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/desktop-pools/{pool_id}/inconsistent-statics", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInconsistentStaticsRequest);
            return new SyncInvoker<ListInconsistentStaticsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInconsistentStaticsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListDesktopsByTagsResponse ListDesktopsByTags(ListDesktopsByTagsRequest listDesktopsByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListDesktopsByTagsResponse> ListDesktopsByTagsInvoker(ListDesktopsByTagsRequest listDesktopsByTagsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/desktops/resource-instances/action", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listDesktopsByTagsRequest);
            return new SyncInvoker<ListDesktopsByTagsResponse>(this, "POST", request, JsonUtils.DeSerialize<ListDesktopsByTagsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportDesktopListNewResponse ExportDesktopListNew(ExportDesktopListNewRequest exportDesktopListNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportDesktopListNewResponse> ExportDesktopListNewInvoker(ExportDesktopListNewRequest exportDesktopListNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/desktops/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportDesktopListNewRequest);
            return new SyncInvoker<ExportDesktopListNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ExportDesktopListNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowHibernateTypeResponse ShowHibernateType(ShowHibernateTypeRequest showHibernateTypeRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowHibernateTypeResponse> ShowHibernateTypeInvoker(ShowHibernateTypeRequest showHibernateTypeRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/hibernate-type", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showHibernateTypeRequest);
            return new SyncInvoker<ShowHibernateTypeResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowHibernateTypeResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteExportTasksResponse DeleteExportTasks(DeleteExportTasksRequest deleteExportTasksRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteExportTasksResponse> DeleteExportTasksInvoker(DeleteExportTasksRequest deleteExportTasksRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/export-tasks/batch-delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", deleteExportTasksRequest);
            return new SyncInvoker<DeleteExportTasksResponse>(this, "POST", request, JsonUtils.DeSerializeNull<DeleteExportTasksResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DownloadExportFileResponse DownloadExportFile(DownloadExportFileRequest downloadExportFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DownloadExportFileResponse> DownloadExportFileInvoker(DownloadExportFileRequest downloadExportFileRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(downloadExportFileRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/export-tasks/{task_id}/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", downloadExportFileRequest);
            return new SyncInvoker<DownloadExportFileResponse>(this, "GET", request, JsonUtils.DeSerializeNull<DownloadExportFileResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUserGroupsResponse ExportUserGroups(ExportUserGroupsRequest exportUserGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUserGroupsResponse> ExportUserGroupsInvoker(ExportUserGroupsRequest exportUserGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/groups/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUserGroupsRequest);
            return new SyncInvoker<ExportUserGroupsResponse>(this, "GET", request, JsonUtils.DeSerializeNull<ExportUserGroupsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUserGroupUsersNewResponse ExportUserGroupUsersNew(ExportUserGroupUsersNewRequest exportUserGroupUsersNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUserGroupUsersNewResponse> ExportUserGroupUsersNewInvoker(ExportUserGroupUsersNewRequest exportUserGroupUsersNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(exportUserGroupUsersNewRequest.GroupId, out var valueOfGroupId)) urlParam.Add("group_id", valueOfGroupId);
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/groups/{group_id}/users/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUserGroupUsersNewRequest);
            return new SyncInvoker<ExportUserGroupUsersNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ExportUserGroupUsersNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListHostsDetailResponse ListHostsDetail(ListHostsDetailRequest listHostsDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListHostsDetailResponse> ListHostsDetailInvoker(ListHostsDetailRequest listHostsDetailRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/hosts", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listHostsDetailRequest);
            return new SyncInvoker<ListHostsDetailResponse>(this, "GET", request, JsonUtils.DeSerialize<ListHostsDetailResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListServersByHostIdResponse ListServersByHostId(ListServersByHostIdRequest listServersByHostIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListServersByHostIdResponse> ListServersByHostIdInvoker(ListServersByHostIdRequest listServersByHostIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listServersByHostIdRequest.HostId, out var valueOfHostId)) urlParam.Add("host_id", valueOfHostId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/hosts/{host_id}/servers", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listServersByHostIdRequest);
            return new SyncInvoker<ListServersByHostIdResponse>(this, "GET", request, JsonUtils.DeSerialize<ListServersByHostIdResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateHostsResponse UpdateHosts(UpdateHostsRequest updateHostsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/hosts", urlParam);
        ...
        public SyncInvoker<UpdateHostsResponse> UpdateHostsInvoker(UpdateHostsRequest updateHostsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/hosts", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateHostsRequest);
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckCidrResponse CheckCidr(CheckCidrRequest checkCidrRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckCidrResponse> CheckCidrInvoker(CheckCidrRequest checkCidrRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/check-cidr", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkCidrRequest);
            return new SyncInvoker<CheckCidrResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckCidrResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListVpcInfoResponse ListVpcInfo(ListVpcInfoRequest listVpcInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListVpcInfoResponse> ListVpcInfoInvoker(ListVpcInfoRequest listVpcInfoRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/vpcs", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listVpcInfoRequest);
            return new SyncInvoker<ListVpcInfoResponse>(this, "GET", request, JsonUtils.DeSerialize<ListVpcInfoResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateResourcePackagesOrderResponse CreateResourcePackagesOrder(CreateResourcePackagesOrderRequest createResourcePackagesOrderRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateResourcePackagesOrderResponse> CreateResourcePackagesOrderInvoker(CreateResourcePackagesOrderRequest createResourcePackagesOrderRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/resource-packages/order", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createResourcePackagesOrderRequest);
            return new SyncInvoker<CreateResourcePackagesOrderResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateResourcePackagesOrderResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportPolicyGroupsResponse ExportPolicyGroups(ExportPolicyGroupsRequest exportPolicyGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportPolicyGroupsResponse> ExportPolicyGroupsInvoker(ExportPolicyGroupsRequest exportPolicyGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/policy-groups/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportPolicyGroupsRequest);
            return new SyncInvoker<ExportPolicyGroupsResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ExportPolicyGroupsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ImportPolicyGroupsResponse ImportPolicyGroups(ImportPolicyGroupsRequest importPolicyGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ImportPolicyGroupsResponse> ImportPolicyGroupsInvoker(ImportPolicyGroupsRequest importPolicyGroupsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/policy-groups/import", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "multipart/form-data", importPolicyGroupsRequest);
            return new SyncInvoker<ImportPolicyGroupsResponse>(this, "POST", request, JsonUtils.DeSerialize<ImportPolicyGroupsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListResourcePackagesResponse ListResourcePackages(ListResourcePackagesRequest listResourcePackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListResourcePackagesResponse> ListResourcePackagesInvoker(ListResourcePackagesRequest listResourcePackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/products/resource-packages", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listResourcePackagesRequest);
            return new SyncInvoker<ListResourcePackagesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListResourcePackagesResponse>);
        }
        ...
        public SyncInvoker<CreateScheduledTasksResponse> CreateScheduledTasksInvoker(CreateScheduledTasksRequest createScheduledTasksRequest)
        {
            ...
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/scheduled-tasks", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createScheduledTasksRequest);
            return new SyncInvoker<CreateScheduledTasksResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateScheduledTasksResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportScheduledTasksRecordsResponse ExportScheduledTasksRecords(ExportScheduledTasksRecordsRequest exportScheduledTasksRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportScheduledTasksRecordsResponse> ExportScheduledTasksRecordsInvoker(ExportScheduledTasksRecordsRequest exportScheduledTasksRecordsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(exportScheduledTasksRecordsRequest.TaskId, out var valueOfTaskId)) urlParam.Add("task_id", valueOfTaskId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/scheduled-tasks/{task_id}/records/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportScheduledTasksRecordsRequest);
            return new SyncInvoker<ExportScheduledTasksRecordsResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ExportScheduledTasksRecordsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListLifeCycleTypeConfigurationsResponse ListLifeCycleTypeConfigurations(ListLifeCycleTypeConfigurationsRequest listLifeCycleTypeConfigurationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListLifeCycleTypeConfigurationsResponse> ListLifeCycleTypeConfigurationsInvoker(ListLifeCycleTypeConfigurationsRequest listLifeCycleTypeConfigurationsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/scheduled-tasks/life-cycle-type/configurations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listLifeCycleTypeConfigurationsRequest);
            return new SyncInvoker<ListLifeCycleTypeConfigurationsResponse>(this, "GET", request, response =>
            {
                var listLifeCycleTypeConfigurationsResponse = JsonUtils.DeSerializeNull<ListLifeCycleTypeConfigurationsResponse>(response);
                listLifeCycleTypeConfigurationsResponse.Body = JsonUtils.DeSerializeMap<string, LifeCycleTypeConfigRsp>(response);
                return listLifeCycleTypeConfigurationsResponse;
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListScreenRecordsTrafficLimitConfigResponse ListScreenRecordsTrafficLimitConfig(ListScreenRecordsTrafficLimitConfigRequest listScreenRecordsTrafficLimitConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListScreenRecordsTrafficLimitConfigResponse> ListScreenRecordsTrafficLimitConfigInvoker(ListScreenRecordsTrafficLimitConfigRequest listScreenRecordsTrafficLimitConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/screen-records/traffic-limit/configurations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listScreenRecordsTrafficLimitConfigRequest);
            return new SyncInvoker<ListScreenRecordsTrafficLimitConfigResponse>(this, "GET", request, JsonUtils.DeSerialize<ListScreenRecordsTrafficLimitConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateScreenRecordsTrafficLimitConfigResponse UpdateScreenRecordsTrafficLimitConfig(UpdateScreenRecordsTrafficLimitConfigRequest updateScreenRecordsTrafficLimitConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/screen-records/traffic-limit/configurations", urlParam);
        ...
        public SyncInvoker<UpdateScreenRecordsTrafficLimitConfigResponse> UpdateScreenRecordsTrafficLimitConfigInvoker(UpdateScreenRecordsTrafficLimitConfigRequest updateScreenRecordsTrafficLimitConfigRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/screen-records/traffic-limit/configurations", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=utf-8", updateScreenRecordsTrafficLimitConfigRequest);
            return new SyncInvoker<UpdateScreenRecordsTrafficLimitConfigResponse>(this, "POST", request, JsonUtils.DeSerializeNull<UpdateScreenRecordsTrafficLimitConfigResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExecuteScriptByDesktopTagResponse ExecuteScriptByDesktopTag(ExecuteScriptByDesktopTagRequest executeScriptByDesktopTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExecuteScriptByDesktopTagResponse> ExecuteScriptByDesktopTagInvoker(ExecuteScriptByDesktopTagRequest executeScriptByDesktopTagRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/script-executions/by-desktop-tag", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", executeScriptByDesktopTagRequest);
            return new SyncInvoker<ExecuteScriptByDesktopTagResponse>(this, "POST", request, JsonUtils.DeSerialize<ExecuteScriptByDesktopTagResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckEdgeSiteResourcesResponse CheckEdgeSiteResources(CheckEdgeSiteResourcesRequest checkEdgeSiteResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckEdgeSiteResourcesResponse> CheckEdgeSiteResourcesInvoker(CheckEdgeSiteResourcesRequest checkEdgeSiteResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/check-edge-site-resources", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkEdgeSiteResourcesRequest);
            return new SyncInvoker<CheckEdgeSiteResourcesResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckEdgeSiteResourcesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateDcVncResponse UpdateDcVnc(UpdateDcVncRequest updateDcVncRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateDcVncResponse> UpdateDcVncInvoker(UpdateDcVncRequest updateDcVncRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateDcVncRequest.SiteId, out var valueOfSiteId)) urlParam.Add("site_id", valueOfSiteId);
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/sites/{site_id}/dc-vnc", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateDcVncRequest);
            return new SyncInvoker<UpdateDcVncResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateDcVncResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateSkillBindingsResponse CreateSkillBindings(CreateSkillBindingsRequest createSkillBindingsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateSkillBindingsResponse> CreateSkillBindingsInvoker(CreateSkillBindingsRequest createSkillBindingsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skill-bindings", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSkillBindingsRequest);
            return new SyncInvoker<CreateSkillBindingsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateSkillBindingsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteSkillBindingsResponse DeleteSkillBindings(DeleteSkillBindingsRequest deleteSkillBindingsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteSkillBindingsResponse> DeleteSkillBindingsInvoker(DeleteSkillBindingsRequest deleteSkillBindingsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skill-bindings/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteSkillBindingsRequest);
            return new SyncInvoker<DeleteSkillBindingsResponse>(this, "POST", request, JsonUtils.DeSerialize<DeleteSkillBindingsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCommonSkillResourcesResponse ListCommonSkillResources(ListCommonSkillResourcesRequest listCommonSkillResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCommonSkillResourcesResponse> ListCommonSkillResourcesInvoker(ListCommonSkillResourcesRequest listCommonSkillResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listCommonSkillResourcesRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/common-skills/{skill_id}/resources", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCommonSkillResourcesRequest);
            return new SyncInvoker<ListCommonSkillResourcesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCommonSkillResourcesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListInstanceSkillsResponse ListInstanceSkills(ListInstanceSkillsRequest listInstanceSkillsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListInstanceSkillsResponse> ListInstanceSkillsInvoker(ListInstanceSkillsRequest listInstanceSkillsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listInstanceSkillsRequest.InstanceId, out var valueOfInstanceId)) urlParam.Add("instance_id", valueOfInstanceId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/instances/{instance_id}/skills", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listInstanceSkillsRequest);
            return new SyncInvoker<ListInstanceSkillsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListInstanceSkillsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSecurityPolicyControlResourcesResponse ListSecurityPolicyControlResources(ListSecurityPolicyControlResourcesRequest listSecurityPolicyControlResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSecurityPolicyControlResourcesResponse> ListSecurityPolicyControlResourcesInvoker(ListSecurityPolicyControlResourcesRequest listSecurityPolicyControlResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/security-policy-control/resources", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSecurityPolicyControlResourcesRequest);
            return new SyncInvoker<ListSecurityPolicyControlResourcesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSecurityPolicyControlResourcesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSkillResourcesResponse ListSkillResources(ListSkillResourcesRequest listSkillResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSkillResourcesResponse> ListSkillResourcesInvoker(ListSkillResourcesRequest listSkillResourcesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSkillResourcesRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/resources", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSkillResourcesRequest);
            return new SyncInvoker<ListSkillResourcesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSkillResourcesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateSecurityPolicyControlResponse UpdateSecurityPolicyControl(UpdateSecurityPolicyControlRequest updateSecurityPolicyControlRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateSecurityPolicyControlResponse> UpdateSecurityPolicyControlInvoker(UpdateSecurityPolicyControlRequest updateSecurityPolicyControlRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/security-policy-control", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateSecurityPolicyControlRequest);
            return new SyncInvoker<UpdateSecurityPolicyControlResponse>(this, "POST", request, JsonUtils.DeSerialize<UpdateSecurityPolicyControlResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchListSkillPackagesResponse BatchListSkillPackages(BatchListSkillPackagesRequest batchListSkillPackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchListSkillPackagesResponse> BatchListSkillPackagesInvoker(BatchListSkillPackagesRequest batchListSkillPackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skill-packages/batch-query", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchListSkillPackagesRequest);
            return new SyncInvoker<BatchListSkillPackagesResponse>(this, "POST", request, JsonUtils.DeSerialize<BatchListSkillPackagesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateDownloadUrlResponse CreateDownloadUrl(CreateDownloadUrlRequest createDownloadUrlRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateDownloadUrlResponse> CreateDownloadUrlInvoker(CreateDownloadUrlRequest createDownloadUrlRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createDownloadUrlRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(createDownloadUrlRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}/download-url", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDownloadUrlRequest);
            return new SyncInvoker<CreateDownloadUrlResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateDownloadUrlResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateSkillPackageResponse CreateSkillPackage(CreateSkillPackageRequest createSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateSkillPackageResponse> CreateSkillPackageInvoker(CreateSkillPackageRequest createSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(createSkillPackageRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSkillPackageRequest);
            return new SyncInvoker<CreateSkillPackageResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateSkillPackageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateUploadUrlsResponse CreateUploadUrls(CreateUploadUrlsRequest createUploadUrlsRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CreateUploadUrlsResponse> CreateUploadUrlsInvoker(CreateUploadUrlsRequest createUploadUrlsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skill-packages/upload-urls", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createUploadUrlsRequest);
            return new SyncInvoker<CreateUploadUrlsResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateUploadUrlsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public DeleteSkillPackageResponse DeleteSkillPackage(DeleteSkillPackageRequest deleteSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<DeleteSkillPackageResponse> DeleteSkillPackageInvoker(DeleteSkillPackageRequest deleteSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteSkillPackageRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(deleteSkillPackageRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteSkillPackageRequest);
            return new SyncInvoker<DeleteSkillPackageResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteSkillPackageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExpandSkillPackageRegionResponse ExpandSkillPackageRegion(ExpandSkillPackageRegionRequest expandSkillPackageRegionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExpandSkillPackageRegionResponse> ExpandSkillPackageRegionInvoker(ExpandSkillPackageRegionRequest expandSkillPackageRegionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(expandSkillPackageRegionRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(expandSkillPackageRegionRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}/regions", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", expandSkillPackageRegionRequest);
            return new SyncInvoker<ExpandSkillPackageRegionResponse>(this, "POST", request, JsonUtils.DeSerialize<ExpandSkillPackageRegionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListCommonSkillPackagesResponse ListCommonSkillPackages(ListCommonSkillPackagesRequest listCommonSkillPackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListCommonSkillPackagesResponse> ListCommonSkillPackagesInvoker(ListCommonSkillPackagesRequest listCommonSkillPackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listCommonSkillPackagesRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/common-skills/{skill_id}/packages", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listCommonSkillPackagesRequest);
            return new SyncInvoker<ListCommonSkillPackagesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListCommonSkillPackagesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ListSkillPackagesResponse ListSkillPackages(ListSkillPackagesRequest listSkillPackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ListSkillPackagesResponse> ListSkillPackagesInvoker(ListSkillPackagesRequest listSkillPackagesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(listSkillPackagesRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSkillPackagesRequest);
            return new SyncInvoker<ListSkillPackagesResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSkillPackagesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public RemoveSkillPackageRegionResponse RemoveSkillPackageRegion(RemoveSkillPackageRegionRequest removeSkillPackageRegionRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<RemoveSkillPackageRegionResponse> RemoveSkillPackageRegionInvoker(RemoveSkillPackageRegionRequest removeSkillPackageRegionRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(removeSkillPackageRegionRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(removeSkillPackageRegionRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}/regions/delete", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", removeSkillPackageRegionRequest);
            return new SyncInvoker<RemoveSkillPackageRegionResponse>(this, "POST", request, JsonUtils.DeSerialize<RemoveSkillPackageRegionResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowCommonSkillPackageResponse ShowCommonSkillPackage(ShowCommonSkillPackageRequest showCommonSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowCommonSkillPackageResponse> ShowCommonSkillPackageInvoker(ShowCommonSkillPackageRequest showCommonSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showCommonSkillPackageRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(showCommonSkillPackageRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/common-skills/{skill_id}/packages/{package_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showCommonSkillPackageRequest);
            return new SyncInvoker<ShowCommonSkillPackageResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowCommonSkillPackageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSkillPackageResponse ShowSkillPackage(ShowSkillPackageRequest showSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSkillPackageResponse> ShowSkillPackageInvoker(ShowSkillPackageRequest showSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSkillPackageRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(showSkillPackageRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSkillPackageRequest);
            return new SyncInvoker<ShowSkillPackageResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSkillPackageResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateSkillPackageResponse UpdateSkillPackage(UpdateSkillPackageRequest updateSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<UpdateSkillPackageResponse> UpdateSkillPackageInvoker(UpdateSkillPackageRequest updateSkillPackageRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateSkillPackageRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            if (StringUtils.TryConvertToNonEmptyString(updateSkillPackageRequest.PackageId, out var valueOfPackageId)) urlParam.Add("package_id", valueOfPackageId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateSkillPackageRequest);
            return new SyncInvoker<UpdateSkillPackageResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateSkillPackageResponse>);
        }
        ...
        public SyncInvoker<CreateSkillResponse> CreateSkillInvoker(CreateSkillRequest createSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createSkillRequest);
            return new SyncInvoker<CreateSkillResponse>(this, "POST", request, JsonUtils.DeSerialize<CreateSkillResponse>);
        }
        ...
        public SyncInvoker<DeleteSkillResponse> DeleteSkillInvoker(DeleteSkillRequest deleteSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(deleteSkillRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", deleteSkillRequest);
            return new SyncInvoker<DeleteSkillResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<DeleteSkillResponse>);
        }
        ...
        public SyncInvoker<ListSkillsResponse> ListSkillsInvoker(ListSkillsRequest listSkillsRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", listSkillsRequest);
            return new SyncInvoker<ListSkillsResponse>(this, "GET", request, JsonUtils.DeSerialize<ListSkillsResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowSkillResponse ShowSkill(ShowSkillRequest showSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ShowSkillResponse> ShowSkillInvoker(ShowSkillRequest showSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(showSkillRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSkillRequest);
            return new SyncInvoker<ShowSkillResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowSkillResponse>);
        }
        ...
        public SyncInvoker<UpdateSkillResponse> UpdateSkillInvoker(UpdateSkillRequest updateSkillRequest)
        {
            var urlParam = new Dictionary<string, string>();
            if (StringUtils.TryConvertToNonEmptyString(updateSkillRequest.SkillId, out var valueOfSkillId)) urlParam.Add("skill_id", valueOfSkillId);
            var urlPath = HttpUtils.AddUrlPath("/v3/ai-agents/skills/{skill_id}", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateSkillRequest);
            return new SyncInvoker<UpdateSkillResponse>(this, "PUT", request, JsonUtils.DeSerialize<UpdateSkillResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportAppUserAccessDataResponse ExportAppUserAccessData(ExportAppUserAccessDataRequest exportAppUserAccessDataRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportAppUserAccessDataResponse> ExportAppUserAccessDataInvoker(ExportAppUserAccessDataRequest exportAppUserAccessDataRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/statistics/metrics/app-user-access/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json;charset=UTF-8", exportAppUserAccessDataRequest);
            return new SyncInvoker<ExportAppUserAccessDataResponse>(this, "POST", request, JsonUtils.DeSerialize<ExportAppUserAccessDataResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportDesktopUsageMetricNewResponse ExportDesktopUsageMetricNew(ExportDesktopUsageMetricNewRequest exportDesktopUsageMetricNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportDesktopUsageMetricNewResponse> ExportDesktopUsageMetricNewInvoker(ExportDesktopUsageMetricNewRequest exportDesktopUsageMetricNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/statistics/metrics/desktops/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportDesktopUsageMetricNewRequest);
            return new SyncInvoker<ExportDesktopUsageMetricNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ExportDesktopUsageMetricNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUserUsageMetricNewResponse ExportUserUsageMetricNew(ExportUserUsageMetricNewRequest exportUserUsageMetricNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUserUsageMetricNewResponse> ExportUserUsageMetricNewInvoker(ExportUserUsageMetricNewRequest exportUserUsageMetricNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/statistics/metrics/users/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUserUsageMetricNewRequest);
            return new SyncInvoker<ExportUserUsageMetricNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ExportUserUsageMetricNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportTerminalsBindingDesktopsTemplateResponse ExportTerminalsBindingDesktopsTemplate(ExportTerminalsBindingDesktopsTemplateRequest exportTerminalsBindingDesktopsTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportTerminalsBindingDesktopsTemplateResponse> ExportTerminalsBindingDesktopsTemplateInvoker(ExportTerminalsBindingDesktopsTemplateRequest exportTerminalsBindingDesktopsTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/terminals/binding-desktops/template", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportTerminalsBindingDesktopsTemplateRequest);
            return new SyncInvoker<ExportTerminalsBindingDesktopsTemplateResponse>(this, "GET", request, JsonUtils.DeSerializeNull<ExportTerminalsBindingDesktopsTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportTerminalsBindingDesktopsInfoNewResponse ExportTerminalsBindingDesktopsInfoNew(ExportTerminalsBindingDesktopsInfoNewRequest exportTerminalsBindingDesktopsInfoNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportTerminalsBindingDesktopsInfoNewResponse> ExportTerminalsBindingDesktopsInfoNewInvoker(ExportTerminalsBindingDesktopsInfoNewRequest exportTerminalsBindingDesktopsInfoNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/terminals/binding-desktops/template/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportTerminalsBindingDesktopsInfoNewRequest);
            return new SyncInvoker<ExportTerminalsBindingDesktopsInfoNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ExportTerminalsBindingDesktopsInfoNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUserListTemplateResponse ExportUserListTemplate(ExportUserListTemplateRequest exportUserListTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUserListTemplateResponse> ExportUserListTemplateInvoker(ExportUserListTemplateRequest exportUserListTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/users/desktop-users/template", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUserListTemplateRequest);
            return new SyncInvoker<ExportUserListTemplateResponse>(this, "GET", request, JsonUtils.DeSerializeNull<ExportUserListTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUsersTemplateResponse ExportUsersTemplate(ExportUsersTemplateRequest exportUsersTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUsersTemplateResponse> ExportUsersTemplateInvoker(ExportUsersTemplateRequest exportUsersTemplateRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/users/template/download", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUsersTemplateRequest);
            return new SyncInvoker<ExportUsersTemplateResponse>(this, "GET", request, JsonUtils.DeSerializeNull<ExportUsersTemplateResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ImportUserListResponse ImportUserList(ImportUserListRequest importUserListRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ImportUserListResponse> ImportUserListInvoker(ImportUserListRequest importUserListRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/users/desktop-users/action/import", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "multipart/form-data", importUserListRequest);
            return new SyncInvoker<ImportUserListResponse>(this, "POST", request, JsonUtils.DeSerialize<ImportUserListResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ExportUsersNewResponse ExportUsersNew(ExportUsersNewRequest exportUsersNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ExportUsersNewResponse> ExportUsersNewInvoker(ExportUsersNewRequest exportUsersNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/users/export", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", exportUsersNewRequest);
            return new SyncInvoker<ExportUsersNewResponse>(this, "POST", request, JsonUtils.DeSerialize<ExportUsersNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public BatchModifyQosVolumesResponse BatchModifyQosVolumes(BatchModifyQosVolumesRequest batchModifyQosVolumesRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<BatchModifyQosVolumesResponse> BatchModifyQosVolumesInvoker(BatchModifyQosVolumesRequest batchModifyQosVolumesRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/volumes/batch-modify-qos", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", batchModifyQosVolumesRequest);
            return new SyncInvoker<BatchModifyQosVolumesResponse>(this, "PUT", request, JsonUtils.DeSerialize<BatchModifyQosVolumesResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CheckEnterpriseIdResponse CheckEnterpriseId(CheckEnterpriseIdRequest checkEnterpriseIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CheckEnterpriseIdResponse> CheckEnterpriseIdInvoker(CheckEnterpriseIdRequest checkEnterpriseIdRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/workspaces/enterprise-ids/check", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", checkEnterpriseIdRequest);
            return new SyncInvoker<CheckEnterpriseIdResponse>(this, "POST", request, JsonUtils.DeSerialize<CheckEnterpriseIdResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ValidateDomainControllerResponse ValidateDomainController(ValidateDomainControllerRequest validateDomainControllerRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<ValidateDomainControllerResponse> ValidateDomainControllerInvoker(ValidateDomainControllerRequest validateDomainControllerRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v2/{project_id}/domain-controllers/validation", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", validateDomainControllerRequest);
            return new SyncInvoker<ValidateDomainControllerResponse>(this, "POST", request, JsonUtils.DeSerializeNull<ValidateDomainControllerResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CloseDomainNewResponse CloseDomainNew(CloseDomainNewRequest closeDomainNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<CloseDomainNewResponse> CloseDomainNewInvoker(CloseDomainNewRequest closeDomainNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", closeDomainNewRequest);
            return new SyncInvoker<CloseDomainNewResponse>(this, "DELETE", request, JsonUtils.DeSerializeNull<CloseDomainNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public CreateDomainNewResponse CreateDomainNew(CreateDomainNewRequest createDomainNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
        ...
        public SyncInvoker<CreateDomainNewResponse> CreateDomainNewInvoker(CreateDomainNewRequest createDomainNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", createDomainNewRequest);
            return new SyncInvoker<CreateDomainNewResponse>(this, "POST", request, JsonUtils.DeSerializeNull<CreateDomainNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public ShowDomainsNewResponse ShowDomainsNew(ShowDomainsNewRequest showDomainsNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
        ...
        public SyncInvoker<ShowDomainsNewResponse> ShowDomainsNewInvoker(ShowDomainsNewRequest showDomainsNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", showDomainsNewRequest);
            return new SyncInvoker<ShowDomainsNewResponse>(this, "GET", request, JsonUtils.DeSerialize<ShowDomainsNewResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public SyncExternalUserResponse SyncExternalUser(SyncExternalUserRequest syncExternalUserRequest)
        {
            var urlParam = new Dictionary<string, string>();
        ...
        public SyncInvoker<SyncExternalUserResponse> SyncExternalUserInvoker(SyncExternalUserRequest syncExternalUserRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains/sync-external-user", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", syncExternalUserRequest);
            return new SyncInvoker<SyncExternalUserResponse>(this, "GET", request, JsonUtils.DeSerialize<SyncExternalUserResponse>);
        }
        ...
        /// Please refer to HUAWEI cloud API Explorer for details.
        /// </summary>
        public UpdateDomainNewResponse UpdateDomainNew(UpdateDomainNewRequest updateDomainNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
        ...
        public SyncInvoker<UpdateDomainNewResponse> UpdateDomainNewInvoker(UpdateDomainNewRequest updateDomainNewRequest)
        {
            var urlParam = new Dictionary<string, string>();
            var urlPath = HttpUtils.AddUrlPath("/v3/{project_id}/domains", urlParam);
            var request = HttpUtils.InitSdkRequest(urlPath, "application/json", updateDomainNewRequest);
            return new SyncInvoker<UpdateDomainNewResponse>(this, "PUT", request, JsonUtils.DeSerializeNull<UpdateDomainNewResponse>);
        }

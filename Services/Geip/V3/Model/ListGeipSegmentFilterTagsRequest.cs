...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class ListGeipSegmentFilterTagsRequest 
    {
        ...
        {
            return this.Equals(input as ListGeipSegmentFilterTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGeipSegmentFilterTagsRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Offset != null &&
                    input.Offset != null &&
                    this.Offset.SequenceEqual(input.Offset)
                ) && 
                (

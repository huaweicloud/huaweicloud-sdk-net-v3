...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGlobalEipResponse : SdkResponse
    {
        ...
        public ShowGlobalEip GlobalEip { get; set; }
        ...
        {
            return this.Equals(input as ShowGlobalEipResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGlobalEipResponse input)
        {

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInternetBandwidthResponse : SdkResponse
    {
        ...
        public ShowInternetBandwidth InternetBandwidth { get; set; }
        ...
        {
            return this.Equals(input as ShowInternetBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInternetBandwidthResponse input)
        {

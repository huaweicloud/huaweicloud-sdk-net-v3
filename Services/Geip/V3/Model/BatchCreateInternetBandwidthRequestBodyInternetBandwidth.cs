...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class BatchCreateInternetBandwidthRequestBodyInternetBandwidth 
    {
        ...
        {
            return this.Equals(input as BatchCreateInternetBandwidthRequestBodyInternetBandwidth);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateInternetBandwidthRequestBodyInternetBandwidth input)
        {
            if (input == null)
                return false;

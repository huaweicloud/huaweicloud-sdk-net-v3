...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class AssociateInstanceRequest 
    {
        ...
        public bool Equals(AssociateInstanceRequest input)
        {
            ...
            return 
                (
                    this.BindingInstanceService == input.BindingInstanceService ||
                    (this.BindingInstanceService != null &&
                    this.BindingInstanceService.Equals(input.BindingInstanceService))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.BindingInstanceService != null)
                    hashCode = hashCode * 59 + this.BindingInstanceService.GetHashCode();

    ...
    public class ListAccessSitesResponse : SdkResponse
    {
        ...
        public bool Equals(ListAccessSitesResponse input)
        {
            ...
            return 
                ...
                (
                    this.AccessSites == input.AccessSites ||
                    this.AccessSites != null &&
                    input.AccessSites != null &&
                    this.AccessSites.SequenceEqual(input.AccessSites)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccessSites != null)
                    hashCode = hashCode * 59 + this.AccessSites.GetHashCode();

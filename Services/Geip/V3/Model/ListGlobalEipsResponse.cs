...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGlobalEipsResponse : SdkResponse
    {
        ...
        public List<ListGlobalEips> GlobalEips { get; set; }
        ...
        {
            return this.Equals(input as ListGlobalEipsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGlobalEipsResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class AssociateInstanceGlobalEipSegmentRequestBodyGlobalEipSegment 
    {
        ...
        {
            return this.Equals(input as AssociateInstanceGlobalEipSegmentRequestBodyGlobalEipSegment);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateInstanceGlobalEipSegmentRequestBodyGlobalEipSegment input)
        {

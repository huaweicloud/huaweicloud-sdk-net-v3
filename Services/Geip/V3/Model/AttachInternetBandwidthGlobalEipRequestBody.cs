...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class AttachInternetBandwidthGlobalEipRequestBody 
    {
        ...
        public AttachInternetBandwidthGlobalEipRequestBodyGlobalEip GlobalEip { get; set; }
        ...
        {
            return this.Equals(input as AttachInternetBandwidthGlobalEipRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachInternetBandwidthGlobalEipRequestBody input)
        {
            if (input == null)
                return false;

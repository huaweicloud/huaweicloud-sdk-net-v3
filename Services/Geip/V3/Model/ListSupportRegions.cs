...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class ListSupportRegions 
    {
        ...
        {
            return this.Equals(input as ListSupportRegions);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSupportRegions input)
        {
            ...
            if (this.RemoteEndpoint != input.RemoteEndpoint || (this.RemoteEndpoint != null && !this.RemoteEndpoint.Equals(input.RemoteEndpoint))) return false;

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class CreateGlobalEipSegmentRequestBodyGlobalEipSegmentInternetBandwidth 
    {
        ...
        {
            return this.Equals(input as CreateGlobalEipSegmentRequestBodyGlobalEipSegmentInternetBandwidth);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGlobalEipSegmentRequestBodyGlobalEipSegmentInternetBandwidth input)
        {
            if (input == null)
                return false;

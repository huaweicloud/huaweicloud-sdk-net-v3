...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListInternetBandwidthLimitsResponse : SdkResponse
    {
        ...
        /// 全域公网带宽限制列表
        /// </summary>
        [JsonProperty("internet_bandwidth_limits", NullValueHandling = NullValueHandling.Ignore)]
        public List<ListInternetBandwidthLimits> InternetBandwidthLimits { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  internetBandwidthLimits: ").Append(InternetBandwidthLimits).Append("\n");
        ...
        {
            return this.Equals(input as ListInternetBandwidthLimitsResponse);
        }

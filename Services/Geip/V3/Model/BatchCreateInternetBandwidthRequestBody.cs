...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class BatchCreateInternetBandwidthRequestBody 
    {
        ...
        public BatchCreateInternetBandwidthRequestBodyInternetBandwidth InternetBandwidth { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateInternetBandwidthRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateInternetBandwidthRequestBody input)
        {
            if (input == null)
                return false;

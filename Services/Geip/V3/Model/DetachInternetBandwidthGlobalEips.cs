...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class DetachInternetBandwidthGlobalEips 
    {
        ...
        public Object EnterpriseProjectId { get; set; }
        ...
        {
            return this.Equals(input as DetachInternetBandwidthGlobalEips);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetachInternetBandwidthGlobalEips input)
        {
            if (input == null)
                return false;

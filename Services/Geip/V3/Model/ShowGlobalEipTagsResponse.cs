...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGlobalEipTagsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGlobalEipTagsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGlobalEipTagsResponse input)
        {
            if (input == null)
                return false;

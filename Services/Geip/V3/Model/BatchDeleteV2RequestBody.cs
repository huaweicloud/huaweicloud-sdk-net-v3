...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class BatchDeleteV2RequestBody 
    {
        ...
        public List<BatchDeleteV2RequestBodyTags> Tags { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteV2RequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteV2RequestBody input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class ListAccessSitesRequest 
    {
        ...
        public class FieldsEnum
        {
            ...
            /// </summary>
            public static readonly FieldsEnum PROXY_REGION = new FieldsEnum("proxy_region");
        ...
        public List<string> IecAzCode { get; set; }
        ...
        {
            return this.Equals(input as ListAccessSitesRequest);
        }

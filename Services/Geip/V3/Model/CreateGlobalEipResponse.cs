...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateGlobalEipResponse : SdkResponse
    {
        ...
        public CreateGlobalEip GlobalEip { get; set; }
        ...
        {
            return this.Equals(input as CreateGlobalEipResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateGlobalEipResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DisassociateInstanceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DisassociateInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DisassociateInstanceResponse input)
        {
            if (input == null)
                return false;

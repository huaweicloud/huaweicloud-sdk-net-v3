...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class UpdateGlobalEipRequestBody 
    {
        ...
        public UpdateGlobalEipRequestBodyGlobalEip GlobalEip { get; set; }
        ...
        {
            return this.Equals(input as UpdateGlobalEipRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateGlobalEipRequestBody input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowGeipSegmentTagsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowGeipSegmentTagsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowGeipSegmentTagsResponse input)
        {
            if (input == null)
                return false;

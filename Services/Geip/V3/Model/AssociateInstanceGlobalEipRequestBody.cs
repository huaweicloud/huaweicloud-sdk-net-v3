...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class AssociateInstanceGlobalEipRequestBody 
    {
        ...
        public AssociateInstanceGlobalEipRequestBodyGlobalEip GlobalEip { get; set; }
        ...
        {
            return this.Equals(input as AssociateInstanceGlobalEipRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateInstanceGlobalEipRequestBody input)
        {

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowInternetBandwidthTagsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowInternetBandwidthTagsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowInternetBandwidthTagsResponse input)
        {

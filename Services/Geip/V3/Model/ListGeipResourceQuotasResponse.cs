...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListGeipResourceQuotasResponse : SdkResponse
    {
        ...
        public ListQuotas Quotas { get; set; }
        ...
        {
            return this.Equals(input as ListGeipResourceQuotasResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListGeipResourceQuotasResponse input)
        {

...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateInternetBandwidthResponse : SdkResponse
    {
        ...
        public CreateInternetBandwidth InternetBandwidth { get; set; }
        ...
        {
            return this.Equals(input as CreateInternetBandwidthResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateInternetBandwidthResponse input)
        {

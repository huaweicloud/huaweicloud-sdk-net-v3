...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class AttachInternetBandwidthRequest 
    {
        ...
        public AttachInternetBandwidthGlobalEipRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AttachInternetBandwidthRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AttachInternetBandwidthRequest input)
        {

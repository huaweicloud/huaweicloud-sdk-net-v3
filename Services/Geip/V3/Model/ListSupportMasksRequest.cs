...
namespace HuaweiCloud.SDK.Geip.V3.Model
{
    ...
    public class ListSupportMasksRequest 
    {
        ...
        public class FieldsEnum
        {
            ...
            /// </summary>
            public static readonly FieldsEnum MASK = new FieldsEnum("mask");
        ...
        public class SortKeyEnum
        {
            ...
            /// Enum MASK for value: mask
            /// </summary>
            public static readonly SortKeyEnum MASK = new SortKeyEnum("mask");
        ...
        {
            return this.Equals(input as ListSupportMasksRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSupportMasksRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Mask != null &&
                    input.Mask != null &&
                    this.Mask.SequenceEqual(input.Mask)
                );
        }

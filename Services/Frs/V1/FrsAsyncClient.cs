...
using HuaweiCloud.SDK.Frs.V1.Model;
...
namespace HuaweiCloud.SDK.Frs.V1
{
    public partial class FrsAsyncClient : Client
    {
        ...
        public async Task<AddFacesByBase64Response> AddFacesByBase64Async(AddFacesByBase64Request addFacesByBase64Request)
        {
            ...
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-sets/{face_set_name}/faces",urlParam);
        ...
        public async Task<BatchDeleteFacesResponse> BatchDeleteFacesAsync(BatchDeleteFacesRequest batchDeleteFacesRequest)
        {
            ...
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-sets/{face_set_name}/faces/batch",urlParam);
        ...
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-compare",urlParam);
        ...
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-sets",urlParam);
        ...
        public async Task<DeleteFaceSetResponse> DeleteFaceSetAsync(DeleteFaceSetRequest deleteFaceSetRequest)
        {
            ...
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-sets/{face_set_name}",urlParam);
        ...
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-detect",urlParam);
        ...
        public async Task<SearchFaceByBase64Response> SearchFaceByBase64Async(SearchFaceByBase64Request searchFaceByBase64Request)
        {
            ...
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/face-sets/{face_set_name}/search",urlParam);
        ...
        /// 查询服务状态
        /// </summary>
        public async Task<ShowSubscribesResponse> ShowSubscribesAsync(ShowSubscribesRequest showSubscribesRequest)
        {
            Dictionary<string, string> urlParam = new Dictionary<string, string>();
            string urlPath = HttpUtils.AddUrlPath("/v1/{project_id}/subscribe",urlParam);
            SdkRequest request = HttpUtils.InitSdkRequest(urlPath, "application/json", showSubscribesRequest);
            HttpResponseMessage response = await DoHttpRequestAsync("GET",request);
            return JsonUtils.DeSerialize<ShowSubscribesResponse>(response);
        }

...
namespace HuaweiCloud.SDK.Frs.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SearchFaceByBase64Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as SearchFaceByBase64Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchFaceByBase64Response input)
        {
            if (input == null)
                return false;

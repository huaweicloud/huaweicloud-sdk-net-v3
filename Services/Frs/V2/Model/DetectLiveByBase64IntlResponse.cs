...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectLiveByBase64IntlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectLiveByBase64IntlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectLiveByBase64IntlResponse input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectLiveFaceByBase64Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectLiveFaceByBase64Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectLiveFaceByBase64Response input)
        {
            if (input == null)
                return false;

...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    public class ShowFaceSetResponse : SdkResponse
    {
        ...
        public bool Equals(ShowFaceSetResponse input)
        {
            ...
            if (this.FaceSetInfo != input.FaceSetInfo || (this.FaceSetInfo != null && !this.FaceSetInfo.Equals(input.FaceSetInfo))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.FaceSetInfo != null) hashCode = hashCode * 59 + this.FaceSetInfo.GetHashCode();

...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectFaceByBase64IntlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectFaceByBase64IntlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectFaceByBase64IntlResponse input)
        {
            if (input == null)
                return false;

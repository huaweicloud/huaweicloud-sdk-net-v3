...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteFaceByFaceIdResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteFaceByFaceIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteFaceByFaceIdResponse input)
        {

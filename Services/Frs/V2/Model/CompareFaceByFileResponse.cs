...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CompareFaceByFileResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CompareFaceByFileResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CompareFaceByFileResponse input)
        {
            if (input == null)
                return false;

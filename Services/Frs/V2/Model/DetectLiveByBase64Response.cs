...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectLiveByBase64Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectLiveByBase64Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectLiveByBase64Response input)
        {
            if (input == null)
                return false;

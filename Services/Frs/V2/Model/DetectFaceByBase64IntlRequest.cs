...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    public class DetectFaceByBase64IntlRequest 
    {
        ...
        public FaceDetectBase64Req Body { get; set; }
        ...
        {
            return this.Equals(input as DetectFaceByBase64IntlRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectFaceByBase64IntlRequest input)
        {
            if (input == null)
                return false;

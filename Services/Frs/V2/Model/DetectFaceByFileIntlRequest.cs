...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    public class DetectFaceByFileIntlRequest 
    {
        ...
        public DetectFaceByFileIntlRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as DetectFaceByFileIntlRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectFaceByFileIntlRequest input)
        {
            if (input == null)
                return false;

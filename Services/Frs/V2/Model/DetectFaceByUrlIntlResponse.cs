...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectFaceByUrlIntlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectFaceByUrlIntlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectFaceByUrlIntlResponse input)
        {
            if (input == null)
                return false;

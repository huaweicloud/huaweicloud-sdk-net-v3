...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CompareFaceByUrlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CompareFaceByUrlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CompareFaceByUrlResponse input)
        {
            if (input == null)
                return false;

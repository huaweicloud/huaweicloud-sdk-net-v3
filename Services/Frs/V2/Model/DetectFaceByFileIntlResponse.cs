...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectFaceByFileIntlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectFaceByFileIntlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectFaceByFileIntlResponse input)
        {
            if (input == null)
                return false;

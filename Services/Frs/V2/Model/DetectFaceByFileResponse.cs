...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectFaceByFileResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectFaceByFileResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectFaceByFileResponse input)
        {
            if (input == null)
                return false;

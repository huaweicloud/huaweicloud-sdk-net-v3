...
namespace HuaweiCloud.SDK.Frs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DetectLiveByFileIntlResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DetectLiveByFileIntlResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DetectLiveByFileIntlResponse input)
        {
            if (input == null)
                return false;

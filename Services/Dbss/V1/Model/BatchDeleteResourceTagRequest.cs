...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    public class BatchDeleteResourceTagRequest 
    {
        ...
        public ResourceTagDeleteRequest Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteResourceTagRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteResourceTagRequest input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditInstanceJobsNewResponse : SdkResponse
    {
        ...
        public List<JobBean> Jobs { get; set; }
        ...
        {
            return this.Equals(input as ListAuditInstanceJobsNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditInstanceJobsNewResponse input)
        {

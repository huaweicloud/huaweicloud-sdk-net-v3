...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAuditQuotaNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAuditQuotaNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAuditQuotaNewResponse input)
        {

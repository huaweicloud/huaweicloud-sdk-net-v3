...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    public class AlarmLogResponseNewAlarmLog 
    {
        ...
        /// 告警状态 - ON：持续中 - OFF：已关闭
        /// </summary>
        [JsonProperty("alarm_life", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as AlarmLogResponseNewAlarmLog);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AlarmLogResponseNewAlarmLog input)
        {

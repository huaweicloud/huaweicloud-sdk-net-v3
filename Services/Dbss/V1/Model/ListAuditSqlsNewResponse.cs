...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditSqlsNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAuditSqlsNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditSqlsNewResponse input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    public class ConfigAlarmTopicRequest 
    {
        ...
        {
            return this.Equals(input as ConfigAlarmTopicRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ConfigAlarmTopicRequest input)
        {

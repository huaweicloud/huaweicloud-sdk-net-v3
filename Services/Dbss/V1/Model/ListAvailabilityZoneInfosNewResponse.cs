...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAvailabilityZoneInfosNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAvailabilityZoneInfosNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAvailabilityZoneInfosNewResponse input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditRuleScopesNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAuditRuleScopesNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditRuleScopesNewResponse input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditInstancesLastResponse : SdkResponse
    {
        ...
        public List<AuditInstanceBean> Instances { get; set; }
        ...
        {
            return this.Equals(input as ListAuditInstancesLastResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditInstancesLastResponse input)
        {

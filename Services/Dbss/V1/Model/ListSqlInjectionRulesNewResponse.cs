...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSqlInjectionRulesNewResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListSqlInjectionRulesNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSqlInjectionRulesNewResponse input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAlarmTopicConfigInfoResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAlarmTopicConfigInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAlarmTopicConfigInfoResponse input)
        {

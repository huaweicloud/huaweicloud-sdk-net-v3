...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    public class SetAuditBackupRiskSwitchRequest 
    {
        ...
        public RiskBackupTemplate Body { get; set; }
        ...
        {
            return this.Equals(input as SetAuditBackupRiskSwitchRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetAuditBackupRiskSwitchRequest input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditDatabasesNewResponse : SdkResponse
    {
        ...
        public List<DataBaseBean> Databases { get; set; }
        ...
        {
            return this.Equals(input as ListAuditDatabasesNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditDatabasesNewResponse input)
        {

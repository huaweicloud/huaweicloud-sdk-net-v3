...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    public class SetRiskOperationPolicyRequest 
    {
        ...
        public RuleAddRiskRuleRequest Body { get; set; }
        ...
        {
            return this.Equals(input as SetRiskOperationPolicyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SetRiskOperationPolicyRequest input)
        {

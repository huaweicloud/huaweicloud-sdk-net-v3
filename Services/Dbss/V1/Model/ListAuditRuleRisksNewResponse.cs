...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditRuleRisksNewResponse : SdkResponse
    {
        ...
        public List<RuleRiskResponseRules> Rules { get; set; }
        ...
        {
            return this.Equals(input as ListAuditRuleRisksNewResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditRuleRisksNewResponse input)
        {

...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    public class DownloadAuditReportRequest 
    {
        ...
        /// </summary>
        [SDKProperty("local", IsQuery = true)]
        ...
        {
            return this.Equals(input as DownloadAuditReportRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DownloadAuditReportRequest input)
        {
            if (input == null) return false;
            if (this.InstanceId != input.InstanceId || (this.InstanceId != null && !this.InstanceId.Equals(input.InstanceId))) return false;
            if (this.Id != input.Id || (this.Id != null && !this.Id.Equals(input.Id))) return false;
            if (this.Local != input.Local || (this.Local != null && !this.Local.Equals(input.Local))) return false;

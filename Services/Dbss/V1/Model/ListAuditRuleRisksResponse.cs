...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditRuleRisksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAuditRuleRisksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditRuleRisksResponse input)
        {

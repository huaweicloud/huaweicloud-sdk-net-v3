...
namespace HuaweiCloud.SDK.Dbss.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAuditAlarmLogResponse : SdkResponse
    {
        ...
        public List<AlarmLogResponseAlarmLog> AlarmLog { get; set; }
        ...
        {
            return this.Equals(input as ListAuditAlarmLogResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAuditAlarmLogResponse input)
        {

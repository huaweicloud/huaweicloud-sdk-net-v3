...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteServerGroupMemberResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteServerGroupMemberResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteServerGroupMemberResponse input)
        {

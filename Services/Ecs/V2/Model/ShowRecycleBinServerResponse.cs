...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowRecycleBinServerResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowRecycleBinServerResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRecycleBinServerResponse input)
        {

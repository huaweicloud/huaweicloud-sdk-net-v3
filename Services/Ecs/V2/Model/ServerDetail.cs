...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class ServerDetail 
    {
        ...
        public bool Equals(ServerDetail input)
        {
            ...
            if (this.OSEXTSTStaskState != input.OSEXTSTStaskState || (this.OSEXTSTStaskState != null && !this.OSEXTSTStaskState.Equals(input.OSEXTSTStaskState))) return false;
            if (this.OSEXTSTSvmState != input.OSEXTSTSvmState || (this.OSEXTSTSvmState != null && !this.OSEXTSTSvmState.Equals(input.OSEXTSTSvmState))) return false;
            ...
            if (this.HostStatus != input.HostStatus || (this.HostStatus != null && !this.HostStatus.Equals(input.HostStatus))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OSEXTSTStaskState != null) hashCode = hashCode * 59 + this.OSEXTSTStaskState.GetHashCode();
                if (this.OSEXTSTSvmState != null) hashCode = hashCode * 59 + this.OSEXTSTSvmState.GetHashCode();
                ...
                if (this.HostStatus != null) hashCode = hashCode * 59 + this.HostStatus.GetHashCode();

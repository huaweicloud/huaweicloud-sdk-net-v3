...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class BatchDeleteServerGroupMemberRequest 
    {
        ...
        public BatchDeleteServerGroupMemberReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteServerGroupMemberRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteServerGroupMemberRequest input)
        {

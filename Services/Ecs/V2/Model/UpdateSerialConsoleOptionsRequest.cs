...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class UpdateSerialConsoleOptionsRequest 
    {
        ...
        public UpdateSerialConsoleOptionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSerialConsoleOptionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSerialConsoleOptionsRequest input)
        {

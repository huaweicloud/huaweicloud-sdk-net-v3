...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateLaunchTemplateResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateLaunchTemplateResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateLaunchTemplateResponse input)
        {

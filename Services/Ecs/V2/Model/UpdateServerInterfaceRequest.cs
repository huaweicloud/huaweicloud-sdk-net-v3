...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class UpdateServerInterfaceRequest 
    {
        ...
        public UpdateNicInfoRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateServerInterfaceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateServerInterfaceRequest input)
        {

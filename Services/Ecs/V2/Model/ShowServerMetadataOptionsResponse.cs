...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowServerMetadataOptionsResponse : SdkResponse
    {
        /// <summary>
        /// 是否禁用IMDS服务。
        /// </summary>
        ...
        {
            return this.Equals(input as ShowServerMetadataOptionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowServerMetadataOptionsResponse input)
        {

...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class ListTemplatesRequest 
    {
        ...
        public bool Equals(ListTemplatesRequest input)
        {
            ...
            if (this.LaunchTemplateId != input.LaunchTemplateId || (this.LaunchTemplateId != null && input.LaunchTemplateId != null && !this.LaunchTemplateId.SequenceEqual(input.LaunchTemplateId))) return false;

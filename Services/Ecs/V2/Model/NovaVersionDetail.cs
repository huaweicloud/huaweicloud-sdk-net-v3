...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class NovaVersionDetail 
    {
        ...
        public List<NovaVersionMediaType> MediaTypes { get; set; }
        ...
        {
            return this.Equals(input as NovaVersionDetail);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NovaVersionDetail input)
        {
            ...
            if (this.MediaTypes != input.MediaTypes || (this.MediaTypes != null && input.MediaTypes != null && !this.MediaTypes.SequenceEqual(input.MediaTypes))) return false;

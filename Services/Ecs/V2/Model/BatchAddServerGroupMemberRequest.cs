...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class BatchAddServerGroupMemberRequest 
    {
        ...
        public BatchAddServerGroupMemberReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAddServerGroupMemberRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddServerGroupMemberRequest input)
        {

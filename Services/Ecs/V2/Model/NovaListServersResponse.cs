...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NovaListServersResponse : SdkResponse
    {
        ...
        public List<NovaSimpleServer> Servers { get; set; }
        ...
        {
            return this.Equals(input as NovaListServersResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NovaListServersResponse input)
        {

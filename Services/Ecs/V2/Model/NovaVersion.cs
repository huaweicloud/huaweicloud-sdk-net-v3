...
namespace HuaweiCloud.SDK.Ecs.V2.Model
{
    ...
    public class NovaVersion 
    {
        ...
        /// </summary>
        /// <value>这个是API版本的状态。可以是：  - CURRENT，这是使用的API的首选版本 - SUPPORTED，这是一个较老的，但仍然支持的API版本 - DEPRECATED，一个被废弃的API版本，该版本将被删除</value>
        ...
        {
            return this.Equals(input as NovaVersion);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NovaVersion input)
        {

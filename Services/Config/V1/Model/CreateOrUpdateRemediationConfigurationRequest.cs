...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class CreateOrUpdateRemediationConfigurationRequest 
    {
        ...
        public RemediationConfigurationRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateOrUpdateRemediationConfigurationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateOrUpdateRemediationConfigurationRequest input)
        {

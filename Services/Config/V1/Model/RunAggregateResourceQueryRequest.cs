...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class RunAggregateResourceQueryRequest 
    {
        ...
        public QueryRunRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RunAggregateResourceQueryRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RunAggregateResourceQueryRequest input)
        {

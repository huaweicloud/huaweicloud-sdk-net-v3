...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class ListConformancePackComplianceDetailsByPackIdRequest 
    {
        ...
        {
            return this.Equals(input as ListConformancePackComplianceDetailsByPackIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListConformancePackComplianceDetailsByPackIdRequest input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateConformancePackResponse : SdkResponse
    {
        /// <summary>
        /// 合规规则包部署状态。
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateConformancePackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateConformancePackResponse input)
        {

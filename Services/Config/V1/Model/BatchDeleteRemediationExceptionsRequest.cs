...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class BatchDeleteRemediationExceptionsRequest 
    {
        ...
        public BatchDeleteRemediationExceptionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteRemediationExceptionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteRemediationExceptionsRequest input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class ListConfigurationAggregatorsRequest 
    {
        ...
        /// 资源聚合器名称。
        /// </summary>
        [SDKProperty("aggregator_name", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListConfigurationAggregatorsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListConfigurationAggregatorsRequest input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class RunRemediationExecutionRequest 
    {
        ...
        public RemediationRunRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as RunRemediationExecutionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RunRemediationExecutionRequest input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateConformancePackResponse : SdkResponse
    {
        /// <summary>
        /// 合规规则包部署状态。
        /// </summary>
        ...
        {
            return this.Equals(input as CreateConformancePackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateConformancePackResponse input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowResourceHistoryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowResourceHistoryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourceHistoryResponse input)
        {

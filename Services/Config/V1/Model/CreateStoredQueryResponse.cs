...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateStoredQueryResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateStoredQueryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateStoredQueryResponse input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowOrganizationPolicyAssignmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowOrganizationPolicyAssignmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowOrganizationPolicyAssignmentResponse input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class PolicyParameterDefinition 
    {
        ...
        public class TypeEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum DATETIME = new TypeEnum("DateTime");
        ...
        {
            return this.Equals(input as PolicyParameterDefinition);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(PolicyParameterDefinition input)
        {

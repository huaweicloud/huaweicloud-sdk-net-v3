...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowResourceDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowResourceDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourceDetailResponse input)
        {

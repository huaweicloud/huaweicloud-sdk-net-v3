...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class ListPolicyStatesByAssignmentIdRequest 
    {
        ...
        /// 合规状态
        /// </summary>
        [SDKProperty("compliance_state", IsQuery = true)]
        ...
        {
            return this.Equals(input as ListPolicyStatesByAssignmentIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPolicyStatesByAssignmentIdRequest input)
        {

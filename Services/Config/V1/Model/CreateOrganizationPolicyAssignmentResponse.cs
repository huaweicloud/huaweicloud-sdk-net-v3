...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateOrganizationPolicyAssignmentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateOrganizationPolicyAssignmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateOrganizationPolicyAssignmentResponse input)
        {

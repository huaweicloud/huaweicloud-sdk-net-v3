...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateConfigurationAggregatorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateConfigurationAggregatorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateConfigurationAggregatorResponse input)
        {

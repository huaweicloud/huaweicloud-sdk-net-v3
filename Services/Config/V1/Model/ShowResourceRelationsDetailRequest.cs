...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class ShowResourceRelationsDetailRequest 
    {
        ...
        public class DirectionEnum
        {
            ...
            /// </summary>
            public static readonly DirectionEnum IN = new DirectionEnum("in");

            /// <summary>
            /// Enum OUT for value: out
            /// </summary>
            public static readonly DirectionEnum OUT = new DirectionEnum("out");
        ...
        {
            return this.Equals(input as ShowResourceRelationsDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourceRelationsDetailRequest input)
        {

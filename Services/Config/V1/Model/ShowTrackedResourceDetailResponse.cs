...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTrackedResourceDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTrackedResourceDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTrackedResourceDetailResponse input)
        {

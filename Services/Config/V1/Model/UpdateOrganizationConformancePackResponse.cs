...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateOrganizationConformancePackResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateOrganizationConformancePackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateOrganizationConformancePackResponse input)
        {

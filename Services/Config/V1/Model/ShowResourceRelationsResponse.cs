...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowResourceRelationsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowResourceRelationsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourceRelationsResponse input)
        {

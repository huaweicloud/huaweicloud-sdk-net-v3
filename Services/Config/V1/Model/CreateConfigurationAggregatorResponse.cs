...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateConfigurationAggregatorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateConfigurationAggregatorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateConfigurationAggregatorResponse input)
        {

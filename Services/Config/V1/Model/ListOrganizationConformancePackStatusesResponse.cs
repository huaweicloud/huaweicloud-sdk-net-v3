...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListOrganizationConformancePackStatusesResponse : SdkResponse
    {
        ...
        public List<OrgConformancePackStatus> Statuses { get; set; }
        ...
        {
            return this.Equals(input as ListOrganizationConformancePackStatusesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOrganizationConformancePackStatusesResponse input)
        {

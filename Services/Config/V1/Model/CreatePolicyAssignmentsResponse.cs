...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreatePolicyAssignmentsResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreatePolicyAssignmentsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreatePolicyAssignmentsResponse input)
        {

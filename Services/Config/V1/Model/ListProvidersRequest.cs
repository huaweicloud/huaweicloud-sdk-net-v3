...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class ListProvidersRequest 
    {
        ...
        /// 资源是否默认收集
        /// </summary>
        /// <value>资源是否默认收集</value>
        [JsonConverter(typeof(EnumClassConverter<TrackEnum>))]
        public class TrackEnum
        {
            /// <summary>
            /// Enum TRACKED for value: tracked
            /// </summary>
            public static readonly TrackEnum TRACKED = new TrackEnum("tracked");

            /// <summary>
            /// Enum UNTRACKED for value: untracked
            /// </summary>
            public static readonly TrackEnum UNTRACKED = new TrackEnum("untracked");

            private static readonly Dictionary<string, TrackEnum> StaticFields =
            new Dictionary<string, TrackEnum>()
            {
                { "tracked", TRACKED },
                { "untracked", UNTRACKED },
            };
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as TrackEnum))
                {
                    return true;
                }
            ...
            public bool Equals(TrackEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
            ...
            public static bool operator ==(TrackEnum a, TrackEnum b)
            {
        ...
        /// 资源是否默认收集
        /// </summary>
        [SDKProperty("track", IsQuery = true)]
        ...
        public bool Equals(ListProvidersRequest input)
        {
            ...
            if (this.Track != input.Track) return false;

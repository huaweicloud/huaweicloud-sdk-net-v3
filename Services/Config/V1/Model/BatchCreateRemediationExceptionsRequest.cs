...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    public class BatchCreateRemediationExceptionsRequest 
    {
        ...
        public BatchCreateRemediationExceptionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateRemediationExceptionsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateRemediationExceptionsRequest input)
        {

...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CollectAllResourcesSummaryResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CollectAllResourcesSummaryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CollectAllResourcesSummaryResponse input)
        {

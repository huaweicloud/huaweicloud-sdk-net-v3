...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPolicyAssignmentResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowPolicyAssignmentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowPolicyAssignmentResponse input)
        {

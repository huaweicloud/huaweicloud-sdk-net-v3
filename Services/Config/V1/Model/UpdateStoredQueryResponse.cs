...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateStoredQueryResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateStoredQueryResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateStoredQueryResponse input)
        {

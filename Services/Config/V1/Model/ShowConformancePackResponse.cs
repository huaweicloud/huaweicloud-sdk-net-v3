...
namespace HuaweiCloud.SDK.Config.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowConformancePackResponse : SdkResponse
    {
        /// <summary>
        /// 合规规则包部署状态。
        /// </summary>
        ...
        {
            return this.Equals(input as ShowConformancePackResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowConformancePackResponse input)
        {

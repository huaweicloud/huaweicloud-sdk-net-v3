...
namespace HuaweiCloud.SDK.ImageSearch.V2.Model
{
    ...
    public class AddDataRestInfoImageInfo 
    {
        ...
        /// 添加的人脸数量。
        /// </summary>
        [JsonProperty("face_num", NullValueHandling = NullValueHandling.Ignore)]
        public decimal? FaceNum { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  faceNum: ").Append(FaceNum).Append("\n");
        ...
        public bool Equals(AddDataRestInfoImageInfo input)
        {
            ...
            return 
                (
                    this.FaceNum == input.FaceNum ||
                    (this.FaceNum != null &&
                    this.FaceNum.Equals(input.FaceNum))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FaceNum != null)
                    hashCode = hashCode * 59 + this.FaceNum.GetHashCode();

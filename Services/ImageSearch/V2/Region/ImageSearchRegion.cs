...
namespace HuaweiCloud.SDK.ImageSearch.V2
{
    public class ImageSearchRegion
    {
        ...
        public static Region ValueOf(string regionId)
        {
            ...
            throw new ArgumentException($"region id '{regionId}' is not in the following supported regions of service 'ImageSearch': [{string.Join(", ", StaticFields.Keys.OrderBy(key => key))}]");
        }
    }
}
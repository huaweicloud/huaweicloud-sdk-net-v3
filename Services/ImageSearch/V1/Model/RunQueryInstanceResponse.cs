...
namespace HuaweiCloud.SDK.ImageSearch.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RunQueryInstanceResponse : SdkResponse
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RunQueryInstanceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RunQueryInstanceResponse input)
        {
            if (input == null)
                return false;

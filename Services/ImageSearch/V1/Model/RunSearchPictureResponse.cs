...
namespace HuaweiCloud.SDK.ImageSearch.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RunSearchPictureResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RunSearchPictureResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RunSearchPictureResponse input)
        {
            if (input == null)
                return false;

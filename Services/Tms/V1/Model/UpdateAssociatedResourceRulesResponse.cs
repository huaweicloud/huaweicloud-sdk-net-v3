...
namespace HuaweiCloud.SDK.Tms.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAssociatedResourceRulesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateAssociatedResourceRulesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAssociatedResourceRulesResponse input)
        {

...
namespace HuaweiCloud.SDK.Smn.V2.Model
{
    ...
    public class BatchDeleteSubscriptionsByTopicRequest 
    {
        ...
        public BatchDeleteSubscriptionsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteSubscriptionsByTopicRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteSubscriptionsByTopicRequest input)
        {

...
namespace HuaweiCloud.SDK.Smn.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteSubscriptionsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteSubscriptionsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteSubscriptionsResponse input)
        {

...
namespace HuaweiCloud.SDK.Smn.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTopicsWithAssociatedResourcesResponse : SdkResponse
    {
        ...
        public List<ListTopicsWithAssociatedResourcesItem> Topics { get; set; }
        ...
        {
            return this.Equals(input as ListTopicsWithAssociatedResourcesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTopicsWithAssociatedResourcesResponse input)
        {

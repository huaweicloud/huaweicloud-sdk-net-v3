...
namespace HuaweiCloud.SDK.Smn.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListCloudServicesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListCloudServicesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListCloudServicesResponse input)
        {

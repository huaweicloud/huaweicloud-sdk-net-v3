...
namespace HuaweiCloud.SDK.Eps.v1.Model
{
    ...
    public class ShowResourceBindEnterpriseProjectRequest 
    {
        ...
        public ResqEpResouce Body { get; set; }
        ...
        {
            return this.Equals(input as ShowResourceBindEnterpriseProjectRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowResourceBindEnterpriseProjectRequest input)
        {
            if (input == null)
                return false;

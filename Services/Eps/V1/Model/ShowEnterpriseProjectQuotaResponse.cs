...
namespace HuaweiCloud.SDK.Eps.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowEnterpriseProjectQuotaResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowEnterpriseProjectQuotaResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEnterpriseProjectQuotaResponse input)
        {

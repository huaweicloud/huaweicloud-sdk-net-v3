...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUpdateVersionTestCasesResponse : SdkResponse
    {
        ...
        public ResultValueUpdateTestCaseListVo Result { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateVersionTestCasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateVersionTestCasesResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowIfTaskNameRepeatResponse : SdkResponse
    {
        ...
        /// 查询到的告警模板
        /// </summary>
        [JsonProperty("pageList", NullValueHandling = NullValueHandling.Ignore)]
        public List<AlarmTemplateInfo> PageList { get; set; }
        ...
        {
            return this.Equals(input as ShowIfTaskNameRepeatResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowIfTaskNameRepeatResponse input)
        {

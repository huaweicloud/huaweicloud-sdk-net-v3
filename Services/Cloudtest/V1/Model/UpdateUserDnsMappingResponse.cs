...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateUserDnsMappingResponse : SdkResponse
    {
        ...
        public DnsMapping Result { get; set; }
        ...
        {
            return this.Equals(input as UpdateUserDnsMappingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateUserDnsMappingResponse input)
        {

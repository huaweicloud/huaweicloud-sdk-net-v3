...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListUserDnsMappingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListUserDnsMappingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListUserDnsMappingResponse input)
        {

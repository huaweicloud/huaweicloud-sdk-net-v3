...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchAddRelationsByOneCaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchAddRelationsByOneCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddRelationsByOneCaseResponse input)
        {

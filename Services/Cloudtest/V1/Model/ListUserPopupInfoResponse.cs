...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListUserPopupInfoResponse : SdkResponse
    {
        ...
        public PopUpInfo Result { get; set; }
        ...
        {
            return this.Equals(input as ListUserPopupInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListUserPopupInfoResponse input)
        {

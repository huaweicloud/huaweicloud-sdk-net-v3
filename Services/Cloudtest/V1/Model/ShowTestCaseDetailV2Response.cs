...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTestCaseDetailV2Response : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTestCaseDetailV2Response);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestCaseDetailV2Response input)
        {

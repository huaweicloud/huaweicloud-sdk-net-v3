...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class AddOrUpdateTestsuiteInfoUsingRequest 
    {
        ...
        public TaskInfoV4VoReq Body { get; set; }
        ...
        {
            return this.Equals(input as AddOrUpdateTestsuiteInfoUsingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddOrUpdateTestsuiteInfoUsingRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteTestCaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteTestCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteTestCaseResponse input)
        {

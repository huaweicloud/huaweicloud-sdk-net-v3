...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchUpdateTestCasesInDiffVersionResponse : SdkResponse
    {
        ...
        public ResultValueBatchCreateUpdateApiTestCaseVo Result { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateTestCasesInDiffVersionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateTestCasesInDiffVersionResponse input)
        {

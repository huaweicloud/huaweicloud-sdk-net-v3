...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CommRequestUpdateAssetTreeParam 
    {
        ...
        public UpdateAssetTreeParam Params { get; set; }
        ...
        {
            return this.Equals(input as CommRequestUpdateAssetTreeParam);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommRequestUpdateAssetTreeParam input)
        {

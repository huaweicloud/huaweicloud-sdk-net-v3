...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowProgressResponse : SdkResponse
    {
        ...
        public ResultValueProgressVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowProgressResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProgressResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListSubTasksByPostUsingRequest 
    {
        ...
        public SubTaskQueryByPageParams Body { get; set; }
        ...
        {
            return this.Equals(input as ListSubTasksByPostUsingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubTasksByPostUsingRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTestCaseDetailResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowTestCaseDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestCaseDetailResponse input)
        {

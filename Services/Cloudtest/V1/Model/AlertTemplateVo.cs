...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class AlertTemplateVo 
    {
        ...
        /// 告警级别列表
        /// </summary>
        [JsonProperty("alertLevels", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  alertLevels: ").Append(AlertLevels).Append("\n");
        ...
        {
            return this.Equals(input as AlertTemplateVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AlertTemplateVo input)
        {
            if (input == null) return false;
            if (this.AlertLevels != input.AlertLevels || (this.AlertLevels != null && input.AlertLevels != null && !this.AlertLevels.SequenceEqual(input.AlertLevels))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.AlertLevels != null) hashCode = hashCode * 59 + this.AlertLevels.GetHashCode();

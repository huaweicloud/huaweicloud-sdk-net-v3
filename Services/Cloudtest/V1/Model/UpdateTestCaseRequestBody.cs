...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class UpdateTestCaseRequestBody 
    {
        ...
        public ExternalServiceBizCase ExtendInfo { get; set; }
        ...
        {
            return this.Equals(input as UpdateTestCaseRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestCaseRequestBody input)
        {

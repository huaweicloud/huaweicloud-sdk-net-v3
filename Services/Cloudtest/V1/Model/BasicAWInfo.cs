...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BasicAWInfo 
    {
        ...
        public List<AwInstanceRes> AwInsList { get; set; }
        ...
        public List<BasicAWInfo> ChildList { get; set; }
        ...
        public List<UploadFileRes> CustomAwLibs { get; set; }
        ...
        public PublicAwLibRes PublicAwLib { get; set; }
        ...
        {
            return this.Equals(input as BasicAWInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BasicAWInfo input)
        {

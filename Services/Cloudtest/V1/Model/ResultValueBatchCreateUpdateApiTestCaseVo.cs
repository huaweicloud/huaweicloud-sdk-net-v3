...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueBatchCreateUpdateApiTestCaseVo 
    {
        ...
        public BatchCreateUpdateApiTestCaseVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueBatchCreateUpdateApiTestCaseVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueBatchCreateUpdateApiTestCaseVo input)
        {

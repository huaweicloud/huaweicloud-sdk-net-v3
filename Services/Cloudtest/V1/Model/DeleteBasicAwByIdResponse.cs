...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteBasicAwByIdResponse : SdkResponse
    {
        ...
        public CommonResponseErrorString Error { get; set; }
        ...
        {
            return this.Equals(input as DeleteBasicAwByIdResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteBasicAwByIdResponse input)
        {

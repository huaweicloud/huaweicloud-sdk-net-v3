...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowProjectDataDashboardRequest 
    {
        ...
        public TestReportInfoRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowProjectDataDashboardRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProjectDataDashboardRequest input)
        {

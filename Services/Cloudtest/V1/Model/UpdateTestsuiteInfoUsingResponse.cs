...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTestsuiteInfoUsingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateTestsuiteInfoUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestsuiteInfoUsingResponse input)
        {

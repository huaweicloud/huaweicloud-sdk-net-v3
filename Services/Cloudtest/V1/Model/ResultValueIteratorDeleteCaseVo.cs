...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueIteratorDeleteCaseVo 
    {
        ...
        public IteratorDeleteCaseVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueIteratorDeleteCaseVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueIteratorDeleteCaseVo input)
        {

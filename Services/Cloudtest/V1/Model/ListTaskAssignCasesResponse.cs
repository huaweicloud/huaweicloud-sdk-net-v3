...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTaskAssignCasesResponse : SdkResponse
    {
        ...
        public ResultValueListTaskAssignCaseDetailVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTaskAssignCasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTaskAssignCasesResponse input)
        {

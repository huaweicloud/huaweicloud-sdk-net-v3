...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CommonResponseErrorPageResultBasicAWInfo 
    {
        ...
        public PageResultBasicAWInfo Detail { get; set; }
        ...
        {
            return this.Equals(input as CommonResponseErrorPageResultBasicAWInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommonResponseErrorPageResultBasicAWInfo input)
        {

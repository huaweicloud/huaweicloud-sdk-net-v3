...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CommRequestTestPointPageParam 
    {
        ...
        public TestPointPageParam Params { get; set; }
        ...
        {
            return this.Equals(input as CommRequestTestPointPageParam);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommRequestTestPointPageParam input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMsgInfosUsingResponse : SdkResponse
    {
        ...
        public List<MsgInfoVo> List { get; set; }
        ...
        {
            return this.Equals(input as ListMsgInfosUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMsgInfosUsingResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBasicAwResponse : SdkResponse
    {
        ...
        public BasicAwRes Result { get; set; }
        ...
        {
            return this.Equals(input as ListBasicAwResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBasicAwResponse input)
        {

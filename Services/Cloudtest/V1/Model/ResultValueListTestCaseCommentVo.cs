...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListTestCaseCommentVo 
    {
        ...
        public List<TestCaseCommentVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListTestCaseCommentVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListTestCaseCommentVo input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UploadStepImgResponse : SdkResponse
    {
        ...
        public ResultValueStepImageVo Result { get; set; }
        ...
        {
            return this.Equals(input as UploadStepImgResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadStepImgResponse input)
        {

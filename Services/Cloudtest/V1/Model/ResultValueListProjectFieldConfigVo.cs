...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListProjectFieldConfigVo 
    {
        ...
        public List<ProjectFieldConfigVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListProjectFieldConfigVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListProjectFieldConfigVo input)
        {

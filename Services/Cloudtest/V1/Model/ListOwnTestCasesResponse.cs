...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListOwnTestCasesResponse : SdkResponse
    {
        ...
        public ResultValueListTestCaseVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListOwnTestCasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListOwnTestCasesResponse input)
        {

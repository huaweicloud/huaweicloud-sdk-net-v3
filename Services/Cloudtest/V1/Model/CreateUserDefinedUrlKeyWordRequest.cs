...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateUserDefinedUrlKeyWordRequest 
    {
        ...
        public CreateBasicAwReq Body { get; set; }
        ...
        {
            return this.Equals(input as CreateUserDefinedUrlKeyWordRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateUserDefinedUrlKeyWordRequest input)
        {

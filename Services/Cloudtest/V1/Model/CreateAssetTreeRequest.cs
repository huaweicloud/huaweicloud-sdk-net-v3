...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateAssetTreeRequest 
    {
        ...
        /// 父目录ID
        /// </summary>
        [SDKProperty("parent_id", IsPath = true)]
        ...
        public CommRequestAssetTree Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAssetTreeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAssetTreeRequest input)
        {

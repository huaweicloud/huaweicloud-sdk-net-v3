...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddTestCaseCommentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddTestCaseCommentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddTestCaseCommentResponse input)
        {

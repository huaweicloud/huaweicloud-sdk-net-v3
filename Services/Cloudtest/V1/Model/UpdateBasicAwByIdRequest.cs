...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class UpdateBasicAwByIdRequest 
    {
        ...
        public UpdateBasicAwReq Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateBasicAwByIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateBasicAwByIdRequest input)
        {

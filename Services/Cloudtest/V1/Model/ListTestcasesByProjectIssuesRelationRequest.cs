...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListTestcasesByProjectIssuesRelationRequest 
    {
        ...
        public QueryProjectIssuesRelationTestCasesInfo Body { get; set; }
        ...
        {
            return this.Equals(input as ListTestcasesByProjectIssuesRelationRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestcasesByProjectIssuesRelationRequest input)
        {

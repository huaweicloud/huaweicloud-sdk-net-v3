...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteTestCasesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteTestCasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteTestCasesResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueCustomReportListVo 
    {
        ...
        public CustomReportListVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueCustomReportListVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueCustomReportListVo input)
        {

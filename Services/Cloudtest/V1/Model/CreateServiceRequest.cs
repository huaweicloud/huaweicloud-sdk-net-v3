...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateServiceRequest 
    {
        ...
        /// <summary>
        /// 主账号用户Token。 通过调用IAM服务获取用户Token接口获取（响应消息头中X-Subject-Token的值）。
        /// </summary>
        ...
        public ServiceRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateServiceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateServiceRequest input)
        {

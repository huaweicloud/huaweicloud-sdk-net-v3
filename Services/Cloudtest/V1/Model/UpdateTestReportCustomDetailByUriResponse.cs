...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTestReportCustomDetailByUriResponse : SdkResponse
    {
        ...
        public ResultValueString Result { get; set; }
        ...
        {
            return this.Equals(input as UpdateTestReportCustomDetailByUriResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestReportCustomDetailByUriResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowMindmapRecycleByPageRequest 
    {
        ...
        public CommRequestMindmapRecyclePageParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowMindmapRecycleByPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMindmapRecycleByPageRequest input)
        {

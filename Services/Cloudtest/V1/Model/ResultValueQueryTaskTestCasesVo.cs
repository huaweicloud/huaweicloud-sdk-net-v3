...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueQueryTaskTestCasesVo 
    {
        ...
        public QueryTaskTestCasesVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueQueryTaskTestCasesVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueQueryTaskTestCasesVo input)
        {

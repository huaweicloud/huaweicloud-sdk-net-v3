...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTaskDefaultResultResponse : SdkResponse
    {
        ...
        public ResultValueExecuteTaskVo Result { get; set; }
        ...
        {
            return this.Equals(input as CreateTaskDefaultResultResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTaskDefaultResultResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListTestCaseReviewVo 
    {
        ...
        public List<TestCaseReviewVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListTestCaseReviewVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListTestCaseReviewVo input)
        {

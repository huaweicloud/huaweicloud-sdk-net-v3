...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListTestCasesByConditionRequest 
    {
        ...
        public TestCasesListQueryInfo Body { get; set; }
        ...
        {
            return this.Equals(input as ListTestCasesByConditionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestCasesByConditionRequest input)
        {

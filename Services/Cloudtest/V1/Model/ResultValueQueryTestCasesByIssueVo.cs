...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueQueryTestCasesByIssueVo 
    {
        ...
        public QueryTestCasesByIssueVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueQueryTestCasesByIssueVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueQueryTestCasesByIssueVo input)
        {

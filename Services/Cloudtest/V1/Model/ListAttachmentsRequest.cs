...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListAttachmentsRequest 
    {
        ...
        /// 资源Uri
        /// </summary>
        [SDKProperty("resource_uri", IsPath = true)]
        [JsonProperty("resource_uri", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ListAttachmentsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAttachmentsRequest input)
        {
            ...
            if (this.ResourceUri != input.ResourceUri || (this.ResourceUri != null && !this.ResourceUri.Equals(input.ResourceUri))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResourceUri != null) hashCode = hashCode * 59 + this.ResourceUri.GetHashCode();

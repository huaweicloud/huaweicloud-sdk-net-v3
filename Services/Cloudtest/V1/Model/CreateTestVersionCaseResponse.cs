...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTestVersionCaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTestVersionCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTestVersionCaseResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CommRequestGetDefaultTemplateParam 
    {
        ...
        public GetDefaultTemplateParam Params { get; set; }
        ...
        {
            return this.Equals(input as CommRequestGetDefaultTemplateParam);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommRequestGetDefaultTemplateParam input)
        {

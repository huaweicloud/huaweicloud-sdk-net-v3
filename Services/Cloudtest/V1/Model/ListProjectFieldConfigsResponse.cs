...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectFieldConfigsResponse : SdkResponse
    {
        ...
        public ResultValueListProjectFieldConfigVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListProjectFieldConfigsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectFieldConfigsResponse input)
        {

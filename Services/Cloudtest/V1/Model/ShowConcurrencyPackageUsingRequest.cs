...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowConcurrencyPackageUsingRequest 
    {
        ...
        /// test_type
        /// </summary>
        [SDKProperty("test_type", IsQuery = true)]
        ...
        {
            return this.Equals(input as ShowConcurrencyPackageUsingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowConcurrencyPackageUsingRequest input)
        {

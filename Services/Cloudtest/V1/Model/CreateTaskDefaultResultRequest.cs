...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateTaskDefaultResultRequest 
    {
        ...
        public InitExecuteTaskInfo Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTaskDefaultResultRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTaskDefaultResultRequest input)
        {

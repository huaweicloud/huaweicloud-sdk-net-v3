...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UploadCacheFileResponse : SdkResponse
    {
        ...
        public ResultValueAttachmentFileVo Result { get; set; }
        ...
        {
            return this.Equals(input as UploadCacheFileResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UploadCacheFileResponse input)
        {

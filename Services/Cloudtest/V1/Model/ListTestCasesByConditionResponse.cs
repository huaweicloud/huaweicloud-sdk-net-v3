...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTestCasesByConditionResponse : SdkResponse
    {
        ...
        public ResultValueListTestCaseListVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTestCasesByConditionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestCasesByConditionResponse input)
        {

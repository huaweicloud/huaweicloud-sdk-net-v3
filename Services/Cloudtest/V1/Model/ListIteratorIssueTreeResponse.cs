...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListIteratorIssueTreeResponse : SdkResponse
    {
        ...
        public ResultValueListWorkItemVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListIteratorIssueTreeResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListIteratorIssueTreeResponse input)
        {

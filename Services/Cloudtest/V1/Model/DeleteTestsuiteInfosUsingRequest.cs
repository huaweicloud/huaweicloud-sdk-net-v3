...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class DeleteTestsuiteInfosUsingRequest 
    {
        ...
        public DeleteTaskParams Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteTestsuiteInfosUsingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTestsuiteInfosUsingRequest input)
        {

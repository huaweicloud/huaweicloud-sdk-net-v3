...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAllTestCasesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListAllTestCasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllTestCasesResponse input)
        {

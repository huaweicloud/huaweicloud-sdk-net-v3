...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowMindmapBackupByPageRequest 
    {
        ...
        public CommRequestMindmapBackupPageParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowMindmapBackupByPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMindmapBackupByPageRequest input)
        {

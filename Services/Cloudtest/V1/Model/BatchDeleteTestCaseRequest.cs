...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchDeleteTestCaseRequest 
    {
        ...
        public BatchDeleteTestCaseRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteTestCaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteTestCaseRequest input)
        {

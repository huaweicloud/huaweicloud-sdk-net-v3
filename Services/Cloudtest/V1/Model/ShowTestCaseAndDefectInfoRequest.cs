...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowTestCaseAndDefectInfoRequest 
    {
        ...
        public ShowTestCaseAndDefectInfoRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowTestCaseAndDefectInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestCaseAndDefectInfoRequest input)
        {

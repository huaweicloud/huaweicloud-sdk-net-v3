...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class MindmapRecycle 
    {
        ...
        /// 脑图版本
        /// </summary>
        [JsonProperty("map_version", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as MindmapRecycle);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MindmapRecycle input)
        {
            ...
            if (this.MapVersion != input.MapVersion || (this.MapVersion != null && !this.MapVersion.Equals(input.MapVersion))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MapVersion != null) hashCode = hashCode * 59 + this.MapVersion.GetHashCode();

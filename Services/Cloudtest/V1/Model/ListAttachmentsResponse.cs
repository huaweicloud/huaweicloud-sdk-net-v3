...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAttachmentsResponse : SdkResponse
    {
        ...
        public ResultValueListAttachmentVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListAttachmentsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAttachmentsResponse input)
        {

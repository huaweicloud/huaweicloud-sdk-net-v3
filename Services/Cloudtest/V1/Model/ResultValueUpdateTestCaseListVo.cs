...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueUpdateTestCaseListVo 
    {
        ...
        public UpdateTestCaseListVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueUpdateTestCaseListVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueUpdateTestCaseListVo input)
        {

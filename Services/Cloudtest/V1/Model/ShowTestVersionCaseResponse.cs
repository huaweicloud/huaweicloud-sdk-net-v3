...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTestVersionCaseResponse : SdkResponse
    {
        ...
        public ResultValueTestCaseDetailVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowTestVersionCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestVersionCaseResponse input)
        {

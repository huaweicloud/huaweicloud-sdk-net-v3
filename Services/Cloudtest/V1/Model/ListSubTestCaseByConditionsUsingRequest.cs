...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListSubTestCaseByConditionsUsingRequest 
    {
        ...
        public SubTaskCaseQuery Body { get; set; }
        ...
        {
            return this.Equals(input as ListSubTestCaseByConditionsUsingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubTestCaseByConditionsUsingRequest input)
        {

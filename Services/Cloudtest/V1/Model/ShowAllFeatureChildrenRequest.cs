...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowAllFeatureChildrenRequest 
    {
        ...
        /// 
        /// </summary>
        [SDKProperty("feature_id", IsPath = true)]
        [JsonProperty("feature_id", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public QueryTestItemTreeInfo Body { get; set; }
        ...
        {
            return this.Equals(input as ShowAllFeatureChildrenRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAllFeatureChildrenRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BasicAwRes 
    {
        ...
        public List<Object> DftCheckPointList { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [JsonProperty("dft_custom_header", NullValueHandling = NullValueHandling.Ignore)]
        public List<Object> DftCustomHeader { get; set; }
        ...
        public List<Object> DftVariableList { get; set; }
        ...
        public List<Object> ParamTypeAndDftValue { get; set; }
        ...
        public Object PublicAwLib { get; set; }
        ...
        {
            return this.Equals(input as BasicAwRes);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BasicAwRes input)
        {

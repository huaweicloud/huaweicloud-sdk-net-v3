...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTestCaseCommentResponse : SdkResponse
    {
        ...
        public ResultValueTestCaseCommentVo Result { get; set; }
        ...
        {
            return this.Equals(input as UpdateTestCaseCommentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestCaseCommentResponse input)
        {

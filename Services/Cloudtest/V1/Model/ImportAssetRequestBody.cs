...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// 
    /// </summary>
    public class ImportAssetRequestBody : IFormDataBody
    {
        ...
        public ImportAssetRequestBody WithExcelFile(Stream stream, string filename)
        {
            this.ExcelFile = new FormDataFilePart(stream, filename);
            return this;
        }

        public ImportAssetRequestBody WithExcelFile(Stream stream, string filename, string contentType)
        {
        ...
        {
            return this.Equals(input as ImportAssetRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ImportAssetRequestBody input)
        {

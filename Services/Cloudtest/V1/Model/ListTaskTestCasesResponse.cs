...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTaskTestCasesResponse : SdkResponse
    {
        ...
        public ResultValueQueryTaskTestCasesVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTaskTestCasesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTaskTestCasesResponse input)
        {

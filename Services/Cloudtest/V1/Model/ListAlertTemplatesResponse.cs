...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAlertTemplatesResponse : SdkResponse
    {
        ...
        public List<AlertTemplateVo> List { get; set; }
        ...
        {
            return this.Equals(input as ListAlertTemplatesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAlertTemplatesResponse input)
        {

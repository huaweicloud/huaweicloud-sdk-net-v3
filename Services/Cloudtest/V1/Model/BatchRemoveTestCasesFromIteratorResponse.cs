...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchRemoveTestCasesFromIteratorResponse : SdkResponse
    {
        ...
        public ResultValueIteratorDeleteCaseVo Result { get; set; }
        ...
        {
            return this.Equals(input as BatchRemoveTestCasesFromIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRemoveTestCasesFromIteratorResponse input)
        {

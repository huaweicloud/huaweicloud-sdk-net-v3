...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListLinesUsingResponse : SdkResponse
    {
        ...
        public List<SubTaskCaseSuccessLineVo> List { get; set; }
        ...
        {
            return this.Equals(input as ListLinesUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListLinesUsingResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteTestCaseCommentResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteTestCaseCommentResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTestCaseCommentResponse input)
        {

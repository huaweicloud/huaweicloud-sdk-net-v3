...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteTestReportCustomDetailByUriResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteTestReportCustomDetailByUriResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteTestReportCustomDetailByUriResponse input)
        {

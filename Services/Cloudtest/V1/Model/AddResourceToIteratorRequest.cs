...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class AddResourceToIteratorRequest 
    {
        ...
        /// 迭代uri
        /// </summary>
        [SDKProperty("iterator_uri", IsPath = true)]
        ...
        /// </summary>
        [SDKProperty("is_async", IsQuery = true)]
        ...
        public AddResourceInfo Body { get; set; }
        ...
        {
            return this.Equals(input as AddResourceToIteratorRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddResourceToIteratorRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class RemoveIssuesFromIteratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as RemoveIssuesFromIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveIssuesFromIteratorResponse input)
        {

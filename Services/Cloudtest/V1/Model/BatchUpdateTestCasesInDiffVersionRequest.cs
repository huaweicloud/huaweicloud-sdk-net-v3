...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchUpdateTestCasesInDiffVersionRequest 
    {
        ...
        public List<TestCaseInfo> Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateTestCasesInDiffVersionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateTestCasesInDiffVersionRequest input)
        {

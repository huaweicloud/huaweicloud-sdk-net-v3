...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowBackgroundInfoResponse : SdkResponse
    {
        ...
        public ResultValueBackgroundInfoVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowBackgroundInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowBackgroundInfoResponse input)
        {

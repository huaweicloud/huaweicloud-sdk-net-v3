...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class StartTestsuiteUsingResponse : SdkResponse
    {
        ...
        public TaskBasicInfoVo Result { get; set; }
        ...
        {
            return this.Equals(input as StartTestsuiteUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(StartTestsuiteUsingResponse input)
        {
            ...
            if (this.Warn != input.Warn || (this.Warn != null && !this.Warn.Equals(input.Warn))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Warn != null) hashCode = hashCode * 59 + this.Warn.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListIteratorVersionSummaryVo 
    {
        ...
        public List<IteratorVersionSummaryVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListIteratorVersionSummaryVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListIteratorVersionSummaryVo input)
        {

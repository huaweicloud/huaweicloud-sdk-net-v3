...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchAddCaseResultInTaskRequest 
    {
        ...
        public BatchAddTestCaseResultInTaskInfo Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAddCaseResultInTaskRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddCaseResultInTaskRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class RemoveIssuesFromIteratorRequest 
    {
        ...
        public RemoveIssuesInfo Body { get; set; }
        ...
        {
            return this.Equals(input as RemoveIssuesFromIteratorRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveIssuesFromIteratorRequest input)
        {

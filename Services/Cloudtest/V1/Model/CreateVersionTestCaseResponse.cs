...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateVersionTestCaseResponse : SdkResponse
    {
        ...
        public ResultValueTestCaseVo Result { get; set; }
        ...
        {
            return this.Equals(input as CreateVersionTestCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateVersionTestCaseResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAllFeatureChildrenResponse : SdkResponse
    {
        ...
        public ResultValueListTestItemVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowAllFeatureChildrenResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAllFeatureChildrenResponse input)
        {

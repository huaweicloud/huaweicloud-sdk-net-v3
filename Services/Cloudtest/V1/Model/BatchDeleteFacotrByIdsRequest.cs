...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchDeleteFacotrByIdsRequest 
    {
        ...
        public CommRequestListString Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteFacotrByIdsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteFacotrByIdsRequest input)
        {

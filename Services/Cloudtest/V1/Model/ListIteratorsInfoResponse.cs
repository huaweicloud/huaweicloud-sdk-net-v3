...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListIteratorsInfoResponse : SdkResponse
    {
        ...
        public ResultValueListIteratorVersionSummaryVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListIteratorsInfoResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListIteratorsInfoResponse input)
        {

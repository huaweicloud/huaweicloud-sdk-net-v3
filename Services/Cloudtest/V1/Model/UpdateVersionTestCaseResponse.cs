...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateVersionTestCaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateVersionTestCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateVersionTestCaseResponse input)
        {

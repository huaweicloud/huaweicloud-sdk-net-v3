...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowRequirementsOverviewRequest 
    {
        ...
        public QueryRequirementsOverviewInfo Body { get; set; }
        ...
        {
            return this.Equals(input as ShowRequirementsOverviewRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowRequirementsOverviewRequest input)
        {

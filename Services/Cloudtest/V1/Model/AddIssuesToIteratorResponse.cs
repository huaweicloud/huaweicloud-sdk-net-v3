...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddIssuesToIteratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddIssuesToIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddIssuesToIteratorResponse input)
        {

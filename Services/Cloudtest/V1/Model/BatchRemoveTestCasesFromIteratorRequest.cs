...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchRemoveTestCasesFromIteratorRequest 
    {
        ...
        public CaseRemoveInfo Body { get; set; }
        ...
        {
            return this.Equals(input as BatchRemoveTestCasesFromIteratorRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchRemoveTestCasesFromIteratorRequest input)
        {

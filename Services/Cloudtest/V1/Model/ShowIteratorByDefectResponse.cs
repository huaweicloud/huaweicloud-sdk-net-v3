...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowIteratorByDefectResponse : SdkResponse
    {
        ...
        public ResultValueTestVersionVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowIteratorByDefectResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowIteratorByDefectResponse input)
        {

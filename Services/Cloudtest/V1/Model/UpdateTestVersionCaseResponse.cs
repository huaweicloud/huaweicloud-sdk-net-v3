...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTestVersionCaseResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateTestVersionCaseResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestVersionCaseResponse input)
        {

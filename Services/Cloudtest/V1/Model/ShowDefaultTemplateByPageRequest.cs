...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowDefaultTemplateByPageRequest 
    {
        ...
        public CommRequestGetDefaultTemplateParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowDefaultTemplateByPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDefaultTemplateByPageRequest input)
        {

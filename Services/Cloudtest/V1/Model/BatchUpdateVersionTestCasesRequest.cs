...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchUpdateVersionTestCasesRequest 
    {
        ...
        public UpdateTestCaseListInfo Body { get; set; }
        ...
        {
            return this.Equals(input as BatchUpdateVersionTestCasesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchUpdateVersionTestCasesRequest input)
        {

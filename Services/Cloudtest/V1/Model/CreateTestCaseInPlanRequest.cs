...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateTestCaseInPlanRequest 
    {
        ...
        public CreateTestCaseInPlanRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateTestCaseInPlanRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTestCaseInPlanRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTestTypesResponse : SdkResponse
    {
        ...
        public ResultValueListIntegerIdAndNameVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTestTypesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestTypesResponse input)
        {

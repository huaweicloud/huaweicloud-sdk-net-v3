...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateBackupMindmapRequest 
    {
        ...
        public CommRequestBackUpMindmapParam Body { get; set; }
        ...
        {
            return this.Equals(input as CreateBackupMindmapRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateBackupMindmapRequest input)
        {

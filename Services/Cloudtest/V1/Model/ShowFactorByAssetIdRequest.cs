...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowFactorByAssetIdRequest 
    {
        ...
        public CommRequestListFactorParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowFactorByAssetIdRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFactorByAssetIdRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListTestReportCustomDetailVo 
    {
        ...
        public List<TestReportCustomDetailVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListTestReportCustomDetailVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListTestReportCustomDetailVo input)
        {

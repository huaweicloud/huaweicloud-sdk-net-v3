...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTestIteratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateTestIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestIteratorResponse input)
        {

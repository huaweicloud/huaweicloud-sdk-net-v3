...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CommRequestMindmapBackupPageParam 
    {
        ...
        public MindmapBackupPageParam Params { get; set; }
        ...
        {
            return this.Equals(input as CommRequestMindmapBackupPageParam);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommRequestMindmapBackupPageParam input)
        {

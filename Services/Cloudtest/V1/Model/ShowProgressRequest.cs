...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowProgressRequest 
    {
        ...
        /// 异步操作uri
        /// </summary>
        [SDKProperty("operation_uri", IsPath = true)]
        [JsonProperty("operation_uri", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ShowProgressRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowProgressRequest input)
        {
            ...
            if (this.OperationUri != input.OperationUri || (this.OperationUri != null && !this.OperationUri.Equals(input.OperationUri))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OperationUri != null) hashCode = hashCode * 59 + this.OperationUri.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SaveTestReportCustomDetailResponse : SdkResponse
    {
        ...
        public ResultValueListTestReportCustomDetailVo Result { get; set; }
        ...
        {
            return this.Equals(input as SaveTestReportCustomDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SaveTestReportCustomDetailResponse input)
        {

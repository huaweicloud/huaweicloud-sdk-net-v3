...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListTestCasesByIssueRequest 
    {
        ...
        public QueryTestCasesByIssueInfo Body { get; set; }
        ...
        {
            return this.Equals(input as ListTestCasesByIssueRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestCasesByIssueRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateUserDefinedUrlKeyWordResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateUserDefinedUrlKeyWordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateUserDefinedUrlKeyWordResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddTestCaseResultLogResponse : SdkResponse
    {
        ...
        public ResultValueTestResultVo Result { get; set; }
        ...
        {
            return this.Equals(input as AddTestCaseResultLogResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddTestCaseResultLogResponse input)
        {

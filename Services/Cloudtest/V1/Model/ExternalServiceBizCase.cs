...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ExternalServiceBizCase 
    {
        ...
        /// 缺陷id信息，数组长度小于50个
        /// </summary>
        [JsonProperty("defect_id_list", NullValueHandling = NullValueHandling.Ignore)]
        public List<string> DefectIdList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  defectIdList: ").Append(DefectIdList).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ExternalServiceBizCase);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ExternalServiceBizCase input)
        {
            ...
            if (this.DefectIdList != input.DefectIdList || (this.DefectIdList != null && input.DefectIdList != null && !this.DefectIdList.SequenceEqual(input.DefectIdList))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DefectIdList != null) hashCode = hashCode * 59 + this.DefectIdList.GetHashCode();
                return hashCode;
            }
        }
    }

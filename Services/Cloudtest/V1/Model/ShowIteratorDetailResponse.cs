...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowIteratorDetailResponse : SdkResponse
    {
        ...
        public ResultValueIteratorVersionSummaryVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowIteratorDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowIteratorDetailResponse input)
        {

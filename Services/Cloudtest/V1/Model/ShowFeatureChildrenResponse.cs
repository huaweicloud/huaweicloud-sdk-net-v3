...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFeatureChildrenResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowFeatureChildrenResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFeatureChildrenResponse input)
        {

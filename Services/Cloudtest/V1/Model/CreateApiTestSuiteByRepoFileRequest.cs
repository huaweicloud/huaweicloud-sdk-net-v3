...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CreateApiTestSuiteByRepoFileRequest 
    {
        ...
        public CreateTestSuitByRepoFileInfo Body { get; set; }
        ...
        {
            return this.Equals(input as CreateApiTestSuiteByRepoFileRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateApiTestSuiteByRepoFileRequest input)
        {

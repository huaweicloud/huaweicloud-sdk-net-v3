...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowFreeDeclarationResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowFreeDeclarationResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowFreeDeclarationResponse input)
        {

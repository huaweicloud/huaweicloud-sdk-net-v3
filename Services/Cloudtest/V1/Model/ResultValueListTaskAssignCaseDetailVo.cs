...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListTaskAssignCaseDetailVo 
    {
        ...
        public List<TaskAssignCaseDetailVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListTaskAssignCaseDetailVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListTaskAssignCaseDetailVo input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListAlarmStatisticsUsingRequest 
    {
        ...
        public AlarmStatisticsQuery Body { get; set; }
        ...
        {
            return this.Equals(input as ListAlarmStatisticsUsingRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAlarmStatisticsUsingRequest input)
        {

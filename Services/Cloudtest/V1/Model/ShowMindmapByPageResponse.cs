...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowMindmapByPageResponse : SdkResponse
    {
        ...
        public MindmapPageParamV3 Params { get; set; }
        ...
        {
            return this.Equals(input as ShowMindmapByPageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMindmapByPageResponse input)
        {

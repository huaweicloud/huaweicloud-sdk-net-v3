...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTestCasesChangeStatisticsResponse : SdkResponse
    {
        ...
        public ResultValueVersionTestCasesChangeStatisticsVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowTestCasesChangeStatisticsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestCasesChangeStatisticsResponse input)
        {

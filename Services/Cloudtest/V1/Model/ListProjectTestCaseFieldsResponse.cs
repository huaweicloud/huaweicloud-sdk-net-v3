...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListProjectTestCaseFieldsResponse : SdkResponse
    {
        ...
        public ResultValueListProjectTestCaseFieldVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListProjectTestCaseFieldsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListProjectTestCaseFieldsResponse input)
        {

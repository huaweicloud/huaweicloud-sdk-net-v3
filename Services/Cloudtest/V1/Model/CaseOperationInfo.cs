...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CaseOperationInfo 
    {
        ...
        public List<AssignCaseInfo> TestCasesInfo { get; set; }

        /// <summary>
        /// 前置用例关联信息
        /// </summary>
        [JsonProperty("set_up_cases_info", NullValueHandling = NullValueHandling.Ignore)]
        public List<AssignCaseInfo> SetUpCasesInfo { get; set; }

        /// <summary>
        /// 后置用例关联信息
        /// </summary>
        [JsonProperty("tear_down_cases_info", NullValueHandling = NullValueHandling.Ignore)]
        public List<AssignCaseInfo> TearDownCasesInfo { get; set; }
        ...
        {
            return this.Equals(input as CaseOperationInfo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CaseOperationInfo input)
        {

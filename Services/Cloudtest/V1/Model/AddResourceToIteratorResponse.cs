...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddResourceToIteratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddResourceToIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddResourceToIteratorResponse input)
        {

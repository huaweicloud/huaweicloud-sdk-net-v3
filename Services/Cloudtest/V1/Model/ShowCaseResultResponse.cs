...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowCaseResultResponse : SdkResponse
    {
        ...
        public ResultValueListTestResultVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowCaseResultResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowCaseResultResponse input)
        {

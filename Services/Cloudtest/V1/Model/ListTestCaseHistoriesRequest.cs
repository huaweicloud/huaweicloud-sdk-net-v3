...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListTestCaseHistoriesRequest 
    {
        ...
        public ListTestCaseHistoriesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListTestCaseHistoriesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestCaseHistoriesRequest input)
        {

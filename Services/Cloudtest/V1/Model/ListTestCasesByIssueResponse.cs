...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTestCasesByIssueResponse : SdkResponse
    {
        ...
        public ResultValueQueryTestCasesByIssueVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTestCasesByIssueResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestCasesByIssueResponse input)
        {

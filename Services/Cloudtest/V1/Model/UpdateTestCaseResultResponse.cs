...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateTestCaseResultResponse : SdkResponse
    {
        ...
        public ErrorDetailInfo ErrorDetail { get; set; }
        ...
        {
            return this.Equals(input as UpdateTestCaseResultResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestCaseResultResponse input)
        {

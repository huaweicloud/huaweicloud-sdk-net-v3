...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListTestCaseListVo 
    {
        ...
        public List<TestCaseListVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListTestCaseListVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListTestCaseListVo input)
        {

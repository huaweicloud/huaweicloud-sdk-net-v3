...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListPublicLibAndAwsResponse : SdkResponse
    {
        ...
        public List<GetPublicLibAndAwsResp> Result { get; set; }
        ...
        {
            return this.Equals(input as ListPublicLibAndAwsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListPublicLibAndAwsResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowUserExecuteTestCaseInfoRequest 
    {
        ...
        public ShowUserExecuteTestCaseInfoRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ShowUserExecuteTestCaseInfoRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowUserExecuteTestCaseInfoRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTestCaseCommentsResponse : SdkResponse
    {
        ...
        public ResultValueListTestCaseCommentVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTestCaseCommentsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestCaseCommentsResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListAllConfigItemByTypeRequest 
    {
        ...
        public ListAllConfigItemByTypeRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListAllConfigItemByTypeRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAllConfigItemByTypeRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListResourcePoolVo 
    {
        ...
        public List<ResourcePoolVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListResourcePoolVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListResourcePoolVo input)
        {

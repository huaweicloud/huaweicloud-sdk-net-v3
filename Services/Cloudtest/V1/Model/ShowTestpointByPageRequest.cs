...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowTestpointByPageRequest 
    {
        ...
        public CommRequestTestPointPageParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowTestpointByPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestpointByPageRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddFeatureResponse : SdkResponse
    {
        ...
        public ResultValueTestItemVo Result { get; set; }
        ...
        {
            return this.Equals(input as AddFeatureResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddFeatureResponse input)
        {

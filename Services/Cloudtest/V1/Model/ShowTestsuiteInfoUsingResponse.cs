...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTestsuiteInfoUsingResponse : SdkResponse
    {

        /// <summary>
        /// 智能告警开关：0为置灰，1为可用
        /// </summary>
        [JsonProperty("alertAction", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public AlertConfigVo AlertConfig { get; set; }
        ...
        /// 
        /// </summary>
        [JsonProperty("executeStrategies", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// 告警模板列表
        /// </summary>
        [JsonProperty("testCaseAlertGroups", NullValueHandling = NullValueHandling.Ignore)]
        public List<TestCaseTemplateVo> TestCaseAlertGroups { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  testCaseAlertGroups: ").Append(TestCaseAlertGroups).Append("\n");
        ...
        {
            return this.Equals(input as ShowTestsuiteInfoUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestsuiteInfoUsingResponse input)
        {
            ...
            if (this.TestCaseAlertGroups != input.TestCaseAlertGroups || (this.TestCaseAlertGroups != null && input.TestCaseAlertGroups != null && !this.TestCaseAlertGroups.SequenceEqual(input.TestCaseAlertGroups))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TestCaseAlertGroups != null) hashCode = hashCode * 59 + this.TestCaseAlertGroups.GetHashCode();

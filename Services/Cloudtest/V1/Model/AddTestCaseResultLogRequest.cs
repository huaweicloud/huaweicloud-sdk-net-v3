...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class AddTestCaseResultLogRequest 
    {
        ...
        public AddTestCaseResultLogInfo Body { get; set; }
        ...
        {
            return this.Equals(input as AddTestCaseResultLogRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddTestCaseResultLogRequest input)
        {

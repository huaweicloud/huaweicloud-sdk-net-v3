...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueRequirementsOverviewVo 
    {
        ...
        public RequirementsOverviewVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueRequirementsOverviewVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueRequirementsOverviewVo input)
        {

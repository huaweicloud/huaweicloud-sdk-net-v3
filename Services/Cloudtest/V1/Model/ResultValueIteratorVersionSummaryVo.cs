...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueIteratorVersionSummaryVo 
    {
        ...
        public IteratorVersionSummaryVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueIteratorVersionSummaryVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueIteratorVersionSummaryVo input)
        {

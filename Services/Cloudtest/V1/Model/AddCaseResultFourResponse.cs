...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AddCaseResultFourResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AddCaseResultFourResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddCaseResultFourResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListTestcasePlansRequest 
    {
        ...
        /// 版本URI
        /// </summary>
        [SDKProperty("branch_uri", IsPath = true)]
        ...
        public TestcasePlanQueryParam Body { get; set; }
        ...
        {
            return this.Equals(input as ListTestcasePlansRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestcasePlansRequest input)
        {

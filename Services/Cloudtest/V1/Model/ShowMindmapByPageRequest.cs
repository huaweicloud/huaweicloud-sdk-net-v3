...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowMindmapByPageRequest 
    {
        ...
        public CommRequestMindmapPageParamV3 Body { get; set; }
        ...
        {
            return this.Equals(input as ShowMindmapByPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMindmapByPageRequest input)
        {

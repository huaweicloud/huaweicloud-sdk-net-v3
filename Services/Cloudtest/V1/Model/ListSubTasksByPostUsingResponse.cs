...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubTasksByPostUsingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListSubTasksByPostUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubTasksByPostUsingResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListScattersUsingResponse : SdkResponse
    {
        ...
        public List<TaskCaseResponseTimeDetailVo> List { get; set; }
        ...
        {
            return this.Equals(input as ListScattersUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListScattersUsingResponse input)
        {

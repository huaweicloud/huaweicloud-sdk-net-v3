...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowTemplateByPageRequest 
    {
        ...
        public CommRequestTemplatePageParam Body { get; set; }
        ...
        {
            return this.Equals(input as ShowTemplateByPageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTemplateByPageRequest input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class BatchAddRelationsByOneCaseRequest 
    {
        ...
        /// 需求/缺陷id
        /// </summary>
        [SDKProperty("workitem_id", IsPath = true)]
        ...
        public AddRelationsInfo Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAddRelationsByOneCaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddRelationsByOneCaseRequest input)
        {

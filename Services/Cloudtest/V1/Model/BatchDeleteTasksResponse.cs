...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteTasksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteTasksResponse input)
        {

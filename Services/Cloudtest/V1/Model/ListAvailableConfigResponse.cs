...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListAvailableConfigResponse : SdkResponse
    {
        ...
        public CommonResponseErrorAvailableConfig Error { get; set; }
        ...
        public AvailableConfig Result { get; set; }
        ...
        {
            return this.Equals(input as ListAvailableConfigResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAvailableConfigResponse input)
        {

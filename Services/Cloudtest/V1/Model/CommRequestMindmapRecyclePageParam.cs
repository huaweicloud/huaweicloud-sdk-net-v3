...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class CommRequestMindmapRecyclePageParam 
    {
        ...
        public MindmapRecyclePageParam Params { get; set; }
        ...
        {
            return this.Equals(input as CommRequestMindmapRecyclePageParam);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CommRequestMindmapRecyclePageParam input)
        {

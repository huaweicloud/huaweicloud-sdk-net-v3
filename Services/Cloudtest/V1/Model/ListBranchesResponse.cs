...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListBranchesResponse : SdkResponse
    {
        ...
        public List<ExternalBranchInfoVo> Values { get; set; }
        ...
        {
            return this.Equals(input as ListBranchesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListBranchesResponse input)
        {

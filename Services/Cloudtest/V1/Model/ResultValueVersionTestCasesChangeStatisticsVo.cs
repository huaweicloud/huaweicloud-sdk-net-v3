...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueVersionTestCasesChangeStatisticsVo 
    {
        ...
        public VersionTestCasesChangeStatisticsVo Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueVersionTestCasesChangeStatisticsVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueVersionTestCasesChangeStatisticsVo input)
        {

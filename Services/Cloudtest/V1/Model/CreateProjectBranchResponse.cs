...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateProjectBranchResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateProjectBranchResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateProjectBranchResponse input)
        {

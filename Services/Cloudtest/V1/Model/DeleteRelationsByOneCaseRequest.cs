...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class DeleteRelationsByOneCaseRequest 
    {
        ...
        public DeleteRelationsByOneCaseInfo Body { get; set; }
        ...
        {
            return this.Equals(input as DeleteRelationsByOneCaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteRelationsByOneCaseRequest input)
        {

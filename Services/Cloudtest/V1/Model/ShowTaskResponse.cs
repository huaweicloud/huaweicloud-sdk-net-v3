...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowTaskResponse : SdkResponse
    {
        ...
        public ResultValueTaskVo Result { get; set; }
        ...
        {
            return this.Equals(input as ShowTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTaskResponse input)
        {

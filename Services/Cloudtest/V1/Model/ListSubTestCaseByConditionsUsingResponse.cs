...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubTestCaseByConditionsUsingResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListSubTestCaseByConditionsUsingResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubTestCaseByConditionsUsingResponse input)
        {

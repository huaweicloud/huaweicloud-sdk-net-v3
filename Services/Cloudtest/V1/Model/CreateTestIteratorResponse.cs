...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateTestIteratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateTestIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateTestIteratorResponse input)
        {

...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ShowTestVersionCaseRequest 
    {
        ...
        /// 用例id
        /// </summary>
        [SDKProperty("case_uri", IsPath = true)]
        ...
        /// 任务
        /// </summary>
        [SDKProperty("taskUri", IsQuery = true)]
        [JsonProperty("taskUri", NullValueHandling = NullValueHandling.Ignore)]
        ...
        {
            return this.Equals(input as ShowTestVersionCaseRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowTestVersionCaseRequest input)
        {

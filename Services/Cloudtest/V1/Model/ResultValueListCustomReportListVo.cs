...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListCustomReportListVo 
    {
        ...
        public List<CustomReportListVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListCustomReportListVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListCustomReportListVo input)
        {

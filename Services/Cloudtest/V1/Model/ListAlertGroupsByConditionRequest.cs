...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ListAlertGroupsByConditionRequest 
    {
        ...
        public ListAlertGroupsByConditionRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as ListAlertGroupsByConditionRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListAlertGroupsByConditionRequest input)
        {

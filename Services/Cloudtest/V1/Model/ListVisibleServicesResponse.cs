...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListVisibleServicesResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListVisibleServicesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListVisibleServicesResponse input)
        {

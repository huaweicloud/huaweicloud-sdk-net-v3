...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowDisclaimerRecordResponse : SdkResponse
    {
        ...
        public ResultValueBoolean Result { get; set; }
        ...
        {
            return this.Equals(input as ShowDisclaimerRecordResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowDisclaimerRecordResponse input)
        {

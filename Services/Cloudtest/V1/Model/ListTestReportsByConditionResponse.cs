...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTestReportsByConditionResponse : SdkResponse
    {
        ...
        public ResultValueListTestReportVo Result { get; set; }
        ...
        {
            return this.Equals(input as ListTestReportsByConditionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListTestReportsByConditionResponse input)
        {

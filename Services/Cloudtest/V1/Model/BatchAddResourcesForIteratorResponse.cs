...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchAddResourcesForIteratorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchAddResourcesForIteratorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAddResourcesForIteratorResponse input)
        {

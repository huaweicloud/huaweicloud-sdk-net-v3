...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class UpdateTestCaseResultRequest 
    {
        ...
        public UpdateTestCaseResultRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateTestCaseResultRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateTestCaseResultRequest input)
        {

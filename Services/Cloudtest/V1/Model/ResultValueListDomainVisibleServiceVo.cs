...
namespace HuaweiCloud.SDK.Cloudtest.V1.Model
{
    ...
    public class ResultValueListDomainVisibleServiceVo 
    {
        ...
        public List<DomainVisibleServiceVo> Value { get; set; }
        ...
        {
            return this.Equals(input as ResultValueListDomainVisibleServiceVo);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ResultValueListDomainVisibleServiceVo input)
        {

...
namespace HuaweiCloud.SDK.Apm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class SearchBusinessTopologyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as SearchBusinessTopologyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchBusinessTopologyResponse input)
        {

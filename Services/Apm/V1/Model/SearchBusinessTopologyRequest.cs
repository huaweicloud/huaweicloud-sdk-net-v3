...
namespace HuaweiCloud.SDK.Apm.V1.Model
{
    ...
    public class SearchBusinessTopologyRequest 
    {
        ...
        public BusinessTopoRequest Body { get; set; }
        ...
        {
            return this.Equals(input as SearchBusinessTopologyRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchBusinessTopologyRequest input)
        {

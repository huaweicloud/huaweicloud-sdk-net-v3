...
namespace HuaweiCloud.SDK.Apm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListEnvInstancesResponse : SdkResponse
    {

        /// <summary>
        /// 实例信息列表。
        /// </summary>
        [JsonProperty("instance_info_list", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  instanceInfoList: ").Append(InstanceInfoList).Append("\n");
        ...
        {
            return this.Equals(input as ListEnvInstancesResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListEnvInstancesResponse input)
        {
            if (input == null) return false;
            if (this.InstanceInfoList != input.InstanceInfoList || (this.InstanceInfoList != null && input.InstanceInfoList != null && !this.InstanceInfoList.SequenceEqual(input.InstanceInfoList))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.InstanceInfoList != null) hashCode = hashCode * 59 + this.InstanceInfoList.GetHashCode();

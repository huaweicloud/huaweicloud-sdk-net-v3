...
namespace HuaweiCloud.SDK.Apm.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowEventDetailResponse : SdkResponse
    {
        ...
        public SpanEventInfo EventInfo { get; set; }
        ...
        {
            return this.Equals(input as ShowEventDetailResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowEventDetailResponse input)
        {

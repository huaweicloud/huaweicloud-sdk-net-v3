...
namespace HuaweiCloud.SDK.Apm.V1.Model
{
    ...
    public class SearchTransactionConfigRequest 
    {
        ...
        public TransactionConfigSearchRequest Body { get; set; }
        ...
        {
            return this.Equals(input as SearchTransactionConfigRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(SearchTransactionConfigRequest input)
        {

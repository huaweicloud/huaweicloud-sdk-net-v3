...
namespace HuaweiCloud.SDK.Classroom.V3.Model
{
    ...
    public class JobRecords 
    {
        ...
        public bool Equals(JobRecords input)
        {
            ...
            if (this.AutoScore != input.AutoScore || (this.AutoScore != null && !this.AutoScore.Equals(input.AutoScore))) return false;
            if (this.CasePassCount != input.CasePassCount || (this.CasePassCount != null && !this.CasePassCount.Equals(input.CasePassCount))) return false;
            if (this.ExeCaseCount != input.ExeCaseCount || (this.ExeCaseCount != null && !this.ExeCaseCount.Equals(input.ExeCaseCount))) return false;
            if (this.CodeLine != input.CodeLine || (this.CodeLine != null && !this.CodeLine.Equals(input.CodeLine))) return false;
            if (this.CommitTime != input.CommitTime || (this.CommitTime != null && !this.CommitTime.Equals(input.CommitTime))) return false;
            if (this.ComplexityFileAvg != input.ComplexityFileAvg || (this.ComplexityFileAvg != null && !this.ComplexityFileAvg.Equals(input.ComplexityFileAvg))) return false;
            if (this.AutoScoreUsingTime != input.AutoScoreUsingTime || (this.AutoScoreUsingTime != null && !this.AutoScoreUsingTime.Equals(input.AutoScoreUsingTime))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AutoScore != null) hashCode = hashCode * 59 + this.AutoScore.GetHashCode();
                if (this.CasePassCount != null) hashCode = hashCode * 59 + this.CasePassCount.GetHashCode();
                if (this.ExeCaseCount != null) hashCode = hashCode * 59 + this.ExeCaseCount.GetHashCode();
                if (this.CodeLine != null) hashCode = hashCode * 59 + this.CodeLine.GetHashCode();
                if (this.CommitTime != null) hashCode = hashCode * 59 + this.CommitTime.GetHashCode();
                if (this.ComplexityFileAvg != null) hashCode = hashCode * 59 + this.ComplexityFileAvg.GetHashCode();
                if (this.AutoScoreUsingTime != null) hashCode = hashCode * 59 + this.AutoScoreUsingTime.GetHashCode();
                return hashCode;
            }
        }
    }

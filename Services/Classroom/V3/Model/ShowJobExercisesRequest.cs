...
namespace HuaweiCloud.SDK.Classroom.V3.Model
{
    ...
    public class ShowJobExercisesRequest 
    {
        ...
        {
            return this.Equals(input as ShowJobExercisesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowJobExercisesRequest input)
        {
            if (input == null) return false;
            if (this.JobId != input.JobId || (this.JobId != null && !this.JobId.Equals(input.JobId))) return false;
            if (this.SourceFrom != input.SourceFrom || (this.SourceFrom != null && !this.SourceFrom.Equals(input.SourceFrom))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SourceFrom != null) hashCode = hashCode * 59 + this.SourceFrom.GetHashCode();

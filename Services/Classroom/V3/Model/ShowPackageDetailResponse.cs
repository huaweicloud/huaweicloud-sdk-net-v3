...
namespace HuaweiCloud.SDK.Classroom.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowPackageDetailResponse : SdkResponse
    {
        ...
        /// 习题库里的习题数量
        /// </summary>
        [JsonProperty("exercise_cnt", NullValueHandling = NullValueHandling.Ignore)]
        public int? ExerciseCnt { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  exerciseCnt: ").Append(ExerciseCnt).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowPackageDetailResponse);
        }

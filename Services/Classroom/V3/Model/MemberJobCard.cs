...
namespace HuaweiCloud.SDK.Classroom.V3.Model
{
    ...
    public class MemberJobCard 
    {
        ...
        public bool Equals(MemberJobCard input)
        {
            ...
            if (this.LastSubmitTime != input.LastSubmitTime || (this.LastSubmitTime != null && !this.LastSubmitTime.Equals(input.LastSubmitTime))) return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastSubmitTime != null) hashCode = hashCode * 59 + this.LastSubmitTime.GetHashCode();
                return hashCode;
            }
        }
    }

...
namespace HuaweiCloud.SDK.Classroom.V3.Model
{
    ...
    public class ShowJobExercisesResponse : SdkResponse
    {
        ...
        public bool Equals(ShowJobExercisesResponse input)
        {
            ...
            if (this.GroupExercises != input.GroupExercises || (this.GroupExercises != null && input.GroupExercises != null && !this.GroupExercises.SequenceEqual(input.GroupExercises))) return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.GroupExercises != null) hashCode = hashCode * 59 + this.GroupExercises.GetHashCode();
